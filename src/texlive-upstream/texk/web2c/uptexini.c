...
initialize ( void ) 
{
  ...
  pagesofar [7 ]= 0 ;
  pagemaxdepth = 0 ;
  {register integer for_end; k = 28462 ;for_end = 29572 ; if ( k <= for_end) 
  do 
    xeqlevel [k ]= 1 ;
  while ( k++ < for_end ) ;} 
  ...
  if ( iniversion ) 
  {
	...
	eqtb [25892 + k ].hh .v.RH = 16 ;
      ...
      eqtb [26036 ].hh .v.RH = 19 ;
      eqtb [26041 ].hh .v.RH = 16 ;
      eqtb [26120 ].hh .v.RH = 17 ;
    ...
    {register integer for_end; k = 28462 ;for_end = 28781 ; if ( k <= 
    for_end) do 
      eqtb [k ].cint = 0 ;
    while ( k++ < for_end ) ;} 
    eqtb [28522 ].cint = 256 ;
    ...
    while ( k++ < for_end ) ;} 
    eqtb [28828 ].cint = 0 ;
    {register integer for_end; k = 29038 ;for_end = 29572 ; if ( k <= 
    for_end) do 
      eqtb [k ].cint = 0 ;
    while ( k++ < for_end ) ;} 
    hashused = 15514 ;
    ...
    trieopptr = 0 ;
    trienotready = true ;
    hash [15514 ].v.RH = 1265 ;
    if ( iniversion ) 
    formatident = 1339 ;
    hash [15522 ].v.RH = 1381 ;
    eqtb [15522 ].hh.b1 = 1 ;
...
znewtrieop ( smallnumber d , smallnumber n , trieopcode v ) 
{
  ...
  while ( true ) {
    ...
    if ( l == 0 ) 
    {
      ...
      overflow ( 1006 , trieopsize ) ;
      u = trieused [curlang ];
      if ( u == maxtrieop ) 
      overflow ( 1007 , maxtrieop - mintrieop ) ;
      incr ( trieopptr ) ;
      incr ( u ) ;
      trieused [curlang ]= u ;
      if ( u > maxopused ) 
...
zlinebreak ( integer finalwidowpenalty ) 
{
  ...
  if ( eqtb [25060 ].hh .v.RH == -1073741823L ) {
    ...
    if ( eqtb [29055 ].cint == 0 ) 
    {
      ...
      {
	firstwidth = eqtb [29041 ].cint - abs ( eqtb [29055 ].cint ) ;
	if ( eqtb [29055 ].cint >= 0 ) 
	firstindent = eqtb [29055 ].cint ;
	else firstindent = 0 ;
	secondwidth = eqtb [29041 ].cint ;
	secondindent = 0 ;
      } 
	...
	firstwidth = eqtb [29041 ].cint ;
	firstindent = 0 ;
	secondwidth = eqtb [29041 ].cint - abs ( eqtb [29055 ].cint ) ;
	if ( eqtb [29055 ].cint >= 0 ) 
	secondindent = eqtb [29055 ].cint ;
	else secondindent = 0 ;
      } 
    } 
  } 
  ...
  while ( true ) {
	...
	;
      ...
      printnl ( 992 ) ;
#endif /* STAT */
      background [2 ]= background [2 ]+ eqtb [29058 ].cint ;
      finalpass = true ;
    } 
  } 
  lab30: 
...
prefixedcommand ( void ) 
{
  ...
  case 108 : 
	...
	enddiagnostic ( false ) ;
      ...
      if ( ( p - 28206 ) < eqtb [28522 ].cint ) {
	  
	if ( ( a >= 4 ) ) 
	geqworddefine ( 28522 , p - 28206 ) ;
	else eqworddefine ( 28522 , p - 28206 ) ;
      } 
      if ( ( p - 28206 ) > eqtb [28523 ].cint ) {
	  
	if ( ( a >= 4 ) ) 
	geqworddefine ( 28523 , p - 28206 ) ;
	else eqworddefine ( 28523 , p - 28206 ) ;
      } 
    } 
    else {
	...
	default: 
	{
	  ...
	  {case 2 : 
	    if ( ( a >= 4 ) ) 
	    geqdefine ( p , 81 , 28526 + curval ) ;
	    else eqdefine ( p , 81 , 28526 + curval ) ;
	    break ;
	  case 3 : 
	    if ( ( a >= 4 ) ) 
	    geqdefine ( p , 82 , 29061 + curval ) ;
	    else eqdefine ( p , 82 , 29061 + curval ) ;
	    break ;
	  case 4 : 
	    if ( ( a >= 4 ) ) 
  ...
  case 87 : 
	...
	if ( ( p == 1 ) || ( p == 2 ) ) 
	{
	  ...
	  if ( ( a >= 4 ) ) 
	  geqworddefine ( 29317 + j , curval ) ;
	  else eqworddefine ( 29317 + j , curval ) ;
	} 
	else confusion ( 535 ) ;
      } 
      else {
...
storefmtfile ( void ) 
{
  ...
  packjobname ( 839 ) ;
  while ( ! wopenout ( fmtfile ) ) promptfilename ( 1358 , 839 ) ;
  printnl ( 1359 ) ;
  ...
  if ( hashhigh > 0 ) 
  dumpthings ( eqtb [29573 ], hashhigh ) ;
  dumpint ( parloc ) ;
  dumpint ( writeloc ) ;
  dumpint ( hashused ) ;
  ...
  if ( hashhigh > 0 ) 
  dumpthings ( hash [29573 ], hashhigh ) ;
  dumpint ( cscount ) ;
  println () ;
  printint ( cscount ) ;
  print ( 1344 ) ;
...
loadfmtfile ( void ) 
{
  ...
  eqtb [24526 ].hh .v.RH = -1073741823L ;
  eqtb [24526 ].hh.b1 = 0 ;
  {register integer for_end; x = 29573 ;for_end = eqtbtop ; if ( x <= 
  for_end) do 
    eqtb [x ]= eqtb [24526 ];
  while ( x++ < for_end ) ;} 
  undumpint ( x ) ;
  ...
  if ( hashhigh > 0 ) 
  undumpthings ( eqtb [29573 ], hashhigh ) ;
  {
    undumpint ( x ) ;
    if ( ( x < 514 ) || ( x > hashtop ) ) 
    goto lab6666 ;
  ...
  if ( hashhigh > 0 ) 
  {
    undumpthings ( hash [29573 ], hashhigh ) ;
    if ( debugformatfile ) 
    {
      printcsnames ( 29573 , hashhigh - ( 29573 ) ) ;
    } 
  } 
  undumpint ( cscount ) ;
  {
...
initprim ( void ) 
{
  ...
  primitive ( 496 , 81 , 28519 ) ;
  primitive ( 497 , 81 , 28520 ) ;
  primitive ( 498 , 81 , 28521 ) ;
  primitive ( 499 , 81 , 28513 ) ;
  primitive ( 500 , 81 , 28514 ) ;
  primitive ( 501 , 81 , 28515 ) ;
  primitive ( 502 , 81 , 28516 ) ;
  primitive ( 503 , 81 , 28517 ) ;
  if ( mltexp ) 
  {
    mltexenabledp = true ;
    if ( false ) 
    primitive ( 504 , 81 , 28522 ) ;
    primitive ( 505 , 81 , 28523 ) ;
    primitive ( 506 , 81 , 28524 ) ;
  } 
  ...
  primitive ( 527 , 82 , 29055 ) ;
  primitive ( 528 , 82 , 29056 ) ;
  primitive ( 529 , 82 , 29057 ) ;
  primitive ( 530 , 82 , 29059 ) ;
  primitive ( 531 , 82 , 29060 ) ;
  primitive ( 532 , 82 , 29058 ) ;
  primitive ( 32 , 69 , 0 ) ;
  primitive ( 47 , 48 , 0 ) ;
  primitive ( 543 , 49 , 0 ) ;
  primitive ( 544 , 103 , 0 ) ;
  ...
  primitive ( 786 , 123 , 8 ) ;
  primitive ( 787 , 123 , 9 ) ;
  primitive ( 788 , 123 , 10 ) ;
  primitive ( 789 , 123 , 11 ) ;
  primitive ( 805 , 120 , 0 ) ;
  primitive ( 806 , 120 , 1 ) ;
  primitive ( 807 , 120 , 2 ) ;
  primitive ( 808 , 120 , 3 ) ;
  ...
  primitive ( 822 , 120 , 17 ) ;
  primitive ( 823 , 120 , 18 ) ;
  primitive ( 824 , 120 , 19 ) ;
  primitive ( 825 , 120 , 20 ) ;
  primitive ( 826 , 120 , 21 ) ;
  primitive ( 827 , 120 , 22 ) ;
  primitive ( 828 , 120 , 23 ) ;
  primitive ( 829 , 121 , 2 ) ;
  hash [15518 ].v.RH = 829 ;
  ...
  primitive ( 1118 , 24 , 4 ) ;
  primitive ( 1024 , 24 , 5 ) ;
  primitive ( 1119 , 24 , 121 ) ;
  primitive ( 1120 , 78 , 3 ) ;
  primitive ( 1121 , 78 , 4 ) ;
  primitive ( 1122 , 78 , 1 ) ;
  primitive ( 1123 , 35 , 99 ) ;
  primitive ( 1124 , 35 , 100 ) ;
  primitive ( 1125 , 35 , 101 ) ;
  primitive ( 1126 , 35 , 102 ) ;
  primitive ( 1148 , 47 , 1 ) ;
  primitive ( 1149 , 47 , 0 ) ;
  primitive ( 1160 , 29 , 14 ) ;
  primitive ( 1161 , 29 , 13 ) ;
  primitive ( 1162 , 29 , 12 ) ;
  primitive ( 1163 , 27 , 0 ) ;
  primitive ( 1164 , 27 , 1 ) ;
  primitive ( 1165 , 28 , 0 ) ;
  primitive ( 1166 , 28 , 1 ) ;
  ...
  primitive ( 1246 , 106 , 1 ) ;
  primitive ( 1247 , 106 , 2 ) ;
  primitive ( 1248 , 106 , 4 ) ;
  primitive ( 1249 , 110 , 0 ) ;
  primitive ( 1250 , 110 , 1 ) ;
  primitive ( 1251 , 110 , 2 ) ;
  primitive ( 1252 , 110 , 3 ) ;
  primitive ( 1266 , 107 , 0 ) ;
  primitive ( 1267 , 107 , 1 ) ;
  primitive ( 1268 , 108 , 0 ) ;
  primitive ( 1269 , 108 , 8 ) ;
  primitive ( 1270 , 108 , 1 ) ;
  primitive ( 1271 , 108 , 2 ) ;
  primitive ( 1272 , 108 , 3 ) ;
  primitive ( 1273 , 108 , 4 ) ;
  primitive ( 1274 , 108 , 5 ) ;
  primitive ( 1275 , 108 , 6 ) ;
  if ( mltexp ) 
  {
    primitive ( 1276 , 108 , 7 ) ;
  } 
  ...
  primitive ( 509 , 96 , 28782 ) ;
  primitive ( 431 , 97 , 25583 ) ;
  primitive ( 432 , 97 , 25599 ) ;
  primitive ( 433 , 97 , 25615 ) ;
  primitive ( 998 , 112 , 0 ) ;
  primitive ( 1010 , 112 , 1 ) ;
  primitive ( 1298 , 86 , 0 ) ;
  primitive ( 1299 , 86 , 1 ) ;
  primitive ( 273 , 113 , 0 ) ;
  primitive ( 274 , 113 , 1 ) ;
  primitive ( 275 , 113 , 2 ) ;
  primitive ( 1308 , 113 , 3 ) ;
  primitive ( 1309 , 65 , 1 ) ;
  primitive ( 1310 , 65 , 0 ) ;
  primitive ( 1311 , 63 , 0 ) ;
  primitive ( 1312 , 63 , 1 ) ;
  primitive ( 1318 , 62 , 27182 ) ;
  primitive ( 1319 , 62 , 27438 ) ;
  primitive ( 1320 , 23 , 0 ) ;
  primitive ( 1321 , 23 , 1 ) ;
  primitive ( 1322 , 23 , 2 ) ;
  primitive ( 1323 , 23 , 3 ) ;
  ...
  primitive ( 1371 , 64 , 2 ) ;
  primitive ( 1372 , 64 , 3 ) ;
  hash [15524 ].v.RH = 1372 ;
  eqtb [15524 ]= eqtb [curval ];
  primitive ( 1373 , 64 , 4 ) ;
  primitive ( 1374 , 64 , 5 ) ;
  primitive ( 1399 , 81 , 28525 ) ;
  primitive ( 439 , 89 , 0 ) ;
  primitive ( 1403 , 114 , 1 ) ;
  primitive ( 1404 , 114 , 0 ) ;
  primitive ( 1405 , 114 , 3 ) ;
  primitive ( 1406 , 114 , 2 ) ;
  primitive ( 1407 , 115 , 0 ) ;
  primitive ( 1408 , 115 , 1 ) ;
  primitive ( 1409 , 115 , 2 ) ;
  primitive ( 1422 , 77 , 0 ) ;
  primitive ( 1423 , 88 , 26660 ) ;
  primitive ( 1426 , 87 , 1 ) ;
  primitive ( 1427 , 87 , 2 ) ;
  nonewcontrolsequence = true ;
} 
...
mainbody ( void ) 
{
  ...
  if ( 65535L < 255 ) 
  bad = 19 ;
  if ( 536900483L + hashextra > 1073741823L ) 
  bad = 21 ;
  ...
  fprintf ( stdout , "%s%s%s",  "This is upTeX, Version 3.14159265" , "-p3.7.1" , "-u1.21"   ) ;
  else
  fprintf ( stdout , "%s%s%s",  "This is upTeX, Version 3.14159265" , "-p3.7.1" ,   "-u1.21" ) ;
  Fputs ( stdout ,  " (" ) ;
