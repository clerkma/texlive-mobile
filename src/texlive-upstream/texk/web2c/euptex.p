...
{:937}{942:}hyphpointer=0..65535;{:942}{1429:}savepointer=0..savesize;
{:1429}var{13:}bad:integer;{:13}{20:}xord:array[ASCIIcode]of ASCIIcode;
...
xeqlevel:array[29188..30310]of quarterword;{:259}{262:}hash:^twohalves;
...
{:1364}{1403:}eTeXmode:0..1;etexp:boolean;
{:1403}{1411:}eofseen:^boolean;{:1411}{1456:}revdisp:scaled;
LRptr:halfword;LRproblems:integer;curdir:smallnumber;
{:1456}{1505:}pseudofiles:halfword;{:1505}{1528:}grpstack:^savepointer;
ifstack:^halfword;{:1528}{1569:}maxregnum:halfword;
maxreghelpline:strnumber;{:1569}{1571:}saroot:array[0..6]of halfword;
curptr:halfword;sanull:memoryword;{:1571}{1590:}sachain:halfword;
salevel:quarterword;{:1590}{1597:}lastlinefill:halfword;
dolastlinefit:boolean;activenodesize:smallnumber;
fillwidth:array[0..3]of scaled;bestplshort:array[0..3]of scaled;
bestplglue:array[0..3]of scaled;{:1597}{1613:}hyphstart:triepointer;
hyphindex:triepointer;{:1613}{1614:}discptr:array[1..3]of halfword;
{:1614}{1622:}editnamestart:poolpointer;editnamelength,editline:integer;
ipcon:cinttype;stopatspace:boolean;{:1622}{1624:}savestrptr:strnumber;
savepoolptr:poolpointer;shellenabledp:cinttype;restrictedshell:cinttype;
outputcomment:^char;k,l:0..255;{:1624}{1626:}debugformatfile:boolean;
{:1626}{1634:}mltexp:boolean;{:1634}{1635:}mltexenabledp:boolean;
{:1635}{1640:}accentc,basec,replacec:integer;iac,ibc:fourquarters;
baseslant,accentslant:real;basexheight:scaled;
basewidth,baseheight:scaled;accentwidth,accentheight:scaled;
delta:scaled;{:1640}{1648:}synctexoption:integer;
{:1648}{1653:}synctexoffset:integer;
{:1653}{1695:}inhibitglueflag:boolean;{:1695}{1711:}dvidir:integer;
curdirhv:integer;pagedir:eightbits;{:1711}{1714:}firstchar:halfword;
lastchar:halfword;findfirstchar:boolean;
{:1714}{1739:}isprintutf8:boolean;{:1739}{1742:}curpagewidth:scaled;
curpageheight:scaled;pdflastxpos:integer;pdflastypos:integer;
{:1742}{1748:}isprintutf8:boolean;lasttokensstring:strnumber;
{:1748}procedure initialize;var{19:}i:integer;{:19}{169:}k:integer;
...
{:221}{260:}for k:=29188 to 30310 do xeqlevel[k]:=1;
...
{:1362}{1457:}LRptr:=-1073741823;LRproblems:=0;curdir:=0;
{:1457}{1506:}pseudofiles:=-1073741823;
{:1506}{1572:}saroot[6]:=-1073741823;sanull.hh.lh:=-1073741823;
sanull.hh.rh:=-1073741823;{:1572}{1591:}sachain:=-1073741823;salevel:=0;
{:1591}{1615:}discptr[2]:=-1073741823;discptr[3]:=-1073741823;
{:1615}{1623:}editnamestart:=0;stopatspace:=true;
{:1623}{1627:}ifdef('TEXMF_DEBUG')debugformatfile:=true;
endif('TEXMF_DEBUG');{:1627}{1636:}mltexenabledp:=false;
{:1636}{1696:}inhibitglueflag:=false;{:1696}{1712:}pagedir:=4;
{:1712}ifdef('INITEX')if iniversion then begin{170:}for k:=membot+1 to
...
end;for k:=0 to 511 do begin eqtb[26618+k].hh.rh:=18;end;
...
eqtb[26750].hh.rh:=19;eqtb[26761].hh.rh:=19;eqtb[26762].hh.rh:=19;
eqtb[26767].hh.rh:=16;eqtb[26846].hh.rh:=17;
for k:=253 to 257 do eqtb[26618+k].hh.rh:=16;eqtb[27128].hh.rh:=17;
...
{:238}{246:}for k:=29188 to 29517 do eqtb[k].int:=0;
eqtb[29248].int:=256;eqtb[29249].int:=-1;eqtb[29205].int:=1000;
eqtb[29189].int:=10000;eqtb[29229].int:=1;eqtb[29228].int:=25;
eqtb[29234].int:=92;eqtb[29237].int:=13;
for k:=0 to 255 do begin eqtb[29518+k].int:=-1;
setintone(eqtb[29518+k],-1);end;eqtb[29564].int:=0;
setintone(eqtb[29564],0);
{:246}{256:}for k:=29774 to 30310 do eqtb[k].int:=0;
{:256}{265:}hashused:=15514;hashhigh:=0;cscount:=0;
eqtb[15523].hh.b0:=132;primused:=2100;hash[15523].rh:=542;
eqtb[15525].hh.b0:=43;eqtb[15525].hh.rh:=1;eqtb[15525].hh.b1:=1;
hash[15525].rh:=543;{:265}{569:}{:569}{698:}eqtb[29245].int:=1000;
eqtb[29246].int:=700;eqtb[29247].int:=500;
{:698}{963:}for k:=-trieopsize to trieopsize do trieophash[k]:=0;
for k:=0 to 255 do trieused[k]:=mintrieop;maxopused:=mintrieop;
trieopptr:=0;{:963}{968:}trienotready:=true;
{:968}{1234:}hash[15514].rh:=1321;
{:1234}{1320:}if iniversion then formatident:=1397;
{:1320}{1388:}hash[15522].rh:=1441;eqtb[15522].hh.b1:=1;
eqtb[15522].hh.b0:=129;eqtb[15522].hh.rh:=-1073741823;
{:1388}{1404:}eTeXmode:=0;{1567:}maxregnum:=255;maxreghelpline:=754;
{:1567}{:1404}{1573:}for i:=0 to 5 do saroot[i]:=-1073741823;
{:1573}{1609:}{:1609}end;endif('INITEX'){:8}{1654:}synctexoffset:=29251;
{:1654}end;{58:}procedure println;var ii:integer;
...
begin if p<514 then if p>=257 then if p=513 then begin printesc(546);
printesc(547);printchar(32);end else begin printesc(p-257);
if eqtb[26362+p-257].hh.rh=11 then printchar(32);
end else if p<1 then printesc(548)else print(p-1)else if((p>=24527)and(p
<=30310))or(p>eqtbtop)then printesc(548)else if(hash[p].rh>=strptr)then
printesc(549)else begin printesc(hash[p].rh);printchar(32);end;end;
{:272}{273:}procedure sprintcs(p:halfword);
begin if p<514 then if p<257 then print(p-1)else if p<513 then printesc(
p-257)else begin printesc(546);printesc(547);
...
{:1374}{1577:}procedure printsanum(q:halfword);var n:halfword;
...
{:1577}{1625:}procedure printcsnames(hstart:integer;hfinish:integer);
var c,h:integer;
...
{:1625}{1628:}procedure printfileline;var level:0..maxinopen;
begin level:=inopen;
...
print(622);end;end;{:1628}{1732:}procedure printdir(dir:eightbits);
...
var x:boolean;begin x:=false;case abs(d)of 4:begin print(1606);x:=true;
end;3:begin print(1607);x:=true;end;1:begin print(1608);x:=true;end;end;
if x then begin if d<0 then print(1609);print(1610);end;end;
procedure printdirection(d:integer);begin case abs(d)of 4:print(1168);
3:print(1167);1:print(1169);end;if d<0 then print(1609);print(1610);end;
{:1732}{1738:}procedure printkanji(s:KANJIcode);
...
end;{:1738}{79:}procedure normalizeselector;forward;procedure gettoken;
...
{:47}{48:}{1632:}function searchstring(search:strnumber):strnumber;
...
{:1632}{1633:}function slowmakestring:strnumber;label 10;
...
{:1633}ifdef('INITEX')function getstringsstarted:boolean;label 30,10;
...
if(m<16)and(c>256)then printesc(608)else{304:}case m of 16,17,18,19:
...
end;14:if c=0 then print(609);others:printesc(608)end{:304};end{:303};
...
printnl(624);p:=defref;end;3:begin printnl(625);p:=memtop-3;end;
4:begin printnl(626);p:=memtop-4;end;5:begin printnl(627);p:=defref;end;
...
endif('STAT'){1658:}if s>=4 then begin mem[r+s-2].int:=curinput.
synctextagfield;mem[r+s-1].int:=line;end;{:1658};getnode:=r;10:end;
...
541);printint(q);printchar(41);end;end{:261};
{295:}if saveptr>0 then for q:=0 to saveptr-1 do begin if savestack[q].
hh.rh=p then begin printnl(600);printint(q);printchar(41);end;end{:295};
{950:}for q:=0 to hyphsize do begin if hyphlist[q]=p then begin printnl(
1041);printint(q);printchar(41);end;end{:950};end;
endif('TEXMF_DEBUG'){1740:}procedure pdferror(t,p:strnumber);
begin normalizeselector;begin if interaction=3 then;
if filelineerrorstylep then printfileline else printnl(264);print(1611);
end;if t<>0 then begin print(286);print(t);print(41);end;print(622);
print(p);begin if interaction=3 then interaction:=2;
if logopened then error;
ifdef('TEXMF_DEBUG')if interaction>0 then debughelp;
endif('TEXMF_DEBUG')history:=3;jumpout;end;end;
{:1740}{1750:}function tokenstostring(p:halfword):strnumber;
begin if selector=21 then pdferror(1612,1613);oldsetting:=selector;
...
end;end;{:1750}{:178}{180:}procedure shortdisplay(p:integer);
var n:integer;
...
print(959);end else showinfo;others:end;decr(poolptr);end;end;
{:709}{711:}procedure printstyle(c:integer);
begin case c div 2 of 0:printesc(960);1:printesc(961);2:printesc(962);
3:printesc(963);others:print(964)end;end;
...
if(eTeXmode=1)then{1455:}if(mem[p].hh.b0=0)and(((mem[p].hh.b1)div 8)=2)
then print(1517){:1455};
...
10:{1375:}case mem[p].hh.b1 of 0:begin printwritewhatsit(1428,p);
printchar(61);
printfilename(mem[p+1].hh.rh,mem[p+2].hh.lh,mem[p+2].hh.rh);end;
1:begin printwritewhatsit(649,p);printmark(mem[p+1].hh.rh);end;
2:printwritewhatsit(1429,p);3:begin printesc(1430);
printmark(mem[p+1].hh.rh);end;4:begin printesc(1432);
printint(mem[p+1].hh.rh);print(1437);printint(mem[p+1].hh.b0);
printchar(44);printint(mem[p+1].hh.b1);printchar(41);end;
6:printesc(1434);others:print(1438)end{:1375};5:begin printesc(322);
...
{707:}16:printstyle(mem[p].hh.b1);17:{712:}begin printesc(573);
...
b0 of 18:printesc(965);19:printesc(966);20:printesc(967);
21:printesc(968);22:printesc(969);23:printesc(970);24:printesc(971);
25:printesc(972);29:printesc(973);28:printesc(974);31:printesc(589);
26:begin printesc(582);printdelimiter(p+5);end;30:begin printesc(550);
printfamandchar(p+5,1);end;32:begin printesc(975);printdelimiter(p+1);
end;33:begin if mem[p].hh.b1=0 then printesc(976)else printesc(977);
printdelimiter(p+1);end;end;
if mem[p].hh.b0<32 then begin if mem[p].hh.b1<>0 then if mem[p].hh.b1=1
then printesc(978)else printesc(979);printsubsidiarydata(p+1,46);end;
printsubsidiarydata(p+2,94);printsubsidiarydata(p+3,95);end{:713};
27:{714:}begin printesc(980);
if mem[p+1].int=1073741824 then print(981)else printscaled(mem[p+1].int)
;
if(mem[p+5].qqqq.b0<>0)or(mem[p+5].qqqq.b1<>0)or(mem[p+5].qqqq.b2<>0)or(
mem[p+5].qqqq.b3<>0)then begin print(982);printdelimiter(p+5);end;
if(mem[p+4].qqqq.b0<>0)or(mem[p+4].qqqq.b1<>0)or(mem[p+4].qqqq.b2<>0)or(
mem[p+4].qqqq.b3<>0)then begin print(983);printdelimiter(p+4);end;
...
2,4:freenode(p,2);6:freenode(p,2);others:confusion(1440)end;goto 30;
end{:1377};
...
begin r:=getnode(10);{1677:}mem[r+8].int:=mem[p+8].int;
mem[r+9].int:=mem[p+9].int;{:1677};mem[r+7]:=mem[p+7];
...
3:begin r:=getnode(6);words:=4;{1678:}{:1678};end;4:begin r:=getnode(6);
...
others:confusion(1439)end{:1376};12:begin r:=getnode(4);
incr(mem[mem[p+1].hh.lh].hh.rh);{1679:}mem[r+2].int:=mem[p+2].int;
mem[r+3].int:=mem[p+3].int;{:1679};mem[r+1].hh.lh:=mem[p+1].hh.lh;
...
if p=0 then begin{1003:}if memtop-2<>pagetail then begin printnl(1083);
if outputactive then print(1084);showbox(mem[memtop-2].hh.rh);
if pagecontents>0 then begin printnl(1085);printtotals;printnl(1086);
printscaled(pagesofar[0]);r:=mem[memtop].hh.rh;
while r<>memtop do begin println;printesc(336);t:=mem[r].hh.b1;
printint(t);print(1087);
if eqtb[29262+t].int=1000 then t:=mem[r+3].int else t:=xovern(mem[r+3].
int,1000)*eqtb[29262+t].int;printscaled(t);
if mem[r].hh.b0=1 then begin q:=memtop-2;t:=0;repeat q:=mem[q].hh.rh;
if(mem[q].hh.b0=4)and(mem[q].hh.b1=mem[r].hh.b1)then incr(t);
until q=mem[r+1].hh.lh;print(1088);printint(t);print(1089);end;
...
56:printesc(498);57:printesc(499);58:printesc(500);59:printesc(501);
51:printesc(502);52:printesc(503);53:printesc(504);54:printesc(505);
55:printesc(506);60:printesc(507);61:printesc(508);62:printesc(509);
{1651:}63:printesc(1567);{:1651}{1410:}64:printesc(1464);
65:printesc(1465);66:printesc(1466);67:printesc(1467);68:printesc(1468);
69:printesc(1469);70:printesc(1470);71:printesc(1471);72:printesc(1472);
{:1410}{1451:}73:printesc(1512);{:1451}others:print(510)end;end;
{:243}{251:}procedure begindiagnostic;begin oldsetting:=selector;
...
begin case n of 0:printesc(513);1:printesc(514);2:printesc(515);
3:printesc(516);4:printesc(517);5:printesc(518);6:printesc(519);
7:printesc(520);8:printesc(521);9:printesc(522);10:printesc(523);
11:printesc(524);12:printesc(525);13:printesc(526);14:printesc(527);
15:printesc(528);16:printesc(529);17:printesc(530);18:printesc(531);
19:printesc(532);21:printesc(533);22:printesc(534);20:printesc(535);
23:printesc(536);24:printesc(537);others:print(538)end;end;
{:253}{258:}{308:}procedure printcmdchr(cmd:quarterword;
chrcode:halfword);var n:integer;begin case cmd of 1:begin print(610);
print(chrcode);end;2:begin print(611);print(chrcode);end;
3:begin print(612);print(chrcode);end;6:begin print(613);print(chrcode);
end;7:begin print(614);print(chrcode);end;8:begin print(615);
print(chrcode);end;9:print(616);10:begin print(617);print(chrcode);end;
11:begin print(618);print(chrcode);end;12:begin print(619);
print(chrcode);end;16,17,18,19:begin print(620);printkanji(chrcode);end;
...
25069:printesc(427);{1409:}25071:printesc(1463);
{:1409}others:printesc(428)end;
{:237}{245:}82:if chrcode<29262 then printparam(chrcode-29188)else begin
printesc(511);printint(chrcode-29262);end;
{:245}{255:}83:if chrcode<29799 then printlengthparam(chrcode-29774)else
begin printesc(539);printint(chrcode-29799);end;
{:255}{276:}49:printesc(550);104:printesc(551);44:printesc(552);
45:printesc(553);86:printesc(565);66:printesc(554);46:printesc(580);
20:printesc(555);123:printesc(546);100:printesc(562);101:printesc(563);
102:printesc(564);15:printesc(557);106:printesc(559);72:printesc(547);
67:printesc(560);69:printesc(32);
118:if chrcode=0 then printesc(561){1518:}else printesc(871){:1518};
36:printesc(566);40:printesc(567);
43:if chrcode=0 then printesc(568)else printesc(543);41:printesc(336);
48:printesc(47);54:printesc(556);22:begin printesc(361);
if chrcode>0 then printchar(115);end;50:printesc(569);21:printesc(570);
59:printesc(573);105:printesc(574);38:printesc(575);70:printesc(576);
119:if chrcode=0 then printesc(577)else printesc(543);60:printesc(341);
68:printesc(578);71:printesc(582);
110:if chrcode=0 then printesc(584){1515:}else printesc(1527){:1515};
0:printesc(585);112:printesc(586);92:printesc(581);
96:case chrcode of 25061:printesc(579);{1620:}25328:printesc(1560);
25329:printesc(1561);25330:printesc(1562);25331:printesc(1563);
{:1620}end;
125:if chrcode=0 then printesc(587){1438:}else if chrcode=1 then
printesc(1502)else printesc(1503){:1438};80:{1588:}begin printesc(429);
if chrcode<>membot then printsanum(chrcode);end{:1588};42:printesc(362);
37:if chrcode=0 then printesc(588){1453:}else case chrcode of 6:printesc
(1513);7:printesc(1514);10:printesc(1515);
others:printesc(1516)end{:1453};61:printesc(589);39:printesc(590);
{:276}{345:}13:printesc(652);
{:345}{394:}120:if chrcode=0 then printesc(690){1503:}else if chrcode=2
then printesc(1525){:1503}else printesc(691);
{:394}{402:}126:begin case(chrcode mod 5)of 1:printesc(693);
2:printesc(694);3:printesc(695);4:printesc(696);others:printesc(692)end;
if chrcode>=5 then printchar(115);end;
{:402}{429:}103:{1587:}begin if(chrcode<membot)or(chrcode>membot+23)then
cmd:=(mem[chrcode].hh.b0 div 16)else begin cmd:=chrcode-membot;
chrcode:=-1073741823;end;
if cmd=0 then printesc(511)else if cmd=1 then printesc(539)else if cmd=2
then printesc(417)else printesc(418);
if chrcode<>-1073741823 then printsanum(chrcode);end{:1587};
{:429}{434:}91:if chrcode=1 then printesc(735)else printesc(734);
94:if chrcode=0 then printesc(736){1444:}else if chrcode=2 then printesc
(1508){:1444}else printesc(737);
95:if chrcode=1 then printesc(738)else if chrcode=3 then printesc(739)
else printesc(740);77:case chrcode of 0:printesc(741);1:printesc(742);
2:printesc(743);5:printesc(744);{1401:}3:printesc(1456);
4:printesc(1457);10:printesc(1458);7:printesc(1459);8:printesc(1460);
9:printesc(1461);{:1401}{1415:}11:printesc(1487);12:printesc(1488);
{:1415}{1418:}13:printesc(1489);14:printesc(1490);15:printesc(1491);
{:1418}{1421:}18:printesc(1492);19:printesc(1493);20:printesc(1494);
21:printesc(1495);{:1421}{1424:}22:printesc(1496);23:printesc(1497);
24:printesc(1498);{:1424}{1534:}29:printesc(1536);30:printesc(1537);
31:printesc(1538);32:printesc(1539);{:1534}{1557:}16:printesc(1543);
17:printesc(1544);25:printesc(1545);26:printesc(1546);
{:1557}{1561:}27:printesc(1547);28:printesc(1548);
{:1561}others:printesc(745)end;
{:434}{486:}124:case chrcode of 0:printesc(806);1:printesc(807);
3:printesc(808);4:printesc(809);5:printesc(810);2:printesc(811);
6:printesc(812);7:printesc(813);8:printesc(814);9:printesc(815);
10:printesc(816);11:printesc(818);12:printesc(819);13:printesc(820);
14:printesc(821);15:printesc(822);16:printesc(823);17:printesc(824);
others:printesc(817)end;
{:486}{505:}121:begin if chrcode>=32 then printesc(871);
case chrcode mod 32 of 1:printesc(848);2:printesc(849);3:printesc(850);
4:printesc(851);5:printesc(852);6:printesc(853);7:printesc(854);
8:printesc(855);9:printesc(856);10:printesc(857);11:printesc(858);
12:printesc(859);13:printesc(860);14:printesc(861);15:printesc(862);
16:printesc(863);20:printesc(864);21:printesc(865);22:printesc(866);
23:printesc(867);24:printesc(868);25:printesc(869);26:printesc(870);
27:printesc(872);{1519:}17:printesc(1528);18:printesc(1529);
19:printesc(1530);{:1519}others:printesc(847)end;end;
{:505}{509:}122:if chrcode=2 then printesc(316)else if chrcode=4 then
printesc(873)else printesc(874);
{:509}{798:}4:if chrcode=256 then printesc(999)else begin print(1003);
print(chrcode);end;
5:if chrcode=257 then printesc(1000)else printesc(1001);
{:798}{1001:}93:case chrcode of 0:printesc(1071);1:printesc(1072);
2:printesc(1073);3:printesc(1074);4:printesc(1075);5:printesc(1076);
6:printesc(1077);7:printesc(1078);others:printesc(1079)end;
{:1001}{1071:}14:if chrcode=1 then printesc(1129)else printesc(349);
{:1071}{1077:}30:case chrcode of 5:printesc(1130);0:printesc(1131);
1:printesc(1132);2:printesc(1133);3:printesc(1134);
others:printesc(1135)end;31:case chrcode of 5:printesc(1136);
0:printesc(1137);1:printesc(1138);2:printesc(1139);3:printesc(1140);
others:printesc(1141)end;32:printesc(342);33:printesc(346);
34:printesc(348);
{:1077}{1090:}25:if chrcode=1 then printesc(1159)else printesc(1160);
26:if chrcode=1 then printesc(1161)else printesc(1162);
24:case chrcode of 0:printesc(431);1:printesc(1163);2:printesc(1164);
3:printesc(1066);4:printesc(1165);5:printesc(1068);
others:printesc(1166)end;79:case chrcode of 4:printesc(1168);
3:printesc(1167);1:printesc(1169);end;
35:if chrcode=100 then printesc(1171)else if chrcode=101 then printesc(
1172)else if chrcode=102 then printesc(1173)else printesc(1170);
{:1090}{1107:}47:if chrcode=0 then printesc(1201)else printesc(1200);
{:1107}{1126:}29:if chrcode=12 then printesc(1214)else if chrcode=13
then printesc(1213)else printesc(1212);
27:if chrcode=1 then printesc(1216)else printesc(1215);
28:if chrcode=1 then printesc(1218){1617:}else if chrcode=2 then
printesc(1558)else if chrcode=3 then printesc(1559){:1617}else printesc(
1217);{:1126}{1133:}51:if chrcode=1 then printesc(45)else printesc(359);
{:1133}{1161:}52:if chrcode=1 then printesc(1252)else printesc(1251);
{:1161}{1175:}55:case chrcode of 18:printesc(965);19:printesc(966);
20:printesc(967);21:printesc(968);22:printesc(969);23:printesc(970);
24:printesc(971);25:printesc(972);28:printesc(974);
others:printesc(973)end;
56:if chrcode=1 then printesc(978)else if chrcode=2 then printesc(979)
else printesc(1256);{:1175}{1188:}58:printstyle(chrcode);
{:1188}{1197:}57:case chrcode of 1:printesc(1275);2:printesc(1276);
3:printesc(1277);4:printesc(1278);5:printesc(1279);
others:printesc(1274)end;
{:1197}{1207:}53:if chrcode=32 then printesc(975){1449:}else if chrcode=
1 then printesc(977){:1449}else printesc(976);
{:1207}{1227:}107:if chrcode=1 then printesc(1299)else if chrcode=2 then
printesc(1300){1526:}else if chrcode=8 then printesc(1313){:1526}else
printesc(1301);
111:if chrcode=0 then printesc(1302)else if chrcode=1 then printesc(1303
)else if chrcode=2 then printesc(1304)else printesc(1305);
{:1227}{1238:}108:if chrcode<>0 then printesc(1323)else printesc(1322);
{:1238}{1241:}109:case chrcode of 0:printesc(1324);9:printesc(1325);
1:printesc(1326);2:printesc(1327);3:printesc(1328);4:printesc(1329);
5:printesc(1330);6:printesc(1331);8:printesc(1333);
others:printesc(1332)end;73:begin printesc(555);printhex(chrcode);end;
74:begin printesc(556);printhex(chrcode);end;75:begin printesc(570);
printhex(chrcode);end;76:begin printesc(572);printhex(chrcode);end;
...
chrcode=28676 then printesc(446)else if chrcode=28804 then printesc(1338
...
29518 then printesc(512)else printesc(1339);98:printsize(chrcode-25589);
{:1249}{1270:}113:if chrcode=1 then printesc(1054)else printesc(1042);
{:1270}{1274:}87:if chrcode=0 then printesc(1358)else printesc(1359);
{:1274}{1280:}99:begin print(1367);slowprint(fontname[chrcode]);
if fontsize[chrcode]<>fontdsize[chrcode]then begin print(832);
printscaled(fontsize[chrcode]);print(419);end;end;
{:1280}{1282:}114:case chrcode of 0:printesc(274);1:printesc(275);
2:printesc(276);others:printesc(1368)end;
{:1282}{1292:}65:if chrcode=0 then printesc(1370)else printesc(1369);
{:1292}{1297:}63:if chrcode=0 then printesc(1371)else printesc(1372);
{:1297}{1306:}62:if chrcode=27908 then printesc(1378)else printesc(1379)
;{:1306}{1311:}23:case chrcode of 1:printesc(1381);2:printesc(1382);
3:printesc(1383);{1427:}4:printesc(1499);{:1427}{1436:}5:printesc(1501);
{:1436}{1441:}6:printesc(1504);{:1441}7:printesc(1384);
others:printesc(1380)end;{:1311}{1314:}117:print(1391);
127,128,129,130:begin n:=cmd-127;
if mem[mem[chrcode].hh.rh].hh.lh=3585 then n:=n+4;
if odd(n div 4)then printesc(1313);if odd(n)then printesc(1299);
if odd(n div 2)then printesc(1300);if n>0 then printchar(32);
print(1392);end;131:printesc(1393);
{:1314}{1365:}64:case chrcode of 0:printesc(1428);1:printesc(649);
2:printesc(1429);3:printesc(1430);4:printesc(1431);5:printesc(1432);
6:printesc(1434);7:printesc(1433);others:print(1435)end;
{:1365}{1687:}90:printesc(442);
{:1687}{1692:}115:begin if(chrcode mod 2)=0 then printesc(1578)else
printesc(1579);if chrcode<2 then print(1580)else print(1581);end;
116:begin if chrcode=0 then printesc(1582)else if chrcode=1 then
printesc(1583)else printesc(1584);print(1585);end;
{:1692}{1699:}78:printesc(1590);89:printesc(1591);
{:1699}{1704:}88:case chrcode of 1:printesc(1594);2:printesc(1595);end;
{:1704}others:print(621)end;end;
{:308}ifdef('STAT')procedure showeqtb(n:halfword);
begin if n<1 then printchar(63)else if(n<24528)or((n>30310)and(n<=
...
end{:241}{:239}else if n<29774 then{248:}begin if n<29262 then
printparam(n-29188)else if n<29518 then begin printesc(511);
printint(n-29262);end else begin printesc(512);printint(n-29518);end;
printchar(61);printint(eqtb[n].int);
end{:248}else if n<30055 then{257:}begin if n<29799 then
printlengthparam(n-29774)else begin printesc(539);printint(n-29799);end;
printchar(61);printscaled(eqtb[n].int);print(419);
end{:257}else if n<=30310 then print(540)else printchar(63);end;
...
incr(hashhigh);hash[p].lh:=hashhigh+30310;p:=hashhigh+30310;
end else begin repeat if(hashused=514)then overflow(544,15000+hashextra)
...
begin if prim[p].rh>0 then begin repeat if(primused=1)then overflow(545,
...
endif('STAT'){:294}{1412:}procedure printgroup(e:boolean);label 10;
begin case curgroup of 0:begin print(1473);goto 10;end;
1,14:begin if curgroup=14 then print(1474);print(1475);end;
2,3:begin if curgroup=3 then print(1476);print(1166);end;4:print(1068);
5:print(1165);6,7:begin if curgroup=7 then print(1477);print(1478);end;
8:print(420);10:print(1479);11:print(336);12:print(589);
9,13,15,16:begin print(351);
if curgroup=13 then print(1480)else if curgroup=15 then print(1481)else
if curgroup=16 then print(1482);end;end;print(1483);printint(curlevel);
printchar(41);
if savestack[saveptr-1].int<>0 then begin if e then print(382)else print
(1484);printint(savestack[saveptr-1].int);end;10:end;
{:1412}{1413:}ifdef('STAT')procedure grouptrace(e:boolean);
begin begindiagnostic;printchar(123);
if e then print(1485)else print(1486);printgroup(e);printchar(125);
enddiagnostic(false);end;
endif('STAT'){:1413}{1511:}function pseudoinput:boolean;var p:halfword;
...
pseudoinput:=true;end;end;{:1511}{1512:}procedure pseudoclose;
...
freenode(p,mem[p].hh.lh);end;end;{:1512}{1529:}procedure groupwarning;
var i:0..maxinopen;w:boolean;begin baseptr:=inputptr;
inputstack[baseptr]:=curinput;i:=inopen;w:=false;
while(grpstack[i]=curboundary)and(i>0)do begin{1530:}if eqtb[29256].int>
0 then begin while(inputstack[baseptr].statefield=0)or(inputstack[
baseptr].indexfield>i)do decr(baseptr);
if inputstack[baseptr].namefield>17 then w:=true;end{:1530};
grpstack[i]:=savestack[saveptr].hh.rh;decr(i);end;
if w then begin printnl(1532);printgroup(true);print(1533);println;
if eqtb[29256].int>1 then showcontext;if history=0 then history:=1;end;
end;{:1529}{1531:}procedure ifwarning;var i:0..maxinopen;w:boolean;
begin baseptr:=inputptr;inputstack[baseptr]:=curinput;i:=inopen;
w:=false;
while ifstack[i]=condptr do begin{1530:}if eqtb[29256].int>0 then begin
...
end{:1530};ifstack[i]:=mem[condptr].hh.rh;decr(i);end;
if w then begin printnl(1532);printcmdchr(121,curif);
if ifline<>0 then begin print(1505);printint(ifline);end;print(1533);
println;if eqtb[29256].int>1 then showcontext;
if history=0 then history:=1;end;end;
{:1531}{1532:}procedure filewarning;var p:halfword;l:quarterword;
c:quarterword;i:integer;begin p:=saveptr;l:=curlevel;c:=curgroup;
saveptr:=curboundary;
while grpstack[inopen]<>saveptr do begin decr(curlevel);printnl(1534);
printgroup(true);print(1535);curgroup:=savestack[saveptr].hh.b1;
saveptr:=savestack[saveptr].hh.rh end;saveptr:=p;curlevel:=l;
curgroup:=c;p:=condptr;l:=iflimit;c:=curif;i:=ifline;
while ifstack[inopen]<>condptr do begin printnl(1534);
printcmdchr(121,curif);if iflimit=2 then printesc(874);
if ifline<>0 then begin print(1505);printint(ifline);end;print(1535);
...
if eqtb[29256].int>1 then showcontext;if history=0 then history:=1;end;
{:1532}{1576:}procedure deletesaref(q:halfword);label 10;var p:halfword;
...
{:1576}{1578:}ifdef('STAT')procedure showsa(p:halfword;s:strnumber);
...
enddiagnostic(false);end;
endif('STAT'){:1578}{1592:}procedure sasave(p:halfword);var q:halfword;
i:quarterword;
begin if curlevel<>salevel then begin if saveptr>maxsavestack then begin
maxsavestack:=saveptr;
if maxsavestack>savesize-7 then overflow(591,savesize);end;
...
incr(mem[p+1].hh.lh);end;{:1592}{1593:}procedure sadestroy(p:halfword);
...
{:1593}{1594:}procedure sadef(p:halfword;e:halfword);
begin incr(mem[p+1].hh.lh);
if mem[p+1].hh.rh=e then begin ifdef('STAT')if eqtb[29252].int>0 then
showsa(p,593);endif('STAT')sadestroy(p);
end else begin ifdef('STAT')if eqtb[29252].int>0 then showsa(p,594);
endif('STAT')if mem[p].hh.b1=curlevel then sadestroy(p)else sasave(p);
mem[p].hh.b1:=curlevel;mem[p+1].hh.rh:=e;
ifdef('STAT')if eqtb[29252].int>0 then showsa(p,595);endif('STAT')end;
deletesaref(p);end;procedure sawdef(p:halfword;w:integer);
begin incr(mem[p+1].hh.lh);
if mem[p+2].int=w then begin ifdef('STAT')if eqtb[29252].int>0 then
showsa(p,593);
endif('STAT')end else begin ifdef('STAT')if eqtb[29252].int>0 then
showsa(p,594);endif('STAT')if mem[p].hh.b1<>curlevel then sasave(p);
mem[p].hh.b1:=curlevel;mem[p+2].int:=w;
ifdef('STAT')if eqtb[29252].int>0 then showsa(p,595);endif('STAT')end;
deletesaref(p);end;{:1594}{1595:}procedure gsadef(p:halfword;
e:halfword);begin incr(mem[p+1].hh.lh);
ifdef('STAT')if eqtb[29252].int>0 then showsa(p,596);
endif('STAT')sadestroy(p);mem[p].hh.b1:=1;mem[p+1].hh.rh:=e;
ifdef('STAT')if eqtb[29252].int>0 then showsa(p,595);
endif('STAT')deletesaref(p);end;procedure gsawdef(p:halfword;w:integer);
begin incr(mem[p+1].hh.lh);
ifdef('STAT')if eqtb[29252].int>0 then showsa(p,596);
endif('STAT')mem[p].hh.b1:=1;mem[p+2].int:=w;
ifdef('STAT')if eqtb[29252].int>0 then showsa(p,595);
endif('STAT')deletesaref(p);end;{:1595}{1596:}procedure sarestore;
var p:halfword;begin repeat p:=mem[sachain+1].hh.lh;
if mem[p].hh.b1=1 then begin if mem[p].hh.b0>=32 then sadestroy(sachain)
;ifdef('STAT')if eqtb[29225].int>0 then showsa(p,598);
...
ifdef('STAT')if eqtb[29225].int>0 then showsa(p,599);endif('STAT')end;
...
{:1596}{:278}{284:}procedure newsavelevel(c:groupcode);
...
if curlevel=65535 then overflow(592,65535);curboundary:=saveptr;
curgroup:=c;ifdef('STAT')if eqtb[29253].int>0 then grouptrace(false);
...
{1589:}80,103:if(w.hh.rh<membot)or(w.hh.rh>membot+23)then deletesaref(w.
hh.rh);{:1589}others:end;end;{:285}{286:}procedure eqsave(p:halfword;
l:quarterword);
begin if saveptr>maxsavestack then begin maxsavestack:=saveptr;
if maxsavestack>savesize-7 then overflow(591,savesize);end;
...
ifdef('STAT')if eqtb[29252].int>0 then restoretrace(p,593);
endif('STAT')eqdestroy(eqtb[p]);goto 10;end;
ifdef('STAT')if eqtb[29252].int>0 then restoretrace(p,594);
...
ifdef('STAT')if eqtb[29252].int>0 then restoretrace(p,595);
...
29252].int>0 then restoretrace(p,593);endif('STAT')goto 10;end;
ifdef('STAT')if eqtb[29252].int>0 then restoretrace(p,594);
...
begin ifdef('STAT')if eqtb[29252].int>0 then restoretrace(p,593);
...
begin ifdef('STAT')if eqtb[29252].int>0 then restoretrace(p,596);
...
{293:}if(p<29188)or(p>30310)then if eqtb[p].hh.b1=1 then begin eqdestroy
(savestack[saveptr]);
ifdef('STAT')if eqtb[29225].int>0 then restoretrace(p,598);
endif('STAT')end else begin eqdestroy(eqtb[p]);
eqtb[p]:=savestack[saveptr];
ifdef('STAT')if eqtb[29225].int>0 then restoretrace(p,599);
...
restoretrace(p,598);endif('STAT')end{:293};end;end;
30:ifdef('STAT')if eqtb[29253].int>0 then grouptrace(true);
...
if(eTeXmode=1)then decr(saveptr){:292};end else confusion(597);end;
{:291}{298:}procedure preparemag;
begin if(magset>0)and(eqtb[29205].int<>magset)then begin begin if
interaction=3 then;
if filelineerrorstylep then printfileline else printnl(264);print(601);
end;printint(eqtb[29205].int);print(602);printnl(603);begin helpptr:=2;
helpline[1]:=604;helpline[0]:=605;end;interror(magset);
geqworddefine(29205,magset);end;
if(eqtb[29205].int<=0)or(eqtb[29205].int>32768)then begin begin if
interaction=3 then;
if filelineerrorstylep then printfileline else printnl(264);print(606);
end;begin helpptr:=1;helpline[0]:=607;end;interror(eqtb[29205].int);
...
print(622);shownmode:=curlist.modefield;end;printcmdchr(curcmd,curchr);
if eqtb[29254].int>0 then if curcmd>=121 then if curcmd<=122 then begin
print(622);if curcmd=122 then begin printcmdchr(121,curif);
printchar(32);n:=0;l:=ifline;end else begin n:=1;l:=line;end;p:=condptr;
while p<>-1073741823 do begin incr(n);p:=mem[p].hh.rh;end;print(623);
printint(n);printchar(41);if l<>0 then begin print(1505);printint(l);
...
if(curinput.namefield=0)then if baseptr=0 then printnl(628)else printnl(
629)else begin printnl(630);
if curinput.namefield=17 then printchar(42)else printint(curinput.
namefield-1);printchar(62);end else begin printnl(631);
...
end else begin{324:}case curinput.indexfield of 0:printnl(632);
1,2:printnl(633);
3:if curinput.locfield=-1073741823 then printnl(634)else printnl(635);
4:printnl(636);5:begin println;printcs(curinput.namefield);end;
6:printnl(637);7:printnl(638);8:printnl(639);9:printnl(640);
10:printnl(641);11:printnl(642);12:printnl(643);13:printnl(644);
14:printnl(645);15:printnl(646);16:printnl(647);
...
if inputptr=stacksize then overflow(648,stacksize);end;
...
printnl(344);case t of 14:printesc(361);16:printesc(649);
others:printcmdchr(81,t+25056)end;print(609);tokenshow(p);
...
alignstate:=0 else fatalerror(650);begin decr(inputptr);
...
begin if inopen=maxinopen then overflow(651,maxinopen);
...
{1661:}curinput.synctextagfield:=0;{:1661};end;
...
if filelineerrorstylep then printfileline else printnl(264);print(659);
end else begin curcs:=0;begin if interaction=3 then;
if filelineerrorstylep then printfileline else printnl(264);print(660);
end;end;{349:}p:=getavail;case scannerstatus of 2:begin print(666);
mem[p].hh.lh:=637;end;3:begin print(667);mem[p].hh.lh:=partoken;
longstate:=129;end;4:begin print(668);mem[p].hh.lh:=637;q:=p;
p:=getavail;mem[p].hh.rh:=q;mem[p].hh.lh:=536886426;
alignstate:=-1000000;end;5:begin print(669);mem[p].hh.lh:=637;end;end;
begintokenlist(p,4){:349};print(661);sprintcs(warningindex);
begin helpptr:=4;helpline[3]:=662;helpline[2]:=663;helpline[1]:=664;
helpline[0]:=665;end;error;
end{:348}else begin begin if interaction=3 then;
if filelineerrorstylep then printfileline else printnl(264);print(653);
end;printcmdchr(121,curif);print(654);printint(skipline);
begin helpptr:=3;helpline[2]:=655;helpline[1]:=656;helpline[0]:=657;end;
if curcs<>0 then curcs:=0 else helpline[2]:=658;curtok:=536886429;
...
if filelineerrorstylep then printfileline else printnl(264);print(670);
end;begin helpptr:=2;helpline[1]:=671;helpline[0]:=672;end;
...
if forceeof then begin if eqtb[29256].int>0 then if(grpstack[inopen]<>
...
if curinput.limitfield=curinput.startfield then printnl(673);println;
first:=curinput.startfield;begin;print(42);terminput;end;
curinput.limitfield:=last;
if(eqtb[29237].int<0)or(eqtb[29237].int>255)then decr(curinput.
limitfield)else buffer[curinput.limitfield]:=eqtb[29237].int;
first:=curinput.limitfield+1;curinput.locfield:=curinput.startfield;
end else fatalerror(674);end{:372};
...
begin if(scannerstatus=4)or(curalign=-1073741823)then fatalerror(650);
...
first:=curinput.limitfield;begin;print(675);terminput;end;
...
print(711);end;sprintcs(warningindex);print(712);begin helpptr:=4;
helpline[3]:=713;helpline[2]:=714;helpline[1]:=715;helpline[0]:=716;end;
...
if filelineerrorstylep then printfileline else printnl(264);print(706);
end;sprintcs(warningindex);print(707);begin helpptr:=3;helpline[2]:=708;
helpline[1]:=709;helpline[0]:=710;end;backerror;end;
...
end;sprintcs(warningindex);print(699);begin helpptr:=6;helpline[5]:=700;
helpline[4]:=701;helpline[3]:=702;helpline[2]:=703;helpline[1]:=704;
helpline[0]:=705;end;incr(alignstate);longstate:=127;curtok:=partoken;
inserror;goto 22;
...
printint(n);print(717);showtokenlist(pstack[n-1],-1073741823,1000);
...
paramptr+n;if maxparamstack>paramsize then overflow(697,paramsize);end;
...
curinput.indexfield:=4;end;{:396}{1507:}procedure pseudostart;forward;
{:1507}{1565:}procedure scanregisternum;forward;
{:1565}{1570:}procedure newindex(i:quarterword;q:halfword);
...
{:1570}{1574:}procedure findsaelement(t:smallnumber;n:halfword;
...
50:{1575:}if t=6 then begin curptr:=getnode(4);mem[curptr+1]:=sanull;
...
mem[curptr].hh.b1:=1{:1575};mem[curptr].hh.rh:=q;
begin if odd(i)then mem[q+(i div 2)+1].hh.rh:=curptr else mem[q+(i div 2
)+1].hh.lh:=curptr;incr(mem[q].hh.b1);end;10:end;
{:1574}procedure passtext;forward;procedure startinput;forward;
...
if expanddepthcount>=expanddepth then overflow(676,expanddepth);
...
if curval=0 then curptr:=curmark[t]else{1579:}begin findsaelement(6,
curval,false);
if curptr<>-1073741823 then if odd(t)then curptr:=mem[curptr+(t div 2)+1
].hh.rh else curptr:=mem[curptr+(t div 2)+1].hh.lh;end{:1579};
...
end{:383}else{1520:}begin gettoken;
...
end;printesc(871);print(1531);printcmdchr(curcmd,curchr);printchar(39);
begin helpptr:=1;helpline[0]:=672;end;backerror;end{:1520};
...
end;begin helpptr:=2;helpline[1]:=678;helpline[0]:=679;end;backerror;
...
end;printesc(547);print(687);begin helpptr:=2;helpline[1]:=688;
helpline[0]:=689;end;backerror;end{:390};{391:}j:=first;p:=mem[r].hh.rh;
...
122:{527:}begin if eqtb[29254].int>0 then if eqtb[29224].int<=1 then
showcurcmdchr;
if curchr>iflimit then if iflimit=1 then insertrelax else begin begin if
interaction=3 then;
if filelineerrorstylep then printfileline else printnl(264);print(875);
end;printcmdchr(122,curchr);begin helpptr:=1;helpline[0]:=876;end;error;
...
120:{395:}if curchr=1 then forceeof:=true{1504:}else if curchr=2 then
pseudostart{:1504}else if nameinprogress then insertrelax else
...
end;begin helpptr:=5;helpline[4]:=681;helpline[3]:=682;helpline[2]:=683;
helpline[1]:=684;helpline[0]:=685;end;error;end{:387}end;
...
if filelineerrorstylep then printfileline else printnl(264);print(718);
end;begin helpptr:=4;helpline[3]:=719;helpline[2]:=720;helpline[1]:=721;
helpline[0]:=722;end;backerror;curtok:=379;curcmd:=1;curchr:=123;
...
end;begin helpptr:=1;helpline[0]:=724;end;error;end;
...
end;begin helpptr:=2;helpline[1]:=754;helpline[0]:=727;end;
...
end;begin helpptr:=2;helpline[1]:=756;helpline[0]:=727;end;
...
end;begin helpptr:=2;helpline[1]:=758;helpline[0]:=727;end;
interror(curval);curval:=0;end;end;procedure scanbigfourbitint;
begin scanint;
if(curval<0)or(curval>255)then begin begin if interaction=3 then;
if filelineerrorstylep then printfileline else printnl(264);print(757);
end;begin helpptr:=2;helpline[1]:=759;helpline[0]:=727;end;
...
end;begin helpptr:=2;helpline[1]:=761;helpline[0]:=727;end;
...
end;begin helpptr:=2;helpline[1]:=763;helpline[0]:=727;end;
interror(curval);curval:=0;end;
...
end;begin helpptr:=2;helpline[1]:=729;helpline[0]:=727;end;
...
if(curval<0)or(curval>134217727)then begin begin if interaction=3 then;
if filelineerrorstylep then printfileline else printnl(264);print(764);
end;begin helpptr:=2;helpline[1]:=765;helpline[0]:=727;end;
interror(curval);curval:=0;end;
iiii:=((curval div 65536)*256)+(curval mod 256);scanint;
if(curval<0)or(curval>16777215)then begin begin if interaction=3 then;
if filelineerrorstylep then printfileline else printnl(264);print(764);
end;begin helpptr:=2;helpline[1]:=766;helpline[0]:=727;end;
interror(curval);curval:=0;end;
curval1:=((curval div 65536)*256)+(curval mod 256);curval:=iiii;end;
{:454}{1566:}procedure scanregisternum;begin scanint;
if(curval<0)or(curval>maxregnum)then begin begin if interaction=3 then;
if filelineerrorstylep then printfileline else printnl(264);print(753);
end;begin helpptr:=2;helpline[1]:=maxreghelpline;helpline[0]:=727;end;
interror(curval);curval:=0;end;end;
{:1566}{1629:}procedure scanfourbitintor18;begin scanint;
if(curval<0)or((curval>15)and(curval<>18))then begin begin if
interaction=3 then;
if filelineerrorstylep then printfileline else printnl(264);print(757);
end;begin helpptr:=2;helpline[1]:=758;helpline[0]:=727;end;
interror(curval);curval:=0;end;end;
{:1629}{1433:}procedure scangeneraltext;forward;
{:1433}{1527:}procedure getxorprotected;label 10;
...
then goto 10;expand;end;10:end;{:1527}{1536:}procedure scanexpr;forward;
{:1536}{1541:}procedure scannormalglue;forward;procedure scanmuglue;
forward;{:1541}{1637:}function effectivechar(errp:boolean;
...
if c>=eqtb[29248].int then if c<=eqtb[29249].int then if(eqtb[28932+c].
...
printnl(923);print(1564);print(c);print(924);slowprint(fontname[f]);
printchar(33);enddiagnostic(false);result:=fontbc[f];end;
40:effectivechar:=result;end;{:1637}{594:}procedure scanfontident;
...
end;begin helpptr:=2;helpline[1]:=916;helpline[0]:=917;end;backerror;
...
repeat if fmemptr=fontmemsize then overflow(922,fontmemsize);
...
end;printesc(hash[15526+f].rh);print(918);printint(fontparams[f]);
print(919);begin helpptr:=2;helpline[1]:=920;helpline[0]:=921;end;error;
end{:596};end;{:595}{1681:}function getjfmpos(kcode:KANJIcode;
...
{:1681}{:426}{430:}{1690:}procedure printkansuji(n:integer);var k:0..23;
...
{:1690}{1700:}function getinhibitpos(c:KANJIcode;
...
{:1700}{1705:}function getkinsokupos(c:KANJIcode;
n:smallnumber):halfword;label 30,31;var p,s:halfword;
begin s:=calcpos(c);p:=s;ifdef('TEXMF_DEBUG')println;print(1596);
printint(c);print(1597);printint(s);if p+27642<0 then begin print(1598);
println;end;
...
{:1705}procedure scansomethinginternal(level:smallnumber;
...
case curcmd of 88:{1707:}begin scanint;q:=getkinsokupos(curval,1);
curvallevel:=0;curval:=0;
if(q<>1000)and(m=eqtb[27642+q].hh.b0)then begin curval:=eqtb[30055+q].
int;curvallevel:=0;end;end{:1707};89:{1702:}begin scanint;
q:=getinhibitpos(curval,1);curvallevel:=0;curval:=3;
if q<>1000 then curval:=eqtb[27386+q].hh.b0;end{:1702};
...
end;begin helpptr:=2;helpline[1]:=726;helpline[0]:=727;end;
...
end else if m=29518 then begin curval1:=eqtb[29518+curval].int;
curval:=getintone(eqtb[29518+curval]);
if((curval1 div 256)mod 256>=16)or(curval>=4096)then begin begin if
interaction=3 then;
if filelineerrorstylep then printfileline else printnl(264);print(728);
end;begin helpptr:=2;helpline[1]:=729;helpline[0]:=727;end;error;
begin curval:=0;curvallevel:=0;end;
end else begin curval:=curval1*4096+curval;curvallevel:=0;end;
end else if m=(29646)then begin begin curval:=-1;curvallevel:=0;end;
...
interaction=3 then;
if filelineerrorstylep then printfileline else printnl(264);print(730);
end;begin helpptr:=3;helpline[2]:=731;helpline[1]:=732;helpline[0]:=733;
...
print(746);end;printcmdchr(91,m);begin helpptr:=4;helpline[3]:=747;
helpline[2]:=748;helpline[1]:=749;helpline[0]:=750;end;error;
...
94:{436:}begin if m=0 then curval:=deadcycles{1445:}else if m=2 then
curval:=interaction{:1445}else curval:=insertpenalties;curvallevel:=0;
end{:436};
...
96:{440:}begin if m>25061 then{1621:}begin scanint;
...
end{:1621}else if eqtb[25061].hh.rh=-1073741823 then curval:=0 else
...
:=mem[curptr+1].hh.rh;
end else case curvallevel of 0:curval:=eqtb[29262+curval].int;
1:curval:=eqtb[29799+curval].int;2:curval:=eqtb[24549+curval].hh.rh;
3:curval:=eqtb[24805+curval].hh.rh;end;end;end{:444};
77:{441:}if m>=5 then if m>=27 then{1535:}begin if m<28 then begin case
m of{1562:}27:scanmuglue;{:1562}end;curvallevel:=2;
end else if m<29 then begin case m of{1563:}28:scannormalglue;
{:1563}end;curvallevel:=3;end else begin curvallevel:=m-29;scanexpr;end;
...
end{:1535}else if m>=18 then begin case m of{1422:}18,19,20,21:begin
...
20:curval:=fontinfo[depthbase[q]+(i.b1)mod 16].int;
21:curval:=fontinfo[italicbase[q]+(i.b2)div 4].int;end;
end else curval:=0;end;{:1422}{1425:}22,23,24:begin q:=curchr-22;
scanint;
...
curvallevel:=1;end;{:1425}{1559:}25,26:begin scannormalglue;q:=curval;
if m=25 then curval:=mem[q+2].int else curval:=mem[q+3].int;
deleteglueref(q);end;{:1559}end;curvallevel:=1;
end else begin case m of 5:curval:=line;6:curval:=lastbadness;
{1402:}10:curval:=2;7:curval:=pdflastxpos;8:curval:=pdflastypos;
9:begin if shellenabledp then begin if restrictedshell then curval:=2
else curval:=1;end else curval:=0;end;
{:1402}{1416:}11:curval:=curlevel-1;12:curval:=curgroup;
{:1416}{1419:}13:begin q:=condptr;curval:=0;
...
curval:=-1 else curval:=0;{:1419}{1558:}16,17:begin scannormalglue;
q:=curval;if m=16 then curval:=mem[q].hh.b0 else curval:=mem[q].hh.b1;
if curval>0 then curval:=curval-1;deleteglueref(q);end;{:1558}end;
curvallevel:=0;
...
if filelineerrorstylep then printfileline else printnl(264);print(751);
end;printcmdchr(curcmd,curchr);print(752);printesc(587);
begin helpptr:=1;helpline[0]:=750;end;error;
if level<>5 then begin curval:=0;curvallevel:=1;
...
end;begin helpptr:=2;helpline[1]:=768;helpline[0]:=769;end;curval:=48;
...
if filelineerrorstylep then printfileline else printnl(264);print(770);
...
savecurval:integer;{:467}{1682:}t:eightbits;{:1682}begin f:=0;
...
interaction=3 then;
if filelineerrorstylep then printfileline else printnl(264);print(774);
end;print(775);begin helpptr:=1;helpline[0]:=776;end;error;
...
if scankeyword(777)then v:=({575:}fontinfo[6+parambase[eqtb[25588].hh.rh
]].int{:575})else if scankeyword(778)then v:=({576:}fontinfo[5+parambase
[eqtb[25588].hh.rh]].int{:576})else if scankeyword(779)then{1683:}if
...
qqqq.b0].int{:1683}else if scankeyword(780)then{1684:}if curlist.
...
depthbase[eqtb[26357].hh.rh]+(t)mod 16].int;end{:1684}else goto 45;
...
interaction=3 then;
if filelineerrorstylep then printfileline else printnl(264);print(774);
end;print(781);begin helpptr:=4;helpline[3]:=782;helpline[2]:=783;
helpline[1]:=784;helpline[0]:=785;end;error;goto 88;end{:473};
if scankeyword(773)then{474:}begin preparemag;
...
{475:}if scankeyword(786)then begin num:=7227;denom:=100;
end else if scankeyword(787)then begin num:=12;denom:=1;
end else if scankeyword(788)then begin num:=7227;denom:=254;
end else if scankeyword(789)then begin num:=7227;denom:=2540;
end else if scankeyword(790)then begin num:=7227;denom:=7200;
end else if scankeyword(791)then begin num:=1238;denom:=1157;
end else if scankeyword(792)then begin num:=14856;denom:=1157;
end else if scankeyword(72)then begin num:=7227;denom:=10160;
end else if scankeyword(81)then begin num:=7227;denom:=10160;
end else if scankeyword(793)then goto 30 else{476:}begin begin if
interaction=3 then;
if filelineerrorstylep then printfileline else printnl(264);print(774);
end;print(794);begin helpptr:=6;helpline[5]:=795;helpline[4]:=796;
helpline[3]:=797;helpline[2]:=783;helpline[1]:=784;helpline[0]:=785;end;
...
end;begin helpptr:=2;helpline[1]:=799;helpline[0]:=800;end;error;
...
mem[q+1].int:=curval;
if scankeyword(801)then begin scandimen(mu,true,false);
mem[q+2].int:=curval;mem[q].hh.b0:=curorder;end;
if scankeyword(802)then begin scandimen(mu,true,false);
mem[q+3].int:=curval;mem[q].hh.b1:=curorder;end;curval:=q{:479};10:end;
{1537:}{1548:}function addorsub(x,y,maxanswer:integer;
...
{:1548}{1552:}function quotient(n,d:integer):integer;
...
{:1552}{1554:}function fract(x,n,d,maxanswer:integer):integer;
...
if x=0 then goto 40;if x<n then begin t:=x;x:=n;n:=t;end;{1555:}f:=0;
...
41:{:1555}if f>(maxanswer-a)then goto 88;a:=a+f;
40:if negative then a:=-a;goto 30;88:begin aritherror:=true;a:=0;end;
30:fract:=a;end;{:1554}procedure scanexpr;label 20,22,40;
...
{1538:}20:r:=0;e:=0;s:=0;t:=0;n:=0;22:if s=0 then o:=l else o:=0;
{1540:}{423:}repeat getxtoken;until curcmd<>10{:423};
if curtok=3112 then{1543:}begin q:=getnode(4);mem[q].hh.rh:=p;
mem[q].hh.b0:=l;mem[q].hh.b1:=4*s+r;mem[q+1].int:=e;mem[q+2].int:=t;
mem[q+3].int:=n;p:=q;l:=o;goto 20;end{:1543};backinput;
if o=0 then scanint else if o=1 then scandimen(false,false,false)else if
o=2 then scannormalglue else scanmuglue;f:=curval{:1540};
40:{1539:}{423:}repeat getxtoken;until curcmd<>10{:423};
...
if filelineerrorstylep then printfileline else printnl(264);print(1541);
end;begin helpptr:=1;helpline[0]:=1542;end;backerror;end;end{:1539};
aritherror:=b;
{1545:}if(l=0)or(s>2)then begin if(f>2147483647)or(f<-2147483647)then
...
deleteglueref(f);f:=newspec(membot);end;end{:1545};
case s of{1546:}0:if(l>=2)and(o<>0)then begin t:=newspec(f);
deleteglueref(f);if mem[t+2].int=0 then mem[t].hh.b0:=0;
if mem[t+3].int=0 then mem[t].hh.b1:=0;end else t:=f;
{:1546}{1550:}3:if o=4 then begin n:=f;o:=5;
...
{:1550}{1551:}4:if l<2 then t:=quotient(t,f)else begin mem[t+1].int:=
quotient(mem[t+1].int,f);mem[t+2].int:=quotient(mem[t+2].int,f);
mem[t+3].int:=quotient(mem[t+3].int,f);end;
{:1551}{1553:}5:if l=0 then t:=fract(t,n,f,2147483647)else if l=1 then t
...
mem[t+3].int:=fract(mem[t+3].int,n,f,1073741823);end;{:1553}end;
if o>2 then s:=o else{1547:}begin s:=0;
if r=0 then e:=t else if l=0 then e:=addorsub(e,t,2147483647,r=2)else if
l=1 then e:=addorsub(e,t,1073741823,r=2)else{1549:}begin mem[e+1].int:=
...
if mem[e+3].int=0 then mem[e].hh.b1:=0;end{:1549};r:=o;end{:1547};
b:=aritherror;if o<>0 then goto 22;
if p<>-1073741823 then{1544:}begin f:=e;q:=p;e:=mem[q+1].int;
t:=mem[q+2].int;n:=mem[q+3].int;s:=mem[q].hh.b1 div 4;
r:=mem[q].hh.b1 mod 4;l:=mem[q].hh.b0;p:=mem[q].hh.rh;freenode(q,4);
goto 40;end{:1544}{:1538};if b then begin begin if interaction=3 then;
if filelineerrorstylep then printfileline else printnl(264);print(1348);
end;begin helpptr:=2;helpline[1]:=1540;helpline[0]:=1350;end;error;
if l>=2 then begin deleteglueref(e);e:=membot;incr(mem[e].hh.rh);
end else e:=0;end;aritherror:=a;curval:=e;curvallevel:=l;end;
{:1537}{1542:}procedure scannormalglue;begin scanglue(2);end;
procedure scanmuglue;begin scanglue(3);end;
{:1542}{:478}{480:}function scanrulespec:halfword;label 21;
var q:halfword;begin q:=newrule;
if curcmd=39 then mem[q+1].int:=26214 else begin mem[q+3].int:=26214;
mem[q+2].int:=0;end;
21:if scankeyword(803)then begin scandimen(false,false,false);
mem[q+1].int:=curval;goto 21;end;
if scankeyword(804)then begin scandimen(false,false,false);
mem[q+3].int:=curval;goto 21;end;
if scankeyword(805)then begin scandimen(false,false,false);
mem[q+2].int:=curval;goto 21;end;scanrulespec:=q;end;
{:480}{481:}{1434:}procedure scangeneraltext;label 40;var s:0..5;
...
{:1434}{1508:}procedure pseudostart;var oldsetting:0..21;s:strnumber;
...
s:=makestring;{1509:}strpool[poolptr]:=32;l:=strstart[s];
...
pseudofiles:=p{:1509};begin decr(strptr);poolptr:=strstart[strptr];end;
{1510:}beginfilereading;line:=0;
curinput.limitfield:=curinput.startfield;
curinput.locfield:=curinput.limitfield+1;
if eqtb[29255].int>0 then begin if termoffset>maxprintline-3 then
println else if(termoffset>0)or(fileoffset>0)then printchar(32);
curinput.namefield:=19;print(1526);incr(openparens);fflush(stdout);
end else begin curinput.namefield:=18;
{1662:}curinput.synctextagfield:=0;{:1662};end{:1510};end;
{:1508}function strtoks(b:poolpointer):halfword;var p:halfword;
...
begin{1439:}if odd(curchr)then begin c:=curchr;scangeneraltext;
...
goto 10;end{:1439};getxtoken;scansomethinginternal(5,false);
...
bool:=scankeyword(825);scanpdfexttoks;
...
end;begin helpptr:=2;helpline[1]:=828;helpline[0]:=727;end;
interror(curval);curval:=0;end;end;i:=curval;curval:=0;
if(scankeyword(829))then begin scanint;
if(curval<0)then begin begin if interaction=3 then;
if filelineerrorstylep then printfileline else printnl(264);print(830);
end;begin helpptr:=2;helpline[1]:=831;helpline[0]:=727;end;
...
if fontsize[curval]<>fontdsize[curval]then begin print(832);
...
if filelineerrorstylep then printfileline else printnl(264);print(835);
end;begin helpptr:=1;helpline[0]:=836;end;error;end else begin incr(t);
if curtok<>t then begin begin if interaction=3 then;
if filelineerrorstylep then printfileline else printnl(264);print(837);
end;begin helpptr:=2;helpline[1]:=838;helpline[0]:=839;end;backerror;
...
if filelineerrorstylep then printfileline else printnl(264);print(718);
end;incr(alignstate);begin helpptr:=2;helpline[1]:=833;helpline[0]:=834;
...
interaction=3 then;
if filelineerrorstylep then printfileline else printnl(264);print(840);
end;sprintcs(warningindex);begin helpptr:=3;helpline[2]:=841;
helpline[1]:=842;helpline[0]:=843;end;backerror;curtok:=s;
...
terminput;end;n:=-1;
end else fatalerror(844){:501}else if readopen[m]=1 then{502:}if inputln
...
if filelineerrorstylep then printfileline else printnl(264);print(845);
end;printesc(584);begin helpptr:=1;helpline[0]:=846;end;
alignstate:=1000000;error;end;end;end{:503};curinput.limitfield:=last;
if(eqtb[29237].int<0)or(eqtb[29237].int>255)then decr(curinput.
limitfield)else buffer[curinput.limitfield]:=eqtb[29237].int;
first:=curinput.limitfield+1;curinput.locfield:=curinput.startfield;
curinput.statefield:=61;
{1516:}if j=1 then begin while curinput.locfield<=curinput.limitfield do
...
goto 30;end{:1516};while true do begin gettoken;
...
if eqtb[29254].int>0 then showcurcmdchr;end;
...
while true do begin if q=-1073741823 then confusion(847);
...
isunless:boolean;
begin if eqtb[29254].int>0 then if eqtb[29224].int<=1 then showcurcmdchr
...
end;printcmdchr(121,thisif);begin helpptr:=1;helpline[0]:=880;end;
backerror;r:=61;end;
...
14:b:=true;15:b:=false;{1521:}17:begin savescannerstatus:=scannerstatus;
scannerstatus:=0;getnext;b:=(curcmd<>117);
scannerstatus:=savescannerstatus;end;{:1521}{1522:}18:begin n:=getavail;
p:=n;repeat getxtoken;if curcs=0 then begin q:=getavail;mem[p].hh.rh:=q;
mem[q].hh.lh:=curtok;p:=q;end;until curcs<>0;
if curcmd<>72 then{390:}begin begin if interaction=3 then;
if filelineerrorstylep then printfileline else printnl(264);print(686);
end;printesc(547);print(687);begin helpptr:=2;helpline[1]:=688;
helpline[0]:=689;end;backerror;end{:390};{1523:}m:=first;
p:=mem[n].hh.rh;
...
curcs:=513 else curcs:=257+buffer[first]{:1523};flushlist(n);
b:=(eqtb[curcs].hh.b0<>117);end;{:1522}{1524:}19:begin scanfontident;
n:=curval;scancharnum;
if(fontbc[n]<=curval)and(fontec[n]>=curval)then b:=(fontinfo[charbase[n]
+curval].qqqq.b0>0)else b:=false;end;{:1524}16:{526:}begin scanint;
n:=curval;if eqtb[29224].int>1 then begin begindiagnostic;print(881);
...
if b then print(877)else print(878);enddiagnostic(false);end{:519};
...
begin if interaction=3 then;
if filelineerrorstylep then printfileline else printnl(264);print(875);
end;printesc(873);begin helpptr:=1;helpline[0]:=876;end;error;
...
if s=883 then begin if interaction=3 then;
if filelineerrorstylep then printfileline else printnl(264);print(884);
end else begin if interaction=3 then;
if filelineerrorstylep then printfileline else printnl(264);print(885);
end;printfilename(curname,curarea,curext);print(886);
if(e=887)or(e=344)then showcontext;println;
printcstring(promptfilenamehelpmsg);if(e<>344)then begin print(888);
print(e);print(39);end;print(41);println;printnl(889);print(s);
if interaction<2 then fatalerror(890);savedcurname:=curname;
savedcurext:=curext;savedcurarea:=curarea;;begin;print(622);terminput;
...
if jobname=0 then jobname:=getjobname(893);packjobname(894);
recorderchangefilename(stringcast(nameoffile+1));packjobname(895);
while not aopenout(logfile)do{552:}begin selector:=17;
promptfilename(897,895);end{:552};
...
then write(logfile,'This is e-upTeX, Version 3.14159265','-p3.7.1',
'-u1.21','-160201','-2.6')else write(logfile,
'This is e-upTeX, Version 3.14159265','-p3.7.1','-u1.21','-160201',
'-2.6');write(logfile,' (');
write(logfile,conststringcast(getencstring));write(logfile,')');
write(logfile,versionstring);slowprint(formatident);print(898);
printint(eqtb[29209].int);printchar(32);
...
printnl(896);l:=inputstack[0].limitfield;
...
fflush(stdout);curinput.statefield:=61;{1660:}synctexstartinput;{:1660};
{555:}begin line:=1;
...
{:554}{577:}{1638:}function effectivecharinfo(f:internalfontnumber;
...
{:1638}function readfontinfo(u:halfword;nom,aire:strnumber;
...
if s>=0 then begin print(832);printscaled(s);print(419);
end else if s<>-1000 then begin print(901);printint(-s);end;print(910);
begin helpptr:=4;helpline[3]:=911;helpline[2]:=912;helpline[1]:=913;
helpline[0]:=914;end;error;goto 30;end{:584};f:=fontptr+1;
...
if s>=0 then begin print(832);printscaled(s);print(419);
end else if s<>-1000 then begin print(901);printint(-s);end;
if fileopened then print(902)else if nametoolong then print(903)else
print(904);begin helpptr:=5;helpline[4]:=905;helpline[3]:=906;
helpline[2]:=907;helpline[1]:=908;helpline[0]:=909;end;error{:578};
...
begin begindiagnostic;printnl(923);
...
end end else print(c);print(924);slowprint(fontname[f]);printchar(33);
...
incr(dviptr);if dviptr=dvilimit then dviswap;end;
{1746:}if poolptr-strstart[strptr]<=10 then goto 30;k:=strstart[strptr];
...
if k=poolptr then goto 30 else if strpool[(k)]<>'t'then goto 30;{:1747};
incr(k);
if k=poolptr then goto 30 else if strpool[(k)]<>','then goto 30 else
incr(k);cw:=t;{1747:}s:=1;t:=0;bl:=true;
while(k<poolptr)and(bl)do begin if(strpool[(k)]>='0')and(strpool[(k)]<=
'9')then begin t:=10*t+strpool[(k)]-'0';incr(k);
end else begin bl:=false;end;end;t:=t*65536;
if k=poolptr then goto 30 else if strpool[(k)]='.'then begin incr(k);
...
if k=poolptr then goto 30 else if strpool[(k-1)]<>'p'then goto 30;
if k=poolptr then goto 30 else if strpool[(k)]<>'t'then goto 30;{:1747};
geqworddefine(29797,cw);geqworddefine(29798,t);curpageheight:=t;
curpagewidth:=cw;if(dvidir=3)or(dvidir=1)then begin t:=curpageheight;
curpageheight:=curpagewidth;curpagewidth:=t;end;{:1746};
...
end;begin helpptr:=2;helpline[1]:=1451;helpline[0]:=1117;end;error;
...
:=19;if not logopened then selector:=17;printnl(1442);
for d:=0 to(poolptr-strstart[strptr])-1 do begin print(strpool[strstart[
strptr]+d]);end;print(1443);
...
clobbered:=true;end;
if clobbered then print(1444)else begin runsystemret:=runsystem(
conststringcast(addressof(strpool[strstart[strptr]])));
if runsystemret=-1 then print(1445)else if runsystemret=0 then print(
1446)else if runsystemret=1 then print(1447)else if runsystemret=2 then
print(1448)end;end else begin print(1449);end;printchar(46);
...
if curext=344 then curext:=887;packfilename(curname,curarea,curext);
while not kpseoutnameok(stringcast(nameoffile+1))or not aopenout(
writefile[j])do promptfilename(1453,887);writeopen[j]:=true;
if logopened then begin oldsetting:=selector;
if(eqtb[29217].int<=0)then selector:=18 else selector:=19;printnl(1454);
printint(j);print(1455);printfilename(curname,curarea,curext);
print(886);printnl(344);println;selector:=oldsetting;end;end;end;
end{:1393};3:specialout(p);4:;
6:{1744:}begin case dvidir of 4:begin pdflastxpos:=curh;
...
case dvidir of 3,1:pdflastypos:=curpageheight-pdflastypos-4736286;
4:pdflastypos:=curpageheight-pdflastypos-4736286;end;end{:1744};
others:confusion(1452)end;end;
{:1392}{1470:}function newedge(s:smallnumber;w:scaled):halfword;
var p:halfword;begin p:=getnode(3);mem[p].hh.b0:=16;mem[p].hh.b1:=s;
mem[p+1].int:=w;mem[p+2].int:=0;newedge:=p;end;
{:1470}{1474:}function reverse(thisbox,t:halfword;var curg:scaled;
...
n:=-1073741823;
while true do begin while p<>-1073741823 do{1479:}21:if(p>=himemmin)then
...
until not(p>=himemmin)else{1480:}begin q:=mem[p].hh.rh;
case mem[p].hh.b0 of 0,1,3,13:rulewd:=mem[p+1].int;
{1481:}12:begin g:=mem[p+1].hh.lh;rulewd:=mem[g+1].int-curg;
...
{1450:}if(((gsign=1)and(mem[g].hh.b0=gorder))or((gsign=2)and(mem[g].hh.
...
end;end{:1450};end;{:1481}{1482:}8:begin flushnodelist(mem[p+1].hh.rh);
tempptr:=p;p:=getavail;mem[p]:=mem[tempptr+1];mem[p].hh.rh:=q;
freenode(tempptr,2);goto 21;end;
{:1482}{1483:}11:begin rulewd:=mem[p+1].int;
...
if m>-1073741823 then decr(m)else{1484:}begin freenode(p,4);
mem[t].hh.rh:=q;mem[t+1].int:=rulewd;mem[t+2].int:=-curh-rulewd;goto 30;
end{:1484};end;end else begin begin tempptr:=getavail;
...
{:1483}16:confusion(1522);5:begin disp2:=mem[p+1].int;
...
(p,4);p:=l;end;l:=p;p:=q;end{:1480}{:1479};
...
{:1474}{1475:}{[1476:]function newsegment(s:smallnumber;
...
[:1476][1478:]function haswhatsit(p:halfword):boolean;label 10;
...
[:1478]function reverse(thisbox,t:halfword;var curg:scaled;
...
begin gorder:=mem[thisbox+5].hh.b1;gsign:=mem[thisbox+5].hh.b0;
[1477:]begin end[:1477];l:=t;p:=tempptr;m:=-1073741823;n:=-1073741823;
while true do begin while p<>-1073741823 do[1479:]21:if(p>=himemmin)then
repeat f:=mem[p].hh.b0;c:=mem[p].hh.b1;
curh:=curh+fontinfo[widthbase[f]+fontinfo[charbase[f]+effectivechar(true
,f,c)].qqqq.b0].int;if fontdir[f]<>0 then begin q:=mem[p].hh.rh;la:=l;
...
if(t=-1073741823)and(m=-1073741823)and(n=-1073741823)then goto 30;
p:=newmath(0,mem[LRptr].hh.lh);LRproblems:=LRproblems+10000;end;
30:reverse:=l;end;}{:1475}{1713:}procedure synchdir;var tmp:scaled;
...
dvidir:=curdirhv;end;others:confusion(1604);end end;
{:1713}{1715:}function checkbox(boxp:halfword):boolean;label 30;
...
{:1715}{1716:}procedure adjusthlist(p:halfword;pf:boolean);label 10;
...
while p<>-1073741823 do begin if(p>=himemmin)then begin repeat{1717:}if
fontdir[mem[p].hh.b0]<>0 then begin cx:=mem[mem[p].hh.rh].hh.lh mod
16777216;if insertskip=1 then{1724:}begin begin x:=getinhibitpos(cx,1);
...
if insertskip=2 then{1725:}begin if(eqtb[27130+ax].hh.rh mod 2)=1 then
...
if doins then begin z:=newglue(s);mem[z].hh.b1:=17;
mem[z].hh.rh:=mem[q].hh.rh;mem[q].hh.rh:=z;q:=z;end;end{:1725};
if eqtb[27130+ax].hh.rh>=2 then insertskip:=1 else insertskip:=0;
end{:1717};q:=p;p:=mem[p].hh.rh;incr(i);
...
end else begin case mem[p].hh.b0 of 0:{1718:}begin findfirstchar:=true;
firstchar:=-1073741823;lastchar:=-1073741823;
if mem[p+4].int=0 then begin if checkbox(mem[p+5].hh.rh)then begin if
firstchar<>-1073741823 then{1719:}if mem[firstchar].hh.b0=11 then begin
ax:=48;
if insertskip=2 then{1725:}begin if(eqtb[27130+ax].hh.rh mod 2)=1 then
begin x:=getinhibitpos(cx,1);
if x<>1000 then if(eqtb[27386+x].hh.b0=0)or(eqtb[27386+x].hh.b0=2)then
...
if insertskip=1 then{1724:}begin begin x:=getinhibitpos(cx,1);
if x<>1000 then if(eqtb[27386+x].hh.b0=0)or(eqtb[27386+x].hh.b0=1)then
doins:=false else doins:=true else doins:=true;end;
if doins then begin z:=newglue(s);mem[z].hh.b1:=17;
mem[z].hh.rh:=mem[q].hh.rh;mem[q].hh.rh:=z;q:=z;end;
end{:1724}else if insertskip=2 then{1726:}begin z:=newglue(u);
mem[z].hh.b1:=16;mem[z].hh.rh:=mem[q].hh.rh;mem[q].hh.rh:=z;q:=z;
end{:1726};end else begin ax:=mem[firstchar].hh.b1;
if insertskip=2 then{1725:}begin if(eqtb[27130+ax].hh.rh mod 2)=1 then
begin x:=getinhibitpos(cx,1);
if x<>1000 then if(eqtb[27386+x].hh.b0=0)or(eqtb[27386+x].hh.b0=2)then
doins:=false else doins:=true else doins:=true;end else doins:=false;
if doins then begin z:=newglue(s);mem[z].hh.b1:=17;
mem[z].hh.rh:=mem[q].hh.rh;mem[q].hh.rh:=z;q:=z;end;end{:1725};end;
{:1719};
if lastchar<>-1073741823 then begin{1720:}if mem[lastchar].hh.b0=11 then
begin ax:=48;
if eqtb[27130+ax].hh.rh>=2 then insertskip:=1 else insertskip:=0;
...
begin{1727:}begin z:=newglue(u);mem[z].hh.b1:=16;
mem[z].hh.rh:=mem[p].hh.rh;mem[p].hh.rh:=z;p:=mem[z].hh.rh;q:=z;
end{:1727};p:=mem[p].hh.rh;end;end else begin ax:=mem[lastchar].hh.b1;
if eqtb[27130+ax].hh.rh>=2 then insertskip:=1 else insertskip:=0;end;
{:1720};end else insertskip:=0;end else insertskip:=0;
end else insertskip:=0;end{:1718};8:{1722:}begin t:=mem[p+1].hh.rh;
...
14,5:{1723:}begin if(mem[p].hh.rh>=himemmin)then begin q:=p;
p:=mem[p].hh.rh;
...
mem[z].hh.b1:=16;mem[z].hh.rh:=mem[q].hh.rh;mem[q].hh.rh:=z;q:=z;
end{:1726};p:=mem[p].hh.rh;insertskip:=2;
...
{1717:}if fontdir[mem[p].hh.b0]<>0 then begin cx:=mem[mem[p].hh.rh].hh.
lh mod 16777216;
if insertskip=1 then{1724:}begin begin x:=getinhibitpos(cx,1);
if x<>1000 then if(eqtb[27386+x].hh.b0=0)or(eqtb[27386+x].hh.b0=1)then
doins:=false else doins:=true else doins:=true;end;
...
11:{1721:}begin if(mem[p].hh.b1=0)and(insertskip=2)then begin ax:=48;
{1725:}begin if(eqtb[27130+ax].hh.rh mod 2)=1 then begin x:=
getinhibitpos(cx,1);
if x<>1000 then if(eqtb[27386+x].hh.b0=0)or(eqtb[27386+x].hh.b0=2)then
doins:=false else doins:=true else doins:=true;end else doins:=false;
if doins then begin z:=newglue(s);mem[z].hh.b1:=17;
...
if eqtb[27130+ax].hh.rh>=2 then insertskip:=1 else insertskip:=0;
end else insertskip:=0;end{:1721};6,7,4,10:;others:insertskip:=0;end;
...
if(v<>-1073741823)and pf and(i>5)then{1728:}begin q:=v;p:=mem[v].hh.rh;
if(v>=himemmin)and(fontdir[mem[v].hh.b0]<>0)then begin q:=p;
p:=mem[p].hh.rh;end;t:=q;s:=-1073741823;
{1729:}while(p<>-1073741823)do begin if(p>=himemmin)then begin if
fontdir[mem[p].hh.b0]<>0 then begin cx:=mem[mem[p].hh.rh].hh.lh mod
...
others:begin q:=p;s:=-1073741823;end;end;end;p:=mem[p].hh.rh;end{:1729};
...
mem[z].hh.rh:=mem[s].hh.rh;mem[s].hh.rh:=z;end;end;end;{:1728};10:end;
{:1716}{1730:}procedure dirout;var thisbox:halfword;
begin thisbox:=tempptr;tempptr:=mem[thisbox+5].hh.rh;
if(mem[tempptr].hh.b0<>0)and(mem[tempptr].hh.b0<>1)then confusion(1605);
...
{:1730}procedure hlistout;label 21,13,14,15,22,40;var baseline:scaled;
...
prevp:=thisbox+5;
{1465:}if(eTeXmode=1)then begin{1461:}begin tempptr:=getavail;
...
if(curdir=1)and(((mem[thisbox].hh.b1)div 8)<>1)then{1472:}begin saveh:=
...
mem[thisbox].hh.b1:=((mem[thisbox].hh.b1)mod 8)+8*(1);end{:1472};
end{:1465};leftedge:=curh;{1669:}synctexhlist(thisbox);{:1669};
...
goto 22;end;
if mltexenabledp then{1639:}begin{1641:}if c>=eqtb[29248].int then if c
<=eqtb[29249].int then if(eqtb[28932+c].hh.rh>0)then begin basec:=(eqtb[
...
printnl(1565);print(c);print(1335);print(accentc);print(32);
print(basec);print(924);slowprint(fontname[f]);printchar(33);
enddiagnostic(false);goto 22;end;begindiagnostic;printnl(923);
print(1564);print(c);print(924);slowprint(fontname[f]);printchar(33);
enddiagnostic(false);goto 22{:1641};
40:{1642:}if eqtb[29223].int>99 then begin begindiagnostic;
printnl(1566);print(c);print(1335);print(accentc);print(32);
print(basec);print(924);slowprint(fontname[f]);printchar(46);
enddiagnostic(false);end{:1642};
{1643:}basexheight:=fontinfo[5+parambase[f]].int;
...
{1672:}synctexcurrent;{:1672};chain:=false;
end else{639:}begin case mem[p].hh.b0 of 0,1,2:{640:}if mem[p+5].hh.rh=
-1073741823 then begin if mem[p].hh.b0<>2 then{1671:}if mem[p].hh.b0=1
then begin synctexvoidvlist(p,thisbox);
end else begin synctexvoidhlist(p,thisbox);end;{:1671};
...
if(eTeXmode=1)then{1450:}if(((gsign=1)and(mem[g].hh.b0=gorder))or((gsign
...
goto 13;end{:642};13:begin{1674:}synctexkern(p,thisbox);{:1674};
curh:=curh+mem[p+1].int;end;11:begin{1675:}synctexmath(p,thisbox);
{:1675};
{1467:}begin if(eTeXmode=1)then{1468:}begin if odd(mem[p].hh.b1)then if
...
mem[tempptr].hh.lh:=(4*(mem[p].hh.b1 div 4)+3);
mem[tempptr].hh.rh:=LRptr;LRptr:=tempptr;end;
if(mem[p].hh.b1 div 8)<>curdir then{1473:}begin saveh:=curh;
...
mem[p+2].int:=curh;curdir:=1-curdir;curh:=saveh;goto 21;end{:1473};end;
mem[p].hh.b0:=13;end{:1468};curh:=curh+mem[p+1].int;end{:1467};end;
8:{669:}begin mem[memtop-12]:=mem[p+1];
mem[memtop-12].hh.rh:=mem[p].hh.rh;p:=memtop-12;goto 21;end{:669};
{1471:}16:begin curh:=curh+mem[p+1].int;leftedge:=curh+mem[p+2].int;
curdir:=mem[p].hh.b1;end;{:1471}others:end;goto 15;
...
{1673:}synctexhorizontalruleorglue(p,thisbox);{:1673};end;15:prevp:=p;
p:=mem[p].hh.rh;end{:639}{:637};{1670:}synctextsilh(thisbox);{:1670};
{1466:}if(eTeXmode=1)then begin{1469:}begin while mem[LRptr].hh.lh<>0 do
...
begin tempptr:=LRptr;LRptr:=mem[tempptr].hh.rh;
begin mem[tempptr].hh.rh:=avail;avail:=tempptr;
ifdef('STAT')decr(dynused);endif('STAT')end;end;end{:1469};
if((mem[thisbox].hh.b1)div 8)=2 then curdir:=1;end{:1466};
...
{1667:}synctexvlist(thisbox);{:1667};curv:=curv-mem[thisbox+3].int;
topedge:=curv;
while p<>-1073741823 do{647:}begin if(p>=himemmin)then confusion(927)
else{648:}begin case mem[p].hh.b0 of 0,1,2:{649:}if mem[p+5].hh.rh=
-1073741823 then begin curv:=curv+mem[p+3].int;
if mem[p].hh.b0<>2 then{1671:}if mem[p].hh.b0=1 then begin
synctexvoidvlist(p,thisbox);end else begin synctexvoidhlist(p,thisbox);
end;{:1671};curv:=curv+mem[p+2].int;
...
{1668:}synctextsilv(thisbox);{:1668};prunemovements(saveloc);
...
begin{1665:}synctexsheet(eqtb[29205].int);{:1665};
begin if eqtb[29222].int>0 then begin printnl(344);println;print(928);
end;if termoffset>maxprintline-9 then println else if(termoffset>0)or(
fileoffset>0)then printchar(32);printchar(91);j:=9;
while(eqtb[29262+j].int=0)and(j>0)do decr(j);
for k:=0 to j do begin printint(eqtb[29262+k].int);
...
[p+3].int+mem[p+2].int+eqtb[29793].int>1073741823)or(mem[p+1].int+eqtb[
29792].int>1073741823)then begin begin if interaction=3 then;
if filelineerrorstylep then printfileline else printnl(264);print(932);
end;begin helpptr:=2;helpline[1]:=933;helpline[0]:=934;end;error;
if eqtb[29222].int<=0 then begin begindiagnostic;printnl(935);
showbox(p);enddiagnostic(true);end;goto 30;end;
if mem[p+3].int+mem[p+2].int+eqtb[29793].int>maxv then maxv:=mem[p+3].
int+mem[p+2].int+eqtb[29793].int;
if mem[p+1].int+eqtb[29792].int>maxh then maxh:=mem[p+1].int+eqtb[29792]
.int{:658};
{634:}{1745:}if eqtb[29798].int<>0 then curpageheight:=eqtb[29798].int
else if(mem[p].hh.b0=2)then begin if(((mem[mem[p+5].hh.rh].hh.b1)mod 8)=
3)or(((mem[mem[p+5].hh.rh].hh.b1)mod 8)=1)then curpageheight:=mem[p+1].
int+2*eqtb[29793].int+2*4736286 else curpageheight:=mem[p+3].int+mem[p+2
].int+2*eqtb[29793].int+2*4736286;
end else curpageheight:=mem[p+3].int+mem[p+2].int+2*eqtb[29793].int+2
*4736286;
if eqtb[29797].int<>0 then curpagewidth:=eqtb[29797].int else if(mem[p].
hh.b0=2)then begin if(((mem[mem[p+5].hh.rh].hh.b1)mod 8)=3)or(((mem[mem[
p+5].hh.rh].hh.b1)mod 8)=1)then curpagewidth:=mem[p+3].int+mem[p+2].int
+2*eqtb[29792].int+2*4736286 else curpagewidth:=mem[p+1].int+2*eqtb[
29792].int+2*4736286;
end else curpagewidth:=mem[p+1].int+2*eqtb[29792].int+2*4736286;{:1745};
dvih:=0;dviv:=0;curh:=eqtb[29792].int;dvif:=0;dvidir:=4;
curdirhv:=dvidir;
if outputfilename=0 then begin if jobname=0 then openlogfile;
packjobname(891);while not bopenout(dvifile)do promptfilename(892,891);
...
incr(dviptr);if dviptr=dvilimit then dviswap;end;
end else begin oldsetting:=selector;selector:=21;print(926);
...
end;for k:=0 to 9 do dvifour(eqtb[29262+k].int);dvifour(lastbop);
lastbop:=pageloc;curv:=mem[p+3].int+eqtb[29793].int;tempptr:=p;
...
if dviptr>(2147483647-dvioffset)then begin curs:=-2;fatalerror(925);end;
...
if(eTeXmode=1)then{1485:}begin if LRproblems>0 then begin{1464:}begin
println;printnl(1519);printint(LRproblems div 10000);print(1520);
printint(LRproblems mod 10000);print(1521);LRproblems:=0;end{:1464};
printchar(41);println;end;
if(LRptr<>-1073741823)or(curdir<>0)then confusion(1523);end{:1485};
if eqtb[29222].int<=0 then printchar(93);deadcycles:=0;fflush(stdout);
{656:}ifdef('STAT')if eqtb[29219].int>1 then begin printnl(929);
printint(varused);printchar(38);printint(dynused);printchar(59);end;
endif('STAT')flushnodelist(p);
ifdef('STAT')if eqtb[29219].int>1 then begin print(930);
printint(varused);printchar(38);printint(dynused);print(931);
printint(himemmin-lomemmax-1);println;end;endif('STAT'){:656};end;
{1666:}synctexteehs;{:1666};end;
...
if scankeyword(941)then speccode:=0 else if scankeyword(942)then
...
if(eqtb[29261].int>0)then{1461:}begin tempptr:=getavail;
mem[tempptr].hh.lh:=0;mem[tempptr].hh.rh:=LRptr;LRptr:=tempptr;
end{:1461};while p<>-1073741823 do{668:}begin 21:chain:=false;
...
if(eqtb[29261].int>0)then{1462:}if odd(mem[p].hh.b1)then if mem[LRptr].
...
mem[tempptr].hh.lh:=(4*(mem[p].hh.b1 div 4)+3);
mem[tempptr].hh.rh:=LRptr;LRptr:=tempptr;end{:1462};end;
8:{669:}begin mem[memtop-12]:=mem[p+1];
mem[memtop-12].hh.rh:=mem[p].hh.rh;p:=memtop-12;goto 21;end{:669};
...
if lastbadness>100 then printnl(943)else printnl(944);print(945);
...
{683:}if(-x-totalshrink[0]>eqtb[29782].int)or(eqtb[29214].int<100)then
begin if(eqtb[29790].int>0)and(-x-totalshrink[0]>eqtb[29782].int)then
begin while mem[q].hh.rh<>-1073741823 do q:=mem[q].hh.rh;
mem[q].hh.rh:=newrule;mem[mem[q].hh.rh+1].int:=eqtb[29790].int;end;
println;printnl(951);printscaled(-x-totalshrink[0]);print(952);goto 50;
end{:683};
end else if o=0 then if mem[r+5].hh.rh<>-1073741823 then{684:}begin
lastbadness:=badness(-x,totalshrink[0]);
if lastbadness>eqtb[29214].int then begin println;printnl(953);
printint(lastbadness);goto 50;end;end{:684};goto 10;end{:681}{:674};
50:{680:}if outputactive then print(946)else begin if packbeginline<>0
then begin if packbeginline>0 then print(947)else print(948);
printint(abs(packbeginline));print(949);end else print(950);
...
if(eqtb[29261].int>0)then{1463:}begin if mem[LRptr].hh.lh<>0 then begin
...
if LRproblems>0 then begin{1464:}begin println;printnl(1519);
printint(LRproblems div 10000);print(1520);
printint(LRproblems mod 10000);print(1521);LRproblems:=0;end{:1464};
goto 50;end;begin tempptr:=LRptr;LRptr:=mem[tempptr].hh.rh;
begin mem[tempptr].hh.rh:=avail;avail:=tempptr;
ifdef('STAT')decr(dynused);endif('STAT')end;end;
if LRptr<>-1073741823 then confusion(1518);end{:1463};hpack:=r;end;
...
while p<>-1073741823 do{686:}begin if(p>=himemmin)then confusion(954)
...
if lastbadness>100 then printnl(943)else printnl(944);print(955);
...
if(totalshrink[o]<-x)and(o=0)and(mem[r+5].hh.rh<>-1073741823)then begin
lastbadness:=1000000;mem[r+6].gr:=1.0;
{694:}if(-x-totalshrink[0]>eqtb[29783].int)or(eqtb[29215].int<100)then
begin println;printnl(956);printscaled(-x-totalshrink[0]);print(957);
goto 50;end{:694};
end else if o=0 then if mem[r+5].hh.rh<>-1073741823 then{695:}begin
lastbadness:=badness(-x,totalshrink[0]);
if lastbadness>eqtb[29215].int then begin println;printnl(958);
printint(lastbadness);goto 50;end;end{:695};goto 10;end{:693}{:689};
50:{692:}if outputactive then print(946)else begin if packbeginline<>0
then begin print(948);printint(abs(packbeginline));print(949);
end else print(950);printint(line);println;end;begindiagnostic;
...
if d<eqtb[29776].int then p:=newparamglue(0)else begin p:=newskipparam(1
...
mem[b+1].int:=eqtb[29785].int;end;
...
begin if curlist.dirfield=3 then d:=eqtb[29795].int else d:=eqtb[29796].
int;
if curstyle<4 then d:=xnoverd(d,eqtb[29245].int,1000)else if curstyle<6
then d:=xnoverd(d,eqtb[29246].int,1000)else d:=xnoverd(d,eqtb[29247].int
...
end;printsize(cursize);printchar(32);printint(mem[a].hh.b0);print(984);
print(curc);printchar(41);begin helpptr:=4;helpline[3]:=985;
helpline[2]:=986;helpline[1]:=987;helpline[0]:=988;end;error;
...
confusion(990)end else begin if mem[v].hh.b0<>1 then confusion(589)end;
...
,mem[q+4].hh.lh);mem[x+1].int:=mem[x+1].int+eqtb[29786].int;
...
curstyle mod 2),mem[q+4].hh.lh);
mem[x+1].int:=mem[x+1].int+eqtb[29786].int;
...
mem[y+1].int:=mem[y+1].int+eqtb[29786].int;
...
delta2:=delta1+delta1-eqtb[29784].int;
...
5:goto 81;{:747}others:confusion(989)end;
{771:}case mem[q+1].hh.rh of 1,5,6,7:{772:}begin fetch(q+1);
...
others:confusion(991)end;mem[q+1].int:=p;
...
goto 30;end;others:confusion(992)end{:778};
...
52:if curstyle<4 then x:=19 else x:=0;others:confusion(994)end;
...
if curcmd=9 then fatalerror(650);
...
then;if filelineerrorstylep then printfileline else printnl(264);
print(746);end;printesc(566);print(995);begin helpptr:=3;
helpline[2]:=996;helpline[1]:=997;helpline[0]:=998;end;error;flushmath;
end{:793};pushnest;
...
begin if interaction=3 then;
if filelineerrorstylep then printfileline else printnl(264);print(1004);
end;begin helpptr:=3;helpline[2]:=1005;helpline[1]:=1006;
helpline[0]:=1007;end;backerror;goto 31;
...
helpline[0]:=1009;end;error;goto 22;end;mem[p].hh.rh:=getavail;
...
begin if curalign=-1073741823 then confusion(1010);
q:=mem[curalign].hh.rh;if q=-1073741823 then confusion(1010);
if alignstate<500000 then fatalerror(650);p:=mem[q].hh.rh;
...
if filelineerrorstylep then printfileline else printnl(264);print(1011);
end;printesc(1000);begin helpptr:=3;helpline[2]:=1012;helpline[1]:=1013;
helpline[0]:=1014;end;mem[curalign+5].hh.lh:=257;error;end{:809};
...
if n>65535 then confusion(1015);q:=curspan;
...
begin if curgroup<>6 then confusion(1016);unsave;
if curgroup<>6 then confusion(1017);unsave;
if nest[nestptr-1].modefield=235 then o:=eqtb[29789].int else o:=0;
...
if curlist.modefield=-1 then begin rulesave:=eqtb[29790].int;
eqtb[29790].int:=0;z:=newnullbox;mem[z].hh.rh:=mem[memtop-8].hh.rh;
...
+0].int);eqtb[29790].int:=rulesave;deleteglueref(mem[z+7].hh.rh);
...
end;begin helpptr:=2;helpline[1]:=996;helpline[0]:=997;end;backerror;
...
begin if interaction=3 then;
if filelineerrorstylep then printfileline else printnl(264);print(1018);
end;begin helpptr:=5;helpline[4]:=1019;helpline[3]:=1020;
helpline[2]:=1021;helpline[1]:=1022;helpline[0]:=1023;end;error;end;
...
{:847}{1599:}g:scaled;
{:1599}begin{848:}if abs(pi)>=10000 then if pi>0 then goto 10 else pi:=
...
others:confusion(1024)end{:858};end;
...
others:confusion(1025)end{:859};s:=mem[s].hh.rh;end;
...
if dolastlinefit then{1606:}begin mem[q+3].int:=bestplshort[fitclass];
mem[q+4].int:=bestplglue[fitclass];end{:1606};mem[q].hh.rh:=r;
mem[prevr].hh.rh:=q;prevr:=q;
ifdef('STAT')if eqtb[29220].int>0 then{863:}begin printnl(1026);
printint(mem[passive].hh.lh);print(1027);printint(mem[q+1].hh.lh-1);
printchar(46);printint(fitclass);if breaktype=1 then printchar(45);
print(1028);printint(mem[q+2].int);
if dolastlinefit then{1607:}begin print(1556);printscaled(mem[q+3].int);
if curp=-1073741823 then print(1557)else print(1099);
printscaled(mem[q+4].int);end{:1607};print(1029);
...
dolastlinefit then begin if curp=-1073741823 then{1601:}begin if(mem[r+3
...
if eqtb[29258].int<1000 then g:=fract(g,eqtb[29258].int,1000,1073741823)
;if aritherror then if mem[r+3].int>0 then g:=1073741823 else g:=
-1073741823;if g>0 then{1602:}begin if g>shortfall then g:=shortfall;
...
goto 40;
end{:1602}else if g<0 then{1603:}begin if-g>curactivewidth[7]then g:=-
curactivewidth[7];b:=badness(-g,curactivewidth[7]);
if b>12 then fitclass:=3 else fitclass:=2;goto 40;end{:1603};
45:end{:1601};shortfall:=0;end;b:=0;fitclass:=2;
...
if dolastlinefit then{1604:}begin if curp=-1073741823 then shortfall:=0;
if shortfall>0 then g:=curactivewidth[2]else if shortfall<0 then g:=
curactivewidth[7]else g:=0;end{:1604};
...
if curp=-1073741823 then printesc(652)else if(mem[curp].hh.b0<>12)and(
not(curp>=himemmin))then begin if mem[curp].hh.b0=14 then printesc(580)
else if mem[curp].hh.b0=9 then printesc(359)else if mem[curp].hh.b0=13
then printesc(346)else printesc(351);end;print(1030);
if mem[r+1].hh.rh=-1073741823 then printchar(48)else printint(mem[mem[r
+1].hh.rh].hh.lh);print(1031);
if b>10000 then printchar(42)else printint(b);print(1032);printint(pi);
print(1033);if artificialdemerits then printchar(42)else printint(d);
...
if dolastlinefit then{1605:}begin bestplshort[fitclass]:=shortfall;
bestplglue[fitclass]:=g;end{:1605};
...
repeat{897:}if(eqtb[29261].int>0)then{1458:}begin q:=mem[memtop-3].hh.rh
...
.b0=11 then{1459:}if odd(mem[q].hh.b1)then begin if LRptr<>-1073741823
...
mem[tempptr].hh.rh:=LRptr;LRptr:=tempptr;end{:1459};q:=mem[q].hh.rh;end;
end{:1458};{898:}q:=mem[curp+1].hh.rh;discbreak:=false;
postdiscbreak:=false;
...
if(eqtb[29261].int>0)then{1459:}if odd(mem[q].hh.b1)then begin if LRptr
...
mem[tempptr].hh.lh:=(4*(mem[q].hh.b1 div 4)+3);
mem[tempptr].hh.rh:=LRptr;LRptr:=tempptr;end{:1459};end;
...
q:=r{:903};30:{:898};
if(eqtb[29261].int>0)then{1460:}if LRptr<>-1073741823 then begin s:=
...
end{:1460};{904:}r:=mem[q].hh.rh;mem[q].hh.rh:=-1073741823;
...
31;r:=q;
if mem[q].hh.b0=11 then if(eqtb[29261].int>0)then{1459:}if odd(mem[q].hh
...
1040);curlist.pgfield:=bestline-1;curlist.eTeXauxfield:=LRptr;end;
...
if l=0 then begin if trieopptr=trieopsize then overflow(1050,trieopsize)
;u:=trieused[curlang];
if u=maxtrieop then overflow(1051,maxtrieop-mintrieop);incr(trieopptr);
...
{971:}if triemax<h+256 then begin if triesize<=h+256 then overflow(1052,
...
if filelineerrorstylep then printfileline else printnl(264);print(1058);
end;begin helpptr:=1;helpline[0]:=1057;end;error;end;end;
...
1052,triesize);incr(trieptr);trier[trieptr]:=p;p:=trieptr;triel[p]:=0;
...
if filelineerrorstylep then printfileline else printnl(264);print(1059);
end;begin helpptr:=1;helpline[0]:=1057;end;error;end;trieo[q]:=v;
...
end;printesc(1054);begin helpptr:=1;helpline[0]:=1057;end;error;end end;
end;30:{:978};if eqtb[29260].int>0 then{1610:}begin c:=curlang;
firstchild:=false;p:=0;repeat q:=p;p:=trier[q];
until(p=0)or(c<=triec[p]);
if(p=0)or(c<triec[p])then{981:}begin if trieptr=triesize then overflow(
1052,triesize);incr(trieptr);trier[trieptr]:=p;p:=trieptr;triel[p]:=0;
if firstchild then triel[q]:=p else trier[q]:=p;triec[p]:=c;
trieo[p]:=mintrieop;end{:981};q:=p;{1611:}p:=triel[q];firstchild:=true;
for c:=0 to 255 do if(eqtb[27908+c].hh.rh>0)or((c=255)and firstchild)
then begin if p=0 then{981:}begin if trieptr=triesize then overflow(1052
...
if firstchild then triel[q]:=0 else trier[q]:=0{:1611};end{:1610};
end else begin begin if interaction=3 then;
if filelineerrorstylep then printfileline else printnl(264);print(1053);
end;printesc(1054);begin helpptr:=1;helpline[0]:=1055;end;error;
...
if trier[0]<>0 then{1612:}begin if triel[0]=0 then for p:=0 to 255 do
triemin[p]:=p+2;firstfit(trier[0]);triepack(trier[0]);
hyphstart:=triehash[trier[0]];end{:1612};
...
background[7]:=mem[q+3].int+mem[r+3].int;{1598:}dolastlinefit:=false;
activenodesize:=3;
if eqtb[29258].int>0 then begin q:=mem[lastlinefill+1].hh.lh;
...
end;end{:1598};{:844}{851:}minimumdemerits:=1073741823;
minimaldemerits[3]:=1073741823;minimaldemerits[2]:=1073741823;
minimaldemerits[1]:=1073741823;minimaldemerits[0]:=1073741823;
{:851}{865:}if eqtb[25061].hh.rh=-1073741823 then if eqtb[29791].int=0
then begin lastspecialline:=0;secondwidth:=eqtb[29777].int;
secondindent:=0;
end else{866:}begin lastspecialline:=abs(eqtb[29229].int);
if eqtb[29229].int<0 then begin firstwidth:=eqtb[29777].int-abs(eqtb[
29791].int);
if eqtb[29791].int>=0 then firstindent:=eqtb[29791].int else firstindent
:=0;secondwidth:=eqtb[29777].int;secondindent:=0;
end else begin firstwidth:=eqtb[29777].int;firstindent:=0;
secondwidth:=eqtb[29777].int-abs(eqtb[29791].int);
if eqtb[29791].int>=0 then secondindent:=eqtb[29791].int else
secondindent:=0;end;
...
begindiagnostic;printnl(1034);end;endif('STAT')secondpass:=false;
finalpass:=false;end else begin threshold:=eqtb[29189].int;
secondpass:=true;finalpass:=(eqtb[29794].int<=0);
...
if dolastlinefit then{1600:}begin mem[q+3].int:=0;mem[q+4].int:=0;
end{:1600};activewidth[1]:=background[1];activewidth[2]:=background[2];
...
5:;others:confusion(1038)end{:887};s:=mem[s].hh.rh;until s=-1073741823;
...
others:confusion(1039)end{:888};decr(r);s:=mem[s].hh.rh;end;prevp:=curp;
...
14:trybreak(mem[curp+1].int,0);5,6,4,7:;others:confusion(1037)end;
...
printnl(1035);endif('STAT')threshold:=eqtb[29189].int;secondpass:=true;
finalpass:=(eqtb[29794].int<=0);
end else begin ifdef('STAT')if eqtb[29220].int>0 then printnl(1036);
endif('STAT')background[2]:=background[2]+eqtb[29794].int;
finalpass:=true;end;end;
30:ifdef('STAT')if eqtb[29220].int>0 then begin enddiagnostic(true);
normalizeselector;end;
endif('STAT')if dolastlinefit then{1608:}if mem[bestbet+3].int=0 then
...
mem[q+2].int:=0;mem[lastlinefill+1].hh.lh:=q;end{:1608};{:880};
{893:}postlinebreak(d){:893};{882:}q:=mem[memtop-7].hh.rh;
while q<>memtop-7 do begin curp:=mem[q].hh.rh;
if mem[q].hh.b0=2 then freenode(q,8)else freenode(q,activenodesize);
q:=curp;end;q:=passive;while q<>-1073741823 do begin curp:=mem[q].hh.rh;
freenode(q,2);q:=curp;end{:882};packbeginline:=0;end;
{1407:}function eTeXenabled(b:boolean;j:quarterword;k:halfword):boolean;
...
end;printcmdchr(j,k);begin helpptr:=1;helpline[0]:=1462;end;error;end;
eTeXenabled:=b;end;{:1407}{1430:}procedure showsavegroups;
...
case curgroup of 1:begin incr(p);goto 42;end;2,3:s:=1166;4:s:=1068;
5:s:=1165;6:if a=0 then begin if m=-1 then s:=566 else s:=588;a:=1;
goto 41;end else begin if a=1 then print(1500)else printesc(1000);
if p>=a then p:=p-a;a:=0;goto 40;end;7:begin incr(p);a:=-1;
printesc(575);goto 42;end;8:begin printesc(420);goto 40;end;9:goto 42;
10,13:begin if curgroup=10 then printesc(359)else printesc(573);
for i:=1 to 3 do if i<=savestack[saveptr-2].int then print(959);goto 42;
end;
...
12:begin s:=589;goto 41;end;14:begin incr(p);printesc(554);goto 40;end;
...
16:begin if mem[nest[p+1].eTeXauxfield].hh.b0=32 then printesc(975)else
printesc(977);goto 40;end;end;{1432:}i:=savestack[saveptr-4].int;
...
(1301);i:=i-(65536);end;printesc(586);printint(i-1073741824);
printchar(61);end else printcmdchr(35,i-(1073872797)){:1432};
41:printesc(s);
{1431:}if savestack[saveptr-2].int<>0 then begin printchar(32);
if savestack[saveptr-3].int=0 then print(941)else print(942);
printscaled(savestack[saveptr-2].int);print(419);end{:1431};
42:printchar(123);40:printchar(41);decr(curlevel);
curgroup:=savestack[saveptr].hh.b1;
saveptr:=savestack[saveptr].hh.rh end;30:saveptr:=v;curlevel:=l;
curgroup:=c;end;{:1430}{1446:}procedure newinteraction;forward;
{:1446}{:832}{951:}procedure newhyphexceptions;label 21,10,40,45,46;
...
if filelineerrorstylep then printfileline else printnl(264);print(1046);
end;begin helpptr:=2;helpline[1]:=1047;helpline[0]:=1048;end;error;
...
do decr(hyphnext);
if(hyphcount=hyphsize)or(hyphnext=0)then overflow(1049,hyphsize);
...
if filelineerrorstylep then printfileline else printnl(264);print(746);
end;printesc(1042);print(1043);begin helpptr:=2;helpline[1]:=1044;
helpline[0]:=1045;end;error;end{:953}end;end{:952};10:end;
...
.hh.rh:=q;r:=q;end else flushnodelist(q);end;others:confusion(1060)end;
...
6,4:goto 45;others:confusion(1061)end{:990};
...
then;if filelineerrorstylep then printfileline else printnl(264);
print(1062);end;begin helpptr:=4;helpline[3]:=1063;helpline[2]:=1064;
helpline[1]:=1065;helpline[0]:=1023;end;error;r:=newspec(q);
...
{:987}{994:}{1580:}function domarks(a,l:smallnumber;q:halfword):boolean;
var i:smallnumber;
...
end else begin case a of{1581:}0:if mem[q+2].hh.rh<>-1073741823 then
begin deletetokenref(mem[q+2].hh.rh);mem[q+2].hh.rh:=-1073741823;
deletetokenref(mem[q+3].hh.lh);mem[q+3].hh.lh:=-1073741823;end;
{:1581}{1583:}1:if mem[q+2].hh.lh<>-1073741823 then begin if mem[q+1].hh
...
end;{:1583}{1584:}2:if(mem[q+1].hh.lh<>-1073741823)and(mem[q+1].hh.rh=
-1073741823)then begin mem[q+1].hh.rh:=mem[q+1].hh.lh;
incr(mem[mem[q+1].hh.lh].hh.lh);end;
{:1584}{1586:}ifdef('INITEX')3:for i:=0 to 4 do begin if odd(i)then
...
+1].hh.lh:=-1073741823;end;end;endif('INITEX'){:1586}end;
...
{:1580}function vsplit(n:halfword;h:scaled):halfword;label 10,30;
...
if filelineerrorstylep then printfileline else printnl(264);print(344);
end;printesc(1066);print(1067);printesc(1068);begin helpptr:=2;
helpline[1]:=1069;helpline[0]:=1070;end;error;vsplit:=-1073741823;
goto 10;end;flushnodelist(mem[v].hh.rh);mem[v].hh.rh:=-1073741823{:995};
q:=vertbreak(mem[v+5].hh.rh,h,eqtb[29780].int);{996:}p:=mem[v+5].hh.rh;
if p=q then mem[v+5].hh.rh:=-1073741823 else while true do begin if mem[
p].hh.b0=6 then if mem[p+1].hh.lh<>0 then{1582:}begin findsaelement(6,
mem[p+1].hh.lh,true);
...
end{:1582}else if curmark[3]=-1073741823 then begin curmark[3]:=mem[p+1]
...
p:=mem[p].hh.rh;end;30:{:996};q:=prunepagetop(q,eqtb[29259].int>0);
p:=mem[v+5].hh.rh;
...
q:=vpackage(p,h,0,eqtb[29780].int);
...
print(1080);end;if pagesofar[5]<>0 then begin print(317);
printscaled(pagesofar[5]);print(1081);end;
if pagesofar[6]<>0 then begin print(317);printscaled(pagesofar[6]);
print(1082);end;if pagesofar[7]<>0 then begin print(318);
printscaled(pagesofar[7]);end;end;
{:1002}{1004:}procedure freezepagespecs(s:smallnumber);
begin pagecontents:=s;pagesofar[0]:=eqtb[29778].int;
pagemaxdepth:=eqtb[29779].int;pagesofar[8]:=0;pagesofar[1]:=0;
...
interaction=3 then;
if filelineerrorstylep then printfileline else printnl(264);print(1092);
end;begin helpptr:=3;helpline[2]:=1093;helpline[1]:=1094;
helpline[0]:=1095;end;boxerror(n);end;end;
...
=3 then;if filelineerrorstylep then printfileline else printnl(264);
print(344);end;printesc(431);print(1108);begin helpptr:=2;
helpline[1]:=1109;helpline[0]:=1095;end;boxerror(255);end{:1032};
...
then;if filelineerrorstylep then printfileline else printnl(264);
print(1101);end;begin helpptr:=3;helpline[2]:=1093;helpline[1]:=1102;
helpline[0]:=1095;end;boxerror(n);eqtb[25332+n].hh.rh:=newnullbox;
...
end else if mem[p].hh.b0=6 then if mem[p+1].hh.lh<>0 then{1585:}begin
...
end{:1585}else{1033:}begin if curmark[1]=-1073741823 then begin curmark[
...
savevfuzz:=eqtb[29783].int;eqtb[29783].int:=1073741823;
...
pagedir;eqtb[29215].int:=savevbadness;eqtb[29783].int:=savevfuzz;
...
if filelineerrorstylep then printfileline else printnl(264);print(1110);
end;printint(deadcycles);print(1111);begin helpptr:=3;helpline[2]:=1112;
helpline[1]:=1113;helpline[0]:=1114;end;error;
...
if filelineerrorstylep then printfileline else printnl(264);print(1101);
end;begin helpptr:=3;helpline[2]:=1093;helpline[1]:=1102;
helpline[0]:=1095;end;
...
if eqtb[29262+n].int=1000 then h:=mem[r+3].int else h:=xovern(mem[r+3].
int,1000)*eqtb[29262+n].int;pagesofar[0]:=pagesofar[0]-h-mem[q+1].int;
pagesofar[2+mem[q].hh.b0]:=pagesofar[2+mem[q].hh.b0]+mem[q+2].int;
pagesofar[7]:=pagesofar[7]+mem[q+3].int;
if(mem[q].hh.b1<>0)and(mem[q+3].int<>0)then begin begin if interaction=3
then;if filelineerrorstylep then printfileline else printnl(264);
print(1103);end;printesc(417);printint(n);begin helpptr:=3;
helpline[2]:=1104;helpline[1]:=1105;helpline[0]:=1023;end;error;end;
end{:1026};
...
if eqtb[29262+n].int=1000 then h:=mem[p+3].int else h:=xovern(mem[p+3].
int,1000)*eqtb[29262+n].int;
if((h<=0)or(h<=delta))and(mem[p+3].int+mem[r+3].int<=eqtb[29799+n].int)
then begin pagesofar[0]:=pagesofar[0]-h;
mem[r+3].int:=mem[r+3].int+mem[p+3].int;
end else{1027:}begin if eqtb[29262+n].int<=0 then w:=1073741823 else
begin w:=pagesofar[0]-pagesofar[1]-pagesofar[8];
if eqtb[29262+n].int<>1000 then w:=xovern(w,eqtb[29262+n].int)*1000;end;
if w>eqtb[29799+n].int-mem[r+3].int then w:=eqtb[29799+n].int-mem[r+3].
...
printnl(1106);printint(n);print(1107);printscaled(w);printchar(44);
printscaled(bestheightplusdepth);print(1032);
...
endif('STAT')if eqtb[29262+n].int<>1000 then bestheightplusdepth:=xovern
(bestheightplusdepth,1000)*eqtb[29262+n].int;
...
end{:1027};end;goto 80;end{:1025};others:confusion(1096)end{:1017};
...
printnl(37);print(1028);printtotals;print(1099);
printscaled(pagesofar[0]);print(1031);
if b=1073741823 then printchar(42)else printint(b);print(1032);
printint(pi);print(1100);
...
if(mem[q].hh.b1<>0)and(mem[q+3].int<>0)then begin begin if interaction=3
then;if filelineerrorstylep then printfileline else printnl(264);
print(1097);end;begin helpptr:=4;helpline[3]:=1098;helpline[2]:=1064;
helpline[1]:=1065;helpline[0]:=1023;end;error;r:=newspec(q);
mem[r].hh.b1:=0;deleteglueref(q);mem[p+1].hh.lh:=r;q:=r;end;end;
...
mem[p].hh.rh:=-1073741823;
if eqtb[29259].int>0 then begin if discptr[2]=-1073741823 then discptr[2
...
if filelineerrorstylep then printfileline else printnl(264);print(1122);
end;begin helpptr:=2;helpline[1]:=1123;helpline[0]:=1124;end;inserror;
...
begin helpptr:=4;helpline[3]:=1125;helpline[2]:=1126;helpline[1]:=1127;
helpline[0]:=1128;end;error;end;
...
curlist.tailfield:=mem[curlist.tailfield].hh.rh;end;
mem[curlist.tailfield+1].int:=eqtb[29777].int;
...
if filelineerrorstylep then printfileline else printnl(264);print(875);
end;printcmdchr(curcmd,curchr);begin helpptr:=1;helpline[0]:=1148;end;
...
printesc(560);end;15:begin mem[p].hh.lh:=804;printchar(36);end;
16:begin mem[p].hh.lh:=536886428;mem[p].hh.rh:=getavail;p:=mem[p].hh.rh;
mem[p].hh.lh:=3118;printesc(1147);end;others:begin mem[p].hh.lh:=637;
printchar(125);end end{:1083};print(687);
begintokenlist(mem[memtop-3].hh.rh,4);begin helpptr:=5;
helpline[4]:=1142;helpline[3]:=1143;helpline[2]:=1144;helpline[1]:=1145;
helpline[0]:=1146;end;error;end;end;
{:1082}{1087:}procedure extrarightbrace;
begin begin if interaction=3 then;
if filelineerrorstylep then printfileline else printnl(264);print(1153);
end;case curgroup of 14:printesc(560);15:printchar(36);16:printesc(976);
end;begin helpptr:=5;helpline[4]:=1154;helpline[3]:=1155;
helpline[2]:=1156;helpline[1]:=1157;helpline[0]:=1158;end;error;
incr(alignstate);end;{:1087}{1088:}procedure normalparagraph;
begin if eqtb[29207].int<>0 then eqworddefine(29207,0);
if eqtb[29791].int<>0 then eqworddefine(29791,0);
...
if filelineerrorstylep then printfileline else printnl(264);print(1181);
end;begin helpptr:=3;helpline[2]:=1182;helpline[1]:=1183;
helpline[0]:=1184;end;backerror;flushnodelist(curbox);end;
...
helpline[0]:=1190;end;error;
end else if(curlist.modefield=1)and(curlist.headfield=curlist.tailfield)
then begin youcant;begin helpptr:=2;helpline[1]:=1191;helpline[0]:=1192;
...
11 then gm:=1 else confusion(1187);end else confusion(1188);end;
if gm=0 then if fm=2 then confusion(1185)else if fm=1 then confusion(
1189);if(fm+fd)=1 then begin fm:=0;fd:=0;end;if gm=0 then fm:=0;
...
if not scankeyword(941)then begin begin if interaction=3 then;
if filelineerrorstylep then printfileline else printnl(264);print(1193);
end;begin helpptr:=2;helpline[1]:=1194;helpline[0]:=1195;end;error;end;
...
if filelineerrorstylep then printfileline else printnl(264);print(1196);
end;begin helpptr:=3;helpline[2]:=1197;helpline[1]:=1198;
helpline[0]:=1199;end;backerror;end;end;
{:1102}{1104:}procedure package(c:smallnumber);var h:scaled;p:halfword;
d:scaled;begin d:=eqtb[29781].int;deleteglueref(curkanjiskip);
deleteglueref(curxkanjiskip);
...
begin if interaction=3 then;
if filelineerrorstylep then printfileline else printnl(264);print(751);
end;printesc(567);print(1202);begin helpptr:=2;helpline[1]:=1203;
helpline[0]:=1204;end;error;end else begin backinput;curtok:=partoken;
...
if filelineerrorstylep then printfileline else printnl(264);print(1205);
end;printesc(336);printint(255);begin helpptr:=1;helpline[0]:=1206;end;
...
youcant;begin helpptr:=2;helpline[1]:=1191;helpline[0]:=1209;end;
if curchr=13 then helpline[0]:=(1210)else if curchr<>12 then helpline[0]
:=(1211);error;end;end{:1124}else begin tx:=curlist.tailfield;
if not(tx>=himemmin)then if mem[tx].hh.b0=5 then tx:=curlist.pnodefield;
if not(tx>=himemmin)then if(mem[tx].hh.b0=5)or((mem[tx].hh.b0=11)and(mem
[tx].hh.b1=3))then begin r:=curlist.headfield;
q:=mem[curlist.headfield].hh.rh;
...
disp:scaled;
begin if curchr>1 then{1618:}begin mem[curlist.tailfield].hh.rh:=discptr
[curchr];discptr[curchr]:=-1073741823;goto 30;end{:1618};c:=curchr;
scanregisternum;
if curval<256 then p:=eqtb[25332+curval].hh.rh else begin findsaelement(
4,curval,false);
if curptr=-1073741823 then p:=-1073741823 else p:=mem[curptr+1].hh.rh;
...
begin if interaction=3 then;
if filelineerrorstylep then printfileline else printnl(264);print(1219);
end;begin helpptr:=3;helpline[2]:=1220;helpline[1]:=1221;
helpline[0]:=1222;end;error;goto 10;end;
case((mem[p].hh.b1)mod 8)of 4,3,1:if abs(curlist.dirfield)<>((mem[p].hh.
b1)mod 8)then begin begin if interaction=3 then;
if filelineerrorstylep then printfileline else printnl(264);print(1223);
end;begin helpptr:=2;helpline[1]:=1220;helpline[0]:=1224;end;error;
...
end;begin helpptr:=1;helpline[0]:=1232;end;error;begindiagnostic;
printnl(1233);showbox(p);enddiagnostic(true);flushnodelist(p);
...
end;printesc(359);begin helpptr:=2;helpline[1]:=1226;helpline[0]:=1227;
...
end;begin helpptr:=2;helpline[1]:=1229;helpline[0]:=1230;end;error;end;
...
fontdir[f]=4 then disp:=eqtb[29795].int-eqtb[29796].int else disp:=eqtb[
29795].int end else begin if fontdir[f]=4 then disp:=0 else if fontdir[f
]=3 then disp:=eqtb[29796].int-eqtb[29795].int else disp:=eqtb[29796].
int end;{1735:}begin if not(curlist.tailfield>=himemmin)and(mem[curlist.
...
curlist.pdispfield:=disp;end;end;{:1735};
...
curlist.tailfield:=p;
{1736:}if disp<>0 then begin if not(curlist.tailfield>=himemmin)and(mem[
curlist.tailfield].hh.b0=5)then begin mem[curlist.tailfield+1].int:=0;
end else begin curlist.pnodefield:=curlist.tailfield;
begin mem[curlist.tailfield].hh.rh:=getnode(2);
curlist.tailfield:=mem[curlist.tailfield].hh.rh;end;
mem[curlist.tailfield].hh.b0:=5;mem[curlist.tailfield+1].int:=0;
curlist.pdispfield:=disp;end;end;{:1736};curlist.auxfield.hh.lh:=1000;
end;end;{:1141}{1145:}procedure alignerror;
begin if abs(alignstate)>2 then{1146:}begin begin if interaction=3 then;
if filelineerrorstylep then printfileline else printnl(264);print(1238);
end;printcmdchr(curcmd,curchr);
if curtok=1062 then begin begin helpptr:=6;helpline[5]:=1239;
helpline[4]:=1240;helpline[3]:=1241;helpline[2]:=1242;helpline[1]:=1243;
helpline[0]:=1244;end;end else begin begin helpptr:=5;helpline[4]:=1239;
helpline[3]:=1245;helpline[2]:=1242;helpline[1]:=1243;helpline[0]:=1244;
...
if filelineerrorstylep then printfileline else printnl(264);print(1234);
end;decr(alignstate);curtok:=637;end;begin helpptr:=3;helpline[2]:=1235;
helpline[1]:=1236;helpline[0]:=1237;end;inserror;end;end;
{:1145}{1147:}procedure noalignerror;begin begin if interaction=3 then;
if filelineerrorstylep then printfileline else printnl(264);print(1238);
end;printesc(575);begin helpptr:=2;helpline[1]:=1246;helpline[0]:=1247;
end;error;end;procedure omiterror;begin begin if interaction=3 then;
if filelineerrorstylep then printfileline else printnl(264);print(1238);
end;printesc(578);begin helpptr:=2;helpline[1]:=1248;helpline[0]:=1247;
...
-1073741823)or(inputstack[baseptr].statefield<>0)then fatalerror(650);
...
if filelineerrorstylep then printfileline else printnl(264);print(875);
end;printesc(547);begin helpptr:=1;helpline[0]:=1250;end;error;end;
{:1153}{1154:}procedure pushmath(c:groupcode);begin pushnest;
curlist.modefield:=-235;curlist.auxfield.int:=-1073741823;
newsavelevel(c);end;
{:1154}{1156:}{1488:}procedure justcopy(p,h,t:halfword);label 40,45;
...
:=getnode(10);{1677:}mem[r+8].int:=mem[p+8].int;
mem[r+9].int:=mem[p+9].int;{:1677};mem[r+7]:=mem[p+7];
mem[r+6]:=mem[p+6];mem[r+5]:=mem[p+5];incr(mem[mem[r+7].hh.rh].hh.rh);
...
q:=mem[p].hh.rh;
if mem[p].hh.b0=11 then{1494:}if odd(mem[p].hh.b1)then if mem[LRptr].hh.
...
end{:1494};mem[p].hh.rh:=l;l:=p;end;goto 30;mem[t+1].int:=mem[p+1].int;
mem[t].hh.rh:=q;freenode(p,2);30:mem[memtop-3].hh.rh:=l;end;
{:1493}procedure initmath;label 21,40,45,30;var w:scaled;j:halfword;
...
w:=-1073741823;
if curlist.headfield=curlist.tailfield then{1487:}begin popnest;
{1486:}if curlist.eTeXauxfield=-1073741823 then x:=0 else if mem[curlist
.eTeXauxfield].hh.lh>=8 then x:=-1 else x:=1{:1486};
end{:1487}else begin adjusthlist(curlist.headfield,true);
linebreak(true);
{1164:}{1489:}if(eTeXmode=1)then{1495:}begin if eqtb[24536].hh.rh=membot
...
8:{669:}begin mem[memtop-12]:=mem[p+1];
mem[memtop-12].hh.rh:=mem[p].hh.rh;p:=memtop-12;goto 21;end{:669};
13:d:=mem[p+1].int;{1491:}11:begin d:=mem[p+1].int;
if(eqtb[29261].int>0)then{1492:}if odd(mem[p].hh.b1)then begin if mem[
...
end;end{:1492}else if mem[p].hh.b1>=4 then begin w:=1073741823;goto 30;
end;end;16:begin d:=mem[p+1].int;curdir:=mem[p].hh.b1;end;
{:1491}12:{1166:}begin q:=mem[p+1].hh.lh;d:=mem[q+1].int;
...
30:{1490:}if(eqtb[29261].int>0)then begin while LRptr<>-1073741823 do
begin tempptr:=LRptr;LRptr:=mem[tempptr].hh.rh;
begin mem[tempptr].hh.rh:=avail;avail:=tempptr;
ifdef('STAT')decr(dynused);endif('STAT')end;end;
if LRproblems<>0 then begin w:=1073741823;LRproblems:=0;end;end;
curdir:=0;flushnodelist(mem[memtop-3].hh.rh){:1490}{:1164};end;
{1167:}if eqtb[25061].hh.rh=-1073741823 then if(eqtb[29791].int<>0)and((
(eqtb[29229].int>=0)and(curlist.pgfield+2>eqtb[29229].int))or(curlist.
pgfield+1<-eqtb[29229].int))then begin l:=eqtb[29777].int-abs(eqtb[29791
].int);if eqtb[29791].int>0 then s:=eqtb[29791].int else s:=0;
end else begin l:=eqtb[29777].int;s:=0;
...
eqworddefine(29787,w);curlist.eTeXauxfield:=j;
if(eTeXmode=1)then eqworddefine(29257,x);eqworddefine(29788,l);
...
if interaction=3 then;
if filelineerrorstylep then printfileline else printnl(264);print(1253);
end;begin helpptr:=1;helpline[0]:=1254;end;error;
...
interaction=3 then;
if filelineerrorstylep then printfileline else printnl(264);print(1255);
end;begin helpptr:=1;helpline[0]:=1254;end;error;end end;10:end;
...
if interaction=3 then;
if filelineerrorstylep then printfileline else printnl(264);print(1253);
end;begin helpptr:=1;helpline[0]:=1254;end;error;end;
...
if filelineerrorstylep then printfileline else printnl(264);print(1257);
end;begin helpptr:=1;helpline[0]:=1258;end;error;10:end;
...
until(curcmd<>10)and(curcmd<>0){:421};
case curcmd of 11,12:begin curval:=eqtb[29518+curchr].int;
curval1:=getintone(eqtb[29518+curchr]);end;
...
if filelineerrorstylep then printfileline else printnl(264);print(1259);
end;begin helpptr:=6;helpline[5]:=1260;helpline[4]:=1261;
helpline[3]:=1262;helpline[2]:=1263;helpline[1]:=1264;helpline[0]:=1265;
...
if filelineerrorstylep then printfileline else printnl(264);print(1266);
end;printesc(569);print(1267);begin helpptr:=2;helpline[1]:=1268;
helpline[0]:=1269;end;error;end{:1184};
...
976);mem[curlist.auxfield.int+2].hh.lh:=mem[curlist.eTeXauxfield].hh.rh;
...
if filelineerrorstylep then printfileline else printnl(264);print(1270);
end;begin helpptr:=1;helpline[0]:=1271;end;
end else begin begin if interaction=3 then;
if filelineerrorstylep then printfileline else printnl(264);print(1272);
end;begin helpptr:=1;helpline[0]:=1273;end;end;error;end;end{:1195};
...
begin if interaction=3 then;
if filelineerrorstylep then printfileline else printnl(264);print(1280);
end;begin helpptr:=3;helpline[2]:=1281;helpline[1]:=1282;
helpline[0]:=1283;end;error;
...
if filelineerrorstylep then printfileline else printnl(264);print(875);
end;if t=1 then begin printesc(977);begin helpptr:=1;helpline[0]:=1284;
end;end else begin printesc(976);begin helpptr:=1;helpline[0]:=1285;end;
...
{:1209}{1212:}{1499:}procedure appdisplay(j,b:halfword;d:scaled);
var z:scaled;s:scaled;e:scaled;x:integer;p,q,r,t,u:halfword;
begin s:=eqtb[29789].int;x:=eqtb[29257].int;
if x=0 then mem[b+4].int:=s+d else begin z:=eqtb[29788].int;p:=b;
{1500:}if x>0 then e:=z-d-mem[p+1].int else begin e:=d;
...
freenode(p,10);if r=-1073741823 then confusion(1524);
if x>0 then begin p:=r;repeat q:=r;r:=mem[r].hh.rh;until r=-1073741823;
end else begin p:=-1073741823;q:=r;repeat t:=mem[r].hh.rh;
mem[r].hh.rh:=p;p:=r;r:=t;until r=-1073741823;end;end{:1500};
{1501:}if j=-1073741823 then begin r:=newkern(0);t:=newkern(0);
...
mem[b+4].int:=s;end else mem[b+5].hh.rh:=u;end{:1501};end;
appendtovlist(b);end;{:1499}procedure aftermath;var l:boolean;
...
g1,g2:smallnumber;r:halfword;t:halfword;{:1216}{1496:}j:halfword;
{:1496}begin danger:=false;
{1497:}if curlist.modefield=235 then j:=curlist.eTeXauxfield{:1497};
...
interaction=3 then;
if filelineerrorstylep then printfileline else printnl(264);print(1286);
end;begin helpptr:=3;helpline[2]:=1287;helpline[1]:=1288;
helpline[0]:=1289;end;error;flushmath;danger:=true;
...
interaction=3 then;
if filelineerrorstylep then printfileline else printnl(264);print(1290);
end;begin helpptr:=3;helpline[2]:=1291;helpline[1]:=1292;
helpline[0]:=1293;end;error;flushmath;danger:=true;end{:1213};
...
if m<0 then{1214:}begin if curlist.dirfield=3 then disp:=eqtb[29795].int
else disp:=eqtb[29796].int;
{1735:}begin if not(curlist.tailfield>=himemmin)and(mem[curlist.
tailfield].hh.b0=5)then begin if curlist.pdispfield=disp then begin
freenode(curlist.tailfield,2);curlist.tailfield:=curlist.pnodefield;
mem[curlist.tailfield].hh.rh:=-1073741823;
end else mem[curlist.tailfield+1].int:=disp;
...
mem[curlist.tailfield].hh.b0:=5;mem[curlist.tailfield+1].int:=disp;
curlist.pdispfield:=disp;end;end;{:1735};
begin mem[curlist.tailfield].hh.rh:=newmath(eqtb[29775].int,0);
...
begin mem[curlist.tailfield].hh.rh:=newmath(eqtb[29775].int,1);
curlist.tailfield:=mem[curlist.tailfield].hh.rh;end;
{1736:}if disp<>0 then begin if not(curlist.tailfield>=himemmin)and(mem[
curlist.tailfield].hh.b0=5)then begin mem[curlist.tailfield+1].int:=0;
end else begin curlist.pnodefield:=curlist.tailfield;
...
w:=mem[b+1].int;z:=eqtb[29788].int;s:=eqtb[29789].int;
if eqtb[29257].int<0 then s:=-s-z;
...
curlist.tailfield:=mem[curlist.tailfield].hh.rh;end;
if(d+s<=eqtb[29787].int)or l then begin g1:=3;g2:=4;
...
{1498:}flushnodelist(j){:1498};resumeafterdisplay{:1217};end;end;
{:1212}{1218:}procedure resumeafterdisplay;
begin if curgroup<>15 then confusion(1297);unsave;
...
if(curcs=0)or(curcs>eqtbtop)or((curcs>15514)and(curcs<=30310))then begin
begin if interaction=3 then;
if filelineerrorstylep then printfileline else printnl(264);print(1315);
end;begin helpptr:=5;helpline[4]:=1316;helpline[3]:=1317;
helpline[2]:=1318;helpline[1]:=1319;helpline[0]:=1320;end;
...
if filelineerrorstylep then printfileline else printnl(264);print(751);
end;printcmdchr(curcmd,curchr);print(752);printcmdchr(q,0);
begin helpptr:=1;helpline[0]:=1351;end;error;goto 10;end;end;
...
l:=curptr;e:=true;end else case p of 0:l:=curval+29262;
1:l:=curval+29799;2:l:=curval+24549;3:l:=curval+24805;end;end;end;
40:if p<2 then if e then w:=mem[l+2].int else w:=eqtb[l].int else if e
then s:=mem[l+1].hh.rh else s:=eqtb[l].hh.rh{:1256};
if q=103 then scanoptionalequals else if scankeyword(1347)then;
aritherror:=false;
...
if filelineerrorstylep then printfileline else printnl(264);print(1348);
end;begin helpptr:=2;helpline[1]:=1349;helpline[0]:=1350;end;
...
end;begin helpptr:=1;helpline[0]:=1355;end;interror(curval);
...
if curval<0 then begin begin if interaction=3 then;
if filelineerrorstylep then printfileline else printnl(264);print(1056);
end;printesc(581);begin helpptr:=1;helpline[0]:=1356;end;
...
if u>=514 then t:=hash[u].rh else if u>=257 then if u=513 then t:=1360
else t:=u-257 else begin oldsetting:=selector;selector:=21;print(1360);
...
if scankeyword(1361)then{1278:}begin scandimen(false,false,false);
s:=curval;
if(s<=0)or(s>=134217728)then begin begin if interaction=3 then;
if filelineerrorstylep then printfileline else printnl(264);print(1363);
end;printscaled(s);print(1364);begin helpptr:=2;helpline[1]:=1365;
helpline[0]:=1366;end;error;s:=10*65536;end;
end{:1278}else if scankeyword(1362)then begin scanint;s:=-curval;
if(curval<=0)or(curval>32768)then begin begin if interaction=3 then;
if filelineerrorstylep then printfileline else printnl(264);print(606);
end;begin helpptr:=1;helpline[0]:=607;end;interror(curval);s:=-1000;end;
...
helpline[0]:=1308;end;if(eTeXmode=1)then helpline[0]:=1309;backerror;
goto 10;end{:1230};
...
3 then;if filelineerrorstylep then printfileline else printnl(264);
print(751);end;printesc(1299);print(1310);printesc(1300);
begin helpptr:=1;helpline[0]:=1311;end;
if(eTeXmode=1)then begin helpline[0]:=1312;print(1310);printesc(1313);
end;print(1314);printcmdchr(curcmd,curchr);printchar(39);error;
end{:1231};
...
if(eqtb[29250].int>0)then begin begindiagnostic;printnl(1334);
print(p-28932);print(1335);print(n);printchar(32);print(curval);
enddiagnostic(false);end;n:=n*256+curval;
if(a>=4)then geqdefine(p,136,n)else eqdefine(p,136,n);
if(p-28932)<eqtb[29248].int then if(a>=4)then geqworddefine(29248,p
-28932)else eqworddefine(29248,p-28932);
if(p-28932)>eqtb[29249].int then if(a>=4)then geqworddefine(29249,p
-28932)else eqworddefine(29249,p-28932);end else begin n:=curchr;
getrtoken;p:=curcs;
...
end else case n of 3:if(a>=4)then geqdefine(p,82,29262+curval)else
eqdefine(p,82,29262+curval);
4:if(a>=4)then geqdefine(p,83,29799+curval)else eqdefine(p,83,29799+
curval);
...
n:=curval;if not scankeyword(941)then begin begin if interaction=3 then;
if filelineerrorstylep then printfileline else printnl(264);print(1193);
end;begin helpptr:=2;helpline[1]:=1336;helpline[0]:=1337;end;error;end;
...
{:1246}{1250:}97:begin if curchr=(29646)then begin p:=curchr-128;
...
then;if filelineerrorstylep then printfileline else printnl(264);
print(1340);end;printint(curval1);print(32);printint(curval);
print(1341);begin helpptr:=1;helpline[0]:=1342;end;error;curval1:=0;
...
else if curchr=28420 then n:=32767 else if curchr=29518 then n:=16777215
...
if((curval<m)and(p<29518))or(curval>n)then begin begin if interaction=3
then;if filelineerrorstylep then printfileline else printnl(264);
print(1340);end;printint(curval);if p<29518 then begin print(1343);
printint(m);print(1344);end else print(1345);printint(n);
if m=0 then begin begin helpptr:=1;helpline[0]:=1342;end;error;
end else begin begin helpptr:=1;helpline[0]:=1346;end;error;end;
curval:=m;end;
...
end else if curval1=29518 then begin curval1:=curval div 4096;
...
if filelineerrorstylep then printfileline else printnl(264);print(746);
end;printesc(586);begin helpptr:=2;helpline[1]:=1352;helpline[0]:=1353;
...
if filelineerrorstylep then printfileline else printnl(264);print(1357);
...
{:1283}{1688:}90:begin p:=curchr;scanint;n:=curval;scanoptionalequals;
scanint;
...
end;printhex(curval);printchar(41);begin helpptr:=1;helpline[0]:=1569;
end;error;goto 10;
...
end;printint(n);printchar(41);begin helpptr:=1;helpline[0]:=1569;end;
error;goto 10;
end else if(a>=4)then geqdefine(27898+n,n,toDVI(curval))else eqdefine(
27898+n,n,toDVI(curval));end;
{:1688}{1693:}115:begin if curchr<2 then p:=26359 else begin p:=26360;
...
curchr);{:1693}{1701:}89:begin p:=curchr;scanint;n:=curval;
scanoptionalequals;scanint;
...
end;begin helpptr:=1;helpline[0]:=1569;end;error;goto 10;end;
if(a>=4)then geqdefine(27386+j,curval,n)else eqdefine(27386+j,curval,n);
end else begin begin if interaction=3 then;
if filelineerrorstylep then printfileline else printnl(264);print(1593);
end;printhex(n);printchar(41);begin helpptr:=1;helpline[0]:=1569;end;
error;goto 10;end;end;{:1701}{1706:}88:begin p:=curchr;scanint;
n:=curval;scanoptionalequals;scanint;
if ischarascii(n)or ischarkanji(n)then begin j:=getkinsokupos(n,0);
if j=1000 then begin begin if interaction=3 then;
if filelineerrorstylep then printfileline else printnl(264);print(1599);
end;begin helpptr:=1;helpline[0]:=1569;end;error;goto 10;end;
if(p=1)or(p=2)then begin if(a>=4)then geqdefine(27642+j,p,n)else
eqdefine(27642+j,p,n);
if(a>=4)then geqworddefine(30055+j,curval)else eqworddefine(30055+j,
curval);end else confusion(540);
end else begin begin if interaction=3 then;
if filelineerrorstylep then printfileline else printnl(264);print(1600);
end;
if p=1 then print(1601)else if p=2 then print(1602)else printchar(63);
print(1603);printhex(n);printchar(41);begin helpptr:=1;
helpline[0]:=1569;end;error;goto 10;end;end;
{:1706}others:confusion(1306)end;
...
longhelpseen then begin helpptr:=1;helpline[0]:=1373;
end else begin if interaction<3 then longhelpseen:=true;
begin helpptr:=4;helpline[3]:=1374;helpline[2]:=1375;helpline[1]:=1376;
helpline[0]:=1377;end;end;error;useerrhelp:=false;end{:1302};
...
4,curval,false);
if curptr=-1073741823 then p:=-1073741823 else p:=mem[curptr+1].hh.rh;
end;begindiagnostic;printnl(1394);printint(curval);printchar(61);
if p=-1073741823 then print(432)else showbox(p);end{:1315};
0:{1313:}begin gettoken;if interaction=3 then;printnl(1390);
if curcs<>0 then begin sprintcs(curcs);printchar(61);end;printmeaning;
goto 50;end{:1313};7:{1694:}begin printnl(1390);
if eqtb[26359].hh.rh>0 then print(1586)else print(1587);printnl(1390);
if eqtb[26360].hh.rh>0 then print(1588)else print(1589);goto 50;
end{:1694};{1428:}4:begin begindiagnostic;showsavegroups;end;
{:1428}{1442:}6:begin begindiagnostic;printnl(344);println;
if condptr=-1073741823 then begin printnl(380);print(1506);
end else begin p:=condptr;n:=0;repeat incr(n);p:=mem[p].hh.rh;
until p=-1073741823;p:=condptr;t:=curif;l:=ifline;m:=iflimit;
repeat printnl(1507);printint(n);print(622);printcmdchr(121,t);
if m=2 then printesc(874);if l<>0 then begin print(1505);printint(l);
end;decr(n);t:=mem[p].hh.b1;l:=mem[p+1].int;m:=mem[p].hh.b0;
p:=mem[p].hh.rh;until p=-1073741823;end;end;
{:1442}others:{1316:}begin p:=thetoks;if interaction=3 then;
printnl(1390);tokenshow(memtop-3);flushlist(mem[memtop-3].hh.rh);
...
print(1396);selector:=19;end{:1317};
50:if interaction<3 then begin helpptr:=0;decr(errorcount);
end else if eqtb[29217].int>0 then begin begin helpptr:=3;
helpline[2]:=1385;helpline[1]:=1386;helpline[0]:=1387;end;
end else begin begin helpptr:=5;helpline[4]:=1385;helpline[3]:=1386;
helpline[2]:=1387;helpline[1]:=1388;helpline[0]:=1389;end;end;error;end;
...
if filelineerrorstylep then printfileline else printnl(264);print(1398);
end;begin helpptr:=1;helpline[0]:=1399;end;
begin if interaction=3 then interaction:=2;if logopened then error;
ifdef('TEXMF_DEBUG')if interaction>0 then debughelp;
endif('TEXMF_DEBUG')history:=3;jumpout;end;end{:1323};
{1347:}selector:=21;print(1415);print(jobname);printchar(32);
...
begin if poolptr+1>poolsize then overflow(259,poolsize-initpoolptr);end;
formatident:=makestring;packjobname(882);
while not wopenout(fmtfile)do promptfilename(1416,882);printnl(1417);
...
dumpint(63848290);{1630:}dumpthings(xord[0],256);
dumpthings(xchr[0],256);dumpthings(xprn[0],256);{:1630};
dumpint(1073741823);dumpint(hashhigh);{1405:}dumpint(eTeXmode);
for j:=0 to-0 do eqtb[29261+j].int:=0;
{:1405}{1513:}while pseudofiles<>-1073741823 do pseudoclose;
{:1513}dumpint(membot);dumpint(memtop);dumpint(30310);dumpint(8501);
dumpint(607){:1326};{1644:}dumpint(1296847960);
if mltexp then dumpint(1)else dumpint(0);{:1644};
{1328:}dumpint(poolptr);dumpint(strptr);
dumpthings(strstart[0],strptr+1);dumpthings(strpool[0],poolptr);println;
printint(strptr);print(1400);printint(poolptr){:1328};{1330:}sortavail;
...
dumpint(varused);dumpint(dynused);println;printint(x);print(1401);
...
while j<30310 do begin if(eqtb[j].int=eqtb[j+1].int)and(getintone(eqtb[j
])=getintone(eqtb[j+1]))then goto 42;incr(j);end;l:=30311;goto 32;
42:incr(j);l:=j;
while j<30310 do begin if(eqtb[j].int<>eqtb[j+1].int)or(getintone(eqtb[j
])<>getintone(eqtb[j+1]))then goto 32;incr(j);end;32:dumpint(l-k);
dumpthings(eqtb[k],l-k);k:=j+1;dumpint(k-l);until k>30310;
if hashhigh>0 then dumpthings(eqtb[30311],hashhigh);{:1335};
...
if hashhigh>0 then dumpthings(hash[30311],hashhigh);dumpint(cscount);
println;printint(cscount);print(1402){:1337}{:1332};
...
for k:=0 to fontptr do begin printnl(1406);printesc(hash[15526+k].rh);
printchar(61);printfilename(fontname[k],fontarea[k],344);
if fontsize[k]<>fontdsize[k]then begin print(832);
printscaled(fontsize[k]);print(419);end;end;end{:1341};println;
printint(fmemptr-7);print(1403);printint(fontptr-0);
if fontptr<>1 then print(1404)else print(1405){:1339};
...
printint(hyphcount);if hyphcount<>1 then print(1407)else print(1408);
...
dumpthings(hyfnext[1],trieopptr);printnl(1409);printint(triemax);
print(1410);printint(trieopptr);
if trieopptr<>1 then print(1411)else print(1412);print(1413);
printint(trieopsize);
for k:=255 downto 0 do if trieused[k]>0 then begin printnl(898);
printint(trieused[k]);print(1414);printint(k);dumpint(k);
...
{:1369}{1741:}procedure comparestrings;label 30;var s1,s2:strnumber;
...
{:1741}{1749:}procedure scanpdfexttoks;
begin begin if scantoks(false,true)<>0 then end;end;
{:1749}procedure doextension;var k:integer;p:halfword;
...
6:{1743:}begin newwhatsit(6,2);end{:1743};7:{1397:}begin scanfilename;
packfilename(curname,curarea,curext);
if setinfileenc(inputfile[curinput.indexfield],stringcast(nameoffile+1))
=false then begin writeln(logfile);write(logfile,'Unknown encoding `');
fputs(stringcast(nameoffile+1),logfile);write(logfile,'''');
end end{:1397};others:confusion(1436)end;end;
...
{:1395}{1733:}procedure setmathkchar(c:integer);var p:halfword;
begin p:=newnoad;mem[p+1].hh.rh:=6;inhibitglueflag:=false;
mem[p+1].hh.b1:=0;mem[p+4].hh.lh:=c;mem[p+1].hh.b0:=eqtb[29233].int;
if fontdir[eqtb[25589+mem[p+1].hh.b0+cursize].hh.rh]=0 then begin begin
if interaction=3 then;
if filelineerrorstylep then printfileline else printnl(264);print(1255);
end;begin helpptr:=1;helpline[0]:=1254;end;error;end;mem[p].hh.b0:=18;
mem[curlist.tailfield].hh.rh:=p;curlist.tailfield:=p;end;
{:1733}{1752:}procedure insertsrcspecial;var toklist,p,q:halfword;
...
remembersourceinfo(sourcefilenamestack[inopen],line);end;end;
{:1752}{1086:}procedure handlerightbrace;var p,q:halfword;r:halfword;
d:scaled;f:integer;begin case curgroup of 1:unsave;
0:begin begin if interaction=3 then;
if filelineerrorstylep then printfileline else printnl(264);print(1149);
end;begin helpptr:=2;helpline[1]:=1150;helpline[0]:=1151;end;error;end;
...
incr(mem[q].hh.rh);d:=eqtb[29780].int;f:=eqtb[29230].int;unsave;
...
begin if interaction=3 then;
if filelineerrorstylep then printfileline else printnl(264);print(1207);
end;begin helpptr:=1;helpline[0]:=1208;end;error;
...
then;if filelineerrorstylep then printfileline else printnl(264);
print(1115);end;begin helpptr:=2;helpline[1]:=1116;helpline[0]:=1117;
...
=3 then;if filelineerrorstylep then printfileline else printnl(264);
print(1118);end;printesc(431);printint(255);begin helpptr:=3;
helpline[2]:=1119;helpline[1]:=1120;helpline[0]:=1121;end;boxerror(255);
end{:1045};
...
begin if interaction=3 then;
if filelineerrorstylep then printfileline else printnl(264);print(686);
end;printesc(1000);print(687);begin helpptr:=1;helpline[0]:=1249;end;
...
end{:1205};end;{:1204}others:confusion(1152)end;end;
...
if filelineerrorstylep then printfileline else printnl(264);print(1174);
end;printcmdchr(curcmd,curchr);print(1175);begin helpptr:=2;
helpline[1]:=1176;helpline[0]:=1177;end;error;
end else begin begin if interaction=3 then;
if filelineerrorstylep then printfileline else printnl(264);print(751);
end;printcmdchr(curcmd,curchr);print(1178);begin helpptr:=2;
helpline[1]:=1179;helpline[0]:=1180;end;error;end end;
...
155:{1454:}if curchr>0 then begin if eTeXenabled((eqtb[29261].int>0),
curcmd,curchr)then begin mem[curlist.tailfield].hh.rh:=newmath(0,curchr)
;curlist.tailfield:=mem[curlist.tailfield].hh.rh;end;
end else{:1454}initalign;
...
{:1309}{1697:}79,196,313:inhibitglueflag:=true;
{:1697}{1366:}65,182,299:doextension;{:1366}{:1063}end;goto 60;
130:{1734:}if(curlist.tailfield>=himemmin)then begin cx:=mem[curlist.
tailfield].hh.b1;{1710:}begin kp:=getkinsokupos(cx,1);
if kp<>1000 then begin if eqtb[27642+kp].hh.b0=2 then begin begin mem[
curlist.tailfield].hh.rh:=newpenalty(eqtb[30055+kp].int);
curlist.tailfield:=mem[curlist.tailfield].hh.rh;end;
mem[curlist.tailfield].hh.b1:=2;end;end;end;{:1710};
end else if mem[curlist.tailfield].hh.b0=8 then begin cx:=mem[curlist.
tailfield+1].hh.b1;{1710:}begin kp:=getkinsokupos(cx,1);
if kp<>1000 then begin if eqtb[27642+kp].hh.b0=2 then begin begin mem[
curlist.tailfield].hh.rh:=newpenalty(eqtb[30055+kp].int);
curlist.tailfield:=mem[curlist.tailfield].hh.rh;end;
mem[curlist.tailfield].hh.b1:=2;end;end;end;{:1710};end;
if curlist.dirfield=3 then begin if fontdir[mainf]=3 then disp:=0 else
if fontdir[mainf]=4 then disp:=eqtb[29795].int-eqtb[29796].int else disp
:=eqtb[29795].int;mainf:=eqtb[26358].hh.rh;
end else begin if fontdir[mainf]=4 then disp:=0 else if fontdir[mainf]=3
then disp:=eqtb[29796].int-eqtb[29795].int else disp:=eqtb[29796].int;
...
curlist.tailfield:=mem[curlist.tailfield].hh.rh;end;
mem[curlist.tailfield].hh.b0:=5;mem[curlist.tailfield+1].int:=0;
curlist.pdispfield:=disp;end;end;{:1736};inskp:=false;
...
{1708:}begin kp:=getkinsokupos(cx,1);
...
eqtb[30055+kp].int else begin mainp:=mem[curq].hh.rh;
mem[curq].hh.rh:=newpenalty(eqtb[30055+kp].int);
...
tailfield].hh.rh:=newpenalty(eqtb[30055+kp].int);
curlist.tailfield:=mem[curlist.tailfield].hh.rh;end;
mem[curlist.tailfield].hh.b1:=2;end;end;end;{:1708};end;inskp:=false;
...
end;end;133:if inskp=true then{1709:}begin kp:=getkinsokupos(curchr,1);
...
.tailfield+1].int:=mem[curlist.tailfield+1].int+eqtb[30055+kp].int else
begin begin mem[curlist.tailfield].hh.rh:=newpenalty(eqtb[30055+kp].int)
;curlist.tailfield:=mem[curlist.tailfield].hh.rh;end;
mem[curlist.tailfield].hh.b1:=2;end;end;end;{:1709};
if mainf<>0 then begin{1737:}curq:=curlist.tailfield;
...
{:1737};end else inhibitglueflag:=false;
if inskp=false then begin goto 131;
end else if inskp=true then begin inskp:=false;goto 70;
end else begin goto 21;end;{:1734};70:inhibitglueflag:=false;
...
if curlist.dirfield=3 then disp:=eqtb[29795].int else disp:=eqtb[29796].
int;{1735:}begin if not(curlist.tailfield>=himemmin)and(mem[curlist.
tailfield].hh.b0=5)then begin if curlist.pdispfield=disp then begin
freenode(curlist.tailfield,2);curlist.tailfield:=curlist.pnodefield;
mem[curlist.tailfield].hh.rh:=-1073741823;
end else mem[curlist.tailfield+1].int:=disp;
...
curlist.tailfield:=mem[curlist.tailfield].hh.rh;end;
mem[curlist.tailfield].hh.b0:=5;mem[curlist.tailfield+1].int:=disp;
curlist.pdispfield:=disp;end;end;{:1735};mainf:=eqtb[25588].hh.rh;
...
90:{1053:}if ligstack=-1073741823 then begin{1736:}if disp<>0 then begin
if not(curlist.tailfield>=himemmin)and(mem[curlist.tailfield].hh.b0=5)
...
curlist.tailfield:=mem[curlist.tailfield].hh.rh;end;
mem[curlist.tailfield].hh.b0:=5;mem[curlist.tailfield+1].int:=0;
curlist.pdispfield:=disp;end;end;{:1736};goto 21;end;
...
if x<>63848290 then begin;
writeln(stdout,'---! ',stringcast(nameoffile+1),' doesn''t match ',
poolname);goto 6666;end;
{1631:}if translatefilename then begin for k:=0 to 255 do undumpthings(
...
if eightbitp then for k:=0 to 255 do xprn[k]:=1;end;{:1631};
undumpint(x);if x<>1073741823 then goto 6666;undumpint(hashhigh);
if(hashhigh<0)or(hashhigh>suphashextra)then goto 6666;
if hashextra<hashhigh then hashextra:=hashhigh;eqtbtop:=30310+hashextra;
...
eqtb[24527].hh.b1:=0;for x:=30311 to eqtbtop do eqtb[x]:=eqtb[24527];
{1406:}begin undumpint(x);if(x<0)or(x>1)then goto 6666 else eTeXmode:=x;
end;if(eTeXmode=1)then begin{1568:}maxregnum:=65535;
maxreghelpline:=1555;{:1568}end else begin{1567:}maxregnum:=255;
maxreghelpline:=754;{:1567}end;{:1406}undumpint(x);
...
mem:=zmem;undumpint(x);if x<>30310 then goto 6666;undumpint(x);
if x<>8501 then goto 6666;undumpint(x);if x<>607 then goto 6666{:1327};
{1645:}undumpint(x);if x<>1296847960 then goto 6666;undumpint(x);
if x=1 then mltexenabledp:=true else if x<>0 then goto 6666;{:1645};
...
repeat undumpint(x);if(x<1)or(k+x>30311)then goto 6666;
undumpthings(eqtb[k],x);k:=k+x;undumpint(x);
if(x<0)or(k+x>30311)then goto 6666;
for j:=k to k+x-1 do eqtb[j]:=eqtb[k-1];k:=k+x;until k>30310;
if hashhigh>0 then undumpthings(eqtb[30311],hashhigh);{:1336};
...
if hashhigh>0 then begin undumpthings(hash[30311],hashhigh);
if debugformatfile then begin printcsnames(30311,hashhigh-(30311));end;
...
begin{1398:}for k:=0 to 15 do if writeopen[k]then aclose(writefile[k])
{:1398};
...
if totalpages=0 then printnl(936)else if curs<>-2 then begin begin
...
if dviptr>(2147483647-dvioffset)then begin curs:=-2;fatalerror(925);end;
if dviptr>0 then writedvi(0,dviptr-1){:616};printnl(937);
printfilename(0,outputfilename,0);print(286);printint(totalpages);
if totalpages<>1 then print(938)else print(939);print(381);
printint(dvioffset+dviptr);print(940);bclose(dvifile);end{:659};
{1663:}synctexterminate(logopened);{:1663};
if logopened then begin writeln(logfile);aclose(logfile);
selector:=selector-2;if selector=17 then begin printnl(1418);
...
endfilereading;while openparens>0 do begin print(1419);decr(openparens);
end;if curlevel>1 then begin printnl(40);printesc(1420);print(1421);
printint(curlevel-1);printchar(41);if(eTeXmode=1)then showsavegroups;
end;while condptr<>-1073741823 do begin printnl(40);printesc(1420);
print(1422);printcmdchr(121,curif);if ifline<>0 then begin print(1423);
printint(ifline);end;print(1424);ifline:=mem[condptr+1].int;
...
then begin selector:=17;printnl(1425);selector:=19;end;
...
goto 10;end;endif('INITEX')printnl(1426);goto 10;end;10:end;
...
primitive(499,82,29245);primitive(500,82,29246);primitive(501,82,29247);
primitive(502,82,29239);primitive(503,82,29240);primitive(504,82,29241);
primitive(505,82,29242);primitive(506,82,29243);
if mltexp then begin mltexenabledp:=true;
if false then primitive(507,82,29248);primitive(508,82,29249);
primitive(509,82,29250);end;{:244}{254:}primitive(513,83,29774);
...
primitive(529,83,29790);primitive(530,83,29791);primitive(531,83,29792);
primitive(532,83,29793);primitive(533,83,29795);primitive(534,83,29796);
primitive(535,83,29794);{:254}{275:}primitive(32,69,0);
primitive(47,48,0);primitive(550,49,0);primitive(551,104,0);
primitive(552,44,0);primitive(553,45,0);primitive(554,66,0);
primitive(555,20,0);primitive(556,54,0);primitive(546,123,0);
primitive(557,15,0);primitive(558,15,1);primitive(559,106,0);
primitive(547,72,0);primitive(560,67,0);hash[15516].rh:=560;
eqtb[15516]:=eqtb[curval];primitive(561,118,0);primitive(562,100,0);
primitive(563,101,0);primitive(564,102,0);primitive(565,86,0);
primitive(566,36,0);primitive(567,40,0);primitive(568,43,0);
primitive(336,41,0);primitive(361,22,0);primitive(569,50,0);
primitive(570,21,0);primitive(571,50,1);primitive(572,21,1);
primitive(573,59,0);primitive(574,105,0);primitive(575,38,0);
primitive(576,70,0);primitive(577,119,0);primitive(341,60,0);
primitive(578,68,0);primitive(579,96,25061);primitive(580,46,0);
primitive(581,92,0);primitive(582,71,0);primitive(583,71,1);
primitive(584,110,0);primitive(585,0,256);hash[15521].rh:=585;
eqtb[15521]:=eqtb[curval];primitive(586,112,0);primitive(587,125,0);
primitive(429,80,membot);primitive(362,42,0);primitive(588,37,0);
primitive(589,61,0);primitive(590,39,0);
{:275}{344:}primitive(652,13,256);parloc:=curval;
partoken:=536870911+parloc;{:344}{393:}primitive(690,120,0);
primitive(691,120,1);{:393}{401:}primitive(692,126,0);
primitive(693,126,1);primitive(694,126,2);primitive(695,126,3);
primitive(696,126,4);{:401}{428:}primitive(511,103,membot+0);
primitive(539,103,membot+1);primitive(417,103,membot+2);
primitive(418,103,membot+3);{:428}{433:}primitive(734,91,118);
primitive(735,91,1);primitive(736,94,0);primitive(737,94,1);
primitive(738,95,1);primitive(739,95,3);primitive(740,95,2);
primitive(741,77,0);primitive(742,77,1);primitive(743,77,2);
primitive(744,77,5);primitive(745,77,6);
{:433}{485:}primitive(806,124,0);primitive(807,124,1);
primitive(808,124,3);primitive(809,124,4);primitive(810,124,5);
primitive(811,124,2);primitive(812,124,6);primitive(813,124,7);
primitive(814,124,8);primitive(815,124,9);primitive(816,124,10);
primitive(817,124,18);{:485}{504:}primitive(847,121,0);
primitive(848,121,1);primitive(849,121,2);primitive(850,121,3);
primitive(851,121,4);primitive(852,121,5);primitive(853,121,6);
primitive(854,121,7);primitive(855,121,8);primitive(856,121,9);
primitive(857,121,10);primitive(858,121,11);primitive(859,121,12);
primitive(860,121,13);primitive(861,121,14);primitive(862,121,15);
primitive(863,121,16);primitive(864,121,20);primitive(865,121,21);
primitive(866,121,22);primitive(867,121,23);primitive(868,121,24);
primitive(869,121,25);primitive(870,121,26);
{:504}{508:}primitive(316,122,2);hash[15518].rh:=316;
eqtb[15518]:=eqtb[curval];primitive(873,122,4);primitive(874,122,3);
{:508}{570:}primitive(899,99,0);hash[15526].rh:=899;
eqtb[15526]:=eqtb[curval];{:570}{797:}primitive(999,4,256);
primitive(1000,5,257);hash[15515].rh:=1000;eqtb[15515]:=eqtb[curval];
primitive(1001,5,258);hash[15519].rh:=1002;hash[15520].rh:=1002;
eqtb[15520].hh.b0:=9;eqtb[15520].hh.rh:=memtop-11;eqtb[15520].hh.b1:=1;
eqtb[15519]:=eqtb[15520];eqtb[15519].hh.b0:=131;
{:797}{1000:}primitive(1071,93,0);primitive(1072,93,1);
primitive(1073,93,2);primitive(1074,93,3);primitive(1075,93,4);
primitive(1076,93,5);primitive(1077,93,6);primitive(1078,93,7);
primitive(1079,93,8);{:1000}{1070:}primitive(349,14,0);
primitive(1129,14,1);{:1070}{1076:}primitive(1130,30,5);
primitive(1131,30,0);primitive(1132,30,1);primitive(1133,30,2);
primitive(1134,30,3);primitive(1135,30,4);primitive(1136,31,5);
primitive(1137,31,0);primitive(1138,31,1);primitive(1139,31,2);
primitive(1140,31,3);primitive(1141,31,4);primitive(342,32,6);
primitive(346,33,1);primitive(348,34,99);
{:1076}{1089:}primitive(1159,25,1);primitive(1160,25,0);
primitive(1161,26,1);primitive(1162,26,0);primitive(431,24,0);
primitive(1163,24,1);primitive(1164,24,2);primitive(1066,24,3);
primitive(1165,24,4);primitive(1068,24,5);primitive(1166,24,122);
primitive(1167,79,3);primitive(1168,79,4);primitive(1169,79,1);
primitive(1170,35,99);primitive(1171,35,100);primitive(1172,35,101);
primitive(1173,35,102);{:1089}{1106:}primitive(1200,47,1);
primitive(1201,47,0);{:1106}{1125:}primitive(1212,29,14);
primitive(1213,29,13);primitive(1214,29,12);primitive(1215,27,0);
primitive(1216,27,1);primitive(1217,28,0);primitive(1218,28,1);
{:1125}{1132:}primitive(45,51,1);primitive(359,51,0);
{:1132}{1159:}primitive(1251,52,0);primitive(1252,52,1);
{:1159}{1174:}primitive(965,55,18);primitive(966,55,19);
primitive(967,55,20);primitive(968,55,21);primitive(969,55,22);
primitive(970,55,23);primitive(971,55,24);primitive(972,55,25);
primitive(974,55,28);primitive(973,55,29);primitive(1256,56,0);
primitive(978,56,1);primitive(979,56,2);
{:1174}{1187:}primitive(960,58,0);primitive(961,58,2);
primitive(962,58,4);primitive(963,58,6);
{:1187}{1196:}primitive(1274,57,0);primitive(1275,57,1);
primitive(1276,57,2);primitive(1277,57,3);primitive(1278,57,4);
primitive(1279,57,5);{:1196}{1206:}primitive(975,53,32);
primitive(976,53,33);hash[15517].rh:=976;eqtb[15517]:=eqtb[curval];
{:1206}{1226:}primitive(1299,107,1);primitive(1300,107,2);
primitive(1301,107,4);primitive(1302,111,0);primitive(1303,111,1);
primitive(1304,111,2);primitive(1305,111,3);
{:1226}{1237:}primitive(1322,108,0);primitive(1323,108,1);
{:1237}{1240:}primitive(1324,109,0);primitive(1325,109,9);
primitive(1326,109,1);primitive(1327,109,2);primitive(1328,109,3);
primitive(1329,109,4);primitive(1330,109,5);primitive(1331,109,6);
primitive(1332,109,7);if mltexp then begin primitive(1333,109,8);end;
{:1240}{1248:}primitive(437,97,26362);primitive(438,97,26618);
primitive(439,97,27130);primitive(446,97,28676);
primitive(1338,97,28804);primitive(443,97,27908);
primitive(444,97,28164);primitive(445,97,28420);primitive(512,97,29518);
primitive(1339,97,29646);primitive(434,98,25589);
primitive(435,98,25845);primitive(436,98,26101);
{:1248}{1269:}primitive(1042,113,0);primitive(1054,113,1);
{:1269}{1273:}primitive(1358,87,0);primitive(1359,87,1);
{:1273}{1281:}primitive(274,114,0);primitive(275,114,1);
primitive(276,114,2);primitive(1368,114,3);
{:1281}{1291:}primitive(1369,65,1);primitive(1370,65,0);
{:1291}{1296:}primitive(1371,63,0);primitive(1372,63,1);
{:1296}{1305:}primitive(1378,62,27908);primitive(1379,62,28164);
{:1305}{1310:}primitive(1380,23,0);primitive(1381,23,1);
primitive(1382,23,2);primitive(1383,23,3);primitive(1384,23,7);
{:1310}{1363:}primitive(1428,64,0);primitive(649,64,1);writeloc:=curval;
primitive(1429,64,2);primitive(1430,64,3);hash[15524].rh:=1430;
eqtb[15524]:=eqtb[curval];primitive(1431,64,4);primitive(1432,64,5);
primitive(1433,64,7);{:1363}{1650:}primitive(1567,82,29251);
{:1650}{1686:}primitive(442,90,0);{:1686}{1691:}primitive(1571,115,1);
primitive(1572,115,0);primitive(1573,115,3);primitive(1574,115,2);
primitive(1575,116,0);primitive(1576,116,1);primitive(1577,116,2);
{:1691}{1698:}primitive(1590,78,0);primitive(1591,89,27386);
{:1698}{1703:}primitive(1594,88,1);primitive(1595,88,2);{:1703};
...
printnl(1427);fflush(stdout);read(stdin,m);
...
memtop-membot+1);zmem:=yzmem-membot;eqtbtop:=30310+hashextra;
if hashextra=0 then hashtop:=24527 else hashtop:=eqtbtop;
yhash:=xmallocarray(twohalves,1+hashtop-hashoffset);
hash:=yhash-hashoffset;hash[514].lh:=0;hash[514].rh:=0;
...
{:112}{300:}if 536901221+hashextra>1073741823 then bad:=21;
...
write(stdout,'This is e-upTeX, Version 3.14159265','-p3.7.1','-u1.21',
'-160201','-2.6')else write(stdout,'This is e-upTeX, Version 3.14159265'
,'-p3.7.1','-u1.21','-160201','-2.6');write(stdout,' (');
...
{1399:}ifdef('INITEX')if(etexp or(buffer[curinput.locfield]=42))and(
formatident=1397)then begin nonewcontrolsequence:=false;
{1400:}primitive(1456,77,3);primitive(1457,77,4);primitive(1458,77,10);
primitive(818,124,11);primitive(543,119,1);primitive(819,124,12);
primitive(820,124,13);primitive(821,124,14);primitive(822,124,15);
primitive(823,124,16);primitive(824,124,17);primitive(1434,64,6);
primitive(536,83,29797);primitive(537,83,29798);primitive(1459,77,7);
primitive(1460,77,8);primitive(1461,77,9);primitive(872,121,27);
{:1400}{1408:}primitive(1463,81,25071);primitive(1464,82,29252);
primitive(1465,82,29253);primitive(1466,82,29254);
primitive(1467,82,29255);primitive(1468,82,29256);
primitive(1469,82,29257);primitive(1470,82,29258);
primitive(1471,82,29259);primitive(1472,82,29260);
{:1408}{1414:}primitive(1487,77,11);primitive(1488,77,12);
{:1414}{1417:}primitive(1489,77,13);primitive(1490,77,14);
primitive(1491,77,15);{:1417}{1420:}primitive(1492,77,18);
primitive(1493,77,19);primitive(1494,77,20);primitive(1495,77,21);
{:1420}{1423:}primitive(1496,77,22);primitive(1497,77,23);
primitive(1498,77,24);{:1423}{1426:}primitive(1499,23,4);
{:1426}{1435:}primitive(1501,23,5);{:1435}{1437:}primitive(1502,125,1);
primitive(1503,125,5);{:1437}{1440:}primitive(1504,23,6);
{:1440}{1443:}primitive(1508,94,2);{:1443}{1448:}primitive(977,53,1);
{:1448}{1452:}primitive(1512,82,29261);primitive(1513,37,6);
primitive(1514,37,7);primitive(1515,37,10);primitive(1516,37,11);
{:1452}{1502:}primitive(1525,120,2);{:1502}{1514:}primitive(1527,110,1);
{:1514}{1517:}primitive(871,118,1);primitive(1528,121,17);
primitive(1529,121,18);primitive(1530,121,19);
{:1517}{1525:}primitive(1313,107,8);{:1525}{1533:}primitive(1536,77,29);
primitive(1537,77,30);primitive(1538,77,31);primitive(1539,77,32);
{:1533}{1556:}primitive(1543,77,16);primitive(1544,77,17);
primitive(1545,77,25);primitive(1546,77,26);
{:1556}{1560:}primitive(1547,77,27);primitive(1548,77,28);
{:1560}{1564:}primitive(1549,22,5);primitive(1550,126,5);
primitive(1551,126,6);primitive(1552,126,7);primitive(1553,126,8);
primitive(1554,126,9);{:1564}{1616:}primitive(1558,28,2);
primitive(1559,28,3);{:1616}{1619:}primitive(1560,96,25328);
primitive(1561,96,25329);primitive(1562,96,25330);
primitive(1563,96,25331);
{:1619}if(buffer[curinput.locfield]=42)then incr(curinput.locfield);
eTeXmode:=1;{1568:}maxregnum:=65535;maxreghelpline:=1555;{:1568}end;
endif('INITEX')if not nonewcontrolsequence then nonewcontrolsequence:=
true else{:1399}if(formatident=0)or(buffer[curinput.locfield]=38)or
...
fontdir[0]:=0;fontnumext[0]:=0;fontname[0]:=899;fontarea[0]:=344;
...
{782:}magicoffset:=strstart[993]-9*18{:782};
{76:}if interaction=0 then selector:=16 else selector:=17{:76};
...
{1655:}synctexinitcommand;{:1655}maincontrol;finalcleanup;
closefilesandterminate;9999:begin fflush(stdout);readyalready:=0;
if(history<>0)and(history<>1)then uexit(1)else uexit(0);end;end;
{:1351}{1753:}function getnullstr:strnumber;begin getnullstr:=344;end;
{:1753}
