...
{:6}const{11:}maxinternal=300;stacksize=300;maxstrings=7500;
stringvacancies=74000;poolsize=100000;movesize=20000;maxwiggle=1000;
...
{:156}{186:}commandcode=1..85;{:186}{565:}screenrow=0..32767;
...
{:1203}{1214:}editnamestart:poolpointer;editnamelength,editline:integer;
xprn:array[ASCIIcode]of ASCIIcode;stopatspace:boolean;
{:1214}procedure initialize;var{19:}i:integer;{:19}{130:}k:integer;
...
gfoffset:=0;{:1153}{1184:}baseident:=0;{:1184}{1215:}editnamestart:=0;
stopatspace:=true;{:1215}end;{57:}procedure println;
...
if r>=9770 then{222:}begin if r<9920 then begin print(498);r:=r-(9770);
end else if r<10070 then begin print(499);r:=r-(9920);
end else begin print(500);r:=r-(10070);end;printint(r);printchar(41);
...
begin if scannerstatus>2 then begin printnl(638);
case scannerstatus of 3:print(639);4,5:print(640);6:print(641);end;
...
p:=mem[q].hh.rh;
while p<>13 do begin if mem[p+1].hh.lh<>q then begin printnl(598);
printint(p);end;p:=mem[p+1].hh.rh;r:=19;
repeat if mem[mem[p].hh.lh+1].int>=mem[r+1].int then begin printnl(599);
...
others:confusion(491)end;freenode(q,2);end;end;end;
...
14:print(477);15:print(478);69:print(479);28:print(480);47:print(408);
...
{:212}{684:}16:if m<=2 then if m=1 then print(655)else if m<1 then print
(454)else print(656)else if m=53 then print(657)else if m=44 then print(
658)else print(659);
4:if m<=1 then if m=1 then print(662)else print(455)else if m=9770 then
print(660)else print(661);{:684}{689:}61:case m of 1:print(664);
2:printchar(64);3:print(665);others:print(663)end;
{:689}{696:}56:if m>=9770 then if m=9770 then print(676)else if m=9920
then print(677)else print(678)else if m<2 then print(679)else if m=2
then print(680)else print(681);
{:696}{710:}3:if m=0 then print(691)else print(617);
{:710}{741:}1,2:case m of 1:print(718);2:print(452);3:print(719);
others:print(720)end;
{:741}{894:}33,34,37,55,45,50,36,43,54,48,51,52:printop(m);
{:894}{1014:}30:printtype(m);
{:1014}{1019:}85:if m=0 then print(912)else print(913);
{:1019}{1025:}23:case m of 0:print(273);1:print(274);2:print(275);
others:print(919)end;
{:1025}{1028:}21:if m=0 then print(920)else print(921);
{:1028}{1038:}22:case m of 0:print(935);1:print(936);2:print(937);
3:print(938);others:print(939)end;
{:1038}{1043:}31,62:begin if c=31 then print(942)else print(943);
print(944);slowprint(hash[m].rh);end;
41:if m=0 then print(945)else print(946);10:print(947);
53,44,49:begin printcmdmod(16,c);print(948);println;
showtokenlist(mem[mem[m].hh.rh].hh.rh,0,1000,0);end;5:print(949);
40:slowprint(intname[m]);
{:1043}{1053:}68:if m=1 then print(956)else if m=0 then print(957)else
print(958);66:if m=6 then print(959)else print(960);
67:if m=0 then print(961)else print(962);
{:1053}{1080:}25:if m<1 then print(992)else if m=1 then print(993)else
print(994);{:1080}{1102:}20:case m of 0:print(1004);1:print(1005);
2:print(1006);3:print(1007);others:print(1008)end;
{:1102}{1109:}76:case m of 0:print(1026);1:print(1027);2:print(1029);
3:print(1031);5:print(1028);6:print(1030);7:print(1032);11:print(1033);
others:print(1034)end;
{:1109}{1180:}29:if m=16 then print(1060)else print(1059);
{:1180}others:print(603)end;end;{:625}procedure showmacro(p:halfword;
...
repeat s:=s-2;
{586:}begin if serialno>2147483583 then overflow(588,serialno div 64);
...
others:confusion(515)end;mem[r].hh.rh:=mem[p].hh.rh;mem[r].hh.b0:=21;
...
if(q>1)or(r<>memtop)then begin printnl(533);printint(n+yoff);
printchar(58);while q>1 do begin printweight(q,xoff);q:=mem[q].hh.rh;
end;print(534);while r<>memtop do begin printweight(r,xoff);
...
if mem[q].hh.b0<>19 then confusion(589);printvariablename(q);
v:=mem[q+1].int mod 64;while v>0 do begin print(590);v:=v-2;end;
...
if(mem[q].hh.lh=0)or(verbosity>0)then printdependency(p,t)else print(764
...
then if internal[13]<=0 then begin selector:=1;printtype(t);print(762);
selector:=3;end;case t of 6:printpen(v,261,false);
8:printpath(v,763,false);9:printpath(v,261,false);11:begin curedges:=v;
...
19:printvariablename(p);others:confusion(761)end{:802};
if restorecurexp then unstashcurexp(p);end;
{:801}{807:}procedure disperr(p:halfword;s:strnumber);
begin if interaction=3 then;printnl(765);printexp(p,1);
...
if(filelineerrorstylep and not(curinput.namefield=0))then begin printnl(
261);print(fullsourcefilenamestack[inopen]);print(58);printint(line);
print(262);print(591);end else begin printnl(263);print(591)end;end;
printscaled(x);printchar(41);begin helpptr:=4;helpline[3]:=592;
helpline[2]:=593;helpline[1]:=594;helpline[0]:=595;end;error;end;end;
...
printnl(596);printvariablename(p);printchar(61);
...
begin if serialno>2147483583 then overflow(588,serialno div 64);
...
printnl(767);if v>0 then printchar(45);
if t=17 then vv:=roundfraction(maxc[17])else vv:=maxc[18];
if vv<>65536 then printscaled(vv);printvariablename(p);
while mem[p+1].int mod 64>0 do begin print(590);
mem[p+1].int:=mem[p+1].int-2;end;
if t=17 then printchar(61)else print(768);printdependency(s,t);
...
end;end{:815};end{:812};20,21:confusion(766);
...
printnl(516);slowprint(intname[q-(9769)]);printchar(61);
...
incr(k);s:=t;if k=pathsize then overflow(531,pathsize);if s=q then n:=k;
...
if(filelineerrorstylep and not(curinput.namefield=0))then begin printnl(
261);print(fullsourcefilenamestack[inopen]);print(58);printint(line);
print(262);print(528);end else begin printnl(263);print(528)end;end;
begin helpptr:=2;helpline[1]:=529;helpline[0]:=530;end;putgeterror;
...
if(filelineerrorstylep and not(curinput.namefield=0))then begin printnl(
261);print(fullsourcefilenamestack[inopen]);print(58);printint(line);
print(262);print(535);end else begin printnl(263);print(535)end;end;
begin helpptr:=3;helpline[2]:=536;helpline[1]:=537;helpline[0]:=538;end;
putgeterror;
...
261);print(fullsourcefilenamestack[inopen]);print(58);printint(line);
print(262);print(535);end else begin printnl(263);print(535)end;end;
begin helpptr:=3;helpline[2]:=539;helpline[1]:=537;helpline[0]:=538;end;
putgeterror;
...
begin printdiagnostic(541,261,true);print(542);printint(curwt);
...
then incr(maxroundingptr)else overflow(568,maxwiggle);
...
if(filelineerrorstylep and not(curinput.namefield=0))then begin printnl(
261);print(fullsourcefilenamestack[inopen]);print(58);printint(line);
print(262);print(563);end else begin printnl(263);print(563)end;end;
begin helpptr:=4;helpline[3]:=564;helpline[2]:=565;helpline[1]:=566;
helpline[0]:=567;end;putgeterror;end{:404};quadrantsubdivide;
...
if(filelineerrorstylep and not(curinput.namefield=0))then begin printnl(
261);print(fullsourcefilenamestack[inopen]);print(58);printint(line);
print(262);print(573);end else begin printnl(263);print(573)end;end;
begin helpptr:=2;helpline[1]:=574;helpline[0]:=575;end;
end else begin begin if interaction=3 then;
if(filelineerrorstylep and not(curinput.namefield=0))then begin printnl(
261);print(fullsourcefilenamestack[inopen]);print(58);printint(line);
print(262);print(576);end else begin printnl(263);print(576)end;end;
begin helpptr:=3;helpline[2]:=577;helpline[1]:=578;helpline[0]:=575;end;
end;putgeterror{:478};40:if internal[6]>0 then printpen(p,572,true);
makepen:=p;end;
...
ifdef('STAT')if internal[10]>65536 then begin printnl(585);
printtwo(x0,y0);print(584);printtwo(curx,cury);printnl(261);end;
...
ifdef('STAT')if internal[10]>65536 then{509:}begin printnl(580);
print(octantdir[octant]);print(558);printint(mem[h].hh.lh);
if mem[h].hh.lh<>1 then print(581)else print(582);print(583);
unskew(mem[p+1].int+mem[w+1].int,mem[p+2].int+mem[w+2].int,octant);
printtwo(curx,cury);ww:=mem[h].hh.rh;
if mem[q+6].int=1 then ww:=mem[ww].hh.lh;print(584);
...
printnl(597);printvariablename(x);w:=n;while w>0 do begin print(590);
...
if(filelineerrorstylep and not(curinput.namefield=0))then begin printnl(
261);print(fullsourcefilenamestack[inopen]);print(58);printint(line);
print(262);print(600);end else begin printnl(263);print(600)end;end;
begin helpptr:=2;helpline[1]:=601;helpline[0]:=602;end;putgeterror;
...
if(curinput.namefield=0)and(fileptr=0)then printnl(604)else printnl(605)
else if curinput.namefield=2 then printnl(606)else begin printnl(607);
...
end else begin{638:}case curinput.indexfield of 16:printnl(608);
17:{639:}begin printnl(613);p:=paramstack[curinput.limitfield];
if p<>0 then if mem[p].hh.rh=1 then printexp(p,0)else showtokenlist(p,0,
20,tally);print(614);end{:639};18:printnl(609);
19:if curinput.locfield=0 then printnl(610)else printnl(611);
20:printnl(612);21:begin println;
...
if inputptr=stacksize then overflow(615,stacksize);end;
...
15:begin begin if serialno>2147483583 then overflow(588,serialno div 64)
...
others:confusion(800)end;end;{:855}function curtok:halfword;
...
begin if inopen=15 then overflow(616,15);
...
if curinput.indexfield<>inopen then confusion(617);
...
if(filelineerrorstylep and not(curinput.namefield=0))then begin printnl(
261);print(fullsourcefilenamestack[inopen]);print(58);printint(line);
print(262);print(623);end else begin printnl(263);print(623)end;
end else begin begin if interaction=3 then;
if(filelineerrorstylep and not(curinput.namefield=0))then begin printnl(
261);print(fullsourcefilenamestack[inopen]);print(58);printint(line);
print(262);print(624);end else begin printnl(263);print(624)end;end;end;
print(625);begin helpptr:=4;helpline[3]:=626;helpline[2]:=627;
helpline[1]:=628;helpline[0]:=629;end;
case scannerstatus of{664:}2:begin print(630);helpline[3]:=631;
cursym:=9763;end;3:begin print(632);helpline[3]:=633;
if warninginfo=0 then cursym:=9767 else begin cursym:=9759;
eqtb[9759].rh:=warninginfo;end;end;4,5:begin print(634);
if scannerstatus=5 then slowprint(hash[warninginfo].rh)else
printvariablename(warninginfo);cursym:=9765;end;6:begin print(635);
slowprint(hash[warninginfo].rh);print(636);helpline[3]:=637;
cursym:=9764;end;{:664}end;inserror;
end{:663}else begin begin if interaction=3 then;
if(filelineerrorstylep and not(curinput.namefield=0))then begin printnl(
261);print(fullsourcefilenamestack[inopen]);print(58);printint(line);
print(262);print(618);end else begin printnl(263);print(618)end;end;
printint(warninginfo);begin helpptr:=3;helpline[2]:=619;
helpline[1]:=620;helpline[0]:=621;end;if cursym=0 then helpline[2]:=622;
...
then printnl(652);println;first:=curinput.startfield;begin;print(42);
...
end else fatalerror(653);end{:679};
...
if(filelineerrorstylep and not(curinput.namefield=0))then begin printnl(
261);print(fullsourcefilenamestack[inopen]);print(58);printint(line);
print(262);print(645);end else begin printnl(263);print(645)end;end;
begin helpptr:=3;helpline[2]:=646;helpline[1]:=647;helpline[0]:=648;end;
...
if(filelineerrorstylep and not(curinput.namefield=0))then begin printnl(
261);print(fullsourcefilenamestack[inopen]);print(58);printint(line);
print(262);print(642);end else begin printnl(263);print(642)end;end;
begin helpptr:=2;helpline[1]:=643;helpline[0]:=644;end;
...
if(filelineerrorstylep and not(curinput.namefield=0))then begin printnl(
261);print(fullsourcefilenamestack[inopen]);print(58);printint(line);
print(262);print(649);end else begin printnl(263);print(649)end;end;
begin helpptr:=2;helpline[1]:=650;helpline[0]:=651;end;
deletionsallowed:=false;error;deletionsallowed:=true;curmod:=268435455;
end;curcmd:=42;goto 10{:675};40:cursym:=idlookup(k,curinput.locfield-k);
...
first:=curinput.limitfield;begin;print(654);terminput;end;
...
if(filelineerrorstylep and not(curinput.namefield=0))then begin printnl(
261);print(fullsourcefilenamestack[inopen]);print(58);printint(line);
print(262);print(666);end else begin printnl(263);print(666)end;end;
begin helpptr:=3;helpline[2]:=667;helpline[1]:=668;helpline[0]:=669;end;
if cursym>0 then helpline[2]:=670 else if curcmd=39 then begin if strref
...
begin helpptr:=5;helpline[4]:=671;helpline[3]:=672;helpline[2]:=673;
helpline[1]:=674;helpline[0]:=675;end;backerror;end;end;
...
begin helpptr:=2;helpline[1]:=922;helpline[0]:=923;end;backerror;
end else begin begin if interaction=3 then;
if(filelineerrorstylep and not(curinput.namefield=0))then begin printnl(
261);print(fullsourcefilenamestack[inopen]);print(58);printint(line);
print(262);print(924);end else begin printnl(263);print(924)end;end;
slowprint(hash[rdelim].rh);print(925);begin helpptr:=3;helpline[2]:=926;
helpline[1]:=927;helpline[0]:=928;end;error;end;10:end;
...
if(filelineerrorstylep and not(curinput.namefield=0))then begin printnl(
261);print(fullsourcefilenamestack[inopen]);print(58);printint(line);
print(262);print(682);end else begin printnl(263);print(682)end;end;
begin helpptr:=2;helpline[1]:=683;helpline[0]:=684;end;error;
...
if(filelineerrorstylep and not(curinput.namefield=0))then begin printnl(
261);print(fullsourcefilenamestack[inopen]);print(58);printint(line);
print(262);print(685);end else begin printnl(263);print(685)end;end;
begin helpptr:=1;helpline[0]:=686;end;backerror;base:=9770;end;
{704:}repeat mem[q].hh.rh:=getavail;q:=mem[q].hh.rh;
mem[q].hh.lh:=base+k;getsymbol;p:=getnode(2);mem[p+1].int:=base+k;
mem[p].hh.lh:=cursym;if k=150 then overflow(687,150);incr(k);
...
if k=150 then overflow(687,150);incr(k);getsymbol;mem[p].hh.lh:=cursym;
mem[p].hh.rh:=r;r:=p;getnext;if c=4 then if curcmd=69 then begin c:=5;
p:=getnode(2);if k=150 then overflow(687,150);mem[p+1].int:=9770+k;
...
begin if mem[q].hh.rh=1 then printnl(498)else if(b<10070)and(b<>7)then
printnl(499)else printnl(500);printint(n);print(703);
...
goto 30 else if curcmd=84 then decr(balance);
end else if curcmd=32 then incr(balance);
end{:732}else{731:}begin if curcmd=62 then begin if curmod=ldelim then
begin decr(balance);if balance=0 then goto 30;end;
end else if curcmd=31 then if curmod=rdelim then incr(balance);
...
printmacroname(arglist,macroname);if n=3 then print(665);
...
while mem[r].hh.lh>=9770 do begin{726:}if curcmd<>82 then begin getxnext
;if curcmd<>31 then begin begin if interaction=3 then;
if(filelineerrorstylep and not(curinput.namefield=0))then begin printnl(
261);print(fullsourcefilenamestack[inopen]);print(58);printint(line);
print(262);print(709);end else begin printnl(263);print(709)end;end;
printmacroname(arglist,macroname);begin helpptr:=3;helpline[2]:=710;
helpline[1]:=711;helpline[0]:=712;end;
...
helpline[2]:=713;helpline[1]:=714;helpline[0]:=708;end;backerror;
curcmd:=82;end else begin missingerr(hash[rdelim].rh);begin helpptr:=2;
helpline[1]:=715;helpline[0]:=708;end;backerror;end{:727};
...
if curcmd=82 then begin begin if interaction=3 then;
if(filelineerrorstylep and not(curinput.namefield=0))then begin printnl(
261);print(fullsourcefilenamestack[inopen]);print(58);printint(line);
print(262);print(704);end else begin printnl(263);print(704)end;end;
printmacroname(arglist,macroname);printchar(59);printnl(705);
slowprint(hash[rdelim].rh);print(299);begin helpptr:=3;helpline[2]:=706;
helpline[1]:=707;helpline[0]:=708;end;error;end;
...
if arglist=0 then arglist:=p else mem[tail].hh.rh:=p;tail:=p;incr(n);
if curcmd<>69 then begin missingerr(479);print(716);
printmacroname(arglist,macroname);begin helpptr:=1;helpline[0]:=717;end;
...
missingerr(hash[rdelim].rh);begin helpptr:=2;helpline[1]:=715;
helpline[0]:=708;end;backerror;end;getxnext;end;end{:735};
...
if maxparamstack>150 then overflow(687,150);end;
...
if(filelineerrorstylep and not(curinput.namefield=0))then begin printnl(
261);print(fullsourcefilenamestack[inopen]);print(58);printint(line);
print(262);print(724);end else begin printnl(263);print(724)end;end;
printcmdmod(2,curmod);begin helpptr:=1;helpline[0]:=725;end;error;
...
if(filelineerrorstylep and not(curinput.namefield=0))then begin printnl(
261);print(fullsourcefilenamestack[inopen]);print(58);printint(line);
print(262);print(688);end else begin printnl(263);print(688)end;end;
begin helpptr:=2;helpline[1]:=689;helpline[0]:=690;end;error;
...
if(filelineerrorstylep and not(curinput.namefield=0))then begin printnl(
261);print(fullsourcefilenamestack[inopen]);print(58);printint(line);
print(262);print(692);end else begin printnl(263);print(692)end;end;
begin helpptr:=2;helpline[1]:=693;helpline[0]:=694;end;error;
...
if(filelineerrorstylep and not(curinput.namefield=0))then begin printnl(
261);print(fullsourcefilenamestack[inopen]);print(58);printint(line);
print(262);print(695);end else begin printnl(263);print(695)end;end;
begin helpptr:=1;helpline[0]:=696;end;
...
until p<>0;if p<>mem[loopptr].hh.lh then fatalerror(699);stopiteration;
end{:714}else if curcmd<>83 then begin missingerr(59);begin helpptr:=2;
helpline[1]:=697;helpline[0]:=698;end;backerror;end;end{:713};7:;
...
if curtype<>4 then begin disperr(0,700);begin helpptr:=2;
helpline[1]:=701;helpline[0]:=702;end;putgetflusherror(0);
...
if maxparamstack>150 then overflow(687,150);end;paramstack[paramptr]:=p;
...
while true do begin if q=0 then confusion(718);
...
helpline[1]:=721;helpline[0]:=698;end;backerror;end;end;
...
if curexp=30 then print(722)else print(723);enddiagnostic(false);
...
{:748}{754:}procedure badfor(s:strnumber);begin disperr(0,726);print(s);
print(306);begin helpptr:=4;helpline[3]:=727;helpline[2]:=728;
helpline[1]:=729;helpline[0]:=308;end;putgetflusherror(0);end;
...
helpline[2]:=730;helpline[1]:=673;helpline[0]:=731;end;backerror;end;
...
737);pp:=getnode(4);mem[pp+1].int:=curexp;getxnext;scanexpression;
if curtype<>16 then badfor(738);mem[pp+2].int:=curexp;
if curcmd<>75 then begin missingerr(490);begin helpptr:=2;
helpline[1]:=739;helpline[0]:=740;end;backerror;end;getxnext;
scanexpression;if curtype<>16 then badfor(741);mem[pp+3].int:=curexp;
...
helpline[2]:=732;helpline[1]:=733;helpline[0]:=734;end;backerror;
...
if internal[7]>65536 then{762:}begin begindiagnostic;printnl(736);
...
if s=743 then begin if interaction=3 then;
if(filelineerrorstylep and not(curinput.namefield=0))then begin printnl(
261);print(fullsourcefilenamestack[inopen]);print(58);printint(line);
print(262);print(744);end else begin printnl(263);print(744)end;
end else begin if interaction=3 then;
if(filelineerrorstylep and not(curinput.namefield=0))then begin printnl(
261);print(fullsourcefilenamestack[inopen]);print(58);printint(line);
print(262);print(745);end else begin printnl(263);print(745)end;end;
printfilename(curname,curarea,curext);print(746);
if e=747 then showcontext;printnl(748);print(s);
if interaction<2 then fatalerror(749);savedcurname:=curname;;begin;
...
if jobname=0 then jobname:=getjobname(750);packjobname(751);
recorderchangefilename(stringcast(nameoffile+1));packjobname(752);
while not aopenout(logfile)do{789:}begin selector:=1;
promptfilename(754,752);end{:789};
texmflogname:=amakenamestring(logfile);selector:=2;logopened:=true;
{790:}begin write(logfile,'This is METAFONT, Version 2.7182818');
write(logfile,versionstring);slowprint(baseident);print(755);
...
end;end{:790};inputstack[inputptr]:=curinput;printnl(753);
...
if(filelineerrorstylep and not(curinput.namefield=0))then begin printnl(
261);print(fullsourcefilenamestack[inopen]);print(58);printint(line);
print(262);print(757);end else begin printnl(263);print(757)end;end;
begin helpptr:=3;helpline[2]:=758;helpline[1]:=759;helpline[0]:=760;end;
error;end;
...
if curext=747 then begin curext:=261;
packfilename(curname,curarea,curext);end;
...
print(770);printcmdmod(curcmd,curmod);printchar(39);begin helpptr:=4;
helpline[3]:=771;helpline[2]:=772;helpline[1]:=773;helpline[0]:=774;end;
...
{:848}{849:}procedure badsubscript;begin disperr(0,786);
begin helpptr:=3;helpline[2]:=787;helpline[1]:=788;helpline[0]:=789;end;
flusherror(0);end;{:849}{851:}procedure obliterated(q:halfword);
begin begin if interaction=3 then;
if(filelineerrorstylep and not(curinput.namefield=0))then begin printnl(
261);print(fullsourcefilenamestack[inopen]);print(58);printint(line);
print(262);print(790);end else begin printnl(263);print(790)end;end;
showtokenlist(q,0,1000,0);print(791);begin helpptr:=5;helpline[4]:=792;
helpline[3]:=793;helpline[2]:=794;helpline[1]:=795;helpline[0]:=796;end;
...
if(filelineerrorstylep and not(curinput.namefield=0))then begin printnl(
261);print(fullsourcefilenamestack[inopen]);print(58);printint(line);
print(262);print(806);end else begin printnl(263);print(806)end;end;
begin helpptr:=2;helpline[1]:=807;helpline[0]:=575;end;putgeterror;
curexp:=3;goto 50;
...
if mem[p+2].hh.b0=16 then cury:=mem[p+3].int else begin disperr(p+2,817)
;begin helpptr:=5;helpline[4]:=818;helpline[3]:=811;helpline[2]:=812;
helpline[1]:=813;helpline[0]:=814;end;putgeterror;recyclevalue(p+2);
...
if(curtype<>16)or(curexp<0)then begin disperr(0,821);begin helpptr:=1;
helpline[0]:=822;end;putgetflusherror(65536);end;t:=3;
end{:876}else{877:}begin scanexpression;
if curtype>14 then{878:}begin if curtype<>16 then begin disperr(0,815);
begin helpptr:=5;helpline[4]:=816;helpline[3]:=811;helpline[2]:=812;
helpline[1]:=813;helpline[0]:=814;end;putgetflusherror(0);end;x:=curexp;
if curcmd<>82 then begin missingerr(44);begin helpptr:=2;
helpline[1]:=823;helpline[0]:=824;end;backerror;end;getxnext;
scanexpression;if curtype<>16 then begin disperr(0,817);
begin helpptr:=5;helpline[4]:=818;helpline[3]:=811;helpline[2]:=812;
helpline[1]:=813;helpline[0]:=814;end;putgetflusherror(0);end;
...
helpline[2]:=819;helpline[1]:=820;helpline[0]:=698;end;backerror;end;
...
35:{897:}begin if interaction<=1 then fatalerror(835);beginfilereading;
...
336)else print(836)else print(837);printchar(41);end;
{:900}{901:}procedure badunary(c:quarterword);begin disperr(0,838);
printop(c);printknownorunknowntype(curtype,curexp);begin helpptr:=3;
helpline[2]:=839;helpline[1]:=840;helpline[0]:=841;end;putgeterror;end;
...
{914:}if badchar then begin disperr(0,843);
if c=47 then begin helpptr:=1;helpline[0]:=844;
end else begin helpptr:=1;helpline[0]:=845;end;putgeterror;end;
if n>4095 then begin begin if interaction=3 then;
if(filelineerrorstylep and not(curinput.namefield=0))then begin printnl(
261);print(fullsourcefilenamestack[inopen]);print(58);printint(line);
print(262);print(846);end else begin printnl(263);print(846)end;end;
printint(n);printchar(41);begin helpptr:=1;helpline[0]:=847;end;
...
printop(c);printchar(40);printexp(0,0);print(842);enddiagnostic(false);
end{:902};
...
begin disperr(p,261);disperr(0,838);if c>=94 then printop(c);
...
helpline[2]:=839;helpline[1]:=848;helpline[0]:=849;end;putgeterror;end;
...
disperr(p,858);begin helpptr:=3;helpline[2]:=859;helpline[1]:=860;
...
begin setuptrans(c);if curtype<>16 then begin disperr(0,861);
begin helpptr:=3;helpline[2]:=862;helpline[1]:=863;helpline[0]:=538;end;
...
if(filelineerrorstylep and not(curinput.namefield=0))then begin printnl(
261);print(fullsourcefilenamestack[inopen]);print(58);printint(line);
print(262);print(867);end else begin printnl(263);print(867)end;end;
begin helpptr:=3;helpline[2]:=868;helpline[1]:=537;helpline[0]:=538;end;
putgeterror;
...
if(filelineerrorstylep and not(curinput.namefield=0))then begin printnl(
261);print(fullsourcefilenamestack[inopen]);print(58);printint(line);
print(262);print(864);end else begin printnl(263);print(864)end;end;
begin helpptr:=3;helpline[2]:=865;helpline[1]:=866;helpline[0]:=538;end;
...
begin begin if aritherror then cleararith;end;
if internal[7]>131072 then{924:}begin begindiagnostic;printnl(850);
printexp(p,0);printchar(41);printop(c);printchar(40);printexp(0,0);
print(842);enddiagnostic(false);end{:924};
...
begin helpptr:=1;helpline[0]:=851;end end else begin helpptr:=2;
helpline[1]:=852;helpline[0]:=853;end;disperr(0,854);
putgetflusherror(31);
...
if v=0 then{950:}begin disperr(0,784);begin helpptr:=2;helpline[1]:=856;
helpline[0]:=857;end;putgeterror;
...
printnl(850);printscaled(n);printchar(47);printscaled(d);print(855);
printexp(0,0);print(842);enddiagnostic(false);end{:945};
...
while not bopenout(gffile)do promptfilename(756,gfext);
...
if(filelineerrorstylep and not(curinput.namefield=0))then begin printnl(
261);print(fullsourcefilenamestack[inopen]);print(58);printint(line);
print(262);print(897);end else begin printnl(263);print(897)end;end;
print(899);printscaled(mem[p+1].int);printchar(41);begin helpptr:=2;
helpline[1]:=898;helpline[0]:=896;end;putgeterror;
...
if(filelineerrorstylep and not(curinput.namefield=0))then begin printnl(
261);print(fullsourcefilenamestack[inopen]);print(58);printint(line);
print(262);print(894);end else begin printnl(263);print(894)end;end;
begin helpptr:=2;helpline[1]:=895;helpline[0]:=896;end;putgeterror;
goto 30;45:begin if interaction=3 then;
if(filelineerrorstylep and not(curinput.namefield=0))then begin printnl(
261);print(fullsourcefilenamestack[inopen]);print(58);printint(line);
print(262);print(897);end else begin printnl(263);print(897)end;end;
begin helpptr:=2;helpline[1]:=898;helpline[0]:=896;end;putgeterror;
goto 30;end{:1004};
...
{:1003}end;{1002:}disperr(lhs,261);disperr(0,891);
...
printchar(41);begin helpptr:=2;helpline[1]:=892;helpline[0]:=893;end;
...
if internal[7]>131072 then{997:}begin begindiagnostic;printnl(850);
printexp(lhs,0);print(886);printexp(0,0);print(842);
...
q:halfword;begin if curtype<>20 then begin disperr(0,883);
begin helpptr:=2;helpline[1]:=884;helpline[0]:=885;end;error;doequation;
...
.lh-(9769)]:=curexp else begin disperr(0,887);
slowprint(intname[mem[lhs].hh.lh-(9769)]);print(888);begin helpptr:=2;
helpline[1]:=889;helpline[0]:=890;end;putgeterror;
...
if(filelineerrorstylep and not(curinput.namefield=0))then begin printnl(
261);print(fullsourcefilenamestack[inopen]);print(58);printint(line);
print(262);print(900);end else begin printnl(263);print(900)end;end;
begin helpptr:=2;helpline[1]:=901;helpline[0]:=902;end;putgeterror;end;
flushlist(p);if curcmd<82 then{1016:}begin begin if interaction=3 then;
if(filelineerrorstylep and not(curinput.namefield=0))then begin printnl(
261);print(fullsourcefilenamestack[inopen]);print(58);printint(line);
print(262);print(903);end else begin printnl(263);print(903)end;end;
begin helpptr:=5;helpline[4]:=904;helpline[3]:=905;helpline[2]:=906;
helpline[1]:=907;helpline[0]:=908;end;
if curcmd=42 then helpline[2]:=909;putgeterror;scannerstatus:=2;
repeat getnext;
{743:}if curcmd=39 then begin if strref[curmod]<127 then if strref[
curmod]>1 then decr(strref[curmod])else flushstring(curmod);end{:743};
until curcmd>=82;scannerstatus:=0;end{:1016};until curcmd>82;end;
{:1015}{1021:}procedure dorandomseed;begin getxnext;
if curcmd<>77 then begin missingerr(461);begin helpptr:=1;
helpline[0]:=914;end;backerror;end;getxnext;scanexpression;
if curtype<>16 then begin disperr(0,915);begin helpptr:=2;
helpline[1]:=916;helpline[0]:=917;end;putgetflusherror(0);
end else{1022:}begin initrandoms(curexp);
if selector>=2 then begin oldsetting:=selector;selector:=2;printnl(918);
...
261);print(fullsourcefilenamestack[inopen]);print(58);printint(line);
print(262);print(924);end else begin printnl(263);print(924)end;end;
if cursym=0 then print(929)else slowprint(hash[cursym].rh);print(930);
begin helpptr:=1;helpline[0]:=931;end;backerror;
...
begin helpptr:=3;helpline[2]:=932;helpline[1]:=673;helpline[0]:=933;end;
...
begin repeat if intptr=maxinternal then overflow(934,maxinternal);
...
begin repeat getxnext;scanexpression;printnl(765);printexp(0,2);
...
if eqtb[cursym].lh>=86 then print(941);printcmdmod(curcmd,curmod);
...
begin printnl(950);ifdef('STAT')printint(varused);printchar(38);
printint(dynused);if false then endif('STAT')print(357);print(558);
printint(himemmin-lomemmax-1);print(951);println;printnl(952);
printint(strptr-initstrptr);printchar(38);printint(poolptr-initpoolptr);
print(558);printint(maxstrings-maxstrptr);printchar(38);
printint(poolsize-maxpoolptr);print(951);println;getxnext;end;
...
printvariablename(p);if mem[p].hh.b0>22 then print(665);print(953);
...
printvariablename(p);
if mem[p].hh.b0=17 then printchar(61)else print(768);
...
if(filelineerrorstylep and not(curinput.namefield=0))then begin printnl(
261);print(fullsourcefilenamestack[inopen]);print(58);printint(line);
print(262);print(954);end else begin printnl(263);print(954)end;end;
if interaction<3 then begin helpptr:=0;decr(errorcount);
end else begin helpptr:=1;helpline[0]:=955;end;
...
result:=false;if curtype<>t then{1055:}begin disperr(0,963);
begin helpptr:=2;helpline[1]:=964;helpline[0]:=965;end;
if t=6 then helpline[1]:=966;putgetflusherror(0);
...
if(filelineerrorstylep and not(curinput.namefield=0))then begin printnl(
261);print(fullsourcefilenamestack[inopen]);print(58);printint(line);
print(262);print(967);end else begin printnl(263);print(967)end;end;
begin helpptr:=1;helpline[0]:=965;end;putgetflusherror(0);end;
...
261);print(fullsourcefilenamestack[inopen]);print(58);printint(line);
print(262);print(790);end else begin printnl(263);print(790)end;end;
showtokenlist(t,0,1000,0);print(968);printtype(mem[p].hh.b0);
printchar(41);begin helpptr:=2;helpline[1]:=969;helpline[0]:=970;end;
...
varflag:=68;scanprimary;if curtype<>20 then{1060:}begin disperr(0,971);
begin helpptr:=4;helpline[3]:=972;helpline[2]:=973;helpline[1]:=974;
helpline[0]:=970;end;putgetflusherror(0);
...
0,975);begin helpptr:=2;helpline[1]:=976;helpline[0]:=970;end;
...
if curtype<>9 then begin disperr(0,975);begin helpptr:=2;
helpline[1]:=977;helpline[0]:=970;end;putgetflusherror(0);
...
if(filelineerrorstylep and not(curinput.namefield=0))then begin printnl(
261);print(fullsourcefilenamestack[inopen]);print(58);printint(line);
print(262);print(978);end else begin printnl(263);print(978)end;end;
begin helpptr:=2;helpline[1]:=979;helpline[0]:=970;end;putgeterror;
...
rh=0)then goto 30 else printstrange(980)else printstrange(981);
begin helpptr:=3;helpline[2]:=982;helpline[1]:=983;helpline[0]:=984;end;
...
if(filelineerrorstylep and not(curinput.namefield=0))then begin printnl(
261);print(fullsourcefilenamestack[inopen]);print(58);printint(line);
print(262);print(1001);end else begin printnl(263);print(1001)end;end;
print(intname[m]);print(1002);begin helpptr:=1;helpline[0]:=1003;end;
putgeterror;
...
{1060:}begin disperr(0,971);begin helpptr:=4;helpline[3]:=972;
helpline[2]:=973;helpline[1]:=974;helpline[0]:=970;end;
...
if curtype<>20 then{1060:}begin disperr(0,971);begin helpptr:=4;
helpline[3]:=972;helpline[2]:=973;helpline[1]:=974;helpline[0]:=970;end;
...
45:curexp:=curexp*65536;50:disperr(0,985);begin helpptr:=1;
helpline[0]:=986;end;putgetflusherror(0);flushtokenlist(e);end;10:end;
...
if(filelineerrorstylep and not(curinput.namefield=0))then begin printnl(
261);print(fullsourcefilenamestack[inopen]);print(58);printint(line);
print(262);print(987);end else begin printnl(263);print(987)end;end;
begin helpptr:=2;helpline[1]:=988;helpline[0]:=989;end;putgeterror;
10:end;{:1073}{1074:}procedure docull;label 45,10;var e:halfword;
keeping:0..1;w,win,wout:integer;begin w:=1;getxnext;varflag:=67;
scanprimary;if curtype<>20 then{1060:}begin disperr(0,971);
begin helpptr:=4;helpline[3]:=972;helpline[2]:=973;helpline[1]:=974;
helpline[0]:=970;end;putgetflusherror(0);end{:1060}else begin e:=curexp;
...
if(filelineerrorstylep and not(curinput.namefield=0))then begin printnl(
261);print(fullsourcefilenamestack[inopen]);print(58);printint(line);
print(262);print(990);end else begin printnl(263);print(990)end;end;
begin helpptr:=1;helpline[0]:=991;end;putgeterror;flushtokenlist(e);end;
10:end;{:1074}{1082:}procedure domessage;var m:0..2;begin m:=curmod;
getxnext;scanexpression;if curtype<>4 then begin disperr(0,700);
begin helpptr:=1;helpline[0]:=995;end;putgeterror;
...
helpptr:=1;helpline[0]:=996;
end else begin if interaction<3 then longhelpseen:=true;
begin helpptr:=4;helpline[3]:=997;helpline[2]:=998;helpline[1]:=999;
helpline[0]:=1000;end;end;putgeterror;useerrhelp:=false;end{:1086};
...
then begin c:=strpool[strstart[curexp]];goto 40;end;disperr(0,1009);
begin helpptr:=2;helpline[1]:=1010;helpline[0]:=1011;end;
...
if(filelineerrorstylep and not(curinput.namefield=0))then begin printnl(
261);print(fullsourcefilenamestack[inopen]);print(58);printint(line);
print(262);print(1012);end else begin printnl(263);print(1012)end;end;
if(c>32)and(c<127)then print(c)else if c=256 then print(1013)else begin
print(1014);printint(c);end;print(1015);case chartag[c]of 1:print(1016);
2:print(1017);3:print(1006);end;begin helpptr:=2;helpline[1]:=1018;
helpline[0]:=970;end;putgeterror;end{:1105};end;
...
if(filelineerrorstylep and not(curinput.namefield=0))then begin printnl(
261);print(fullsourcefilenamestack[inopen]);print(58);printint(line);
print(262);print(1035);end else begin printnl(263);print(1035)end;end;
begin helpptr:=1;helpline[0]:=1036;end;error;ll:=skiptable[c];
...
261);print(fullsourcefilenamestack[inopen]);print(58);printint(line);
print(262);print(1035);end else begin printnl(263);print(1035)end;end;
begin helpptr:=1;helpline[0]:=1036;end;error;ll:=ll;
repeat lll:=ligkern[ll].b0;ligkern[ll].b0:=128;ll:=ll-lll;until lll=0;
...
if curtype<>16 then begin disperr(0,1037);begin helpptr:=2;
helpline[1]:=1038;helpline[0]:=308;end;putgetflusherror(0);end;
kern[nk]:=curexp;k:=0;while kern[k]<>curexp do incr(k);
if k=nk then begin if nk=maxkerns then overflow(1034,maxkerns);incr(nk);
...
if(filelineerrorstylep and not(curinput.namefield=0))then begin printnl(
261);print(fullsourcefilenamestack[inopen]);print(58);printint(line);
print(262);print(1023);end else begin printnl(263);print(1023)end;end;
begin helpptr:=1;helpline[0]:=1024;end;backerror;ligkern[nl].b1:=0;
ligkern[nl].b2:=0;ligkern[nl].b3:=0;ligkern[nl].b0:=129;end;
if nl=ligtablesize then overflow(1025,ligtablesize);incr(nl);
if curcmd=82 then goto 22;
if ligkern[nl-1].b0<128 then ligkern[nl-1].b0:=128;30:end{:1107};
2:{1113:}begin if ne=256 then overflow(1006,256);c:=getcode;
settag(c,3,ne);if curcmd<>81 then begin missingerr(58);begin helpptr:=1;
helpline[0]:=1039;end;backerror;end;exten[ne].b0:=getcode;
if curcmd<>82 then begin missingerr(44);begin helpptr:=1;
helpline[0]:=1039;end;backerror;end;exten[ne].b1:=getcode;
if curcmd<>82 then begin missingerr(44);begin helpptr:=1;
helpline[0]:=1039;end;backerror;end;exten[ne].b2:=getcode;
if curcmd<>82 then begin missingerr(44);begin helpptr:=1;
helpline[0]:=1039;end;backerror;end;exten[ne].b3:=getcode;incr(ne);
end{:1113};3,4:begin c:=curmod;getxnext;scanexpression;
if(curtype<>16)or(curexp<32768)then begin disperr(0,1019);
begin helpptr:=2;helpline[1]:=1020;helpline[0]:=1021;end;putgeterror;
end else begin j:=roundunscaled(curexp);
if curcmd<>81 then begin missingerr(58);begin helpptr:=1;
helpline[0]:=1022;end;backerror;end;
if c=3 then{1114:}repeat if j>headersize then overflow(1007,headersize);
headerbyte[j]:=getcode;incr(j);
until curcmd<>82{:1114}else{1115:}repeat if j>maxfontdimen then overflow
(1008,maxfontdimen);while j>np do begin incr(np);param[np]:=0;end;
getxnext;scanexpression;if curtype<>16 then begin disperr(0,1040);
begin helpptr:=1;helpline[0]:=308;end;putgetflusherror(0);end;
param[j]:=curexp;incr(j);until curcmd<>82{:1115};end;end;end;end;
...
baseengine:^ASCIIcode;begin{1200:}selector:=5;print(1073);
...
while not wopenout(basefile)do promptfilename(1074,742);printnl(1075);
...
dumpthings(baseengine[0],x);libcfree(baseengine);dumpint(4795517);
{1216:}dumpthings(xord[0],256);dumpthings(xchr[0],256);
dumpthings(xprn[0],256);{:1216};dumpint(0);dumpint(memtop);
...
w.b3:=strpool[k+3];dumpqqqq(w);println;printint(strptr);print(1070);
...
dumpint(varused);dumpint(dynused);println;printint(x);print(1071);
...
dumpint(stcount);println;printint(stcount);print(1072){:1196};
...
getxnext;if curcmd>43 then{990:}begin if curcmd<83 then begin begin if
interaction=3 then;
if(filelineerrorstylep and not(curinput.namefield=0))then begin printnl(
261);print(fullsourcefilenamestack[inopen]);print(58);printint(line);
print(262);print(869);end else begin printnl(263);print(869)end;end;
printcmdmod(curcmd,curmod);printchar(39);begin helpptr:=5;
helpline[4]:=870;helpline[3]:=871;helpline[2]:=872;helpline[1]:=873;
helpline[0]:=874;end;backerror;getxnext;end;
...
end{:994}else if curtype<>1 then begin disperr(0,879);begin helpptr:=3;
helpline[2]:=880;helpline[1]:=881;helpline[0]:=882;end;putgeterror;end;
...
if curcmd<83 then{991:}begin begin if interaction=3 then;
if(filelineerrorstylep and not(curinput.namefield=0))then begin printnl(
261);print(fullsourcefilenamestack[inopen]);print(58);printint(line);
print(262);print(875);end else begin printnl(263);print(875)end;end;
begin helpptr:=6;helpline[5]:=876;helpline[4]:=877;helpline[3]:=878;
helpline[2]:=872;helpline[1]:=873;helpline[0]:=874;end;backerror;
scannerstatus:=2;repeat getnext;
{743:}if curcmd=39 then begin if strref[curmod]<127 then if strref[
curmod]>1 then decr(strref[curmod])else flushstring(curmod);end{:743};
until curcmd>82;scannerstatus:=0;end{:991};errorcount:=0;end;
{:989}{1017:}procedure maincontrol;begin repeat dostatement;
if curcmd=84 then begin begin if interaction=3 then;
if(filelineerrorstylep and not(curinput.namefield=0))then begin printnl(
261);print(fullsourcefilenamestack[inopen]);print(58);printint(line);
print(262);print(910);end else begin printnl(263);print(910)end;end;
begin helpptr:=2;helpline[1]:=911;helpline[0]:=690;end;flusherror(0);
end;until curcmd=85;end;
...
{:1121}{1123:}procedure tfmwarning(m:smallnumber);begin printnl(1041);
print(intname[m]);print(1042);printscaled(perturbation);print(1043);end;
{:1123}{1128:}procedure fixdesignsize;var d:scaled;
begin d:=internal[26];
if(d<65536)or(d>=134217728)then begin if d<>0 then printnl(1044);
...
libcfree(baseengine);undumpint(x);if x<>4795517 then begin;
writeln(stdout,'---! ',stringcast(nameoffile+1),' doesn''t match ',
poolname);goto 6666;end;
{1217:}if translatefilename then begin for k:=0 to 255 do undumpthings(
...
if eightbitp then for k:=0 to 255 do xprn[k]:=1;end;{:1217};
...
end{:825};case curcmd of 31:{826:}begin ldelim:=cursym;rdelim:=curmod;
getxnext;scanexpression;
...
if curtype<16 then begin disperr(0,775);begin helpptr:=4;
helpline[3]:=776;helpline[2]:=777;helpline[1]:=778;helpline[0]:=779;end;
...
if(filelineerrorstylep and not(curinput.namefield=0))then begin printnl(
261);print(fullsourcefilenamestack[inopen]);print(58);printint(line);
print(262);print(780);end else begin printnl(263);print(780)end;end;
printint(groupline);print(781);begin helpptr:=2;helpline[1]:=782;
helpline[0]:=783;end;backerror;curcmd:=84;end;unsave;
if internal[7]>0 then showcmdmod(curcmd,curmod);end{:832};
39:{833:}begin curtype:=4;curexp:=curmod;end{:833};
...
if(filelineerrorstylep and not(curinput.namefield=0))then begin printnl(
261);print(fullsourcefilenamestack[inopen]);print(58);printint(line);
print(262);print(784);end else begin printnl(263);print(784)end;end;
begin helpptr:=1;helpline[0]:=785;end;error;
...
if curcmd<>69 then begin missingerr(479);print(716);printcmdmod(37,c);
begin helpptr:=1;helpline[0]:=717;end;backerror;end;p:=stashcurexp;
...
helpline[2]:=797;helpline[1]:=798;helpline[0]:=799;putgetflusherror(0);
end;flushnodelist(q);goto 30{:852};end{:844};others:begin badexp(769);
...
backexpr;curcmd:=63;curmod:=0;cursym:=9760;end{:847};unstashcurexp(p);
end else begin q:=stashcurexp;getxnext;scanexpression;
if curcmd<>64 then begin missingerr(93);begin helpptr:=3;
helpline[2]:=801;helpline[1]:=802;helpline[0]:=698;end;backerror;end;
...
if curcmd<>64 then begin missingerr(93);begin helpptr:=3;
helpline[2]:=803;helpline[1]:=802;helpline[0]:=698;end;backerror;end;
...
begin 20:if(curcmd<30)or(curcmd>43)then badexp(804);scanprimary;
...
begin 20:if(curcmd<30)or(curcmd>43)then badexp(805);scansecondary;
...
20:if(curcmd<30)or(curcmd>43)then badexp(808);scantertiary;
...
{883:}if(curtype<>16)or(curexp<49152)then begin disperr(0,826);
begin helpptr:=1;helpline[0]:=827;end;putgetflusherror(65536);end{:883};
...
if curcmd<>47 then begin missingerr(408);begin helpptr:=1;
helpline[0]:=825;end;backerror;end;
...
if(filelineerrorstylep and not(curinput.namefield=0))then begin printnl(
261);print(fullsourcefilenamestack[inopen]);print(58);printint(line);
print(262);print(828);end else begin printnl(263);print(828)end;end;
begin helpptr:=3;helpline[2]:=829;helpline[1]:=830;helpline[0]:=831;end;
putgeterror;d:=47;mem[q+6].int:=65536;y:=65536;end;
...
if curtype<>2 then begin disperr(0,832);begin helpptr:=2;
helpline[1]:=833;helpline[0]:=834;end;putgetflusherror(31);curtype:=2;
...
{1134:}if jobname=0 then openlogfile;packjobname(1045);
while not bopenout(tfmfile)do promptfilename(1046,1045);
...
printnl(1048);printint(k);print(1049);ll:=skiptable[k];
repeat lll:=ligkern[ll].b0;ligkern[ll].b0:=128;ll:=ll-lll;until lll=0;
...
if tfmchanged>0 then begin if tfmchanged=1 then printnl(1050)else begin
printnl(40);printint(tfmchanged);print(1051);end;print(1052);end{:1140};
...
endif('STAT')printnl(1047);printfilename(0,metricfilename,0);
...
if gfptr>(2147483647-gfoffset)then begin gfprevptr:=0;fatalerror(1053);
end;if gfptr>0 then writegf(0,gfptr-1){:1156};printnl(1064);
printfilename(0,outputfilename,0);print(558);printint(totalchars);
if totalchars<>1 then print(1065)else print(1066);print(1067);
printint(gfoffset+gfptr);print(1068);bclose(gffile);end{:1182};
end{:1206};if logopened then begin writeln(logfile);aclose(logfile);
selector:=selector-2;if selector=1 then begin printnl(1076);
...
while openparens>0 do begin print(1077);decr(openparens);end;
while condptr<>0 do begin printnl(1078);printcmdmod(2,curif);
if ifline<>0 then begin print(1079);printint(ifline);end;print(1080);
...
then begin selector:=1;printnl(1081);selector:=3;end;
if c=1 then begin ifdef('INIMF')if iniversion then begin storebasefile;
goto 10;end;endif('INIMF')printnl(1082);goto 10;end;10:end;
{:1209}{1210:}ifdef('INIMF')procedure initprim;
begin{192:}primitive(409,40,1);primitive(410,40,2);primitive(411,40,3);
primitive(412,40,4);primitive(413,40,5);primitive(414,40,6);
primitive(415,40,7);primitive(416,40,8);primitive(417,40,9);
primitive(418,40,10);primitive(419,40,11);primitive(420,40,12);
primitive(421,40,13);primitive(422,40,14);primitive(423,40,15);
primitive(424,40,16);primitive(425,40,17);primitive(426,40,18);
primitive(427,40,19);primitive(428,40,20);primitive(429,40,21);
primitive(430,40,22);primitive(431,40,23);primitive(432,40,24);
primitive(433,40,25);primitive(434,40,26);primitive(435,40,27);
primitive(436,40,28);primitive(437,40,29);primitive(438,40,30);
primitive(439,40,31);primitive(440,40,32);primitive(441,40,33);
primitive(442,40,34);primitive(443,40,35);primitive(444,40,36);
primitive(445,40,37);primitive(446,40,38);primitive(447,40,39);
primitive(448,40,40);primitive(449,40,41);
{:192}{211:}primitive(408,47,0);primitive(91,63,0);
...
eqtb[9767]:=eqtb[cursym];egloc:=cursym;primitive(471,26,0);
...
primitive(490,75,0);{:211}{683:}primitive(655,16,1);primitive(656,16,2);
primitive(657,16,53);primitive(658,16,44);primitive(659,16,49);
primitive(454,16,0);eqtb[9765]:=eqtb[cursym];primitive(660,4,9770);
primitive(661,4,9920);primitive(662,4,1);primitive(455,4,0);
eqtb[9764]:=eqtb[cursym];{:683}{688:}primitive(663,61,0);
primitive(664,61,1);primitive(64,61,2);primitive(665,61,3);
{:688}{695:}primitive(676,56,9770);primitive(677,56,9920);
primitive(678,56,10070);primitive(679,56,1);primitive(680,56,2);
primitive(681,56,3);{:695}{709:}primitive(691,3,0);primitive(617,3,1);
{:709}{740:}primitive(718,1,1);primitive(452,2,2);
eqtb[9766]:=eqtb[cursym];primitive(719,2,3);primitive(720,2,4);
{:740}{893:}primitive(347,33,30);primitive(348,33,31);
primitive(349,33,32);primitive(350,33,33);primitive(351,33,34);
primitive(352,33,35);primitive(353,33,36);primitive(354,33,37);
primitive(355,34,38);primitive(356,34,39);primitive(357,34,40);
primitive(358,34,41);primitive(359,34,42);primitive(360,34,43);
primitive(361,34,44);primitive(362,34,45);primitive(363,34,46);
primitive(364,34,47);primitive(365,34,48);primitive(366,34,49);
primitive(367,34,50);primitive(368,34,51);primitive(369,34,52);
primitive(370,34,53);primitive(371,34,54);primitive(372,34,55);
primitive(373,34,56);primitive(374,34,57);primitive(375,34,58);
primitive(376,34,59);primitive(377,34,60);primitive(378,34,61);
primitive(379,34,62);primitive(380,34,63);primitive(381,34,64);
primitive(382,34,65);primitive(383,34,66);primitive(384,34,67);
primitive(385,36,68);primitive(43,43,69);primitive(45,43,70);
primitive(42,55,71);primitive(47,54,72);eqtb[9761]:=eqtb[cursym];
primitive(386,45,73);primitive(310,45,74);primitive(388,52,76);
primitive(387,45,75);primitive(60,50,77);primitive(389,50,78);
primitive(62,50,79);primitive(390,50,80);primitive(61,51,81);
primitive(391,50,82);primitive(401,37,94);primitive(402,37,95);
primitive(403,37,96);primitive(404,37,97);primitive(405,37,98);
primitive(406,37,99);primitive(407,37,100);primitive(38,48,83);
primitive(392,55,84);primitive(393,55,85);primitive(394,55,86);
primitive(395,55,87);primitive(396,55,88);primitive(397,55,89);
primitive(398,55,90);primitive(399,55,91);primitive(400,45,92);
{:893}{1013:}primitive(340,30,15);primitive(326,30,4);
primitive(324,30,2);primitive(331,30,9);primitive(328,30,6);
primitive(333,30,11);primitive(335,30,13);primitive(336,30,14);
{:1013}{1018:}primitive(912,85,0);primitive(913,85,1);
{:1018}{1024:}primitive(273,23,0);primitive(274,23,1);
primitive(275,23,2);primitive(919,23,3);
{:1024}{1027:}primitive(920,21,0);primitive(921,21,1);
{:1027}{1037:}primitive(935,22,0);primitive(936,22,1);
primitive(937,22,2);primitive(938,22,3);primitive(939,22,4);
{:1037}{1052:}primitive(956,68,1);primitive(957,68,0);
primitive(958,68,2);primitive(959,66,6);primitive(960,66,16);
primitive(961,67,0);primitive(962,67,1);
{:1052}{1079:}primitive(992,25,0);primitive(993,25,1);
primitive(994,25,2);{:1079}{1101:}primitive(1004,20,0);
primitive(1005,20,1);primitive(1006,20,2);primitive(1007,20,3);
primitive(1008,20,4);{:1101}{1108:}primitive(1026,76,0);
primitive(1027,76,1);primitive(1028,76,5);primitive(1029,76,2);
primitive(1030,76,6);primitive(1031,76,3);primitive(1032,76,7);
primitive(1033,76,11);primitive(1034,76,128);
...
hash[9757].rh:=456;eqtb[9759].lh:=62;{:203}{229:}mem[19].hh.lh:=9770;
...
memtop+1);end;endif('INIMF')history:=3;;
...
endif('INIMF')readyalready:=314159;1:{55:}selector:=1;tally:=0;
termoffset:=0;fileoffset:=0;
{:55}{61:}write(stdout,'This is METAFONT, Version 2.7182818');
