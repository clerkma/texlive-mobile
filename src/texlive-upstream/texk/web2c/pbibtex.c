...
znamescanforand ( strnumber poplitvar ) 
{
  ...
  case 161 : 
    {
      if ( ( ( exbuf [exbufptr + 1 ]== 164 ) || ( exbuf [exbufptr + 1 ]== 
      162 ) ) ) 
      {
	precedingwhite = false ;
	andfound = true ;
      } 
      else if ( ( exbuf [exbufptr + 1 ]== 161 ) ) 
      {
	exbuf [exbufptr ]= 32 ;
	exbuf [exbufptr + 1 ]= 32 ;
	precedingwhite = true ;
  ...
  case 125 : 
    ...
    if ( ( lexclass [exbuf [exbufptr ]]== 1 ) ) 
    {
      ...
      if ( ( exbuf [exbufptr ]> 127 ) ) 
      exbufptr = exbufptr + 2 ;
      else exbufptr = exbufptr + 1 ;
      precedingwhite = false ;
    } 
    break ;
  } 
...
initialize ( void ) 
{
  ...
  while ( i++ < for_end ) ;} 
  xchr [9 ]= chr ( 9 ) ;
  {register integer for_end; i = 128 ;for_end = 159 ; if ( i <= for_end) do 
    xchr [i ]= chr ( i - 128 ) ;
  while ( i++ < for_end ) ;} 
  {register integer for_end; i = 160 ;for_end = 255 ; if ( i <= for_end) do 
    xchr [i ]= chr ( i ) ;
  while ( i++ < for_end ) ;} 
  xchr [27 ]= chr ( 27 ) ;
  ...
  charwidth [125 ]= 500 ;
  charwidth [126 ]= 500 ;
  {register integer for_end; i = 160 ;for_end = 254 ; if ( i <= for_end) do 
    charwidth [i ]= 514 ;
  while ( i++ < for_end ) ;} 
...
#define noptions ( 6 ) 
  ...
  if ( ( optind + 1 != argc ) ) 
  {
    fprintf ( stderr , "%s%s\n",  "pbibtex" , ": Need exactly one file argument." ) ;
    usage ( "pbibtex" ) ;
  } 
} 
void mainbody( void ) {
  ...
  {
    {
      Fputs ( logfile ,  "This is pBibTeX, Version 0.99d-j0.33" ) ;
      Fputs ( standardoutput ,  "This is pBibTeX, Version 0.99d-j0.33" ) ;
    } 
    {
