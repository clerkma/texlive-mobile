...
zprintcs ( integer p ) 
{
  ...
  else if ( ( ( p >= 2252239L ) && ( p <= 10053470L ) ) || ( p > eqtbtop ) ) 
  printesc ( 65811L ) ;
...
zshownodelist ( integer p ) 
{
  ...
  while ( p > memmin ) {
	...
	break ;
      case 1 : 
	{
	  printwritewhatsit ( 65914L , p ) ;
	  printmark ( mem [p + 1 ].hh .v.RH ) ;
	} 
	break ;
      case 2 : 
	printwritewhatsit ( 66712L , p ) ;
	break ;
      case 3 : 
	{
	  printesc ( 66713L ) ;
	...
	if ( memtop - 2 != pagetail ) 
	{
	  ...
	  if ( pagecontents > 0 ) 
	  {
	    ...
	    while ( r != memtop ) {
	      ...
	      printint ( t ) ;
	      print ( 66382L ) ;
	      if ( eqtb [8938824L + t ].cint == 1000 ) 
	      t = mem [r + 3 ].cint ;
	      else t = xovern ( mem [r + 3 ].cint , 1000 ) * eqtb [8938824L 
	      + t ].cint ;
	      printscaled ( t ) ;
	      if ( mem [r ].hh.b0 == 1 ) 
	      {
...
zprintcmdchr ( quarterword cmd , halfword chrcode ) 
{
  ...
  case 74 : 
    ...
    printparam ( chrcode - 8938740L ) ;
      ...
      printesc ( 65777L ) ;
      printint ( chrcode - 8938824L ) ;
    } 
    break ;
  case 75 : 
    if ( chrcode < 10053215L ) 
    printlengthparam ( chrcode - 10053192L ) ;
    else {
	
      printesc ( 65803L ) ;
      printint ( chrcode - 10053215L ) ;
    } 
    break ;
  case 45 : 
    printesc ( 65813L ) ;
  ...
  case 31 : 
    ...
    printesc ( 66461L ) ;
    else printesc ( 66458L ) ;
    break ;
  case 43 : 
    if ( chrcode == 0 ) 
    printesc ( 66478L ) ;
    else printesc ( 66477L ) ;
    break ;
  case 25 : 
    if ( chrcode == 10 ) 
    printesc ( 66490L ) ;
  ...
  case 99 : 
    ...
    printesc ( 66577L ) ;
    else printesc ( 66578L ) ;
    break ;
  case 96 : 
    if ( chrcode != 0 ) 
    printesc ( 66596L ) ;
    else printesc ( 66595L ) ;
    break ;
  case 97 : 
    switch ( chrcode ) 
    {case 0 : 
  ...
  case 87 : 
    ...
    printesc ( 66616L ) ;
    else if ( chrcode == 8939080L ) 
    printesc ( 66619L ) ;
    else printesc ( 66621L ) ;
    break ;
  case 88 : 
...
zshoweqtb ( halfword n ) 
{
  ...
  if ( n < 1 ) 
  printchar ( 63 ) ;
  else if ( ( n < 2252240L ) || ( ( n > 10053470L ) && ( n <= eqtbtop ) ) ) 
  {
    sprintcs ( n ) ;
    printchar ( 61 ) ;
    ...
    if ( n < 2252259L ) 
    {
      ...
      printchar ( 61 ) ;
      if ( n < 2252256L ) 
      printspec ( eqtb [n ].hh .v.RH , 65693L ) ;
  ...
  {
    if ( n < 10053215L ) 
    printlengthparam ( n - 10053192L ) ;
    else {
	
      printesc ( 65803L ) ;
      printint ( n - 10053215L ) ;
    } 
    printchar ( 61 ) ;
...
zidlookup ( integer j , integer l ) 
{
  ...
  while ( true ) {
	...
	if ( hash [p ].v.RH > 0 ) 
	{
	  ...
	  {
	    incr ( hashhigh ) ;
	    hash [p ].v.LH = hashhigh + 10053470L ;
	    p = hashhigh + 10053470L ;
	  } 
	  else {
	      
	    do {
		if ( ( hashused == 2228226L ) ) 
	      overflow ( 65807L , 15000 + hashextra ) ;
	      decr ( hashused ) ;
...
zscansomethinginternal ( smallnumber level , boolean negative ) 
{
  ...
  {case 86 : 
	...
	curval1 ) * 256 ) + mathcharfield ( curval1 ) ;
	{
      ...
      {
	curval1 = eqtb [8939080L + curval ].cint ;
  ...
  case 87 : 
	...
	error () ;
	{
      ...
      {
	{
	  curval = eqtb [8939080L + curval ].cint ;
	  curvallevel = 0 ;
	} 
      } 
      else {
  ...
  case 91 : 
	...
	{case 0 : 
	  curval = eqtb [8938824L + curval ].cint ;
	  break ;
	case 1 : 
	  curval = eqtb [10053215L + curval ].cint ;
	  break ;
	case 2 : 
...
requiresunits ) 
{
  ...
  if ( requiresunits ) 
  {
    ...
    if ( scankeyword ( 65693L ) ) 
    goto lab88 ;
    if ( scankeyword ( 66062L ) ) 
    {
      num = 7227 ;
      denom = 100 ;
    } 
...
scanrulespec ( void ) 
{
  ...
  lab21: if ( scankeyword ( 66079L ) ) 
  {
    scandimen ( false , false , false ) ;
    mem [q + 1 ].cint = curval ;
    goto lab21 ;
  } 
  if ( scankeyword ( 66080L ) ) 
  {
    scandimen ( false , false , false ) ;
    mem [q + 3 ].cint = curval ;
    goto lab21 ;
  } 
  if ( scankeyword ( 66081L ) ) 
  {
    scandimen ( false , false , false ) ;
    mem [q + 2 ].cint = curval ;
    goto lab21 ;
  ...
  case 44 : 
    {
      ...
      boolvar = scankeyword ( 66826L ) ;
      scanpdfexttoks () ;
      if ( selector == 21 ) 
      pdferror ( 66726L , 66727L ) ;
      oldsetting = selector ;
      selector = 21 ;
...
openlogfile ( void ) 
{
  ...
  logopened = true ;
  {
    ...
    fprintf ( logfile , "%s%s%s",  "This is XeTeX, Version 3.14159265" , "-2.6" ,     "-0.99996" ) ;
    else
    fprintf ( logfile , "%s%s%s",  "This is XeTeX, Version 3.14159265" , "-2.6" ,     "-0.99996" ) ;
...
zzreverse ( halfword thisbox , halfword t , scaled * curg , real * curglue ) 
{
  ...
  while ( true ) {
	...
	[p ].hh.b1 == 42 ) || ( mem [p ].hh.b1 == 43 ) || ( mem [p ]
	.hh.b1 == 44 ) ) 
	rulewd = mem [p + 1 ].cint ;
	else goto lab15 ;
	break ;
...
hlistout ( void ) 
{
  ...
  if ( eqtb [8938820L ].cint > 1 ) 
  {
    ...
    while ( p != -268435455L ) {
      ...
      {
	if ( ( ( ( p ) != -268435455L && ( ! ( p >= himemmin ) ) && ( mem [p 
	].hh.b0 == 8 ) && ( ( mem [p ].hh.b1 == 40 ) || ( mem [p ].hh.b1 
	== 41 ) ) ) ) && ( fontletterspace [mem [p + 4 ].qqqq .b1 ]== 0 ) 
	) 
	{
	  r = p ;
	  k = mem [r + 4 ].qqqq .b2 ;
	  ...
	  if ( ( q != -268435455L ) && ! ( q >= himemmin ) ) 
	  {
	    ...
	    .hh.b1 == 41 ) ) ) ) && ( mem [q + 4 ].qqqq .b1 == mem [r + 4 ]
	    .qqqq .b1 ) ) 
	    {
	      p = q ;
	      q = mem [q ].hh .v.RH ;
	  ...
	  lab1237: if ( p != r ) 
	  {
	    ...
	    while ( true ) {
	      ...
	      if ( mem [q ].hh.b0 == 8 ) 
	      {
		if ( ( mem [q ].hh.b1 == 40 ) || ( mem [q ].hh.b1 == 41 ) 
		) 
		{
...
zshipout ( halfword p ) 
{
  ...
  synctexsheet ( eqtb [8938757L ].cint ) ;
  {
    ...
    printchar ( 91 ) ;
    j = 9 ;
    while ( ( eqtb [8938824L + j ].cint == 0 ) && ( j > 0 ) ) decr ( j ) ;
    {register integer for_end; k = 0 ;for_end = j ; if ( k <= for_end) do 
      {
	printint ( eqtb [8938824L + k ].cint ) ;
	if ( k < j ) 
	printchar ( 46 ) ;
      } 
    while ( k++ < for_end ) ;} 
    ...
    10053211L ].cint > 1073741823L ) || ( mem [p + 1 ].cint + eqtb [
    10053210L ].cint > 1073741823L ) ) 
    {
      {
	if ( interaction == 3 ) 
	;
    ...
    if ( mem [p + 3 ].cint + mem [p + 2 ].cint + eqtb [10053211L ].cint 
    > maxv ) 
    maxv = mem [p + 3 ].cint + mem [p + 2 ].cint + eqtb [10053211L ]
    .cint ;
    if ( mem [p + 1 ].cint + eqtb [10053210L ].cint > maxh ) 
    maxh = mem [p + 1 ].cint + eqtb [10053210L ].cint ;
    dvih = 0 ;
    dviv = 0 ;
    curh = eqtb [10053210L ].cint ;
    dvif = 0 ;
    curhoffset = eqtb [10053210L ].cint + ( 65536L * 7227 ) / ((double) 100 
    ) ;
    curvoffset = eqtb [10053211L ].cint + ( 65536L * 7227 ) / ((double) 100 
    ) ;
    if ( eqtb [10053213L ].cint != 0 ) 
    curpagewidth = eqtb [10053213L ].cint ;
    else curpagewidth = mem [p + 1 ].cint + 2 * curhoffset ;
    if ( eqtb [10053214L ].cint != 0 ) 
    curpageheight = eqtb [10053214L ].cint ;
    ...
    if ( outputfilename == 0 ) 
    {
      ...
      while ( ! dviopenout ( dvifile ) ) promptfilename ( 66150L , 
      outputfileextension ) ;
    ...
    selector = 21 ;
    print ( 66195L ) ;
    if ( ( eqtb [10053213L ].cint > 0 ) && ( eqtb [10053214L ].cint > 0 ) 
    ) 
    {
      print ( 66079L ) ;
      print ( 32 ) ;
      printscaled ( eqtb [10053213L ].cint ) ;
      print ( 65693L ) ;
      print ( 32 ) ;
      print ( 66080L ) ;
      print ( 32 ) ;
      printscaled ( eqtb [10053214L ].cint ) ;
      print ( 65693L ) ;
    } 
    else print ( 66196L ) ;
    selector = oldsetting ;
    ...
    while ( s++ < for_end ) ;} 
    poolptr = strstart [( strptr ) - 65536L ];
    curv = mem [p + 3 ].cint + eqtb [10053211L ].cint ;
    tempptr = p ;
    if ( mem [p ].hh.b0 == 1 ) 
    vlistout () ;
    else hlistout () ;
...
zscanspec ( groupcode c , boolean threecodes ) 
{
  ...
  if ( scankeyword ( 66213L ) ) 
  speccode = 0 ;
  else if ( scankeyword ( 66214L ) ) 
  speccode = 1 ;
  else {
...
zhpack ( halfword p , scaled w , smallnumber m ) 
{
  ...
  else if ( x > 0 ) 
  {
    ...
    ].hh .v.RH != -268435455L ) ) 
    {
      ...
      mem [r + 6 ].gr = 1.0 ;
      if ( ( - (integer) x - totalshrink [0 ]> eqtb [10053200L ].cint ) || 
      ( eqtb [8938766L ].cint < 100 ) ) 
      {
	if ( ( eqtb [10053208L ].cint > 0 ) && ( - (integer) x - totalshrink 
	[0 ]> eqtb [10053200L ].cint ) ) 
	{
	  while ( mem [q ].hh .v.RH != -268435455L ) q = mem [q ].hh .v.RH 
	  ;
	  mem [q ].hh .v.RH = newrule () ;
	  mem [mem [q ].hh .v.RH + 1 ].cint = eqtb [10053208L ].cint ;
	} 
	println () ;
	printnl ( 66224L ) ;
...
zvpackage ( halfword p , scaled h , smallnumber m , scaled l ) 
{
  ...
  else if ( x > 0 ) 
  {
    ...
    ].hh .v.RH != -268435455L ) ) 
    {
      lastbadness = 1000000L ;
      mem [r + 6 ].gr = 1.0 ;
      if ( ( - (integer) x - totalshrink [0 ]> eqtb [10053201L ].cint ) || 
...
zvardelimiter ( halfword d , integer s , scaled v ) 
{
  ...
  lab40: if ( f != 0 ) 
  {
    ...
    b = newnullbox () ;
    mem [b + 1 ].cint = eqtb [10053203L ].cint ;
  } 
...
zmakescripts ( halfword q , scaled delta ) 
{
  ...
  if ( mem [q + 2 ].hh .v.RH == 0 ) 
  {
    ...
    curf = savef ;
    mem [x + 1 ].cint = mem [x + 1 ].cint + eqtb [10053204L ].cint ;
    ...
    mem [x + 4 ].cint = - (integer) shiftup ;
      ...
      curf = savef ;
      mem [y + 1 ].cint = mem [y + 1 ].cint + eqtb [10053204L ].cint ;
...
zmakeleftright ( halfword q , smallnumber style , scaled maxd , scaled maxh ) 
{
  ...
  delta2 = delta1 + delta1 - eqtb [10053202L ].cint ;
  if ( delta < delta2 ) 
  delta = delta2 ;
...
finalign ( void ) 
{
  ...
  {
    rulesave = eqtb [10053208L ].cint ;
    eqtb [10053208L ].cint = 0 ;
    p = hpack ( mem [memtop - 8 ].hh .v.RH , savestack [saveptr + 1 ].cint 
    , savestack [saveptr + 0 ].cint ) ;
    eqtb [10053208L ].cint = rulesave ;
  } 
  else {
...
hyphenate ( void ) 
{
  ...
  .hh.b0 == 8 ) && ( ( mem [ha ].hh.b1 == 40 ) || ( mem [ha ].hh.b1 == 41 
  ) ) ) ) ) 
  {
    s = curp ;
...
maxhyphenatablelength ( void ) 
{
  ...
  if ( eqtb [8938822L ].cint > 4095 ) 
  Result = 4095 ;
  else Result = eqtb [8938822L ].cint ;
  return Result ;
} 
boolean 
...
zvsplit ( halfword n , scaled h ) 
{
  ...
  q = vertbreak ( mem [v + 5 ].hh .v.RH , h , eqtb [10053198L ].cint ) ;
  p = mem [v + 5 ].hh .v.RH ;
  if ( p == q ) 
  ...
  Result = vpackage ( p , h , 0 , eqtb [10053198L ].cint ) ;
  return Result ;
} 
void 
printtotals ( void ) 
...
zfreezepagespecs ( smallnumber s ) 
{
  ...
  pagecontents = s ;
  pagesofar [0 ]= eqtb [10053196L ].cint ;
  pagemaxdepth = eqtb [10053197L ].cint ;
  pagesofar [7 ]= 0 ;
  pagesofar [1 ]= 0 ;
  pagesofar [2 ]= 0 ;
  pagesofar [3 ]= 0 ;
...
buildpage ( void ) 
{
  ...
  do {
	...
	if ( mem [r ].hh.b1 != n ) 
	{
	  ...
	  if ( eqtb [8938824L + n ].cint == 1000 ) 
	  h = mem [r + 3 ].cint ;
	  else h = xovern ( mem [r + 3 ].cint , 1000 ) * eqtb [8938824L + n 
	  ].cint ;
	...
	insertpenalties = insertpenalties + mem [p + 1 ].cint ;
	  ...
	  if ( eqtb [8938824L + n ].cint == 1000 ) 
	  h = mem [p + 3 ].cint ;
	  else h = xovern ( mem [p + 3 ].cint , 1000 ) * eqtb [8938824L + n 
	  ].cint ;
	  if ( ( ( h <= 0 ) || ( h <= delta ) ) && ( mem [p + 3 ].cint + mem 
	  [r + 3 ].cint <= eqtb [10053215L + n ].cint ) ) 
	  {
	    ...
	    if ( eqtb [8938824L + n ].cint <= 0 ) 
	    w = 1073741823L ;
	    else {
		
	      w = pagesofar [0 ]- pagesofar [1 ]- pagesofar [7 ];
	      if ( eqtb [8938824L + n ].cint != 1000 ) 
	      w = xovern ( w , eqtb [8938824L + n ].cint ) * 1000 ;
	    } 
	    if ( w > eqtb [10053215L + n ].cint - mem [r + 3 ].cint ) 
	    w = eqtb [10053215L + n ].cint - mem [r + 3 ].cint ;
...
itsallover ( void ) 
{
  ...
  if ( privileged () ) 
  {
    ...
    mem [curlist .tailfield + 1 ].cint = eqtb [10053195L ].cint ;
    {
...
normalparagraph ( void ) 
{
  ...
  if ( eqtb [10053209L ].cint != 0 ) 
  eqworddefine ( 10053209L , 0 ) ;
...
indentinhmode ( void ) 
{
  ...
  {
    p = newnullbox () ;
    mem [p + 1 ].cint = eqtb [10053192L ].cint ;
    if ( abs ( curlist .modefield ) == 104 ) 
    curlist .auxfield .hh .v.LH = 1000 ;
    else {
...
begininsertoradjust ( void ) 
{
  ...
  if ( ( curcmd == 38 ) && scankeyword ( 66484L ) ) 
...
initmath ( void ) 
{
  ...
  if ( ( curcmd == 3 ) && ( curlist .modefield > 0 ) ) 
  {
	...
	case 8 : 
	  ...
	  mem [p ].hh.b1 == 42 ) || ( mem [p ].hh.b1 == 43 ) || ( mem [p 
	  ].hh.b1 == 44 ) ) 
	  {
	    d = mem [p + 1 ].cint ;
	    goto lab40 ;
    ...
    if ( eqtb [2252771L ].hh .v.RH == -268435455L ) {
      ...
      if ( ( eqtb [10053209L ].cint != 0 ) && ( ( ( eqtb [8938781L ].cint 
      >= 0 ) && ( curlist .pgfield + 2 > eqtb [8938781L ].cint ) ) || ( 
      curlist .pgfield + 1 < - (integer) eqtb [8938781L ].cint ) ) ) 
      {
	l = eqtb [10053195L ].cint - abs ( eqtb [10053209L ].cint ) ;
	if ( eqtb [10053209L ].cint > 0 ) 
	s = eqtb [10053209L ].cint ;
	else s = 0 ;
      } 
      else {
	  
	l = eqtb [10053195L ].cint ;
	s = 0 ;
      } 
    } 
    else {
    ...
    eqworddefine ( 10053205L , w ) ;
    curlist .eTeXauxfield = j ;
    if ( ( eTeXmode == 1 ) ) 
    eqworddefine ( 8938803L , x ) ;
    eqworddefine ( 10053206L , l ) ;
    eqworddefine ( 10053207L , s ) ;
...
zscandelimiter ( halfword p , boolean r ) 
{
  ...
  if ( r ) 
  {
    ...
    case 12 : 
      {
	curval = eqtb [8939080L + curchr ].cint ;
      } 
      break ;
    case 15 : 
      if ( curchr == 1 ) 
...
mathac ( void ) 
{
  ...
  if ( curchr == 1 ) 
  {
    if ( scankeyword ( 66537L ) ) 
    mem [curlist .tailfield ].hh.b1 = 1 ;
    else if ( scankeyword ( 66538L ) ) 
    {
      if ( scankeyword ( 66537L ) ) 
...
zappdisplay ( halfword j , halfword b , scaled d ) 
{
  ...
  integer x  ;
  halfword p, q, r, t, u  ;
  s = eqtb [10053207L ].cint ;
  x = eqtb [8938803L ].cint ;
  if ( x == 0 ) 
  mem [b + 4 ].cint = s + d ;
  else {
      
    z = eqtb [10053206L ].cint ;
    p = b ;
    if ( x > 0 ) 
    e = z - d - mem [p + 1 ].cint ;
    else {
...
aftermath ( void ) 
{
  ...
  {
    {
      mem [curlist .tailfield ].hh .v.RH = newmath ( eqtb [10053193L ]
      .cint , 0 ) ;
      curlist .tailfield = mem [curlist .tailfield ].hh .v.RH ;
    } 
    curmlist = p ;
...
zloadpicture ( boolean ispdf ) 
{
  ...
  if ( ispdf ) 
  {
    if ( scankeyword ( 66391L ) ) 
    {
      scanint () ;
      page = curval ;
    } 
    pdfboxtype = 6 ;
    if ( scankeyword ( 66759L ) ) 
    pdfboxtype = 1 ;
...
maincontrol ( void ) 
{
  ...
  case 169 : 
	...
	if ( ( eqtb [8938815L ].cint > 0 ) && ( spaceclass != 4096 ) && ( 
	prevclass != ( 4095 ) ) ) 
	{
	  prevclass = ( 4095 ) ;
  ...
  [eqtb [2253299L ].hh .v.RH ]== 65534L ) ) ) 
  {
	...
	( mem [mainpp ].hh.b1 == 41 ) ) ) ) && ( mem [mainpp + 4 ].qqqq 
	.b1 == mainf ) && ( mainppp != mainpp ) && ( ! ( mainppp >= himemmin ) 
	) && ( mem [mainppp ].hh.b0 != 7 ) ) 
	{
	...
	if ( ( mem [mainpp + 4 ].qqqq .b1 == mainf ) ) 
	{
	  ...
	  if ( ! ( mainp >= himemmin ) && ( mem [mainp ].hh.b0 == 10 ) ) 
	  {
	      ...
	      .tailfield + 4 ].qqqq .b2 - 1 ; if ( t <= for_end) do 
		{
	      ...
	      while ( t++ < for_end ) ;} 
	      setnativemetrics ( tempptr , ( eqtb [8938814L ].cint > 0 ) ) ;
  ...
  goto lab110 ;
  lab120: if ( ( eqtb [8938815L ].cint > 0 ) && ( spaceclass != 4096 ) && ( 
  prevclass != ( 4095 ) ) ) 
  {
    prevclass = ( 4095 ) ;
    findsaelement ( 6 , spaceclass * 4096 + ( 4095 ) , false ) ;
