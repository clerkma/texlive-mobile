...
endif('TEXMF_DEBUG'){:9}program MF;label{6:}1,9998,9999;
{:6}const{11:}maxinternal=300;stacksize=300;maxstrings=75000;
stringvacancies=74000;poolsize=1000000;movesize=20000;maxwiggle=1000;
poolname=TEXMFPOOLNAME;enginename=TEXMFENGINENAME;pathsize=1000;
bistacksize=1500;headersize=100;ligtablesize=15000;maxkerns=2500;
maxfontdimen=60;infmainmemory=3000;supmainmemory=8000000;infbufsize=500;
supbufsize=30000000;{:11}type{18:}ASCIIcode=0..255;
...
{:106}{156:}quarterword=0..255;halfword=0..268435455;twochoices=1..2;
threechoices=1..3;#include "texmfmem.h";wordfile=file of memoryword;
{:156}{186:}commandcode=1..86;{:186}{565:}screenrow=0..32767;
screencol=0..32767;transspec=^screencol;pixelcolor=0..1;
{:565}{571:}windownumber=0..15;
...
endif('INIMF')dumpname:constcstring;bounddefault:integer;
boundname:constcstring;mainmemory:integer;memtop:integer;memmax:integer;
bufsize:integer;errorline:integer;halferrorline:integer;
maxprintline:integer;screenwidth:integer;screendepth:integer;
gfbufsize:integer;parsefirstlinep:cinttype;filelineerrorstylep:cinttype;
eightbitp:cinttype;haltonerrorp:cinttype;quotedfilename:boolean;
{:13}{20:}xord:array[ASCIIcode]of ASCIIcode;
xchr:array[ASCIIcode]of ASCIIcode;{:20}{25:}nameoffile:^ASCIIcode;
namelength:0..maxint;{:25}{29:}buffer:^ASCIIcode;first:0..bufsize;
...
{:38}{42:}strref:array[strnumber]of 0..127;
{:42}{50:}ifdef('INIMF')poolfile:alphafile;
endif('INIMF'){:50}{54:}logfile:alphafile;selector:0..5;
...
trickcount:integer;firstcount:integer;{:54}{68:}interaction:0..3;
interactionoption:0..4;{:68}{71:}deletionsallowed:boolean;history:0..3;
errorcount:-1..100;{:71}{74:}helpline:array[0..5]of strnumber;
helpptr:0..6;useerrhelp:boolean;errhelp:strnumber;
...
{:148}{159:}mem:^memoryword;lomemmax:halfword;himemmin:halfword;
{:159}{160:}varused,dynused:integer;{:160}{161:}avail:halfword;
memend:halfword;{:161}{166:}rover:halfword;
{:166}{178:}ifdef('TEXMF_DEBUG')freearr:packed array[0..1]of boolean;
...
{:190}{196:}oldsetting:0..5;
{:196}{198:}charclass:array[ASCIIcode]of 0..20;
{:198}{200:}hashused:halfword;stcount:integer;
{:200}{201:}hash:array[1..9769]of twohalves;
eqtb:array[1..9769]of twohalves;{:201}{225:}gpointer:halfword;
...
{:628}{631:}inopen:0..15;openparens:0..15;
inputfile:array[1..15]of alphafile;line:integer;
linestack:array[1..15]of integer;sourcefilenamestack:^strnumber;
fullsourcefilenamestack:^strnumber;
...
{:659}{680:}forceeof:boolean;{:680}{699:}bgloc,egloc:1..9769;
...
{:768}{775:}basedefaultlength:integer;MFbasedefault:cstring;
{:775}{782:}jobname:strnumber;logopened:boolean;texmflogname:strnumber;
{:782}{785:}gfext:strnumber;{:785}{791:}gffile:bytefile;
outputfilename:strnumber;{:791}{796:}curtype:smallnumber;curexp:integer;
luacurexp:integer;{:796}{813:}maxc:array[17..18]of integer;
maxptr:array[17..18]of halfword;maxlink:array[17..18]of halfword;
{:813}{821:}varflag:0..86;{:821}{954:}txx,txy,tyx,tyy,tx,ty:scaled;
...
gfdx,gfdy:array[eightbits]of integer;{:1149}{1152:}gfbuf:^eightbits;
halfbuf:gfindex;gflimit:gfindex;gfptr:gfindex;gfoffset:integer;
{:1152}{1162:}bocc,bocp:integer;{:1162}{1183:}baseident:strnumber;
{:1183}{1188:}basefile:wordfile;{:1188}{1203:}readyalready:integer;
{:1203}{1216:}editnamestart:poolpointer;editnamelength,editline:integer;
xprn:array[ASCIIcode]of ASCIIcode;stopatspace:boolean;
{:1216}procedure initialize;var{19:}i:integer;{:19}{130:}k:integer;
...
xchr[125]:='}';xchr[126]:='~';{:21}{22:}for i:=0 to 31 do xchr[i]:=i;
...
{:23}{69:}if interactionoption=4 then interaction:=3 else interaction:=
interactionoption;{:69}{72:}deletionsallowed:=true;errorcount:=0;
{:72}{75:}helpptr:=0;useerrhelp:=false;errhelp:=0;
{:75}{92:}interrupt:=0;OKtointerrupt:=true;{:92}{98:}aritherror:=false;
{:98}{131:}twotothe[0]:=1;
...
specatan[26]:=1;{:138}{179:}ifdef('TEXMF_DEBUG')wasmemend:=0;
waslomax:=0;washimin:=memmax;panicking:=false;
endif('TEXMF_DEBUG'){:179}{191:}for k:=1 to 41 do internal[k]:=0;
...
{:199}{202:}hash[1].lh:=0;hash[1].rh:=0;eqtb[1].lh:=42;eqtb[1].rh:=0;
for k:=2 to 9769 do begin hash[k]:=hash[1];eqtb[k]:=eqtb[1];end;
{:202}{231:}bignodesize[13]:=12;bignodesize[14]:=4;
{:231}{251:}saveptr:=0;{:251}{396:}octantdir[1]:=549;octantdir[5]:=550;
octantdir[6]:=551;octantdir[2]:=552;octantdir[4]:=553;octantdir[8]:=554;
octantdir[7]:=555;octantdir[3]:=556;{:396}{428:}maxroundingptr:=0;
...
{:739}{753:}loopptr:=0;{:753}{797:}curexp:=0;{:797}{822:}varflag:=0;
{:822}{1078:}startsym:=0;{:1078}{1085:}longhelpseen:=false;
...
gfoffset:=0;{:1153}{1184:}baseident:=0;{:1184}{1217:}editnamestart:=0;
stopatspace:=true;{:1217}end;{57:}procedure println;
begin case selector of 3:begin writeln(stdout);writeln(logfile);
termoffset:=0;fileoffset:=0;end;2:begin writeln(logfile);fileoffset:=0;
end;1:begin writeln(stdout);termoffset:=0;end;0,4,5:;end;end;
...
incr(poolptr);end;end;end;incr(tally);end;
{:58}{59:}procedure print(s:integer);var j:poolpointer;
begin if(s<0)or(s>=strptr)then s:=259;
if(s<256)and((selector>4)or xprn[s])then printchar(s)else begin j:=
strstart[s];while j<strstart[s+1]do begin printchar(strpool[j]);incr(j);
end;end;end;{:59}{60:}procedure slowprint(s:integer);var j:poolpointer;
begin if(s<0)or(s>=strptr)then s:=259;
if(s<256)and((selector>4)or xprn[s])then printchar(s)else begin j:=
strstart[s];while j<strstart[s+1]do begin print(strpool[j]);incr(j);end;
end;end;{:60}{62:}procedure printnl(s:strnumber);
...
begin while k>0 do begin decr(k);printchar(48+dig[k]);end;end;
...
until n=0;printthedigs(k);end;
{:64}{103:}procedure printscaled(s:scaled);var delta:scaled;
...
begin case t of 1:print(323);2:print(324);3:print(325);4:print(326);
...
32;incr(j);end;end;if mustquote then slowprint(34);
...
then print(strpool[j]);if mustquote then slowprint(34);end;
{:773}{73:}procedure normalizeselector;forward;procedure getnext;
...
endif('TEXMF_DEBUG'){43:}procedure flushstring(s:strnumber);
begin if s<strptr-1 then strref[s]:=0 else repeat decr(strptr);
until strref[strptr-1]<>0;poolptr:=strstart[strptr];end;
{:43}{:73}{76:}noreturn procedure jumpout;begin closefilesandterminate;
begin fflush(stdout);readyalready:=0;
...
if interaction=3 then{78:}while true do begin 22:clearforerrorprompt;
...
{743:}if curcmd=40 then begin if strref[curmod]<127 then if strref[
curmod]>1 then decr(strref[curmod])else flushstring(curmod);end{:743};
decr(c);end;curcmd:=s1;curmod:=s2;cursym:=s3;OKtointerrupt:=true;
begin helpptr:=2;helpline[1]:=278;helpline[0]:=279;end;showcontext;
goto 22;end{:83};ifdef('TEXMF_DEBUG')68:begin debughelp;goto 22;end;
...
inputstack[fileptr].namefield];editline:=line;jumpout;end;
...
helpline[1]:=280;helpline[0]:=281;end;repeat decr(helpptr);
...
case c of 81:begin print(273);decr(selector);end;82:print(274);
83:print(275);end;print(276);println;fflush(stdout);goto 10;end{:81};
88:begin interaction:=2;jumpout;end;others:end;{80:}begin print(266);
printnl(267);printnl(268);if fileptr>0 then print(269);
if deletionsallowed then printnl(270);printnl(271);end{:80}{:79};
end{:78};incr(errorcount);if errorcount=100 then begin printnl(264);
history:=3;jumpout;end;{86:}if interaction>0 then decr(selector);
if useerrhelp then begin printnl(261);{85:}j:=strstart[errhelp];
while j<strstart[errhelp+1]do begin if strpool[j]<>37 then print(strpool
[j])else if j+1=strstart[errhelp+1]then println else if strpool[j+1]<>37
then println else begin incr(j);printchar(37);end;incr(j);end{:85};
end else while helpptr>0 do begin decr(helpptr);
printnl(helpline[helpptr]);end;println;
if interaction>0 then incr(selector);println{:86};10:end;
{:77}{88:}noreturn procedure fatalerror(s:strnumber);
begin normalizeselector;begin if interaction=3 then;
if(filelineerrorstylep and not(curinput.namefield=0))then begin printnl(
261);print(fullsourcefilenamestack[inopen]);print(58);printint(line);
print(262);print(285);end else begin printnl(263);print(285)end;end;
...
{:88}{89:}noreturn procedure overflow(s:strnumber;n:integer);
begin normalizeselector;begin if interaction=3 then;
if(filelineerrorstylep and not(curinput.namefield=0))then begin printnl(
261);print(fullsourcefilenamestack[inopen]);print(58);printint(line);
print(262);print(286);end else begin printnl(263);print(286)end;end;
print(s);printchar(61);printint(n);printchar(93);begin helpptr:=2;
helpline[1]:=287;helpline[0]:=288;end;
begin if interaction=3 then interaction:=2;if logopened then error;
ifdef('TEXMF_DEBUG')if interaction>0 then debughelp;
endif('TEXMF_DEBUG')history:=3;jumpout;end;end;
{:89}{90:}noreturn procedure confusion(s:strnumber);
begin normalizeselector;
if history<2 then begin begin if interaction=3 then;
if(filelineerrorstylep and not(curinput.namefield=0))then begin printnl(
261);print(fullsourcefilenamestack[inopen]);print(58);printint(line);
print(262);print(289);end else begin printnl(263);print(289)end;end;
print(s);printchar(41);begin helpptr:=1;helpline[0]:=290;end;
end else begin begin if interaction=3 then;
if(filelineerrorstylep and not(curinput.namefield=0))then begin printnl(
261);print(fullsourcefilenamestack[inopen]);print(58);printint(line);
print(262);print(291);end else begin printnl(263);print(291)end;end;
begin helpptr:=2;helpline[1]:=292;helpline[0]:=293;end;end;
begin if interaction=3 then interaction:=2;if logopened then error;
ifdef('TEXMF_DEBUG')if interaction>0 then debughelp;
endif('TEXMF_DEBUG')history:=3;jumpout;end;end;
{:90}{:4}{30:}{[34:]if baseident=0 then begin writeln(stdout,
'Buffer size exceeded!');goto 9999;
end else begin curinput.locfield:=first;curinput.limitfield:=last-1;
overflow(256,bufsize);end[:34]}{:30}{36:}function initterminal:boolean;
label 10;begin topenin;
...
{:45}{46:}function strvsstr(s,t:strnumber):integer;label 10;
...
label 30,10;var k,l:0..255;g:strnumber;begin poolptr:=0;strptr:=0;
maxpoolptr:=0;maxstrptr:=0;strstart[0]:=0;
...
buffer[last]:=37;incr(selector);end;
...
if(filelineerrorstylep and not(curinput.namefield=0))then begin printnl(
261);print(fullsourcefilenamestack[inopen]);print(58);printint(line);
print(262);print(294);end else begin printnl(263);print(294)end;end;
...
if(filelineerrorstylep and not(curinput.namefield=0))then begin printnl(
261);print(fullsourcefilenamestack[inopen]);print(58);printint(line);
print(262);print(298);end else begin printnl(263);print(298)end;end;
print(s);print(299);end;{:94}{99:}procedure cleararith;
begin begin if interaction=3 then;
if(filelineerrorstylep and not(curinput.namefield=0))then begin printnl(
261);print(fullsourcefilenamestack[inopen]);print(58);printint(line);
print(262);print(300);end else begin printnl(263);print(300)end;end;
begin helpptr:=4;helpline[3]:=301;helpline[2]:=302;helpline[1]:=303;
helpline[0]:=304;end;error;aritherror:=false;end;
...
rounddecimals:=halfp(a+1);end;
{:102}{107:}ifdef('FIXPT')function makefraction(p,q:integer):fraction;
...
endif('FIXPT'){:107}{109:}ifdef('FIXPT')function takefraction(q:integer;
...
f:=halfp(f);until f=1{:111};becareful:=n-2147483647;
...
endif('FIXPT'){:109}{112:}ifdef('FIXPT')function takescaled(q:integer;
...
f:=halfp(f);
until f=1 else repeat if odd(f)then p:=p+halfp(q-p)else p:=halfp(p);
f:=halfp(f);until f=1{:113};becareful:=n-2147483647;
if becareful+p>0 then begin aritherror:=true;n:=2147483647-p;end;
if negative then takescaled:=-(n+p)else takescaled:=n+p;end;
endif('FIXPT'){:112}{114:}ifdef('FIXPT')function makescaled(p,q:integer)
:scaled;var f:integer;n:integer;negative:boolean;becareful:integer;
begin if p>=0 then negative:=false else begin p:=-p;negative:=true;end;
if q<=0 then begin ifdef('TEXMF_DEBUG')if q=0 then confusion(47);
endif('TEXMF_DEBUG')q:=-q;negative:=not negative;end;n:=p div q;
...
endif('FIXPT'){:114}{116:}function velocity(st,ct,sf,cf:fraction;
...
{:117}{121:}function squarert(x:scaled):scaled;var k:smallnumber;
y,q:integer;
begin if x<=0 then{122:}begin if x<0 then begin begin if interaction=3
then;
if(filelineerrorstylep and not(curinput.namefield=0))then begin printnl(
261);print(fullsourcefilenamestack[inopen]);print(58);printint(line);
print(262);print(305);end else begin printnl(263);print(305)end;end;
printscaled(x);print(306);begin helpptr:=2;helpline[1]:=307;
helpline[0]:=308;end;error;end;squarert:=0;end{:122}else begin k:=23;
q:=2;while x<536870912 do begin decr(k);x:=x+x+x+x;end;
...
y:=y+q;end;decr(k){:123};until k=0;squarert:=halfp(q);end;end;
...
if(filelineerrorstylep and not(curinput.namefield=0))then begin printnl(
261);print(fullsourcefilenamestack[inopen]);print(58);printint(line);
print(262);print(309);end else begin printnl(263);print(309)end;end;
printscaled(a);print(310);printscaled(b);print(306);begin helpptr:=2;
helpline[1]:=307;helpline[0]:=308;end;error;end;a:=0;
end{:128}else begin if a<1073741824 then big:=false else begin a:=halfp(
a);b:=halfp(b);big:=true;end;
...
begin if x<=0 then{134:}begin begin if interaction=3 then;
if(filelineerrorstylep and not(curinput.namefield=0))then begin printnl(
261);print(fullsourcefilenamestack[inopen]);print(58);printint(line);
print(262);print(311);end else begin printnl(263);print(311)end;end;
printscaled(x);print(306);begin helpptr:=2;helpline[1]:=312;
helpline[0]:=308;end;error;mlog:=0;end{:134}else begin y:=1302456860;
...
if x=0 then{140:}begin begin if interaction=3 then;
if(filelineerrorstylep and not(curinput.namefield=0))then begin printnl(
261);print(fullsourcefilenamestack[inopen]);print(58);printint(line);
print(262);print(313);end else begin printnl(263);print(313)end;end;
begin helpptr:=2;helpline[1]:=314;helpline[0]:=308;end;error;narg:=0;
end{:140}else begin{142:}while x>=536870912 do begin x:=halfp(x);
y:=halfp(y);end;z:=0;
if y>0 then begin while x<268435456 do begin x:=x+x;y:=y+y;end;
{143:}k:=0;repeat y:=y+y;incr(k);if y>x then begin z:=z+specatan[k];
t:=x;x:=x+(y div twotothe[k+k]);y:=y-t;end;until k=15;repeat y:=y+y;
incr(k);if y>x then begin z:=z+specatan[k];y:=y-x;end;until k=26{:143};
...
i:0..54;begin j:=abs(seed);while j>=268435456 do j:=halfp(j);k:=1;
...
{:152}{157:}ifdef('TEXMF_DEBUG')procedure printword(w:memoryword);
...
endif('TEXMF_DEBUG'){:157}{162:}{217:}procedure printcapsule;forward;
procedure showtokenlist(p,q:integer;l,nulltally:integer);label 10;
var cclass,c:smallnumber;r,v:integer;begin cclass:=3;tally:=nulltally;
...
if(p<0)or(p>memend)then begin print(494);goto 10;end;
if p<himemmin then{219:}if mem[p].hh.b1=12 then if mem[p].hh.b0=16 then
{220:}begin if cclass=0 then printchar(32);v:=mem[p+1].int;
if v<0 then begin if cclass=17 then printchar(32);printchar(91);
printscaled(v);printchar(93);c:=18;end else begin printscaled(v);c:=0;
end;
end{:220}else if mem[p].hh.b0<>4 then print(497)else begin printchar(34)
;slowprint(mem[p+1].int);printchar(34);c:=4;
end else if(mem[p].hh.b1<>11)or(mem[p].hh.b0<1)or(mem[p].hh.b0>19)then
print(497)else begin gpointer:=p;printcapsule;c:=8;
end{:219}else begin r:=mem[p].hh.lh;
if r>=9770 then{222:}begin if r<9920 then begin print(499);r:=r-(9770);
end else if r<10070 then begin print(500);r:=r-(9920);
end else begin print(501);r:=r-(10070);end;printint(r);printchar(41);
c:=8;end{:222}else if r<1 then if r=0 then{221:}begin if cclass=17 then
printchar(32);print(498);c:=18;
end{:221}else print(495)else begin r:=hash[r].rh;
if(r<0)or(r>=strptr)then print(496)else{223:}begin c:=charclass[strpool[
strstart[r]]];if c=cclass then case c of 9:printchar(46);5,6,7,8:;
others:printchar(32)end;slowprint(r);end{:223};end;end{:218};cclass:=c;
p:=mem[p].hh.rh;end;if p<>0 then print(493);10:end;
{:217}{665:}procedure runaway;
begin if scannerstatus>2 then begin printnl(639);
case scannerstatus of 3:print(640);4,5:print(641);6:print(642);end;
...
if r>p+1 then{170:}begin mem[p].hh.lh:=r-p;rover:=p;goto 40;end{:170};
...
if lomemmax+2<himemmin then if lomemmax+2<=268435455 then{168:}begin if
himemmin-lomemmax>=1998 then t:=lomemmax+1000 else t:=lomemmax+1+(
himemmin-lomemmax)div 2;if t>268435455 then t:=268435455;
...
mem[lomemmax].hh.rh:=0;mem[lomemmax].hh.lh:=0;rover:=q;goto 20;
end{:168};overflow(315,memmax+1);40:mem[r].hh.rh:=0;
ifdef('STAT')varused:=varused+s;endif('STAT')getnode:=r;10:end;
{:167}{172:}procedure freenode(p:halfword;s:halfword);var q:halfword;
...
{:177}{180:}ifdef('TEXMF_DEBUG')procedure checkmem(printlocs:boolean);
label 31,32;var p,q,r:halfword;clobbered:boolean;
...
p:=mem[q].hh.rh;
while p<>13 do begin if mem[p+1].hh.lh<>q then begin printnl(599);
printint(p);end;p:=mem[p+1].hh.rh;r:=19;
repeat if mem[mem[p].hh.lh+1].int>=mem[r+1].int then begin printnl(600);
printint(p);end;r:=mem[p].hh.lh;q:=p;p:=mem[q].hh.rh;until r=0;
end{:617};if printlocs then{184:}begin printnl(320);
...
endif('TEXMF_DEBUG'){:180}{185:}ifdef('TEXMF_DEBUG')procedure searchmem(
p:halfword);var q:integer;
begin for q:=0 to lomemmax do begin if mem[q].hh.rh=p then begin printnl
(321);printint(q);printchar(41);end;
if mem[q].hh.lh=p then begin printnl(322);printint(q);printchar(41);end;
end;
for q:=himemmin to memend do begin if mem[q].hh.rh=p then begin printnl(
321);printint(q);printchar(41);end;
if mem[q].hh.lh=p then begin printnl(322);printint(q);printchar(41);end;
end;
{209:}for q:=1 to 9769 do begin if eqtb[q].rh=p then begin printnl(458);
printint(q);printchar(41);end;end{:209};end;
endif('TEXMF_DEBUG'){:185}{189:}procedure printop(c:quarterword);
...
66:print(383);67:print(384);68:print(385);69:printchar(43);
70:printchar(45);71:printchar(42);72:printchar(47);73:print(386);
74:print(310);75:print(387);76:print(388);77:printchar(60);
78:print(389);79:printchar(62);80:print(390);81:printchar(61);
82:print(391);83:print(38);84:print(392);85:print(393);86:print(394);
87:print(395);88:print(396);89:print(397);90:print(398);91:print(399);
92:print(400);94:print(401);95:print(402);96:print(403);97:print(404);
98:print(405);99:print(406);100:print(407);others:print(408)end;end;
...
hashused=257)then overflow(457,9500);decr(hashused);
...
end;40:idlookup:=p;end;
{:205}{210:}ifdef('INIMF')procedure primitive(s:strnumber;c:halfword;
...
if s>=256 then begin flushstring(strptr-1);hash[cursym].rh:=s;end;
eqtb[cursym].lh:=c;eqtb[cursym].rh:=o;end;
...
others:confusion(492)end;freenode(q,2);end;end;end;
...
begin case c of{212:}19:print(462);78:print(461);60:print(464);
73:print(463);80:print(460);33:print(465);82:print(58);83:print(44);
58:print(466);20:print(467);61:print(468);28:print(469);12:print(470);
81:print(459);85:print(453);27:print(471);6:print(472);10:print(473);
71:print(474);74:print(475);14:print(476);47:print(123);64:print(91);
15:print(477);16:print(478);70:print(479);29:print(480);48:print(408);
25:print(481);7:printchar(92);66:print(125);65:print(93);9:print(482);
13:print(483);8:print(484);84:print(59);18:print(485);79:print(486);
75:print(487);36:print(488);59:print(489);72:print(490);76:print(491);
{:212}{684:}17:if m<=2 then if m=1 then print(656)else if m<1 then print
(454)else print(657)else if m=54 then print(658)else if m=45 then print(
659)else print(660);
4:if m<=1 then if m=1 then print(663)else print(455)else if m=9770 then
print(661)else print(662);{:684}{689:}62:case m of 1:print(665);
2:printchar(64);3:print(666);others:print(664)end;
{:689}{696:}57:if m>=9770 then if m=9770 then print(677)else if m=9920
then print(678)else print(679)else if m<2 then print(680)else if m=2
then print(681)else print(682);
{:696}{710:}3:if m=0 then print(692)else print(618);
{:710}{741:}1,2:case m of 1:print(719);2:print(452);3:print(720);
others:print(721)end;
{:741}{894:}34,35,38,56,46,51,37,44,55,49,52,53:printop(m);
{:894}{1014:}31:printtype(m);
{:1014}{1019:}86:if m=0 then print(913)else print(914);
{:1019}{1025:}24:case m of 0:print(273);1:print(274);2:print(275);
others:print(920)end;
{:1025}{1028:}22:if m=0 then print(921)else print(922);
{:1028}{1038:}23:case m of 0:print(936);1:print(937);2:print(938);
3:print(939);others:print(940)end;
{:1038}{1043:}32,63:begin if c=32 then print(943)else print(944);
print(945);slowprint(hash[m].rh);end;
42:if m=0 then print(946)else print(947);11:print(948);
54,45,50:begin printcmdmod(17,c);print(949);println;
showtokenlist(mem[mem[m].hh.rh].hh.rh,0,1000,0);end;5:print(950);
41:slowprint(intname[m]);
{:1043}{1053:}69:if m=1 then print(957)else if m=0 then print(958)else
print(959);67:if m=6 then print(960)else print(961);
68:if m=0 then print(962)else print(963);
{:1053}{1080:}26:if m<1 then print(993)else if m=1 then print(994)else
print(995);{:1080}{1102:}21:case m of 0:print(1005);1:print(1006);
2:print(1007);3:print(1008);others:print(1009)end;
{:1102}{1109:}77:case m of 0:print(1027);1:print(1028);2:print(1030);
3:print(1032);5:print(1029);6:print(1031);7:print(1033);11:print(1034);
others:print(1035)end;
{:1109}{1180:}30:if m=16 then print(1061)else print(1060);
{:1180}others:print(604)end;end;{:625}procedure showmacro(p:halfword;
...
case mem[p].hh.lh of 0:print(502);1,2,3:begin printchar(60);
printcmdmod(57,mem[p].hh.lh);print(503);end;4:print(504);5:print(505);
6:print(506);7:print(507);end;showtokenlist(mem[p].hh.rh,q,l-tally,0);
10:end;{:227}{232:}procedure initbignode(p:halfword);var q:halfword;
s:smallnumber;begin s:=bignodesize[mem[p].hh.b0];q:=getnode(s);
repeat s:=s-2;
{586:}begin if serialno>2147483583 then overflow(589,serialno div 64);
mem[q+s].hh.b0:=19;serialno:=serialno+64;mem[q+s+1].int:=serialno;
end{:586};mem[q+s].hh.b1:=halfp(s)+5;mem[q+s].hh.rh:=0;until s=0;
...
printchar(120);6:printchar(121);7:print(510);8:print(511);9:print(512);
10:print(513);11:begin print(514);printint(p-0);goto 10;end;end;
print(515);p:=mem[p-2*(mem[p].hh.b1-5)].hh.rh;end{:237};q:=0;
...
others:confusion(516)end;mem[r].hh.rh:=mem[p].hh.rh;mem[r].hh.b0:=21;
...
if eqtb[p].lh mod 87<>42 then begin findvariable:=0;goto 10;end;
...
begin mfluaprintpath(h,s,nuline);printdiagnostic(518,s,nuline);println;
p:=h;repeat q:=mem[p].hh.rh;if(p=0)or(q=0)then begin printnl(259);
goto 30;end;{258:}printtwo(mem[p+1].int,mem[p+2].int);
case mem[p].hh.b1 of 0:begin if mem[p].hh.b0=4 then print(519);
if(mem[q].hh.b0<>0)or(q<>h)then q:=0;goto 31;end;
1:{261:}begin print(525);printtwo(mem[p+5].int,mem[p+6].int);print(524);
if mem[q].hh.b0<>1 then print(526)else printtwo(mem[q+3].int,mem[q+4].
int);goto 31;end{:261};
4:{262:}if(mem[p].hh.b0<>1)and(mem[p].hh.b0<>4)then print(519){:262};
3,2:{263:}begin if mem[p].hh.b0=4 then print(526);
if mem[p].hh.b1=3 then begin print(522);printscaled(mem[p+5].int);
...
if mem[q].hh.b0<=1 then print(520)else if(mem[p+6].int<>65536)or(mem[q+4
].int<>65536)then{260:}begin print(523);
if mem[p+6].int<0 then print(464);printscaled(abs(mem[p+6].int));
if mem[p+6].int<>mem[q+4].int then begin print(524);
if mem[q+4].int<0 then print(464);printscaled(abs(mem[q+4].int));end;
end{:260};31:{:258};p:=q;
if(p<>h)or(mem[h].hh.b0<>0)then{259:}begin printnl(521);
...
end else if mem[p].hh.b0=3 then begin print(522);
printscaled(mem[p+3].int);printchar(125);end;end{:259};until p=h;
if mem[h].hh.b0<>0 then print(385);30:enddiagnostic(true);end;
...
begin printdiagnostic(570,s,nuline);nothingprinted:=true;println;
...
begin if nothingprinted then nothingprinted:=false else printnl(572);
...
printtwo(mem[w+1].int+mem[w+2].int,mem[w+2].int);end;printnl(571);
...
if mem[q].hh.b0<>19 then confusion(590);printvariablename(q);
v:=mem[q+1].int mod 64;while v>0 do begin print(591);v:=v-2;end;
...
{802:}case t of 1:print(323);2:if v=30 then print(347)else print(348);
...
selector:=3;end;case t of 6:printpen(v,261,false);
8:printpath(v,764,false);9:printpath(v,261,false);11:begin curedges:=v;
printedges(261,false,0,0);end;end;end{:804};
...
19:printvariablename(p);others:confusion(762)end{:802};
...
if s<>261 then begin printnl(263);print(s);end;end;
...
if abs(v)>halfp(threshold)then begin s:=getnode(2);mem[s].hh.lh:=qq;
mem[s+1].int:=v;
...
f));mem[r].hh.rh:=p;depfinal:=p;pplusfq:=mem[memtop-1].hh.rh;end;
...
if(filelineerrorstylep and not(curinput.namefield=0))then begin printnl(
261);print(fullsourcefilenamestack[inopen]);print(58);printint(line);
print(262);print(592);end else begin printnl(263);print(592)end;end;
printscaled(x);printchar(41);begin helpptr:=4;helpline[3]:=593;
helpline[2]:=594;helpline[1]:=595;helpline[0]:=596;end;error;end;end;
...
printnl(597);printvariablename(p);printchar(61);
...
freenode(q,7);q:=r;until q=p;end;
{:268}{385:}procedure tossedges(h:halfword);var p,q:halfword;
begin q:=mem[h].hh.rh;while q<>h do begin flushlist(mem[q+1].hh.rh);
...
begin if serialno>2147483583 then overflow(589,serialno div 64);
...
while mem[p+1].int mod 64>0 do begin print(591);
...
11:tossedges(curexp);others:end;curtype:=16;curexp:=v;end;
{:808}{820:}procedure flusherror(v:scaled);begin error;flushcurexp(v);
...
case eqtb[p].lh mod 87 of 11,54,45,50:if not saving then deletemacref(q)
;42:if q<>0 then if saving then mem[q].hh.b1:=1 else begin
...
ifdef('STAT')decr(dynused);endif('STAT')end;saveptr:=p;end;
{:254}{264:}function copyknot(p:halfword):halfword;var q:halfword;
k:0..6;begin q:=getnode(7);for k:=0 to 6 do mem[q+k]:=mem[p+k];
copyknot:=q;end;{:264}{265:}function copypath(p:halfword):halfword;
label 10;var q,pp,qq:halfword;begin q:=getnode(7);qq:=q;pp:=p;
...
setcontrols(s,t,k);incr(k);s:=t;until k=n{:297};10:end;
...
end;if internal[4]>0 then printpath(knots,527,true);{271:}p:=knots;
...
incr(k);s:=t;if k=pathsize then overflow(532,pathsize);if s=q then n:=k;
...
if internal[4]>0 then printpath(knots,528,true);
if aritherror then{270:}begin begin if interaction=3 then;
if(filelineerrorstylep and not(curinput.namefield=0))then begin printnl(
261);print(fullsourcefilenamestack[inopen]);print(58);printint(line);
print(262);print(529);end else begin printnl(263);print(529)end;end;
begin helpptr:=2;helpline[1]:=530;helpline[0]:=531;end;putgeterror;
aritherror:=false;end{:270};end;
...
if(xx3-xx0>=268435456)or(yy3-yy0>=268435456)then{313:}begin x1:=half(x1+
xicorr);x2:=half(x2+xicorr);x3:=half(x3+xicorr);r:=half(r+xicorr);
y1:=half(y1+etacorr);y2:=half(y2+etacorr);y3:=half(y3+etacorr);
s:=half(s+etacorr);l:=15;end{:313};
while true do begin 22:{314:}if m=0 then{315:}while n>0 do begin incr(
moveptr);move[moveptr]:=1;decr(n);
end{:315}else if n=0 then{316:}move[moveptr]:=move[moveptr]+m{:316}else
if m+n=2 then{317:}begin r:=twotothe[l]-r;s:=twotothe[l]-s;
while l<30 do begin x3a:=x3;x2a:=half(x2+x3+xicorr);
x2:=half(x1+x2+xicorr);x3:=half(x2+x2a+xicorr);t:=x1+x2+x3;
r:=r+r-xicorr;y3a:=y3;y2a:=half(y2+y3+etacorr);y2:=half(y1+y2+etacorr);
y3:=half(y2+y2a+etacorr);u:=y1+y2+y3;s:=s+s-etacorr;
if t<r then if u<s then{318:}begin x1:=x3;x2:=x2a;x3:=x3a;r:=r-t;y1:=y3;
y2:=y2a;y3:=y3a;s:=s-u;end{:318}else begin{320:}begin incr(moveptr);
move[moveptr]:=2;end{:320};goto 30;
...
s:=s-etacorr;
if abvscd(x1+x2+x3,s,y1+y2+y3,r)-xicorr>=0 then{319:}begin incr(move[
moveptr]);incr(moveptr);move[moveptr]:=1;
end{:319}else{320:}begin incr(moveptr);move[moveptr]:=2;end{:320};
30:end{:317}else begin incr(l);bisectstack[bisectptr+10]:=l;
bisectstack[bisectptr+2]:=x3;
bisectstack[bisectptr+1]:=half(x2+x3+xicorr);x2:=half(x1+x2+xicorr);
x3:=half(x2+bisectstack[bisectptr+1]+xicorr);bisectstack[bisectptr]:=x3;
r:=r+r+xicorr;t:=x1+x2+x3+r;q:=t div twotothe[l];
bisectstack[bisectptr+3]:=t mod twotothe[l];
bisectstack[bisectptr+4]:=m-q;m:=q;bisectstack[bisectptr+7]:=y3;
bisectstack[bisectptr+6]:=half(y2+y3+etacorr);y2:=half(y1+y2+etacorr);
...
+1]then begin incr(move[k-1]);move[k]:=a-1;end;
...
temp:integer;p,q:halfword;begin ml:=ml+4096;mr:=mr+4096;nl:=nl+4096;
nr:=nr+4095;if ml<mem[curedges+2].hh.lh then mem[curedges+2].hh.lh:=ml;
...
repeat q:=getnode(2);mem[q+1].hh.rh:=memtop;mem[q+1].hh.lh:=1;
mem[p].hh.lh:=q;mem[q].hh.rh:=p;p:=q;decr(delta);until delta=0;
...
repeat q:=getnode(2);mem[q+1].hh.rh:=memtop;mem[q+1].hh.lh:=1;
mem[p].hh.rh:=q;mem[q].hh.lh:=p;p:=q;decr(delta);until delta=0;
...
repeat{339:}q:=mem[p+1].hh.rh;r:=memtop;
while q<>memtop do begin s:=mem[q].hh.rh;mem[q].hh.rh:=r;r:=q;
...
lh-4096)<=-4096)then begin begin if interaction=3 then;
if(filelineerrorstylep and not(curinput.namefield=0))then begin printnl(
261);print(fullsourcefilenamestack[inopen]);print(58);printint(line);
print(262);print(536);end else begin printnl(263);print(536)end;end;
begin helpptr:=3;helpline[2]:=537;helpline[1]:=538;helpline[0]:=539;end;
putgeterror;
...
261);print(fullsourcefilenamestack[inopen]);print(58);printint(line);
print(262);print(536);end else begin printnl(263);print(536)end;end;
begin helpptr:=3;helpline[2]:=540;helpline[1]:=538;helpline[0]:=539;end;
putgeterror;
...
begin mind:=268435455;maxd:=0;minn:=268435455;maxn:=0;
p:=mem[curedges].hh.rh;n:=mem[curedges+1].hh.lh;
...
.lh;mm:=d div 8;ww:=ww+(d mod 8)-4;end;
...
if r<>memtop-1 then{351:}begin if minn=268435455 then minn:=n;maxn:=n;
...
end{:349};p:=mem[p].hh.rh;incr(n);end;
...
if mspread>movesize then overflow(541,movesize);
...
confusion(511);extras:=(abs(w)-1)div 3;
...
nmagic:=nmagic-8;until mem[p].hh.lh=curedges;freenode(p,2);
{364:}move[mspread]:=0;j:=0;while move[j]=memtop do incr(j);
...
while n<mem[h+1].hh.lh do begin incr(n);p:=mem[p].hh.rh;end;
...
p:=mem[p].hh.rh;y0:=y0+65536;incr(n);end;
...
dx:integer;edgeandweight:integer;j:integer;n:integer;
ifdef('TEXMF_DEBUG')sum:integer;endif('TEXMF_DEBUG')begin delta:=n1-n0;
ifdef('TEXMF_DEBUG')sum:=move[0];
for k:=1 to delta do sum:=sum+abs(move[k]);
if sum<>m1-m0 then confusion(48);
endif('TEXMF_DEBUG'){380:}case octant of 1:begin dx:=8;
...
incr(k);until k>delta;goto 30{:383};
...
3:begin curx:=x+y;cury:=-y;end;end;end;
...
{392:}d:=1;x0:=a;x1:=a-b;x2:=b-c;repeat x:=half(x1+x2);
...
var p,q:halfword;octant:smallnumber;begin printdiagnostic(545,s,true);
p:=curspec;octant:=mem[p+3].int;println;
unskew(mem[curspec+1].int,mem[curspec+2].int,octant);
printtwo(curx,cury);print(546);
while true do begin print(octantdir[octant]);printchar(39);
while true do begin q:=mem[p].hh.rh;if mem[p].hh.b1=0 then goto 45;
{397:}begin printnl(557);unskew(mem[p+5].int,mem[p+6].int,octant);
printtwo(curx,cury);print(524);unskew(mem[q+3].int,mem[q+4].int,octant);
printtwo(curx,cury);printnl(521);
unskew(mem[q+1].int,mem[q+2].int,octant);printtwo(curx,cury);print(558);
printint(mem[q].hh.b0-1);end{:397};p:=q;end;
45:if q=curspec then goto 30;p:=q;octant:=mem[p+3].int;printnl(547);end;
30:printnl(548);enddiagnostic(true);end;
...
559);print(octantdir[mem[q+3].int]);q:=mem[q].hh.rh;
...
if q<>0 then{401:}if mem[mem[q].hh.rh].hh.b0=0 then begin print(559);
print(octantdir[mem[q+3].int]);q:=mem[q].hh.rh;
while mem[mem[q].hh.rh].hh.b0=0 do begin printchar(32);
print(octantdir[mem[q+3].int]);q:=mem[q].hh.rh;end;printchar(41);
end{:401};begin if interaction=3 then;
if(filelineerrorstylep and not(curinput.namefield=0))then begin printnl(
261);print(fullsourcefilenamestack[inopen]);print(58);printint(line);
print(262);print(s);end else begin printnl(263);print(s)end;end;end;
...
then incr(maxroundingptr)else overflow(569,maxwiggle);
after[curroundingptr]:=a;before[curroundingptr]:=b;
nodetoround[curroundingptr]:=p;incr(curroundingptr);end;
...
begin compromise:=half(goodval(u+u,-u-v));end;
...
if odd(mem[q].hh.b1)then a:=goodval(b,penedge+halfp(curgran))else a:=
goodval(b-1,penedge+halfp(curgran));end{:442}else a:=b else a:=b;
...
if odd(aa-bb)then if mem[p].hh.b1>4 then cc:=dd-half(aa-bb+1)else cc:=dd
-half(aa-bb-1)else cc:=dd-half(aa-bb);end;d:=mem[p+2].int;
if odd(a-b)then if mem[p].hh.b1>4 then c:=d-half(a-b-1)else c:=d-half(a-
b+1)else c:=d-half(a-b){:445};
...
if tracing>0 then printpath(curspec,560,true);
...
mem[p].hh.b0:=k;if k<255 then incr(k)else k:=1;until p=curspec;
if chopped>0 then begin begin if interaction=3 then;
if(filelineerrorstylep and not(curinput.namefield=0))then begin printnl(
261);print(fullsourcefilenamestack[inopen]);print(58);printint(line);
print(262);print(564);end else begin printnl(263);print(564)end;end;
begin helpptr:=4;helpline[3]:=565;helpline[2]:=566;helpline[1]:=567;
helpline[0]:=568;end;putgeterror;end{:404};quadrantsubdivide;
if(internal[36]>0)and(chopped=0)then xyround;octantsubdivide;
...
{458:}while true do begin if clockwise then if o1=1 then o1:=8 else decr
(o1)else if o1=8 then o1:=1 else incr(o1);if o1=o2 then goto 30;
...
if tracing>0 then if(internal[36]<=0)or(chopped<>0)then printspec(561)
else if internal[36]>65536 then printspec(562)else printspec(563);
...
{468:}if n1-n0>=movesize then overflow(541,movesize);move[0]:=d0;
...
mfluaPREmovetoedges(p);movetoedges(m0,n0,m1,n1);mfluaPOSTmovetoedges(p);
end;p:=mem[q].hh.rh;until p=h;tossknotlist(h);
...
incr(n);end;31:{483:}r:=mem[h].hh.rh;
if odd(k)then begin mem[w].hh.rh:=r;mem[r].hh.lh:=w;
end else begin mem[w].hh.lh:=r;mem[r].hh.rh:=w;mem[h].hh.rh:=w;r:=w;end;
...
{:483};if n>=255 then overflow(580,255);mem[h].hh.lh:=n;end{:481};
goto 40;45:p:=3;
{478:}if mc>=268402688 then begin begin if interaction=3 then;
if(filelineerrorstylep and not(curinput.namefield=0))then begin printnl(
261);print(fullsourcefilenamestack[inopen]);print(58);printint(line);
print(262);print(574);end else begin printnl(263);print(574)end;end;
begin helpptr:=2;helpline[1]:=575;helpline[0]:=576;end;
end else begin begin if interaction=3 then;
if(filelineerrorstylep and not(curinput.namefield=0))then begin printnl(
261);print(fullsourcefilenamestack[inopen]);print(58);printint(line);
print(262);print(577);end else begin printnl(263);print(577)end;end;
begin helpptr:=3;helpline[2]:=578;helpline[1]:=579;helpline[0]:=576;end;
end;putgeterror{:478};40:if internal[6]>0 then printpen(p,573,true);
makepen:=p;end;
...
k:1..8;h:halfword;m,n:integer;w,ww:halfword;begin p:=memtop-1;
...
makepath:=mem[memtop-1].hh.rh;end;
...
if rising then incr(k)else decr(k);w:=ww;end;10:end;
...
mfluaprintretrogradeline(x0,y0,curx,cury);
ifdef('STAT')if internal[10]>65536 then begin printnl(586);
printtwo(x0,y0);print(585);printtwo(curx,cury);printnl(261);end;
endif('STAT')lineedges(x0,y0,curx,cury);end;end;
...
ifdef('STAT')if internal[10]>65536 then begin printnl(587);printint(k);
print(588);unskew(xx,yy-32768,octant);printtwo(curx,cury);end;
...
ifdef('STAT')if internal[10]>65536 then begin print(585);
...
{520:}repeat if m<envmove[n]then envmove[n]:=m;m:=m+move[n]-1;incr(n);
until n>moveptr{:520};r:=s;end;
30:{523:}ifdef('TEXMF_DEBUG')if(m<>mm1)or(moveptr<>n1-n0)then confusion(
50);endif('TEXMF_DEBUG')move[0]:=d0+envmove[1]-mm0;
...
ifdef('STAT')if internal[10]>65536 then{509:}begin printnl(581);
print(octantdir[octant]);print(559);printint(mem[h].hh.lh);
if mem[h].hh.lh<>1 then print(582)else print(583);print(584);
unskew(mem[p+1].int+mem[w+1].int,mem[p+2].int+mem[w+2].int,octant);
printtwo(curx,cury);ww:=mem[h].hh.rh;
if mem[q+6].int=1 then ww:=mem[ww].hh.lh;print(585);
...
if n1-n0>=movesize then overflow(541,movesize){:508};
mfluaPREoffsetprep(p,h);offsetprep(p,h);mfluaPOSToffsetprep(p,h);
...
+32768,mem[r+6].int+mem[w+2].int+32768,mem[s+4].int+mem[w+2].int+32768,
mem[s+2].int+mem[w+2].int+32768,xycorr[octant],ycorr[octant]);
{514:}repeat m:=m+move[n]-1;if m>envmove[n]then envmove[n]:=m;incr(n);
until n>moveptr{:514};r:=s;end;
30:{517:}ifdef('TEXMF_DEBUG')if(m<>mm1)or(moveptr<>n1-n0)then confusion(
49);endif('TEXMF_DEBUG')move[0]:=d0+envmove[0]-mm0;
...
goto 10;end;
{560:}45:if odd(curtt)then if odd(curt)then{561:}begin curt:=halfp(curt)
;curtt:=halfp(curtt);if curt=0 then goto 10;bisectptr:=bisectptr-45;
...
{:562}{574:}procedure openawindow(k:windownumber;r0,c0,r1,c1:scaled;
...
then begin if n=0 then if alreadythere then begin b:=0;incr(n);
end else b:=1 else incr(n);rowtransition[n]:=m;end;
...
1 else b:=0;incr(n);rowtransition[n]:=rightcol[k];
...
depfinal:=p;pplusq:=mem[memtop-1].hh.rh;end;
...
pwithxbecomingq:=pplusfq(mem[memtop-1].hh.rh,v,q,t,17);end;end;
...
finalnode:=r;p:=mem[memtop-1].hh.rh{:612};
if internal[2]>0 then{613:}if interesting(x)then begin begindiagnostic;
printnl(598);printvariablename(x);w:=n;while w>0 do begin print(591);
...
if(filelineerrorstylep and not(curinput.namefield=0))then begin printnl(
261);print(fullsourcefilenamestack[inopen]);print(58);printint(line);
print(262);print(601);end else begin printnl(263);print(601)end;end;
begin helpptr:=2;helpline[1]:=602;helpline[0]:=603;end;putgeterror;
end{:623};goto 10;end;r:=mem[r+1].int;end;r:=mem[p+1].int;
mem[p+1].int:=mem[q+1].int;mem[q+1].int:=r;10:end;
...
{636:}if(fileptr=inputptr)or(curinput.indexfield<=15)or(curinput.
indexfield<>19)or(curinput.locfield<>0)then begin tally:=0;
oldsetting:=selector;
if(curinput.indexfield<=15)then begin{637:}if curinput.namefield<=1 then
if(curinput.namefield=0)and(fileptr=0)then printnl(605)else printnl(606)
else if curinput.namefield=2 then printnl(607)else begin printnl(608);
...
end else begin{638:}case curinput.indexfield of 16:printnl(609);
17:{639:}begin printnl(614);p:=paramstack[curinput.limitfield];
if p<>0 then if mem[p].hh.rh=1 then printexp(p,0)else showtokenlist(p,0,
20,tally);print(615);end{:639};18:printnl(610);
19:if curinput.locfield=0 then printnl(611)else printnl(612);
20:printnl(613);21:begin println;
...
showtokenlist(p,0,20,tally);mem[q].hh.rh:=0;end;end{:640};print(502);
...
if inputptr=stacksize then overflow(616,stacksize);end;
...
15:begin begin if serialno>2147483583 then overflow(589,serialno div 64)
...
others:confusion(801)end;end;{:855}function curtok:halfword;
var p:halfword;savetype:smallnumber;saveexp:integer;
begin if cursym=0 then if curcmd=39 then begin savetype:=curtype;
...
if curcmd=43 then mem[p].hh.b0:=16 else mem[p].hh.b0:=4;
...
curinput.indexfield:=20;OKtointerrupt:=true;error;end;
{:653}{654:}procedure beginfilereading;
begin if inopen=15 then overflow(617,15);
...
if curinput.indexfield<>inopen then confusion(618);
...
if cursym=0 then begin if interaction=3 then;
if(filelineerrorstylep and not(curinput.namefield=0))then begin printnl(
261);print(fullsourcefilenamestack[inopen]);print(58);printint(line);
print(262);print(624);end else begin printnl(263);print(624)end;
end else begin begin if interaction=3 then;
if(filelineerrorstylep and not(curinput.namefield=0))then begin printnl(
261);print(fullsourcefilenamestack[inopen]);print(58);printint(line);
print(262);print(625);end else begin printnl(263);print(625)end;end;end;
print(626);begin helpptr:=4;helpline[3]:=627;helpline[2]:=628;
helpline[1]:=629;helpline[0]:=630;end;
case scannerstatus of{664:}2:begin print(631);helpline[3]:=632;
cursym:=9763;end;3:begin print(633);helpline[3]:=634;
if warninginfo=0 then cursym:=9767 else begin cursym:=9759;
eqtb[9759].rh:=warninginfo;end;end;4,5:begin print(635);
if scannerstatus=5 then slowprint(hash[warninginfo].rh)else
printvariablename(warninginfo);cursym:=9765;end;6:begin print(636);
slowprint(hash[warninginfo].rh);print(637);helpline[3]:=638;
cursym:=9764;end;{:664}end;inserror;
end{:663}else begin begin if interaction=3 then;
if(filelineerrorstylep and not(curinput.namefield=0))then begin printnl(
261);print(fullsourcefilenamestack[inopen]);print(58);printint(line);
print(262);print(619);end else begin printnl(263);print(619)end;end;
printint(warninginfo);begin helpptr:=3;helpline[2]:=620;
helpline[1]:=621;helpline[0]:=622;end;if cursym=0 then helpline[2]:=623;
...
var k:0..bufsize;c:ASCIIcode;cclass:ASCIIcode;n,f:integer;
begin 20:cursym:=0;
if(curinput.indexfield<=15)then{669:}begin 25:c:=buffer[curinput.
locfield];incr(curinput.locfield);cclass:=charclass[c];
case cclass of 0:goto 85;
1:begin cclass:=charclass[buffer[curinput.locfield]];
if cclass>1 then goto 25 else if cclass<1 then begin n:=0;goto 86;end;
end;2:goto 25;
3:begin{679:}if curinput.namefield>2 then{681:}begin incr(line);
...
then printnl(653);println;first:=curinput.startfield;begin;print(42);
...
end else fatalerror(654);end{:679};
begin if interrupt<>0 then pauseforinstructions;end;goto 25;end;
4:{671:}begin if buffer[curinput.locfield]=34 then curmod:=261 else
...
locfield:=curinput.limitfield;begin if interaction=3 then;
if(filelineerrorstylep and not(curinput.namefield=0))then begin printnl(
261);print(fullsourcefilenamestack[inopen]);print(58);printint(line);
print(262);print(646);end else begin printnl(263);print(646)end;end;
begin helpptr:=3;helpline[2]:=647;helpline[1]:=648;helpline[0]:=649;end;
...
incr(curinput.locfield);curcmd:=40;goto 10;end{:671};
5,6,7,8:begin k:=curinput.locfield-1;goto 40;end;
20:{670:}begin begin if interaction=3 then;
if(filelineerrorstylep and not(curinput.namefield=0))then begin printnl(
261);print(fullsourcefilenamestack[inopen]);print(58);printint(line);
print(262);print(643);end else begin printnl(263);print(643)end;end;
begin helpptr:=2;helpline[1]:=644;helpline[0]:=645;end;
deletionsallowed:=false;error;deletionsallowed:=true;goto 20;end{:670};
others:end;k:=curinput.locfield-1;
while charclass[buffer[curinput.locfield]]=cclass do incr(curinput.
...
if f=65536 then begin incr(n);f:=0;end{:674};
87:{675:}if n<4096 then curmod:=n*65536+f else begin begin if
interaction=3 then;
if(filelineerrorstylep and not(curinput.namefield=0))then begin printnl(
261);print(fullsourcefilenamestack[inopen]);print(58);printint(line);
print(262);print(650);end else begin printnl(263);print(650)end;end;
begin helpptr:=2;helpline[1]:=651;helpline[0]:=652;end;
deletionsallowed:=false;error;deletionsallowed:=true;curmod:=268435455;
end;curcmd:=43;goto 10{:675};40:cursym:=idlookup(k,curinput.locfield-k);
...
if cursym>=9770 then if cursym>=9920 then{677:}begin if cursym>=10070
then cursym:=cursym-150;
begintokenlist(paramstack[curinput.limitfield+cursym-(9920)],18);
goto 20;end{:677}else begin curcmd:=39;
...
if mem[curinput.locfield].hh.b0=16 then curcmd:=43 else begin curcmd:=40
;begin if strref[curmod]<127 then incr(strref[curmod]);end;end;
end else begin curmod:=curinput.locfield;curcmd:=39;end;
...
if curcmd>=87 then if checkoutervalidity then curcmd:=curcmd-87 else
...
first:=curinput.limitfield;begin;print(655);terminput;end;
...
if curcmd=terminator then{687:}if curmod>0 then incr(balance)else begin
decr(balance);if balance=0 then goto 30;
end{:687}else if curcmd=62 then{690:}begin if curmod=0 then getnext else
if curmod<=suffixcount then cursym:=9919+curmod;end{:690};end;
mem[p].hh.rh:=curtok;p:=mem[p].hh.rh;end;30:mem[p].hh.rh:=tailend;
flushnodelist(substlist);scantoks:=mem[memtop-2].hh.rh;end;
{:685}{691:}procedure getsymbol;label 20;begin 20:getnext;
if(cursym=0)or(cursym>9757)then begin begin if interaction=3 then;
if(filelineerrorstylep and not(curinput.namefield=0))then begin printnl(
261);print(fullsourcefilenamestack[inopen]);print(58);printint(line);
print(262);print(667);end else begin printnl(263);print(667)end;end;
begin helpptr:=3;helpline[2]:=668;helpline[1]:=669;helpline[0]:=670;end;
if cursym>0 then helpline[2]:=671 else if curcmd=40 then begin if strref
[curmod]<127 then if strref[curmod]>1 then decr(strref[curmod])else
flushstring(curmod);end;cursym:=9757;inserror;goto 20;end;end;
{:691}{692:}procedure getclearsymbol;begin getsymbol;
clearsymbol(cursym,false);end;{:692}{693:}procedure checkequals;
begin if curcmd<>52 then if curcmd<>78 then begin missingerr(61);
begin helpptr:=5;helpline[4]:=672;helpline[3]:=673;helpline[2]:=674;
helpline[1]:=675;helpline[0]:=676;end;backerror;end;end;
{:693}{694:}procedure makeopdef;var m:commandcode;p,q,r:halfword;
begin m:=curmod;getsymbol;q:=getnode(2);mem[q].hh.lh:=cursym;
mem[q+1].int:=9770;getclearsymbol;warninginfo:=cursym;getsymbol;
p:=getnode(2);mem[p].hh.lh:=cursym;mem[p+1].int:=9771;mem[p].hh.rh:=q;
getnext;checkequals;scannerstatus:=5;q:=getavail;mem[q].hh.lh:=0;
r:=getavail;mem[q].hh.rh:=r;mem[r].hh.lh:=0;
mem[r].hh.rh:=scantoks(17,p,0,0);scannerstatus:=0;
eqtb[warninginfo].lh:=m;eqtb[warninginfo].rh:=q;getxnext;end;
{:694}{697:}{1032:}procedure checkdelimiter(ldelim,rdelim:halfword);
label 10;begin if curcmd=63 then if curmod=ldelim then goto 10;
if cursym<>rdelim then begin missingerr(hash[rdelim].rh);
begin helpptr:=2;helpline[1]:=923;helpline[0]:=924;end;backerror;
end else begin begin if interaction=3 then;
if(filelineerrorstylep and not(curinput.namefield=0))then begin printnl(
261);print(fullsourcefilenamestack[inopen]);print(58);printint(line);
print(262);print(925);end else begin printnl(263);print(925)end;end;
...
if curcmd<>42 then clearsymbol(x,false);h:=getavail;mem[h].hh.lh:=x;
t:=h;while true do begin getxnext;if cursym=0 then goto 30;
if curcmd<>42 then if curcmd<>41 then if curcmd=64 then{1012:}begin l:=
cursym;getxnext;if curcmd<>65 then begin backinput;cursym:=l;curcmd:=64;
goto 30;end else cursym:=0;end{:1012}else goto 30;
mem[t].hh.rh:=getavail;t:=mem[t].hh.rh;mem[t].hh.lh:=cursym;end;
30:if eqtb[x].lh mod 87<>42 then clearsymbol(x,false);
...
scannerstatus:=5;n:=0;eqtb[warninginfo].lh:=11;eqtb[warninginfo].rh:=q;
...
if(filelineerrorstylep and not(curinput.namefield=0))then begin printnl(
261);print(fullsourcefilenamestack[inopen]);print(58);printint(line);
print(262);print(683);end else begin printnl(263);print(683)end;end;
begin helpptr:=2;helpline[1]:=684;helpline[0]:=685;end;error;
...
if curcmd=32 then{703:}repeat ldelim:=cursym;rdelim:=curmod;getnext;
if(curcmd=57)and(curmod>=9770)then base:=curmod else begin begin if
interaction=3 then;
if(filelineerrorstylep and not(curinput.namefield=0))then begin printnl(
261);print(fullsourcefilenamestack[inopen]);print(58);printint(line);
print(262);print(686);end else begin printnl(263);print(686)end;end;
begin helpptr:=1;helpline[0]:=687;end;backerror;base:=9770;end;
{704:}repeat mem[q].hh.rh:=getavail;q:=mem[q].hh.rh;
mem[q].hh.lh:=base+k;getsymbol;p:=getnode(2);mem[p+1].int:=base+k;
mem[p].hh.lh:=cursym;if k=150 then overflow(688,150);incr(k);
mem[p].hh.rh:=r;r:=p;getnext;until curcmd<>83{:704};
checkdelimiter(ldelim,rdelim);getnext;until curcmd<>32{:703};
if curcmd=57 then{705:}begin p:=getnode(2);
...
if k=150 then overflow(688,150);incr(k);getsymbol;mem[p].hh.lh:=cursym;
mem[p].hh.rh:=r;r:=p;getnext;if c=4 then if curcmd=70 then begin c:=5;
p:=getnode(2);if k=150 then overflow(688,150);mem[p+1].int:=9770+k;
getsymbol;mem[p].hh.lh:=cursym;mem[p].hh.rh:=r;r:=p;getnext;end;
end{:705};checkequals;p:=getavail;mem[p].hh.lh:=c;mem[q].hh.rh:=p;
{698:}if m=1 then mem[p].hh.rh:=scantoks(17,r,0,n)else begin q:=getavail
;mem[q].hh.lh:=bgloc;mem[p].hh.rh:=q;p:=getavail;mem[p].hh.lh:=egloc;
mem[q].hh.rh:=scantoks(17,r,p,n);end;
...
begin if mem[q].hh.rh=1 then printnl(499)else if(b<10070)and(b<>7)then
printnl(500)else printnl(501);printint(n);print(704);
...
if ldelim=0 then{732:}begin if curcmd>83 then begin if balance=1 then
goto 30 else if curcmd=85 then decr(balance);
end else if curcmd=33 then incr(balance);
end{:732}else{731:}begin if curcmd=63 then begin if curmod=ldelim then
begin decr(balance);if balance=0 then goto 30;end;
end else if curcmd=32 then if curmod=rdelim then incr(balance);
end{:731};mem[p].hh.rh:=curtok;p:=mem[p].hh.rh;end;
30:curexp:=mem[memtop-2].hh.rh;curtype:=20;scannerstatus:=0;end;
...
printmacroname(arglist,macroname);if n=3 then print(666);
showmacro(defref,0,100000);if arglist<>0 then begin n:=0;p:=arglist;
repeat q:=mem[p].hh.lh;printarg(q,n,0);incr(n);p:=mem[p].hh.rh;
until p=0;end;enddiagnostic(false);end{:721};{725:}curcmd:=84;
while mem[r].hh.lh>=9770 do begin{726:}if curcmd<>83 then begin getxnext
;if curcmd<>32 then begin begin if interaction=3 then;
if(filelineerrorstylep and not(curinput.namefield=0))then begin printnl(
261);print(fullsourcefilenamestack[inopen]);print(58);printint(line);
print(262);print(710);end else begin printnl(263);print(710)end;end;
printmacroname(arglist,macroname);begin helpptr:=3;helpline[2]:=711;
helpline[1]:=712;helpline[0]:=713;end;
if mem[r].hh.lh>=9920 then begin curexp:=0;curtype:=20;
end else begin curexp:=0;curtype:=16;end;backerror;curcmd:=63;goto 40;
end;ldelim:=cursym;rdelim:=curmod;end;
{729:}if mem[r].hh.lh>=10070 then scantextarg(ldelim,rdelim)else begin
getxnext;if mem[r].hh.lh>=9920 then scansuffix else scanexpression;
end{:729};
if curcmd<>83 then{727:}if(curcmd<>63)or(curmod<>ldelim)then if mem[mem[
r].hh.rh].hh.lh>=9770 then begin missingerr(44);begin helpptr:=3;
helpline[2]:=714;helpline[1]:=715;helpline[0]:=709;end;backerror;
curcmd:=83;end else begin missingerr(hash[rdelim].rh);begin helpptr:=2;
helpline[1]:=716;helpline[0]:=709;end;backerror;end{:727};
...
if curcmd=83 then begin begin if interaction=3 then;
if(filelineerrorstylep and not(curinput.namefield=0))then begin printnl(
261);print(fullsourcefilenamestack[inopen]);print(58);printint(line);
print(262);print(705);end else begin printnl(263);print(705)end;end;
printmacroname(arglist,macroname);printchar(59);printnl(706);
slowprint(hash[rdelim].rh);print(299);begin helpptr:=3;helpline[2]:=707;
helpline[1]:=708;helpline[0]:=709;end;error;end;
if mem[r].hh.lh<>0 then{733:}begin if mem[r].hh.lh<7 then begin getxnext
;if mem[r].hh.lh<>6 then if(curcmd=52)or(curcmd=78)then getxnext;end;
...
if arglist=0 then arglist:=p else mem[tail].hh.rh:=p;tail:=p;incr(n);
if curcmd<>70 then begin missingerr(479);print(717);
printmacroname(arglist,macroname);begin helpptr:=1;helpline[0]:=718;end;
backerror;end;getxnext;scanprimary;end{:734};
6:{735:}begin if curcmd<>32 then ldelim:=0 else begin ldelim:=cursym;
rdelim:=curmod;getxnext;end;scansuffix;
if ldelim<>0 then begin if(curcmd<>63)or(curmod<>ldelim)then begin
missingerr(hash[rdelim].rh);begin helpptr:=2;helpline[1]:=716;
helpline[0]:=709;end;backerror;end;getxnext;end;end{:735};
...
{736:}while(curinput.indexfield>15)and(curinput.locfield=0)do
endtokenlist;
if paramptr+n>maxparamstack then begin maxparamstack:=paramptr+n;
if maxparamstack>150 then overflow(688,150);end;
...
begin if internal[7]>65536 then if curcmd<>11 then showcmdmod(curcmd,
curmod);case curcmd of 1:conditional;
2:{751:}if curmod>iflimit then if iflimit=1 then begin missingerr(58);
backinput;cursym:=9762;inserror;
end else begin begin if interaction=3 then;
if(filelineerrorstylep and not(curinput.namefield=0))then begin printnl(
261);print(fullsourcefilenamestack[inopen]);print(58);printint(line);
print(262);print(725);end else begin printnl(263);print(725)end;end;
printcmdmod(2,curmod);begin helpptr:=1;helpline[0]:=726;end;error;
...
4:if curmod=0 then{708:}begin begin if interaction=3 then;
if(filelineerrorstylep and not(curinput.namefield=0))then begin printnl(
261);print(fullsourcefilenamestack[inopen]);print(58);printint(line);
print(262);print(689);end else begin printnl(263);print(689)end;end;
begin helpptr:=2;helpline[1]:=690;helpline[0]:=691;end;error;
end{:708}else beginiteration;
5:{712:}begin while(curinput.indexfield>15)and(curinput.locfield=0)do
endtokenlist;if loopptr=0 then begin begin if interaction=3 then;
if(filelineerrorstylep and not(curinput.namefield=0))then begin printnl(
261);print(fullsourcefilenamestack[inopen]);print(58);printint(line);
print(262);print(693);end else begin printnl(263);print(693)end;end;
begin helpptr:=2;helpline[1]:=694;helpline[0]:=695;end;error;
end else resumeiteration;end{:712};6:{713:}begin getboolean;
if internal[7]>65536 then showcmdmod(34,curexp);
if curexp=30 then if loopptr=0 then begin begin if interaction=3 then;
if(filelineerrorstylep and not(curinput.namefield=0))then begin printnl(
261);print(fullsourcefilenamestack[inopen]);print(58);printint(line);
print(262);print(696);end else begin printnl(263);print(696)end;end;
begin helpptr:=1;helpline[0]:=697;end;
if curcmd=84 then error else backerror;end else{714:}begin p:=0;
...
until p<>0;if p<>mem[loopptr].hh.lh then fatalerror(700);stopiteration;
end{:714}else if curcmd<>84 then begin missingerr(59);begin helpptr:=2;
helpline[1]:=698;helpline[0]:=699;end;backerror;end;end{:713};7:;
10:{715:}begin getnext;p:=curtok;getnext;
if curcmd<12 then expand else backinput;begintokenlist(p,19);end{:715};
8:{716:}begin getxnext;scanprimary;
if curtype<>4 then begin disperr(0,701);begin helpptr:=2;
helpline[1]:=702;helpline[0]:=703;end;putgetflusherror(0);
...
first:=curinput.limitfield+1;curinput.locfield:=curinput.startfield;
flushcurexp(0);end{:717};end;end{:716};9:{1214:}begin getxnext;
scanprimary;if curtype<>4 then begin disperr(0,701);begin helpptr:=2;
helpline[1]:=702;helpline[0]:=1085;end;putgetflusherror(0);
end else begin backinput;
if(strstart[curexp+1]-strstart[curexp])>0 then{1215:}begin curinput.
namefield:=2;k:=first+(strstart[curexp+1]-strstart[curexp]);
j:=strstart[curexp];curinput.limitfield:=k;
mfluarunscript(j,first,curinput.limitfield);luacurexp:=makestring;
if(strstart[luacurexp+1]-strstart[luacurexp])>0 then begin
beginfilereading;
begin if strref[luacurexp]<127 then incr(strref[luacurexp]);end;
j:=strstart[luacurexp];
k:=first+(strstart[luacurexp+1]-strstart[luacurexp]);
...
incr(j);incr(first);end;buffer[curinput.limitfield]:=37;
first:=curinput.limitfield+1;curinput.locfield:=curinput.startfield;
begin if strref[luacurexp]<127 then if strref[luacurexp]>1 then decr(
strref[luacurexp])else flushstring(luacurexp);end;end;flushcurexp(0);
end{:1215};end;end{:1214};11:macrocall(curmod,0,cursym);end;end;
{:707}{718:}procedure getxnext;var saveexp:halfword;begin getnext;
if curcmd<12 then begin saveexp:=stashcurexp;
repeat if curcmd=11 then macrocall(curmod,0,cursym)else expand;getnext;
until curcmd>=12;unstashcurexp(saveexp);end;end;
{:718}{737:}procedure stackargument(p:halfword);
begin if paramptr=maxparamstack then begin incr(maxparamstack);
if maxparamstack>150 then overflow(688,150);end;paramstack[paramptr]:=p;
...
;if curmod=2 then decr(l);
end else{743:}if curcmd=40 then begin if strref[curmod]<127 then if
strref[curmod]>1 then decr(strref[curmod])else flushstring(curmod);
end{:743};end;30:scannerstatus:=0;end;
...
while true do begin if q=0 then confusion(719);
if mem[q].hh.rh=p then begin mem[q].hh.b0:=l;goto 10;end;
q:=mem[q].hh.rh;end;end;10:end;{:746}{747:}procedure checkcolon;
begin if curcmd<>82 then begin missingerr(58);begin helpptr:=2;
helpline[1]:=722;helpline[0]:=699;end;backerror;end;end;
...
if curexp=30 then print(723)else print(724);enddiagnostic(false);
...
{:748}{754:}procedure badfor(s:strnumber);begin disperr(0,727);print(s);
print(306);begin helpptr:=4;helpline[3]:=728;helpline[2]:=729;
helpline[1]:=730;helpline[0]:=308;end;putgetflusherror(0);end;
...
if(curcmd<>52)and(curcmd<>78)then begin missingerr(61);begin helpptr:=3;
helpline[2]:=731;helpline[1]:=674;helpline[0]:=732;end;backerror;end;
{764:}mem[s+1].hh.lh:=0;q:=s+1;mem[q].hh.rh:=0;repeat getxnext;
if m<>9770 then scansuffix else begin if curcmd>=82 then if curcmd<=83
then goto 22;scanexpression;
if curcmd=75 then if q=s+1 then{765:}begin if curtype<>16 then badfor(
738);pp:=getnode(4);mem[pp+1].int:=curexp;getxnext;scanexpression;
if curtype<>16 then badfor(739);mem[pp+2].int:=curexp;
if curcmd<>76 then begin missingerr(491);begin helpptr:=2;
helpline[1]:=740;helpline[0]:=741;end;backerror;end;getxnext;
scanexpression;if curtype<>16 then badfor(742);mem[pp+3].int:=curexp;
mem[s+1].hh.lh:=pp;goto 30;end{:765};curexp:=stashcurexp;end;
mem[q].hh.rh:=getavail;q:=mem[q].hh.rh;mem[q].hh.lh:=curexp;curtype:=1;
22:until curcmd<>83;30:{:764};
40:{756:}if curcmd<>82 then begin missingerr(58);begin helpptr:=3;
helpline[2]:=733;helpline[1]:=734;helpline[0]:=735;end;backerror;
...
if internal[7]>65536 then{762:}begin begindiagnostic;printnl(737);
...
{:763}{770:}procedure beginname;begin areadelimiter:=0;extdelimiter:=0;
quotedfilename:=false;end;
{:770}{771:}function morename(c:ASCIIcode):boolean;
begin if c=34 then begin quotedfilename:=not quotedfilename;
morename:=true;
end else if((c=32)or(c=9))and stopatspace and(not quotedfilename)then
morename:=false else begin if ISDIRSEP(c)then begin areadelimiter:=
poolptr;extdelimiter:=0;end else if c=46 then extdelimiter:=poolptr;
...
{:771}{772:}procedure endname;var mustquote:boolean;j,s,t:poolpointer;
...
begin if poolptr+6>maxpoolptr then begin if poolptr+6>poolsize then
overflow(257,poolsize-initpoolptr);maxpoolptr:=poolptr+6;end;end;
if areadelimiter=0 then curarea:=261 else begin mustquote:=false;
s:=strstart[strptr];t:=areadelimiter+1;j:=s;
...
poolptr:=poolptr+2;areadelimiter:=areadelimiter+2;
if extdelimiter<>0 then extdelimiter:=extdelimiter+2;end;
curarea:=strptr;incr(strptr);strstart[strptr]:=areadelimiter+1;end;
if extdelimiter=0 then curext:=261 else begin mustquote:=false;
s:=strstart[strptr];t:=extdelimiter;j:=s;
while(not mustquote)and(j<t)do begin mustquote:=strpool[j]=32;incr(j);
end;if mustquote then begin for j:=poolptr-1 downto t do strpool[j+2]:=
strpool[j];strpool[t+1]:=34;
for j:=t-1 downto s do strpool[j+1]:=strpool[j];strpool[s]:=34;
poolptr:=poolptr+2;extdelimiter:=extdelimiter+2;end;curname:=strptr;
incr(strptr);strstart[strptr]:=extdelimiter;end;mustquote:=false;
s:=strstart[strptr];t:=poolptr;j:=s;
while(not mustquote)and(j<t)do begin mustquote:=strpool[j]=32;incr(j);
end;if mustquote then begin strpool[t+1]:=34;
for j:=t-1 downto s do strpool[j+1]:=strpool[j];strpool[s]:=34;
poolptr:=poolptr+2;end;
if extdelimiter=0 then curname:=makestring else curext:=makestring;end;
...
makenamestring:=makestring;end;k:=1;beginname;stopatspace:=false;
while(k<=namelength)and(morename(nameoffile[k]))do incr(k);
stopatspace:=true;endname;end;
...
incr(curinput.locfield);end;30:endname;end;
{:781}{784:}procedure packjobname(s:strnumber);begin curarea:=261;
curext:=s;curname:=jobname;packfilename(curname,curarea,curext);end;
{:784}{786:}procedure promptfilename(s,e:strnumber);label 30;
var k:0..bufsize;savedcurname:strnumber;begin if interaction=2 then;
if s=744 then begin if interaction=3 then;
if(filelineerrorstylep and not(curinput.namefield=0))then begin printnl(
261);print(fullsourcefilenamestack[inopen]);print(58);printint(line);
print(262);print(745);end else begin printnl(263);print(745)end;
end else begin if interaction=3 then;
if(filelineerrorstylep and not(curinput.namefield=0))then begin printnl(
261);print(fullsourcefilenamestack[inopen]);print(58);printint(line);
print(262);print(746);end else begin printnl(263);print(746)end;end;
printfilename(curname,curarea,curext);print(747);
if e=748 then showcontext;printnl(749);print(s);
if interaction<2 then fatalerror(750);savedcurname:=curname;;begin;
print(262);terminput;end;{787:}begin beginname;k:=first;
...
if curext=261 then curext:=e;
if(strstart[curname+1]-strstart[curname])=0 then curname:=savedcurname;
packfilename(curname,curarea,curext);end;
{:786}{788:}procedure openlogfile;var oldsetting:0..5;k:0..bufsize;
l:0..bufsize;m:integer;months:constcstring;begin oldsetting:=selector;
if jobname=0 then jobname:=getjobname(751);packjobname(752);
recorderchangefilename(stringcast(nameoffile+1));packjobname(753);
while not aopenout(logfile)do{789:}begin selector:=1;
promptfilename(755,753);end{:789};
texmflogname:=amakenamestring(logfile);selector:=2;logopened:=true;
{790:}begin write(logfile,'This is MFLuaJIT, Version 2.7182818','-0.5');
write(logfile,versionstring);slowprint(baseident);print(756);
printint(roundunscaled(internal[16]));printchar(32);
...
printdd(m mod 60);if translatefilename then begin writeln(logfile);
write(logfile,'(');fputs(translatefilename,logfile);write(logfile,')');
end;end{:790};inputstack[inputptr]:=curinput;printnl(754);
...
begin{795:}while(curinput.indexfield>15)and(curinput.locfield=0)do
endtokenlist;
if(curinput.indexfield>15)then begin begin if interaction=3 then;
if(filelineerrorstylep and not(curinput.namefield=0))then begin printnl(
261);print(fullsourcefilenamestack[inopen]);print(58);printint(line);
print(262);print(758);end else begin printnl(263);print(758)end;end;
begin helpptr:=3;helpline[2]:=759;helpline[1]:=760;helpline[0]:=761;end;
error;end;
if(curinput.indexfield<=15)then scanfilename else begin curname:=261;
curext:=261;curarea:=261;end{:795};packfilename(curname,curarea,curext);
while true do begin beginfilereading;
if curext=748 then begin curext:=261;
packfilename(curname,curarea,curext);end;
if kpseinnameok(stringcast(nameoffile+1))and aopenin(inputfile[curinput.
indexfield],kpsemfformat)then goto 30;endfilereading;
promptfilename(744,748);end;
...
slowprint(curinput.namefield);fflush(stdout);{794:}begin line:=1;
if inputln(inputfile[curinput.indexfield],false)then;firmuptheline;
buffer[curinput.limitfield]:=37;first:=curinput.limitfield+1;
curinput.locfield:=curinput.startfield;end{:794};end;
{:793}{824:}procedure badexp(s:strnumber);var saveflag:0..86;
begin begin if interaction=3 then;
if(filelineerrorstylep and not(curinput.namefield=0))then begin printnl(
261);print(fullsourcefilenamestack[inopen]);print(58);printint(line);
print(262);print(s);end else begin printnl(263);print(s)end;end;
print(771);printcmdmod(curcmd,curmod);printchar(39);begin helpptr:=4;
helpline[3]:=772;helpline[2]:=773;helpline[1]:=774;helpline[0]:=775;end;
backinput;cursym:=0;curcmd:=43;curmod:=0;inserror;saveflag:=varflag;
...
mem[p].hh.rh:=0;begintokenlist(p,19);end;
...
if(filelineerrorstylep and not(curinput.namefield=0))then begin printnl(
261);print(fullsourcefilenamestack[inopen]);print(58);printint(line);
print(262);print(791);end else begin printnl(263);print(791)end;end;
...
if mem[q].hh.b0=0 then begin begin if interaction=3 then;
if(filelineerrorstylep and not(curinput.namefield=0))then begin printnl(
261);print(fullsourcefilenamestack[inopen]);print(58);printint(line);
print(262);print(807);end else begin printnl(263);print(807)end;end;
begin helpptr:=2;helpline[1]:=808;helpline[0]:=576;end;putgeterror;
curexp:=3;goto 50;
...
begin if curtype<>14 then begin disperr(0,810);begin helpptr:=5;
helpline[4]:=811;helpline[3]:=812;helpline[2]:=813;helpline[1]:=814;
helpline[0]:=815;end;putgetflusherror(0);curx:=0;cury:=0;
...
begin getxnext;if curcmd=61 then{876:}begin getxnext;scanexpression;
...
if curcmd<>83 then begin missingerr(44);begin helpptr:=2;
...
end;end{:877};if curcmd<>66 then begin missingerr(125);begin helpptr:=3;
helpline[2]:=820;helpline[1]:=821;helpline[0]:=699;end;backerror;end;
...
if internal[7]>131072 then showcmdmod(34,c);
...
curinput.namefield:=1;begin;print(261);terminput;end;
...
336)else print(837)else print(838);printchar(41);end;
...
if n>4095 then begin begin if interaction=3 then;
if(filelineerrorstylep and not(curinput.namefield=0))then begin printnl(
261);print(fullsourcefilenamestack[inopen]);print(58);printint(line);
print(262);print(847);end else begin printnl(263);print(847)end;end;
printint(n);printchar(41);begin helpptr:=1;helpline[0]:=848;end;
putgeterror;end{:914};end;flushcurexp(n*65536);end;
...
11:negateedges(curexp);others:badunary(70)end{:903};
...
begin disperr(p,261);disperr(0,839);if c>=94 then printop(c);
...
helpline[0]:=539;end;putgeterror;30:recyclevalue(p);freenode(p,2);
...
begin helpptr:=3;helpline[2]:=863;helpline[1]:=864;helpline[0]:=539;end;
...
if(filelineerrorstylep and not(curinput.namefield=0))then begin printnl(
261);print(fullsourcefilenamestack[inopen]);print(58);printint(line);
print(262);print(868);end else begin printnl(263);print(868)end;end;
begin helpptr:=3;helpline[2]:=869;helpline[1]:=538;helpline[0]:=539;end;
putgeterror;
...
if(filelineerrorstylep and not(curinput.namefield=0))then begin printnl(
261);print(fullsourcefilenamestack[inopen]);print(58);printint(line);
print(262);print(865);end else begin printnl(263);print(865)end;end;
begin helpptr:=3;helpline[2]:=866;helpline[1]:=867;helpline[0]:=539;end;
putgeterror;10:end;{:963}{966:}{968:}procedure bilin1(p:halfword;
t:scaled;q:halfword;u,delta:scaled);var r:halfword;
begin if t<>65536 then depmult(p,t,true);
...
31:takepart(53+half(r-mem[curexp+1].int));
end{:939}else if curtype=2 then flushcurexp(curexp-mem[p+1].int)else
begin badbinary(p,c);goto 30;end;
{937:}if curtype<>16 then begin if curtype<16 then begin disperr(p,261);
...
begin if gfptr>(2147483647-gfoffset)then begin gfprevptr:=0;
fatalerror(1054);end;
if gflimit=gfbufsize then begin writegf(0,halfbuf-1);gflimit:=halfbuf;
gfoffset:=gfoffset+gfbufsize;gfptr:=0;
...
if gfptr=gflimit then gfswap;end;end;
{:1157}{1158:}procedure gftwo(x:integer);
begin begin gfbuf[gfptr]:=x div 256;incr(gfptr);
...
begin if d<64 then begin gfbuf[gfptr]:=0+d;incr(gfptr);
...
incr(gfptr);if gfptr=gflimit then gfswap;end;gftwo(d);end;end;
...
:=strpool[k];incr(gfptr);if gfptr=gflimit then gfswap;end;end;
...
gffour(minm);gffour(maxm);gffour(minn);gffour(maxn);10:end;
{:1161}{1163:}procedure initgf;var k:0..256;t:integer;
begin gfminm:=4096;gfmaxm:=-4096;gfminn:=4096;gfmaxn:=-4096;
for k:=0 to 255 do charptr[k]:=-1;
{1164:}if internal[27]<=0 then gfext:=1056 else begin oldsetting:=
selector;selector:=5;printchar(46);
printint(makescaled(internal[27],59429463));print(1057);
...
selector:=5;print(1055);printint(roundunscaled(internal[14]));
...
incr(gfptr);if gfptr=gflimit then gfswap;end;gfstring(0,makestring);
decr(strptr);poolptr:=strstart[strptr];gfprevptr:=gfoffset+gfptr;end;
{:1163}{1165:}procedure shipout(c:eightbits);label 30;var f:integer;
...
if f<>0 then begin printchar(46);printint(f);end;fflush(stdout);
bocc:=256*f+c;bocp:=charptr[c];charptr[c]:=gfprevptr;
if internal[34]>0 then{1166:}begin if xoff<>0 then begin gfstring(437,0)
;begin gfbuf[gfptr]:=243;incr(gfptr);if gfptr=gflimit then gfswap;end;
gffour(xoff*65536);end;if yoff<>0 then begin gfstring(438,0);
begin gfbuf[gfptr]:=243;incr(gfptr);if gfptr=gflimit then gfswap;end;
...
incr(gfptr);if gfptr=gflimit then gfswap;end;gftwo(delta);end;
...
until mm=268435456;if w<>0 then printnl(1059);
...
gfprevptr:=gfoffset+gfptr;incr(totalchars);printchar(93);fflush(stdout);
mfluaprintedges(1058,true,xoff,yoff);
if internal[11]>0 then printedges(1058,true,xoff,yoff);end;
...
if(filelineerrorstylep and not(curinput.namefield=0))then begin printnl(
261);print(fullsourcefilenamestack[inopen]);print(58);printint(line);
print(262);print(898);end else begin printnl(263);print(898)end;end;
print(900);printscaled(mem[p+1].int);printchar(41);begin helpptr:=2;
...
print(262);print(601);end else begin printnl(263);print(601)end;end;
begin helpptr:=2;helpline[1]:=602;helpline[0]:=603;end;putgeterror;
end{:623};freenode(p,2);end{:1008}else begin lineareq(p,t);
...
{623:}begin begin if interaction=3 then;
if(filelineerrorstylep and not(curinput.namefield=0))then begin printnl(
261);print(fullsourcefilenamestack[inopen]);print(58);printint(line);
print(262);print(601);end else begin printnl(263);print(601)end;end;
begin helpptr:=2;helpline[1]:=602;helpline[0]:=603;end;putgeterror;
end{:623};goto 30;end;begin if interaction=3 then;
if(filelineerrorstylep and not(curinput.namefield=0))then begin printnl(
261);print(fullsourcefilenamestack[inopen]);print(58);printint(line);
print(262);print(895);end else begin printnl(263);print(895)end;end;
begin helpptr:=2;helpline[1]:=896;helpline[0]:=897;end;putgeterror;
goto 30;45:begin if interaction=3 then;
if(filelineerrorstylep and not(curinput.namefield=0))then begin printnl(
261);print(fullsourcefilenamestack[inopen]);print(58);printint(line);
print(262);print(898);end else begin printnl(263);print(898)end;end;
begin helpptr:=2;helpline[1]:=899;helpline[0]:=897;end;putgeterror;
goto 30;end{:1004};
...
{:1003}end;{1002:}disperr(lhs,261);disperr(0,892);
...
begin lhs:=stashcurexp;getxnext;varflag:=78;scanexpression;
if curcmd=52 then doequation else if curcmd=78 then doassignment;
...
end else begin lhs:=curexp;curtype:=1;getxnext;varflag:=78;
scanexpression;
if curcmd=52 then doequation else if curcmd=78 then doassignment;
...
if mem[lhs].hh.lh>9769 then{999:}if curtype=16 then internal[mem[lhs].hh
.lh-(9769)]:=curexp else begin disperr(0,888);
slowprint(intname[mem[lhs].hh.lh-(9769)]);print(889);begin helpptr:=2;
...
if(filelineerrorstylep and not(curinput.namefield=0))then begin printnl(
261);print(fullsourcefilenamestack[inopen]);print(58);printint(line);
print(262);print(901);end else begin printnl(263);print(901)end;end;
begin helpptr:=2;helpline[1]:=902;helpline[0]:=903;end;putgeterror;end;
flushlist(p);if curcmd<83 then{1016:}begin begin if interaction=3 then;
if(filelineerrorstylep and not(curinput.namefield=0))then begin printnl(
261);print(fullsourcefilenamestack[inopen]);print(58);printint(line);
print(262);print(904);end else begin printnl(263);print(904)end;end;
begin helpptr:=5;helpline[4]:=905;helpline[3]:=906;helpline[2]:=907;
helpline[1]:=908;helpline[0]:=909;end;
if curcmd=43 then helpline[2]:=910;putgeterror;scannerstatus:=2;
repeat getnext;
{743:}if curcmd=40 then begin if strref[curmod]<127 then if strref[
curmod]>1 then decr(strref[curmod])else flushstring(curmod);end{:743};
until curcmd>=83;scannerstatus:=0;end{:1016};until curcmd>83;end;
{:1015}{1021:}procedure dorandomseed;begin getxnext;
if curcmd<>78 then begin missingerr(461);begin helpptr:=1;
...
printscaled(curexp);printchar(125);printnl(261);selector:=oldsetting;
end;end{:1022};end;{:1021}{1029:}procedure doprotection;var m:0..1;
t:halfword;begin m:=curmod;repeat getsymbol;t:=eqtb[cursym].lh;
if m=0 then begin if t>=87 then eqtb[cursym].lh:=t-87;
end else if t<87 then eqtb[cursym].lh:=t+87;getxnext;until curcmd<>83;
...
eqtb[ldelim].lh:=32;eqtb[ldelim].rh:=rdelim;eqtb[rdelim].lh:=63;
eqtb[rdelim].rh:=ldelim;getxnext;end;
{:1031}{1034:}procedure dostatement;forward;procedure dointerim;
begin getxnext;if curcmd<>41 then begin begin if interaction=3 then;
if(filelineerrorstylep and not(curinput.namefield=0))then begin printnl(
261);print(fullsourcefilenamestack[inopen]);print(58);printint(line);
print(262);print(925);end else begin printnl(263);print(925)end;end;
...
getxnext;if curcmd<>52 then if curcmd<>78 then begin missingerr(61);
begin helpptr:=3;helpline[2]:=933;helpline[1]:=674;helpline[0]:=934;end;
backerror;end;getsymbol;
case curcmd of 11,54,45,50:incr(mem[curmod].hh.lh);others:end;
clearsymbol(l,false);eqtb[l].lh:=curcmd;
if curcmd=42 then eqtb[l].rh:=0 else eqtb[l].rh:=curmod;getxnext;end;
{:1035}{1036:}procedure donewinternal;
begin repeat if intptr=maxinternal then overflow(935,maxinternal);
getclearsymbol;incr(intptr);eqtb[cursym].lh:=41;eqtb[cursym].rh:=intptr;
intname[intptr]:=hash[cursym].rh;internal[intptr]:=0;getxnext;
until curcmd<>83;end;{:1036}{1040:}procedure doshow;
begin repeat getxnext;scanexpression;printnl(766);printexp(0,2);
flushcurexp(0);until curcmd<>83;end;{:1040}{1041:}procedure disptoken;
begin printnl(941);
if cursym=0 then{1042:}begin if curcmd=43 then printscaled(curmod)else
if curcmd=39 then begin gpointer:=curmod;printcapsule;
...
curmod])else flushstring(curmod);end;end;
end{:1042}else begin slowprint(hash[cursym].rh);printchar(61);
if eqtb[cursym].lh>=87 then print(942);printcmdmod(curcmd,curmod);
if curcmd=11 then begin println;showmacro(curmod,0,100000);end;end;end;
{:1041}{1044:}procedure doshowtoken;begin repeat getnext;disptoken;
getxnext;until curcmd<>83;end;{:1044}{1045:}procedure doshowstats;
begin printnl(951);ifdef('STAT')printint(varused);printchar(38);
printint(dynused);if false then endif('STAT')print(357);print(559);
printint(himemmin-lomemmax-1);print(952);println;printnl(953);
printint(strptr-initstrptr);printchar(38);printint(poolptr-initpoolptr);
print(559);printint(maxstrings-maxstrptr);printchar(38);
...
end{:1047}else if mem[p].hh.b0>=22 then{1048:}begin printnl(261);
printvariablename(p);if mem[p].hh.b0>22 then print(666);print(954);
if fileoffset>=maxprintline-20 then n:=5 else n:=maxprintline-fileoffset
-15;showmacro(mem[p+1].int,0,n);
end{:1048}else if mem[p].hh.b0<>0 then begin printnl(261);
printvariablename(p);printchar(61);printexp(p,0);end;end;
{:1046}{1049:}procedure doshowvar;label 30;begin repeat getnext;
if cursym>0 then if cursym<=9769 then if curcmd=42 then if curmod<>0
then begin dispvar(curmod);goto 30;end;disptoken;30:getxnext;
until curcmd<>83;end;{:1049}{1050:}procedure doshowdependencies;
var p:halfword;begin p:=mem[13].hh.rh;
while p<>13 do begin if interesting(p)then begin printnl(261);
printvariablename(p);
...
if internal[32]>0 then begin begin if interaction=3 then;
if(filelineerrorstylep and not(curinput.namefield=0))then begin printnl(
261);print(fullsourcefilenamestack[inopen]);print(58);printint(line);
print(262);print(955);end else begin printnl(263);print(955)end;end;
if interaction<3 then begin helpptr:=0;decr(errorcount);
end else begin helpptr:=1;helpline[0]:=956;end;
if curcmd=84 then error else putgeterror;end;end;
...
if(filelineerrorstylep and not(curinput.namefield=0))then begin printnl(
261);print(fullsourcefilenamestack[inopen]);print(58);printint(line);
print(262);print(968);end else begin printnl(263);print(968)end;end;
begin helpptr:=1;helpline[0]:=966;end;putgetflusherror(0);end;
end{:1056};scanwith:=result;end;
{:1054}{1057:}procedure findedgesvar(t:halfword);var p:halfword;
...
261);print(fullsourcefilenamestack[inopen]);print(58);printint(line);
print(262);print(791);end else begin printnl(263);print(791)end;end;
showtokenlist(t,0,1000,0);print(969);printtype(mem[p].hh.b0);
printchar(41);begin helpptr:=2;helpline[1]:=970;helpline[0]:=971;end;
putgeterror;end else curedges:=mem[p+1].int;flushnodelist(t);end;
{:1057}{1059:}procedure doaddto;label 30,45;var lhs,rhs:halfword;
w:integer;p:halfword;q:halfword;addtotype:0..2;begin getxnext;
varflag:=69;scanprimary;if curtype<>20 then{1060:}begin disperr(0,972);
begin helpptr:=4;helpline[3]:=973;helpline[2]:=974;helpline[1]:=975;
helpline[0]:=971;end;putgetflusherror(0);
end{:1060}else begin lhs:=curexp;addtotype:=curmod;curtype:=1;getxnext;
...
while curcmd=67 do if scanwith then if curtype=16 then w:=curexp else
{1063:}begin if mem[curpen].hh.lh=0 then tosspen(curpen)else decr(mem[
curpen].hh.lh);curpen:=curexp;end{:1063};{1064:}findedgesvar(lhs);
...
end{:1065}else{1067:}begin begin if interaction=3 then;
if(filelineerrorstylep and not(curinput.namefield=0))then begin printnl(
261);print(fullsourcefilenamestack[inopen]);print(58);printint(line);
print(262);print(979);end else begin printnl(263);print(979)end;end;
begin helpptr:=2;helpline[1]:=980;helpline[0]:=971;end;putgeterror;
tossknotlist(rhs);goto 45;
...
if mem[curpen+9].int=0 then begin mfluaPREfillspecrhs(rhs);
fillspec(rhs);mfluaPOSTfillspecrhs(rhs);
end else begin mfluaPREfillenveloperhs(rhs);fillenvelope(rhs);
mfluaPOSTfillenveloperhs(rhs);end;if lhs<>0 then begin revturns:=true;
lhs:=makespec(lhs,mem[curpen+9].int,internal[5]);revturns:=false;
if mem[curpen+9].int=0 then begin mfluaPREfillspeclhs(lhs);
fillspec(lhs);mfluaPOSTfillspeclhs(lhs);
end else begin mfluaPREfillenvelopelhs(lhs);fillenvelope(lhs);
mfluaPOSTfillenvelopelhs(lhs);end;end;45:end{:1064};
if mem[curpen].hh.lh=0 then tosspen(curpen)else decr(mem[curpen].hh.lh);
end;end{:1062};end;end;
{:1059}{1070:}{1098:}function tfmcheck(m:smallnumber):scaled;
begin if abs(internal[m])>=134217728 then begin begin if interaction=3
then;
if(filelineerrorstylep and not(curinput.namefield=0))then begin printnl(
261);print(fullsourcefilenamestack[inopen]);print(58);printint(line);
print(262);print(1002);end else begin printnl(263);print(1002)end;end;
print(intname[m]);print(1003);begin helpptr:=1;helpline[0]:=1004;end;
putgeterror;
...
var c:integer;begin getxnext;varflag:=84;scanexpression;
...
begin getxnext;varflag:=74;scanprimary;
...
if k<0 then goto 45;if k>15 then goto 45;if not getpair(71)then goto 45;
r0:=curx;c0:=cury;if not getpair(72)then goto 45;r1:=curx;c1:=cury;
if not getpair(73)then goto 45;openawindow(k,r0,c0,r1,c1,curx,cury);
goto 10;45:begin if interaction=3 then;
if(filelineerrorstylep and not(curinput.namefield=0))then begin printnl(
261);print(fullsourcefilenamestack[inopen]);print(58);printint(line);
print(262);print(988);end else begin printnl(263);print(988)end;end;
...
keeping:0..1;w,win,wout:integer;begin w:=1;getxnext;varflag:=68;
...
curtype:=1;keeping:=curmod;if not getpair(68)then goto 45;
while(curcmd=67)and(curmod=16)do if scanwith then w:=curexp;
...
cury),wout,win);goto 10;45:begin if interaction=3 then;
if(filelineerrorstylep and not(curinput.namefield=0))then begin printnl(
261);print(fullsourcefilenamestack[inopen]);print(58);printint(line);
print(262);print(991);end else begin printnl(263);print(991)end;end;
begin helpptr:=1;helpline[0]:=992;end;putgeterror;flushtokenlist(e);end;
10:end;{:1074}{1082:}procedure domessage;var m:0..2;begin m:=curmod;
getxnext;scanexpression;if curtype<>4 then begin disperr(0,701);
begin helpptr:=1;helpline[0]:=996;end;putgeterror;
end else case m of 0:begin printnl(261);slowprint(curexp);end;
1:{1086:}begin begin if interaction=3 then;
if(filelineerrorstylep and not(curinput.namefield=0))then begin printnl(
261);print(fullsourcefilenamestack[inopen]);print(58);printint(line);
print(262);print(261);end else begin printnl(263);print(261)end;end;
slowprint(curexp);
...
strref[errhelp]>1 then decr(strref[errhelp])else flushstring(errhelp);
end;if(strstart[curexp+1]-strstart[curexp])=0 then errhelp:=0 else begin
...
end else{1105:}begin begin if interaction=3 then;
if(filelineerrorstylep and not(curinput.namefield=0))then begin printnl(
261);print(fullsourcefilenamestack[inopen]);print(58);printint(line);
print(262);print(1013);end else begin printnl(263);print(1013)end;end;
...
while curcmd=82 do begin cc:=getcode;settag(c,2,cc);c:=cc;end;end;
1:{1107:}begin lkstarted:=false;22:getxnext;
if(curcmd=79)and lkstarted then{1110:}begin c:=getcode;
if nl-skiptable[c]>128 then begin begin begin if interaction=3 then;
if(filelineerrorstylep and not(curinput.namefield=0))then begin printnl(
261);print(fullsourcefilenamestack[inopen]);print(58);printint(line);
print(262);print(1036);end else begin printnl(263);print(1036)end;end;
begin helpptr:=1;helpline[0]:=1037;end;error;ll:=skiptable[c];
repeat lll:=ligkern[ll].b0;ligkern[ll].b0:=128;ll:=ll-lll;until lll=0;
end;skiptable[c]:=ligtablesize;end;
...
if curcmd=80 then begin c:=256;curcmd:=82;end else begin backinput;
c:=getcode;end;
if(curcmd=82)or(curcmd=81)then{1111:}begin if curcmd=82 then if c=256
then bchlabel:=nl else settag(c,1,nl)else if skiptable[c]<ligtablesize
then begin ll:=skiptable[c];skiptable[c]:=ligtablesize;
repeat lll:=ligkern[ll].b0;
if nl-ll>128 then begin begin begin if interaction=3 then;
if(filelineerrorstylep and not(curinput.namefield=0))then begin printnl(
261);print(fullsourcefilenamestack[inopen]);print(58);printint(line);
print(262);print(1036);end else begin printnl(263);print(1036)end;end;
begin helpptr:=1;helpline[0]:=1037;end;error;ll:=ll;
repeat lll:=ligkern[ll].b0;ligkern[ll].b0:=128;ll:=ll-lll;until lll=0;
end;goto 22;end;ligkern[ll].b0:=nl-ll-1;ll:=ll-lll;until lll=0;end;
goto 22;end{:1111};if curcmd=77 then{1112:}begin ligkern[nl].b1:=c;
...
helpline[1]:=1039;helpline[0]:=308;end;putgetflusherror(0);end;
kern[nk]:=curexp;k:=0;while kern[k]<>curexp do incr(k);
if k=nk then begin if nk=maxkerns then overflow(1035,maxkerns);incr(nk);
...
if(filelineerrorstylep and not(curinput.namefield=0))then begin printnl(
261);print(fullsourcefilenamestack[inopen]);print(58);printint(line);
print(262);print(1024);end else begin printnl(263);print(1024)end;end;
begin helpptr:=1;helpline[0]:=1025;end;backerror;ligkern[nl].b1:=0;
ligkern[nl].b2:=0;ligkern[nl].b3:=0;ligkern[nl].b0:=129;end;
if nl=ligtablesize then overflow(1026,ligtablesize);incr(nl);
if curcmd=83 then goto 22;
if ligkern[nl-1].b0<128 then ligkern[nl-1].b0:=128;30:end{:1107};
2:{1113:}begin if ne=256 then overflow(1007,256);c:=getcode;
settag(c,3,ne);if curcmd<>82 then begin missingerr(58);begin helpptr:=1;
helpline[0]:=1040;end;backerror;end;exten[ne].b0:=getcode;
if curcmd<>83 then begin missingerr(44);begin helpptr:=1;
helpline[0]:=1040;end;backerror;end;exten[ne].b1:=getcode;
if curcmd<>83 then begin missingerr(44);begin helpptr:=1;
helpline[0]:=1040;end;backerror;end;exten[ne].b2:=getcode;
if curcmd<>83 then begin missingerr(44);begin helpptr:=1;
helpline[0]:=1040;end;backerror;end;exten[ne].b3:=getcode;incr(ne);
...
if curcmd<>82 then begin missingerr(58);begin helpptr:=1;
helpline[0]:=1023;end;backerror;end;
if c=3 then{1114:}repeat if j>headersize then overflow(1008,headersize);
headerbyte[j]:=getcode;incr(j);
until curcmd<>83{:1114}else{1115:}repeat if j>maxfontdimen then overflow
(1009,maxfontdimen);while j>np do begin incr(np);param[np]:=0;end;
getxnext;scanexpression;if curtype<>16 then begin disperr(0,1041);
begin helpptr:=1;helpline[0]:=308;end;putgetflusherror(0);end;
param[j]:=curexp;incr(j);until curcmd<>83{:1115};end;end;end;end;
{:1106}{1177:}procedure dospecial;var m:smallnumber;begin m:=curmod;
getxnext;scanexpression;
if internal[34]>=0 then if curtype<>m then{1178:}begin disperr(0,1062);
begin helpptr:=1;helpline[0]:=1063;end;putgeterror;
...
var k:integer;p,q:halfword;x:integer;w:fourquarters;
baseengine:^ASCIIcode;begin{1200:}selector:=5;print(1074);
print(jobname);printchar(32);printint(roundunscaled(internal[14]));
printchar(46);printint(roundunscaled(internal[15]));printchar(46);
printint(roundunscaled(internal[16]));printchar(41);
if interaction=0 then selector:=2 else selector:=3;
begin if poolptr+1>maxpoolptr then begin if poolptr+1>poolsize then
overflow(257,poolsize-initpoolptr);maxpoolptr:=poolptr+1;end;end;
baseident:=makestring;strref[baseident]:=127;packjobname(743);
while not wopenout(basefile)do promptfilename(1075,743);printnl(1076);
slowprint(wmakenamestring(basefile));flushstring(strptr-1);printnl(261);
slowprint(baseident){:1200};{1190:}dumpint(1462914374);
x:=strlen(enginename);baseengine:=xmallocarray(ASCIIcode,x+4);
strcpy(stringcast(baseengine),enginename);
for k:=x to x+3 do baseengine[k]:=0;x:=x+4-(x mod 4);dumpint(x);
dumpthings(baseengine[0],x);libcfree(baseengine);dumpint(228418379);
{1218:}dumpthings(xord[0],256);dumpthings(xchr[0],256);
dumpthings(xprn[0],256);{:1218};dumpint(0);dumpint(memtop);
dumpint(9500);dumpint(7919);dumpint(15){:1190};{1192:}dumpint(poolptr);
dumpint(strptr);for k:=0 to strptr do dumpint(strstart[k]);k:=0;
...
w.b3:=strpool[k+3];dumpqqqq(w);println;printint(strptr);print(1071);
...
dumpint(varused);dumpint(dynused);println;printint(x);print(1072);
printint(varused);printchar(38);printint(dynused){:1194};
{1196:}dumpint(hashused);stcount:=9756-hashused;
...
dumpint(stcount);println;printint(stcount);print(1073){:1196};
{1198:}dumpint(intptr);for k:=1 to intptr do begin dumpint(internal[k]);
...
getxnext;if curcmd>44 then{990:}begin if curcmd<84 then begin begin if
interaction=3 then;
if(filelineerrorstylep and not(curinput.namefield=0))then begin printnl(
261);print(fullsourcefilenamestack[inopen]);print(58);printint(line);
print(262);print(870);end else begin printnl(263);print(870)end;end;
...
end{:990}else if curcmd>31 then{993:}begin varflag:=78;scanexpression;
if curcmd<85 then begin if curcmd=52 then doequation else if curcmd=78
then doassignment else if curtype=4 then{994:}begin if internal[1]>0
then begin printnl(261);slowprint(curexp);fflush(stdout);end;
if internal[34]>0 then{1179:}begin if outputfilename=0 then initgf;
gfstring(1064,curexp);end{:1179};
...
;case curcmd of 31:dotypedeclaration;
17:if curmod>2 then makeopdef else if curmod>0 then scandef;
{1020:}25:dorandomseed;{:1020}{1023:}24:begin println;
interaction:=curmod;
...
{:1023}{1026:}22:doprotection;{:1026}{1030:}28:defdelims;
{:1030}{1033:}13:repeat getsymbol;savevariable(cursym);getxnext;
until curcmd<>83;14:dointerim;15:dolet;16:donewinternal;
{:1033}{1039:}23:doshowwhatever;{:1039}{1058:}19:doaddto;
{:1058}{1069:}18:doshipout;12:dodisplay;29:doopenwindow;20:docull;
{:1069}{1076:}27:begin getsymbol;startsym:=cursym;getxnext;end;
{:1076}{1081:}26:domessage;{:1081}{1100:}21:dotfmcommand;
{:1100}{1175:}30:dospecial;{:1175}end;curtype:=1;end{:992};
if curcmd<84 then{991:}begin begin if interaction=3 then;
if(filelineerrorstylep and not(curinput.namefield=0))then begin printnl(
261);print(fullsourcefilenamestack[inopen]);print(58);printint(line);
print(262);print(876);end else begin printnl(263);print(876)end;end;
begin helpptr:=6;helpline[5]:=877;helpline[4]:=878;helpline[3]:=879;
helpline[2]:=873;helpline[1]:=874;helpline[0]:=875;end;backerror;
scannerstatus:=2;repeat getnext;
{743:}if curcmd=40 then begin if strref[curmod]<127 then if strref[
curmod]>1 then decr(strref[curmod])else flushstring(curmod);end{:743};
until curcmd>83;scannerstatus:=0;end{:991};errorcount:=0;end;
{:989}{1017:}procedure maincontrol;begin repeat dostatement;
if curcmd=85 then begin begin if interaction=3 then;
if(filelineerrorstylep and not(curinput.namefield=0))then begin printnl(
261);print(fullsourcefilenamestack[inopen]);print(58);printint(line);
print(262);print(911);end else begin printnl(263);print(911)end;end;
begin helpptr:=2;helpline[1]:=912;helpline[0]:=691;end;flusherror(0);
end;until curcmd=86;end;
{:1017}{1117:}function sortin(v:scaled):halfword;label 40;
var p,q,r:halfword;begin p:=memtop-1;
while true do begin q:=mem[p].hh.rh;if v<=mem[q+1].int then goto 40;
p:=q;end;40:if v<mem[q+1].int then begin r:=getnode(2);mem[r+1].int:=v;
mem[r].hh.rh:=q;mem[p].hh.rh:=r;end;sortin:=mem[p].hh.rh;end;
{:1117}{1118:}function mincover(d:scaled):integer;var p:halfword;
l:scaled;m:integer;begin m:=0;p:=mem[memtop-1].hh.rh;
perturbation:=2147483647;while p<>19 do begin incr(m);l:=mem[p+1].int;
...
until mem[mem[p].hh.rh+1].int>l+d;v:=l+halfp(mem[p+1].int-l);
...
{:1131}{1133:}procedure tfmqqqq(x:fourquarters);
begin putbyte(x.b0,tfmfile);putbyte(x.b1,tfmfile);putbyte(x.b2,tfmfile);
putbyte(x.b3,tfmfile);end;
...
write(stdout,'Sorry, I can''t find the base `');
fputs(stringcast(nameoffile+1),stdout);write(stdout,'''; will try `');
fputs(MFbasedefault+1,stdout);writeln(stdout,'''.');fflush(stdout);end;
packbufferedname(basedefaultlength-5,1,0);
if not wopenin(basefile)then begin;
write(stdout,'I can''t find the base file `');
fputs(MFbasedefault+1,stdout);writeln(stdout,'''!');openbasefile:=false;
goto 10;end;40:curinput.locfield:=j;openbasefile:=true;10:end;
{:779}function loadbasefile:boolean;label 6666,10;var k:integer;
p,q:halfword;x:integer;w:fourquarters;baseengine:^ASCIIcode;
dummyxord:ASCIIcode;dummyxchr:ASCIIcode;dummyxprn:ASCIIcode;
begin{1191:}undumpint(x);if x<>1462914374 then goto 6666;undumpint(x);
if(x<0)or(x>256)then goto 6666;baseengine:=xmallocarray(ASCIIcode,x);
undumpthings(baseengine[0],x);baseengine[x-1]:=0;
if strcmp(enginename,stringcast(baseengine))then begin;
writeln(stdout,'---! ',stringcast(nameoffile+1),' was written by ',
stringcast(baseengine));libcfree(baseengine);goto 6666;end;
libcfree(baseengine);undumpint(x);if x<>228418379 then begin;
writeln(stdout,'---! ',stringcast(nameoffile+1),' doesn''t match ',
poolname);goto 6666;end;
{1219:}if translatefilename then begin for k:=0 to 255 do undumpthings(
...
if eightbitp then for k:=0 to 255 do xprn[k]:=1;end;{:1219};
undumpint(x);if x<>0 then goto 6666;
ifdef('INIMF')if iniversion then begin libcfree(mem);end;
endif('INIMF')undumpint(memtop);if memmax<memtop then memmax:=memtop;
if 1100>memtop then goto 6666;mem:=xmallocarray(memoryword,memmax+1);
...
end;undumpint(serialno);undumpint(x);if x<>69069 then goto 6666{:1199};
loadbasefile:=true;goto 10;6666:;
writeln(stdout,'(Fatal base file error; I''m stymied)');
loadbasefile:=false;10:end;{:1187}{1202:}{823:}procedure scanprimary;
label 20,30,31,32;var p,q,r:halfword;c:quarterword;myvarflag:0..86;
...
{825:}ifdef('TEXMF_DEBUG')if panicking then checkmem(false);
...
end{:825};case curcmd of 32:{826:}begin ldelim:=cursym;rdelim:=curmod;
getxnext;scanexpression;
if(curcmd=83)and(curtype>=16)then{830:}begin p:=getnode(2);
...
end{:826};33:{832:}begin groupline:=line;
...
until curcmd<>84;if curcmd<>85 then begin begin if interaction=3 then;
if(filelineerrorstylep and not(curinput.namefield=0))then begin printnl(
261);print(fullsourcefilenamestack[inopen]);print(58);printint(line);
print(262);print(781);end else begin printnl(263);print(781)end;end;
printint(groupline);print(782);begin helpptr:=2;helpline[1]:=783;
helpline[0]:=784;end;backerror;curcmd:=85;end;unsave;
if internal[7]>0 then showcmdmod(curcmd,curmod);end{:832};
40:{833:}begin curtype:=4;curexp:=curmod;end{:833};
43:{837:}begin curexp:=curmod;curtype:=16;getxnext;
if curcmd<>55 then begin num:=0;denom:=0;end else begin getxnext;
if curcmd<>43 then begin backinput;curcmd:=55;curmod:=72;cursym:=9761;
goto 30;end;num:=curexp;denom:=curmod;
if denom=0 then{838:}begin begin if interaction=3 then;
if(filelineerrorstylep and not(curinput.namefield=0))then begin printnl(
261);print(fullsourcefilenamestack[inopen]);print(58);printint(line);
print(262);print(785);end else begin printnl(263);print(785)end;end;
...
if curcmd>=31 then if curcmd<43 then begin p:=stashcurexp;scanprimary;
if(abs(num)>=abs(denom))or(curtype<14)then dobinary(p,71)else begin
fracmult(num,denom);freenode(p,2);end;end;goto 30;end{:837};
34:{834:}donullary(curmod){:834};35,31,37,44:{835:}begin c:=curmod;
getxnext;scanprimary;dounary(c);goto 30;end{:835};
38:{839:}begin c:=curmod;getxnext;scanexpression;
if curcmd<>70 then begin missingerr(479);print(717);printcmdmod(38,c);
begin helpptr:=1;helpline[0]:=718;end;backerror;end;p:=stashcurexp;
getxnext;scanprimary;dobinary(p,c);goto 30;end{:839};
36:{840:}begin getxnext;scansuffix;oldsetting:=selector;selector:=5;
showtokenlist(curexp,0,100000,0);flushtokenlist(curexp);
curexp:=makestring;selector:=oldsetting;curtype:=4;goto 30;end{:840};
41:{841:}begin q:=curmod;if myvarflag=78 then begin getxnext;
if curcmd=78 then begin curexp:=getavail;mem[curexp].hh.lh:=q+9769;
curtype:=20;goto 30;end;backinput;end;curtype:=16;curexp:=internal[q];
end{:841};39:makeexpcopy(curmod);42:{844:}begin begin prehead:=avail;
...
q:=mem[p].hh.lh;tt:=0;if eqtb[q].lh mod 87=42 then begin q:=eqtb[q].rh;
...
end{:853};end{:845};end;getxnext;tail:=t;
if curcmd=64 then{846:}begin getxnext;scanexpression;
if curcmd<>65 then{847:}begin backinput;backexpr;curcmd:=64;curmod:=0;
cursym:=9760;end{:847}else begin if curtype<>16 then badsubscript;
curcmd:=43;curmod:=curexp;cursym:=0;end;end{:846};
if curcmd>43 then goto 31;if curcmd<41 then goto 31;end;
...
helpline[2]:=798;helpline[1]:=799;helpline[0]:=800;putgetflusherror(0);
end;flushnodelist(q);goto 30{:852};end{:844};others:begin badexp(770);
goto 20;end end;getxnext;
30:if curcmd=64 then if curtype>=16 then{859:}begin p:=stashcurexp;
getxnext;scanexpression;if curcmd<>83 then begin{847:}begin backinput;
backexpr;curcmd:=64;curmod:=0;cursym:=9760;end{:847};unstashcurexp(p);
end else begin q:=stashcurexp;getxnext;scanexpression;
if curcmd<>65 then begin missingerr(93);begin helpptr:=3;
helpline[2]:=802;helpline[1]:=803;helpline[0]:=699;end;backerror;end;
...
while true do begin if curcmd=64 then{861:}begin getxnext;
scanexpression;if curtype<>16 then badsubscript;
if curcmd<>65 then begin missingerr(93);begin helpptr:=3;
helpline[2]:=804;helpline[1]:=803;helpline[0]:=699;end;backerror;end;
curcmd:=43;curmod:=curexp;end{:861};
if curcmd=43 then p:=newnumtok(curmod)else if(curcmd=42)or(curcmd=41)
...
begin 20:if(curcmd<31)or(curcmd>44)then badexp(805);scanprimary;
22:if curcmd<=56 then if curcmd>=53 then begin p:=stashcurexp;c:=curmod;
d:=curcmd;if d=54 then begin macname:=cursym;incr(mem[c].hh.lh);end;
getxnext;scanprimary;if d<>54 then dobinary(p,c)else begin backinput;
...
begin 20:if(curcmd<31)or(curcmd>44)then badexp(806);scansecondary;
if curtype=8 then materializepen;
22:if curcmd<=46 then if curcmd>=44 then begin p:=stashcurexp;c:=curmod;
d:=curcmd;if d=45 then begin macname:=cursym;incr(mem[c].hh.lh);end;
getxnext;scansecondary;if d<>45 then dobinary(p,c)else begin backinput;
binarymac(p,c,macname);decr(mem[c].hh.lh);getxnext;goto 20;end;goto 22;
end;end;{:864}{868:}procedure scanexpression;label 20,30,22,25,26,10;
var p,q,r,pp,qq:halfword;c,d:halfword;myvarflag:0..86;macname:halfword;
cyclehit:boolean;x,y:scaled;t:0..4;begin myvarflag:=varflag;
20:if(curcmd<31)or(curcmd>44)then badexp(809);scantertiary;
22:if curcmd<=52 then if curcmd>=47 then if(curcmd<>52)or(myvarflag<>78)
then begin p:=stashcurexp;c:=curmod;d:=curcmd;
if d=50 then begin macname:=cursym;incr(mem[c].hh.lh);end;
if(d<49)or((d=49)and((mem[p].hh.b0=14)or(mem[p].hh.b0=9)))then{869:}
...
25:{874:}if curcmd=47 then{879:}begin t:=scandirection;
if t<>4 then begin mem[q].hh.b1:=t;mem[q+5].int:=curexp;
if mem[q].hh.b0=4 then begin mem[q].hh.b0:=t;mem[q+3].int:=curexp;end;
end;end{:879};d:=curcmd;if d=48 then{881:}begin getxnext;
if curcmd=59 then{882:}begin getxnext;y:=curcmd;
if curcmd=60 then getxnext;scanprimary;
...
if curcmd=53 then begin getxnext;y:=curcmd;if curcmd=60 then getxnext;
scanprimary;
{883:}if(curtype<>16)or(curexp<49152)then begin disperr(0,827);
begin helpptr:=1;helpline[0]:=828;end;putgetflusherror(65536);end{:883};
if y=60 then curexp:=-curexp;end;y:=curexp;
end{:882}else if curcmd=58 then{884:}begin mem[q].hh.b1:=1;t:=1;
getxnext;scanprimary;knownpair;mem[q+5].int:=curx;mem[q+6].int:=cury;
if curcmd<>53 then begin x:=mem[q+5].int;y:=mem[q+6].int;
...
if curcmd<>48 then begin missingerr(408);begin helpptr:=1;
helpline[0]:=826;end;backerror;end;
30:end{:881}else if d<>49 then goto 26;getxnext;
if curcmd=47 then{880:}begin t:=scandirection;
if mem[q].hh.b1<>1 then x:=curexp else t:=1;
end{:880}else if mem[q].hh.b1<>1 then begin t:=4;x:=0;end{:874};
if curcmd=37 then{886:}begin cyclehit:=true;getxnext;pp:=p;qq:=p;
if d=49 then if p=q then begin d:=48;mem[q+6].int:=65536;y:=65536;end;
...
{887:}begin if d=49 then if(mem[q+1].int<>mem[pp+1].int)or(mem[q+2].int
<>mem[pp+2].int)then begin begin if interaction=3 then;
if(filelineerrorstylep and not(curinput.namefield=0))then begin printnl(
261);print(fullsourcefilenamestack[inopen]);print(58);printint(line);
print(262);print(829);end else begin printnl(263);print(829)end;end;
begin helpptr:=3;helpline[2]:=830;helpline[1]:=831;helpline[0]:=832;end;
putgeterror;d:=48;mem[q+6].int:=65536;y:=65536;end;
{889:}if mem[pp].hh.b1=4 then if(t=3)or(t=2)then begin mem[pp].hh.b1:=t;
mem[pp+5].int:=x;end{:889};
if d=49 then{890:}begin if mem[q].hh.b0=4 then if mem[q].hh.b1=4 then
...
if curcmd>=47 then if curcmd<=49 then if not cyclehit then goto 25;
26:{891:}if cyclehit then begin if d=49 then p:=q;
...
mem[q+3].int:=65536;end;mem[q].hh.rh:=p;end;mfluaPREmakechoices(p);
makechoices(p);mfluaPOSTmakechoices(p);curtype:=9;curexp:=p{:891};
end{:869}else begin getxnext;scantertiary;
if d<>50 then dobinary(p,c)else begin backinput;binarymac(p,c,macname);
decr(mem[c].hh.lh);getxnext;goto 20;end;end;goto 22;end;10:end;
{:868}{892:}procedure getboolean;begin getxnext;scanexpression;
...
begin ifdef('STAT')if internal[12]>0 then{1208:}if logopened then begin
writeln(logfile,' ');
...
putbyte(headerbyte[k],tfmfile);end{:1135};
{1136:}for k:=bc to ec do if not charexists[k]then put4bytes(tfmfile,0)
else begin putbyte(mem[tfmwidth[k]].hh.lh,tfmfile);
...
while p<>19 do begin put4bytes(tfmfile,dimenout(mem[p+1].int));
p:=mem[p].hh.rh;end;end{:1136};
{1139:}for k:=0 to 255 do if skiptable[k]<ligtablesize then begin
printnl(1049);printint(k);print(1050);ll:=skiptable[k];
repeat lll:=ligkern[ll].b0;ligkern[ll].b0:=128;ll:=ll-lll;until lll=0;
end;if lkstarted then begin putbyte(255,tfmfile);putbyte(bchar,tfmfile);
put2bytes(tfmfile,0);
...
for k:=0 to nk-1 do put4bytes(tfmfile,dimenout(kern[k])){:1139};
...
endif('STAT')printnl(1048);printfilename(0,metricfilename,0);
printchar(46);bclose(tfmfile){:1134};end;
if gfprevptr>0 then{1182:}begin begin gfbuf[gfptr]:=248;incr(gfptr);
...
if gfptr=gflimit then gfswap;end;decr(k);end;
{1156:}if gflimit=halfbuf then writegf(halfbuf,gfbufsize-1);
if gfptr>(2147483647-gfoffset)then begin gfprevptr:=0;fatalerror(1054);
end;if gfptr>0 then writegf(0,gfptr-1){:1156};printnl(1065);
printfilename(0,outputfilename,0);print(559);printint(totalchars);
if totalchars<>1 then print(1066)else print(1067);print(1068);
printint(gfoffset+gfptr);print(1069);bclose(gffile);end{:1182};
end{:1206};if logopened then begin writeln(logfile);aclose(logfile);
selector:=selector-2;if selector=1 then begin printnl(1077);
printfilename(0,texmflogname,0);printchar(46);end;end;println;
if(editnamestart<>0)and(interaction>0)then calledit(strpool,
editnamestart,editnamelength,editline);mfluaendprogram;end;
...
while openparens>0 do begin print(1078);decr(openparens);end;
while condptr<>0 do begin printnl(1079);printcmdmod(2,curif);
if ifline<>0 then begin print(1080);printint(ifline);end;print(1081);
...
then begin selector:=1;printnl(1082);selector:=3;end;
if c=1 then begin ifdef('INIMF')if iniversion then begin storebasefile;
goto 10;end;endif('INIMF')printnl(1083);goto 10;end;10:end;
{:1209}{1210:}ifdef('INIMF')procedure initprim;
begin{192:}primitive(409,41,1);primitive(410,41,2);primitive(411,41,3);
primitive(412,41,4);primitive(413,41,5);primitive(414,41,6);
primitive(415,41,7);primitive(416,41,8);primitive(417,41,9);
primitive(418,41,10);primitive(419,41,11);primitive(420,41,12);
primitive(421,41,13);primitive(422,41,14);primitive(423,41,15);
primitive(424,41,16);primitive(425,41,17);primitive(426,41,18);
primitive(427,41,19);primitive(428,41,20);primitive(429,41,21);
primitive(430,41,22);primitive(431,41,23);primitive(432,41,24);
primitive(433,41,25);primitive(434,41,26);primitive(435,41,27);
primitive(436,41,28);primitive(437,41,29);primitive(438,41,30);
primitive(439,41,31);primitive(440,41,32);primitive(441,41,33);
primitive(442,41,34);primitive(443,41,35);primitive(444,41,36);
primitive(445,41,37);primitive(446,41,38);primitive(447,41,39);
primitive(448,41,40);primitive(449,41,41);
{:192}{211:}primitive(408,48,0);primitive(91,64,0);
eqtb[9760]:=eqtb[cursym];primitive(93,65,0);primitive(125,66,0);
primitive(123,47,0);primitive(58,82,0);eqtb[9762]:=eqtb[cursym];
primitive(459,81,0);primitive(460,80,0);primitive(461,78,0);
primitive(44,83,0);primitive(59,84,0);eqtb[9763]:=eqtb[cursym];
primitive(92,7,0);primitive(462,19,0);primitive(463,73,0);
primitive(464,60,0);primitive(465,33,0);bgloc:=cursym;
primitive(466,58,0);primitive(467,20,0);primitive(468,61,0);
primitive(469,28,0);primitive(470,12,0);primitive(453,85,0);
eqtb[9767]:=eqtb[cursym];egloc:=cursym;primitive(471,27,0);
primitive(472,6,0);primitive(473,10,0);primitive(474,71,0);
primitive(475,74,0);primitive(476,14,0);primitive(477,15,0);
primitive(478,16,0);primitive(479,70,0);primitive(480,29,0);
primitive(481,25,0);primitive(482,9,0);primitive(483,13,0);
primitive(484,8,0);primitive(485,18,0);primitive(486,79,0);
primitive(487,75,0);primitive(488,36,0);primitive(489,59,0);
primitive(490,72,0);primitive(491,76,0);{:211}{683:}primitive(656,17,1);
primitive(657,17,2);primitive(658,17,54);primitive(659,17,45);
primitive(660,17,50);primitive(454,17,0);eqtb[9765]:=eqtb[cursym];
primitive(661,4,9770);primitive(662,4,9920);primitive(663,4,1);
primitive(455,4,0);eqtb[9764]:=eqtb[cursym];
{:683}{688:}primitive(664,62,0);primitive(665,62,1);primitive(64,62,2);
primitive(666,62,3);{:688}{695:}primitive(677,57,9770);
primitive(678,57,9920);primitive(679,57,10070);primitive(680,57,1);
primitive(681,57,2);primitive(682,57,3);{:695}{709:}primitive(692,3,0);
primitive(618,3,1);{:709}{740:}primitive(719,1,1);primitive(452,2,2);
eqtb[9766]:=eqtb[cursym];primitive(720,2,3);primitive(721,2,4);
{:740}{893:}primitive(347,34,30);primitive(348,34,31);
primitive(349,34,32);primitive(350,34,33);primitive(351,34,34);
primitive(352,34,35);primitive(353,34,36);primitive(354,34,37);
primitive(355,35,38);primitive(356,35,39);primitive(357,35,40);
primitive(358,35,41);primitive(359,35,42);primitive(360,35,43);
primitive(361,35,44);primitive(362,35,45);primitive(363,35,46);
primitive(364,35,47);primitive(365,35,48);primitive(366,35,49);
primitive(367,35,50);primitive(368,35,51);primitive(369,35,52);
primitive(370,35,53);primitive(371,35,54);primitive(372,35,55);
primitive(373,35,56);primitive(374,35,57);primitive(375,35,58);
primitive(376,35,59);primitive(377,35,60);primitive(378,35,61);
primitive(379,35,62);primitive(380,35,63);primitive(381,35,64);
primitive(382,35,65);primitive(383,35,66);primitive(384,35,67);
primitive(385,37,68);primitive(43,44,69);primitive(45,44,70);
primitive(42,56,71);primitive(47,55,72);eqtb[9761]:=eqtb[cursym];
primitive(386,46,73);primitive(310,46,74);primitive(388,53,76);
primitive(387,46,75);primitive(60,51,77);primitive(389,51,78);
primitive(62,51,79);primitive(390,51,80);primitive(61,52,81);
primitive(391,51,82);primitive(401,38,94);primitive(402,38,95);
primitive(403,38,96);primitive(404,38,97);primitive(405,38,98);
primitive(406,38,99);primitive(407,38,100);primitive(38,49,83);
primitive(392,56,84);primitive(393,56,85);primitive(394,56,86);
primitive(395,56,87);primitive(396,56,88);primitive(397,56,89);
primitive(398,56,90);primitive(399,56,91);primitive(400,46,92);
{:893}{1013:}primitive(340,31,15);primitive(326,31,4);
primitive(324,31,2);primitive(331,31,9);primitive(328,31,6);
primitive(333,31,11);primitive(335,31,13);primitive(336,31,14);
{:1013}{1018:}primitive(913,86,0);primitive(914,86,1);
{:1018}{1024:}primitive(273,24,0);primitive(274,24,1);
primitive(275,24,2);primitive(920,24,3);
{:1024}{1027:}primitive(921,22,0);primitive(922,22,1);
{:1027}{1037:}primitive(936,23,0);primitive(937,23,1);
primitive(938,23,2);primitive(939,23,3);primitive(940,23,4);
{:1037}{1052:}primitive(957,69,1);primitive(958,69,0);
primitive(959,69,2);primitive(960,67,6);primitive(961,67,16);
primitive(962,68,0);primitive(963,68,1);
{:1052}{1079:}primitive(993,26,0);primitive(994,26,1);
primitive(995,26,2);{:1079}{1101:}primitive(1005,21,0);
primitive(1006,21,1);primitive(1007,21,2);primitive(1008,21,3);
primitive(1009,21,4);{:1101}{1108:}primitive(1027,77,0);
primitive(1028,77,1);primitive(1029,77,5);primitive(1030,77,2);
primitive(1031,77,6);primitive(1032,77,3);primitive(1033,77,7);
primitive(1034,77,11);primitive(1035,77,128);
{:1108}{1176:}primitive(1060,30,4);primitive(1061,30,16);{:1176};end;
...
dynused:=memtop+1-himemmin;{:176}{193:}intname[1]:=409;intname[2]:=410;
intname[3]:=411;intname[4]:=412;intname[5]:=413;intname[6]:=414;
intname[7]:=415;intname[8]:=416;intname[9]:=417;intname[10]:=418;
intname[11]:=419;intname[12]:=420;intname[13]:=421;intname[14]:=422;
intname[15]:=423;intname[16]:=424;intname[17]:=425;intname[18]:=426;
intname[19]:=427;intname[20]:=428;intname[21]:=429;intname[22]:=430;
intname[23]:=431;intname[24]:=432;intname[25]:=433;intname[26]:=434;
intname[27]:=435;intname[28]:=436;intname[29]:=437;intname[30]:=438;
intname[31]:=439;intname[32]:=440;intname[33]:=441;intname[34]:=442;
intname[35]:=443;intname[36]:=444;intname[37]:=445;intname[38]:=446;
intname[39]:=447;intname[40]:=448;intname[41]:=449;
{:193}{203:}hashused:=9757;stcount:=0;hash[9768].rh:=451;
hash[9766].rh:=452;hash[9767].rh:=453;hash[9765].rh:=454;
hash[9764].rh:=455;hash[9763].rh:=59;hash[9762].rh:=58;
hash[9761].rh:=47;hash[9760].rh:=91;hash[9759].rh:=41;
hash[9757].rh:=456;eqtb[9759].lh:=63;{:203}{229:}mem[19].hh.lh:=9770;
mem[19].hh.rh:=0;{:229}{324:}mem[memtop].hh.lh:=268435455;
...
mem[21].hh.rh:=9768;eqtb[9768].rh:=21;eqtb[9768].lh:=42;
{:702}{759:}eqtb[9758].lh:=92;hash[9758].rh:=736;
{:759}{911:}mem[17].hh.b1:=11;{:911}{1116:}mem[20].int:=1073741824;
{:1116}{1127:}mem[16].int:=0;mem[15].hh.lh:=0;
{:1127}{1185:}if iniversion then baseident:=1070;{:1185}end;
endif('INIMF'){:1210}{1212:}ifdef('TEXMF_DEBUG')procedure debughelp;
label 888,10;var k,l,m,n:integer;begin while true do begin;
printnl(1084);fflush(stdout);read(stdin,m);
...
endif('TEXMF_DEBUG'){:1212}{:1202}{1204:}begin bounddefault:=250000;
...
memtop:=0+mainmemory-1;memmax:=memtop;
...
ifdef('INIMF')if iniversion then begin mem:=xmallocarray(memoryword,
memtop+1);end;endif('INIMF')mfluabeginprogram;history:=3;;
...
{:14}{154:}ifdef('INIMF')if memmax<>memtop then bad:=10;
endif('INIMF')if memmax<memtop then bad:=10;
if(0>0)or(255<127)then bad:=11;if(0>0)or(268435455<32767)then bad:=12;
if(0<0)or(255>268435455)then bad:=13;
if(0<0)or(memmax>=268435455)then bad:=14;
if maxstrings>268435455 then bad:=15;if bufsize>268435455 then bad:=16;
if(255<255)or(268435455<65535)then bad:=17;
{:154}{204:}if 9769+maxinternal>268435455 then bad:=21;
{:204}{214:}if 10220>268435455 then bad:=22;
{:214}{310:}if 15*11>bistacksize then bad:=31;
{:310}{553:}if 20+17*45>bistacksize then bad:=32;
{:553}{777:}if basedefaultlength>maxint then bad:=41;
{:777}if bad>0 then begin writeln(stdout,
'Ouch---my internal constants have been clobbered!','---case ',bad:1);
goto 9999;end;initialize;
ifdef('INIMF')if iniversion then begin if not getstringsstarted then
goto 9999;inittab;initprim;initstrptr:=strptr;initpoolptr:=poolptr;
maxstrptr:=strptr;maxpoolptr:=poolptr;fixdateandtime;end;
endif('INIMF')readyalready:=314159;mfluaPREstartofMF;1:{55:}selector:=1;
tally:=0;termoffset:=0;fileoffset:=0;
{:55}{61:}write(stdout,'This is MFLuaJIT, Version 2.7182818','-0.5');
write(stdout,versionstring);
if baseident=0 then writeln(stdout,' (preloaded base=',dumpname,')')else
begin slowprint(baseident);println;end;
if translatefilename then begin write(stdout,'(');
fputs(translatefilename,stdout);writeln(stdout,')');end;fflush(stdout);
{:61}{783:}jobname:=0;logopened:=false;{:783}{792:}outputfilename:=0;
{:792};{1211:}begin{657:}begin inputptr:=0;maxinstack:=0;inopen:=0;
...
fixdateandtime;initrandoms((internal[17]div 65536)+internal[16]);
{70:}if interaction=0 then selector:=0 else selector:=1{:70};
if curinput.locfield<curinput.limitfield then if buffer[curinput.
locfield]<>92 then startinput;end{:1211};history:=0;mfluainitialize;
if startsym>0 then begin cursym:=startsym;backinput;end;
mfluaPREmaincontrol;maincontrol;mfluaPOSTmaincontrol;finalcleanup;
mfluaPOSTfinalcleanup;closefilesandterminate;9999:begin fflush(stdout);
