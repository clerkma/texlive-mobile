...
xeqlevel:array[28931..30053]of quarterword;{:259}{262:}hash:^twohalves;
...
{:221}{260:}for k:=28931 to 30053 do xeqlevel[k]:=1;
...
{:1362}{1457:}LRptr:=-268435455;LRproblems:=0;curdir:=0;
{:1457}{1506:}pseudofiles:=-268435455;
{:1506}{1572:}saroot[6]:=-268435455;sanull.hh.lh:=-268435455;
sanull.hh.rh:=-268435455;{:1572}{1591:}sachain:=-268435455;salevel:=0;
{:1591}{1615:}discptr[2]:=-268435455;discptr[3]:=-268435455;
...
{:238}{246:}for k:=28931 to 29260 do eqtb[k].int:=0;
eqtb[28991].int:=256;eqtb[28992].int:=-1;eqtb[28948].int:=1000;
eqtb[28932].int:=10000;eqtb[28972].int:=1;eqtb[28971].int:=25;
eqtb[28977].int:=92;eqtb[28980].int:=13;
for k:=0 to 255 do begin eqtb[29261+k].int:=-1;
setintone(eqtb[29261+k],-1);end;eqtb[29307].int:=0;
setintone(eqtb[29307],0);
{:246}{256:}for k:=29517 to 30053 do eqtb[k].int:=0;
{:256}{265:}hashused:=15514;hashhigh:=0;cscount:=0;
eqtb[15523].hh.b0:=128;primused:=2100;hash[15523].rh:=541;
eqtb[15525].hh.b0:=42;eqtb[15525].hh.rh:=1;eqtb[15525].hh.b1:=1;
hash[15525].rh:=542;{:265}{569:}{:569}{698:}eqtb[28988].int:=1000;
eqtb[28989].int:=700;eqtb[28990].int:=500;
...
{:1234}{1320:}if iniversion then formatident:=1393;
{:1320}{1388:}hash[15522].rh:=1437;eqtb[15522].hh.b1:=1;
eqtb[15522].hh.b0:=125;eqtb[15522].hh.rh:=-268435455;
{:1388}{1404:}eTeXmode:=0;{1567:}maxregnum:=255;maxreghelpline:=752;
{:1567}{:1404}{1573:}for i:=0 to 5 do saroot[i]:=-268435455;
{:1573}{1609:}{:1609}end;endif('INITEX'){:8}{1654:}synctexoffset:=28994;
{:1654}end;{58:}procedure println;
...
begin if p<514 then if p>=257 then if p=513 then begin printesc(545);
printesc(546);printchar(32);end else begin printesc(p-257);
if eqtb[26361+p-257].hh.rh=11 then printchar(32);
end else if p<1 then printesc(547)else print(p-1)else if((p>=24527)and(p
<=30053))or(p>eqtbtop)then printesc(547)else if(hash[p].rh>=strptr)then
printesc(548)else begin printesc(hash[p].rh);printchar(32);end;end;
{:272}{273:}procedure sprintcs(p:halfword);
begin if p<514 then if p<257 then print(p-1)else if p<513 then printesc(
p-257)else begin printesc(545);printesc(546);
...
print(620);end;end;{:1628}{1732:}procedure printdir(dir:eightbits);
...
var x:boolean;begin x:=false;case abs(d)of 4:begin print(1595);x:=true;
end;3:begin print(1596);x:=true;end;1:begin print(1597);x:=true;end;end;
if x then begin if d<0 then print(1598);print(1599);end;end;
procedure printdirection(d:integer);begin case abs(d)of 4:print(1165);
3:print(1164);1:print(1166);end;if d<0 then print(1598);print(1599);end;
{:1732}{1738:}procedure printkanji(s:integer);
...
end else printchar(s);end;{:1738}{79:}procedure normalizeselector;
...
if(m<16)and(c>256)then printesc(606)else{304:}case m of 16,17,18:
...
end;14:if c=0 then print(607);others:printesc(606)end{:304};end{:303};
...
printnl(622);p:=defref;end;3:begin printnl(623);p:=memtop-3;end;
4:begin printnl(624);p:=memtop-4;end;5:begin printnl(625);p:=defref;end;
...
540);printint(q);printchar(41);end;end{:261};
{295:}if saveptr>0 then for q:=0 to saveptr-1 do begin if savestack[q].
hh.rh=p then begin printnl(598);printint(q);printchar(41);end;end{:295};
...
begin normalizeselector;begin if interaction=3 then;
if filelineerrorstylep then printfileline else printnl(263);print(1600);
end;if t<>0 then begin print(285);print(t);print(41);end;print(620);
...
begin if selector=21 then pdferror(1601,1602);oldsetting:=selector;
...
10:{1375:}case mem[p].hh.b1 of 0:begin printwritewhatsit(1424,p);
printchar(61);
printfilename(mem[p+1].hh.rh,mem[p+2].hh.lh,mem[p+2].hh.rh);end;
1:begin printwritewhatsit(647,p);printmark(mem[p+1].hh.rh);end;
2:printwritewhatsit(1425,p);3:begin printesc(1426);
printmark(mem[p+1].hh.rh);end;4:begin printesc(1428);
printint(mem[p+1].hh.rh);print(1433);printint(mem[p+1].hh.b0);
printchar(44);printint(mem[p+1].hh.b1);printchar(41);end;
6:printesc(1430);others:print(1434)end{:1375};5:begin printesc(321);
...
{707:}16:printstyle(mem[p].hh.b1);17:{712:}begin printesc(571);
...
25:printesc(969);29:printesc(970);28:printesc(971);31:printesc(587);
26:begin printesc(580);printdelimiter(p+5);end;30:begin printesc(549);
...
if eqtb[29005+t].int=1000 then t:=mem[r+3].int else t:=xovern(mem[r+3].
int,1000)*eqtb[29005+t].int;printscaled(t);
...
56:printesc(497);57:printesc(498);58:printesc(499);59:printesc(500);
51:printesc(501);52:printesc(502);53:printesc(503);54:printesc(504);
55:printesc(505);60:printesc(506);61:printesc(507);62:printesc(508);
{1651:}63:printesc(1563);{:1651}{1410:}64:printesc(1460);
65:printesc(1461);66:printesc(1462);67:printesc(1463);68:printesc(1464);
69:printesc(1465);70:printesc(1466);71:printesc(1467);72:printesc(1468);
{:1410}{1451:}73:printesc(1508);{:1451}others:print(509)end;end;
...
begin case n of 0:printesc(512);1:printesc(513);2:printesc(514);
3:printesc(515);4:printesc(516);5:printesc(517);6:printesc(518);
7:printesc(519);8:printesc(520);9:printesc(521);10:printesc(522);
11:printesc(523);12:printesc(524);13:printesc(525);14:printesc(526);
15:printesc(527);16:printesc(528);17:printesc(529);18:printesc(530);
19:printesc(531);21:printesc(532);22:printesc(533);20:printesc(534);
23:printesc(535);24:printesc(536);others:print(537)end;end;
{:253}{258:}{308:}procedure printcmdchr(cmd:quarterword;
chrcode:halfword);var n:integer;begin case cmd of 1:begin print(608);
print(chrcode);end;2:begin print(609);print(chrcode);end;
3:begin print(610);print(chrcode);end;6:begin print(611);print(chrcode);
end;7:begin print(612);print(chrcode);end;8:begin print(613);
print(chrcode);end;9:print(614);10:begin print(615);print(chrcode);end;
11:begin print(616);print(chrcode);end;12:begin print(617);
print(chrcode);end;16,17,18:begin print(618);printkanji(chrcode);end;
...
25069:printesc(426);{1409:}25071:printesc(1459);
{:1409}others:printesc(427)end;
{:237}{245:}79:if chrcode<29005 then printparam(chrcode-28931)else begin
printesc(510);printint(chrcode-29005);end;
{:245}{255:}80:if chrcode<29542 then printlengthparam(chrcode-29517)else
begin printesc(538);printint(chrcode-29542);end;
{:255}{276:}48:printesc(549);101:printesc(550);43:printesc(551);
44:printesc(552);83:printesc(563);64:printesc(553);45:printesc(578);
19:printesc(554);119:printesc(545);97:printesc(560);98:printesc(561);
99:printesc(562);15:printesc(555);103:printesc(557);70:printesc(546);
65:printesc(558);67:printesc(32);
114:if chrcode=0 then printesc(559){1518:}else printesc(868){:1518};
35:printesc(564);39:printesc(565);
42:if chrcode=0 then printesc(566)else printesc(542);40:printesc(335);
47:printesc(47);21:begin printesc(360);if chrcode>0 then printchar(115);
end;49:printesc(567);20:printesc(568);57:printesc(571);
102:printesc(572);37:printesc(573);68:printesc(574);
115:if chrcode=0 then printesc(575)else printesc(542);58:printesc(340);
66:printesc(576);69:printesc(580);
107:if chrcode=0 then printesc(582){1515:}else printesc(1523){:1515};
0:printesc(583);109:printesc(584);89:printesc(579);
93:case chrcode of 25061:printesc(577);{1620:}25328:printesc(1556);
25329:printesc(1557);25330:printesc(1558);25331:printesc(1559);
{:1620}end;
121:if chrcode=0 then printesc(585){1438:}else if chrcode=1 then
printesc(1498)else printesc(1499){:1438};77:{1588:}begin printesc(428);
if chrcode<>membot then printsanum(chrcode);end{:1588};41:printesc(361);
36:if chrcode=0 then printesc(586){1453:}else case chrcode of 6:printesc
(1509);7:printesc(1510);10:printesc(1511);
others:printesc(1512)end{:1453};59:printesc(587);38:printesc(588);
{:276}{345:}13:printesc(650);
{:345}{394:}116:if chrcode=0 then printesc(688){1503:}else if chrcode=2
then printesc(1521){:1503}else printesc(689);
{:394}{402:}122:begin case(chrcode mod 5)of 1:printesc(691);
2:printesc(692);3:printesc(693);4:printesc(694);others:printesc(690)end;
if chrcode>=5 then printchar(115);end;
{:402}{429:}100:{1587:}begin if(chrcode<membot)or(chrcode>membot+23)then
cmd:=(mem[chrcode].hh.b0 div 16)else begin cmd:=chrcode-membot;
chrcode:=-268435455;end;
if cmd=0 then printesc(510)else if cmd=1 then printesc(538)else if cmd=2
then printesc(416)else printesc(417);
if chrcode<>-268435455 then printsanum(chrcode);end{:1587};
{:429}{434:}88:if chrcode=1 then printesc(733)else printesc(732);
91:if chrcode=0 then printesc(734){1444:}else if chrcode=2 then printesc
(1504){:1444}else printesc(735);
92:if chrcode=1 then printesc(736)else if chrcode=3 then printesc(737)
else printesc(738);74:case chrcode of 0:printesc(739);1:printesc(740);
2:printesc(741);5:printesc(742);{1401:}3:printesc(1452);
4:printesc(1453);10:printesc(1454);7:printesc(1455);8:printesc(1456);
9:printesc(1457);{:1401}{1415:}11:printesc(1483);12:printesc(1484);
{:1415}{1418:}13:printesc(1485);14:printesc(1486);15:printesc(1487);
{:1418}{1421:}18:printesc(1488);19:printesc(1489);20:printesc(1490);
21:printesc(1491);{:1421}{1424:}22:printesc(1492);23:printesc(1493);
24:printesc(1494);{:1424}{1534:}29:printesc(1532);30:printesc(1533);
31:printesc(1534);32:printesc(1535);{:1534}{1557:}16:printesc(1539);
17:printesc(1540);25:printesc(1541);26:printesc(1542);
{:1557}{1561:}27:printesc(1543);28:printesc(1544);
{:1561}others:printesc(743)end;
{:434}{486:}120:case chrcode of 0:printesc(804);1:printesc(805);
3:printesc(806);4:printesc(807);5:printesc(808);2:printesc(809);
6:printesc(810);7:printesc(811);8:printesc(812);9:printesc(813);
10:printesc(815);11:printesc(816);12:printesc(817);13:printesc(818);
14:printesc(819);15:printesc(820);16:printesc(821);
others:printesc(814)end;
{:486}{505:}117:begin if chrcode>=32 then printesc(868);
...
27:printesc(869);{1519:}17:printesc(1524);18:printesc(1525);
19:printesc(1526);{:1519}others:printesc(844)end;end;
...
{:798}{1001:}90:case chrcode of 0:printesc(1068);1:printesc(1069);
2:printesc(1070);3:printesc(1071);4:printesc(1072);5:printesc(1073);
6:printesc(1074);7:printesc(1075);others:printesc(1076)end;
{:1001}{1071:}14:if chrcode=1 then printesc(1126)else printesc(348);
{:1071}{1077:}29:case chrcode of 5:printesc(1127);0:printesc(1128);
1:printesc(1129);2:printesc(1130);3:printesc(1131);
others:printesc(1132)end;30:case chrcode of 5:printesc(1133);
0:printesc(1134);1:printesc(1135);2:printesc(1136);3:printesc(1137);
others:printesc(1138)end;31:printesc(341);32:printesc(345);
33:printesc(347);
{:1077}{1090:}24:if chrcode=1 then printesc(1156)else printesc(1157);
25:if chrcode=1 then printesc(1158)else printesc(1159);
23:case chrcode of 0:printesc(430);1:printesc(1160);2:printesc(1161);
3:printesc(1063);4:printesc(1162);5:printesc(1065);
others:printesc(1163)end;76:case chrcode of 4:printesc(1165);
3:printesc(1164);1:printesc(1166);end;
34:if chrcode=100 then printesc(1168)else if chrcode=101 then printesc(
1169)else if chrcode=102 then printesc(1170)else printesc(1167);
{:1090}{1107:}46:if chrcode=0 then printesc(1198)else printesc(1197);
{:1107}{1126:}28:if chrcode=12 then printesc(1211)else if chrcode=13
then printesc(1210)else printesc(1209);
26:if chrcode=1 then printesc(1213)else printesc(1212);
27:if chrcode=1 then printesc(1215){1617:}else if chrcode=2 then
printesc(1554)else if chrcode=3 then printesc(1555){:1617}else printesc(
1214);{:1126}{1133:}50:if chrcode=1 then printesc(45)else printesc(358);
{:1133}{1161:}51:if chrcode=1 then printesc(1249)else printesc(1248);
{:1161}{1175:}53:case chrcode of 18:printesc(962);19:printesc(963);
...
54:if chrcode=1 then printesc(975)else if chrcode=2 then printesc(976)
else printesc(1253);{:1175}{1188:}56:printstyle(chrcode);
{:1188}{1197:}55:case chrcode of 1:printesc(1272);2:printesc(1273);
3:printesc(1274);4:printesc(1275);5:printesc(1276);
others:printesc(1271)end;
{:1197}{1207:}52:if chrcode=32 then printesc(972){1449:}else if chrcode=
1 then printesc(974){:1449}else printesc(973);
{:1207}{1227:}104:if chrcode=1 then printesc(1296)else if chrcode=2 then
printesc(1297){1526:}else if chrcode=8 then printesc(1310){:1526}else
printesc(1298);
108:if chrcode=0 then printesc(1299)else if chrcode=1 then printesc(1300
)else if chrcode=2 then printesc(1301)else printesc(1302);
{:1227}{1238:}105:if chrcode<>0 then printesc(1320)else printesc(1319);
{:1238}{1241:}106:case chrcode of 0:printesc(1321);1:printesc(1322);
2:printesc(1323);3:printesc(1324);4:printesc(1325);5:printesc(1326);
6:printesc(1327);8:printesc(1329);others:printesc(1328)end;
71:begin printesc(554);printhex(chrcode);end;72:begin printesc(568);
printhex(chrcode);end;73:begin printesc(570);printhex(chrcode);end;
...
chrcode=28419 then printesc(445)else if chrcode=28547 then printesc(1334
...
29261 then printesc(511)else printesc(1335);95:printsize(chrcode-25589);
{:1249}{1270:}110:if chrcode=1 then printesc(1051)else printesc(1039);
{:1270}{1274:}84:if chrcode=0 then printesc(1354)else printesc(1355);
{:1274}{1280:}96:begin print(1363);slowprint(fontname[chrcode]);
...
2:printesc(275);others:printesc(1364)end;
{:1282}{1292:}63:if chrcode=0 then printesc(1366)else printesc(1365);
{:1292}{1297:}61:if chrcode=0 then printesc(1367)else printesc(1368);
{:1297}{1306:}60:if chrcode=27651 then printesc(1374)else printesc(1375)
;{:1306}{1311:}22:case chrcode of 1:printesc(1377);2:printesc(1378);
3:printesc(1379);{1427:}4:printesc(1495);{:1427}{1436:}5:printesc(1497);
{:1436}{1441:}6:printesc(1500);{:1441}7:printesc(1380);
others:printesc(1376)end;{:1311}{1314:}113:print(1387);
...
print(1388);end;127:printesc(1389);
{:1314}{1365:}62:case chrcode of 0:printesc(1424);1:printesc(647);
2:printesc(1425);3:printesc(1426);4:printesc(1427);5:printesc(1428);
6:printesc(1430);7:printesc(1429);others:print(1431)end;
{:1365}{1687:}87:printesc(441);
{:1687}{1692:}112:begin if(chrcode mod 2)=0 then printesc(1571)else
printesc(1572);if chrcode<2 then print(1573)else print(1574);end;
{:1692}{1699:}75:printesc(1579);86:printesc(1580);
{:1699}{1704:}85:case chrcode of 1:printesc(1583);2:printesc(1584);end;
{:1704}others:print(619)end;end;
{:308}ifdef('STAT')procedure showeqtb(n:halfword);
begin if n<1 then printchar(63)else if(n<24528)or((n>30053)and(n<=
...
end{:241}{:239}else if n<29517 then{248:}begin if n<29005 then
printparam(n-28931)else if n<29261 then begin printesc(510);
printint(n-29005);end else begin printesc(511);printint(n-29261);end;
printchar(61);printint(eqtb[n].int);
end{:248}else if n<29798 then{257:}begin if n<29542 then
printlengthparam(n-29517)else begin printesc(538);printint(n-29542);end;
printchar(61);printscaled(eqtb[n].int);print(418);
end{:257}else if n<=30053 then print(539)else printchar(63);end;
...
incr(hashhigh);hash[p].lh:=hashhigh+30053;p:=hashhigh+30053;
end else begin repeat if(hashused=514)then overflow(543,15000+hashextra)
...
begin if prim[p].rh>0 then begin repeat if(primused=1)then overflow(544,
...
8:print(419);10:print(1475);11:print(335);12:print(587);
...
while(grpstack[i]=curboundary)and(i>0)do begin{1530:}if eqtb[28999].int>
...
if eqtb[28999].int>1 then showcontext;if history=0 then history:=1;end;
end;{:1529}{1531:}procedure ifwarning;var i:0..maxinopen;w:boolean;
begin baseptr:=inputptr;inputstack[baseptr]:=curinput;i:=inopen;
w:=false;
while ifstack[i]=condptr do begin{1530:}if eqtb[28999].int>0 then begin
...
if w then begin printnl(1528);printcmdchr(117,curif);
if ifline<>0 then begin print(1501);printint(ifline);end;print(1529);
println;if eqtb[28999].int>1 then showcontext;
if history=0 then history:=1;end;end;
...
printcmdchr(117,curif);if iflimit=2 then printesc(871);
...
if maxsavestack>savesize-7 then overflow(589,savesize);end;
...
if mem[p+1].hh.rh=e then begin ifdef('STAT')if eqtb[28995].int>0 then
showsa(p,591);endif('STAT')sadestroy(p);
end else begin ifdef('STAT')if eqtb[28995].int>0 then showsa(p,592);
endif('STAT')if mem[p].hh.b1=curlevel then sadestroy(p)else sasave(p);
mem[p].hh.b1:=curlevel;mem[p+1].hh.rh:=e;
ifdef('STAT')if eqtb[28995].int>0 then showsa(p,593);endif('STAT')end;
deletesaref(p);end;procedure sawdef(p:halfword;w:integer);
begin incr(mem[p+1].hh.lh);
if mem[p+2].int=w then begin ifdef('STAT')if eqtb[28995].int>0 then
showsa(p,591);
endif('STAT')end else begin ifdef('STAT')if eqtb[28995].int>0 then
showsa(p,592);endif('STAT')if mem[p].hh.b1<>curlevel then sasave(p);
...
ifdef('STAT')if eqtb[28995].int>0 then showsa(p,594);
endif('STAT')sadestroy(p);mem[p].hh.b1:=1;mem[p+1].hh.rh:=e;
ifdef('STAT')if eqtb[28995].int>0 then showsa(p,593);
...
;ifdef('STAT')if eqtb[28968].int>0 then showsa(p,596);
...
ifdef('STAT')if eqtb[28968].int>0 then showsa(p,597);endif('STAT')end;
...
if curlevel=65535 then overflow(590,65535);curboundary:=saveptr;
curgroup:=c;ifdef('STAT')if eqtb[28996].int>0 then grouptrace(false);
...
{1589:}77,100:if(w.hh.rh<membot)or(w.hh.rh>membot+23)then deletesaref(w.
...
ifdef('STAT')if eqtb[28995].int>0 then restoretrace(p,591);
endif('STAT')eqdestroy(eqtb[p]);goto 10;end;
ifdef('STAT')if eqtb[28995].int>0 then restoretrace(p,592);
...
ifdef('STAT')if eqtb[28995].int>0 then restoretrace(p,593);
...
28995].int>0 then restoretrace(p,591);endif('STAT')goto 10;end;
ifdef('STAT')if eqtb[28995].int>0 then restoretrace(p,592);
...
begin ifdef('STAT')if eqtb[28995].int>0 then restoretrace(p,591);
...
begin ifdef('STAT')if eqtb[28995].int>0 then restoretrace(p,594);
...
{293:}if(p<28931)or(p>30053)then if eqtb[p].hh.b1=1 then begin eqdestroy
(savestack[saveptr]);
ifdef('STAT')if eqtb[28968].int>0 then restoretrace(p,596);
endif('STAT')end else begin eqdestroy(eqtb[p]);
eqtb[p]:=savestack[saveptr];
ifdef('STAT')if eqtb[28968].int>0 then restoretrace(p,597);
...
restoretrace(p,596);endif('STAT')end{:293};end;end;
30:ifdef('STAT')if eqtb[28996].int>0 then grouptrace(true);
...
if(eTeXmode=1)then decr(saveptr){:292};end else confusion(595);end;
{:291}{298:}procedure preparemag;
begin if(magset>0)and(eqtb[28948].int<>magset)then begin begin if
interaction=3 then;
if filelineerrorstylep then printfileline else printnl(263);print(599);
end;printint(eqtb[28948].int);print(600);printnl(601);begin helpptr:=2;
helpline[1]:=602;helpline[0]:=603;end;interror(magset);
geqworddefine(28948,magset);end;
if(eqtb[28948].int<=0)or(eqtb[28948].int>32768)then begin begin if
interaction=3 then;
if filelineerrorstylep then printfileline else printnl(263);print(604);
end;begin helpptr:=1;helpline[0]:=605;end;interror(eqtb[28948].int);
...
print(620);shownmode:=curlist.modefield;end;printcmdchr(curcmd,curchr);
if eqtb[28997].int>0 then if curcmd>=117 then if curcmd<=118 then begin
print(620);if curcmd=118 then begin printcmdchr(117,curif);
printchar(32);n:=0;l:=ifline;end else begin n:=1;l:=line;end;p:=condptr;
while p<>-268435455 do begin incr(n);p:=mem[p].hh.rh;end;print(621);
...
if(curinput.namefield=0)then if baseptr=0 then printnl(626)else printnl(
627)else begin printnl(628);
if curinput.namefield=17 then printchar(42)else printint(curinput.
namefield-1);printchar(62);end else begin printnl(629);
...
end else begin{324:}case curinput.indexfield of 0:printnl(630);
1,2:printnl(631);
3:if curinput.locfield=-268435455 then printnl(632)else printnl(633);
4:printnl(634);5:begin println;printcs(curinput.namefield);end;
6:printnl(635);7:printnl(636);8:printnl(637);9:printnl(638);
10:printnl(639);11:printnl(640);12:printnl(641);13:printnl(642);
14:printnl(643);15:printnl(644);16:printnl(645);
...
if inputptr=stacksize then overflow(646,stacksize);end;
...
printnl(343);case t of 14:printesc(360);16:printesc(647);
others:printcmdchr(78,t+25056)end;print(607);tokenshow(p);
...
alignstate:=0 else fatalerror(648);begin decr(inputptr);
...
begin if inopen=maxinopen then overflow(649,maxinopen);
...
if filelineerrorstylep then printfileline else printnl(263);print(657);
end else begin curcs:=0;begin if interaction=3 then;
if filelineerrorstylep then printfileline else printnl(263);print(658);
end;end;{349:}p:=getavail;case scannerstatus of 2:begin print(664);
mem[p].hh.lh:=637;end;3:begin print(665);mem[p].hh.lh:=partoken;
longstate:=125;end;4:begin print(666);mem[p].hh.lh:=637;q:=p;
p:=getavail;mem[p].hh.rh:=q;mem[p].hh.lh:=81050;alignstate:=-1000000;
end;5:begin print(667);mem[p].hh.lh:=637;end;end;
begintokenlist(p,4){:349};print(659);sprintcs(warningindex);
begin helpptr:=4;helpline[3]:=660;helpline[2]:=661;helpline[1]:=662;
helpline[0]:=663;end;error;
end{:348}else begin begin if interaction=3 then;
if filelineerrorstylep then printfileline else printnl(263);print(651);
end;printcmdchr(117,curif);print(652);printint(skipline);
begin helpptr:=3;helpline[2]:=653;helpline[1]:=654;helpline[0]:=655;end;
if curcs<>0 then curcs:=0 else helpline[2]:=656;curtok:=81053;inserror;
...
if filelineerrorstylep then printfileline else printnl(263);print(668);
end;begin helpptr:=2;helpline[1]:=669;helpline[0]:=670;end;
...
if forceeof then begin if eqtb[28999].int>0 then if(grpstack[inopen]<>
...
if curinput.limitfield=curinput.startfield then printnl(671);println;
first:=curinput.startfield;begin;print(42);terminput;end;
curinput.limitfield:=last;
if(eqtb[28980].int<0)or(eqtb[28980].int>255)then decr(curinput.
limitfield)else buffer[curinput.limitfield]:=eqtb[28980].int;
first:=curinput.limitfield+1;curinput.locfield:=curinput.startfield;
end else fatalerror(672);end{:372};
...
begin if(scannerstatus=4)or(curalign=-268435455)then fatalerror(648);
...
first:=curinput.limitfield;begin;print(673);terminput;end;
...
print(709);end;sprintcs(warningindex);print(710);begin helpptr:=4;
helpline[3]:=711;helpline[2]:=712;helpline[1]:=713;helpline[0]:=714;end;
...
if filelineerrorstylep then printfileline else printnl(263);print(704);
end;sprintcs(warningindex);print(705);begin helpptr:=3;helpline[2]:=706;
helpline[1]:=707;helpline[0]:=708;end;backerror;end;
...
if filelineerrorstylep then printfileline else printnl(263);print(696);
end;sprintcs(warningindex);print(697);begin helpptr:=6;helpline[5]:=698;
helpline[4]:=699;helpline[3]:=700;helpline[2]:=701;helpline[1]:=702;
helpline[0]:=703;end;incr(alignstate);longstate:=123;curtok:=partoken;
inserror;goto 22;
...
printint(n);print(715);showtokenlist(pstack[n-1],-268435455,1000);
...
paramptr+n;if maxparamstack>paramsize then overflow(695,paramsize);end;
...
if expanddepthcount>=expanddepth then overflow(674,expanddepth);
...
begin if interaction=3 then;
if filelineerrorstylep then printfileline else printnl(263);print(749);
end;printesc(868);print(1527);printcmdchr(curcmd,curchr);printchar(39);
begin helpptr:=1;helpline[0]:=670;end;backerror;end{:1520};
...
end;begin helpptr:=2;helpline[1]:=676;helpline[0]:=677;end;backerror;
...
if filelineerrorstylep then printfileline else printnl(263);print(684);
end;printesc(546);print(685);begin helpptr:=2;helpline[1]:=686;
helpline[0]:=687;end;backerror;end{:390};{391:}j:=first;p:=mem[r].hh.rh;
...
117:conditional;
118:{527:}begin if eqtb[28997].int>0 then if eqtb[28967].int<=1 then
showcurcmdchr;
...
end;printcmdchr(118,curchr);begin helpptr:=1;helpline[0]:=873;end;error;
...
116:{395:}if curchr=1 then forceeof:=true{1504:}else if curchr=2 then
...
end;begin helpptr:=5;helpline[4]:=679;helpline[3]:=680;helpline[2]:=681;
helpline[1]:=682;helpline[0]:=683;end;error;end{:387}end;
...
if filelineerrorstylep then printfileline else printnl(263);print(716);
end;begin helpptr:=4;helpline[3]:=717;helpline[2]:=718;helpline[1]:=719;
helpline[0]:=720;end;backerror;curtok:=379;curcmd:=1;curchr:=123;
...
end;begin helpptr:=1;helpline[0]:=722;end;error;end;
...
if filelineerrorstylep then printfileline else printnl(263);print(751);
end;begin helpptr:=2;helpline[1]:=752;helpline[0]:=725;end;
...
interaction=3 then;
if filelineerrorstylep then printfileline else printnl(263);print(753);
end;begin helpptr:=2;helpline[1]:=754;helpline[0]:=725;end;
...
end;begin helpptr:=2;helpline[1]:=756;helpline[0]:=725;end;
interror(curval);curval:=0;end;end;procedure scanbigfourbitint;
begin scanint;
if(curval<0)or(curval>255)then begin begin if interaction=3 then;
if filelineerrorstylep then printfileline else printnl(263);print(755);
end;begin helpptr:=2;helpline[1]:=757;helpline[0]:=725;end;
...
if filelineerrorstylep then printfileline else printnl(263);print(758);
end;begin helpptr:=2;helpline[1]:=759;helpline[0]:=725;end;
...
if filelineerrorstylep then printfileline else printnl(263);print(760);
end;begin helpptr:=2;helpline[1]:=761;helpline[0]:=725;end;
interror(curval);curval:=0;end;
...
end;begin helpptr:=2;helpline[1]:=727;helpline[0]:=725;end;
...
if filelineerrorstylep then printfileline else printnl(263);print(751);
end;begin helpptr:=2;helpline[1]:=maxreghelpline;helpline[0]:=725;end;
interror(curval);curval:=0;end;end;
...
if c>=eqtb[28991].int then if c<=eqtb[28992].int then if(eqtb[28675+c].
...
if filelineerrorstylep then printfileline else printnl(263);print(912);
...
if filelineerrorstylep then printfileline else printnl(263);print(897);
...
n:smallnumber):halfword;label 30,31;var p,s:halfword;
begin s:=calcpos(c);p:=s;ifdef('TEXMF_DEBUG')println;print(1585);
printint(c);print(1586);printint(s);if p+27385<0 then begin print(1587);
println;end;
...
case curcmd of 85:{1707:}begin scanint;q:=getkinsokupos(curval,1);
curvallevel:=0;curval:=0;
if(q<>1000)and(m=eqtb[27385+q].hh.b0)then begin curval:=eqtb[29798+q].
int;curvallevel:=0;end;end{:1707};86:{1702:}begin scanint;
q:=getinhibitpos(curval,1);curvallevel:=0;curval:=3;
if q<>1000 then curval:=eqtb[27129+q].hh.b0;end{:1702};
...
end;begin helpptr:=2;helpline[1]:=724;helpline[0]:=725;end;
...
end else if m=29261 then begin curval1:=eqtb[29261+curval].int;
curval:=getintone(eqtb[29261+curval]);
...
end;begin helpptr:=2;helpline[1]:=727;helpline[0]:=725;end;error;
begin curval:=0;curvallevel:=0;end;
end else begin curval:=curval1*4096+curval;curvallevel:=0;end;
end else if m=(29389)then begin begin curval:=-1;curvallevel:=0;end;
...
print(728);end;begin helpptr:=3;helpline[2]:=729;helpline[1]:=730;
helpline[0]:=731;end;backerror;begin curval:=0;curvallevel:=1;end;
...
then;if filelineerrorstylep then printfileline else printnl(263);
print(744);end;printcmdchr(88,m);begin helpptr:=4;helpline[3]:=745;
helpline[2]:=746;helpline[1]:=747;helpline[0]:=748;end;error;
...
91:{436:}begin if m=0 then curval:=deadcycles{1445:}else if m=2 then
...
93:{440:}begin if m>25061 then{1621:}begin scanint;
...
end{:1621}else if eqtb[25061].hh.rh=-268435455 then curval:=0 else
...
:=mem[curptr+1].hh.rh;
end else case curvallevel of 0:curval:=eqtb[29005+curval].int;
1:curval:=eqtb[29542+curval].int;2:curval:=eqtb[24549+curval].hh.rh;
3:curval:=eqtb[24805+curval].hh.rh;end;end;end{:444};
74:{441:}if m>=5 then if m>=27 then{1535:}begin if m<28 then begin case
...
if filelineerrorstylep then printfileline else printnl(263);print(749);
end;printcmdchr(curcmd,curchr);print(750);printesc(585);
begin helpptr:=1;helpline[0]:=748;end;error;
if level<>5 then begin curval:=0;curvallevel:=1;
...
end;begin helpptr:=2;helpline[1]:=766;helpline[0]:=767;end;curval:=48;
...
if filelineerrorstylep then printfileline else printnl(263);print(768);
...
end;begin helpptr:=3;helpline[2]:=729;helpline[1]:=730;helpline[0]:=731;
...
interaction=3 then;
if filelineerrorstylep then printfileline else printnl(263);print(772);
end;print(773);begin helpptr:=1;helpline[0]:=774;end;error;
...
if scankeyword(775)then v:=({575:}fontinfo[6+parambase[eqtb[25588].hh.rh
]].int{:575})else if scankeyword(776)then v:=({576:}fontinfo[5+parambase
[eqtb[25588].hh.rh]].int{:576})else if scankeyword(777)then{1683:}if
...
qqqq.b0].int{:1683}else if scankeyword(778)then{1684:}if curlist.
...
interaction=3 then;
if filelineerrorstylep then printfileline else printnl(263);print(772);
end;print(779);begin helpptr:=4;helpline[3]:=780;helpline[2]:=781;
helpline[1]:=782;helpline[0]:=783;end;error;goto 88;end{:473};
if scankeyword(771)then{474:}begin preparemag;
...
{475:}if scankeyword(784)then begin num:=7227;denom:=100;
end else if scankeyword(785)then begin num:=12;denom:=1;
end else if scankeyword(786)then begin num:=7227;denom:=254;
end else if scankeyword(787)then begin num:=7227;denom:=2540;
end else if scankeyword(788)then begin num:=7227;denom:=7200;
end else if scankeyword(789)then begin num:=1238;denom:=1157;
end else if scankeyword(790)then begin num:=14856;denom:=1157;
end else if scankeyword(72)then begin num:=7227;denom:=10160;
end else if scankeyword(81)then begin num:=7227;denom:=10160;
end else if scankeyword(791)then goto 30 else{476:}begin begin if
interaction=3 then;
if filelineerrorstylep then printfileline else printnl(263);print(772);
end;print(792);begin helpptr:=6;helpline[5]:=793;helpline[4]:=794;
helpline[3]:=795;helpline[2]:=781;helpline[1]:=782;helpline[0]:=783;end;
...
interaction=3 then;
if filelineerrorstylep then printfileline else printnl(263);print(796);
end;begin helpptr:=2;helpline[1]:=797;helpline[0]:=798;end;error;
...
if scankeyword(800)then begin scandimen(mu,true,false);
...
if filelineerrorstylep then printfileline else printnl(263);print(1537);
end;begin helpptr:=1;helpline[0]:=1538;end;backerror;end;end{:1539};
aritherror:=b;
...
if p<>-268435455 then{1544:}begin f:=e;q:=p;e:=mem[q+1].int;
...
if filelineerrorstylep then printfileline else printnl(263);print(1344);
end;begin helpptr:=2;helpline[1]:=1536;helpline[0]:=1346;end;error;
...
mem[q+2].int:=0;end;
21:if scankeyword(801)then begin scandimen(false,false,false);
mem[q+1].int:=curval;goto 21;end;
if scankeyword(802)then begin scandimen(false,false,false);
mem[q+3].int:=curval;goto 21;end;
if scankeyword(803)then begin scandimen(false,false,false);
...
if eqtb[28998].int>0 then begin if termoffset>maxprintline-3 then
...
end;begin helpptr:=2;helpline[1]:=825;helpline[0]:=725;end;
interror(curval);curval:=0;end;end;i:=curval;curval:=0;
if(scankeyword(826))then begin scanint;
if(curval<0)then begin begin if interaction=3 then;
if filelineerrorstylep then printfileline else printnl(263);print(827);
end;begin helpptr:=2;helpline[1]:=828;helpline[0]:=725;end;
...
interaction=3 then;
if filelineerrorstylep then printfileline else printnl(263);print(837);
...
end;printesc(582);begin helpptr:=1;helpline[0]:=843;end;
...
if eqtb[28997].int>0 then showcurcmdchr;end;
...
while true do begin if q=-268435455 then confusion(844);
...
isunless:boolean;
begin if eqtb[28997].int>0 then if eqtb[28967].int<=1 then showcurcmdchr
...
interaction=3 then;
if filelineerrorstylep then printfileline else printnl(263);print(876);
end;printcmdchr(117,thisif);begin helpptr:=1;helpline[0]:=877;end;
backerror;r:=61;end;
...
helpline[0]:=687;end;backerror;end{:390};{1523:}m:=first;
p:=mem[n].hh.rh;
...
b:=(eqtb[curcs].hh.b0<>113);end;{:1522}{1524:}19:begin scanfontident;
...
n:=curval;if eqtb[28967].int>1 then begin begindiagnostic;print(878);
...
if filelineerrorstylep then printfileline else printnl(263);print(881);
end else begin if interaction=3 then;
if filelineerrorstylep then printfileline else printnl(263);print(882);
end;printfilename(curname,curarea,curext);print(883);
if(e=884)or(e=343)then showcontext;println;
printcstring(promptfilenamehelpmsg);if(e<>343)then begin print(885);
print(e);print(39);end;print(41);println;printnl(886);print(s);
if interaction<2 then fatalerror(887);savedcurname:=curname;
savedcurext:=curext;savedcurarea:=curarea;;begin;print(620);terminput;
...
then write(logfile,'This is e-pTeX, Version 3.14159265','-p3.7.1',
'-160201','-2.6')else write(logfile,'This is e-pTeX, Version 3.14159265'
,'-p3.7.1','-160201','-2.6');write(logfile,' (');
write(logfile,conststringcast(getencstring));write(logfile,')');
write(logfile,versionstring);slowprint(formatident);print(895);
...
fflush(stdout);curinput.statefield:=58;{1660:}synctexstartinput;{:1660};
{555:}begin line:=1;
...
if s>=0 then begin print(829);printscaled(s);print(418);
...
if k=poolptr then goto 30 else if strpool[(k-1)]<>'p'then goto 30;
if k=poolptr then goto 30 else if strpool[(k)]<>'t'then goto 30;{:1747};
geqworddefine(29540,cw);geqworddefine(29541,t);curpageheight:=t;
...
if filelineerrorstylep then printfileline else printnl(263);print(1446);
...
if curext=343 then curext:=884;packfilename(curname,curarea,curext);
...
if(eqtb[28960].int<=0)then selector:=18 else selector:=19;printnl(1450);
printint(j);print(1451);printfilename(curname,curarea,curext);
print(883);printnl(343);println;selector:=oldsetting;end;end;end;
...
while true do begin while p<>-268435455 do{1479:}21:if(p>=himemmin)then
...
if m>-268435455 then decr(m)else{1484:}begin freenode(p,4);
...
{:1483}16:confusion(1518);5:begin disp2:=mem[p+1].int;
...
begin gorder:=mem[thisbox+5].hh.b1;gsign:=mem[thisbox+5].hh.b0;
[1477:]begin end[:1477];l:=t;p:=tempptr;m:=-268435455;n:=-268435455;
while true do begin while p<>-268435455 do[1479:]21:if(p>=himemmin)then
repeat f:=mem[p].hh.b0;c:=mem[p].hh.b1;
curh:=curh+fontinfo[widthbase[f]+fontinfo[charbase[f]+effectivechar(true
,f,c)].qqqq.b0].int;if fontdir[f]<>0 then begin q:=mem[p].hh.rh;la:=l;
...
dvidir:=curdirhv;end;others:confusion(1593);end end;
...
while p<>-268435455 do begin if(p>=himemmin)then begin repeat{1717:}if
...
if insertskip=2 then{1725:}begin if(eqtb[26873+ax].hh.rh mod 2)=1 then
...
firstchar<>-268435455 then{1719:}if mem[firstchar].hh.b0=11 then begin
ax:=48;
if insertskip=2 then{1725:}begin if(eqtb[26873+ax].hh.rh mod 2)=1 then
begin x:=getinhibitpos(cx,1);
if x<>1000 then if(eqtb[27129+x].hh.b0=0)or(eqtb[27129+x].hh.b0=2)then
...
{:1719};
if lastchar<>-268435455 then begin{1720:}if mem[lastchar].hh.b0=11 then
begin ax:=48;
if eqtb[26873+ax].hh.rh>=2 then insertskip:=1 else insertskip:=0;
...
lh;if insertskip=1 then{1724:}begin begin x:=getinhibitpos(cx,1);
if x<>1000 then if(eqtb[27129+x].hh.b0=0)or(eqtb[27129+x].hh.b0=1)then
doins:=false else doins:=true else doins:=true;end;
if doins then begin z:=newglue(s);mem[z].hh.b1:=17;
mem[z].hh.rh:=mem[q].hh.rh;mem[q].hh.rh:=z;q:=z;end;end{:1724};
...
{1725:}begin if(eqtb[26873+ax].hh.rh mod 2)=1 then begin x:=
getinhibitpos(cx,1);
if x<>1000 then if(eqtb[27129+x].hh.b0=0)or(eqtb[27129+x].hh.b0=2)then
doins:=false else doins:=true else doins:=true;end else doins:=false;
if doins then begin z:=newglue(s);mem[z].hh.b1:=17;
...
if(v<>-268435455)and pf and(i>5)then{1728:}begin q:=v;p:=mem[v].hh.rh;
if(v>=himemmin)and(fontdir[mem[v].hh.b0]<>0)then begin q:=p;
p:=mem[p].hh.rh;end;t:=q;s:=-268435455;
{1729:}while(p<>-268435455)do begin if(p>=himemmin)then begin if fontdir
...
others:begin q:=p;s:=-268435455;end;end;end;p:=mem[p].hh.rh;end{:1729};
...
if(mem[tempptr].hh.b0<>0)and(mem[tempptr].hh.b0<>1)then confusion(1594);
...
goto 22;end;
if mltexenabledp then{1639:}begin{1641:}if c>=eqtb[28991].int then if c
<=eqtb[28992].int then if(eqtb[28675+c].hh.rh>0)then begin basec:=(eqtb[
...
printnl(1561);print(c);print(1331);print(accentc);print(32);
...
40:{1642:}if eqtb[28966].int>99 then begin begindiagnostic;
printnl(1562);print(c);print(1331);print(accentc);print(32);
...
-268435455 then begin if mem[p].hh.b0<>2 then{1671:}if mem[p].hh.b0=1
...
topedge:=curv;
while p<>-268435455 do{647:}begin if(p>=himemmin)then confusion(924)else
...
begin{1665:}synctexsheet(eqtb[28948].int);{:1665};
begin if eqtb[28965].int>0 then begin printnl(343);println;print(925);
end;if termoffset>maxprintline-9 then println else if(termoffset>0)or(
fileoffset>0)then printchar(32);printchar(91);j:=9;
while(eqtb[29005+j].int=0)and(j>0)do decr(j);
for k:=0 to j do begin printint(eqtb[29005+k].int);
...
[p+3].int+mem[p+2].int+eqtb[29536].int>1073741823)or(mem[p+1].int+eqtb[
29535].int>1073741823)then begin begin if interaction=3 then;
if filelineerrorstylep then printfileline else printnl(263);print(929);
end;begin helpptr:=2;helpline[1]:=930;helpline[0]:=931;end;error;
if eqtb[28965].int<=0 then begin begindiagnostic;printnl(932);
showbox(p);enddiagnostic(true);end;goto 30;end;
if mem[p+3].int+mem[p+2].int+eqtb[29536].int>maxv then maxv:=mem[p+3].
int+mem[p+2].int+eqtb[29536].int;
if mem[p+1].int+eqtb[29535].int>maxh then maxh:=mem[p+1].int+eqtb[29535]
.int{:658};
{634:}{1745:}if eqtb[29541].int<>0 then curpageheight:=eqtb[29541].int
...
int+2*eqtb[29536].int+2*4736286 else curpageheight:=mem[p+3].int+mem[p+2
].int+2*eqtb[29536].int+2*4736286;
end else curpageheight:=mem[p+3].int+mem[p+2].int+2*eqtb[29536].int+2
*4736286;
if eqtb[29540].int<>0 then curpagewidth:=eqtb[29540].int else if(mem[p].
...
+2*eqtb[29535].int+2*4736286 else curpagewidth:=mem[p+1].int+2*eqtb[
29535].int+2*4736286;
end else curpagewidth:=mem[p+1].int+2*eqtb[29535].int+2*4736286;{:1745};
dvih:=0;dviv:=0;curh:=eqtb[29535].int;dvif:=0;dvidir:=4;
curdirhv:=dvidir;
...
end;for k:=0 to 9 do dvifour(eqtb[29005+k].int);dvifour(lastbop);
lastbop:=pageloc;curv:=mem[p+3].int+eqtb[29536].int;tempptr:=p;
...
printint(LRproblems mod 10000);print(1517);LRproblems:=0;end{:1464};
printchar(41);println;end;
if(LRptr<>-268435455)or(curdir<>0)then confusion(1519);end{:1485};
if eqtb[28965].int<=0 then printchar(93);deadcycles:=0;fflush(stdout);
{656:}ifdef('STAT')if eqtb[28962].int>1 then begin printnl(926);
printint(varused);printchar(38);printint(dynused);printchar(59);end;
endif('STAT')flushnodelist(p);
ifdef('STAT')if eqtb[28962].int>1 then begin print(927);
...
if(eqtb[29004].int>0)then{1461:}begin tempptr:=getavail;
mem[tempptr].hh.lh:=0;mem[tempptr].hh.rh:=LRptr;LRptr:=tempptr;
end{:1461};while p<>-268435455 do{668:}begin 21:chain:=false;
...
if(eqtb[29004].int>0)then{1462:}if odd(mem[p].hh.b1)then if mem[LRptr].
...
{683:}if(-x-totalshrink[0]>eqtb[29525].int)or(eqtb[28957].int<100)then
begin if(eqtb[29533].int>0)and(-x-totalshrink[0]>eqtb[29525].int)then
begin while mem[q].hh.rh<>-268435455 do q:=mem[q].hh.rh;
mem[q].hh.rh:=newrule;mem[mem[q].hh.rh+1].int:=eqtb[29533].int;end;
...
if lastbadness>eqtb[28957].int then begin println;printnl(950);
...
if(eqtb[29004].int>0)then{1463:}begin if mem[LRptr].hh.lh<>0 then begin
...
if LRproblems>0 then begin{1464:}begin println;printnl(1515);
printint(LRproblems div 10000);print(1516);
printint(LRproblems mod 10000);print(1517);LRproblems:=0;end{:1464};
goto 50;end;begin tempptr:=LRptr;LRptr:=mem[tempptr].hh.rh;
begin mem[tempptr].hh.rh:=avail;avail:=tempptr;
ifdef('STAT')decr(dynused);endif('STAT')end;end;
if LRptr<>-268435455 then confusion(1514);end{:1463};hpack:=r;end;
...
while p<>-268435455 do{686:}begin if(p>=himemmin)then confusion(951)else
...
if(totalshrink[o]<-x)and(o=0)and(mem[r+5].hh.rh<>-268435455)then begin
lastbadness:=1000000;mem[r+6].gr:=1.0;
{694:}if(-x-totalshrink[0]>eqtb[29526].int)or(eqtb[28958].int<100)then
...
lastbadness:=badness(-x,totalshrink[0]);
if lastbadness>eqtb[28958].int then begin println;printnl(955);
...
if d<eqtb[29519].int then p:=newparamglue(0)else begin p:=newskipparam(1
...
mem[b+1].int:=eqtb[29528].int;end;
...
begin if curlist.dirfield=3 then d:=eqtb[29538].int else d:=eqtb[29539].
int;
if curstyle<4 then d:=xnoverd(d,eqtb[28988].int,1000)else if curstyle<6
then d:=xnoverd(d,eqtb[28989].int,1000)else d:=xnoverd(d,eqtb[28990].int
...
confusion(987)end else begin if mem[v].hh.b0<>1 then confusion(587)end;
...
,mem[q+4].hh.lh);mem[x+1].int:=mem[x+1].int+eqtb[29529].int;
...
curstyle mod 2),mem[q+4].hh.lh);
mem[x+1].int:=mem[x+1].int+eqtb[29529].int;
...
mem[y+1].int:=mem[y+1].int+eqtb[29529].int;
...
delta2:=delta1+delta1-eqtb[29527].int;
...
if curcmd=9 then fatalerror(648);
...
then;if filelineerrorstylep then printfileline else printnl(263);
print(744);end;printesc(564);print(992);begin helpptr:=3;
...
begin if interaction=3 then;
if filelineerrorstylep then printfileline else printnl(263);print(1001);
...
begin if curalign=-268435455 then confusion(1007);
q:=mem[curalign].hh.rh;if q=-268435455 then confusion(1007);
if alignstate<500000 then fatalerror(648);p:=mem[q].hh.rh;
...
if filelineerrorstylep then printfileline else printnl(263);print(1008);
...
if nest[nestptr-1].modefield=227 then o:=eqtb[29532].int else o:=0;
...
if curlist.modefield=-1 then begin rulesave:=eqtb[29533].int;
eqtb[29533].int:=0;z:=newnullbox;mem[z].hh.rh:=mem[memtop-8].hh.rh;
...
+0].int);eqtb[29533].int:=rulesave;deleteglueref(mem[z+7].hh.rh);
...
if filelineerrorstylep then printfileline else printnl(263);print(1295);
...
if filelineerrorstylep then printfileline else printnl(263);print(1291);
...
ifdef('STAT')if eqtb[28963].int>0 then{863:}begin printnl(1023);
...
if dolastlinefit then{1607:}begin print(1552);printscaled(mem[q+3].int);
if curp=-268435455 then print(1553)else print(1096);
printscaled(mem[q+4].int);end{:1607};print(1026);
...
dolastlinefit then begin if curp=-268435455 then{1601:}begin if(mem[r+3]
...
if eqtb[29001].int<1000 then g:=fract(g,eqtb[29001].int,1000,1073741823)
...
if dolastlinefit then{1604:}begin if curp=-268435455 then shortfall:=0;
...
if curp=-268435455 then printesc(650)else if(mem[curp].hh.b0<>12)and(not
(curp>=himemmin))then begin if mem[curp].hh.b0=14 then printesc(578)else
if mem[curp].hh.b0=9 then printesc(358)else if mem[curp].hh.b0=13 then
printesc(345)else printesc(350);end;print(1027);
if mem[r+1].hh.rh=-268435455 then printchar(48)else printint(mem[mem[r+1
].hh.rh].hh.lh);print(1028);
...
repeat{897:}if(eqtb[29004].int>0)then{1458:}begin q:=mem[memtop-3].hh.rh
...
.b0=11 then{1459:}if odd(mem[q].hh.b1)then begin if LRptr<>-268435455
...
if(eqtb[29004].int>0)then{1459:}if odd(mem[q].hh.b1)then begin if LRptr
...
q:=r{:903};30:{:898};
if(eqtb[29004].int>0)then{1460:}if LRptr<>-268435455 then begin s:=
...
end{:1460};{904:}r:=mem[q].hh.rh;mem[q].hh.rh:=-268435455;
...
31;r:=q;
if mem[q].hh.b0=11 then if(eqtb[29004].int>0)then{1459:}if odd(mem[q].hh
...
if filelineerrorstylep then printfileline else printnl(263);print(1056);
...
end;30:{:978};if eqtb[29003].int>0 then{1610:}begin c:=curlang;
...
activenodesize:=3;
if eqtb[29001].int>0 then begin q:=mem[lastlinefill+1].hh.lh;
...
{:851}{865:}if eqtb[25061].hh.rh=-268435455 then if eqtb[29534].int=0
then begin lastspecialline:=0;secondwidth:=eqtb[29520].int;
secondindent:=0;
end else{866:}begin lastspecialline:=abs(eqtb[28972].int);
if eqtb[28972].int<0 then begin firstwidth:=eqtb[29520].int-abs(eqtb[
29534].int);
if eqtb[29534].int>=0 then firstindent:=eqtb[29534].int else firstindent
:=0;secondwidth:=eqtb[29520].int;secondindent:=0;
end else begin firstwidth:=eqtb[29520].int;firstindent:=0;
secondwidth:=eqtb[29520].int-abs(eqtb[29534].int);
if eqtb[29534].int>=0 then secondindent:=eqtb[29534].int else
secondindent:=0;end;
...
secondpass:=true;finalpass:=(eqtb[29537].int<=0);
...
5:;others:confusion(1035)end{:887};s:=mem[s].hh.rh;until s=-268435455;
...
printnl(1032);endif('STAT')threshold:=eqtb[28932].int;secondpass:=true;
finalpass:=(eqtb[29537].int<=0);
end else begin ifdef('STAT')if eqtb[28963].int>0 then printnl(1033);
endif('STAT')background[2]:=background[2]+eqtb[29537].int;
...
if filelineerrorstylep then printfileline else printnl(263);print(744);
...
5:s:=1162;6:if a=0 then begin if m=-1 then s:=564 else s:=586;a:=1;
goto 41;end else begin if a=1 then print(1496)else printesc(997);
if p>=a then p:=p-a;a:=0;goto 40;end;7:begin incr(p);a:=-1;
printesc(573);goto 42;end;8:begin printesc(419);goto 40;end;9:goto 42;
10,13:begin if curgroup=10 then printesc(358)else printesc(571);
...
12:begin s:=587;goto 41;end;14:begin incr(p);printesc(553);goto 40;end;
...
printesc(974);goto 40;end;end;{1432:}i:=savestack[saveptr-4].int;
...
(1298);i:=i-(65536);end;printesc(584);printint(i-1073741824);
printchar(61);end else printcmdchr(34,i-(1073872797)){:1432};
41:printesc(s);
{1431:}if savestack[saveptr-2].int<>0 then begin printchar(32);
if savestack[saveptr-3].int=0 then print(938)else print(939);
printscaled(savestack[saveptr-2].int);print(418);end{:1431};
...
if filelineerrorstylep then printfileline else printnl(263);print(1043);
...
end else begin case a of{1581:}0:if mem[q+2].hh.rh<>-268435455 then
begin deletetokenref(mem[q+2].hh.rh);mem[q+2].hh.rh:=-268435455;
deletetokenref(mem[q+3].hh.lh);mem[q+3].hh.lh:=-268435455;end;
{:1581}{1583:}1:if mem[q+2].hh.lh<>-268435455 then begin if mem[q+1].hh.
...
end;{:1583}{1584:}2:if(mem[q+1].hh.lh<>-268435455)and(mem[q+1].hh.rh=
...
+1].hh.lh:=-268435455;end;end;endif('INITEX'){:1586}end;
...
helpline[1]:=1066;helpline[0]:=1067;end;error;vsplit:=-268435455;
goto 10;end;flushnodelist(mem[v].hh.rh);mem[v].hh.rh:=-268435455{:995};
q:=vertbreak(mem[v+5].hh.rh,h,eqtb[29523].int);{996:}p:=mem[v+5].hh.rh;
if p=q then mem[v+5].hh.rh:=-268435455 else while true do begin if mem[p
].hh.b0=6 then if mem[p+1].hh.lh<>0 then{1582:}begin findsaelement(6,mem
[p+1].hh.lh,true);
...
end{:1582}else if curmark[3]=-268435455 then begin curmark[3]:=mem[p+1].
...
p:=mem[p].hh.rh;end;30:{:996};q:=prunepagetop(q,eqtb[29002].int>0);
p:=mem[v+5].hh.rh;
...
q:=vpackage(p,h,0,eqtb[29523].int);
...
print(1077);end;if pagesofar[5]<>0 then begin print(316);
printscaled(pagesofar[5]);print(1078);end;
if pagesofar[6]<>0 then begin print(316);printscaled(pagesofar[6]);
print(1079);end;if pagesofar[7]<>0 then begin print(317);
printscaled(pagesofar[7]);end;end;
{:1002}{1004:}procedure freezepagespecs(s:smallnumber);
begin pagecontents:=s;pagesofar[0]:=eqtb[29521].int;
pagemaxdepth:=eqtb[29522].int;pagesofar[8]:=0;pagesofar[1]:=0;
...
=3 then;if filelineerrorstylep then printfileline else printnl(263);
print(1089);end;begin helpptr:=3;helpline[2]:=1090;helpline[1]:=1091;
...
3 then;if filelineerrorstylep then printfileline else printnl(263);
print(343);end;printesc(430);print(1105);begin helpptr:=2;
...
end{:1585}else{1033:}begin if curmark[1]=-268435455 then begin curmark[1
...
savevfuzz:=eqtb[29526].int;eqtb[29526].int:=1073741823;
...
pagedir;eqtb[28958].int:=savevbadness;eqtb[29526].int:=savevfuzz;
...
if filelineerrorstylep then printfileline else printnl(263);print(1107);
...
interaction=3 then;
if filelineerrorstylep then printfileline else printnl(263);print(1098);
...
if eqtb[29005+n].int=1000 then h:=mem[r+3].int else h:=xovern(mem[r+3].
int,1000)*eqtb[29005+n].int;pagesofar[0]:=pagesofar[0]-h-mem[q+1].int;
pagesofar[2+mem[q].hh.b0]:=pagesofar[2+mem[q].hh.b0]+mem[q+2].int;
pagesofar[7]:=pagesofar[7]+mem[q+3].int;
if(mem[q].hh.b1<>0)and(mem[q+3].int<>0)then begin begin if interaction=3
then;if filelineerrorstylep then printfileline else printnl(263);
print(1100);end;printesc(416);printint(n);begin helpptr:=3;
...
if eqtb[29005+n].int=1000 then h:=mem[p+3].int else h:=xovern(mem[p+3].
int,1000)*eqtb[29005+n].int;
if((h<=0)or(h<=delta))and(mem[p+3].int+mem[r+3].int<=eqtb[29542+n].int)
then begin pagesofar[0]:=pagesofar[0]-h;
mem[r+3].int:=mem[r+3].int+mem[p+3].int;
end else{1027:}begin if eqtb[29005+n].int<=0 then w:=1073741823 else
begin w:=pagesofar[0]-pagesofar[1]-pagesofar[8];
if eqtb[29005+n].int<>1000 then w:=xovern(w,eqtb[29005+n].int)*1000;end;
if w>eqtb[29542+n].int-mem[r+3].int then w:=eqtb[29542+n].int-mem[r+3].
...
endif('STAT')if eqtb[29005+n].int<>1000 then bestheightplusdepth:=xovern
(bestheightplusdepth,1000)*eqtb[29005+n].int;
...
mem[p].hh.rh:=-268435455;
if eqtb[29002].int>0 then begin if discptr[2]=-268435455 then discptr[2]
...
if filelineerrorstylep then printfileline else printnl(263);print(1119);
...
curlist.tailfield:=mem[curlist.tailfield].hh.rh;end;
mem[curlist.tailfield+1].int:=eqtb[29520].int;
...
begin if interaction=3 then;
if filelineerrorstylep then printfileline else printnl(263);print(684);
end;{1083:}case curgroup of 14:begin mem[p].hh.lh:=81051;printesc(558);
...
printchar(125);end end{:1083};print(685);
...
begin begin if interaction=3 then;
if filelineerrorstylep then printfileline else printnl(263);print(1150);
end;case curgroup of 14:printesc(558);15:printchar(36);16:printesc(973);
...
if eqtb[29534].int<>0 then eqworddefine(29534,0);
...
if filelineerrorstylep then printfileline else printnl(263);print(1178);
...
then gm:=1 else confusion(1184);end else confusion(1185);end;
...
if filelineerrorstylep then printfileline else printnl(263);print(1193);
...
d:scaled;begin d:=eqtb[29524].int;deleteglueref(curkanjiskip);
deleteglueref(curxkanjiskip);
...
begin if interaction=3 then;
if filelineerrorstylep then printfileline else printnl(263);print(749);
end;printesc(565);print(1199);begin helpptr:=2;helpline[1]:=1200;
...
if filelineerrorstylep then printfileline else printnl(263);print(1202);
end;printesc(335);printint(255);begin helpptr:=1;helpline[0]:=1203;end;
...
;begin helpptr:=2;helpline[1]:=1188;helpline[0]:=1206;end;
...
[curchr];discptr[curchr]:=-268435455;goto 30;end{:1618};c:=curchr;
scanregisternum;
if curval<256 then p:=eqtb[25332+curval].hh.rh else begin findsaelement(
4,curval,false);
if curptr=-268435455 then p:=-268435455 else p:=mem[curptr+1].hh.rh;end;
...
begin if interaction=3 then;
if filelineerrorstylep then printfileline else printnl(263);print(1216);
...
end;printesc(358);begin helpptr:=2;helpline[1]:=1223;helpline[0]:=1224;
...
fontdir[f]=4 then disp:=eqtb[29538].int-eqtb[29539].int else disp:=eqtb[
29538].int end else begin if fontdir[f]=4 then disp:=0 else if fontdir[f
]=3 then disp:=eqtb[29539].int-eqtb[29538].int else disp:=eqtb[29539].
...
if filelineerrorstylep then printfileline else printnl(263);print(1235);
...
if filelineerrorstylep then printfileline else printnl(263);print(1231);
...
if filelineerrorstylep then printfileline else printnl(263);print(1235);
end;printesc(573);begin helpptr:=2;helpline[1]:=1243;helpline[0]:=1244;
end;error;end;procedure omiterror;begin begin if interaction=3 then;
if filelineerrorstylep then printfileline else printnl(263);print(1235);
end;printesc(576);begin helpptr:=2;helpline[1]:=1245;helpline[0]:=1244;
...
-268435455)or(inputstack[baseptr].statefield<>0)then fatalerror(648);
...
if filelineerrorstylep then printfileline else printnl(263);print(872);
end;printesc(546);begin helpptr:=1;helpline[0]:=1247;end;error;end;
...
{1486:}if curlist.eTeXauxfield=-268435455 then x:=0 else if mem[curlist.
...
if(eqtb[29004].int>0)then{1492:}if odd(mem[p].hh.b1)then begin if mem[
...
30:{1490:}if(eqtb[29004].int>0)then begin while LRptr<>-268435455 do
begin tempptr:=LRptr;LRptr:=mem[tempptr].hh.rh;
begin mem[tempptr].hh.rh:=avail;avail:=tempptr;
ifdef('STAT')decr(dynused);endif('STAT')end;end;
if LRproblems<>0 then begin w:=1073741823;LRproblems:=0;end;end;
curdir:=0;flushnodelist(mem[memtop-3].hh.rh){:1490}{:1164};end;
{1167:}if eqtb[25061].hh.rh=-268435455 then if(eqtb[29534].int<>0)and(((
eqtb[28972].int>=0)and(curlist.pgfield+2>eqtb[28972].int))or(curlist.
pgfield+1<-eqtb[28972].int))then begin l:=eqtb[29520].int-abs(eqtb[29534
].int);if eqtb[29534].int>0 then s:=eqtb[29534].int else s:=0;
end else begin l:=eqtb[29520].int;s:=0;
...
eqworddefine(29530,w);curlist.eTeXauxfield:=j;
if(eTeXmode=1)then eqworddefine(29000,x);eqworddefine(29531,l);
eqworddefine(29532,s);
...
if filelineerrorstylep then printfileline else printnl(263);print(1250);
...
interaction=3 then;
if filelineerrorstylep then printfileline else printnl(263);print(1252);
...
until(curcmd<>10)and(curcmd<>0){:421};
case curcmd of 11,12:begin curval:=eqtb[29261+curchr].int;
curval1:=getintone(eqtb[29261+curchr]);end;
...
if filelineerrorstylep then printfileline else printnl(263);print(1256);
...
if filelineerrorstylep then printfileline else printnl(263);print(1263);
end;printesc(567);print(1264);begin helpptr:=2;helpline[1]:=1265;
...
if filelineerrorstylep then printfileline else printnl(263);print(1267);
end;begin helpptr:=1;helpline[0]:=1268;end;
end else begin begin if interaction=3 then;
if filelineerrorstylep then printfileline else printnl(263);print(1269);
...
begin if interaction=3 then;
if filelineerrorstylep then printfileline else printnl(263);print(1277);
...
begin s:=eqtb[29532].int;x:=eqtb[29000].int;
if x=0 then mem[b+4].int:=s+d else begin z:=eqtb[29531].int;p:=b;
...
freenode(p,10);if r=-268435455 then confusion(1520);
if x>0 then begin p:=r;repeat q:=r;r:=mem[r].hh.rh;until r=-268435455;
end else begin p:=-268435455;q:=r;repeat t:=mem[r].hh.rh;
mem[r].hh.rh:=p;p:=r;r:=t;until r=-268435455;end;end{:1500};
{1501:}if j=-268435455 then begin r:=newkern(0);t:=newkern(0);
...
{1497:}if curlist.modefield=227 then j:=curlist.eTeXauxfield{:1497};
...
interaction=3 then;
if filelineerrorstylep then printfileline else printnl(263);print(1283);
...
interaction=3 then;
if filelineerrorstylep then printfileline else printnl(263);print(1287);
...
if m<0 then{1214:}begin if curlist.dirfield=3 then disp:=eqtb[29538].int
else disp:=eqtb[29539].int;
...
mem[curlist.tailfield].hh.b0:=5;mem[curlist.tailfield+1].int:=disp;
curlist.pdispfield:=disp;end;end;{:1735};
begin mem[curlist.tailfield].hh.rh:=newmath(eqtb[29518].int,0);
...
begin mem[curlist.tailfield].hh.rh:=newmath(eqtb[29518].int,1);
curlist.tailfield:=mem[curlist.tailfield].hh.rh;end;
{1736:}if disp<>0 then begin if not(curlist.tailfield>=himemmin)and(mem[
curlist.tailfield].hh.b0=5)then begin mem[curlist.tailfield+1].int:=0;
end else begin curlist.pnodefield:=curlist.tailfield;
...
w:=mem[b+1].int;z:=eqtb[29531].int;s:=eqtb[29532].int;
if eqtb[29000].int<0 then s:=-s-z;
...
curlist.tailfield:=mem[curlist.tailfield].hh.rh;end;
if(d+s<=eqtb[29530].int)or l then begin g1:=3;g2:=4;
...
if(curcs=0)or(curcs>eqtbtop)or((curcs>15514)and(curcs<=30053))then begin
begin if interaction=3 then;
if filelineerrorstylep then printfileline else printnl(263);print(1312);
...
if filelineerrorstylep then printfileline else printnl(263);print(749);
end;printcmdchr(curcmd,curchr);print(750);printcmdchr(q,0);
begin helpptr:=1;helpline[0]:=1347;end;error;goto 10;end;end;
...
l:=curptr;e:=true;end else case p of 0:l:=curval+29005;
1:l:=curval+29542;2:l:=curval+24549;3:l:=curval+24805;end;end;end;
40:if p<2 then if e then w:=mem[l+2].int else w:=eqtb[l].int else if e
then s:=mem[l+1].hh.rh else s:=eqtb[l].hh.rh{:1256};
if q=100 then scanoptionalequals else if scankeyword(1343)then;
aritherror:=false;
...
if filelineerrorstylep then printfileline else printnl(263);print(1344);
end;begin helpptr:=2;helpline[1]:=1345;helpline[0]:=1346;end;
...
end;begin helpptr:=1;helpline[0]:=1351;end;interror(curval);
...
if curval<0 then begin begin if interaction=3 then;
if filelineerrorstylep then printfileline else printnl(263);print(1053);
end;printesc(579);begin helpptr:=1;helpline[0]:=1352;end;
...
if filelineerrorstylep then printfileline else printnl(263);print(1505);
...
if u>=514 then t:=hash[u].rh else if u>=257 then if u=513 then t:=1356
else t:=u-257 else begin oldsetting:=selector;selector:=21;print(1356);
...
if scankeyword(1357)then{1278:}begin scandimen(false,false,false);
s:=curval;
if(s<=0)or(s>=134217728)then begin begin if interaction=3 then;
if filelineerrorstylep then printfileline else printnl(263);print(1359);
end;printscaled(s);print(1360);begin helpptr:=2;helpline[1]:=1361;
helpline[0]:=1362;end;error;s:=10*65536;end;
end{:1278}else if scankeyword(1358)then begin scanint;s:=-curval;
if(curval<=0)or(curval>32768)then begin begin if interaction=3 then;
if filelineerrorstylep then printfileline else printnl(263);print(604);
end;begin helpptr:=1;helpline[0]:=605;end;interror(curval);s:=-1000;end;
...
if filelineerrorstylep then printfileline else printnl(263);print(1304);
...
3 then;if filelineerrorstylep then printfileline else printnl(263);
print(749);end;printesc(1296);print(1307);printesc(1297);
...
if(eqtb[28993].int>0)then begin begindiagnostic;printnl(1330);
print(p-28675);print(1331);print(n);printchar(32);print(curval);
enddiagnostic(false);end;n:=n*256+curval;
if(a>=4)then geqdefine(p,132,n)else eqdefine(p,132,n);
if(p-28675)<eqtb[28991].int then if(a>=4)then geqworddefine(28991,p
-28675)else eqworddefine(28991,p-28675);
if(p-28675)>eqtb[28992].int then if(a>=4)then geqworddefine(28992,p
-28675)else eqworddefine(28992,p-28675);end else begin n:=curchr;
getrtoken;p:=curcs;
...
end else case n of 3:if(a>=4)then geqdefine(p,79,29005+curval)else
eqdefine(p,79,29005+curval);
4:if(a>=4)then geqdefine(p,80,29542+curval)else eqdefine(p,80,29542+
curval);
...
if filelineerrorstylep then printfileline else printnl(263);print(1190);
end;begin helpptr:=2;helpline[1]:=1332;helpline[0]:=1333;end;error;end;
...
{:1246}{1250:}94:begin if curchr=(29389)then begin p:=curchr-128;
...
then;if filelineerrorstylep then printfileline else printnl(263);
print(1336);end;printint(curval1);print(32);printint(curval);
print(1337);begin helpptr:=1;helpline[0]:=1338;end;error;curval1:=0;
...
else if curchr=28163 then n:=32767 else if curchr=29261 then n:=16777215
...
if((curval<m)and(p<29261))or(curval>n)then begin begin if interaction=3
then;if filelineerrorstylep then printfileline else printnl(263);
print(1336);end;printint(curval);if p<29261 then begin print(1339);
printint(m);print(1340);end else print(1341);printint(n);
if m=0 then begin begin helpptr:=1;helpline[0]:=1338;end;error;
end else begin begin helpptr:=1;helpline[0]:=1342;end;error;end;
curval:=m;end;
...
end else if curval1=29261 then begin curval1:=curval div 4096;
...
if filelineerrorstylep then printfileline else printnl(263);print(744);
end;printesc(584);begin helpptr:=2;helpline[1]:=1348;helpline[0]:=1349;
...
if filelineerrorstylep then printfileline else printnl(263);print(1353);
...
{:1283}{1688:}87:begin p:=curchr;scanint;n:=curval;scanoptionalequals;
scanint;
if not ischarkanji(curval)then begin begin if interaction=3 then;
if filelineerrorstylep then printfileline else printnl(263);print(1564);
...
if filelineerrorstylep then printfileline else printnl(263);print(1566);
...
{:1688}{1693:}112:begin if curchr<2 then p:=26359 else begin p:=26360;
curchr:=(curchr mod 2);end;
if(a>=4)then geqdefine(p,132,curchr)else eqdefine(p,132,curchr);end;
{:1693}{1701:}86:begin p:=curchr;scanint;n:=curval;scanoptionalequals;
scanint;if ischarkanji(n)then begin j:=getinhibitpos(n,0);
if j=1000 then begin begin if interaction=3 then;
if filelineerrorstylep then printfileline else printnl(263);print(1581);
...
if filelineerrorstylep then printfileline else printnl(263);print(1582);
end;printhex(n);printchar(41);begin helpptr:=1;helpline[0]:=1565;end;
error;goto 10;end;end;{:1701}{1706:}85:begin p:=curchr;scanint;
n:=curval;scanoptionalequals;scanint;
if ischarascii(n)or ischarkanji(n)then begin j:=getkinsokupos(n,0);
if j=1000 then begin begin if interaction=3 then;
if filelineerrorstylep then printfileline else printnl(263);print(1588);
end;begin helpptr:=1;helpline[0]:=1565;end;error;goto 10;end;
if(p=1)or(p=2)then begin if(a>=4)then geqdefine(27385+j,p,n)else
eqdefine(27385+j,p,n);
if(a>=4)then geqworddefine(29798+j,curval)else eqworddefine(29798+j,
curval);end else confusion(539);
end else begin begin if interaction=3 then;
if filelineerrorstylep then printfileline else printnl(263);print(1589);
end;
if p=1 then print(1590)else if p=2 then print(1591)else printchar(63);
print(1592);printhex(n);printchar(41);begin helpptr:=1;
helpline[0]:=1565;end;error;goto 10;end;end;
{:1706}others:confusion(1303)end;
...
longhelpseen then begin helpptr:=1;helpline[0]:=1369;
end else begin if interaction<3 then longhelpseen:=true;
begin helpptr:=4;helpline[3]:=1370;helpline[2]:=1371;helpline[1]:=1372;
helpline[0]:=1373;end;end;error;useerrhelp:=false;end{:1302};
...
4,curval,false);
if curptr=-268435455 then p:=-268435455 else p:=mem[curptr+1].hh.rh;end;
begindiagnostic;printnl(1390);printint(curval);printchar(61);
if p=-268435455 then print(431)else showbox(p);end{:1315};
0:{1313:}begin gettoken;if interaction=3 then;printnl(1386);
if curcs<>0 then begin sprintcs(curcs);printchar(61);end;printmeaning;
goto 50;end{:1313};7:{1694:}begin printnl(1386);
if eqtb[26359].hh.rh>0 then print(1575)else print(1576);printnl(1386);
if eqtb[26360].hh.rh>0 then print(1577)else print(1578);goto 50;
end{:1694};{1428:}4:begin begindiagnostic;showsavegroups;end;
{:1428}{1442:}6:begin begindiagnostic;printnl(343);println;
if condptr=-268435455 then begin printnl(379);print(1502);
end else begin p:=condptr;n:=0;repeat incr(n);p:=mem[p].hh.rh;
until p=-268435455;p:=condptr;t:=curif;l:=ifline;m:=iflimit;
repeat printnl(1503);printint(n);print(620);printcmdchr(117,t);
...
printnl(1386);tokenshow(memtop-3);flushlist(mem[memtop-3].hh.rh);
...
print(1392);selector:=19;end{:1317};
50:if interaction<3 then begin helpptr:=0;decr(errorcount);
end else if eqtb[28960].int>0 then begin begin helpptr:=3;
helpline[2]:=1381;helpline[1]:=1382;helpline[0]:=1383;end;
end else begin begin helpptr:=5;helpline[4]:=1381;helpline[3]:=1382;
helpline[2]:=1383;helpline[1]:=1384;helpline[0]:=1385;end;end;error;end;
...
if filelineerrorstylep then printfileline else printnl(263);print(1394);
end;begin helpptr:=1;helpline[0]:=1395;end;
begin if interaction=3 then interaction:=2;if logopened then error;
ifdef('TEXMF_DEBUG')if interaction>0 then debughelp;
endif('TEXMF_DEBUG')history:=3;jumpout;end;end{:1323};
{1347:}selector:=21;print(1411);print(jobname);printchar(32);
...
while not wopenout(fmtfile)do promptfilename(1412,879);printnl(1413);
...
dumpthings(formatengine[0],x);libcfree(formatengine);dumpint(147802702);
{1630:}dumpthings(xord[0],256);dumpthings(xchr[0],256);
dumpthings(xprn[0],256);{:1630};dumpint(268435455);dumpint(hashhigh);
{1405:}dumpint(eTeXmode);for j:=0 to-0 do eqtb[29004+j].int:=0;
{:1405}{1513:}while pseudofiles<>-268435455 do pseudoclose;
{:1513}dumpint(membot);dumpint(memtop);dumpint(30053);dumpint(8501);
...
printint(strptr);print(1396);printint(poolptr){:1328};{1330:}sortavail;
...
dumpint(varused);dumpint(dynused);println;printint(x);print(1397);
...
while j<30053 do begin if(eqtb[j].int=eqtb[j+1].int)and(getintone(eqtb[j
])=getintone(eqtb[j+1]))then goto 42;incr(j);end;l:=30054;goto 32;
42:incr(j);l:=j;
while j<30053 do begin if(eqtb[j].int<>eqtb[j+1].int)or(getintone(eqtb[j
])<>getintone(eqtb[j+1]))then goto 32;incr(j);end;32:dumpint(l-k);
dumpthings(eqtb[k],l-k);k:=j+1;dumpint(k-l);until k>30053;
if hashhigh>0 then dumpthings(eqtb[30054],hashhigh);{:1335};
...
if hashhigh>0 then dumpthings(hash[30054],hashhigh);dumpint(cscount);
println;printint(cscount);print(1398){:1337}{:1332};
...
for k:=0 to fontptr do begin printnl(1402);printesc(hash[15526+k].rh);
...
printint(fmemptr-7);print(1399);printint(fontptr-0);
if fontptr<>1 then print(1400)else print(1401){:1339};
...
printint(hyphcount);if hyphcount<>1 then print(1403)else print(1404);
...
dumpthings(hyfnext[1],trieopptr);printnl(1405);printint(triemax);
print(1406);printint(trieopptr);
if trieopptr<>1 then print(1407)else print(1408);print(1409);
printint(trieopsize);
for k:=255 downto 0 do if trieused[k]>0 then begin printnl(895);
printint(trieused[k]);print(1410);printint(k);dumpint(k);
...
end end{:1397};others:confusion(1432)end;end;
...
if filelineerrorstylep then printfileline else printnl(263);print(1146);
...
incr(mem[q].hh.rh);d:=eqtb[29523].int;f:=eqtb[28973].int;unsave;
...
begin if interaction=3 then;
if filelineerrorstylep then printfileline else printnl(263);print(1204);
...
3 then;if filelineerrorstylep then printfileline else printnl(263);
print(1115);end;printesc(430);printint(255);begin helpptr:=3;
...
begin if interaction=3 then;
if filelineerrorstylep then printfileline else printnl(263);print(684);
end;printesc(997);print(685);begin helpptr:=1;helpline[0]:=1246;end;
...
150:{1454:}if curchr>0 then begin if eTeXenabled((eqtb[29004].int>0),
...
{:1309}{1697:}76,189,302:inhibitglueflag:=true;
{:1697}{1366:}63,176,289:doextension;{:1366}{:1063}end;goto 60;
...
curlist.tailfield].hh.rh:=newpenalty(eqtb[29798+kp].int);
curlist.tailfield:=mem[curlist.tailfield].hh.rh;end;
...
if fontdir[mainf]=4 then disp:=eqtb[29538].int-eqtb[29539].int else disp
:=eqtb[29538].int;mainf:=eqtb[26358].hh.rh;
end else begin if fontdir[mainf]=4 then disp:=0 else if fontdir[mainf]=3
then disp:=eqtb[29539].int-eqtb[29538].int else disp:=eqtb[29539].int;
...
eqtb[29798+kp].int else begin mainp:=mem[curq].hh.rh;
mem[curq].hh.rh:=newpenalty(eqtb[29798+kp].int);
...
tailfield].hh.rh:=newpenalty(eqtb[29798+kp].int);
curlist.tailfield:=mem[curlist.tailfield].hh.rh;end;
...
.tailfield+1].int:=mem[curlist.tailfield+1].int+eqtb[29798+kp].int else
begin begin mem[curlist.tailfield].hh.rh:=newpenalty(eqtb[29798+kp].int)
;curlist.tailfield:=mem[curlist.tailfield].hh.rh;end;
...
if curlist.dirfield=3 then disp:=eqtb[29538].int else disp:=eqtb[29539].
...
90:{1053:}if ligstack=-268435455 then begin{1736:}if disp<>0 then begin
if not(curlist.tailfield>=himemmin)and(mem[curlist.tailfield].hh.b0=5)
...
if hashextra<hashhigh then hashextra:=hashhigh;eqtbtop:=30053+hashextra;
...
eqtb[24527].hh.b1:=0;for x:=30054 to eqtbtop do eqtb[x]:=eqtb[24527];
{1406:}begin undumpint(x);if(x<0)or(x>1)then goto 6666 else eTeXmode:=x;
end;if(eTeXmode=1)then begin{1568:}maxregnum:=65535;
maxreghelpline:=1551;{:1568}end else begin{1567:}maxregnum:=255;
maxreghelpline:=752;{:1567}end;{:1406}undumpint(x);
...
mem:=zmem;undumpint(x);if x<>30053 then goto 6666;undumpint(x);
...
repeat undumpint(x);if(x<1)or(k+x>30054)then goto 6666;
undumpthings(eqtb[k],x);k:=k+x;undumpint(x);
if(x<0)or(k+x>30054)then goto 6666;
for j:=k to k+x-1 do eqtb[j]:=eqtb[k-1];k:=k+x;until k>30053;
if hashhigh>0 then undumpthings(eqtb[30054],hashhigh);{:1336};
...
if hashhigh>0 then begin undumpthings(hash[30054],hashhigh);
if debugformatfile then begin printcsnames(30054,hashhigh-(30054));end;
...
if totalpages<>1 then print(935)else print(936);print(380);
...
selector:=selector-2;if selector=17 then begin printnl(1414);
...
endfilereading;while openparens>0 do begin print(1415);decr(openparens);
end;if curlevel>1 then begin printnl(40);printesc(1416);print(1417);
printint(curlevel-1);printchar(41);if(eTeXmode=1)then showsavegroups;
end;while condptr<>-268435455 do begin printnl(40);printesc(1416);
print(1418);printcmdchr(117,curif);if ifline<>0 then begin print(1419);
printint(ifline);end;print(1420);ifline:=mem[condptr+1].int;
...
then begin selector:=17;printnl(1421);selector:=19;end;
...
goto 10;end;endif('INITEX')printnl(1422);goto 10;end;10:end;
...
primitive(498,79,28988);primitive(499,79,28989);primitive(500,79,28990);
primitive(501,79,28982);primitive(502,79,28983);primitive(503,79,28984);
primitive(504,79,28985);primitive(505,79,28986);
if mltexp then begin mltexenabledp:=true;
if false then primitive(506,79,28991);primitive(507,79,28992);
primitive(508,79,28993);end;{:244}{254:}primitive(512,80,29517);
...
primitive(528,80,29533);primitive(529,80,29534);primitive(530,80,29535);
primitive(531,80,29536);primitive(532,80,29538);primitive(533,80,29539);
primitive(534,80,29537);{:254}{275:}primitive(32,67,0);
primitive(47,47,0);primitive(549,48,0);primitive(550,101,0);
primitive(551,43,0);primitive(552,44,0);primitive(553,64,0);
primitive(554,19,0);primitive(545,119,0);primitive(555,15,0);
primitive(556,15,1);primitive(557,103,0);primitive(546,70,0);
primitive(558,65,0);hash[15516].rh:=558;eqtb[15516]:=eqtb[curval];
primitive(559,114,0);primitive(560,97,0);primitive(561,98,0);
primitive(562,99,0);primitive(563,83,0);primitive(564,35,0);
primitive(565,39,0);primitive(566,42,0);primitive(335,40,0);
primitive(360,21,0);primitive(567,49,0);primitive(568,20,0);
primitive(569,49,1);primitive(570,20,1);primitive(571,57,0);
primitive(572,102,0);primitive(573,37,0);primitive(574,68,0);
primitive(575,115,0);primitive(340,58,0);primitive(576,66,0);
primitive(577,93,25061);primitive(578,45,0);primitive(579,89,0);
primitive(580,69,0);primitive(581,69,1);primitive(582,107,0);
primitive(583,0,256);hash[15521].rh:=583;eqtb[15521]:=eqtb[curval];
primitive(584,109,0);primitive(585,121,0);primitive(428,77,membot);
primitive(361,41,0);primitive(586,36,0);primitive(587,59,0);
primitive(588,38,0);{:275}{344:}primitive(650,13,256);parloc:=curval;
partoken:=65535+parloc;{:344}{393:}primitive(688,116,0);
primitive(689,116,1);{:393}{401:}primitive(690,122,0);
primitive(691,122,1);primitive(692,122,2);primitive(693,122,3);
primitive(694,122,4);{:401}{428:}primitive(510,100,membot+0);
primitive(538,100,membot+1);primitive(416,100,membot+2);
primitive(417,100,membot+3);{:428}{433:}primitive(732,88,114);
primitive(733,88,1);primitive(734,91,0);primitive(735,91,1);
primitive(736,92,1);primitive(737,92,3);primitive(738,92,2);
primitive(739,74,0);primitive(740,74,1);primitive(741,74,2);
primitive(742,74,5);primitive(743,74,6);
{:433}{485:}primitive(804,120,0);primitive(805,120,1);
primitive(806,120,3);primitive(807,120,4);primitive(808,120,5);
primitive(809,120,2);primitive(810,120,6);primitive(811,120,7);
primitive(812,120,8);primitive(813,120,9);primitive(814,120,17);
{:485}{504:}primitive(844,117,0);primitive(845,117,1);
primitive(846,117,2);primitive(847,117,3);primitive(848,117,4);
primitive(849,117,5);primitive(850,117,6);primitive(851,117,7);
primitive(852,117,8);primitive(853,117,9);primitive(854,117,10);
primitive(855,117,11);primitive(856,117,12);primitive(857,117,13);
primitive(858,117,14);primitive(859,117,15);primitive(860,117,16);
primitive(861,117,20);primitive(862,117,21);primitive(863,117,22);
primitive(864,117,23);primitive(865,117,24);primitive(866,117,25);
primitive(867,117,26);{:504}{508:}primitive(315,118,2);
hash[15518].rh:=315;eqtb[15518]:=eqtb[curval];primitive(870,118,4);
primitive(871,118,3);{:508}{570:}primitive(896,96,0);
hash[15526].rh:=896;eqtb[15526]:=eqtb[curval];
{:570}{797:}primitive(996,4,256);primitive(997,5,257);
hash[15515].rh:=997;eqtb[15515]:=eqtb[curval];primitive(998,5,258);
hash[15519].rh:=999;hash[15520].rh:=999;eqtb[15520].hh.b0:=9;
eqtb[15520].hh.rh:=memtop-11;eqtb[15520].hh.b1:=1;
eqtb[15519]:=eqtb[15520];eqtb[15519].hh.b0:=127;
{:797}{1000:}primitive(1068,90,0);primitive(1069,90,1);
primitive(1070,90,2);primitive(1071,90,3);primitive(1072,90,4);
primitive(1073,90,5);primitive(1074,90,6);primitive(1075,90,7);
primitive(1076,90,8);{:1000}{1070:}primitive(348,14,0);
primitive(1126,14,1);{:1070}{1076:}primitive(1127,29,5);
primitive(1128,29,0);primitive(1129,29,1);primitive(1130,29,2);
primitive(1131,29,3);primitive(1132,29,4);primitive(1133,30,5);
primitive(1134,30,0);primitive(1135,30,1);primitive(1136,30,2);
primitive(1137,30,3);primitive(1138,30,4);primitive(341,31,6);
primitive(345,32,1);primitive(347,33,99);
{:1076}{1089:}primitive(1156,24,1);primitive(1157,24,0);
primitive(1158,25,1);primitive(1159,25,0);primitive(430,23,0);
primitive(1160,23,1);primitive(1161,23,2);primitive(1063,23,3);
primitive(1162,23,4);primitive(1065,23,5);primitive(1163,23,118);
primitive(1164,76,3);primitive(1165,76,4);primitive(1166,76,1);
primitive(1167,34,99);primitive(1168,34,100);primitive(1169,34,101);
primitive(1170,34,102);{:1089}{1106:}primitive(1197,46,1);
primitive(1198,46,0);{:1106}{1125:}primitive(1209,28,14);
primitive(1210,28,13);primitive(1211,28,12);primitive(1212,26,0);
primitive(1213,26,1);primitive(1214,27,0);primitive(1215,27,1);
{:1125}{1132:}primitive(45,50,1);primitive(358,50,0);
{:1132}{1159:}primitive(1248,51,0);primitive(1249,51,1);
{:1159}{1174:}primitive(962,53,18);primitive(963,53,19);
primitive(964,53,20);primitive(965,53,21);primitive(966,53,22);
primitive(967,53,23);primitive(968,53,24);primitive(969,53,25);
primitive(971,53,28);primitive(970,53,29);primitive(1253,54,0);
primitive(975,54,1);primitive(976,54,2);
{:1174}{1187:}primitive(957,56,0);primitive(958,56,2);
primitive(959,56,4);primitive(960,56,6);
{:1187}{1196:}primitive(1271,55,0);primitive(1272,55,1);
primitive(1273,55,2);primitive(1274,55,3);primitive(1275,55,4);
primitive(1276,55,5);{:1196}{1206:}primitive(972,52,32);
primitive(973,52,33);hash[15517].rh:=973;eqtb[15517]:=eqtb[curval];
{:1206}{1226:}primitive(1296,104,1);primitive(1297,104,2);
primitive(1298,104,4);primitive(1299,108,0);primitive(1300,108,1);
primitive(1301,108,2);primitive(1302,108,3);
{:1226}{1237:}primitive(1319,105,0);primitive(1320,105,1);
{:1237}{1240:}primitive(1321,106,0);primitive(1322,106,1);
primitive(1323,106,2);primitive(1324,106,3);primitive(1325,106,4);
primitive(1326,106,5);primitive(1327,106,6);primitive(1328,106,7);
if mltexp then begin primitive(1329,106,8);end;
{:1240}{1248:}primitive(436,94,26361);primitive(437,94,26617);
primitive(438,94,26873);primitive(445,94,28419);
primitive(1334,94,28547);primitive(442,94,27651);
primitive(443,94,27907);primitive(444,94,28163);primitive(511,94,29261);
primitive(1335,94,29389);primitive(433,95,25589);
primitive(434,95,25845);primitive(435,95,26101);
{:1248}{1269:}primitive(1039,110,0);primitive(1051,110,1);
{:1269}{1273:}primitive(1354,84,0);primitive(1355,84,1);
{:1273}{1281:}primitive(273,111,0);primitive(274,111,1);
primitive(275,111,2);primitive(1364,111,3);
{:1281}{1291:}primitive(1365,63,1);primitive(1366,63,0);
{:1291}{1296:}primitive(1367,61,0);primitive(1368,61,1);
{:1296}{1305:}primitive(1374,60,27651);primitive(1375,60,27907);
{:1305}{1310:}primitive(1376,22,0);primitive(1377,22,1);
primitive(1378,22,2);primitive(1379,22,3);primitive(1380,22,7);
{:1310}{1363:}primitive(1424,62,0);primitive(647,62,1);writeloc:=curval;
primitive(1425,62,2);primitive(1426,62,3);hash[15524].rh:=1426;
eqtb[15524]:=eqtb[curval];primitive(1427,62,4);primitive(1428,62,5);
primitive(1429,62,7);{:1363}{1650:}primitive(1563,79,28994);
{:1650}{1686:}primitive(441,87,0);{:1686}{1691:}primitive(1567,112,1);
primitive(1568,112,0);primitive(1569,112,3);primitive(1570,112,2);
{:1691}{1698:}primitive(1579,75,0);primitive(1580,86,27129);
{:1698}{1703:}primitive(1583,85,1);primitive(1584,85,2);{:1703};
...
printnl(1423);fflush(stdout);read(stdin,m);
...
memtop-membot+1);zmem:=yzmem-membot;eqtbtop:=30053+hashextra;
if hashextra=0 then hashtop:=24527 else hashtop:=eqtbtop;
yhash:=xmallocarray(twohalves,1+hashtop-hashoffset);
hash:=yhash-hashoffset;hash[514].lh:=0;hash[514].rh:=0;
...
{:112}{300:}if 95588+hashextra>268435455 then bad:=21;
...
write(stdout,'This is e-pTeX, Version 3.14159265','-p3.7.1','-160201',
'-2.6')else write(stdout,'This is e-pTeX, Version 3.14159265','-p3.7.1',
'-160201','-2.6');write(stdout,' (');
...
formatident=1393)then begin nonewcontrolsequence:=false;
{1400:}primitive(1452,74,3);primitive(1453,74,4);primitive(1454,74,10);
primitive(815,120,10);primitive(542,115,1);primitive(816,120,11);
primitive(817,120,12);primitive(818,120,13);primitive(819,120,14);
primitive(820,120,15);primitive(821,120,16);primitive(1430,62,6);
primitive(535,80,29540);primitive(536,80,29541);primitive(1455,74,7);
primitive(1456,74,8);primitive(1457,74,9);primitive(869,117,27);
{:1400}{1408:}primitive(1459,78,25071);primitive(1460,79,28995);
primitive(1461,79,28996);primitive(1462,79,28997);
primitive(1463,79,28998);primitive(1464,79,28999);
primitive(1465,79,29000);primitive(1466,79,29001);
primitive(1467,79,29002);primitive(1468,79,29003);
{:1408}{1414:}primitive(1483,74,11);primitive(1484,74,12);
{:1414}{1417:}primitive(1485,74,13);primitive(1486,74,14);
primitive(1487,74,15);{:1417}{1420:}primitive(1488,74,18);
primitive(1489,74,19);primitive(1490,74,20);primitive(1491,74,21);
{:1420}{1423:}primitive(1492,74,22);primitive(1493,74,23);
primitive(1494,74,24);{:1423}{1426:}primitive(1495,22,4);
{:1426}{1435:}primitive(1497,22,5);{:1435}{1437:}primitive(1498,121,1);
primitive(1499,121,5);{:1437}{1440:}primitive(1500,22,6);
{:1440}{1443:}primitive(1504,91,2);{:1443}{1448:}primitive(974,52,1);
{:1448}{1452:}primitive(1508,79,29004);primitive(1509,36,6);
primitive(1510,36,7);primitive(1511,36,10);primitive(1512,36,11);
{:1452}{1502:}primitive(1521,116,2);{:1502}{1514:}primitive(1523,107,1);
{:1514}{1517:}primitive(868,114,1);primitive(1524,117,17);
primitive(1525,117,18);primitive(1526,117,19);
{:1517}{1525:}primitive(1310,104,8);{:1525}{1533:}primitive(1532,74,29);
primitive(1533,74,30);primitive(1534,74,31);primitive(1535,74,32);
{:1533}{1556:}primitive(1539,74,16);primitive(1540,74,17);
primitive(1541,74,25);primitive(1542,74,26);
{:1556}{1560:}primitive(1543,74,27);primitive(1544,74,28);
{:1560}{1564:}primitive(1545,21,5);primitive(1546,122,5);
primitive(1547,122,6);primitive(1548,122,7);primitive(1549,122,8);
primitive(1550,122,9);{:1564}{1616:}primitive(1554,27,2);
primitive(1555,27,3);{:1616}{1619:}primitive(1556,93,25328);
primitive(1557,93,25329);primitive(1558,93,25330);
primitive(1559,93,25331);
{:1619}if(buffer[curinput.locfield]=42)then incr(curinput.locfield);
eTeXmode:=1;{1568:}maxregnum:=65535;maxreghelpline:=1551;{:1568}end;
...
fontdir[0]:=0;fontnumext[0]:=0;fontname[0]:=896;fontarea[0]:=343;
...
if(history<>0)and(history<>1)then uexit(1)else uexit(0);end;end;
{:1351}{1753:}function getnullstr:strnumber;begin getnullstr:=343;end;
{:1753}
