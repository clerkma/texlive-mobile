...
#define ctype_char_end(A) (A) ].hh.LH
#define ctype_char(A) mp->font_info[mp->ctype_base[(A) ]+ctype_char_end
#define ctype_type_end(A) (A) ].hh.RH
#define ctype_type(A) mp->font_info[mp->ctype_base[(A) ]+ctype_type_end
...
#line 164 "./pmpostdir/pmp.ch"
/*:541*//*542:*/
#line 13000 "./pmp.w"

case mp_text_node_type:
{
#line 190 "./pmpostdir/pmp.ch"
