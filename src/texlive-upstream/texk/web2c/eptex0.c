...
zprintcs ( integer p ) 
{
  ...
  else if ( ( ( p >= 24527 ) && ( p <= 30053 ) ) || ( p > eqtbtop ) ) 
  printesc ( 547 ) ;
...
zshownodelist ( integer p ) 
{
  ...
  while ( p > memmin ) {
	...
	break ;
      case 1 : 
	{
	  printwritewhatsit ( 647 , p ) ;
	  printmark ( mem [p + 1 ].hh .v.RH ) ;
	} 
	break ;
      case 2 : 
	printwritewhatsit ( 1425 , p ) ;
	break ;
      case 3 : 
	{
	  printesc ( 1426 ) ;
	...
	if ( memtop - 2 != pagetail ) 
	{
	  ...
	  if ( pagecontents > 0 ) 
	  {
	    ...
	    while ( r != memtop ) {
	      ...
	      printint ( t ) ;
	      print ( 1084 ) ;
	      if ( eqtb [29005 + t ].cint == 1000 ) 
	      t = mem [r + 3 ].cint ;
	      else t = xovern ( mem [r + 3 ].cint , 1000 ) * eqtb [29005 + 
	      t ].cint ;
	      printscaled ( t ) ;
	      if ( mem [r ].hh.b0 == 1 ) 
	      {
...
zprintcmdchr ( quarterword cmd , halfword chrcode ) 
{
  ...
  case 79 : 
    ...
    printparam ( chrcode - 28931 ) ;
      ...
      printesc ( 510 ) ;
      printint ( chrcode - 29005 ) ;
    } 
    break ;
  case 80 : 
    if ( chrcode < 29542 ) 
    printlengthparam ( chrcode - 29517 ) ;
    else {
	
      printesc ( 538 ) ;
      printint ( chrcode - 29542 ) ;
    } 
    break ;
  case 48 : 
    printesc ( 549 ) ;
...
zshoweqtb ( halfword n ) 
{
  ...
  if ( n < 1 ) 
  printchar ( 63 ) ;
  else if ( ( n < 24528 ) || ( ( n > 30053 ) && ( n <= eqtbtop ) ) ) 
  {
    sprintcs ( n ) ;
    printchar ( 61 ) ;
...
zeffectivechar ( boolean errp , internalfontnumber f , quarterword c ) 
{
  ...
  if ( c >= eqtb [28991 ].cint ) {
      
    if ( c <= eqtb [28992 ].cint ) {
...
zscansomethinginternal ( smallnumber level , boolean negative ) 
{
  ...
  case 94 : 
	...
	) * 65536L + ( curval1 % 256 ) ;
	{
      ...
      {
	curval1 = eqtb [29261 + curval ].cint ;
  ...
  case 100 : 
	...
	{case 0 : 
	  curval = eqtb [29005 + curval ].cint ;
	  break ;
	case 1 : 
	  curval = eqtb [29542 + curval ].cint ;
	  break ;
	case 2 : 
...
zscandimen ( boolean mu , boolean inf , boolean shortcut ) 
{
  ...
  else if ( scankeyword ( 776 ) ) 
  v = ( fontinfo [5 + parambase [eqtb [25588 ].hh .v.RH ]].cint ) ;
  else if ( scankeyword ( 777 ) ) {
...
openlogfile ( void ) 
{
  ...
  logopened = true ;
  {
    ...
    fprintf ( logfile , "%s%s%s%s",  "This is e-pTeX, Version 3.14159265" , "-p3.7.1" ,     "-160201" , "-2.6" ) ;
    else
    fprintf ( logfile , "%s%s%s%s",  "This is e-pTeX, Version 3.14159265" , "-p3.7.1" ,     "-160201" , "-2.6" ) ;
    Fputs ( logfile ,  " (" ) ;
...
zspecialout ( halfword p ) 
{
  ...
  goto lab30 ;
  geqworddefine ( 29540 , cw ) ;
  geqworddefine ( 29541 , t ) ;
  curpageheight = t ;
  curpagewidth = cw ;
...
zoutwhat ( halfword p ) 
{
  ...
  case 2 : 
	...
	else if ( j < 16 ) 
	{
	  ...
	  aopenout ( writefile [j ]) ) promptfilename ( 1449 , 884 ) ;
	  writeopen [j ]= true ;
	  if ( logopened ) 
	  {
	    oldsetting = selector ;
...
zshipout ( halfword p ) 
{
  ...
  synctexsheet ( eqtb [28948 ].cint ) ;
  {
    ...
    printchar ( 91 ) ;
    j = 9 ;
    while ( ( eqtb [29005 + j ].cint == 0 ) && ( j > 0 ) ) decr ( j ) ;
    {register integer for_end; k = 0 ;for_end = j ; if ( k <= for_end) do 
      {
	printint ( eqtb [29005 + k ].cint ) ;
	if ( k < j ) 
	printchar ( 46 ) ;
      } 
    while ( k++ < for_end ) ;} 
    ...
    29536 ].cint > 1073741823L ) || ( mem [p + 1 ].cint + eqtb [29535 ]
    .cint > 1073741823L ) ) 
    {
      {
	if ( interaction == 3 ) 
    ...
    if ( mem [p + 3 ].cint + mem [p + 2 ].cint + eqtb [29536 ].cint > 
    maxv ) 
    maxv = mem [p + 3 ].cint + mem [p + 2 ].cint + eqtb [29536 ].cint ;
    if ( mem [p + 1 ].cint + eqtb [29535 ].cint > maxh ) 
    maxh = mem [p + 1 ].cint + eqtb [29535 ].cint ;
    if ( eqtb [29541 ].cint != 0 ) 
    curpageheight = eqtb [29541 ].cint ;
    else if ( ( mem [p ].hh.b0 == 2 ) ) 
    {
      if ( ( ( ( mem [mem [p + 5 ].hh .v.RH ].hh.b1 ) % 8 ) == 3 ) || ( ( 
      ( mem [mem [p + 5 ].hh .v.RH ].hh.b1 ) % 8 ) == 1 ) ) 
      curpageheight = mem [p + 1 ].cint + 2 * eqtb [29536 ].cint + 2 * 
      4736286L ;
      else curpageheight = mem [p + 3 ].cint + mem [p + 2 ].cint + 2 * 
      eqtb [29536 ].cint + 2 * 4736286L ;
    } 
    else curpageheight = mem [p + 3 ].cint + mem [p + 2 ].cint + 2 * eqtb 
    [29536 ].cint + 2 * 4736286L ;
    if ( eqtb [29540 ].cint != 0 ) 
    curpagewidth = eqtb [29540 ].cint ;
    else if ( ( mem [p ].hh.b0 == 2 ) ) 
    {
      if ( ( ( ( mem [mem [p + 5 ].hh .v.RH ].hh.b1 ) % 8 ) == 3 ) || ( ( 
      ( mem [mem [p + 5 ].hh .v.RH ].hh.b1 ) % 8 ) == 1 ) ) 
      curpagewidth = mem [p + 3 ].cint + mem [p + 2 ].cint + 2 * eqtb [
      29535 ].cint + 2 * 4736286L ;
      else curpagewidth = mem [p + 1 ].cint + 2 * eqtb [29535 ].cint + 2 * 
      4736286L ;
    } 
    else curpagewidth = mem [p + 1 ].cint + 2 * eqtb [29535 ].cint + 2 * 
    4736286L ;
    ...
    if ( outputfilename == 0 ) 
    {
      ...
      openlogfile () ;
      packjobname ( 888 ) ;
      while ( ! bopenout ( dvifile ) ) promptfilename ( 889 , 888 ) ;
    ...
    {register integer for_end; k = 0 ;for_end = 9 ; if ( k <= for_end) do 
      dvifour ( eqtb [29005 + k ].cint ) ;
    while ( k++ < for_end ) ;} 
    dvifour ( lastbop ) ;
    lastbop = pageloc ;
    curv = mem [p + 3 ].cint + eqtb [29536 ].cint ;
    tempptr = p ;
    switch ( mem [p ].hh.b0 ) 
    {case 0 : 
      hlistout () ;
...
zhpack ( halfword p , scaled w , smallnumber m ) 
{
  ...
  else if ( x > 0 ) 
  {
    ...
    ].hh .v.RH != -268435455L ) ) 
    {
      ...
      mem [r + 6 ].gr = 1.0 ;
      if ( ( - (integer) x - totalshrink [0 ]> eqtb [29525 ].cint ) || ( 
      eqtb [28957 ].cint < 100 ) ) 
      {
	if ( ( eqtb [29533 ].cint > 0 ) && ( - (integer) x - totalshrink [0 
	]> eqtb [29525 ].cint ) ) 
	{
	  while ( mem [q ].hh .v.RH != -268435455L ) q = mem [q ].hh .v.RH 
	  ;
	  mem [q ].hh .v.RH = newrule () ;
	  mem [mem [q ].hh .v.RH + 1 ].cint = eqtb [29533 ].cint ;
	} 
	println () ;
	printnl ( 948 ) ;
...
zvpackage ( halfword p , scaled h , smallnumber m , scaled l ) 
{
  ...
  else if ( x > 0 ) 
  {
    ...
    ].hh .v.RH != -268435455L ) ) 
    {
      lastbadness = 1000000L ;
      mem [r + 6 ].gr = 1.0 ;
      if ( ( - (integer) x - totalshrink [0 ]> eqtb [29526 ].cint ) || ( 
      eqtb [28958 ].cint < 100 ) ) 
      {
	println () ;
	printnl ( 953 ) ;
...
zshiftsubexpbox ( halfword q ) 
{
  ...
  if ( curlist .dirfield == 3 ) 
  d = eqtb [29538 ].cint ;
  else d = eqtb [29539 ].cint ;
  if ( curstyle < 4 ) 
  d = xnoverd ( d , eqtb [28988 ].cint , 1000 ) ;
  else if ( curstyle < 6 ) 
  d = xnoverd ( d , eqtb [28989 ].cint , 1000 ) ;
  else d = xnoverd ( d , eqtb [28990 ].cint , 1000 ) ;
...
zmakescripts ( halfword q , scaled delta ) 
{
  ...
  if ( mem [q + 2 ].hh .v.RH == 0 ) 
  {
    ...
    mem [x + 1 ].cint = mem [x + 1 ].cint + eqtb [29529 ].cint ;
    ...
    mem [x + 4 ].cint = - (integer) shiftup ;
      ...
      .v.LH ) ;
      mem [y + 1 ].cint = mem [y + 1 ].cint + eqtb [29529 ].cint ;
...
zmakeleftright ( halfword q , smallnumber style , scaled maxd , scaled maxh ) 
{
  ...
  delta2 = delta1 + delta1 - eqtb [29527 ].cint ;
  if ( delta < delta2 ) 
  delta = delta2 ;
	...
	( curactivewidth [5 ]!= 0 ) || ( curactivewidth [6 ]!= 0 ) ) 
	{
	  if ( dolastlinefit ) 
	  {
	    if ( curp == -268435455L ) 
	    {
	      ...
	      1073741823L ) ;
	      if ( eqtb [29001 ].cint < 1000 ) 
	      g = fract ( g , eqtb [29001 ].cint , 1000 , 1073741823L ) ;
	      if ( aritherror ) {
...
zvsplit ( halfword n , scaled h ) 
{
  ...
  q = vertbreak ( mem [v + 5 ].hh .v.RH , h , eqtb [29523 ].cint ) ;
  p = mem [v + 5 ].hh .v.RH ;
  if ( p == q ) 
  ...
  lab30: ;
  q = prunepagetop ( q , eqtb [29002 ].cint > 0 ) ;
  p = mem [v + 5 ].hh .v.RH ;
  if ( q != -268435455L ) 
  {
  ...
  q = vpackage ( p , h , 0 , eqtb [29523 ].cint ) ;
  mem [q ].hh.b1 = ( ( mem [q ].hh.b1 ) / 8 ) * 8 + ( ( mem [v ].hh.b1 ) 
  % 8 ) ;
...
zfreezepagespecs ( smallnumber s ) 
{
  ...
  pagecontents = s ;
  pagesofar [0 ]= eqtb [29521 ].cint ;
  pagemaxdepth = eqtb [29522 ].cint ;
  pagesofar [8 ]= 0 ;
  pagesofar [1 ]= 0 ;
  pagesofar [2 ]= 0 ;
  pagesofar [3 ]= 0 ;
...
zfireup ( halfword c ) 
{
  ...
  savevfuzz = eqtb [29526 ].cint ;
  eqtb [29526 ].cint = 1073741823L ;
...
buildpage ( void ) 
{
  ...
  do {
	...
	if ( mem [r ].hh.b1 != n ) 
	{
	  ...
	  if ( eqtb [29005 + n ].cint == 1000 ) 
	  h = mem [r + 3 ].cint ;
	  else h = xovern ( mem [r + 3 ].cint , 1000 ) * eqtb [29005 + n ]
	  .cint ;
	...
	insertpenalties = insertpenalties + mem [p + 1 ].cint ;
	  ...
	  if ( eqtb [29005 + n ].cint == 1000 ) 
	  h = mem [p + 3 ].cint ;
	  else h = xovern ( mem [p + 3 ].cint , 1000 ) * eqtb [29005 + n ]
	  .cint ;
	  if ( ( ( h <= 0 ) || ( h <= delta ) ) && ( mem [p + 3 ].cint + mem 
	  [r + 3 ].cint <= eqtb [29542 + n ].cint ) ) 
	  {
	    ...
	    if ( eqtb [29005 + n ].cint <= 0 ) 
	    w = 1073741823L ;
	    else {
		
	      w = pagesofar [0 ]- pagesofar [1 ]- pagesofar [8 ];
	      if ( eqtb [29005 + n ].cint != 1000 ) 
	      w = xovern ( w , eqtb [29005 + n ].cint ) * 1000 ;
	    } 
	    if ( w > eqtb [29542 + n ].cint - mem [r + 3 ].cint ) 
	    w = eqtb [29542 + n ].cint - mem [r + 3 ].cint ;
...
itsallover ( void ) 
{
  ...
  if ( privileged () ) 
  {
    ...
    mem [curlist .tailfield + 1 ].cint = eqtb [29520 ].cint ;
    {
...
makeaccent ( void ) 
{
  ...
  if ( p != -268435455L ) 
  {
    ...
    if ( curlist .dirfield == 3 ) 
    {
      ...
      disp = eqtb [29538 ].cint - eqtb [29539 ].cint ;
      else disp = eqtb [29538 ].cint ;
    } 
    else {
      ...
      disp = eqtb [29539 ].cint - eqtb [29538 ].cint ;
      else disp = eqtb [29539 ].cint ;
    } 
    {
      if ( ! ( curlist .tailfield >= himemmin ) && ( mem [curlist .tailfield 
      ].hh.b0 == 5 ) ) 
...
initmath ( void ) 
{
  ...
  if ( ( curcmd == 3 ) && ( curlist .modefield > 0 ) ) 
  {
    ...
    if ( eqtb [25061 ].hh .v.RH == -268435455L ) {
      ...
      if ( ( eqtb [29534 ].cint != 0 ) && ( ( ( eqtb [28972 ].cint >= 0 ) 
      && ( curlist .pgfield + 2 > eqtb [28972 ].cint ) ) || ( curlist 
      .pgfield + 1 < - (integer) eqtb [28972 ].cint ) ) ) 
      {
	l = eqtb [29520 ].cint - abs ( eqtb [29534 ].cint ) ;
	if ( eqtb [29534 ].cint > 0 ) 
	s = eqtb [29534 ].cint ;
	else s = 0 ;
      } 
    ...
    eqworddefine ( 29530 , w ) ;
    curlist .eTeXauxfield = j ;
    if ( ( eTeXmode == 1 ) ) 
    eqworddefine ( 29000 , x ) ;
    eqworddefine ( 29531 , l ) ;
...
zscandelimiter ( halfword p , boolean r ) 
{
  ...
  scanfiftyonebitint () ;
    ...
    case 12 : 
      {
	curval = eqtb [29261 + curchr ].cint ;
	curval1 = getintone ( eqtb [29261 + curchr ]) ;
      } 
      break ;
    case 15 : 
      if ( curchr == 0 ) 
...
aftermath ( void ) 
{
  ...
  if ( m < 0 ) 
  {
    ...
    {
      mem [curlist .tailfield ].hh .v.RH = newmath ( eqtb [29518 ].cint , 
      0 ) ;
      curlist .tailfield = mem [curlist .tailfield ].hh .v.RH ;
    } 
    curmlist = p ;
...
maincontrol ( void ) 
{
  ...
  */ maincontrol_regmem 
  ...
  case 150 : 
    if ( curchr > 0 ) 
    {
      if ( eTeXenabled ( ( eqtb [29004 ].cint > 0 ) , curcmd , curchr ) ) 
      {
  ...
  lab130: if ( ( curlist .tailfield >= himemmin ) ) 
  {
	...
	{
	  {
	    mem [curlist .tailfield ].hh .v.RH = newpenalty ( eqtb [29798 + 
	    kp ].cint ) ;
	    curlist .tailfield = mem [curlist .tailfield ].hh .v.RH ;
	  } 
	  mem [curlist .tailfield ].hh.b1 = 2 ;
  ...
  if ( mainf != 0 ) 
  {
	...
	if ( eqtb [27385 + kp ].hh.b0 == 1 ) 
	{
	  ...
	  mem [curq + 1 ].cint = mem [curq + 1 ].cint + eqtb [29798 + kp 
	  ].cint ;
	  else {
	      
	    mainp = mem [curq ].hh .v.RH ;
	    mem [curq ].hh .v.RH = newpenalty ( eqtb [29798 + kp ].cint ) 
	    ;
  ...
  if ( ( curcmd == 16 ) || ( curcmd == 17 ) || ( curcmd == 18 ) ) 
  {
	...
	if ( kp != 1000 ) 
	{
	  ...
	  {
	    if ( ! ( curq >= himemmin ) && ( mem [curq ].hh.b0 == 14 ) ) 
	    mem [curq + 1 ].cint = mem [curq + 1 ].cint + eqtb [29798 + 
	    kp ].cint ;
	    else {
  ...
  if ( curcmd == 71 ) 
  {
	...
	cx = curl ;
	{
	  ...
	  if ( kp != 1000 ) 
	  {
		...
		mainp = mem [curq ].hh .v.RH ;
		mem [curq ].hh .v.RH = newpenalty ( eqtb [29798 + kp ]
		.cint ) ;
		mem [mem [curq ].hh .v.RH ].hh.b1 = 2 ;
		mem [mem [curq ].hh .v.RH ].hh .v.RH = mainp ;
	      } 
