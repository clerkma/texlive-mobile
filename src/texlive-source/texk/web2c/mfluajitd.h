...
typedef screencol * transspec  ;
typedef unsigned char pixelcolor  ;
typedef unsigned char windownumber  ;
typedef struct {
...
EXTERN unsigned char strref[maxstrings + 1]  ;
#ifdef INIMF
...
EXTERN unsigned char charclass[256]  ;
...
EXTERN unsigned char curpathtype  ;
...
EXTERN unsigned char octantnumber[9]  ;
EXTERN unsigned char octantcode[9]  ;
EXTERN boolean revturns  ;
EXTERN unsigned char ycorr[9], xycorr[9], zcorr[9]  ;
EXTERN schar xcorr[9]  ;
EXTERN integer m0, n0, m1, n1  ;
EXTERN unsigned char d0, d1  ;
EXTERN integer envmove[movesize + 1]  ;
EXTERN unsigned char tolstep  ;
...
EXTERN unsigned char inopen  ;
EXTERN unsigned char openparens  ;
...
EXTERN unsigned char chartag[256]  ;
