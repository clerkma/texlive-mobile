...
zprint ( integer s ) 
{
  ...
  s = 65541L ;
	...
	if ( selector < 20 ) 
	{
      ...
      nl = eqtb [8938789L ].cint ;
      eqtb [8938789L ].cint = -1 ;
      printchar ( s ) ;
      eqtb [8938789L ].cint = nl ;
      return ;
    } 
  } 
  j = strstart [( s ) - 65536L ];
...
zprintcs ( integer p ) 
{
  ...
  if ( p < 2228226L ) {
	...
	printesc ( p - 1114113L ) ;
	if ( eqtb [2254068L + p - 1114113L ].hh .v.RH == 11 ) 
	printchar ( 32 ) ;
      } 
    } 
    else if ( p < 1 ) 
  ...
  else if ( ( ( p >= 2252239L ) && ( p <= 10053467L ) ) || ( p > eqtbtop ) ) 
  printesc ( 65810L ) ;
...
getavail ( void ) 
{
  ...
  else if ( memend < memmax ) 
  {
    ...
    {
      runaway () ;
      overflow ( 65580L , memmax + 1 - memmin ) ;
    } 
  } 
...
znewskipparam ( smallnumber n ) 
{
  ...
  halfword p  ;
  tempptr = newspec ( eqtb [2252240L + n ].hh .v.RH ) ;
  p = newglue ( tempptr ) ;
...
zsearchmem ( halfword p ) 
{
  ...
  while ( q++ < for_end ) ;} 
  {register integer for_end; q = 1 ;for_end = 2253298L ; if ( q <= for_end) 
  do 
    {
      if ( eqtb [q ].hh .v.RH == p ) 
      {
...
zshortdisplay ( integer p ) 
{
  ...
  while ( p > memmin ) {
	...
	if ( mem [p ].hh.b0 != fontinshortdisplay ) 
	{
	  ...
	  printchar ( 42 ) ;
	  else printesc ( hash [2243238L + mem [p ].hh.b0 ].v.RH ) ;
	  printchar ( 32 ) ;
      ...
      {case 40 : 
	{
	  ...
	  {
	    printesc ( hash [2243238L + mem [p + 4 ].qqqq .b1 ].v.RH ) ;
	    printchar ( 32 ) ;
...
zshownodelist ( integer p ) 
{
  ...
  while ( p > memmin ) {
	...
	break ;
      case 1 : 
	{
	  printwritewhatsit ( 65913L , p ) ;
	  printmark ( mem [p + 1 ].hh .v.RH ) ;
	} 
	break ;
      case 2 : 
	printwritewhatsit ( 66710L , p ) ;
	break ;
      case 3 : 
	{
	  printesc ( 66711L ) ;
	...
	if ( mem [p ].hh.b1 != 98 ) 
	{
	  ...
	  if ( mem [p ].hh.b1 < 98 ) 
	  printspec ( mem [p + 1 ].hh .v.LH , 0 ) ;
	  else printspec ( mem [p + 1 ].hh .v.LH , 65621L ) ;
	} 
      } 
      break ;
    case 11 : 
...
{
  showbox_regmem 
  depththreshold = eqtb [8938765L ].cint ;
  breadthmax = eqtb [8938764L ].cint ;
  if ( breadthmax <= 0 ) 
  breadthmax = 5 ;
	...
	if ( memtop - 2 != pagetail ) 
	{
	  ...
	  if ( pagecontents > 0 ) 
	  {
	    ...
	    while ( r != memtop ) {
	      ...
	      printint ( t ) ;
	      print ( 66380L ) ;
	      if ( eqtb [8938821L + t ].cint == 1000 ) 
	      t = mem [r + 3 ].cint ;
	      else t = xovern ( mem [r + 3 ].cint , 1000 ) * eqtb [8938821L 
	      + t ].cint ;
	      printscaled ( t ) ;
	      if ( mem [r ].hh.b0 == 1 ) 
	      {
...
begindiagnostic ( void ) 
{
  ...
  oldsetting = selector ;
  if ( ( eqtb [8938769L ].cint <= 0 ) && ( selector == 19 ) ) 
  {
    decr ( selector ) ;
    if ( history == 0 ) 
    history = 1 ;
...
zprintcmdchr ( quarterword cmd , halfword chrcode ) 
{
  ...
  case 77 : 
    if ( chrcode < 2252259L ) 
    printskipparam ( chrcode - 2252240L ) ;
    else if ( chrcode < 2252515L ) 
    {
      printesc ( 65690L ) ;
      printint ( chrcode - 2252259L ) ;
    } 
    else {
	
      printesc ( 65691L ) ;
      printint ( chrcode - 2252515L ) ;
    } 
    break ;
  case 73 : 
    if ( chrcode >= 2252783L ) 
  ...
  case 74 : 
    if ( chrcode < 8938821L ) 
    printparam ( chrcode - 8938740L ) ;
    else {
	
      printesc ( 65776L ) ;
      printint ( chrcode - 8938821L ) ;
    } 
    break ;
  case 75 : 
    if ( chrcode < 10053212L ) 
    printlengthparam ( chrcode - 10053189L ) ;
    else {
	
      printesc ( 65802L ) ;
      printint ( chrcode - 10053212L ) ;
    } 
    break ;
  case 45 : 
    printesc ( 65812L ) ;
  ...
  case 31 : 
    ...
    printesc ( 66459L ) ;
    else printesc ( 66456L ) ;
    break ;
  case 43 : 
    if ( chrcode == 0 ) 
    printesc ( 66476L ) ;
    else printesc ( 66475L ) ;
    break ;
  case 25 : 
    if ( chrcode == 10 ) 
    printesc ( 66488L ) ;
  ...
  case 99 : 
    ...
    printesc ( 66575L ) ;
    else printesc ( 66576L ) ;
    break ;
  case 96 : 
    if ( chrcode != 0 ) 
    printesc ( 66594L ) ;
    else printesc ( 66593L ) ;
    break ;
  case 97 : 
    switch ( chrcode ) 
    {case 0 : 
  ...
  case 86 : 
    if ( chrcode == 2254068L ) 
    printesc ( 65710L ) ;
    else if ( chrcode == 6710516L ) 
    printesc ( 65714L ) ;
    else if ( chrcode == 3368180L ) 
    printesc ( 65711L ) ;
    else if ( chrcode == 4482292L ) 
    printesc ( 65712L ) ;
    else if ( chrcode == 5596404L ) 
    printesc ( 65713L ) ;
    else printesc ( 65777L ) ;
    break ;
  case 87 : 
    if ( chrcode == 5596404L ) 
    printesc ( 66615L ) ;
    ...
    printesc ( 66612L ) ;
    else if ( chrcode == 6710517L ) 
    printesc ( 66614L ) ;
    else if ( chrcode == 8939077L ) 
    printesc ( 66617L ) ;
    else printesc ( 66619L ) ;
    break ;
  case 88 : 
    printsize ( chrcode - 2253300L ) ;
    break ;
  case 101 : 
    if ( chrcode == 1 ) 
    printesc ( 66349L ) ;
    else printesc ( 66337L ) ;
    break ;
  case 79 : 
    switch ( chrcode ) 
    {case 0 : 
  ...
  case 60 : 
    if ( chrcode == 0 ) 
    printesc ( 66648L ) ;
    else printesc ( 66647L ) ;
    break ;
  case 58 : 
    if ( chrcode == 0 ) 
    printesc ( 66649L ) ;
    else printesc ( 66650L ) ;
    break ;
  case 57 : 
    if ( chrcode == 3368180L ) 
    printesc ( 66656L ) ;
    else printesc ( 66657L ) ;
    break ;
  case 19 : 
    switch ( chrcode ) 
    {case 1 : 
...
zshoweqtb ( halfword n ) 
{
  ...
  if ( n < 1 ) 
  printchar ( 63 ) ;
  else if ( ( n < 2252240L ) || ( ( n > 10053467L ) && ( n <= eqtbtop ) ) ) 
  {
    sprintcs ( n ) ;
    printchar ( 61 ) ;
    ...
    if ( n < 2252259L ) 
    {
      printskipparam ( n - 2252240L ) ;
      printchar ( 61 ) ;
      if ( n < 2252256L ) 
      printspec ( eqtb [n ].hh .v.RH , 65692L ) ;
      else printspec ( eqtb [n ].hh .v.RH , 65621L ) ;
    } 
    else if ( n < 2252515L ) 
    {
      printesc ( 65690L ) ;
      ...
      printint ( n - 2252515L ) ;
      printchar ( 61 ) ;
      printspec ( eqtb [n ].hh .v.RH , 65621L ) ;
    } 
  } 
  else if ( n < 8938740L ) {
      
    if ( ( n == 2252771L ) || ( ( n >= 2253039L ) && ( n < 2253043L ) ) ) 
    {
      printcmdchr ( 85 , n ) ;
      printchar ( 61 ) ;
	...
	printesc ( 65703L ) ;
      ...
      else printint ( mem [eqtb [2252771L ].hh .v.RH ].hh .v.LH ) ;
    } 
    else if ( n < 2252783L ) 
    {
      printcmdchr ( 73 , n ) ;
	...
	printint ( n - 2253812L ) ;
      ...
      printchar ( 61 ) ;
      printesc ( hash [2243238L + eqtb [n ].hh .v.RH ].v.RH ) ;
    } 
    else if ( n < 6710516L ) 
    {
      if ( n < 3368180L ) 
  ...
  {
    if ( n < 10053212L ) 
    printlengthparam ( n - 10053189L ) ;
    else {
	
      printesc ( 65802L ) ;
      printint ( n - 10053212L ) ;
    } 
    printchar ( 61 ) ;
...
zidlookup ( integer j , integer l ) 
{
  ...
  while ( true ) {
	...
	if ( hash [p ].v.RH > 0 ) 
	{
	  ...
	  {
	    incr ( hashhigh ) ;
	    hash [p ].v.LH = hashhigh + 10053467L ;
	    p = hashhigh + 10053467L ;
	  } 
	  else {
	      
	    do {
		if ( ( hashused == 2228226L ) ) 
	      overflow ( 65806L , 15000 + hashextra ) ;
	      decr ( hashused ) ;
...
znewsavelevel ( groupcode c ) 
{
  ...
  if ( curlevel == 65535L ) 
  overflow ( 65857L , 65535L ) ;
  curboundary = saveptr ;
  curgroup = c ;
	;
#ifdef STAT
  if ( eqtb [8938799L ].cint > 0 ) 
  grouptrace ( false ) ;
#endif /* STAT */
  incr ( curlevel ) ;
  incr ( saveptr ) ;
...
unsave ( void ) 
{
  ...
  if ( curlevel > 1 ) 
  {
	...
	else savestack [saveptr ]= eqtb [2252239L ];
	if ( ( p < 8938740L ) || ( p > 10053467L ) ) {
  ...
  else confusion ( 65862L ) ;
} 
void 
preparemag ( void ) 
{
  preparemag_regmem 
  if ( ( magset > 0 ) && ( eqtb [8938757L ].cint != magset ) ) 
  {
    {
      if ( interaction == 3 ) 
      ;
    ...
    interror ( magset ) ;
    geqworddefine ( 8938757L , magset ) ;
  } 
  if ( ( eqtb [8938757L ].cint <= 0 ) || ( eqtb [8938757L ].cint > 32768L 
  ) ) 
  {
    {
      if ( interaction == 3 ) 
    ...
    interror ( eqtb [8938757L ].cint ) ;
    geqworddefine ( 8938757L , 1000 ) ;
  } 
  magset = eqtb [8938757L ].cint ;
} 
void 
...
showcontext ( void ) 
{
  ...
  while ( true ) {
    ...
    if ( ( baseptr == inputptr ) || bottomline || ( nn < eqtb [8938794L ]
    .cint ) ) 
    {
	...
	if ( curinput .statefield != 0 ) 
	{
	  ...
	  if ( buffer [curinput .limitfield ]== eqtb [8938788L ].cint ) 
	...
	<= for_end) do 
	  printrawchar ( trickbuf [q % errorline ], true ) ;
	while ( q++ < for_end ) ;} 
	println () ;
...
getnext ( void ) 
{
  ...
  if ( curinput .statefield != 0 ) 
  {
	...
	curchr = 65536L + ( curchr - 55296L ) * 1024 + lower ;
      ...
      lab21: curcmd = eqtb [2254068L + curchr ].hh .v.RH ;
      ...
      case 33 : 
	{
	  ...
	  curcs = 2228225L ;
	    ...
	    curchr = buffer [k ];
	    cat = eqtb [2254068L + curchr ].hh .v.RH ;
	    incr ( k ) ;
	    if ( cat == 11 ) 
	...
	if ( ( eqtb [8938788L ].cint < 0 ) || ( eqtb [8938788L ].cint > 
	255 ) ) 
	decr ( curinput .limitfield ) ;
	else buffer [curinput .limitfield ]= eqtb [8938788L ].cint ;
...
zeffectivechar ( boolean errp , internalfontnumber f , quarterword c ) 
{
  ...
  if ( c >= eqtb [8938795L ].cint ) {
      
    if ( c <= eqtb [8938796L ].cint ) {
	
      if ( ( eqtb [7824628L + c ].hh .v.RH > 0 ) ) 
      {
	basec = ( eqtb [7824628L + c ].hh .v.RH % 256 ) ;
	result = basec ;
	if ( ! errp ) 
	goto lab40 ;
	if ( fontec [f ]>= basec ) {
...
zscansomethinginternal ( smallnumber level , boolean negative ) 
{
  ...
  {case 86 : 
    {
      ...
      if ( m == 6710516L ) 
      {
	curval1 = eqtb [6710516L + curval ].hh .v.RH ;
	...
	curval1 ) * 256 ) + mathcharfield ( curval1 ) ;
	{
      ...
      {
	curval1 = eqtb [8939077L + curval ].cint ;
  ...
  case 87 : 
    {
      ...
      {
	{
	  curval = eqtb [5596404L + curval ].hh .v.RH / 65536L ;
	  curvallevel = 0 ;
	} 
      } 
      else if ( m == 6710516L ) 
      {
	{
	  curval = eqtb [6710516L + curval ].hh .v.RH ;
	  curvallevel = 0 ;
	} 
      } 
      else if ( m == 6710517L ) 
	...
	error () ;
	{
      ...
      {
	{
	  curval = eqtb [8939077L + curval ].cint ;
	  curvallevel = 0 ;
	} 
      } 
      else {
  ...
  case 90 : 
	...
	if ( m == membot ) 
	{
	  scanregisternum () ;
	  if ( curval < 256 ) 
	  curval = eqtb [2252783L + curval ].hh .v.RH ;
	  else {
  ...
  case 85 : 
	...
	curval = 0 ;
      ...
      else if ( eqtb [2252771L ].hh .v.RH == -268435455L ) 
      curval = 0 ;
      else curval = mem [eqtb [2252771L ].hh .v.RH ].hh .v.LH ;
      curvallevel = 0 ;
    } 
    break ;
  case 84 : 
    {
      scanregisternum () ;
      if ( curval < 256 ) 
      q = eqtb [2253043L + curval ].hh .v.RH ;
      else {
  ...
  case 91 : 
	...
	{case 0 : 
	  curval = eqtb [8938821L + curval ].cint ;
	  break ;
	case 1 : 
	  curval = eqtb [10053212L + curval ].cint ;
	  break ;
	case 2 : 
	  curval = eqtb [2252259L + curval ].hh .v.RH ;
	  break ;
	case 3 : 
	  curval = eqtb [2252515L + curval ].hh .v.RH ;
	  break ;
	} 
      } 
    } 
  ...
  case 71 : 
	...
	{case 47 : 
	  {
	    if ( ( ( fontarea [eqtb [2253299L ].hh .v.RH ]== 65535L ) || ( 
	    fontarea [eqtb [2253299L ].hh .v.RH ]== 65534L ) ) ) 
	    {
	      scanint () ;
	      n = curval ;
	      if ( ( n < 1 ) || ( n > 4 ) ) 
		...
		scanint () ;
		curval = getglyphbounds ( eqtb [2253299L ].hh .v.RH , n , 
		curval ) ;
	      } 
	    } 
	    else {
		
	      notnativefonterror ( 71 , m , eqtb [2253299L ].hh .v.RH ) ;
	      curval = 0 ;
	    } 
	  } 
	  break ;
	...
	case 54 : 
	  {
	    q = curchr - 52 ;
	    scanint () ;
	    if ( ( eqtb [2252771L ].hh .v.RH == -268435455L ) || ( curval <= 
	    0 ) ) 
	    curval = 0 ;
	    else {
		...
		curval = ( curval + q ) / 2 ;
	      ...
	      if ( curval > mem [eqtb [2252771L ].hh .v.RH ].hh .v.LH ) 
	      curval = mem [eqtb [2252771L ].hh .v.RH ].hh .v.LH ;
	      curval = mem [eqtb [2252771L ].hh .v.RH + 2 * curval - q ]
	      .cint ;
	    } 
	    curvallevel = 1 ;
	  } 
	...
	case 15 : 
	  {
	    ...
	    curval = aatfontget ( m - 14 , fontlayoutengine [n ]) ;
	    else if ( ( fontarea [n ]== 65534L ) ) 
	    curval = otfontget ( m - 14 , fontlayoutengine [n ]) ;
	    else curval = 0 ;
	  } 
	  break ;
	case 22 : 
	...
	case 29 : 
	  {
	    ...
	    if ( ( fontarea [n ]== 65535L ) ) 
	    {
	      ...
	      k = curval ;
	      scanint () ;
	      curval = aatfontget2 ( m - 14 , fontlayoutengine [n ], k , 
	      curval ) ;
	    } 
	    else if ( ( ( fontarea [n ]== 65534L ) && ( usingGraphite ( 
	    fontlayoutengine [n ]) ) ) ) 
	    {
	      ...
	      k = curval ;
	      scanint () ;
	      curval = otfontget2 ( m - 14 , fontlayoutengine [n ], k , 
	      curval ) ;
	    } 
	    else {
	...
	case 33 : 
	  {
	    ...
	    {
	      scanint () ;
	      curval = otfontget1 ( m - 14 , fontlayoutengine [n ], curval ) 
	      ;
	    } 
	    else {
	...
	case 35 : 
	  {
	    ...
	    fontlayoutengine [n ]) ) ) ) 
	    {
	      ...
	      kk = curval ;
	      scanint () ;
	      curval = otfontget3 ( m - 14 , fontlayoutengine [n ], k , kk , 
	      curval ) ;
	    } 
	    else {
	...
	case 36 : 
	  {
	    ...
	    fontarea [eqtb [2253299L ].hh .v.RH ]== 65534L ) ) ) 
	    {
	      scanint () ;
	      n = curval ;
	      curval = mapchartoglyph ( eqtb [2253299L ].hh .v.RH , n ) ;
	    } 
	    else {
	...
	case 37 : 
	  {
	    ...
	    {
	      scanandpackname () ;
	      curval = mapglyphtoindex ( eqtb [2253299L ].hh .v.RH ) ;
	    } 
	    else {
	...
	case 40 : 
	  {
	    ...
	    curval = getfontcharrange ( n , m == 39 ) ;
	    else {
...
requiresunits ) 
{
  ...
  if ( requiresunits ) 
  {
    ...
    if ( mu ) 
    goto lab45 ;
    if ( scankeyword ( 66053L ) ) 
    v = ( fontinfo [6 + parambase [eqtb [2253299L ].hh .v.RH ]].cint ) ;
    else if ( scankeyword ( 66054L ) ) 
    v = ( fontinfo [5 + parambase [eqtb [2253299L ].hh .v.RH ]].cint ) ;
    else goto lab45 ;
    {
      getxtoken () ;
      if ( curcmd != 10 ) 
    ...
    if ( scankeyword ( 66049L ) ) 
    {
      preparemag () ;
      if ( eqtb [8938757L ].cint != 1000 ) 
      {
	curval = xnoverd ( curval , 1000 , eqtb [8938757L ].cint ) ;
	f = ( 1000 * f + 65536L * texremainder ) / eqtb [8938757L ].cint ;
	curval = curval + ( f / 65536L ) ;
	f = f % 65536L ;
      } 
    } 
    if ( scankeyword ( 65692L ) ) 
    goto lab88 ;
    ...
    else if ( scankeyword ( 66061L ) ) 
    {
      num = 12 ;
      denom = 1 ;
    } 
    else if ( scankeyword ( 66062L ) ) 
    {
      num = 7227 ;
      denom = 254 ;
    } 
    else if ( scankeyword ( 66063L ) ) 
    {
      num = 7227 ;
      denom = 2540 ;
    } 
    ...
    else if ( scankeyword ( 66066L ) ) 
    {
      num = 14856 ;
      denom = 1157 ;
    } 
    else if ( scankeyword ( 66067L ) ) 
    goto lab30 ;
    else {
...
scanrulespec ( void ) 
{
  ...
  lab21: if ( scankeyword ( 66077L ) ) 
  {
    scandimen ( false , false , false ) ;
    mem [q + 1 ].cint = curval ;
    goto lab21 ;
  } 
  if ( scankeyword ( 66078L ) ) 
  {
    scandimen ( false , false , false ) ;
    mem [q + 3 ].cint = curval ;
    goto lab21 ;
  } 
  if ( scankeyword ( 66079L ) ) 
  {
    scandimen ( false , false , false ) ;
    mem [q + 2 ].cint = curval ;
    goto lab21 ;
...
thetoks ( void ) 
{
  ...
  if ( curvallevel >= 4 ) 
  {
    ...
    case 2 : 
      {
	printspec ( curval , 65692L ) ;
	deleteglueref ( curval ) ;
      } 
      break ;
    case 3 : 
      {
	printspec ( curval , 65621L ) ;
	deleteglueref ( curval ) ;
      } 
      break ;
    } 
  ...
  case 14 : 
    {
      ...
      savedchr = curval ;
      scanint () ;
      if ( ( curval < 1 ) || ( curval > 12 ) || ( curval == 5 ) || ( curval == 
      9 ) ) 
      {
	{
	  if ( interaction == 3 ) 
  ...
  case 44 : 
    {
      ...
      boolvar = scankeyword ( 66824L ) ;
      scanpdfexttoks () ;
      if ( selector == 21 ) 
      pdferror ( 66724L , 66725L ) ;
      oldsetting = selector ;
      selector = 21 ;
  ...
  case 12 : 
    {
      scanregisternum () ;
      if ( curval < 256 ) 
      p = eqtb [2253043L + curval ].hh .v.RH ;
      else {
...
zreadtoks ( integer n , halfword r , halfword j ) 
{
  ...
  do {
    ...
    curinput .limitfield = last ;
    if ( ( eqtb [8938788L ].cint < 0 ) || ( eqtb [8938788L ].cint > 255 ) 
    ) 
    decr ( curinput .limitfield ) ;
    else buffer [curinput .limitfield ]= eqtb [8938788L ].cint ;
    first = curinput .limitfield + 1 ;
...
zpromptfilename ( strnumber s , strnumber e ) 
{
  ...
  if ( ( length ( curname ) == 0 ) && ( curext == 65622L ) && ( curarea == 
  65622L ) ) 
  {
...
openlogfile ( void ) 
{
  ...
  logopened = true ;
  {
    ...
    fprintf ( logfile , "%s%s%s",  "This is XeTeX, Version 3.14159265" , "-2.6" ,     "-0.99993" ) ;
    else
    fprintf ( logfile , "%s%s%s",  "This is XeTeX, Version 3.14159265" , "-2.6" ,     "-0.99993" ) ;
    Fputs ( logfile ,  versionstring ) ;
    print ( formatident ) ;
    print ( 66156L ) ;
    printint ( eqtb [8938761L ].cint ) ;
    printchar ( 32 ) ;
    months = " JANFEBMARAPRMAYJUNJULAUGSEPOCTNOVDEC" ;
    {register integer for_end; k = 3 * eqtb [8938762L ].cint - 2 ;for_end 
    = 3 * eqtb [8938762L ].cint ; if ( k <= for_end) do 
      putc ( months [k ],  logfile );
    while ( k++ < for_end ) ;} 
    printchar ( 32 ) ;
    printint ( eqtb [8938763L ].cint ) ;
    printchar ( 32 ) ;
    printtwo ( eqtb [8938760L ].cint / 60 ) ;
    printchar ( 58 ) ;
    printtwo ( eqtb [8938760L ].cint % 60 ) ;
    if ( ( eTeXmode == 1 ) ) 
    {
  ...
  if ( buffer [l ]== eqtb [8938788L ].cint ) 
  decr ( l ) ;
...
zcharwarning ( internalfontnumber f , integer c ) 
{
  charwarning_regmem 
  integer oldsetting  ;
  if ( eqtb [8938775L ].cint > 0 ) 
  {
    oldsetting = eqtb [8938769L ].cint ;
    if ( ( eTeXmode == 1 ) && ( eqtb [8938775L ].cint > 1 ) ) 
    eqtb [8938769L ].cint = 1 ;
    {
      begindiagnostic () ;
      printnl ( 66184L ) ;
      if ( c < 65536L ) 
...
znewnativecharacter ( internalfontnumber f , UnicodeScalar c ) 
{
  ...
  setnativemetrics ( p , ( eqtb [8938814L ].cint > 0 ) ) ;
  Result = p ;
  return Result ;
} 
void 
...
#define firstmathfontdimen ( 10 ) 
  ...
  hyphenchar [fontptr ]= eqtb [8938786L ].cint ;
  skewchar [fontptr ]= eqtb [8938787L ].cint ;
...
zdolocalelinebreaks ( integer s , integer len ) 
{
  ...
  if ( ( eqtb [8938808L ].cint == 0 ) || ( len == 1 ) ) 
  {
    ...
    while ( i++ < for_end ) ;} 
    setnativemetrics ( curlist .tailfield , ( eqtb [8938814L ].cint > 0 ) ) 
    ;
  } 
  else {
      
    useskip = eqtb [2252255L ].hh .v.RH != membot ;
    usepenalty = eqtb [8938809L ].cint != 0 || ! useskip ;
    linebreakstart ( mainf , eqtb [8938808L ].cint , nativetext + s , len ) 
    ;
    offs = 0 ;
    do {
	prevOffs = offs ;
...
getinputnormalizationstate ( void ) 
{
  ...
  if ( eqtb == nil ) 
  Result = 0 ;
  else Result = eqtb [8938816L ].cint ;
  return Result ;
} 
integer 
...
zreadfontinfo ( halfword u , strnumber nom , strnumber aire , scaled s ) 
{
  ...
  if ( bopenin ( tfmfile ) ) 
  {
    ...
    hyphenchar [f ]= eqtb [8938786L ].cint ;
    skewchar [f ]= eqtb [8938787L ].cint ;
    if ( bchlabel < nl ) 
...
zoutwhat ( halfword p ) 
{
  ...
  case 2 : 
	...
	else if ( j < 16 ) 
	{
	  ...
	  aopenout ( writefile [j ]) ) promptfilename ( 66752L , 66144L ) ;
	  writeopen [j ]= true ;
	  if ( logopened ) 
	  {
	    oldsetting = selector ;
...
zzreverse ( halfword thisbox , halfword t , scaled * curg , real * curglue ) 
{
  ...
  while ( true ) {
	...
	break ;
      case 8 : 
	if ( ( mem [p ].hh.b1 == 40 ) || ( mem [p ].hh.b1 == 41 ) || ( mem 
	[p ].hh.b1 == 42 ) || ( mem [p ].hh.b1 == 43 ) ) 
	rulewd = mem [p + 1 ].cint ;
	else goto lab15 ;
	break ;
      case 10 : 
...
hlistout ( void ) 
{
  ...
  while ( p != -268435455L ) {
    ...
    {
      if ( ( ( ( p ) != -268435455L && ( ! ( p >= himemmin ) ) && ( mem [p ]
      .hh.b0 == 8 ) && ( mem [p ].hh.b1 == 40 ) ) ) && ( fontarea [mem [p 
      + 4 ].qqqq .b1 ]== 65535L ) && ( fontletterspace [mem [p + 4 ].qqqq 
      .b1 ]== 0 ) ) 
      {
	r = p ;
	k = mem [r + 4 ].qqqq .b2 ;
	...
	mem [q ].hh.b0 == 7 ) ) q = mem [q ].hh .v.RH ;
	if ( ( q != -268435455L ) && ! ( q >= himemmin ) ) 
	{
	  if ( ( mem [q ].hh.b0 == 10 ) && ( mem [q ].hh.b1 == 0 ) && ( 
	  mem [q + 1 ].hh .v.LH == fontglue [mem [r + 4 ].qqqq .b1 ]) ) 
	  {
	    q = mem [q ].hh .v.RH ;
	    while ( ( q != -268435455L ) && ( ! ( q >= himemmin ) ) && ( mem [
	    q ].hh.b0 == 7 ) ) q = mem [q ].hh .v.RH ;
	    if ( ( ( ( q ) != -268435455L && ( ! ( q >= himemmin ) ) && ( mem 
	    [q ].hh.b0 == 8 ) && ( mem [q ].hh.b1 == 40 ) ) ) && ( mem [q 
	    + 4 ].qqqq .b1 == mem [r + 4 ].qqqq .b1 ) ) 
	    {
	      p = q ;
	  ...
	  if ( ( ( ( q ) != -268435455L && ( ! ( q >= himemmin ) ) && ( mem [
	  q ].hh.b0 == 8 ) && ( mem [q ].hh.b1 == 40 ) ) ) && ( mem [q + 4 
	  ].qqqq .b1 == mem [r + 4 ].qqqq .b1 ) ) 
	  {
	    p = q ;
	    q = mem [q ].hh .v.RH ;
	    goto lab1236 ;
  ...
  while ( p != -268435455L ) lab21: if ( ( p >= himemmin ) ) 
  {
	...
	if ( c >= eqtb [8938795L ].cint ) {
	  ...
	  if ( c <= eqtb [8938796L ].cint ) {
	    ...
	    {
	      basec = ( eqtb [7824628L + c ].hh .v.RH % 256 ) ;
	      accentc = ( eqtb [7824628L + c ].hh .v.RH / 256 ) ;
	      if ( ( fontec [f ]>= basec ) ) {
	...
	enddiagnostic ( false ) ;
	goto lab22 ;
	lab40: if ( eqtb [8938775L ].cint > 99 ) 
	{
	  begindiagnostic () ;
	  printnl ( 66939L ) ;
	  print ( c ) ;
	...
	case 41 : 
	  {
		...
		{register integer for_end; k = 0 ;for_end = len - 1 ; if ( k 
		<= for_end) do 
		  {
...
zshipout ( halfword p ) 
{
  ...
  poolpointer s  ;
  unsigned char oldsetting  ;
  synctexsheet ( eqtb [8938757L ].cint ) ;
  {
    if ( jobname == 0 ) 
    openlogfile () ;
    if ( eqtb [8938774L ].cint > 0 ) 
    {
      printnl ( 65622L ) ;
      println () ;
      print ( 66189L ) ;
    ...
    printchar ( 91 ) ;
    j = 9 ;
    while ( ( eqtb [8938821L + j ].cint == 0 ) && ( j > 0 ) ) decr ( j ) ;
    {register integer for_end; k = 0 ;for_end = j ; if ( k <= for_end) do 
      {
	printint ( eqtb [8938821L + k ].cint ) ;
	if ( k < j ) 
	printchar ( 46 ) ;
      } 
    while ( k++ < for_end ) ;} 
    ...
    10053208L ].cint > 1073741823L ) || ( mem [p + 1 ].cint + eqtb [
    10053207L ].cint > 1073741823L ) ) 
    {
      {
	if ( interaction == 3 ) 
	;
    ...
    if ( mem [p + 3 ].cint + mem [p + 2 ].cint + eqtb [10053208L ].cint 
    > maxv ) 
    maxv = mem [p + 3 ].cint + mem [p + 2 ].cint + eqtb [10053208L ]
    .cint ;
    if ( mem [p + 1 ].cint + eqtb [10053207L ].cint > maxh ) 
    maxh = mem [p + 1 ].cint + eqtb [10053207L ].cint ;
    dvih = 0 ;
    dviv = 0 ;
    curh = eqtb [10053207L ].cint ;
    dvif = 0 ;
    curhoffset = eqtb [10053207L ].cint + ( 65536L * 7227 ) / ((double) 100 
    ) ;
    curvoffset = eqtb [10053208L ].cint + ( 65536L * 7227 ) / ((double) 100 
    ) ;
    if ( eqtb [10053210L ].cint != 0 ) 
    curpagewidth = eqtb [10053210L ].cint ;
    else curpagewidth = mem [p + 1 ].cint + 2 * curhoffset ;
    if ( eqtb [10053211L ].cint != 0 ) 
    curpageheight = eqtb [10053211L ].cint ;
    ...
    if ( outputfilename == 0 ) 
    {
      ...
      while ( ! dviopenout ( dvifile ) ) promptfilename ( 66148L , 
      outputfileextension ) ;
	...
	printint ( eqtb [8938763L ].cint ) ;
	printchar ( 46 ) ;
	printtwo ( eqtb [8938762L ].cint ) ;
	printchar ( 46 ) ;
	printtwo ( eqtb [8938761L ].cint ) ;
	printchar ( 58 ) ;
	printtwo ( eqtb [8938760L ].cint / 60 ) ;
	printtwo ( eqtb [8938760L ].cint % 60 ) ;
	selector = oldsetting ;
    ...
    selector = 21 ;
    print ( 66193L ) ;
    if ( ( eqtb [10053210L ].cint > 0 ) && ( eqtb [10053211L ].cint > 0 ) 
    ) 
    {
      print ( 66077L ) ;
      print ( 32 ) ;
      printscaled ( eqtb [10053210L ].cint ) ;
      print ( 65692L ) ;
      print ( 32 ) ;
      print ( 66078L ) ;
      print ( 32 ) ;
      printscaled ( eqtb [10053211L ].cint ) ;
      print ( 65692L ) ;
    } 
    else print ( 66194L ) ;
    selector = oldsetting ;
    ...
    while ( s++ < for_end ) ;} 
    poolptr = strstart [( strptr ) - 65536L ];
    curv = mem [p + 3 ].cint + eqtb [10053208L ].cint ;
    tempptr = p ;
    if ( mem [p ].hh.b0 == 1 ) 
    vlistout () ;
    else hlistout () ;
...
zscanspec ( groupcode c , boolean threecodes ) 
{
  ...
  if ( scankeyword ( 66211L ) ) 
  speccode = 0 ;
  else if ( scankeyword ( 66212L ) ) 
  speccode = 1 ;
  else {
...
zhpack ( halfword p , scaled w , smallnumber m ) 
{
      ...
      case 8 : 
	{
	  ...
	  {case 40 : 
		...
		k = mem [q ].hh.b1 ;
	      ...
	      himemmin ) ) ) 
	      {
		if ( ( mem [pp ].hh.b0 == 8 ) && ( mem [pp ].hh.b1 == 40 ) 
		...
		else if ( ( mem [pp ].hh.b0 == 7 ) ) 
		{
		  ...
		  && ( mem [ppp ].hh.b0 == 8 ) && ( mem [ppp ].hh.b1 == 40 
		  ) ) ) && ( mem [ppp + 4 ].qqqq .b1 == mem [p + 4 ].qqqq 
		  .b1 ) ) 
		  {
		    pp = mem [ppp ].hh .v.RH ;
		    goto lab20 ;
  ...
  else if ( x > 0 ) 
  {
	...
	if ( lastbadness > eqtb [8938766L ].cint ) 
	{
	  println () ;
	  if ( lastbadness > 100 ) 
	  printnl ( 66214L ) ;
    ...
    ].hh .v.RH != -268435455L ) ) 
    {
      ...
      mem [r + 6 ].gr = 1.0 ;
      if ( ( - (integer) x - totalshrink [0 ]> eqtb [10053197L ].cint ) || 
      ( eqtb [8938766L ].cint < 100 ) ) 
      {
	if ( ( eqtb [10053205L ].cint > 0 ) && ( - (integer) x - totalshrink 
	[0 ]> eqtb [10053197L ].cint ) ) 
	{
	  while ( mem [q ].hh .v.RH != -268435455L ) q = mem [q ].hh .v.RH 
	  ;
	  mem [q ].hh .v.RH = newrule () ;
	  mem [mem [q ].hh .v.RH + 1 ].cint = eqtb [10053205L ].cint ;
	} 
	println () ;
	printnl ( 66222L ) ;
...
zvpackage ( halfword p , scaled h , smallnumber m , scaled l ) 
{
  ...
  while ( p != -268435455L ) {
    ...
    case 8 : 
      {
	if ( ( mem [p ].hh.b1 == 42 ) || ( mem [p ].hh.b1 == 43 ) ) 
	{
	  x = x + d + mem [p + 3 ].cint ;
	  d = mem [p + 2 ].cint ;
	  if ( mem [p + 1 ].cint > w ) 
  ...
  else if ( x > 0 ) 
  {
    ...
    if ( o == 0 ) {
      ...
      {
	lastbadness = badness ( x , totalstretch [0 ]) ;
	if ( lastbadness > eqtb [8938767L ].cint ) 
	{
	  println () ;
	  if ( lastbadness > 100 ) 
	  printnl ( 66214L ) ;
    ...
    ].hh .v.RH != -268435455L ) ) 
    {
      lastbadness = 1000000L ;
      mem [r + 6 ].gr = 1.0 ;
      if ( ( - (integer) x - totalshrink [0 ]> eqtb [10053198L ].cint ) || 
      ( eqtb [8938767L ].cint < 100 ) ) 
      {
	println () ;
	printnl ( 66227L ) ;
	printscaled ( - (integer) x - totalshrink [0 ]) ;
...
zappendtovlist ( halfword b ) 
{
  ...
  halfword p  ;
  boolean upwards  ;
  upwards = ( eqtb [8938813L ].cint > 0 ) ;
  if ( curlist .auxfield .cint > -65536000L ) 
  {
    if ( upwards ) 
    d = mem [eqtb [2252241L ].hh .v.RH + 1 ].cint - curlist .auxfield 
    .cint - mem [b + 2 ].cint ;
    else d = mem [eqtb [2252241L ].hh .v.RH + 1 ].cint - curlist .auxfield 
    .cint - mem [b + 3 ].cint ;
    if ( d < eqtb [10053191L ].cint ) 
    p = newparamglue ( 0 ) ;
    else {
...
zmathxheight ( integer sizecode ) 
{
  ...
  integer f  ;
  scaled rval  ;
  f = eqtb [2253302L + sizecode ].hh .v.RH ;
  if ( ( ( fontarea [curf ]== 65534L ) && ( isOpenTypeMathFont ( 
  fontlayoutengine [curf ]) ) ) ) 
  rval = getnativemathsyparam ( curf , 5 ) ;
...
zmathquad ( integer sizecode ) 
{
  ...
  if ( ( ( fontarea [curf ]== 65534L ) && ( isOpenTypeMathFont ( 
  fontlayoutengine [curf ]) ) ) ) 
  rval = getnativemathsyparam ( curf , 6 ) ;
...
znum1 ( integer sizecode ) 
{
  ...
  if ( ( ( fontarea [curf ]== 65534L ) && ( isOpenTypeMathFont ( 
  fontlayoutengine [curf ]) ) ) ) 
  rval = getnativemathsyparam ( curf , 8 ) ;
...
znum2 ( integer sizecode ) 
{
  ...
  if ( ( ( fontarea [curf ]== 65534L ) && ( isOpenTypeMathFont ( 
  fontlayoutengine [curf ]) ) ) ) 
  rval = getnativemathsyparam ( curf , 9 ) ;
...
znum3 ( integer sizecode ) 
{
  ...
  if ( ( ( fontarea [curf ]== 65534L ) && ( isOpenTypeMathFont ( 
  fontlayoutengine [curf ]) ) ) ) 
  rval = getnativemathsyparam ( curf , 10 ) ;
...
zdenom1 ( integer sizecode ) 
{
  ...
  if ( ( ( fontarea [curf ]== 65534L ) && ( isOpenTypeMathFont ( 
  fontlayoutengine [curf ]) ) ) ) 
  rval = getnativemathsyparam ( curf , 11 ) ;
...
zdenom2 ( integer sizecode ) 
{
  ...
  if ( ( ( fontarea [curf ]== 65534L ) && ( isOpenTypeMathFont ( 
  fontlayoutengine [curf ]) ) ) ) 
  rval = getnativemathsyparam ( curf , 12 ) ;
...
zsup1 ( integer sizecode ) 
{
  ...
  if ( ( ( fontarea [curf ]== 65534L ) && ( isOpenTypeMathFont ( 
  fontlayoutengine [curf ]) ) ) ) 
  rval = getnativemathsyparam ( curf , 13 ) ;
...
zsup2 ( integer sizecode ) 
{
  ...
  if ( ( ( fontarea [curf ]== 65534L ) && ( isOpenTypeMathFont ( 
  fontlayoutengine [curf ]) ) ) ) 
  rval = getnativemathsyparam ( curf , 14 ) ;
...
zsup3 ( integer sizecode ) 
{
  ...
  if ( ( ( fontarea [curf ]== 65534L ) && ( isOpenTypeMathFont ( 
  fontlayoutengine [curf ]) ) ) ) 
  rval = getnativemathsyparam ( curf , 15 ) ;
...
zsub1 ( integer sizecode ) 
{
  ...
  if ( ( ( fontarea [curf ]== 65534L ) && ( isOpenTypeMathFont ( 
  fontlayoutengine [curf ]) ) ) ) 
  rval = getnativemathsyparam ( curf , 16 ) ;
...
zsub2 ( integer sizecode ) 
{
  ...
  if ( ( ( fontarea [curf ]== 65534L ) && ( isOpenTypeMathFont ( 
  fontlayoutengine [curf ]) ) ) ) 
  rval = getnativemathsyparam ( curf , 17 ) ;
...
zsupdrop ( integer sizecode ) 
{
  ...
  if ( ( ( fontarea [curf ]== 65534L ) && ( isOpenTypeMathFont ( 
  fontlayoutengine [curf ]) ) ) ) 
  rval = getnativemathsyparam ( curf , 18 ) ;
...
zsubdrop ( integer sizecode ) 
{
  ...
  if ( ( ( fontarea [curf ]== 65534L ) && ( isOpenTypeMathFont ( 
  fontlayoutengine [curf ]) ) ) ) 
  rval = getnativemathsyparam ( curf , 19 ) ;
...
zdelim1 ( integer sizecode ) 
{
  ...
  if ( ( ( fontarea [curf ]== 65534L ) && ( isOpenTypeMathFont ( 
  fontlayoutengine [curf ]) ) ) ) 
  rval = getnativemathsyparam ( curf , 20 ) ;
...
zdelim2 ( integer sizecode ) 
{
  ...
  if ( ( ( fontarea [curf ]== 65534L ) && ( isOpenTypeMathFont ( 
  fontlayoutengine [curf ]) ) ) ) 
  rval = getnativemathsyparam ( curf , 21 ) ;
...
zaxisheight ( integer sizecode ) 
{
  ...
  if ( ( ( fontarea [curf ]== 65534L ) && ( isOpenTypeMathFont ( 
  fontlayoutengine [curf ]) ) ) ) 
  rval = getnativemathsyparam ( curf , 22 ) ;
...
defaultrulethickness ( void ) 
{
  ...
  integer f  ;
  scaled rval  ;
  f = eqtb [2253303L + cursize ].hh .v.RH ;
  if ( ( ( fontarea [curf ]== 65534L ) && ( isOpenTypeMathFont ( 
  fontlayoutengine [curf ]) ) ) ) 
  rval = getnativemathexparam ( curf , 8 ) ;
  else rval = fontinfo [8 + parambase [f ]].cint ;
  Result = rval ;
  return Result ;
} 
...
bigopspacing1 ( void ) 
{
  ...
  if ( ( ( fontarea [curf ]== 65534L ) && ( isOpenTypeMathFont ( 
  fontlayoutengine [curf ]) ) ) ) 
  rval = getnativemathexparam ( curf , 9 ) ;
  else rval = fontinfo [9 + parambase [f ]].cint ;
  Result = rval ;
  return Result ;
} 
...
bigopspacing2 ( void ) 
{
  ...
  if ( ( ( fontarea [curf ]== 65534L ) && ( isOpenTypeMathFont ( 
  fontlayoutengine [curf ]) ) ) ) 
  rval = getnativemathexparam ( curf , 10 ) ;
  else rval = fontinfo [10 + parambase [f ]].cint ;
  Result = rval ;
  return Result ;
} 
...
bigopspacing3 ( void ) 
{
  ...
  if ( ( ( fontarea [curf ]== 65534L ) && ( isOpenTypeMathFont ( 
  fontlayoutengine [curf ]) ) ) ) 
  rval = getnativemathexparam ( curf , 11 ) ;
  else rval = fontinfo [11 + parambase [f ]].cint ;
  Result = rval ;
  return Result ;
} 
...
bigopspacing4 ( void ) 
{
  ...
  if ( ( ( fontarea [curf ]== 65534L ) && ( isOpenTypeMathFont ( 
  fontlayoutengine [curf ]) ) ) ) 
  rval = getnativemathexparam ( curf , 12 ) ;
  else rval = fontinfo [12 + parambase [f ]].cint ;
  Result = rval ;
  return Result ;
} 
...
bigopspacing5 ( void ) 
{
  ...
  if ( ( ( fontarea [curf ]== 65534L ) && ( isOpenTypeMathFont ( 
  fontlayoutengine [curf ]) ) ) ) 
  rval = getnativemathexparam ( curf , 13 ) ;
  else rval = fontinfo [13 + parambase [f ]].cint ;
  Result = rval ;
  return Result ;
} 
...
zvardelimiter ( halfword d , integer s , scaled v ) 
{
  ...
  while ( true ) {
    ...
    if ( ( z != 0 ) || ( x != 0 ) ) 
    {
      ...
      do {
	  z = z - 256 ;
	g = eqtb [2253300L + z ].hh .v.RH ;
	if ( g != 0 ) {
	    
	  if ( ( ( fontarea [g ]== 65534L ) && ( usingOpenType ( 
	  fontlayoutengine [g ]) ) ) ) 
	  {
	    b = newnativecharacter ( g , x ) ;
	    x = getnativeglyph ( b , 0 ) ;
	    freenode ( b , mem [b + 4 ].qqqq .b0 ) ;
	    f = g ;
	    c = x ;
	    w = 0 ;
	    n = 0 ;
  ...
  lab40: if ( f != 0 ) 
  {
    ...
    b = newnullbox () ;
    mem [b + 1 ].cint = eqtb [10053200L ].cint ;
  } 
...
zfetch ( halfword a ) 
{
  ...
  curf = eqtb [2253300L + ( mem [a ].hh.b0 % 256 ) + cursize ].hh .v.RH ;
...
zmakeradical ( halfword q ) 
{
  ...
  scaled delta, clr  ;
  f = eqtb [2253300L + ( mem [q + 4 ].qqqq .b0 % 256 ) + cursize ].hh 
  .v.RH ;
...
zmakescripts ( halfword q , scaled delta ) 
{
  ...
  if ( mem [q + 2 ].hh .v.RH == 0 ) 
  {
    ...
    curf = savef ;
    mem [x + 1 ].cint = mem [x + 1 ].cint + eqtb [10053201L ].cint ;
    ...
    mem [x + 4 ].cint = - (integer) shiftup ;
      ...
      curf = savef ;
      mem [y + 1 ].cint = mem [y + 1 ].cint + eqtb [10053201L ].cint ;
...
zmakeleftright ( halfword q , smallnumber style , scaled maxd , scaled maxh ) 
{
  ...
  if ( delta2 > delta1 ) 
  delta1 = delta2 ;
  delta = ( delta1 / 500 ) * eqtb [8938758L ].cint ;
  delta2 = delta1 + delta1 - eqtb [10053199L ].cint ;
  if ( delta < delta2 ) 
  delta = delta2 ;
...
mlisttohlist ( void ) 
{
  ...
  while ( q != -268435455L ) {
    ...
    case 18 : 
      {
	t = 18 ;
	pen = eqtb [8938749L ].cint ;
      } 
      break ;
    case 19 : 
      {
	t = 19 ;
	pen = eqtb [8938750L ].cint ;
      } 
      break ;
    case 16 : 
    case 29 : 
	...
	break ;
      ...
      if ( x != 0 ) 
      {
	y = mathglue ( eqtb [2252240L + x ].hh .v.RH , curmu ) ;
	z = newglue ( y ) ;
...
getpreambletoken ( void ) 
{
  ...
  if ( curcmd == 9 ) 
  fatalerror ( 65914L ) ;
  if ( ( curcmd == 76 ) && ( curchr == 2252251L ) ) 
  {
    scanoptionalequals () ;
    scanglue ( 2 ) ;
    if ( eqtb [8938783L ].cint > 0 ) 
    geqdefine ( 2252251L , 119 , curval ) ;
    else eqdefine ( 2252251L , 119 , curval ) ;
    goto lab20 ;
  } 
} 
void 
initalign ( void ) 
{
  ...
  newsavelevel ( 6 ) ;
  if ( eqtb [2252779L ].hh .v.RH != -268435455L ) 
  begintokenlist ( eqtb [2252779L ].hh .v.RH , 14 ) ;
  alignpeek () ;
} 
void 
...
fincol ( void ) 
{
  ...
  fatalerror ( 65914L ) ;
  p = mem [q ].hh .v.RH ;
  if ( ( p == -268435455L ) && ( mem [curalign + 5 ].hh .v.LH < 65538L ) ) {
...
finalign ( void ) 
{
  ...
  {
    rulesave = eqtb [10053205L ].cint ;
    eqtb [10053205L ].cint = 0 ;
    p = hpack ( mem [memtop - 8 ].hh .v.RH , savestack [saveptr + 1 ].cint 
    , savestack [saveptr + 0 ].cint ) ;
    eqtb [10053205L ].cint = rulesave ;
  } 
  else {
  ...
  if ( curlist .modefield == 207 ) 
  {
    ...
    popnest () ;
    {
      mem [curlist .tailfield ].hh .v.RH = newpenalty ( eqtb [8938751L ]
      .cint ) ;
      curlist .tailfield = mem [curlist .tailfield ].hh .v.RH ;
    } 
    {
    ...
    curlist .tailfield = q ;
    {
      mem [curlist .tailfield ].hh .v.RH = newpenalty ( eqtb [8938752L ]
      .cint ) ;
      curlist .tailfield = mem [curlist .tailfield ].hh .v.RH ;
    } 
    {
...
ztrybreak ( integer pi , smallnumber breaktype ) 
{
  ...
  while ( true ) {
	...
	r == memtop - 7 ) ) ) 
	{
	  if ( nobreakyet ) 
	  {
		...
		while ( t > 0 ) {
		  ...
		  case 8 : 
		    ...
		    41 ) || ( mem [v ].hh.b1 == 42 ) || ( mem [v ].hh.b1 
		    == 43 ) ) 
		    breakwidth [1 ]= breakwidth [1 ]- mem [v + 1 ].cint 
		    ;
		    else confusion ( 66315L ) ;
		    break ;
		    default: 
		    confusion ( 66316L ) ;
		    break ;
	  ...
	  if ( abs ( eqtb [8938756L ].cint ) >= 1073741823L - 
	  minimumdemerits ) 
	  minimumdemerits = 1073741822L ;
	  else minimumdemerits = minimumdemerits + abs ( eqtb [8938756L ]
	  .cint ) ;
	...
	if ( l > easyline ) 
	{
	  ...
	  else linewidth = mem [eqtb [2252771L ].hh .v.RH + 2 * l ].cint ;
	} 
      } 
    } 
    {
	...
	( curactivewidth [5 ]!= 0 ) ) 
	{
	  if ( dolastlinefit ) 
	  {
	    if ( curp == -268435455L ) 
	    {
	      ...
	      1073741823L ) ;
	      if ( eqtb [8938804L ].cint < 1000 ) 
	      g = fract ( g , eqtb [8938804L ].cint , 1000 , 1073741823L ) ;
	      if ( aritherror ) {
	...
	if ( ( breaktype == 1 ) && ( mem [r ].hh.b0 == 1 ) ) {
	  ...
	  if ( curp != -268435455L ) 
	  d = d + eqtb [8938754L ].cint ;
	  else d = d + eqtb [8938755L ].cint ;
	} 
	if ( abs ( fitclass - mem [r ].hh.b1 ) > 1 ) 
	d = d + eqtb [8938756L ].cint ;
      } 
	;
#ifdef STAT
      if ( eqtb [8938772L ].cint > 0 ) 
...
zpostlinebreak ( boolean d ) 
{
  ...
  do {
	...
	mem [q + 1 ].hh .v.LH = eqtb [2252248L ].hh .v.RH ;
	mem [q ].hh.b1 = 9 ;
	incr ( mem [eqtb [2252248L ].hh .v.RH ].hh .v.RH ) ;
	gluebreak = true ;
	goto lab30 ;
      } 
      else {
    ...
    if ( eqtb [2252247L ].hh .v.RH != membot ) 
    {
      r = newparamglue ( 7 ) ;
      mem [r ].hh .v.RH = q ;
      q = r ;
    ...
    else if ( eqtb [2252771L ].hh .v.RH == -268435455L ) 
    {
      ...
      curwidth = mem [eqtb [2252771L ].hh .v.RH + 2 * curline ].cint ;
      curindent = mem [eqtb [2252771L ].hh .v.RH + 2 * curline - 1 ].cint 
      ;
    } 
    adjusttail = memtop - 5 ;
	...
	pen = mem [q + r + 1 ].cint ;
      ...
      else pen = eqtb [8938753L ].cint ;
      q = eqtb [2253040L ].hh .v.RH ;
      if ( q != -268435455L ) 
      {
	...
	pen = pen + mem [q + r + 1 ].cint ;
      ...
      pen = pen + eqtb [8938745L ].cint ;
      if ( d ) 
      q = eqtb [2253042L ].hh .v.RH ;
      else q = eqtb [2253041L ].hh .v.RH ;
      if ( q != -268435455L ) 
      {
	...
	if ( d ) 
	pen = pen + eqtb [8938747L ].cint ;
	else pen = pen + eqtb [8938746L ].cint ;
      } 
      if ( discbreak ) 
      pen = pen + eqtb [8938748L ].cint ;
      if ( pen != 0 ) 
      {
	r = newpenalty ( pen ) ;
  ...
  .hh.b0 == 8 ) && ( mem [ha ].hh.b1 == 40 ) ) ) ) 
  {
	...
	if ( odd ( hyf [j ]) ) 
	{
	  ...
	  ; if ( i <= for_end) do 
	    ...
	    ;
	  while ( i++ < for_end ) ;} 
	  setnativemetrics ( q , ( eqtb [8938814L ].cint > 0 ) ) ;
	  mem [s ].hh .v.RH = q ;
	  s = q ;
	  q = newdisc () ;
...
zvsplit ( halfword n , scaled h ) 
{
  ...
  curval = n ;
  if ( curval < 256 ) 
  v = eqtb [2253043L + curval ].hh .v.RH ;
  else {
  ...
  q = vertbreak ( mem [v + 5 ].hh .v.RH , h , eqtb [10053195L ].cint ) ;
  p = mem [v + 5 ].hh .v.RH ;
  if ( p == q ) 
  ...
  lab30: ;
  q = prunepagetop ( q , eqtb [8938805L ].cint > 0 ) ;
  p = mem [v + 5 ].hh .v.RH ;
  freenode ( v , 8 ) ;
  if ( q != -268435455L ) 
  q = vpackage ( q , 0 , 1 , 1073741823L ) ;
  if ( curval < 256 ) 
  eqtb [2253043L + curval ].hh .v.RH = q ;
  else {
  ...
  Result = vpackage ( p , h , 0 , eqtb [10053195L ].cint ) ;
  return Result ;
} 
void 
printtotals ( void ) 
...
zfreezepagespecs ( smallnumber s ) 
{
  ...
  pagecontents = s ;
  pagesofar [0 ]= eqtb [10053193L ].cint ;
  pagemaxdepth = eqtb [10053194L ].cint ;
  pagesofar [7 ]= 0 ;
  pagesofar [1 ]= 0 ;
  pagesofar [2 ]= 0 ;
  pagesofar [3 ]= 0 ;
...
zboxerror ( eightbits n ) 
{
  ...
  begindiagnostic () ;
  printnl ( 66198L ) ;
  showbox ( eqtb [2253043L + n ].hh .v.RH ) ;
  enddiagnostic ( true ) ;
  flushnodelist ( eqtb [2253043L + n ].hh .v.RH ) ;
  eqtb [2253043L + n ].hh .v.RH = -268435455L ;
} 
void 
...
zfireup ( halfword c ) 
{
  ...
  {
    geqworddefine ( 8938779L , mem [bestpagebreak + 1 ].cint ) ;
    mem [bestpagebreak + 1 ].cint = 10000 ;
  } 
  else geqworddefine ( 8938779L , 10000 ) ;
  if ( saroot [7 ]!= -268435455L ) {
  ...
  if ( eqtb [2253298L ].hh .v.RH != -268435455L ) 
  {
    {
      if ( interaction == 3 ) 
      ;
  ...
  insertpenalties = 0 ;
  savesplittopskip = eqtb [2252250L ].hh .v.RH ;
  if ( eqtb [8938793L ].cint <= 0 ) 
  {
    r = mem [memtop ].hh .v.RH ;
    while ( r != memtop ) {
	...
	n = mem [r ].hh.b1 ;
	ensurevbox ( n ) ;
	if ( eqtb [2253043L + n ].hh .v.RH == -268435455L ) 
	eqtb [2253043L + n ].hh .v.RH = newnullbox () ;
	p = eqtb [2253043L + n ].hh .v.RH + 5 ;
	while ( mem [p ].hh .v.RH != -268435455L ) p = mem [p ].hh .v.RH ;
	mem [r + 2 ].hh .v.RH = p ;
      } 
      r = mem [r ].hh .v.RH ;
  ...
  while ( p != bestpagebreak ) {
	...
	wait = true ;
	  ...
	  if ( mem [r + 2 ].hh .v.LH == p ) 
	  {
		...
		mem [s ].hh .v.RH ;
		mem [s ].hh .v.RH = -268435455L ;
		eqtb [2252250L ].hh .v.RH = mem [p + 4 ].hh .v.RH ;
	    ...
	    n = mem [r ].hh.b1 ;
	    tempptr = mem [eqtb [2253043L + n ].hh .v.RH + 5 ].hh .v.RH ;
	    freenode ( eqtb [2253043L + n ].hh .v.RH , 8 ) ;
	    eqtb [2253043L + n ].hh .v.RH = vpackage ( tempptr , 0 , 1 , 
	    1073741823L ) ;
	  } 
	  else {
  ...
  eqtb [2252250L ].hh .v.RH = savesplittopskip ;
  if ( p != -268435455L ) 
  {
    if ( mem [memtop - 1 ].hh .v.RH == -268435455L ) {
  ...
  savevbadness = eqtb [8938767L ].cint ;
  eqtb [8938767L ].cint = 10000 ;
  savevfuzz = eqtb [10053198L ].cint ;
  eqtb [10053198L ].cint = 1073741823L ;
  eqtb [2253298L ].hh .v.RH = vpackage ( mem [memtop - 2 ].hh .v.RH , 
  bestsize , 0 , pagemaxdepth ) ;
  eqtb [8938767L ].cint = savevbadness ;
  eqtb [10053198L ].cint = savevfuzz ;
  if ( lastglue != 1073741823L ) 
  ...
  if ( eqtb [2252772L ].hh .v.RH != -268435455L ) {
      
    if ( deadcycles >= eqtb [8938780L ].cint ) 
    {
      {
	if ( interaction == 3 ) 
	;
	...
	helpline [0 ]= 66405L ;
      ...
      begintokenlist ( eqtb [2252772L ].hh .v.RH , 7 ) ;
      newsavelevel ( 8 ) ;
      normalparagraph () ;
      scanleftbrace () ;
      return ;
  ...
  } 
  {
    ...
    shipout ( eqtb [2253298L ].hh .v.RH ) ;
    eqtb [2253298L ].hh .v.RH = -268435455L ;
  } 
} 
void 
buildpage ( void ) 
{
  ...
  do {
	...
	if ( mem [r ].hh.b1 != n ) 
	{
	  ...
	  if ( eqtb [2253043L + n ].hh .v.RH == -268435455L ) 
	  mem [r + 3 ].cint = 0 ;
	  else mem [r + 3 ].cint = mem [eqtb [2253043L + n ].hh .v.RH + 3 
	  ].cint + mem [eqtb [2253043L + n ].hh .v.RH + 2 ].cint ;
	  mem [r + 2 ].hh .v.LH = -268435455L ;
	  q = eqtb [2252259L + n ].hh .v.RH ;
	  if ( eqtb [8938821L + n ].cint == 1000 ) 
	  h = mem [r + 3 ].cint ;
	  else h = xovern ( mem [r + 3 ].cint , 1000 ) * eqtb [8938821L + n 
	  ].cint ;
	...
	insertpenalties = insertpenalties + mem [p + 1 ].cint ;
	  ...
	  if ( eqtb [8938821L + n ].cint == 1000 ) 
	  h = mem [p + 3 ].cint ;
	  else h = xovern ( mem [p + 3 ].cint , 1000 ) * eqtb [8938821L + n 
	  ].cint ;
	  if ( ( ( h <= 0 ) || ( h <= delta ) ) && ( mem [p + 3 ].cint + mem 
	  [r + 3 ].cint <= eqtb [10053212L + n ].cint ) ) 
	  {
	    ...
	    if ( eqtb [8938821L + n ].cint <= 0 ) 
	    w = 1073741823L ;
	    else {
		
	      w = pagesofar [0 ]- pagesofar [1 ]- pagesofar [7 ];
	      if ( eqtb [8938821L + n ].cint != 1000 ) 
	      w = xovern ( w , eqtb [8938821L + n ].cint ) * 1000 ;
	    } 
	    if ( w > eqtb [10053212L + n ].cint - mem [r + 3 ].cint ) 
	    w = eqtb [10053212L + n ].cint - mem [r + 3 ].cint ;
...
appspace ( void ) 
{
  appspace_regmem 
  halfword q  ;
  if ( ( curlist .auxfield .hh .v.LH >= 2000 ) && ( eqtb [2252253L ].hh 
  .v.RH != membot ) ) 
  q = newparamglue ( 13 ) ;
  else {
      
    if ( eqtb [2252252L ].hh .v.RH != membot ) 
    mainp = eqtb [2252252L ].hh .v.RH ;
    else {
	
      mainp = fontglue [eqtb [2253299L ].hh .v.RH ];
      if ( mainp == -268435455L ) 
      {
	mainp = newspec ( membot ) ;
	maink = parambase [eqtb [2253299L ].hh .v.RH ]+ 2 ;
	mem [mainp + 1 ].cint = fontinfo [maink ].cint ;
	mem [mainp + 2 ].cint = fontinfo [maink + 1 ].cint ;
	mem [mainp + 3 ].cint = fontinfo [maink + 2 ].cint ;
	fontglue [eqtb [2253299L ].hh .v.RH ]= mainp ;
      } 
    } 
    mainp = newspec ( mainp ) ;
    if ( curlist .auxfield .hh .v.LH >= 2000 ) 
    mem [mainp + 1 ].cint = mem [mainp + 1 ].cint + fontinfo [7 + 
    parambase [eqtb [2253299L ].hh .v.RH ]].cint ;
...
itsallover ( void ) 
{
  ...
  if ( privileged () ) 
  {
    ...
    mem [curlist .tailfield + 1 ].cint = eqtb [10053192L ].cint ;
    {
...
normalparagraph ( void ) 
{
  ...
  if ( eqtb [8938759L ].cint != 0 ) 
  eqworddefine ( 8938759L , 0 ) ;
  if ( eqtb [10053206L ].cint != 0 ) 
  eqworddefine ( 10053206L , 0 ) ;
  if ( eqtb [8938781L ].cint != 1 ) 
  eqworddefine ( 8938781L , 1 ) ;
  if ( eqtb [2252771L ].hh .v.RH != -268435455L ) 
  eqdefine ( 2252771L , 120 , -268435455L ) ;
  if ( eqtb [2253039L ].hh .v.RH != -268435455L ) 
  eqdefine ( 2253039L , 120 , -268435455L ) ;
} 
void 
zboxend ( integer boxcontext ) 
{
  ...
  else if ( boxcontext < 1073807360L ) 
  {
    ...
    if ( curval < 256 ) {
      ...
      if ( ( a >= 4 ) ) 
      geqdefine ( 2253043L + curval , 121 , curbox ) ;
      else eqdefine ( 2253043L + curval , 121 , curbox ) ;
    } 
    else {
...
zbeginbox ( integer boxcontext ) 
{
  ...
  {case 0 : 
    {
      scanregisternum () ;
      if ( curval < 256 ) 
      curbox = eqtb [2253043L + curval ].hh .v.RH ;
      else {
	...
	curbox = -268435455L ;
      ...
      if ( curval < 256 ) 
      eqtb [2253043L + curval ].hh .v.RH = -268435455L ;
      else {
  ...
  case 3 : 
	...
	normalparagraph () ;
      ...
      {
	curlist .auxfield .cint = -65536000L ;
	if ( eqtb [2252777L ].hh .v.RH != -268435455L ) 
	begintokenlist ( eqtb [2252777L ].hh .v.RH , 12 ) ;
      } 
      else {
	  
	curlist .auxfield .hh .v.LH = 1000 ;
	if ( eqtb [2252776L ].hh .v.RH != -268435455L ) 
	begintokenlist ( eqtb [2252776L ].hh .v.RH , 11 ) ;
      } 
      return ;
    } 
    break ;
...
zpackage ( smallnumber c ) 
{
  ...
  scaled d  ;
  integer u, v  ;
  d = eqtb [10053196L ].cint ;
  u = eqtb [8938813L ].cint ;
  unsave () ;
  saveptr = saveptr - 3 ;
  v = eqtb [8938813L ].cint ;
  eqtb [8938813L ].cint = u ;
  if ( curlist .modefield == -104 ) 
...
znewgraf ( boolean indented ) 
{
  ...
  curlist .auxfield .hh .v.LH = 1000 ;
  if ( eqtb [8938790L ].cint <= 0 ) 
  curlang = 0 ;
  else if ( eqtb [8938790L ].cint > 255 ) 
  curlang = 0 ;
  else curlang = eqtb [8938790L ].cint ;
  curlist .auxfield .hh .v.RH = curlang ;
  curlist .pgfield = ( normmin ( eqtb [8938791L ].cint ) * 64 + normmin ( 
  eqtb [8938792L ].cint ) ) * 65536L + curlang ;
  if ( indented ) 
  {
    curlist .tailfield = newnullbox () ;
    mem [curlist .headfield ].hh .v.RH = curlist .tailfield ;
    mem [curlist .tailfield + 1 ].cint = eqtb [10053189L ].cint ;
    if ( ( insertsrcspecialeverypar ) ) 
    insertsrcspecial () ;
  } 
  if ( eqtb [2252773L ].hh .v.RH != -268435455L ) 
  begintokenlist ( eqtb [2252773L ].hh .v.RH , 8 ) ;
  if ( nestptr == 1 ) 
  buildpage () ;
} 
void 
indentinhmode ( void ) 
{
  ...
  {
    p = newnullbox () ;
    mem [p + 1 ].cint = eqtb [10053189L ].cint ;
    if ( abs ( curlist .modefield ) == 104 ) 
    curlist .auxfield .hh .v.LH = 1000 ;
    else {
...
begininsertoradjust ( void ) 
{
  ...
  if ( ( curcmd == 38 ) && scankeyword ( 66482L ) ) 
...
appenditaliccorrection ( void ) 
{
  ...
  if ( curlist .tailfield != curlist .headfield ) 
  {
    ...
    {
      if ( ( mem [curlist .tailfield ].hh.b1 == 40 ) ) 
      {
	{
	...
	mem [curlist .tailfield ].hh.b1 = 1 ;
      ...
      else if ( ( mem [curlist .tailfield ].hh.b1 == 41 ) ) 
      {
	{
	  mem [curlist .tailfield ].hh .v.RH = newkern ( 
...
appenddiscretionary ( void ) 
{
  ...
  if ( curchr == 1 ) 
  {
    c = hyphenchar [eqtb [2253299L ].hh .v.RH ];
    if ( c >= 0 ) {
...
initmath ( void ) 
{
  ...
  if ( ( curcmd == 3 ) && ( curlist .modefield > 0 ) ) 
  {
    ...
    if ( curlist .headfield == curlist .tailfield ) 
    {
      ...
      if ( ( eTeXmode == 1 ) ) 
      {
	if ( eqtb [2252248L ].hh .v.RH == membot ) 
	j = newkern ( 0 ) ;
	...
	curdir = 1 ;
      ...
      v = v + 2 * fontinfo [6 + parambase [eqtb [2253299L ].hh .v.RH ]]
      .cint ;
      if ( ( eqtb [8938811L ].cint > 0 ) ) 
      {
	tempptr = getavail () ;
    ...
    if ( eqtb [2252771L ].hh .v.RH == -268435455L ) {
      ...
      if ( ( eqtb [10053206L ].cint != 0 ) && ( ( ( eqtb [8938781L ].cint 
      >= 0 ) && ( curlist .pgfield + 2 > eqtb [8938781L ].cint ) ) || ( 
      curlist .pgfield + 1 < - (integer) eqtb [8938781L ].cint ) ) ) 
      {
	l = eqtb [10053192L ].cint - abs ( eqtb [10053206L ].cint ) ;
	if ( eqtb [10053206L ].cint > 0 ) 
	s = eqtb [10053206L ].cint ;
	else s = 0 ;
      } 
      else {
	  
	l = eqtb [10053192L ].cint ;
	s = 0 ;
      } 
    } 
    else {
	
      n = mem [eqtb [2252771L ].hh .v.RH ].hh .v.LH ;
      if ( curlist .pgfield + 2 >= n ) 
      p = eqtb [2252771L ].hh .v.RH + 2 * n ;
      else p = eqtb [2252771L ].hh .v.RH + 2 * ( curlist .pgfield + 2 ) ;
      s = mem [p - 1 ].cint ;
      l = mem [p ].cint ;
    } 
    pushmath ( 15 ) ;
    curlist .modefield = 207 ;
    eqworddefine ( 8938784L , -1 ) ;
    eqworddefine ( 10053202L , w ) ;
    curlist .eTeXauxfield = j ;
    if ( ( eTeXmode == 1 ) ) 
    eqworddefine ( 8938803L , x ) ;
    eqworddefine ( 10053203L , l ) ;
    eqworddefine ( 10053204L , s ) ;
    if ( eqtb [2252775L ].hh .v.RH != -268435455L ) 
    begintokenlist ( eqtb [2252775L ].hh .v.RH , 10 ) ;
    if ( nestptr == 1 ) 
    buildpage () ;
  } 
  else {
    ...
    backinput () ;
    {
      ...
      insertsrcspecial () ;
      if ( eqtb [2252774L ].hh .v.RH != -268435455L ) 
      begintokenlist ( eqtb [2252774L ].hh .v.RH , 9 ) ;
    } 
  } 
} 
void 
...
zscanmath ( halfword p ) 
{
  ...
  case 68 : 
    {
      c = eqtb [6710516L + curchr ].hh .v.RH ;
  ...
  if ( ( mathclassfield ( c ) == 7 ) && ( ( eqtb [8938784L ].cint >= 0 ) && 
  ( eqtb [8938784L ].cint < 256 ) ) ) 
  mem [p ].hh.b0 = eqtb [8938784L ].cint ;
...
zsetmathchar ( integer c ) 
{
  ...
  if ( mathcharfield ( c ) == 2097151L ) 
  {
    ...
    {
      if ( ( ( eqtb [8938784L ].cint >= 0 ) && ( eqtb [8938784L ].cint < 
      256 ) ) ) 
      mem [p + 1 ].hh.b0 = eqtb [8938784L ].cint ;
      mem [p ].hh.b0 = 16 ;
    } 
...
zscandelimiter ( halfword p , boolean r ) 
{
  ...
  if ( r ) 
  {
    ...
    case 12 : 
      {
	curval = eqtb [8939077L + curchr ].cint ;
      } 
      break ;
    case 15 : 
      if ( curchr == 1 ) 
...
mathac ( void ) 
{
  ...
  if ( curchr == 1 ) 
  {
    if ( scankeyword ( 66535L ) ) 
    mem [curlist .tailfield ].hh.b1 = 1 ;
    else if ( scankeyword ( 66536L ) ) 
    {
      if ( scankeyword ( 66535L ) ) 
  ...
  if ( ( mathclassfield ( curval ) == 7 ) && ( ( eqtb [8938784L ].cint >= 0 
  ) && ( eqtb [8938784L ].cint < 256 ) ) ) 
  mem [curlist .tailfield + 4 ].hh.b0 = eqtb [8938784L ].cint ;
...
zappdisplay ( halfword j , halfword b , scaled d ) 
{
  ...
  integer x  ;
  halfword p, q, r, t, u  ;
  s = eqtb [10053204L ].cint ;
  x = eqtb [8938803L ].cint ;
  if ( x == 0 ) 
  mem [b + 4 ].cint = s + d ;
  else {
      
    z = eqtb [10053203L ].cint ;
    p = b ;
    if ( x > 0 ) 
    e = z - d - mem [p + 1 ].cint ;
    else {
...
aftermath ( void ) 
{
  ...
  if ( ( ( fontparams [eqtb [2253302L ].hh .v.RH ]< 22 ) && ( ! ( ( 
  fontarea [eqtb [2253302L ].hh .v.RH ]== 65534L ) && ( isOpenTypeMathFont 
  ( fontlayoutengine [eqtb [2253302L ].hh .v.RH ]) ) ) ) ) || ( ( 
  fontparams [eqtb [2253558L ].hh .v.RH ]< 22 ) && ( ! ( ( fontarea [eqtb 
  [2253558L ].hh .v.RH ]== 65534L ) && ( isOpenTypeMathFont ( 
  fontlayoutengine [eqtb [2253558L ].hh .v.RH ]) ) ) ) ) || ( ( fontparams 
  [eqtb [2253814L ].hh .v.RH ]< 22 ) && ( ! ( ( fontarea [eqtb [2253814L 
  ...
  else if ( ( ( fontparams [eqtb [2253303L ].hh .v.RH ]< 13 ) && ( ! ( ( 
  fontarea [eqtb [2253303L ].hh .v.RH ]== 65534L ) && ( isOpenTypeMathFont 
  ( fontlayoutengine [eqtb [2253303L ].hh .v.RH ]) ) ) ) ) || ( ( 
  fontparams [eqtb [2253559L ].hh .v.RH ]< 13 ) && ( ! ( ( fontarea [eqtb 
  [2253559L ].hh .v.RH ]== 65534L ) && ( isOpenTypeMathFont ( 
  fontlayoutengine [eqtb [2253559L ].hh .v.RH ]) ) ) ) ) || ( ( fontparams 
  [eqtb [2253815L ].hh .v.RH ]< 13 ) && ( ! ( ( fontarea [eqtb [2253815L 
  ].hh .v.RH ]== 65534L ) && ( isOpenTypeMathFont ( fontlayoutengine [eqtb 
  [2253815L ].hh .v.RH ]) ) ) ) ) ) 
  {
    {
  ...
  if ( curlist .modefield == - (integer) m ) 
  {
    ...
    j = curlist .eTeXauxfield ;
    if ( ( ( fontparams [eqtb [2253302L ].hh .v.RH ]< 22 ) && ( ! ( ( 
    fontarea [eqtb [2253302L ].hh .v.RH ]== 65534L ) && ( 
    isOpenTypeMathFont ( fontlayoutengine [eqtb [2253302L ].hh .v.RH ]) ) 
    ) ) ) || ( ( fontparams [eqtb [2253558L ].hh .v.RH ]< 22 ) && ( ! ( ( 
    fontarea [eqtb [2253558L ].hh .v.RH ]== 65534L ) && ( 
    isOpenTypeMathFont ( fontlayoutengine [eqtb [2253558L ].hh .v.RH ]) ) 
    ) ) ) || ( ( fontparams [eqtb [2253814L ].hh .v.RH ]< 22 ) && ( ! ( ( 
    fontarea [eqtb [2253814L ].hh .v.RH ]== 65534L ) && ( 
    isOpenTypeMathFont ( fontlayoutengine [eqtb [2253814L ].hh .v.RH ]) ) 
    ) ) ) ) 
    {
      {
	if ( interaction == 3 ) 
    ...
    fontarea [eqtb [2253303L ].hh .v.RH ]== 65534L ) && ( 
    isOpenTypeMathFont ( fontlayoutengine [eqtb [2253303L ].hh .v.RH ]) ) 
    ) ) ) || ( ( fontparams [eqtb [2253559L ].hh .v.RH ]< 13 ) && ( ! ( ( 
    fontarea [eqtb [2253559L ].hh .v.RH ]== 65534L ) && ( 
    isOpenTypeMathFont ( fontlayoutengine [eqtb [2253559L ].hh .v.RH ]) ) 
    ) ) ) || ( ( fontparams [eqtb [2253815L ].hh .v.RH ]< 13 ) && ( ! ( ( 
    fontarea [eqtb [2253815L ].hh .v.RH ]== 65534L ) && ( 
    isOpenTypeMathFont ( fontlayoutengine [eqtb [2253815L ].hh .v.RH ]) ) 
    ) ) ) ) 
    {
      {
	if ( interaction == 3 ) 
  ...
  {
    {
      mem [curlist .tailfield ].hh .v.RH = newmath ( eqtb [10053190L ]
      .cint , 0 ) ;
      curlist .tailfield = mem [curlist .tailfield ].hh .v.RH ;
    } 
    curmlist = p ;
...
alterboxdimen ( void ) 
{
  ...
  scanregisternum () ;
  if ( curval < 256 ) 
  b = eqtb [2253043L + curval ].hh .v.RH ;
  else {
...
znewfont ( smallnumber a ) 
{
  ...
  do 
    {
      if ( streqstr ( fontname [f ], curname ) && ( ( ( curarea == 65622L ) 
  ...
  eqtb [2243238L + f ]= eqtb [u ];
  hash [2243238L + f ].v.RH = t ;
} 
void 
newinteraction ( void ) 
{
...
issuemessage ( void ) 
{
  ...
  if ( c == 0 ) 
  {
    ...
    print ( s ) ;
    if ( eqtb [2252780L ].hh .v.RH != -268435455L ) 
    useerrhelp = true ;
...
zloadpicture ( boolean ispdf ) 
{
  ...
  if ( ispdf ) 
  {
    if ( scankeyword ( 66389L ) ) 
    {
      scanint () ;
      page = curval ;
    } 
    pdfboxtype = 6 ;
    if ( scankeyword ( 66757L ) ) 
    pdfboxtype = 1 ;
    else if ( scankeyword ( 66758L ) ) 
    pdfboxtype = 2 ;
    else if ( scankeyword ( 66759L ) ) 
    pdfboxtype = 3 ;
    else if ( scankeyword ( 66760L ) ) 
    pdfboxtype = 4 ;
    else if ( scankeyword ( 66761L ) ) 
    pdfboxtype = 5 ;
  } 
  if ( pdfboxtype == 6 ) 
  ...
  if ( result == 0 ) 
  {
    newwhatsit ( 42 , 9 + ( strlen ( picpath ) + sizeof ( memoryword ) - 1 ) / 
    sizeof ( memoryword ) ) ;
    if ( ispdf ) 
    {
      mem [curlist .tailfield ].hh.b1 = 43 ;
    } 
...
doextension ( void ) 
{
  ...
  case 5 : 
    ...
    reportillegalcase () ;
      ...
      mem [curlist .tailfield + 1 ].hh.b0 = normmin ( eqtb [8938791L ]
      .cint ) ;
      mem [curlist .tailfield + 1 ].hh.b1 = normmin ( eqtb [8938792L ]
      .cint ) ;
    } 
    break ;
  case 41 : 
  ...
  case 43 : 
	...
	fontarea [eqtb [2253299L ].hh .v.RH ]== 65534L ) ) ) 
	{
	  ...
	  mem [curlist .tailfield + 4 ].qqqq .b1 = eqtb [2253299L ].hh 
	  .v.RH ;
	  mem [curlist .tailfield + 4 ].qqqq .b2 = curval ;
	  setnativeglyphmetrics ( curlist .tailfield , ( eqtb [8938814L ]
	  .cint > 0 ) ) ;
	} 
	else notnativefonterror ( 59 , 43 , eqtb [2253299L ].hh .v.RH ) ;
      } 
    } 
    break ;
  case 44 : 
  ...
  case 45 : 
    {
      scanandpackname () ;
      i = getencodingmodeandinfo ( addressof ( j ) ) ;
      eqtb [8938817L ].cint = i ;
      eqtb [8938818L ].cint = j ;
    } 
    break ;
  case 46 : 
    {
      scanfilename () ;
      if ( length ( curname ) == 0 ) 
      eqtb [8938808L ].cint = 0 ;
      else eqtb [8938808L ].cint = curname ;
    } 
    break ;
  case 6 : 
    {
...
fixlanguage ( void ) 
{
  ...
  l = 0 ;
  else l = eqtb [8938790L ].cint ;
  if ( l != curlist .auxfield .hh .v.RH ) 
  {
    newwhatsit ( 4 , 2 ) ;
    mem [curlist .tailfield + 1 ].hh .v.RH = l ;
    curlist .auxfield .hh .v.RH = l ;
    mem [curlist .tailfield + 1 ].hh.b0 = normmin ( eqtb [8938791L ].cint 
    ) ;
    mem [curlist .tailfield + 1 ].hh.b1 = normmin ( eqtb [8938792L ].cint 
    ) ;
  } 
} 
void 
...
handlerightbrace ( void ) 
{
  ...
  case 11 : 
    {
      endgraf () ;
      q = eqtb [2252250L ].hh .v.RH ;
      incr ( mem [q ].hh .v.RH ) ;
      d = eqtb [10053195L ].cint ;
      f = eqtb [8938782L ].cint ;
      unsave () ;
      saveptr = saveptr - 2 ;
...
maincontrol ( void ) 
{
  ...
  maincontrol_regmem 
  integer t  ;
  if ( eqtb [2252778L ].hh .v.RH != -268435455L ) 
  begintokenlist ( eqtb [2252778L ].hh .v.RH , 13 ) ;
  lab60: getxtoken () ;
  ...
  case 169 : 
	...
	if ( ( eqtb [8938815L ].cint > 0 ) && ( spaceclass != 256 ) && ( 
	prevclass != 255 ) ) 
	{
	  prevclass = 255 ;
	...
	if ( curchr > 0 ) 
	{
	  if ( eTeXenabled ( ( eqtb [8938811L ].cint > 0 ) , curcmd , curchr 
	  ) ) 
	  {
	...
	break ;
      ...
      case 219 : 
      case 275 : 
	setmathchar ( eqtb [6710516L + curchr ].hh .v.RH ) ;
	break ;
      case 223 : 
	{
	  scancharnum () ;
  ...
  prevclass = 255 ;
  if ( ( ( fontarea [eqtb [2253299L ].hh .v.RH ]== 65535L ) || ( fontarea 
  [eqtb [2253299L ].hh .v.RH ]== 65534L ) ) ) 
  {
    if ( curlist .modefield > 0 ) {
	
      if ( eqtb [8938790L ].cint != curlist .auxfield .hh .v.RH ) 
      fixlanguage () ;
    } 
    mainh = 0 ;
    mainf = eqtb [2253299L ].hh .v.RH ;
    nativelen = 0 ;
    lab71: mains = eqtb [5596404L + curchr ].hh .v.RH % 65536L ;
    if ( mains == 1000 ) 
    curlist .auxfield .hh .v.LH = 1000 ;
    else if ( mains < 1000 ) 
    {
    ...
    curptr = -268435455L ;
    spaceclass = eqtb [5596404L + curchr ].hh .v.RH / 65536L ;
    if ( ( eqtb [8938815L ].cint > 0 ) && spaceclass != 256 ) 
    {
      if ( prevclass == 255 ) 
      {
	...
	{
	  findsaelement ( 6 , 255 * 256 + spaceclass , false ) ;
	  if ( curptr != -268435455L ) 
	  {
	    if ( curcmd != 11 ) 
	    curcmd = 12 ;
	...
	findsaelement ( 6 , prevclass * 256 + spaceclass , false ) ;
	if ( curptr != -268435455L ) 
	{
	  if ( curcmd != 11 ) 
	  curcmd = 12 ;
    ...
    ishyph = ( curchr == hyphenchar [mainf ]) || ( ( eqtb [8938812L ].cint 
      ...
      <= for_end) do 
	{
	  ...
	  mainf ]) || ( ( eqtb [8938812L ].cint > 0 ) && ( ( mappedtext [
    ...
    if ( curlist .modefield == 104 ) 
    {
      ...
      if ( mainppp != mainpp ) 
      while ( ( mem [mainppp ].hh .v.RH != mainpp ) ) {
	  
	if ( ( ! ( mainppp >= himemmin ) ) && ( mem [mainppp == 7 ].hh.b0 ) 
	) 
	{
	  tempptr = mainppp ;
	...
	&& ( mem [mainpp + 4 ].qqqq .b1 == mainf ) && ( mainppp != mainpp ) 
	&& ( ! ( mainppp >= himemmin ) ) && ( mem [mainppp ].hh.b0 != 7 ) ) 
	{
	  ...
	  hyphenchar [mainf ]) && ( ( ! ( eqtb [8938812L ].cint > 0 ) ) || 
  ...
  mains = eqtb [5596404L + curchr ].hh .v.RH % 65536L ;
  if ( mains == 1000 ) 
  curlist .auxfield .hh .v.LH = 1000 ;
  else if ( mains < 1000 ) 
  {
  ...
  ligstack = -268435455L ;
  goto lab110 ;
  lab101: mains = eqtb [5596404L + curchr ].hh .v.RH % 65536L ;
  if ( mains == 1000 ) 
  curlist .auxfield .hh .v.LH = 1000 ;
  else if ( mains < 1000 ) 
  {
  ...
  goto lab110 ;
  lab120: if ( ( eqtb [8938815L ].cint > 0 ) && ( spaceclass != 256 ) && ( 
  prevclass != 255 ) ) 
  {
    prevclass = 255 ;
    findsaelement ( 6 , spaceclass * 256 + 255 , false ) ;
...
{
  giveerrhelp_regmem 
  tokenshow ( eqtb [2252780L ].hh .v.RH ) ;
} 
boolean 
openfmtfile ( void ) 
{
