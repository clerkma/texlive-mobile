...
initialize ( void ) 
{
  ...
  pagesofar [7 ]= 0 ;
  pagemaxdepth = 0 ;
  {register integer for_end; k = 27177 ;for_end = 28082 ; if ( k <= for_end) 
  do 
    xeqlevel [k ]= 1 ;
  while ( k++ < for_end ) ;} 
  ...
  if ( iniversion ) 
  {
    ...
    while ( k++ < for_end ) ;} 
    {register integer for_end; k = 27177 ;for_end = 27536 ; if ( k <= 
    for_end) do 
      eqtb [k ].cint = 0 ;
    while ( k++ < for_end ) ;} 
    eqtb [27232 ].cint = 256 ;
    ...
    while ( k++ < for_end ) ;} 
    eqtb [27583 ].cint = 0 ;
    {register integer for_end; k = 27793 ;for_end = 28082 ; if ( k <= 
    for_end) do 
      eqtb [k ].cint = 0 ;
    while ( k++ < for_end ) ;} 
    primused = 2100 ;
    ...
    eqtb [15525 ].hh.b1 = 1 ;
    hash [15525 ].v.RH = 575 ;
    eqtb [27814 ].cint = ( onehundredinch + 50 ) / 100 ;
    ...
    eqtb [27254 ].cint = 1 ;
    eqtb [27255 ].cint = 0 ;
    eqtb [27826 ].cint = onebp ;
    eqtb [27264 ].cint = 0 ;
    eqtb [27825 ].cint = -65536000L ;
    eqtb [27823 ].cint = eqtb [27825 ].cint ;
    eqtb [27824 ].cint = eqtb [27825 ].cint ;
    eqtb [27821 ].cint = eqtb [27825 ].cint ;
    eqtb [27822 ].cint = eqtb [27825 ].cint ;
    ...
    trieopptr = 0 ;
    trienotready = true ;
    hash [15514 ].v.RH = 1600 ;
    if ( iniversion ) 
    formatident = 1687 ;
    hash [15522 ].v.RH = 1899 ;
    eqtb [15522 ].hh.b1 = 1 ;
...
znewtrieop ( smallnumber d , smallnumber n , trieopcode v ) 
{
  ...
  while ( true ) {
    ...
    if ( l == 0 ) 
    {
      ...
      overflow ( 1352 , trieopsize ) ;
      u = trieused [curlang ];
      if ( u == maxtrieop ) 
      overflow ( 1353 , maxtrieop - mintrieop ) ;
      incr ( trieopptr ) ;
      incr ( u ) ;
      trieused [curlang ]= u ;
      if ( u > maxopused ) 
...
zlinebreak ( boolean d ) 
{
  ...
  if ( eqtb [25058 ].hh .v.RH == -268435455L ) {
    ...
    if ( eqtb [27810 ].cint == 0 ) 
    {
      ...
      {
	firstwidth = eqtb [27796 ].cint - abs ( eqtb [27810 ].cint ) ;
	if ( eqtb [27810 ].cint >= 0 ) 
	firstindent = eqtb [27810 ].cint ;
	else firstindent = 0 ;
	secondwidth = eqtb [27796 ].cint ;
	secondindent = 0 ;
      } 
	...
	firstwidth = eqtb [27796 ].cint ;
	firstindent = 0 ;
	secondwidth = eqtb [27796 ].cint - abs ( eqtb [27810 ].cint ) ;
	if ( eqtb [27810 ].cint >= 0 ) 
	secondindent = eqtb [27810 ].cint ;
	else secondindent = 0 ;
      } 
    } 
  } 
  ...
  while ( true ) {
	...
	;
      ...
      printnl ( 1338 ) ;
#endif /* STAT */
      background [2 ]= background [2 ]+ eqtb [27813 ].cint ;
      finalpass = true ;
    } 
  } 
  lab30: 
...
prefixedcommand ( void ) 
{
  ...
  case 95 : 
	...
	default: 
	{
	  ...
	  {case 2 : 
	    if ( ( a >= 4 ) ) 
	    geqdefine ( p , 73 , 27281 + curval ) ;
	    else eqdefine ( p , 73 , 27281 + curval ) ;
	    break ;
	  case 3 : 
	    if ( ( a >= 4 ) ) 
	    geqdefine ( p , 74 , 27827 + curval ) ;
	    else eqdefine ( p , 74 , 27827 + curval ) ;
	    break ;
	  case 4 : 
	    if ( ( a >= 4 ) ) 
...
storefmtfile ( void ) 
{
  ...
  packjobname ( 939 ) ;
  while ( ! wopenout ( fmtfile ) ) promptfilename ( 1708 , 939 ) ;
  printnl ( 1709 ) ;
  ...
  if ( hashhigh > 0 ) 
  dumpthings ( eqtb [28083 ], hashhigh ) ;
  dumpint ( parloc ) ;
  dumpint ( writeloc ) ;
  ...
  if ( hashhigh > 0 ) 
  dumpthings ( hash [28083 ], hashhigh ) ;
  dumpint ( cscount ) ;
  println () ;
  printint ( cscount ) ;
  print ( 1692 ) ;
...
loadfmtfile ( void ) 
{
  ...
  eqtb [24527 ].hh .v.RH = -268435455L ;
  eqtb [24527 ].hh.b1 = 0 ;
  {register integer for_end; x = 28083 ;for_end = eqtbtop ; if ( x <= 
  for_end) do 
    eqtb [x ]= eqtb [24527 ];
  while ( x++ < for_end ) ;} 
  {
  ...
  if ( hashhigh > 0 ) 
  undumpthings ( eqtb [28083 ], hashhigh ) ;
  {
    undumpint ( x ) ;
    if ( ( x < 514 ) || ( x > hashtop ) ) 
    goto lab6666 ;
  ...
  if ( hashhigh > 0 ) 
  {
    undumpthings ( hash [28083 ], hashhigh ) ;
    if ( debugformatfile ) 
    {
      printcsnames ( 28083 , hashhigh - ( 28083 ) ) ;
    } 
  } 
  undumpint ( cscount ) ;
  {
...
initprim ( void ) 
{
  ...
  primitive ( 722 , 112 , 3 ) ;
  primitive ( 723 , 112 , 4 ) ;
  primitive ( 535 , 89 , membot + 0 ) ;
  primitive ( 572 , 89 , membot + 1 ) ;
  primitive ( 412 , 89 , membot + 2 ) ;
  primitive ( 413 , 89 , membot + 3 ) ;
  primitive ( 756 , 79 , 104 ) ;
  primitive ( 757 , 79 , 1 ) ;
  primitive ( 758 , 82 , 0 ) ;
  primitive ( 759 , 82 , 1 ) ;
  primitive ( 760 , 83 , 1 ) ;
  ...
  primitive ( 847 , 110 , 8 ) ;
  primitive ( 848 , 110 , 9 ) ;
  primitive ( 849 , 110 , 10 ) ;
  primitive ( 850 , 110 , 11 ) ;
  primitive ( 851 , 110 , 15 ) ;
  primitive ( 852 , 110 , 16 ) ;
  primitive ( 853 , 110 , 12 ) ;
  primitive ( 854 , 110 , 13 ) ;
  primitive ( 855 , 110 , 14 ) ;
  primitive ( 856 , 110 , 19 ) ;
  primitive ( 857 , 110 , 20 ) ;
  primitive ( 858 , 110 , 21 ) ;
  primitive ( 859 , 110 , 22 ) ;
  primitive ( 860 , 110 , 23 ) ;
  primitive ( 861 , 110 , 24 ) ;
  primitive ( 862 , 110 , 25 ) ;
  primitive ( 863 , 110 , 26 ) ;
  primitive ( 864 , 110 , 27 ) ;
  primitive ( 865 , 110 , 17 ) ;
  primitive ( 866 , 110 , 18 ) ;
  primitive ( 867 , 110 , 28 ) ;
  primitive ( 868 , 110 , 29 ) ;
  primitive ( 869 , 110 , 32 ) ;
  primitive ( 870 , 110 , 30 ) ;
  primitive ( 871 , 110 , 31 ) ;
  primitive ( 910 , 107 , 0 ) ;
  primitive ( 911 , 107 , 1 ) ;
  primitive ( 912 , 107 , 2 ) ;
  primitive ( 913 , 107 , 3 ) ;
  ...
  primitive ( 1297 , 4 , 256 ) ;
  primitive ( 1298 , 5 , 257 ) ;
  hash [15515 ].v.RH = 1298 ;
  eqtb [15515 ]= eqtb [curval ];
  primitive ( 1299 , 5 , 258 ) ;
  hash [15519 ].v.RH = 1300 ;
  hash [15520 ].v.RH = 1300 ;
  eqtb [15520 ].hh.b0 = 9 ;
  ...
  primitive ( 1462 , 20 , 4 ) ;
  primitive ( 1372 , 20 , 5 ) ;
  primitive ( 1463 , 20 , 108 ) ;
  primitive ( 1464 , 31 , 99 ) ;
  primitive ( 1465 , 31 , 100 ) ;
  primitive ( 1466 , 31 , 101 ) ;
  primitive ( 1467 , 31 , 102 ) ;
  primitive ( 1483 , 43 , 1 ) ;
  primitive ( 1484 , 43 , 0 ) ;
  primitive ( 1485 , 43 , 2 ) ;
  primitive ( 1495 , 25 , 12 ) ;
  primitive ( 1496 , 25 , 11 ) ;
  primitive ( 1497 , 25 , 10 ) ;
  primitive ( 1498 , 23 , 0 ) ;
  primitive ( 1499 , 23 , 1 ) ;
  primitive ( 1500 , 24 , 0 ) ;
  primitive ( 1501 , 24 , 1 ) ;
  ...
  primitive ( 1533 , 48 , 0 ) ;
  primitive ( 1534 , 48 , 1 ) ;
  primitive ( 1264 , 50 , 16 ) ;
  primitive ( 1265 , 50 , 17 ) ;
  primitive ( 1266 , 50 , 18 ) ;
  primitive ( 1267 , 50 , 19 ) ;
  primitive ( 1268 , 50 , 20 ) ;
  primitive ( 1269 , 50 , 21 ) ;
  primitive ( 1270 , 50 , 22 ) ;
  primitive ( 1271 , 50 , 23 ) ;
  primitive ( 1273 , 50 , 26 ) ;
  primitive ( 1272 , 50 , 27 ) ;
  primitive ( 1535 , 51 , 0 ) ;
  primitive ( 1277 , 51 , 1 ) ;
  primitive ( 1278 , 51 , 2 ) ;
  primitive ( 1259 , 53 , 0 ) ;
  ...
  primitive ( 1557 , 52 , 4 ) ;
  primitive ( 1558 , 52 , 5 ) ;
  primitive ( 1274 , 49 , 30 ) ;
  primitive ( 1275 , 49 , 31 ) ;
  hash [15517 ].v.RH = 1275 ;
  ...
  if ( enctexp ) 
  {
    primitive ( 1603 , 94 , 10 ) ;
    primitive ( 1604 , 94 , 11 ) ;
  } 
  primitive ( 1610 , 95 , 0 ) ;
  primitive ( 1611 , 95 , 1 ) ;
  primitive ( 1612 , 95 , 2 ) ;
  ...
  if ( enctexp ) 
  {
    primitive ( 1622 , 85 , 25590 ) ;
    primitive ( 1623 , 85 , 25591 ) ;
    primitive ( 1624 , 85 , 25592 ) ;
  } 
  primitive ( 439 , 85 , 26665 ) ;
  primitive ( 436 , 85 , 25897 ) ;
  primitive ( 437 , 85 , 26153 ) ;
  primitive ( 438 , 85 , 26409 ) ;
  primitive ( 536 , 85 , 27537 ) ;
  ...
  primitive ( 1647 , 78 , 8 ) ;
  primitive ( 1648 , 78 , 9 ) ;
  primitive ( 1649 , 78 , 10 ) ;
  primitive ( 1650 , 78 , 11 ) ;
  primitive ( 1651 , 78 , 6 ) ;
  primitive ( 274 , 100 , 0 ) ;
  primitive ( 275 , 100 , 1 ) ;
  primitive ( 276 , 100 , 2 ) ;
  primitive ( 1659 , 100 , 3 ) ;
  primitive ( 1660 , 60 , 1 ) ;
  primitive ( 1661 , 60 , 0 ) ;
  primitive ( 1662 , 58 , 0 ) ;
  primitive ( 1663 , 58 , 1 ) ;
  primitive ( 1669 , 57 , 25897 ) ;
  primitive ( 1670 , 57 , 26153 ) ;
  primitive ( 1671 , 19 , 0 ) ;
  primitive ( 1672 , 19 , 1 ) ;
  primitive ( 1673 , 19 , 2 ) ;
  primitive ( 1674 , 19 , 3 ) ;
  ...
  primitive ( 1722 , 59 , 2 ) ;
  primitive ( 1723 , 59 , 3 ) ;
  hash [15524 ].v.RH = 1723 ;
  eqtb [15524 ]= eqtb [curval ];
  primitive ( 1724 , 59 , 4 ) ;
  primitive ( 1725 , 59 , 5 ) ;
  primitive ( 1726 , 59 , 6 ) ;
  primitive ( 1126 , 59 , 38 ) ;
  primitive ( 1727 , 59 , 39 ) ;
  primitive ( 1728 , 59 , 40 ) ;
  primitive ( 1729 , 59 , 41 ) ;
  primitive ( 1730 , 59 , 7 ) ;
  primitive ( 1731 , 59 , 8 ) ;
  primitive ( 1732 , 59 , 9 ) ;
  primitive ( 1733 , 59 , 10 ) ;
  primitive ( 1734 , 59 , 11 ) ;
  primitive ( 1735 , 59 , 12 ) ;
  primitive ( 1736 , 59 , 13 ) ;
  primitive ( 1737 , 59 , 14 ) ;
  primitive ( 1738 , 59 , 15 ) ;
  primitive ( 1739 , 59 , 16 ) ;
  primitive ( 1740 , 59 , 17 ) ;
  primitive ( 1741 , 59 , 18 ) ;
  primitive ( 1742 , 59 , 19 ) ;
  primitive ( 1743 , 59 , 20 ) ;
  primitive ( 1744 , 59 , 21 ) ;
  primitive ( 1745 , 59 , 34 ) ;
  primitive ( 1746 , 59 , 35 ) ;
  primitive ( 1747 , 59 , 36 ) ;
  primitive ( 1748 , 59 , 22 ) ;
  primitive ( 1749 , 59 , 23 ) ;
  primitive ( 1750 , 59 , 24 ) ;
  primitive ( 1751 , 59 , 26 ) ;
  primitive ( 1752 , 59 , 25 ) ;
  primitive ( 1753 , 59 , 27 ) ;
  primitive ( 1754 , 59 , 28 ) ;
  primitive ( 1755 , 59 , 29 ) ;
  primitive ( 1756 , 59 , 30 ) ;
  primitive ( 1757 , 59 , 31 ) ;
  primitive ( 1758 , 59 , 33 ) ;
  primitive ( 1759 , 59 , 32 ) ;
  primitive ( 1760 , 59 , 37 ) ;
  primitive ( 1761 , 59 , 42 ) ;
  primitive ( 1762 , 59 , 43 ) ;
  primitive ( 1763 , 59 , 44 ) ;
  primitive ( 1764 , 59 , 45 ) ;
  primitive ( 2067 , 73 , 27280 ) ;
  nonewcontrolsequence = true ;
} 
#endif /* INITEX */
void 
mainbody ( void ) 
{
  ...
  fprintf ( stdout , "%s%s%s",  "This is pdfTeX, Version 3.14159265" , "-2.6" , "-1.40.16"   ) ;
  else
  fprintf ( stdout , "%s%s%s",  "This is pdfTeX, Version 3.14159265" , "-2.6" ,   "-1.40.16" ) ;
  ...
  outputfilename = 0 ;
  {
    ...
    == 1687 ) ) 
    {
      nonewcontrolsequence = false ;
      primitive ( 1957 , 70 , 3 ) ;
      primitive ( 1958 , 70 , 20 ) ;
      primitive ( 872 , 110 , 5 ) ;
      primitive ( 1960 , 72 , 25072 ) ;
      primitive ( 1961 , 73 , 27270 ) ;
      ...
      primitive ( 1984 , 70 , 21 ) ;
      primitive ( 1985 , 70 , 22 ) ;
      primitive ( 1986 , 70 , 23 ) ;
      primitive ( 1987 , 70 , 24 ) ;
      primitive ( 1988 , 70 , 25 ) ;
      primitive ( 1989 , 70 , 28 ) ;
      primitive ( 1990 , 70 , 29 ) ;
      primitive ( 1991 , 70 , 30 ) ;
      primitive ( 1992 , 70 , 31 ) ;
      primitive ( 1993 , 70 , 32 ) ;
      primitive ( 1994 , 70 , 33 ) ;
      primitive ( 1995 , 70 , 34 ) ;
      primitive ( 1996 , 19 , 4 ) ;
      primitive ( 1998 , 19 , 5 ) ;
      primitive ( 1999 , 111 , 1 ) ;
      primitive ( 2000 , 111 , 5 ) ;
      primitive ( 2001 , 19 , 6 ) ;
      primitive ( 2005 , 82 , 2 ) ;
      primitive ( 1276 , 49 , 1 ) ;
      primitive ( 2009 , 73 , 27279 ) ;
      primitive ( 2010 , 33 , 6 ) ;
      primitive ( 2011 , 33 , 7 ) ;
      primitive ( 2012 , 33 , 10 ) ;
      primitive ( 2013 , 33 , 11 ) ;
      primitive ( 2022 , 106 , 2 ) ;
      primitive ( 2024 , 96 , 1 ) ;
      primitive ( 928 , 104 , 1 ) ;
      primitive ( 2025 , 107 , 17 ) ;
      primitive ( 2026 , 107 , 18 ) ;
      primitive ( 2027 , 107 , 19 ) ;
      primitive ( 2028 , 107 , 20 ) ;
      primitive ( 2029 , 107 , 22 ) ;
      primitive ( 2030 , 107 , 23 ) ;
      primitive ( 1592 , 93 , 8 ) ;
      primitive ( 2036 , 70 , 39 ) ;
      primitive ( 2037 , 70 , 40 ) ;
      primitive ( 2038 , 70 , 41 ) ;
      primitive ( 2039 , 70 , 42 ) ;
      primitive ( 2043 , 70 , 26 ) ;
      primitive ( 2044 , 70 , 27 ) ;
      primitive ( 2045 , 70 , 35 ) ;
      primitive ( 2046 , 70 , 36 ) ;
      primitive ( 2047 , 70 , 37 ) ;
      primitive ( 2048 , 70 , 38 ) ;
      primitive ( 2049 , 18 , 5 ) ;
      primitive ( 2050 , 112 , 5 ) ;
      primitive ( 2051 , 112 , 6 ) ;
      primitive ( 2052 , 112 , 7 ) ;
      primitive ( 2053 , 112 , 8 ) ;
      primitive ( 2054 , 112 , 9 ) ;
      primitive ( 2058 , 24 , 2 ) ;
      primitive ( 2059 , 24 , 3 ) ;
      primitive ( 2060 , 84 , 25329 ) ;
      primitive ( 2061 , 84 , 25330 ) ;
      primitive ( 2062 , 84 , 25331 ) ;
    ...
    magicoffset = strstart [1291 ]- 9 * 16 ;
    if ( interaction == 0 ) 
    selector = 16 ;
    else selector = 17 ;
