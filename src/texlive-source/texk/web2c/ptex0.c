...
zprintcs ( integer p ) 
{
  ...
  else if ( ( ( p >= 24526 ) && ( p <= 29312 ) ) || ( p > eqtbtop ) ) 
  printesc ( 537 ) ;
...
zshownodelist ( integer p ) 
{
  ...
  while ( p > memmin ) {
	...
	break ;
      case 1 : 
	{
	  printwritewhatsit ( 627 , p ) ;
	  printmark ( mem [p + 1 ].hh .v.RH ) ;
	} 
	break ;
      case 2 : 
	printwritewhatsit ( 1364 , p ) ;
	break ;
      case 3 : 
	{
	  printesc ( 1365 ) ;
	...
	if ( memtop - 2 != pagetail ) 
	{
	  ...
	  if ( pagecontents > 0 ) 
	  {
	    ...
	    while ( r != memtop ) {
	      ...
	      printint ( t ) ;
	      print ( 1035 ) ;
	      if ( eqtb [28266 + t ].cint == 1000 ) 
	      t = mem [r + 3 ].cint ;
	      else t = xovern ( mem [r + 3 ].cint , 1000 ) * eqtb [28266 + 
	      t ].cint ;
	      printscaled ( t ) ;
	      if ( mem [r ].hh.b0 == 1 ) 
	      {
...
zprintcmdchr ( quarterword cmd , halfword chrcode ) 
{
  ...
  case 78 : 
    ...
    printparam ( chrcode - 28205 ) ;
      ...
      printesc ( 504 ) ;
      printint ( chrcode - 28266 ) ;
    } 
    break ;
  case 79 : 
    if ( chrcode < 28801 ) 
    printlengthparam ( chrcode - 28778 ) ;
    else {
	
      printesc ( 530 ) ;
      printint ( chrcode - 28801 ) ;
    } 
    break ;
  case 48 : 
    printesc ( 539 ) ;
...
zshoweqtb ( halfword n ) 
{
  ...
  if ( n < 1 ) 
  printchar ( 63 ) ;
  else if ( ( n < 24527 ) || ( ( n > 29312 ) && ( n <= eqtbtop ) ) ) 
  {
    sprintcs ( n ) ;
    printchar ( 61 ) ;
  ...
  case 99 : 
    {
      ...
      switch ( m ) 
      {case 0 : 
	curval = eqtb [28266 + curval ].cint ;
	break ;
      case 1 : 
	curval = eqtb [28801 + curval ].cint ;
	break ;
      case 2 : 
...
zscandimen ( boolean mu , boolean inf , boolean shortcut ) 
{
  ...
  else if ( scankeyword ( 745 ) ) 
  v = ( fontinfo [5 + parambase [eqtb [25582 ].hh .v.RH ]].cint ) ;
  else if ( scankeyword ( 746 ) ) {
  ...
  else if ( scankeyword ( 754 ) ) 
  {
    num = 12 ;
    denom = 1 ;
  } 
  else if ( scankeyword ( 755 ) ) 
  {
    num = 7227 ;
    denom = 254 ;
  } 
  else if ( scankeyword ( 756 ) ) 
  {
    num = 7227 ;
    denom = 2540 ;
  } 
...
openlogfile ( void ) 
{
  ...
  logopened = true ;
  {
    ...
    fprintf ( logfile , "%s%s",  "This is pTeX, Version 3.14159265" , "-p3.7" ) ;
    else
    fprintf ( logfile , "%s%s",  "This is pTeX, Version 3.14159265" , "-p3.7" ) ;
    Fputs ( logfile ,  " (" ) ;
...
zeffectivechar ( boolean errp , internalfontnumber f , quarterword c ) 
{
  ...
  if ( c >= eqtb [28262 ].cint ) {
      
    if ( c <= eqtb [28263 ].cint ) {
...
zoutwhat ( halfword p ) 
{
  ...
  case 2 : 
	...
	else if ( j < 16 ) 
	{
	  ...
	  aopenout ( writefile [j ]) ) promptfilename ( 1386 , 838 ) ;
	  writeopen [j ]= true ;
	  if ( logopened ) 
	  {
	    oldsetting = selector ;
...
zshipout ( halfword p ) 
{
  ...
  synctexsheet ( eqtb [28222 ].cint ) ;
  {
    ...
    printchar ( 91 ) ;
    j = 9 ;
    while ( ( eqtb [28266 + j ].cint == 0 ) && ( j > 0 ) ) decr ( j ) ;
    {register integer for_end; k = 0 ;for_end = j ; if ( k <= for_end) do 
      {
	printint ( eqtb [28266 + k ].cint ) ;
	if ( k < j ) 
	printchar ( 46 ) ;
      } 
    while ( k++ < for_end ) ;} 
    ...
    28797 ].cint > 1073741823L ) || ( mem [p + 1 ].cint + eqtb [28796 ]
    .cint > 1073741823L ) ) 
    {
      {
	if ( interaction == 3 ) 
    ...
    if ( mem [p + 3 ].cint + mem [p + 2 ].cint + eqtb [28797 ].cint > 
    maxv ) 
    maxv = mem [p + 3 ].cint + mem [p + 2 ].cint + eqtb [28797 ].cint ;
    if ( mem [p + 1 ].cint + eqtb [28796 ].cint > maxh ) 
    maxh = mem [p + 1 ].cint + eqtb [28796 ].cint ;
    dvih = 0 ;
    dviv = 0 ;
    curh = eqtb [28796 ].cint ;
    dvif = 0 ;
    dvidir = 4 ;
    curdirhv = dvidir ;
    if ( outputfilename == 0 ) 
    {
      ...
      openlogfile () ;
      packjobname ( 842 ) ;
      while ( ! bopenout ( dvifile ) ) promptfilename ( 843 , 842 ) ;
    ...
    {register integer for_end; k = 0 ;for_end = 9 ; if ( k <= for_end) do 
      dvifour ( eqtb [28266 + k ].cint ) ;
    while ( k++ < for_end ) ;} 
    dvifour ( lastbop ) ;
    lastbop = pageloc ;
    curv = mem [p + 3 ].cint + eqtb [28797 ].cint ;
    tempptr = p ;
    switch ( mem [p ].hh.b0 ) 
    {case 0 : 
      hlistout () ;
...
zhpack ( halfword p , scaled w , smallnumber m ) 
{
  ...
  else if ( x > 0 ) 
  {
    ...
    ].hh .v.RH != -268435455L ) ) 
    {
      ...
      mem [r + 6 ].gr = 1.0 ;
      if ( ( - (integer) x - totalshrink [0 ]> eqtb [28786 ].cint ) || ( 
      eqtb [28231 ].cint < 100 ) ) 
      {
	if ( ( eqtb [28794 ].cint > 0 ) && ( - (integer) x - totalshrink [0 
	]> eqtb [28786 ].cint ) ) 
	{
	  while ( mem [q ].hh .v.RH != -268435455L ) q = mem [q ].hh .v.RH 
	  ;
	  mem [q ].hh .v.RH = newrule () ;
	  mem [mem [q ].hh .v.RH + 1 ].cint = eqtb [28794 ].cint ;
	} 
	println () ;
	printnl ( 902 ) ;
...
zvpackage ( halfword p , scaled h , smallnumber m , scaled l ) 
{
  ...
  else if ( x > 0 ) 
  {
    ...
    ].hh .v.RH != -268435455L ) ) 
    {
      lastbadness = 1000000L ;
      mem [r + 6 ].gr = 1.0 ;
      if ( ( - (integer) x - totalshrink [0 ]> eqtb [28787 ].cint ) || ( 
      eqtb [28232 ].cint < 100 ) ) 
      {
	println () ;
	printnl ( 907 ) ;
...
zmakescripts ( halfword q , scaled delta ) 
{
  ...
  if ( mem [q + 2 ].hh .v.RH == 0 ) 
  {
    ...
    mem [x + 1 ].cint = mem [x + 1 ].cint + eqtb [28790 ].cint ;
    ...
    mem [x + 4 ].cint = - (integer) shiftup ;
      ...
      .v.LH ) ;
      mem [y + 1 ].cint = mem [y + 1 ].cint + eqtb [28790 ].cint ;
...
zmakeleftright ( halfword q , smallnumber style , scaled maxd , scaled maxh ) 
{
  ...
  delta2 = delta1 + delta1 - eqtb [28788 ].cint ;
  if ( delta < delta2 ) 
  delta = delta2 ;
...
zvsplit ( eightbits n , scaled h ) 
{
  ...
  q = vertbreak ( mem [v + 5 ].hh .v.RH , h , eqtb [28784 ].cint ) ;
  p = mem [v + 5 ].hh .v.RH ;
  if ( p == q ) 
  ...
  q = vpackage ( p , h , 0 , eqtb [28784 ].cint ) ;
...
zfreezepagespecs ( smallnumber s ) 
{
  ...
  pagecontents = s ;
  pagesofar [0 ]= eqtb [28782 ].cint ;
  pagemaxdepth = eqtb [28783 ].cint ;
  pagesofar [7 ]= 0 ;
  pagesofar [1 ]= 0 ;
  pagesofar [2 ]= 0 ;
  pagesofar [3 ]= 0 ;
...
zfireup ( halfword c ) 
{
  ...
  savevfuzz = eqtb [28787 ].cint ;
  eqtb [28787 ].cint = 1073741823L ;
...
buildpage ( void ) 
{
  ...
  do {
	...
	if ( mem [r ].hh.b1 != n ) 
	{
	  ...
	  if ( eqtb [28266 + n ].cint == 1000 ) 
	  h = mem [r + 3 ].cint ;
	  else h = xovern ( mem [r + 3 ].cint , 1000 ) * eqtb [28266 + n ]
	  .cint ;
	...
	insertpenalties = insertpenalties + mem [p + 1 ].cint ;
	  ...
	  if ( eqtb [28266 + n ].cint == 1000 ) 
	  h = mem [p + 3 ].cint ;
	  else h = xovern ( mem [p + 3 ].cint , 1000 ) * eqtb [28266 + n ]
	  .cint ;
	  if ( ( ( h <= 0 ) || ( h <= delta ) ) && ( mem [p + 3 ].cint + mem 
	  [r + 3 ].cint <= eqtb [28801 + n ].cint ) ) 
	  {
	    ...
	    if ( eqtb [28266 + n ].cint <= 0 ) 
	    w = 1073741823L ;
	    else {
		
	      w = pagesofar [0 ]- pagesofar [1 ]- pagesofar [7 ];
	      if ( eqtb [28266 + n ].cint != 1000 ) 
	      w = xovern ( w , eqtb [28266 + n ].cint ) * 1000 ;
	    } 
	    if ( w > eqtb [28801 + n ].cint - mem [r + 3 ].cint ) 
	    w = eqtb [28801 + n ].cint - mem [r + 3 ].cint ;
...
normalparagraph ( void ) 
{
  ...
  if ( eqtb [28795 ].cint != 0 ) 
  eqworddefine ( 28795 , 0 ) ;
...
znewgraf ( boolean indented ) 
{
  ...
  if ( indented ) 
  {
    ...
    mem [curlist .tailfield + 1 ].cint = eqtb [28778 ].cint ;
...
makeaccent ( void ) 
{
  ...
  if ( p != -268435455L ) 
  {
    ...
    if ( curlist .dirfield == 3 ) 
    {
      ...
      disp = eqtb [28799 ].cint - eqtb [28800 ].cint ;
      else disp = eqtb [28799 ].cint ;
    } 
    else {
      ...
      disp = eqtb [28800 ].cint - eqtb [28799 ].cint ;
      else disp = eqtb [28800 ].cint ;
    } 
    {
      if ( ! ( curlist .tailfield >= himemmin ) && ( mem [curlist .tailfield 
      ].hh.b0 == 5 ) ) 
...
initmath ( void ) 
{
  ...
  if ( ( curcmd == 3 ) && ( curlist .modefield > 0 ) ) 
  {
    ...
    if ( eqtb [25060 ].hh .v.RH == -268435455L ) {
      ...
      if ( ( eqtb [28795 ].cint != 0 ) && ( ( ( eqtb [28246 ].cint >= 0 ) 
      && ( curlist .pgfield + 2 > eqtb [28246 ].cint ) ) || ( curlist 
      .pgfield + 1 < - (integer) eqtb [28246 ].cint ) ) ) 
      {
	l = eqtb [28781 ].cint - abs ( eqtb [28795 ].cint ) ;
	if ( eqtb [28795 ].cint > 0 ) 
	s = eqtb [28795 ].cint ;
	else s = 0 ;
      } 
    ...
    eqworddefine ( 28791 , w ) ;
    eqworddefine ( 28792 , l ) ;
    eqworddefine ( 28793 , s ) ;
...
aftermath ( void ) 
{
  ...
  if ( m < 0 ) 
  {
    ...
    {
      mem [curlist .tailfield ].hh .v.RH = newmath ( eqtb [28779 ].cint , 
      0 ) ;
      curlist .tailfield = mem [curlist .tailfield ].hh .v.RH ;
    } 
    curmlist = p ;
...
maincontrol ( void ) 
{
  ...
  */ maincontrol_regmem 
  ...
  lab130: if ( ( curlist .tailfield >= himemmin ) ) 
  {
	...
	{
	  {
	    mem [curlist .tailfield ].hh .v.RH = newpenalty ( eqtb [29057 + 
	    kp ].cint ) ;
	    curlist .tailfield = mem [curlist .tailfield ].hh .v.RH ;
	  } 
	  mem [curlist .tailfield ].hh.b1 = 2 ;
  ...
  if ( mainf != 0 ) 
  {
	...
	if ( eqtb [26659 + kp ].hh.b0 == 1 ) 
	{
	  ...
	  mem [curq + 1 ].cint = mem [curq + 1 ].cint + eqtb [29057 + kp 
	  ].cint ;
	  else {
	      
	    mainp = mem [curq ].hh .v.RH ;
	    mem [curq ].hh .v.RH = newpenalty ( eqtb [29057 + kp ].cint ) 
	    ;
  ...
  if ( ( curcmd == 16 ) || ( curcmd == 17 ) || ( curcmd == 18 ) ) 
  {
	...
	if ( kp != 1000 ) 
	{
	  ...
	  {
	    if ( ! ( curq >= himemmin ) && ( mem [curq ].hh.b0 == 14 ) ) 
	    mem [curq + 1 ].cint = mem [curq + 1 ].cint + eqtb [29057 + 
	    kp ].cint ;
	    else {
  ...
  if ( curcmd == 71 ) 
  {
	...
	cx = curl ;
	{
	  ...
	  if ( kp != 1000 ) 
	  {
		...
		mainp = mem [curq ].hh .v.RH ;
		mem [curq ].hh .v.RH = newpenalty ( eqtb [29057 + kp ]
		.cint ) ;
		mem [mem [curq ].hh .v.RH ].hh.b1 = 2 ;
		mem [mem [curq ].hh .v.RH ].hh .v.RH = mainp ;
	      } 
