...
static const char *poolfilearr[] = {
  ...
  "A right brace was mandatory here, so I've put one in.",
  ...
  "Copyright (C) 2002--2009 Aleph task force",
  "nullfont",
  "Font ",
  " scaled ",
  " not loadable: Bad metric (TFM/OFM) file",
  " not loadable: Metric (TFM/OFM) file name too long",
  " not loadable: Metric (TFM/OFM) file not found",
  ...
  "OCP file error (",
  "Translation process ",
  " not loadable: Bad ocp file",
  " not loadable: ocp file not found",
  "I wasn't able to read the data for this ocp,",
  "so I will ignore the ocp specification.",
  "I cant handle more than 65535 translation processes,",
  "opening file",
  ".ocp",
  ...
  "nullocplist",
  "warning: stack entry already empty",
  "Stack number too large",
  " : ",
  ", ",
  "Bad ocp list specification",
  "I was looking for a ocp list specification.",
  "Stack numbers must be between 0 and 4096 (exclusive)",
  "Missing ocp list identifier",
  "current meaning has been defined by \\ocplist.",
  "dvi length exceeds \"7FFFFFFF",
  "Aleph output, Version 3.14159265--1.15--2.1, ",
  "vlistout",
  ...
  "odelcode",
  "Invalid code (",
  "), should be at most \"FFFFFF \"FFFFFF",
  ...
  "Patterns can be loaded only by INIALEPH",
  "Invalid dimension assignment",
  "You tried to assign a character dimension.",
  "This is not allowed. Proceed; I'll ignore the assignment.",
  "hyphenchar",
  "skewchar",
  "FONT",
  "offset",
  "Illegal offset has been changed to 0",
  "The offset must be bigger than 0.",
  "naturaldir",
  "at",
  "scaled",
  "Improper `at' size (",
  ...
  "(\\dump is performed only by INIALEPH)",
  "debug # (-1 to exit):",
  "openout",
  "closeout",
  "special",
  ...
  "twobyteLE",
  "Invalid input mode",
  "Null ocp being used: all input lost",
  "(OTP invaded) buffer size",
  "bad OCP program -- PC not valid",
  "bad OCP program -- unknown instruction",
  "right hand side of OCP expression is bad",
  "bad OCP program -- table index not valid",
  "ocp",
  "externalocp",
  "ocplist",
  "pushocplist",
  ...
  "To use ocps, use the ",
  " primitive",
  "To use ocp lists, use the ",
  "To build ocp lists, use the ",
  "OCP",
  "OCPLIST",
  "New active ocp list: {",
