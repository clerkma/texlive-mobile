...
zprintcs ( integer p ) 
{
  ...
  else if ( ( ( p >= 24526 ) && ( p <= 29569 ) ) || ( p > eqtbtop ) ) 
  printesc ( 538 ) ;
...
zshownodelist ( integer p ) 
{
  ...
  while ( p > memmin ) {
	...
	break ;
      case 1 : 
	{
	  printwritewhatsit ( 629 , p ) ;
	  printmark ( mem [p + 1 ].hh .v.RH ) ;
	} 
	break ;
      case 2 : 
	printwritewhatsit ( 1368 , p ) ;
	break ;
      case 3 : 
	{
	  printesc ( 1369 ) ;
	...
	if ( memtop - 2 != pagetail ) 
	{
	  ...
	  if ( pagecontents > 0 ) 
	  {
	    ...
	    while ( r != memtop ) {
	      ...
	      printint ( t ) ;
	      print ( 1038 ) ;
	      if ( eqtb [28523 + t ].cint == 1000 ) 
	      t = mem [r + 3 ].cint ;
	      else t = xovern ( mem [r + 3 ].cint , 1000 ) * eqtb [28523 + 
	      t ].cint ;
	      printscaled ( t ) ;
	      if ( mem [r ].hh.b0 == 1 ) 
	      {
...
zprintcmdchr ( quarterword cmd , halfword chrcode ) 
{
  ...
  case 81 : 
    ...
    printparam ( chrcode - 28462 ) ;
      ...
      printesc ( 505 ) ;
      printint ( chrcode - 28523 ) ;
    } 
    break ;
  case 82 : 
    if ( chrcode < 29058 ) 
    printlengthparam ( chrcode - 29035 ) ;
    else {
	
      printesc ( 531 ) ;
      printint ( chrcode - 29058 ) ;
    } 
    break ;
  case 49 : 
    printesc ( 540 ) ;
...
zshoweqtb ( halfword n ) 
{
  ...
  if ( n < 1 ) 
  printchar ( 63 ) ;
  else if ( ( n < 24527 ) || ( ( n > 29569 ) && ( n <= eqtbtop ) ) ) 
  {
    sprintcs ( n ) ;
    printchar ( 61 ) ;
  ...
  case 102 : 
    {
      ...
      switch ( m ) 
      {case 0 : 
	curval = eqtb [28523 + curval ].cint ;
	break ;
      case 1 : 
	curval = eqtb [29058 + curval ].cint ;
	break ;
      case 2 : 
...
openlogfile ( void ) 
{
  ...
  logopened = true ;
  {
    ...
    fprintf ( logfile , "%s%s%s",  "This is upTeX, Version 3.14159265" , "-p3.7" , "-u1.20"     ) ;
    else
    fprintf ( logfile , "%s%s%s",  "This is upTeX, Version 3.14159265" , "-p3.7" ,     "-u1.20" ) ;
    Fputs ( logfile ,  " (" ) ;
...
zeffectivechar ( boolean errp , internalfontnumber f , quarterword c ) 
{
  ...
  if ( c >= eqtb [28519 ].cint ) {
      
    if ( c <= eqtb [28520 ].cint ) {
...
zoutwhat ( halfword p ) 
{
  ...
  case 2 : 
	...
	else if ( j < 16 ) 
	{
	  ...
	  aopenout ( writefile [j ]) ) promptfilename ( 1390 , 841 ) ;
	  writeopen [j ]= true ;
	  if ( logopened ) 
	  {
	    oldsetting = selector ;
...
zshipout ( halfword p ) 
{
  ...
  synctexsheet ( eqtb [28479 ].cint ) ;
  {
    ...
    printchar ( 91 ) ;
    j = 9 ;
    while ( ( eqtb [28523 + j ].cint == 0 ) && ( j > 0 ) ) decr ( j ) ;
    {register integer for_end; k = 0 ;for_end = j ; if ( k <= for_end) do 
      {
	printint ( eqtb [28523 + k ].cint ) ;
	if ( k < j ) 
	printchar ( 46 ) ;
      } 
    while ( k++ < for_end ) ;} 
    ...
    29054 ].cint > 1073741823L ) || ( mem [p + 1 ].cint + eqtb [29053 ]
    .cint > 1073741823L ) ) 
    {
      {
	if ( interaction == 3 ) 
    ...
    if ( mem [p + 3 ].cint + mem [p + 2 ].cint + eqtb [29054 ].cint > 
    maxv ) 
    maxv = mem [p + 3 ].cint + mem [p + 2 ].cint + eqtb [29054 ].cint ;
    if ( mem [p + 1 ].cint + eqtb [29053 ].cint > maxh ) 
    maxh = mem [p + 1 ].cint + eqtb [29053 ].cint ;
    dvih = 0 ;
    dviv = 0 ;
    curh = eqtb [29053 ].cint ;
    dvif = 0 ;
    dvidir = 4 ;
    curdirhv = dvidir ;
    if ( outputfilename == 0 ) 
    ...
    {register integer for_end; k = 0 ;for_end = 9 ; if ( k <= for_end) do 
      dvifour ( eqtb [28523 + k ].cint ) ;
    while ( k++ < for_end ) ;} 
    dvifour ( lastbop ) ;
    lastbop = pageloc ;
    curv = mem [p + 3 ].cint + eqtb [29054 ].cint ;
    tempptr = p ;
    switch ( mem [p ].hh.b0 ) 
    {case 0 : 
      hlistout () ;
...
zhpack ( halfword p , scaled w , smallnumber m ) 
{
  ...
  else if ( x > 0 ) 
  {
    ...
    ].hh .v.RH != -1073741823L ) ) 
    {
      ...
      mem [r + 6 ].gr = 1.0 ;
      if ( ( - (integer) x - totalshrink [0 ]> eqtb [29043 ].cint ) || ( 
      eqtb [28488 ].cint < 100 ) ) 
      {
	if ( ( eqtb [29051 ].cint > 0 ) && ( - (integer) x - totalshrink [0 
	]> eqtb [29043 ].cint ) ) 
	{
	  while ( mem [q ].hh .v.RH != -1073741823L ) q = mem [q ].hh 
	  .v.RH ;
	  mem [q ].hh .v.RH = newrule () ;
	  mem [mem [q ].hh .v.RH + 1 ].cint = eqtb [29051 ].cint ;
	} 
	println () ;
	printnl ( 905 ) ;
...
zvpackage ( halfword p , scaled h , smallnumber m , scaled l ) 
{
  ...
  else if ( x > 0 ) 
  {
    ...
    ].hh .v.RH != -1073741823L ) ) 
    {
      lastbadness = 1000000L ;
      mem [r + 6 ].gr = 1.0 ;
      if ( ( - (integer) x - totalshrink [0 ]> eqtb [29044 ].cint ) || ( 
      eqtb [28489 ].cint < 100 ) ) 
      {
	println () ;
	printnl ( 910 ) ;
...
zmakescripts ( halfword q , scaled delta ) 
{
  ...
  if ( mem [q + 2 ].hh .v.RH == 0 ) 
  {
    ...
    mem [x + 1 ].cint = mem [x + 1 ].cint + eqtb [29047 ].cint ;
    ...
    mem [x + 4 ].cint = - (integer) shiftup ;
      ...
      .v.LH ) ;
      mem [y + 1 ].cint = mem [y + 1 ].cint + eqtb [29047 ].cint ;
...
zmakeleftright ( halfword q , smallnumber style , scaled maxd , scaled maxh ) 
{
  ...
  delta2 = delta1 + delta1 - eqtb [29045 ].cint ;
  if ( delta < delta2 ) 
  delta = delta2 ;
...
zvsplit ( eightbits n , scaled h ) 
{
  ...
  q = vertbreak ( mem [v + 5 ].hh .v.RH , h , eqtb [29041 ].cint ) ;
  p = mem [v + 5 ].hh .v.RH ;
  if ( p == q ) 
  ...
  q = vpackage ( p , h , 0 , eqtb [29041 ].cint ) ;
...
zfreezepagespecs ( smallnumber s ) 
{
  ...
  pagecontents = s ;
  pagesofar [0 ]= eqtb [29039 ].cint ;
  pagemaxdepth = eqtb [29040 ].cint ;
  pagesofar [7 ]= 0 ;
  pagesofar [1 ]= 0 ;
  pagesofar [2 ]= 0 ;
  pagesofar [3 ]= 0 ;
...
zfireup ( halfword c ) 
{
  ...
  savevfuzz = eqtb [29044 ].cint ;
  eqtb [29044 ].cint = 1073741823L ;
...
buildpage ( void ) 
{
  ...
  do {
	...
	if ( mem [r ].hh.b1 != n ) 
	{
	  ...
	  if ( eqtb [28523 + n ].cint == 1000 ) 
	  h = mem [r + 3 ].cint ;
	  else h = xovern ( mem [r + 3 ].cint , 1000 ) * eqtb [28523 + n ]
	  .cint ;
	...
	insertpenalties = insertpenalties + mem [p + 1 ].cint ;
	  ...
	  if ( eqtb [28523 + n ].cint == 1000 ) 
	  h = mem [p + 3 ].cint ;
	  else h = xovern ( mem [p + 3 ].cint , 1000 ) * eqtb [28523 + n ]
	  .cint ;
	  if ( ( ( h <= 0 ) || ( h <= delta ) ) && ( mem [p + 3 ].cint + mem 
	  [r + 3 ].cint <= eqtb [29058 + n ].cint ) ) 
	  {
	    ...
	    if ( eqtb [28523 + n ].cint <= 0 ) 
	    w = 1073741823L ;
	    else {
		
	      w = pagesofar [0 ]- pagesofar [1 ]- pagesofar [7 ];
	      if ( eqtb [28523 + n ].cint != 1000 ) 
	      w = xovern ( w , eqtb [28523 + n ].cint ) * 1000 ;
	    } 
	    if ( w > eqtb [29058 + n ].cint - mem [r + 3 ].cint ) 
	    w = eqtb [29058 + n ].cint - mem [r + 3 ].cint ;
...
znewgraf ( boolean indented ) 
{
  ...
  if ( indented ) 
  {
    ...
    mem [curlist .tailfield + 1 ].cint = eqtb [29035 ].cint ;
...
makeaccent ( void ) 
{
  ...
  if ( p != -1073741823L ) 
  {
    ...
    if ( curlist .dirfield == 3 ) 
    {
      ...
      disp = eqtb [29056 ].cint - eqtb [29057 ].cint ;
      else disp = eqtb [29056 ].cint ;
    } 
    else {
      ...
      disp = eqtb [29057 ].cint - eqtb [29056 ].cint ;
      else disp = eqtb [29057 ].cint ;
    } 
    {
      if ( ! ( curlist .tailfield >= himemmin ) && ( mem [curlist .tailfield 
      ].hh.b0 == 5 ) ) 
...
initmath ( void ) 
{
  ...
  if ( ( curcmd == 3 ) && ( curlist .modefield > 0 ) ) 
  {
    ...
    if ( eqtb [25060 ].hh .v.RH == -1073741823L ) {
      ...
      if ( ( eqtb [29052 ].cint != 0 ) && ( ( ( eqtb [28503 ].cint >= 0 ) 
      && ( curlist .pgfield + 2 > eqtb [28503 ].cint ) ) || ( curlist 
      .pgfield + 1 < - (integer) eqtb [28503 ].cint ) ) ) 
      {
	l = eqtb [29038 ].cint - abs ( eqtb [29052 ].cint ) ;
	if ( eqtb [29052 ].cint > 0 ) 
	s = eqtb [29052 ].cint ;
	else s = 0 ;
      } 
    ...
    eqworddefine ( 29048 , w ) ;
    eqworddefine ( 29049 , l ) ;
    eqworddefine ( 29050 , s ) ;
...
aftermath ( void ) 
{
  ...
  if ( m < 0 ) 
  {
    ...
    {
      mem [curlist .tailfield ].hh .v.RH = newmath ( eqtb [29036 ].cint , 
      0 ) ;
      curlist .tailfield = mem [curlist .tailfield ].hh .v.RH ;
    } 
    curmlist = p ;
...
maincontrol ( void ) 
{
  ...
  */ maincontrol_regmem 
  ...
  lab130: if ( ( curlist .tailfield >= himemmin ) ) 
  {
	...
	{
	  {
	    mem [curlist .tailfield ].hh .v.RH = newpenalty ( eqtb [29314 + 
	    kp ].cint ) ;
	    curlist .tailfield = mem [curlist .tailfield ].hh .v.RH ;
	  } 
	  mem [curlist .tailfield ].hh.b1 = 2 ;
  ...
  if ( mainf != 0 ) 
  {
	...
	if ( eqtb [26916 + kp ].hh.b0 == 1 ) 
	{
	  ...
	  mem [curq + 1 ].cint = mem [curq + 1 ].cint + eqtb [29314 + kp 
	  ].cint ;
	  else {
	      
	    mainp = mem [curq ].hh .v.RH ;
	    mem [curq ].hh .v.RH = newpenalty ( eqtb [29314 + kp ].cint ) 
	    ;
  ...
  if ( ( curcmd >= 16 ) && ( curcmd <= 19 ) ) 
  {
	...
	if ( kp != 1000 ) 
	{
	  ...
	  {
	    if ( ! ( curq >= himemmin ) && ( mem [curq ].hh.b0 == 14 ) ) 
	    mem [curq + 1 ].cint = mem [curq + 1 ].cint + eqtb [29314 + 
	    kp ].cint ;
	    else {
  ...
  if ( curcmd == 73 ) 
  {
	...
	cx = curl ;
	{
	  ...
	  if ( kp != 1000 ) 
	  {
		...
		mainp = mem [curq ].hh .v.RH ;
		mem [curq ].hh .v.RH = newpenalty ( eqtb [29314 + kp ]
		.cint ) ;
		mem [mem [curq ].hh .v.RH ].hh.b1 = 2 ;
		mem [mem [curq ].hh .v.RH ].hh .v.RH = mainp ;
	      } 
