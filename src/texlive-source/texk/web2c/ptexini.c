...
initialize ( void ) 
{
  ...
  pagesofar [7 ]= 0 ;
  pagemaxdepth = 0 ;
  {register integer for_end; k = 28205 ;for_end = 29312 ; if ( k <= for_end) 
  do 
    xeqlevel [k ]= 1 ;
  while ( k++ < for_end ) ;} 
  ...
  if ( iniversion ) 
  {
    ...
    while ( k++ < for_end ) ;} 
    {register integer for_end; k = 28205 ;for_end = 28521 ; if ( k <= 
    for_end) do 
      eqtb [k ].cint = 0 ;
    while ( k++ < for_end ) ;} 
    eqtb [28262 ].cint = 256 ;
    ...
    while ( k++ < for_end ) ;} 
    eqtb [28568 ].cint = 0 ;
    {register integer for_end; k = 28778 ;for_end = 29312 ; if ( k <= 
    for_end) do 
      eqtb [k ].cint = 0 ;
    while ( k++ < for_end ) ;} 
    hashused = 15514 ;
    ...
    trieopptr = 0 ;
    trienotready = true ;
    hash [15514 ].v.RH = 1259 ;
    if ( iniversion ) 
    formatident = 1332 ;
    hash [15522 ].v.RH = 1374 ;
    eqtb [15522 ].hh.b1 = 1 ;
...
znewtrieop ( smallnumber d , smallnumber n , trieopcode v ) 
{
  ...
  while ( true ) {
    ...
    if ( l == 0 ) 
    {
      ...
      overflow ( 1000 , trieopsize ) ;
      u = trieused [curlang ];
      if ( u == maxtrieop ) 
      overflow ( 1001 , maxtrieop - mintrieop ) ;
      incr ( trieopptr ) ;
      incr ( u ) ;
      trieused [curlang ]= u ;
      if ( u > maxopused ) 
...
zlinebreak ( integer finalwidowpenalty ) 
{
  ...
  if ( eqtb [25060 ].hh .v.RH == -268435455L ) {
    ...
    if ( eqtb [28795 ].cint == 0 ) 
    {
      ...
      {
	firstwidth = eqtb [28781 ].cint - abs ( eqtb [28795 ].cint ) ;
	if ( eqtb [28795 ].cint >= 0 ) 
	firstindent = eqtb [28795 ].cint ;
	else firstindent = 0 ;
	secondwidth = eqtb [28781 ].cint ;
	secondindent = 0 ;
      } 
	...
	firstwidth = eqtb [28781 ].cint ;
	firstindent = 0 ;
	secondwidth = eqtb [28781 ].cint - abs ( eqtb [28795 ].cint ) ;
	if ( eqtb [28795 ].cint >= 0 ) 
	secondindent = eqtb [28795 ].cint ;
	else secondindent = 0 ;
      } 
    } 
  } 
  ...
  while ( true ) {
	...
	;
      ...
      printnl ( 986 ) ;
#endif /* STAT */
      background [2 ]= background [2 ]+ eqtb [28798 ].cint ;
      finalpass = true ;
    } 
  } 
  lab30: 
...
prefixedcommand ( void ) 
{
  ...
  case 105 : 
	...
	enddiagnostic ( false ) ;
      ...
      if ( ( p - 27949 ) < eqtb [28262 ].cint ) {
	  
	if ( ( a >= 4 ) ) 
	geqworddefine ( 28262 , p - 27949 ) ;
	else eqworddefine ( 28262 , p - 27949 ) ;
      } 
      if ( ( p - 27949 ) > eqtb [28263 ].cint ) {
	  
	if ( ( a >= 4 ) ) 
	geqworddefine ( 28263 , p - 27949 ) ;
	else eqworddefine ( 28263 , p - 27949 ) ;
      } 
    } 
    else {
	...
	default: 
	{
	  ...
	  {case 2 : 
	    if ( ( a >= 4 ) ) 
	    geqdefine ( p , 78 , 28266 + curval ) ;
	    else eqdefine ( p , 78 , 28266 + curval ) ;
	    break ;
	  case 3 : 
	    if ( ( a >= 4 ) ) 
	    geqdefine ( p , 79 , 28801 + curval ) ;
	    else eqdefine ( p , 79 , 28801 + curval ) ;
	    break ;
	  case 4 : 
	    if ( ( a >= 4 ) ) 
  ...
  case 84 : 
	...
	if ( ( p == 1 ) || ( p == 2 ) ) 
	{
	  ...
	  if ( ( a >= 4 ) ) 
	  geqworddefine ( 29057 + j , curval ) ;
	  else eqworddefine ( 29057 + j , curval ) ;
	} 
	else confusion ( 531 ) ;
      } 
      else {
...
storefmtfile ( void ) 
{
  ...
  packjobname ( 833 ) ;
  while ( ! wopenout ( fmtfile ) ) promptfilename ( 1351 , 833 ) ;
  printnl ( 1352 ) ;
  ...
  if ( hashhigh > 0 ) 
  dumpthings ( eqtb [29313 ], hashhigh ) ;
  dumpint ( parloc ) ;
  dumpint ( writeloc ) ;
  dumpint ( hashused ) ;
  ...
  if ( hashhigh > 0 ) 
  dumpthings ( hash [29313 ], hashhigh ) ;
  dumpint ( cscount ) ;
  println () ;
  printint ( cscount ) ;
  print ( 1337 ) ;
...
loadfmtfile ( void ) 
{
  ...
  eqtb [24526 ].hh .v.RH = -268435455L ;
  eqtb [24526 ].hh.b1 = 0 ;
  {register integer for_end; x = 29313 ;for_end = eqtbtop ; if ( x <= 
  for_end) do 
    eqtb [x ]= eqtb [24526 ];
  while ( x++ < for_end ) ;} 
  undumpint ( x ) ;
  ...
  if ( hashhigh > 0 ) 
  undumpthings ( eqtb [29313 ], hashhigh ) ;
  {
    undumpint ( x ) ;
    if ( ( x < 514 ) || ( x > hashtop ) ) 
    goto lab6666 ;
  ...
  if ( hashhigh > 0 ) 
  {
    undumpthings ( hash [29313 ], hashhigh ) ;
    if ( debugformatfile ) 
    {
      printcsnames ( 29313 , hashhigh - ( 29313 ) ) ;
    } 
  } 
  undumpint ( cscount ) ;
  {
...
initprim ( void ) 
{
  ...
  primitive ( 495 , 78 , 28256 ) ;
  primitive ( 496 , 78 , 28257 ) ;
  primitive ( 497 , 78 , 28258 ) ;
  primitive ( 498 , 78 , 28259 ) ;
  primitive ( 499 , 78 , 28260 ) ;
  if ( mltexp ) 
  {
    mltexenabledp = true ;
    if ( false ) 
    primitive ( 500 , 78 , 28262 ) ;
    primitive ( 501 , 78 , 28263 ) ;
    primitive ( 502 , 78 , 28264 ) ;
  } 
  primitive ( 506 , 79 , 28778 ) ;
  primitive ( 507 , 79 , 28779 ) ;
  primitive ( 508 , 79 , 28780 ) ;
  ...
  primitive ( 526 , 79 , 28799 ) ;
  primitive ( 527 , 79 , 28800 ) ;
  primitive ( 528 , 79 , 28798 ) ;
  primitive ( 32 , 67 , 0 ) ;
  primitive ( 47 , 47 , 0 ) ;
  primitive ( 539 , 48 , 0 ) ;
  primitive ( 540 , 100 , 0 ) ;
  ...
  primitive ( 807 , 116 , 8 ) ;
  primitive ( 808 , 116 , 9 ) ;
  primitive ( 809 , 116 , 10 ) ;
  primitive ( 810 , 116 , 11 ) ;
  primitive ( 811 , 116 , 12 ) ;
  primitive ( 812 , 116 , 13 ) ;
  primitive ( 813 , 116 , 14 ) ;
  primitive ( 814 , 116 , 15 ) ;
  primitive ( 815 , 116 , 16 ) ;
  primitive ( 816 , 116 , 17 ) ;
  primitive ( 817 , 116 , 18 ) ;
  primitive ( 818 , 116 , 19 ) ;
  primitive ( 819 , 116 , 20 ) ;
  primitive ( 820 , 116 , 21 ) ;
  primitive ( 821 , 116 , 22 ) ;
  primitive ( 822 , 116 , 23 ) ;
  primitive ( 823 , 117 , 2 ) ;
  hash [15518 ].v.RH = 823 ;
  ...
  primitive ( 1112 , 23 , 4 ) ;
  primitive ( 1018 , 23 , 5 ) ;
  primitive ( 1113 , 23 , 117 ) ;
  primitive ( 1114 , 75 , 3 ) ;
  primitive ( 1115 , 75 , 4 ) ;
  primitive ( 1116 , 75 , 1 ) ;
  primitive ( 1117 , 34 , 99 ) ;
  primitive ( 1118 , 34 , 100 ) ;
  primitive ( 1119 , 34 , 101 ) ;
  primitive ( 1120 , 34 , 102 ) ;
  primitive ( 1142 , 46 , 1 ) ;
  primitive ( 1143 , 46 , 0 ) ;
  primitive ( 1154 , 28 , 14 ) ;
  primitive ( 1155 , 28 , 13 ) ;
  primitive ( 1156 , 28 , 12 ) ;
  primitive ( 1157 , 26 , 0 ) ;
  primitive ( 1158 , 26 , 1 ) ;
  primitive ( 1159 , 27 , 0 ) ;
  primitive ( 1160 , 27 , 1 ) ;
  ...
  primitive ( 1240 , 103 , 1 ) ;
  primitive ( 1241 , 103 , 2 ) ;
  primitive ( 1242 , 103 , 4 ) ;
  primitive ( 1243 , 107 , 0 ) ;
  primitive ( 1244 , 107 , 1 ) ;
  primitive ( 1245 , 107 , 2 ) ;
  primitive ( 1246 , 107 , 3 ) ;
  primitive ( 1260 , 104 , 0 ) ;
  primitive ( 1261 , 104 , 1 ) ;
  primitive ( 1262 , 105 , 0 ) ;
  primitive ( 1263 , 105 , 1 ) ;
  primitive ( 1264 , 105 , 2 ) ;
  primitive ( 1265 , 105 , 3 ) ;
  primitive ( 1266 , 105 , 4 ) ;
  primitive ( 1267 , 105 , 5 ) ;
  primitive ( 1268 , 105 , 6 ) ;
  if ( mltexp ) 
  {
    primitive ( 1269 , 105 , 7 ) ;
  } 
  ...
  primitive ( 505 , 93 , 28522 ) ;
  primitive ( 430 , 94 , 25583 ) ;
  primitive ( 431 , 94 , 25599 ) ;
  primitive ( 432 , 94 , 25615 ) ;
  primitive ( 992 , 109 , 0 ) ;
  primitive ( 1004 , 109 , 1 ) ;
  primitive ( 1291 , 83 , 0 ) ;
  primitive ( 1292 , 83 , 1 ) ;
  primitive ( 272 , 110 , 0 ) ;
  primitive ( 273 , 110 , 1 ) ;
  primitive ( 274 , 110 , 2 ) ;
  primitive ( 1301 , 110 , 3 ) ;
  primitive ( 1302 , 63 , 1 ) ;
  primitive ( 1303 , 63 , 0 ) ;
  primitive ( 1304 , 61 , 0 ) ;
  primitive ( 1305 , 61 , 1 ) ;
  primitive ( 1311 , 60 , 26925 ) ;
  primitive ( 1312 , 60 , 27181 ) ;
  primitive ( 1313 , 22 , 0 ) ;
  primitive ( 1314 , 22 , 1 ) ;
  primitive ( 1315 , 22 , 2 ) ;
  primitive ( 1316 , 22 , 3 ) ;
  ...
  primitive ( 1364 , 62 , 2 ) ;
  primitive ( 1365 , 62 , 3 ) ;
  hash [15524 ].v.RH = 1365 ;
  eqtb [15524 ]= eqtb [curval ];
  primitive ( 1366 , 62 , 4 ) ;
  primitive ( 1367 , 62 , 5 ) ;
  primitive ( 1392 , 78 , 28265 ) ;
  primitive ( 438 , 86 , 0 ) ;
  primitive ( 1396 , 111 , 1 ) ;
  primitive ( 1397 , 111 , 0 ) ;
  primitive ( 1398 , 111 , 3 ) ;
  primitive ( 1399 , 111 , 2 ) ;
  primitive ( 1408 , 74 , 0 ) ;
  primitive ( 1409 , 85 , 26403 ) ;
  primitive ( 1412 , 84 , 1 ) ;
  primitive ( 1413 , 84 , 2 ) ;
  nonewcontrolsequence = true ;
} 
...
mainbody ( void ) 
{
  ...
  if ( 255 < 255 ) 
  bad = 19 ;
  if ( 94847L + hashextra > 268435455L ) 
  bad = 21 ;
  ...
  fprintf ( stdout , "%s%s",  "This is pTeX, Version 3.14159265" , "-p3.7" ) ;
  else
  fprintf ( stdout , "%s%s",  "This is pTeX, Version 3.14159265" , "-p3.7" ) ;
  Fputs ( stdout ,  " (" ) ;
