...
initialize ( void ) 
{
  ...
  pagesofar [8 ]= 0 ;
  pagemaxdepth = 0 ;
  {register integer for_end; k = 28931 ;for_end = 30050 ; if ( k <= for_end) 
  do 
    xeqlevel [k ]= 1 ;
  while ( k++ < for_end ) ;} 
  ...
  if ( iniversion ) 
  {
    ...
    while ( k++ < for_end ) ;} 
    {register integer for_end; k = 28931 ;for_end = 29257 ; if ( k <= 
    for_end) do 
      eqtb [k ].cint = 0 ;
    while ( k++ < for_end ) ;} 
    eqtb [28988 ].cint = 256 ;
    ...
    {register integer for_end; k = 0 ;for_end = 255 ; if ( k <= for_end) do 
      {
	eqtb [29258 + k ].cint = -1 ;
	setintone ( eqtb [29258 + k ], -1 ) ;
      } 
    while ( k++ < for_end ) ;} 
    eqtb [29304 ].cint = 0 ;
    setintone ( eqtb [29304 ], 0 ) ;
    {register integer for_end; k = 29514 ;for_end = 30050 ; if ( k <= 
    for_end) do 
      eqtb [k ].cint = 0 ;
    while ( k++ < for_end ) ;} 
    hashused = 15514 ;
    ...
    trieopptr = 0 ;
    trienotready = true ;
    hash [15514 ].v.RH = 1315 ;
    if ( iniversion ) 
    formatident = 1390 ;
    hash [15522 ].v.RH = 1433 ;
    eqtb [15522 ].hh.b1 = 1 ;
...
znewtrieop ( smallnumber d , smallnumber n , trieopcode v ) 
{
  ...
  while ( true ) {
    ...
    if ( l == 0 ) 
    {
      ...
      overflow ( 1044 , trieopsize ) ;
      u = trieused [curlang ];
      if ( u == maxtrieop ) 
      overflow ( 1045 , maxtrieop - mintrieop ) ;
      incr ( trieopptr ) ;
      incr ( u ) ;
      trieused [curlang ]= u ;
      if ( u > maxopused ) 
...
zlinebreak ( boolean d ) 
{
  ...
  if ( eqtb [25061 ].hh .v.RH == -268435455L ) {
    ...
    if ( eqtb [29531 ].cint == 0 ) 
    {
      ...
      {
	firstwidth = eqtb [29517 ].cint - abs ( eqtb [29531 ].cint ) ;
	if ( eqtb [29531 ].cint >= 0 ) 
	firstindent = eqtb [29531 ].cint ;
	else firstindent = 0 ;
	secondwidth = eqtb [29517 ].cint ;
	secondindent = 0 ;
      } 
	...
	firstwidth = eqtb [29517 ].cint ;
	firstindent = 0 ;
	secondwidth = eqtb [29517 ].cint - abs ( eqtb [29531 ].cint ) ;
	if ( eqtb [29531 ].cint >= 0 ) 
	secondindent = eqtb [29531 ].cint ;
	else secondindent = 0 ;
      } 
    } 
  } 
  ...
  while ( true ) {
	...
	;
      ...
      printnl ( 1030 ) ;
#endif /* STAT */
      background [2 ]= background [2 ]+ eqtb [29534 ].cint ;
      finalpass = true ;
    } 
  } 
  lab30: 
...
prefixedcommand ( void ) 
{
  ...
  case 106 : 
	...
	enddiagnostic ( false ) ;
      ...
      if ( ( p - 28675 ) < eqtb [28988 ].cint ) {
	  
	if ( ( a >= 4 ) ) 
	geqworddefine ( 28988 , p - 28675 ) ;
	else eqworddefine ( 28988 , p - 28675 ) ;
      } 
      if ( ( p - 28675 ) > eqtb [28989 ].cint ) {
	  
	if ( ( a >= 4 ) ) 
	geqworddefine ( 28989 , p - 28675 ) ;
	else eqworddefine ( 28989 , p - 28675 ) ;
      } 
    } 
    else {
	...
	default: 
	{
	  ...
	  {case 3 : 
	    if ( ( a >= 4 ) ) 
	    geqdefine ( p , 79 , 29002 + curval ) ;
	    else eqdefine ( p , 79 , 29002 + curval ) ;
	    break ;
	  case 4 : 
	    if ( ( a >= 4 ) ) 
	    geqdefine ( p , 80 , 29539 + curval ) ;
	    else eqdefine ( p , 80 , 29539 + curval ) ;
	    break ;
	  case 5 : 
	    if ( ( a >= 4 ) ) 
  ...
  case 85 : 
	...
	if ( ( p == 1 ) || ( p == 2 ) ) 
	{
	  ...
	  if ( ( a >= 4 ) ) 
	  geqworddefine ( 29795 + j , curval ) ;
	  else eqworddefine ( 29795 + j , curval ) ;
	} 
	else confusion ( 536 ) ;
      } 
      else {
...
storefmtfile ( void ) 
{
  ...
  packjobname ( 876 ) ;
  while ( ! wopenout ( fmtfile ) ) promptfilename ( 1409 , 876 ) ;
  printnl ( 1410 ) ;
  ...
  if ( hashhigh > 0 ) 
  dumpthings ( eqtb [30051 ], hashhigh ) ;
  dumpint ( parloc ) ;
  dumpint ( writeloc ) ;
  ...
  if ( hashhigh > 0 ) 
  dumpthings ( hash [30051 ], hashhigh ) ;
  dumpint ( cscount ) ;
  println () ;
  printint ( cscount ) ;
  print ( 1395 ) ;
...
loadfmtfile ( void ) 
{
  ...
  eqtb [24527 ].hh .v.RH = -268435455L ;
  eqtb [24527 ].hh.b1 = 0 ;
  {register integer for_end; x = 30051 ;for_end = eqtbtop ; if ( x <= 
  for_end) do 
    eqtb [x ]= eqtb [24527 ];
  while ( x++ < for_end ) ;} 
  {
  ...
  if ( hashhigh > 0 ) 
  undumpthings ( eqtb [30051 ], hashhigh ) ;
  {
    undumpint ( x ) ;
    if ( ( x < 514 ) || ( x > hashtop ) ) 
    goto lab6666 ;
  ...
  if ( hashhigh > 0 ) 
  {
    undumpthings ( hash [30051 ], hashhigh ) ;
    if ( debugformatfile ) 
    {
      printcsnames ( 30051 , hashhigh - ( 30051 ) ) ;
    } 
  } 
  undumpint ( cscount ) ;
  {
...
initprim ( void ) 
{
  ...
  primitive ( 498 , 79 , 28982 ) ;
  primitive ( 499 , 79 , 28983 ) ;
  primitive ( 500 , 79 , 28984 ) ;
  primitive ( 501 , 79 , 28985 ) ;
  primitive ( 502 , 79 , 28986 ) ;
  if ( mltexp ) 
  {
    mltexenabledp = true ;
    if ( false ) 
    primitive ( 503 , 79 , 28988 ) ;
    primitive ( 504 , 79 , 28989 ) ;
    primitive ( 505 , 79 , 28990 ) ;
  } 
  primitive ( 509 , 80 , 29514 ) ;
  primitive ( 510 , 80 , 29515 ) ;
  primitive ( 511 , 80 , 29516 ) ;
  ...
  primitive ( 529 , 80 , 29535 ) ;
  primitive ( 530 , 80 , 29536 ) ;
  primitive ( 531 , 80 , 29534 ) ;
  primitive ( 32 , 67 , 0 ) ;
  primitive ( 47 , 47 , 0 ) ;
  primitive ( 546 , 48 , 0 ) ;
  primitive ( 547 , 101 , 0 ) ;
  ...
  primitive ( 690 , 122 , 3 ) ;
  primitive ( 691 , 122 , 4 ) ;
  primitive ( 507 , 100 , membot + 0 ) ;
  primitive ( 535 , 100 , membot + 1 ) ;
  primitive ( 416 , 100 , membot + 2 ) ;
  primitive ( 417 , 100 , membot + 3 ) ;
  primitive ( 729 , 88 , 114 ) ;
  primitive ( 730 , 88 , 1 ) ;
  primitive ( 731 , 91 , 0 ) ;
  primitive ( 732 , 91 , 1 ) ;
  primitive ( 733 , 92 , 1 ) ;
  ...
  primitive ( 849 , 117 , 8 ) ;
  primitive ( 850 , 117 , 9 ) ;
  primitive ( 851 , 117 , 10 ) ;
  primitive ( 852 , 117 , 11 ) ;
  primitive ( 853 , 117 , 12 ) ;
  primitive ( 854 , 117 , 13 ) ;
  primitive ( 855 , 117 , 14 ) ;
  primitive ( 856 , 117 , 15 ) ;
  primitive ( 857 , 117 , 16 ) ;
  primitive ( 858 , 117 , 20 ) ;
  primitive ( 859 , 117 , 21 ) ;
  primitive ( 860 , 117 , 22 ) ;
  primitive ( 861 , 117 , 23 ) ;
  primitive ( 862 , 117 , 24 ) ;
  primitive ( 863 , 117 , 25 ) ;
  primitive ( 864 , 117 , 26 ) ;
  primitive ( 315 , 118 , 2 ) ;
  hash [15518 ].v.RH = 315 ;
  ...
  primitive ( 1159 , 23 , 4 ) ;
  primitive ( 1062 , 23 , 5 ) ;
  primitive ( 1160 , 23 , 118 ) ;
  primitive ( 1161 , 76 , 3 ) ;
  primitive ( 1162 , 76 , 4 ) ;
  primitive ( 1163 , 76 , 1 ) ;
  primitive ( 1164 , 34 , 99 ) ;
  primitive ( 1165 , 34 , 100 ) ;
  primitive ( 1166 , 34 , 101 ) ;
  primitive ( 1167 , 34 , 102 ) ;
  primitive ( 1194 , 46 , 1 ) ;
  primitive ( 1195 , 46 , 0 ) ;
  primitive ( 1206 , 28 , 14 ) ;
  primitive ( 1207 , 28 , 13 ) ;
  primitive ( 1208 , 28 , 12 ) ;
  primitive ( 1209 , 26 , 0 ) ;
  primitive ( 1210 , 26 , 1 ) ;
  primitive ( 1211 , 27 , 0 ) ;
  primitive ( 1212 , 27 , 1 ) ;
  ...
  primitive ( 1293 , 104 , 1 ) ;
  primitive ( 1294 , 104 , 2 ) ;
  primitive ( 1295 , 104 , 4 ) ;
  primitive ( 1296 , 108 , 0 ) ;
  primitive ( 1297 , 108 , 1 ) ;
  primitive ( 1298 , 108 , 2 ) ;
  primitive ( 1299 , 108 , 3 ) ;
  primitive ( 1316 , 105 , 0 ) ;
  primitive ( 1317 , 105 , 1 ) ;
  primitive ( 1318 , 106 , 0 ) ;
  primitive ( 1319 , 106 , 1 ) ;
  primitive ( 1320 , 106 , 2 ) ;
  primitive ( 1321 , 106 , 3 ) ;
  primitive ( 1322 , 106 , 4 ) ;
  primitive ( 1323 , 106 , 5 ) ;
  primitive ( 1324 , 106 , 6 ) ;
  primitive ( 1325 , 106 , 7 ) ;
  if ( mltexp ) 
  {
    primitive ( 1326 , 106 , 8 ) ;
  } 
  primitive ( 436 , 94 , 26361 ) ;
  primitive ( 437 , 94 , 26617 ) ;
  primitive ( 438 , 94 , 26873 ) ;
  primitive ( 445 , 94 , 28419 ) ;
  primitive ( 1331 , 94 , 28547 ) ;
  primitive ( 442 , 94 , 27651 ) ;
  primitive ( 443 , 94 , 27907 ) ;
  primitive ( 444 , 94 , 28163 ) ;
  primitive ( 508 , 94 , 29258 ) ;
  primitive ( 1332 , 94 , 29386 ) ;
  primitive ( 433 , 95 , 25589 ) ;
  primitive ( 434 , 95 , 25845 ) ;
  primitive ( 435 , 95 , 26101 ) ;
  primitive ( 1036 , 110 , 0 ) ;
  primitive ( 1048 , 110 , 1 ) ;
  primitive ( 1351 , 84 , 0 ) ;
  primitive ( 1352 , 84 , 1 ) ;
  primitive ( 273 , 111 , 0 ) ;
  primitive ( 274 , 111 , 1 ) ;
  primitive ( 275 , 111 , 2 ) ;
  primitive ( 1361 , 111 , 3 ) ;
  primitive ( 1362 , 63 , 1 ) ;
  primitive ( 1363 , 63 , 0 ) ;
  primitive ( 1364 , 61 , 0 ) ;
  primitive ( 1365 , 61 , 1 ) ;
  primitive ( 1371 , 60 , 27651 ) ;
  primitive ( 1372 , 60 , 27907 ) ;
  primitive ( 1373 , 22 , 0 ) ;
  primitive ( 1374 , 22 , 1 ) ;
  primitive ( 1375 , 22 , 2 ) ;
  primitive ( 1376 , 22 , 3 ) ;
  ...
  primitive ( 1422 , 62 , 2 ) ;
  primitive ( 1423 , 62 , 3 ) ;
  hash [15524 ].v.RH = 1423 ;
  eqtb [15524 ]= eqtb [curval ];
  primitive ( 1424 , 62 , 4 ) ;
  primitive ( 1425 , 62 , 5 ) ;
  primitive ( 1559 , 79 , 28991 ) ;
  primitive ( 441 , 87 , 0 ) ;
  primitive ( 1563 , 112 , 1 ) ;
  primitive ( 1564 , 112 , 0 ) ;
  primitive ( 1565 , 112 , 3 ) ;
  primitive ( 1566 , 112 , 2 ) ;
  primitive ( 1575 , 75 , 0 ) ;
  primitive ( 1576 , 86 , 27129 ) ;
  primitive ( 1579 , 85 , 1 ) ;
  primitive ( 1580 , 85 , 2 ) ;
  nonewcontrolsequence = true ;
} 
...
mainbody ( void ) 
{
  ...
  if ( 65535L < 255 ) 
  bad = 19 ;
  if ( 95585L + hashextra > 268435455L ) 
  bad = 21 ;
  ...
  fprintf ( stdout , "%s%s%s%s",  "This is e-pTeX, Version 3.14159265" , "-p3.7" , "-150805"   , "-2.6" ) ;
  else
  fprintf ( stdout , "%s%s%s%s",  "This is e-pTeX, Version 3.14159265" , "-p3.7" ,   "-150805" , "-2.6" ) ;
  Fputs ( stdout ,  " (" ) ;
  ...
  outputfilename = 0 ;
  {
    ...
    == 1390 ) ) 
    {
      ...
      primitive ( 1426 , 62 , 6 ) ;
      primitive ( 532 , 80 , 29537 ) ;
      primitive ( 533 , 80 , 29538 ) ;
      primitive ( 1451 , 74 , 7 ) ;
      primitive ( 1452 , 74 , 8 ) ;
      primitive ( 1453 , 74 , 9 ) ;
      primitive ( 866 , 117 , 27 ) ;
      primitive ( 1455 , 78 , 25071 ) ;
      primitive ( 1456 , 79 , 28992 ) ;
      primitive ( 1457 , 79 , 28993 ) ;
      primitive ( 1458 , 79 , 28994 ) ;
      primitive ( 1459 , 79 , 28995 ) ;
      primitive ( 1460 , 79 , 28996 ) ;
      primitive ( 1461 , 79 , 28997 ) ;
      primitive ( 1462 , 79 , 28998 ) ;
      primitive ( 1463 , 79 , 28999 ) ;
      primitive ( 1464 , 79 , 29000 ) ;
      primitive ( 1479 , 74 , 11 ) ;
      primitive ( 1480 , 74 , 12 ) ;
      primitive ( 1481 , 74 , 13 ) ;
      primitive ( 1482 , 74 , 14 ) ;
      primitive ( 1483 , 74 , 15 ) ;
      primitive ( 1484 , 74 , 18 ) ;
      primitive ( 1485 , 74 , 19 ) ;
      primitive ( 1486 , 74 , 20 ) ;
      primitive ( 1487 , 74 , 21 ) ;
      primitive ( 1488 , 74 , 22 ) ;
      primitive ( 1489 , 74 , 23 ) ;
      primitive ( 1490 , 74 , 24 ) ;
      primitive ( 1491 , 22 , 4 ) ;
      primitive ( 1493 , 22 , 5 ) ;
      primitive ( 1494 , 121 , 1 ) ;
      primitive ( 1495 , 121 , 5 ) ;
      primitive ( 1496 , 22 , 6 ) ;
      primitive ( 1500 , 91 , 2 ) ;
      primitive ( 971 , 52 , 1 ) ;
      primitive ( 1504 , 79 , 29001 ) ;
      primitive ( 1505 , 36 , 6 ) ;
      primitive ( 1506 , 36 , 7 ) ;
      primitive ( 1507 , 36 , 10 ) ;
      primitive ( 1508 , 36 , 11 ) ;
      primitive ( 1517 , 116 , 2 ) ;
      primitive ( 1519 , 107 , 1 ) ;
      primitive ( 865 , 114 , 1 ) ;
      primitive ( 1520 , 117 , 17 ) ;
      primitive ( 1521 , 117 , 18 ) ;
      primitive ( 1522 , 117 , 19 ) ;
      primitive ( 1307 , 104 , 8 ) ;
      primitive ( 1528 , 74 , 29 ) ;
      primitive ( 1529 , 74 , 30 ) ;
      primitive ( 1530 , 74 , 31 ) ;
      primitive ( 1531 , 74 , 32 ) ;
      primitive ( 1535 , 74 , 16 ) ;
      primitive ( 1536 , 74 , 17 ) ;
      primitive ( 1537 , 74 , 25 ) ;
      primitive ( 1538 , 74 , 26 ) ;
      primitive ( 1539 , 74 , 27 ) ;
      primitive ( 1540 , 74 , 28 ) ;
      primitive ( 1541 , 21 , 5 ) ;
      primitive ( 1542 , 122 , 5 ) ;
      primitive ( 1543 , 122 , 6 ) ;
      primitive ( 1544 , 122 , 7 ) ;
      primitive ( 1545 , 122 , 8 ) ;
      primitive ( 1546 , 122 , 9 ) ;
      primitive ( 1550 , 27 , 2 ) ;
      primitive ( 1551 , 27 , 3 ) ;
      primitive ( 1552 , 93 , 25328 ) ;
      primitive ( 1553 , 93 , 25329 ) ;
      primitive ( 1554 , 93 , 25330 ) ;
