...
xeqlevel:array[28462..29569]of quarterword;{:259}{262:}hash:^twohalves;
...
{:221}{260:}for k:=28462 to 29569 do xeqlevel[k]:=1;
...
end;for k:=0 to 512 do begin eqtb[25892+k].hh.rh:=18;end;
...
eqtb[26024].hh.rh:=19;eqtb[26034].hh.rh:=19;eqtb[26035].hh.rh:=19;
eqtb[26040].hh.rh:=16;eqtb[26113].hh.rh:=17;
for k:=244 to 247 do eqtb[25892+k].hh.rh:=16;eqtb[26402].hh.rh:=17;
...
{:238}{246:}for k:=28462 to 28778 do eqtb[k].int:=0;
eqtb[28519].int:=256;eqtb[28520].int:=-1;eqtb[28479].int:=1000;
eqtb[28463].int:=10000;eqtb[28503].int:=1;eqtb[28502].int:=25;
eqtb[28508].int:=92;eqtb[28511].int:=13;
for k:=0 to 255 do eqtb[28779+k].int:=-1;eqtb[28825].int:=0;
{:246}{256:}for k:=29035 to 29569 do eqtb[k].int:=0;
{:256}{264:}hashused:=15514;hashhigh:=0;cscount:=0;
eqtb[15523].hh.b0:=131;hash[15523].rh:=534;
...
{:1228}{1314:}if iniversion then formatident:=1336;
{:1314}{1382:}hash[15522].rh:=1378;eqtb[15522].hh.b1:=1;
eqtb[15522].hh.b0:=128;eqtb[15522].hh.rh:=-1073741823;{:1382}end;
endif('INITEX'){:8}{1423:}synctexoffset:=28522;{:1423}end;
...
begin if p<514 then if p>=257 then if p=513 then begin printesc(536);
printesc(537);printchar(32);end else begin printesc(p-257);
if eqtb[25636+p-257].hh.rh=11 then printchar(32);
end else if p<1 then printesc(538)else print(p-1)else if((p>=24526)and(p
<=29569))or(p>eqtbtop)then printesc(538)else if(hash[p].rh>=strptr)then
printesc(539)else begin printesc(hash[p].rh);printchar(32);end;end;
{:268}{269:}procedure sprintcs(p:halfword);
begin if p<514 then if p<257 then print(p-1)else if p<513 then printesc(
p-257)else begin printesc(536);printesc(537);
...
print(604);end;end;{:1398}{1500:}procedure printdir(dir:eightbits);
...
if d<0 then print(1435);print(1436);end;
...
if(m<16)and(c>256)then printesc(590)else{300:}case m of 16,17,18,19:
...
end;14:print(591);others:printesc(590)end{:300};end{:299};
p:=mem[p].hh.rh;end;if p<>-1073741823 then printesc(589);10:end;
{:298}{312:}procedure runaway;var p:halfword;
begin if scannerstatus>1 then begin case scannerstatus of 2:begin
printnl(605);p:=defref;end;3:begin printnl(606);p:=memtop-3;end;
4:begin printnl(607);p:=memtop-4;end;5:begin printnl(608);p:=defref;end;
...
533);printint(q);printchar(41);end;end{:261};
{291:}if saveptr>0 then for q:=0 to saveptr-1 do begin if savestack[q].
hh.rh=p then begin printnl(581);printint(q);printchar(41);end;end{:291};
...
10:{1369:}case mem[p].hh.b1 of 0:begin printwritewhatsit(1367,p);
printchar(61);
printfilename(mem[p+1].hh.rh,mem[p+2].hh.lh,mem[p+2].hh.rh);end;
1:begin printwritewhatsit(629,p);printmark(mem[p+1].hh.rh);end;
2:printwritewhatsit(1368,p);3:begin printesc(1369);
printmark(mem[p+1].hh.rh);end;4:begin printesc(1371);
printint(mem[p+1].hh.rh);print(1374);printint(mem[p+1].hh.b0);
printchar(44);printint(mem[p+1].hh.b1);printchar(41);end;
others:print(1375)end{:1369};5:begin printesc(321);
...
17:{706:}begin printesc(560);begin strpool[poolptr]:=68;incr(poolptr);
...
25:printesc(926);29:printesc(927);28:printesc(928);31:printesc(574);
26:begin printesc(568);printdelimiter(p+5);end;30:begin printesc(540);
...
2,4:freenode(p,2);others:confusion(1377)end;goto 30;end{:1371};
...
2,4:begin r:=getnode(2);words:=2;end;others:confusion(1376)end{:1370};
...
if eqtb[28523+t].int=1000 then t:=mem[r+3].int else t:=xovern(mem[r+3].
int,1000)*eqtb[28523+t].int;printscaled(t);
...
56:printesc(495);51:printesc(496);52:printesc(497);53:printesc(498);
54:printesc(499);55:printesc(500);57:printesc(501);58:printesc(502);
59:printesc(503);others:print(504)end;end;
...
begin case n of 0:printesc(507);1:printesc(508);2:printesc(509);
3:printesc(510);4:printesc(511);5:printesc(512);6:printesc(513);
7:printesc(514);8:printesc(515);9:printesc(516);10:printesc(517);
11:printesc(518);12:printesc(519);13:printesc(520);14:printesc(521);
15:printesc(522);16:printesc(523);17:printesc(524);18:printesc(525);
19:printesc(526);21:printesc(527);22:printesc(528);20:printesc(529);
others:print(530)end;end;
{:253}{258:}{304:}procedure printcmdchr(cmd:quarterword;
chrcode:halfword);begin case cmd of 1:begin print(592);print(chrcode);
end;2:begin print(593);print(chrcode);end;3:begin print(594);
print(chrcode);end;6:begin print(595);print(chrcode);end;
7:begin print(596);print(chrcode);end;8:begin print(597);print(chrcode);
end;9:print(598);10:begin print(599);print(chrcode);end;
11:begin print(600);print(chrcode);end;12:begin print(601);
print(chrcode);end;16,17,18,19:begin print(602);printkanji(chrcode);end;
...
{:237}{245:}81:if chrcode<28523 then printparam(chrcode-28462)else begin
printesc(505);printint(chrcode-28523);end;
{:245}{255:}82:if chrcode<29058 then printlengthparam(chrcode-29035)else
begin printesc(531);printint(chrcode-29058);end;
{:255}{272:}49:printesc(540);103:printesc(541);44:printesc(542);
45:printesc(543);85:printesc(554);66:printesc(544);46:printesc(566);
20:printesc(545);122:printesc(536);99:printesc(551);100:printesc(552);
101:printesc(553);15:printesc(547);105:printesc(548);72:printesc(537);
67:printesc(549);69:printesc(32);117:printesc(550);36:printesc(555);
40:printesc(556);43:printesc(557);41:printesc(336);48:printesc(47);
54:printesc(546);22:printesc(359);50:printesc(558);21:printesc(559);
59:printesc(560);104:printesc(561);38:printesc(562);70:printesc(563);
118:printesc(564);60:printesc(341);68:printesc(565);71:printesc(568);
109:printesc(569);0:printesc(570);111:printesc(571);91:printesc(567);
95:printesc(427);124:printesc(572);79:printesc(426);42:printesc(360);
37:printesc(573);61:printesc(574);39:printesc(575);
{:272}{341:}13:printesc(632);
{:341}{388:}119:if chrcode=0 then printesc(667)else printesc(668);
{:388}{396:}125:case chrcode of 1:printesc(670);2:printesc(671);
3:printesc(672);4:printesc(673);others:printesc(669)end;
{:396}{423:}102:if chrcode=0 then printesc(505)else if chrcode=1 then
printesc(531)else if chrcode=2 then printesc(414)else printesc(415);
{:423}{428:}90:if chrcode=1 then printesc(707)else printesc(706);
93:if chrcode=0 then printesc(708)else printesc(709);
94:if chrcode=1 then printesc(710)else if chrcode=3 then printesc(711)
else printesc(712);76:case chrcode of 0:printesc(713);1:printesc(714);
2:printesc(715);3:printesc(716);others:printesc(717)end;
{:428}{480:}123:case chrcode of 0:printesc(775);1:printesc(776);
3:printesc(777);4:printesc(778);5:printesc(779);2:printesc(780);
6:printesc(781);7:printesc(782);8:printesc(783);9:printesc(784);
10:printesc(785);others:printesc(786)end;
{:480}{499:}120:case chrcode of 1:printesc(803);2:printesc(804);
3:printesc(805);4:printesc(806);5:printesc(807);6:printesc(808);
7:printesc(809);8:printesc(810);9:printesc(811);10:printesc(812);
11:printesc(813);12:printesc(814);13:printesc(815);14:printesc(816);
15:printesc(817);16:printesc(818);17:printesc(819);18:printesc(820);
19:printesc(821);20:printesc(822);21:printesc(823);22:printesc(824);
23:printesc(825);others:printesc(802)end;
{:499}{503:}121:if chrcode=2 then printesc(826)else if chrcode=4 then
...
{:792}{995:}92:case chrcode of 0:printesc(1024);1:printesc(1025);
...
{:1065}{1071:}30:case chrcode of 4:printesc(1082);0:printesc(1083);
1:printesc(1084);2:printesc(1085);others:printesc(1086)end;
31:case chrcode of 4:printesc(1087);0:printesc(1088);1:printesc(1089);
2:printesc(1090);others:printesc(1091)end;32:printesc(342);
33:printesc(346);34:printesc(348);
{:1071}{1084:}25:if chrcode=1 then printesc(1109)else printesc(1110);
26:if chrcode=1 then printesc(1111)else printesc(1112);
24:case chrcode of 0:printesc(428);1:printesc(1113);2:printesc(1114);
3:printesc(1019);4:printesc(1115);5:printesc(1021);
others:printesc(1116)end;78:case chrcode of 4:printesc(1118);
3:printesc(1117);1:printesc(1119);end;
35:if chrcode=100 then printesc(1121)else if chrcode=101 then printesc(
1122)else if chrcode=102 then printesc(1123)else printesc(1120);
{:1084}{1101:}47:if chrcode=0 then printesc(1146)else printesc(1145);
{:1101}{1120:}29:if chrcode=12 then printesc(1159)else if chrcode=13
then printesc(1158)else printesc(1157);
27:if chrcode=1 then printesc(1161)else printesc(1160);
28:if chrcode=1 then printesc(1163)else printesc(1162);
{:1120}{1127:}51:if chrcode=1 then printesc(45)else printesc(357);
{:1127}{1155:}52:if chrcode=1 then printesc(1197)else printesc(1196);
{:1155}{1169:}55:case chrcode of 18:printesc(919);19:printesc(920);
...
56:if chrcode=1 then printesc(931)else if chrcode=2 then printesc(932)
else printesc(1201);{:1169}{1182:}58:printstyle(chrcode);
{:1182}{1191:}57:case chrcode of 1:printesc(1220);2:printesc(1221);
3:printesc(1222);4:printesc(1223);5:printesc(1224);
others:printesc(1219)end;
{:1191}{1201:}53:if chrcode=32 then printesc(929)else printesc(930);
{:1201}{1221:}106:if chrcode=1 then printesc(1243)else if chrcode=2 then
printesc(1244)else printesc(1245);
110:if chrcode=0 then printesc(1246)else if chrcode=1 then printesc(1247
)else if chrcode=2 then printesc(1248)else printesc(1249);
{:1221}{1232:}107:if chrcode<>0 then printesc(1264)else printesc(1263);
{:1232}{1235:}108:case chrcode of 0:printesc(1265);8:printesc(1266);
1:printesc(1267);2:printesc(1268);3:printesc(1269);4:printesc(1270);
5:printesc(1271);7:printesc(1273);others:printesc(1272)end;
73:begin printesc(545);printhex(chrcode);end;74:begin printesc(546);
printhex(chrcode);end;75:begin printesc(559);printhex(chrcode);end;
...
printesc(442)else printesc(506);97:printsize(chrcode-25583);
{:1243}{1264:}112:if chrcode=1 then printesc(1007)else printesc(995);
{:1264}{1268:}86:if chrcode=0 then printesc(1295)else printesc(1296);
{:1268}{1274:}98:begin print(1304);slowprint(fontname[chrcode]);
...
2:printesc(275);others:printesc(1305)end;
{:1276}{1286:}65:if chrcode=0 then printesc(1307)else printesc(1306);
{:1286}{1291:}63:if chrcode=0 then printesc(1308)else printesc(1309);
{:1291}{1300:}62:if chrcode=27182 then printesc(1315)else printesc(1316)
;{:1300}{1305:}23:case chrcode of 1:printesc(1318);2:printesc(1319);
3:printesc(1320);4:printesc(1321);others:printesc(1317)end;
{:1305}{1308:}116:print(1328);126:print(1329);127:printesc(1330);
128:printesc(1331);129:begin printesc(1243);printesc(1331);end;
130:printesc(1332);{:1308}{1359:}64:case chrcode of 0:printesc(1367);
1:printesc(629);2:printesc(1368);3:printesc(1369);4:printesc(1370);
5:printesc(1371);others:print(1372)end;{:1359}{1455:}89:printesc(439);
{:1455}{1460:}114:begin if(chrcode mod 2)=0 then printesc(1407)else
printesc(1408);if chrcode<2 then print(1409)else print(1410);end;
115:begin if chrcode=0 then printesc(1411)else if chrcode=1 then
printesc(1412)else printesc(1413);print(1414);end;
{:1460}{1467:}77:printesc(1419);88:printesc(1420);
{:1467}{1472:}87:case chrcode of 1:printesc(1423);2:printesc(1424);end;
{:1472}others:print(603)end;end;
{:304}ifdef('STAT')procedure showeqtb(n:halfword);
begin if n<1 then printchar(63)else if(n<24527)or((n>29569)and(n<=
...
end{:241}{:239}else if n<29035 then{248:}begin if n<28523 then
printparam(n-28462)else if n<28779 then begin printesc(505);
printint(n-28523);end else begin printesc(506);printint(n-28779);end;
printchar(61);printint(eqtb[n].int);
end{:248}else if n<29314 then{257:}begin if n<29058 then
printlengthparam(n-29035)else begin printesc(531);printint(n-29058);end;
printchar(61);printscaled(eqtb[n].int);print(416);
end{:257}else if n<=29569 then print(532)else printchar(63);end;
...
incr(hashhigh);hash[p].lh:=hashhigh+29569;p:=hashhigh+29569;
end else begin repeat if(hashused=514)then overflow(535,15000+hashextra)
...
if maxsavestack>savesize-6 then overflow(576,savesize);end;
savestack[saveptr].hh.b0:=3;savestack[saveptr].hh.b1:=curgroup;
savestack[saveptr].hh.rh:=curboundary;
if curlevel=65535 then overflow(577,65535);curboundary:=saveptr;
...
{289:}if(p<28462)or(p>29569)then if eqtb[p].hh.b1=1 then begin eqdestroy
(savestack[saveptr]);
ifdef('STAT')if eqtb[28499].int>0 then restoretrace(p,579);
endif('STAT')end else begin eqdestroy(eqtb[p]);
eqtb[p]:=savestack[saveptr];
ifdef('STAT')if eqtb[28499].int>0 then restoretrace(p,580);
...
restoretrace(p,579);endif('STAT')end{:289};end;end;
30:curgroup:=savestack[saveptr].hh.b1;
curboundary:=savestack[saveptr].hh.rh{:288};end else confusion(578);end;
{:287}{294:}procedure preparemag;
begin if(magset>0)and(eqtb[28479].int<>magset)then begin begin if
interaction=3 then;
if filelineerrorstylep then printfileline else printnl(263);print(582);
end;printint(eqtb[28479].int);print(583);printnl(584);begin helpptr:=2;
helpline[1]:=585;helpline[0]:=586;end;interror(magset);
geqworddefine(28479,magset);end;
if(eqtb[28479].int<=0)or(eqtb[28479].int>32768)then begin begin if
interaction=3 then;
if filelineerrorstylep then printfileline else printnl(263);print(587);
end;begin helpptr:=1;helpline[0]:=588;end;interror(eqtb[28479].int);
...
print(604);shownmode:=curlist.modefield;end;printcmdchr(curcmd,curchr);
...
if(curinput.namefield=0)then if baseptr=0 then printnl(609)else printnl(
610)else begin printnl(611);
if curinput.namefield=17 then printchar(42)else printint(curinput.
namefield-1);printchar(62);end else begin printnl(612);printint(line);
...
end else begin{320:}case curinput.indexfield of 0:printnl(613);
1,2:printnl(614);
3:if curinput.locfield=-1073741823 then printnl(615)else printnl(616);
4:printnl(617);5:begin println;printcs(curinput.namefield);end;
6:printnl(618);7:printnl(619);8:printnl(620);9:printnl(621);
10:printnl(622);11:printnl(623);12:printnl(624);13:printnl(625);
14:printnl(626);15:printnl(627);others:printnl(63)end{:320};
...
if inputptr=stacksize then overflow(628,stacksize);end;
...
printnl(344);case t of 14:printesc(359);15:printesc(629);
others:printcmdchr(80,t+25055)end;print(591);tokenshow(p);
...
alignstate:=0 else fatalerror(630);begin decr(inputptr);
...
begin if inopen=maxinopen then overflow(631,maxinopen);
...
if filelineerrorstylep then printfileline else printnl(263);print(639);
end else begin curcs:=0;begin if interaction=3 then;
if filelineerrorstylep then printfileline else printnl(263);print(640);
end;end;{345:}p:=getavail;case scannerstatus of 2:begin print(646);
mem[p].hh.lh:=637;end;3:begin print(647);mem[p].hh.lh:=partoken;
longstate:=128;end;4:begin print(648);mem[p].hh.lh:=637;q:=p;
p:=getavail;mem[p].hh.rh:=q;mem[p].hh.lh:=536886426;
alignstate:=-1000000;end;5:begin print(649);mem[p].hh.lh:=637;end;end;
begintokenlist(p,4){:345};print(641);sprintcs(warningindex);
begin helpptr:=4;helpline[3]:=642;helpline[2]:=643;helpline[1]:=644;
helpline[0]:=645;end;error;
end{:344}else begin begin if interaction=3 then;
if filelineerrorstylep then printfileline else printnl(263);print(633);
end;printcmdchr(120,curif);print(634);printint(skipline);
begin helpptr:=3;helpline[2]:=635;helpline[1]:=636;helpline[0]:=637;end;
if curcs<>0 then curcs:=0 else helpline[2]:=638;curtok:=536886429;
...
if filelineerrorstylep then printfileline else printnl(263);print(650);
end;begin helpptr:=2;helpline[1]:=651;helpline[0]:=652;end;
...
if curinput.limitfield=curinput.startfield then printnl(653);println;
first:=curinput.startfield;begin;print(42);terminput;end;
curinput.limitfield:=last;
if(eqtb[28511].int<0)or(eqtb[28511].int>255)then decr(curinput.
limitfield)else buffer[curinput.limitfield]:=eqtb[28511].int;
first:=curinput.limitfield+1;curinput.locfield:=curinput.startfield;
end else fatalerror(654);end{:368};
...
begin if(scannerstatus=4)or(curalign=-1073741823)then fatalerror(630);
...
print(688);end;sprintcs(warningindex);print(689);begin helpptr:=4;
...
if filelineerrorstylep then printfileline else printnl(263);print(683);
end;sprintcs(warningindex);print(684);begin helpptr:=3;helpline[2]:=685;
helpline[1]:=686;helpline[0]:=687;end;backerror;end;
...
end;sprintcs(warningindex);print(676);begin helpptr:=6;helpline[5]:=677;
helpline[4]:=678;helpline[3]:=679;helpline[2]:=680;helpline[1]:=681;
helpline[0]:=682;end;incr(alignstate);longstate:=126;curtok:=partoken;
inserror;goto 22;
...
printint(n);print(694);showtokenlist(pstack[n-1],-1073741823,1000);
...
paramptr+n;if maxparamstack>paramsize then overflow(674,paramsize);end;
...
if expanddepthcount>=expanddepth then overflow(656,expanddepth);
...
if filelineerrorstylep then printfileline else printnl(263);print(663);
end;printesc(537);print(664);begin helpptr:=2;helpline[1]:=665;
helpline[0]:=666;end;backerror;end{:384};{385:}j:=first;p:=mem[r].hh.rh;
...
end;printcmdchr(121,curchr);begin helpptr:=1;helpline[0]:=830;end;error;
...
end;begin helpptr:=5;helpline[4]:=658;helpline[3]:=659;helpline[2]:=660;
helpline[1]:=661;helpline[0]:=662;end;error;end{:381}end;
...
if filelineerrorstylep then printfileline else printnl(263);print(695);
end;begin helpptr:=4;helpline[3]:=696;helpline[2]:=697;helpline[1]:=698;
helpline[0]:=699;end;backerror;curtok:=379;curcmd:=1;curchr:=123;
...
begin begin if interaction=3 then;
if filelineerrorstylep then printfileline else printnl(263);print(700);
end;begin helpptr:=1;helpline[0]:=701;end;error;end;
...
if filelineerrorstylep then printfileline else printnl(263);print(730);
end;begin helpptr:=2;helpline[1]:=731;helpline[0]:=727;end;
...
if filelineerrorstylep then printfileline else printnl(263);print(732);
end;begin helpptr:=2;helpline[1]:=733;helpline[0]:=727;end;
interror(curval);curval:=0;end;end;
...
if filelineerrorstylep then printfileline else printnl(263);print(734);
end;begin helpptr:=2;helpline[1]:=735;helpline[0]:=727;end;
interror(curval);curval:=0;end;end;
...
if filelineerrorstylep then printfileline else printnl(263);print(854);
...
n:smallnumber):halfword;label 30,31;var p,s:halfword;
begin s:=calcpos(c);p:=s;ifdef('TEXMF_DEBUG')println;print(1425);
printint(c);print(1426);printint(s);if p+26916<0 then begin print(1427);
println;end;
...
if(q<>1000)and(m=eqtb[26916+q].hh.b0)then begin curval:=eqtb[29314+q].
...
=3 then;if filelineerrorstylep then printfileline else printnl(263);
print(702);end;begin helpptr:=3;helpline[2]:=703;helpline[1]:=704;
helpline[0]:=705;end;backerror;begin curval:=0;curvallevel:=1;end;
...
print(718);end;printcmdchr(90,m);begin helpptr:=4;helpline[3]:=719;
helpline[2]:=720;helpline[1]:=721;helpline[0]:=722;end;error;
...
case m of 0:curval:=eqtb[28523+curval].int;
1:curval:=eqtb[29058+curval].int;2:curval:=eqtb[24548+curval].hh.rh;
...
end;printcmdchr(curcmd,curchr);print(724);printesc(572);
begin helpptr:=1;helpline[0]:=722;end;error;
if level<>5 then begin curval:=0;curvallevel:=1;
...
interaction=3 then;
if filelineerrorstylep then printfileline else printnl(263);print(736);
end;begin helpptr:=2;helpline[1]:=737;helpline[0]:=738;end;curval:=48;
...
end;begin helpptr:=2;helpline[1]:=740;helpline[0]:=741;end;error;
...
if filelineerrorstylep then printfileline else printnl(263);print(702);
end;begin helpptr:=3;helpline[2]:=703;helpline[1]:=704;helpline[0]:=705;
...
interaction=3 then;
if filelineerrorstylep then printfileline else printnl(263);print(743);
end;print(744);begin helpptr:=1;helpline[0]:=745;end;error;
...
if scankeyword(746)then v:=({569:}fontinfo[6+parambase[eqtb[25582].hh.rh
]].int{:569})else if scankeyword(747)then v:=({570:}fontinfo[5+parambase
[eqtb[25582].hh.rh]].int{:570})else if scankeyword(748)then{1451:}if
...
qqqq.b0].int{:1451}else if scankeyword(749)then{1452:}if curlist.
...
interaction=3 then;
if filelineerrorstylep then printfileline else printnl(263);print(743);
end;print(750);begin helpptr:=4;helpline[3]:=751;helpline[2]:=752;
helpline[1]:=753;helpline[0]:=754;end;error;goto 88;end{:467};
if scankeyword(742)then{468:}begin preparemag;
...
{469:}if scankeyword(755)then begin num:=7227;denom:=100;
end else if scankeyword(756)then begin num:=12;denom:=1;
end else if scankeyword(757)then begin num:=7227;denom:=254;
end else if scankeyword(758)then begin num:=7227;denom:=2540;
end else if scankeyword(759)then begin num:=7227;denom:=7200;
end else if scankeyword(760)then begin num:=1238;denom:=1157;
end else if scankeyword(761)then begin num:=14856;denom:=1157;
end else if scankeyword(72)then begin num:=7227;denom:=10160;
end else if scankeyword(81)then begin num:=7227;denom:=10160;
end else if scankeyword(762)then goto 30 else{470:}begin begin if
interaction=3 then;
if filelineerrorstylep then printfileline else printnl(263);print(743);
end;print(763);begin helpptr:=6;helpline[5]:=764;helpline[4]:=765;
helpline[3]:=766;helpline[2]:=752;helpline[1]:=753;helpline[0]:=754;end;
...
interaction=3 then;
if filelineerrorstylep then printfileline else printnl(263);print(767);
...
mem[q+1].int:=curval;
if scankeyword(770)then begin scandimen(mu,true,false);
...
mem[q+2].int:=0;end;
21:if scankeyword(772)then begin scandimen(false,false,false);
mem[q+1].int:=curval;goto 21;end;
if scankeyword(773)then begin scandimen(false,false,false);
...
if filelineerrorstylep then printfileline else printnl(263);print(790);
end;begin helpptr:=1;helpline[0]:=791;end;error;end else begin incr(t);
if curtok<>t then begin begin if interaction=3 then;
if filelineerrorstylep then printfileline else printnl(263);print(792);
...
if filelineerrorstylep then printfileline else printnl(263);print(800);
end;printesc(569);begin helpptr:=1;helpline[0]:=801;end;
...
while true do begin if q=-1073741823 then confusion(802);
...
interaction=3 then;
if filelineerrorstylep then printfileline else printnl(263);print(833);
end;printcmdchr(120,thisif);begin helpptr:=1;helpline[0]:=834;end;
backerror;r:=61;end;
...
if eqtb[28498].int>1 then begin begindiagnostic;print(835);printint(n);
...
if filelineerrorstylep then printfileline else printnl(263);print(838);
...
if(e=841)or(e=344)then showcontext;println;
printcstring(promptfilenamehelpmsg);if(e<>344)then begin print(842);
print(e);print(39);end;print(41);println;printnl(843);print(s);
if interaction<2 then fatalerror(844);savedcurname:=curname;
savedcurext:=curext;savedcurarea:=curarea;;begin;print(604);terminput;
...
then write(logfile,'This is upTeX, Version 3.14159265','-p3.7','-u1.20')
else write(logfile,'This is upTeX, Version 3.14159265','-p3.7','-u1.20')
;write(logfile,' (');write(logfile,conststringcast(getencstring));
write(logfile,')');write(logfile,versionstring);slowprint(formatident);
print(852);printint(eqtb[28483].int);printchar(32);
...
if c>=eqtb[28519].int then if c<=eqtb[28520].int then if(eqtb[28206+c].
...
printnl(877);print(1393);print(c);print(878);slowprint(fontname[f]);
...
if s>=0 then begin print(787);printscaled(s);print(416);
...
if filelineerrorstylep then printfileline else printnl(263);print(1387);
end;begin helpptr:=2;helpline[1]:=1388;helpline[0]:=1068;end;error;
...
:=19;if not logopened then selector:=17;printnl(1379);
for d:=0 to(poolptr-strstart[strptr])-1 do begin print(strpool[strstart[
strptr]+d]);end;print(1380);
...
clobbered:=true;end;
if clobbered then print(1381)else begin runsystemret:=runsystem(
conststringcast(addressof(strpool[strstart[strptr]])));
if runsystemret=-1 then print(1382)else if runsystemret=0 then print(
1383)else if runsystemret=1 then print(1384)else if runsystemret=2 then
print(1385)end;end else begin print(1386);end;printchar(46);
...
if curext=344 then curext:=841;packfilename(curname,curarea,curext);
while not kpseoutnameok(stringcast(nameoffile+1))or not aopenout(
writefile[j])do promptfilename(1390,841);writeopen[j]:=true;
if logopened then begin oldsetting:=selector;
if(eqtb[28491].int<=0)then selector:=18 else selector:=19;printnl(1391);
printint(j);print(1392);printfilename(curname,curarea,curext);
print(840);printnl(344);println;selector:=oldsetting;end;end;end;
end{:1387};3:specialout(p);4:;others:confusion(1389)end;end;
...
dvidir:=curdirhv;end;others:confusion(1433);end end;
...
if(mem[tempptr].hh.b0<>0)and(mem[tempptr].hh.b0<>1)then confusion(1434);
...
goto 22;end;
if mltexenabledp then{1409:}begin{1411:}if c>=eqtb[28519].int then if c
<=eqtb[28520].int then if(eqtb[28206+c].hh.rh>0)then begin basec:=(eqtb[
...
topedge:=curv;
while p<>-1073741823 do{641:}begin if(p>=himemmin)then confusion(881)
...
begin if eqtb[28496].int>0 then begin printnl(344);println;print(882);
end;if termoffset>maxprintline-9 then println else if(termoffset>0)or(
fileoffset>0)then printchar(32);printchar(91);j:=9;
while(eqtb[28523+j].int=0)and(j>0)do decr(j);
for k:=0 to j do begin printint(eqtb[28523+k].int);
...
[p+3].int+mem[p+2].int+eqtb[29054].int>1073741823)or(mem[p+1].int+eqtb[
29053].int>1073741823)then begin begin if interaction=3 then;
if filelineerrorstylep then printfileline else printnl(263);print(886);
end;begin helpptr:=2;helpline[1]:=887;helpline[0]:=888;end;error;
if eqtb[28496].int<=0 then begin begindiagnostic;printnl(889);
showbox(p);enddiagnostic(true);end;goto 30;end;
if mem[p+3].int+mem[p+2].int+eqtb[29054].int>maxv then maxv:=mem[p+3].
int+mem[p+2].int+eqtb[29054].int;
if mem[p+1].int+eqtb[29053].int>maxh then maxh:=mem[p+1].int+eqtb[29053]
.int{:652};{628:}dvih:=0;dviv:=0;curh:=eqtb[29053].int;dvif:=0;
...
end;for k:=0 to 9 do dvifour(eqtb[28523+k].int);dvifour(lastbop);
lastbop:=pageloc;curv:=mem[p+3].int+eqtb[29054].int;tempptr:=p;
...
{650:}ifdef('STAT')if eqtb[28493].int>1 then begin printnl(883);
printint(varused);printchar(38);printint(dynused);printchar(59);end;
endif('STAT')flushnodelist(p);
ifdef('STAT')if eqtb[28493].int>1 then begin print(884);
...
{677:}if(-x-totalshrink[0]>eqtb[29043].int)or(eqtb[28488].int<100)then
begin if(eqtb[29051].int>0)and(-x-totalshrink[0]>eqtb[29043].int)then
begin while mem[q].hh.rh<>-1073741823 do q:=mem[q].hh.rh;
mem[q].hh.rh:=newrule;mem[mem[q].hh.rh+1].int:=eqtb[29051].int;end;
...
if lastbadness>eqtb[28488].int then begin println;printnl(907);
...
totalshrink[3]:=0{:661};
while p<>-1073741823 do{680:}begin if(p>=himemmin)then confusion(908)
...
if(totalshrink[o]<-x)and(o=0)and(mem[r+5].hh.rh<>-1073741823)then begin
lastbadness:=1000000;mem[r+6].gr:=1.0;
{688:}if(-x-totalshrink[0]>eqtb[29044].int)or(eqtb[28489].int<100)then
...
lastbadness:=badness(-x,totalshrink[0]);
if lastbadness>eqtb[28489].int then begin println;printnl(912);
...
if d<eqtb[29037].int then p:=newparamglue(0)else begin p:=newskipparam(1
...
mem[b+1].int:=eqtb[29046].int;end;
...
confusion(943)end else begin if mem[v].hh.b0<>1 then confusion(574)end;
...
,mem[q+4].hh.lh);mem[x+1].int:=mem[x+1].int+eqtb[29047].int;
...
curstyle mod 2),mem[q+4].hh.lh);
mem[x+1].int:=mem[x+1].int+eqtb[29047].int;
...
mem[y+1].int:=mem[y+1].int+eqtb[29047].int;
...
delta2:=delta1+delta1-eqtb[29045].int;
...
if curcmd=9 then fatalerror(630);
...
then;if filelineerrorstylep then printfileline else printnl(263);
print(718);end;printesc(555);print(948);begin helpptr:=3;
...
begin if interaction=3 then;
if filelineerrorstylep then printfileline else printnl(263);print(957);
...
if filelineerrorstylep then printfileline else printnl(263);print(961);
...
begin if curalign=-1073741823 then confusion(963);
q:=mem[curalign].hh.rh;if q=-1073741823 then confusion(963);
if alignstate<500000 then fatalerror(630);p:=mem[q].hh.rh;
...
if n>65535 then confusion(968);q:=curspan;
...
if nest[nestptr-1].modefield=233 then o:=eqtb[29050].int else o:=0;
...
if curlist.modefield=-1 then begin rulesave:=eqtb[29051].int;
eqtb[29051].int:=0;z:=newnullbox;mem[z].hh.rh:=mem[memtop-8].hh.rh;
...
+0].int);eqtb[29051].int:=rulesave;deleteglueref(mem[z+7].hh.rh);
...
if filelineerrorstylep then printfileline else printnl(263);print(1242);
...
if filelineerrorstylep then printfileline else printnl(263);print(1238);
...
begin if interaction=3 then;
if filelineerrorstylep then printfileline else printnl(263);print(971);
...
ifdef('STAT')if eqtb[28494].int>0 then{857:}begin printnl(979);
...
if curp=-1073741823 then printesc(632)else if(mem[curp].hh.b0<>12)and(
not(curp>=himemmin))then begin if mem[curp].hh.b0=14 then printesc(566)
else if mem[curp].hh.b0=9 then printesc(357)else if mem[curp].hh.b0=13
then printesc(346)else printesc(349);end;print(983);
if mem[r+1].hh.rh=-1073741823 then printchar(48)else printint(mem[mem[r
+1].hh.rh].hh.lh);print(984);
...
if filelineerrorstylep then printfileline else printnl(263);print(1011);
...
if filelineerrorstylep then printfileline else printnl(263);print(1006);
...
{:845}{859:}if eqtb[25060].hh.rh=-1073741823 then if eqtb[29052].int=0
then begin lastspecialline:=0;secondwidth:=eqtb[29038].int;
secondindent:=0;
end else{860:}begin lastspecialline:=abs(eqtb[28503].int);
if eqtb[28503].int<0 then begin firstwidth:=eqtb[29038].int-abs(eqtb[
29052].int);
if eqtb[29052].int>=0 then firstindent:=eqtb[29052].int else firstindent
:=0;secondwidth:=eqtb[29038].int;secondindent:=0;
end else begin firstwidth:=eqtb[29038].int;firstindent:=0;
secondwidth:=eqtb[29038].int-abs(eqtb[29052].int);
if eqtb[29052].int>=0 then secondindent:=eqtb[29052].int else
secondindent:=0;end;
...
secondpass:=true;finalpass:=(eqtb[29055].int<=0);
...
5:;others:confusion(991)end{:881};s:=mem[s].hh.rh;until s=-1073741823;
...
printnl(988);endif('STAT')threshold:=eqtb[28463].int;secondpass:=true;
finalpass:=(eqtb[29055].int<=0);
end else begin ifdef('STAT')if eqtb[28494].int>0 then printnl(989);
endif('STAT')background[2]:=background[2]+eqtb[29055].int;
...
interaction=3 then;
if filelineerrorstylep then printfileline else printnl(263);print(999);
...
mem[prevp].hh.rh:=p;flushnodelist(q);end;others:confusion(1013)end;
...
helpline[1]:=1022;helpline[0]:=1023;end;error;vsplit:=-1073741823;
goto 10;end;flushnodelist(mem[v].hh.rh);mem[v].hh.rh:=-1073741823{:989};
q:=vertbreak(mem[v+5].hh.rh,h,eqtb[29041].int);{990:}p:=mem[v+5].hh.rh;
...
q:=vpackage(p,h,0,eqtb[29041].int);mem[q].hh.b1:=(mem[v].hh.b1);
...
print(1032);end;if pagesofar[5]<>0 then begin print(316);
...
begin pagecontents:=s;pagesofar[0]:=eqtb[29039].int;
pagemaxdepth:=eqtb[29040].int;pagesofar[7]:=0;pagesofar[1]:=0;
...
end;begin helpptr:=3;helpline[2]:=1044;helpline[1]:=1045;
...
=3 then;if filelineerrorstylep then printfileline else printnl(263);
print(344);end;printesc(428);print(1059);begin helpptr:=2;
...
savevfuzz:=eqtb[29044].int;eqtb[29044].int:=1073741823;
...
if filelineerrorstylep then printfileline else printnl(263);print(1061);
...
if eqtb[28523+n].int=1000 then h:=mem[r+3].int else h:=xovern(mem[r+3].
int,1000)*eqtb[28523+n].int;pagesofar[0]:=pagesofar[0]-h-mem[q+1].int;
pagesofar[2+mem[q].hh.b0]:=pagesofar[2+mem[q].hh.b0]+mem[q+2].int;
pagesofar[6]:=pagesofar[6]+mem[q+3].int;
if(mem[q].hh.b1<>0)and(mem[q+3].int<>0)then begin begin if interaction=3
then;if filelineerrorstylep then printfileline else printnl(263);
print(1054);end;printesc(414);printint(n);begin helpptr:=3;
...
if eqtb[28523+n].int=1000 then h:=mem[p+3].int else h:=xovern(mem[p+3].
int,1000)*eqtb[28523+n].int;
if((h<=0)or(h<=delta))and(mem[p+3].int+mem[r+3].int<=eqtb[29058+n].int)
then begin pagesofar[0]:=pagesofar[0]-h;
mem[r+3].int:=mem[r+3].int+mem[p+3].int;
end else{1021:}begin if eqtb[28523+n].int<=0 then w:=1073741823 else
begin w:=pagesofar[0]-pagesofar[1]-pagesofar[7];
if eqtb[28523+n].int<>1000 then w:=xovern(w,eqtb[28523+n].int)*1000;end;
if w>eqtb[29058+n].int-mem[r+3].int then w:=eqtb[29058+n].int-mem[r+3].
...
endif('STAT')if eqtb[28523+n].int<>1000 then bestheightplusdepth:=xovern
(bestheightplusdepth,1000)*eqtb[28523+n].int;
...
if filelineerrorstylep then printfileline else printnl(263);print(1073);
...
printesc(549);end;15:begin mem[p].hh.lh:=804;printchar(36);end;
...
printchar(125);end end{:1077};print(664);
...
begin begin if interaction=3 then;
if filelineerrorstylep then printfileline else printnl(263);print(1103);
end;case curgroup of 14:printesc(549);15:printchar(36);16:printesc(930);
...
if eqtb[29052].int<>0 then eqworddefine(29052,0);
...
if filelineerrorstylep then printfileline else printnl(263);print(1131);
...
if filelineerrorstylep then printfileline else printnl(263);print(1138);
...
d:scaled;begin d:=eqtb[29042].int;deleteglueref(curkanjiskip);
deleteglueref(curxkanjiskip);
...
mem[curlist.tailfield+1].int:=eqtb[29035].int;
...
begin if interaction=3 then;
if filelineerrorstylep then printfileline else printnl(263);print(723);
end;printesc(556);print(1147);begin helpptr:=2;helpline[1]:=1148;
...
end;printesc(336);printint(255);begin helpptr:=1;helpline[0]:=1151;end;
...
youcant;begin helpptr:=2;helpline[1]:=1136;helpline[0]:=1154;end;
...
begin if interaction=3 then;
if filelineerrorstylep then printfileline else printnl(263);print(1164);
...
interaction=3 then;
if filelineerrorstylep then printfileline else printnl(263);print(1170);
end;printesc(357);begin helpptr:=2;helpline[1]:=1171;helpline[0]:=1172;
...
fontdir[f]=4 then disp:=eqtb[29056].int-eqtb[29057].int else disp:=eqtb[
29056].int end else begin if fontdir[f]=4 then disp:=0 else if fontdir[f
]=3 then disp:=eqtb[29057].int-eqtb[29056].int else disp:=eqtb[29057].
...
if filelineerrorstylep then printfileline else printnl(263);print(1183);
...
if filelineerrorstylep then printfileline else printnl(263);print(1183);
end;printesc(562);begin helpptr:=2;helpline[1]:=1191;helpline[0]:=1192;
end;error;end;procedure omiterror;begin begin if interaction=3 then;
if filelineerrorstylep then printfileline else printnl(263);print(1183);
end;printesc(565);begin helpptr:=2;helpline[1]:=1193;helpline[0]:=1192;
...
-1073741823)or(inputstack[baseptr].statefield<>0)then fatalerror(630);
...
if filelineerrorstylep then printfileline else printnl(263);print(829);
end;printesc(537);begin helpptr:=1;helpline[0]:=1195;end;error;end;
...
{1161:}if eqtb[25060].hh.rh=-1073741823 then if(eqtb[29052].int<>0)and((
(eqtb[28503].int>=0)and(curlist.pgfield+2>eqtb[28503].int))or(curlist.
pgfield+1<-eqtb[28503].int))then begin l:=eqtb[29038].int-abs(eqtb[29052
].int);if eqtb[29052].int>0 then s:=eqtb[29052].int else s:=0;
end else begin l:=eqtb[29038].int;s:=0;
...
eqworddefine(29048,w);eqworddefine(29049,l);eqworddefine(29050,s);
...
if filelineerrorstylep then printfileline else printnl(263);print(1198);
...
interaction=3 then;
if filelineerrorstylep then printfileline else printnl(263);print(1200);
...
case curcmd of 11,12:curval:=eqtb[28779+curchr].int;
...
if filelineerrorstylep then printfileline else printnl(263);print(1211);
end;printesc(558);print(1212);begin helpptr:=2;helpline[1]:=1213;
...
if filelineerrorstylep then printfileline else printnl(263);print(1215);
...
interaction=3 then;
if filelineerrorstylep then printfileline else printnl(263);print(1230);
...
interaction=3 then;
if filelineerrorstylep then printfileline else printnl(263);print(1234);
...
if m<0 then{1208:}begin if curlist.dirfield=3 then disp:=eqtb[29056].int
else disp:=eqtb[29057].int;
...
mem[curlist.tailfield].hh.b0:=5;mem[curlist.tailfield+1].int:=disp;
curlist.pdispfield:=disp;end;end;{:1503};
begin mem[curlist.tailfield].hh.rh:=newmath(eqtb[29036].int,0);
...
begin mem[curlist.tailfield].hh.rh:=newmath(eqtb[29036].int,1);
curlist.tailfield:=mem[curlist.tailfield].hh.rh;end;
{1504:}if disp<>0 then begin if not(curlist.tailfield>=himemmin)and(mem[
curlist.tailfield].hh.b0=5)then begin mem[curlist.tailfield+1].int:=0;
end else begin curlist.pnodefield:=curlist.tailfield;
...
w:=mem[b+1].int;z:=eqtb[29049].int;s:=eqtb[29050].int;
...
curlist.tailfield:=mem[curlist.tailfield].hh.rh;end;
if(d+s<=eqtb[29048].int)or l then begin g1:=3;g2:=4;
...
if(curcs=0)or(curcs>eqtbtop)or((curcs>15514)and(curcs<=29569))then begin
begin if interaction=3 then;
...
if filelineerrorstylep then printfileline else printnl(263);print(723);
end;printcmdchr(curcmd,curchr);print(724);printcmdchr(q,0);
begin helpptr:=1;helpline[0]:=1288;end;error;goto 10;end;end;p:=curchr;
scaneightbitint;case p of 0:l:=curval+28523;1:l:=curval+29058;
2:l:=curval+24548;3:l:=curval+24804;end;end;40:{:1250};
if q=102 then scanoptionalequals else if scankeyword(1284)then;
aritherror:=false;
...
if filelineerrorstylep then printfileline else printnl(263);print(1285);
end;begin helpptr:=2;helpline[1]:=1286;helpline[0]:=1287;end;
...
end;begin helpptr:=1;helpline[0]:=1292;end;interror(curval);
...
if filelineerrorstylep then printfileline else printnl(263);print(1009);
end;printesc(567);begin helpptr:=1;helpline[0]:=1293;end;
...
if u>=514 then t:=hash[u].rh else if u>=257 then if u=513 then t:=1297
else t:=u-257 else begin oldsetting:=selector;selector:=21;print(1297);
...
if scankeyword(1298)then{1272:}begin scandimen(false,false,false);
s:=curval;
if(s<=0)or(s>=134217728)then begin begin if interaction=3 then;
if filelineerrorstylep then printfileline else printnl(263);print(1300);
end;printscaled(s);print(1301);begin helpptr:=2;helpline[1]:=1302;
helpline[0]:=1303;end;error;s:=10*65536;end;
end{:1272}else if scankeyword(1299)then begin scanint;s:=-curval;
if(curval<=0)or(curval>32768)then begin begin if interaction=3 then;
if filelineerrorstylep then printfileline else printnl(263);print(587);
end;begin helpptr:=1;helpline[0]:=588;end;interror(curval);s:=-1000;end;
...
then;if filelineerrorstylep then printfileline else printnl(263);
print(723);end;printesc(1243);print(1253);printesc(1244);print(1254);
...
if(eqtb[28521].int>0)then begin begindiagnostic;printnl(1274);
print(p-28206);print(1275);print(n);printchar(32);print(curval);
enddiagnostic(false);end;n:=n*256+curval;
if(a>=4)then geqdefine(p,135,n)else eqdefine(p,135,n);
if(p-28206)<eqtb[28519].int then if(a>=4)then geqworddefine(28519,p
-28206)else eqworddefine(28519,p-28206);
if(p-28206)>eqtb[28520].int then if(a>=4)then geqworddefine(28520,p
-28206)else eqworddefine(28520,p-28206);end else begin n:=curchr;
getrtoken;p:=curcs;
...
case n of 2:if(a>=4)then geqdefine(p,81,28523+curval)else eqdefine(p,81,
28523+curval);
3:if(a>=4)then geqdefine(p,82,29058+curval)else eqdefine(p,82,29058+
curval);
...
if filelineerrorstylep then printfileline else printnl(263);print(1138);
end;begin helpptr:=2;helpline[1]:=1276;helpline[0]:=1277;end;error;end;
...
curchr=28779 then n:=16777215 else n:=255{:1246};p:=curchr;scancharnum;
...
if((curval<m)and(p<28779))or(curval>n)then begin begin if interaction=3
then;if filelineerrorstylep then printfileline else printnl(263);
print(1278);end;printint(curval);if p<28779 then begin print(1279);
printint(m);print(1280);end else print(1281);printint(n);
if m=0 then begin begin helpptr:=1;helpline[0]:=1282;end;error;
end else begin begin helpptr:=1;helpline[0]:=1283;end;error;end;
curval:=m;end;
if p<27950 then if(a>=4)then geqdefine(p,135,curval)else eqdefine(p,135,
curval)else if p<28779 then if(a>=4)then geqdefine(p,135,curval)else
...
interaction=3 then;
if filelineerrorstylep then printfileline else printnl(263);print(718);
end;printesc(571);begin helpptr:=2;helpline[1]:=1289;helpline[0]:=1290;
...
if filelineerrorstylep then printfileline else printnl(263);print(1397);
end;printhex(curval);printchar(41);begin helpptr:=1;helpline[0]:=1398;
end;error;goto 10;
end else if(n<0)or(n>9)then begin begin if interaction=3 then;
if filelineerrorstylep then printfileline else printnl(263);print(1399);
end;printint(n);printchar(41);begin helpptr:=1;helpline[0]:=1398;end;
error;goto 10;
...
if filelineerrorstylep then printfileline else printnl(263);print(1421);
end;begin helpptr:=1;helpline[0]:=1398;end;error;goto 10;end;
if(a>=4)then geqdefine(26660+j,curval,n)else eqdefine(26660+j,curval,n);
end else begin begin if interaction=3 then;
if filelineerrorstylep then printfileline else printnl(263);print(1422);
end;printhex(n);printchar(41);begin helpptr:=1;helpline[0]:=1398;end;
...
if j=1000 then begin begin if interaction=3 then;
if filelineerrorstylep then printfileline else printnl(263);print(1428);
end;begin helpptr:=1;helpline[0]:=1398;end;error;goto 10;end;
if(p=1)or(p=2)then begin if(a>=4)then geqdefine(26916+j,p,n)else
eqdefine(26916+j,p,n);
if(a>=4)then geqworddefine(29314+j,curval)else eqworddefine(29314+j,
curval);end else confusion(532);
end else begin begin if interaction=3 then;
if filelineerrorstylep then printfileline else printnl(263);print(1429);
end;
if p=1 then print(1430)else if p=2 then print(1431)else printchar(63);
print(1432);printhex(n);printchar(41);begin helpptr:=1;
helpline[0]:=1398;end;error;goto 10;end;end;
...
longhelpseen then begin helpptr:=1;helpline[0]:=1310;
end else begin if interaction<3 then longhelpseen:=true;
begin helpptr:=4;helpline[3]:=1311;helpline[2]:=1312;helpline[1]:=1313;
helpline[0]:=1314;end;end;error;useerrhelp:=false;end{:1296};
...
printnl(1333);printint(curval);printchar(61);
if eqtb[25326+curval].hh.rh=-1073741823 then print(429)else showbox(eqtb
[25326+curval].hh.rh);end{:1309};0:{1307:}begin gettoken;
if interaction=3 then;printnl(1327);
if curcs<>0 then begin sprintcs(curcs);printchar(61);end;printmeaning;
goto 50;end{:1307};4:{1462:}begin printnl(1327);
if eqtb[25633].hh.rh>0 then print(1415)else print(1416);printnl(1327);
if eqtb[25634].hh.rh>0 then print(1417)else print(1418);goto 50;
end{:1462};others:{1310:}begin p:=thetoks;if interaction=3 then;
printnl(1327);tokenshow(memtop-3);flushlist(mem[memtop-3].hh.rh);
goto 50;end{:1310}end;{1311:}enddiagnostic(true);
begin if interaction=3 then;
if filelineerrorstylep then printfileline else printnl(263);print(1334);
end;if selector=19 then if eqtb[28491].int<=0 then begin selector:=17;
print(1335);selector:=19;end{:1311};
50:if interaction<3 then begin helpptr:=0;decr(errorcount);
end else if eqtb[28491].int>0 then begin begin helpptr:=3;
helpline[2]:=1322;helpline[1]:=1323;helpline[0]:=1324;end;
end else begin begin helpptr:=5;helpline[4]:=1322;helpline[3]:=1323;
helpline[2]:=1324;helpline[1]:=1325;helpline[0]:=1326;end;end;error;end;
...
end;begin helpptr:=1;helpline[0]:=1338;end;
begin if interaction=3 then interaction:=2;if logopened then error;
ifdef('TEXMF_DEBUG')if interaction>0 then debughelp;
endif('TEXMF_DEBUG')history:=3;jumpout;end;end{:1317};
{1341:}selector:=21;print(1354);print(jobname);printchar(32);
...
while not wopenout(fmtfile)do promptfilename(1355,836);printnl(1356);
...
printint(strptr);print(1339);printint(poolptr){:1322};{1324:}sortavail;
...
dumpint(varused);dumpint(dynused);println;printint(x);print(1340);
...
while j<29569 do begin if eqtb[j].int=eqtb[j+1].int then goto 42;
incr(j);end;l:=29570;goto 32;42:incr(j);l:=j;
while j<29569 do begin if eqtb[j].int<>eqtb[j+1].int then goto 32;
incr(j);end;32:dumpint(l-k);dumpthings(eqtb[k],l-k);k:=j+1;dumpint(k-l);
until k>29569;if hashhigh>0 then dumpthings(eqtb[29570],hashhigh);
...
if hashhigh>0 then dumpthings(hash[29570],hashhigh);dumpint(cscount);
println;printint(cscount);print(1341){:1331}{:1326};
...
for k:=0 to fontptr do begin printnl(1345);printesc(hash[15525+k].rh);
...
printint(fmemptr-7);print(1342);printint(fontptr-0);
if fontptr<>1 then print(1343)else print(1344){:1333};
...
printint(hyphcount);if hyphcount<>1 then print(1346)else print(1347);
...
dumpthings(hyfnext[1],trieopptr);printnl(1348);printint(triemax);
print(1349);printint(trieopptr);
if trieopptr<>1 then print(1350)else print(1351);print(1352);
printint(trieopsize);
for k:=255 downto 0 do if trieused[k]>0 then begin printnl(852);
printint(trieused[k]);print(1353);printint(k);dumpint(k);
...
others:confusion(1373)end;end;{:1361}{1389:}procedure fixlanguage;
var l:ASCIIcode;
...
if filelineerrorstylep then printfileline else printnl(263);print(1099);
...
incr(mem[q].hh.rh);d:=eqtb[29041].int;f:=eqtb[28504].int;unsave;
...
interaction=3 then;
if filelineerrorstylep then printfileline else printnl(263);print(1152);
...
=3 then;if filelineerrorstylep then printfileline else printnl(263);
print(1069);end;printesc(428);printint(255);begin helpptr:=3;
...
begin if interaction=3 then;
if filelineerrorstylep then printfileline else printnl(263);print(663);
end;printesc(953);print(664);begin helpptr:=1;helpline[0]:=1194;end;
...
if filelineerrorstylep then printfileline else printnl(263);print(1124);
...
curlist.tailfield].hh.rh:=newpenalty(eqtb[29314+kp].int);
curlist.tailfield:=mem[curlist.tailfield].hh.rh;end;
...
if fontdir[mainf]=4 then disp:=eqtb[29056].int-eqtb[29057].int else disp
:=eqtb[29056].int;mainf:=eqtb[25632].hh.rh;
end else begin if fontdir[mainf]=4 then disp:=0 else if fontdir[mainf]=3
then disp:=eqtb[29057].int-eqtb[29056].int else disp:=eqtb[29057].int;
...
eqtb[29314+kp].int else begin mainp:=mem[curq].hh.rh;
mem[curq].hh.rh:=newpenalty(eqtb[29314+kp].int);
...
tailfield].hh.rh:=newpenalty(eqtb[29314+kp].int);
curlist.tailfield:=mem[curlist.tailfield].hh.rh;end;
...
.tailfield+1].int:=mem[curlist.tailfield+1].int+eqtb[29314+kp].int else
begin begin mem[curlist.tailfield].hh.rh:=newpenalty(eqtb[29314+kp].int)
;curlist.tailfield:=mem[curlist.tailfield].hh.rh;end;
...
if curlist.dirfield=3 then disp:=eqtb[29056].int else disp:=eqtb[29057].
...
if hashextra<hashhigh then hashextra:=hashhigh;eqtbtop:=29569+hashextra;
...
eqtb[24526].hh.b1:=0;for x:=29570 to eqtbtop do eqtb[x]:=eqtb[24526];
undumpint(x);
...
mem:=zmem;undumpint(x);if x<>29569 then goto 6666;undumpint(x);
...
repeat undumpint(x);if(x<1)or(k+x>29570)then goto 6666;
undumpthings(eqtb[k],x);k:=k+x;undumpint(x);
if(x<0)or(k+x>29570)then goto 6666;
for j:=k to k+x-1 do eqtb[j]:=eqtb[k-1];k:=k+x;until k>29569;
if hashhigh>0 then undumpthings(eqtb[29570],hashhigh);{:1330};
...
if hashhigh>0 then begin undumpthings(hash[29570],hashhigh);
if debugformatfile then begin printcsnames(29570,hashhigh-(29570));end;
...
if totalpages<>1 then print(892)else print(893);print(328);
...
selector:=selector-2;if selector=17 then begin printnl(1357);
...
endfilereading;while openparens>0 do begin print(1358);decr(openparens);
end;if curlevel>1 then begin printnl(40);printesc(1359);print(1360);
printint(curlevel-1);printchar(41);end;
while condptr<>-1073741823 do begin printnl(40);printesc(1359);
print(1361);printcmdchr(120,curif);if ifline<>0 then begin print(1362);
printint(ifline);end;print(1363);ifline:=mem[condptr+1].int;
...
then begin selector:=17;printnl(1364);selector:=19;end;
...
goto 10;end;endif('INITEX')printnl(1365);goto 10;end;10:end;
...
primitive(494,81,28507);primitive(495,81,28518);primitive(496,81,28513);
primitive(497,81,28514);primitive(498,81,28515);primitive(499,81,28516);
primitive(500,81,28517);if mltexp then begin mltexenabledp:=true;
if false then primitive(501,81,28519);primitive(502,81,28520);
primitive(503,81,28521);end;{:244}{254:}primitive(507,82,29035);
primitive(508,82,29036);primitive(509,82,29037);primitive(510,82,29038);
...
primitive(526,82,29054);primitive(527,82,29056);primitive(528,82,29057);
primitive(529,82,29055);{:254}{271:}primitive(32,69,0);
primitive(47,48,0);primitive(540,49,0);primitive(541,103,0);
primitive(542,44,0);primitive(543,45,0);primitive(544,66,0);
primitive(545,20,0);primitive(546,54,0);primitive(536,122,0);
primitive(547,15,0);primitive(548,105,0);primitive(537,72,0);
primitive(549,67,0);hash[15516].rh:=549;eqtb[15516]:=eqtb[curval];
primitive(550,117,0);primitive(551,99,0);primitive(552,100,0);
primitive(553,101,0);primitive(554,85,0);primitive(555,36,0);
primitive(556,40,0);primitive(557,43,0);primitive(336,41,0);
primitive(359,22,0);primitive(558,50,0);primitive(559,21,0);
primitive(560,59,0);primitive(561,104,0);primitive(562,38,0);
primitive(563,70,0);primitive(564,118,0);primitive(341,60,0);
primitive(565,68,0);primitive(427,95,0);primitive(566,46,0);
primitive(567,91,0);primitive(568,71,0);primitive(569,109,0);
primitive(570,0,256);hash[15521].rh:=570;eqtb[15521]:=eqtb[curval];
primitive(571,111,0);primitive(572,124,0);primitive(426,79,0);
primitive(360,42,0);primitive(573,37,0);primitive(574,61,0);
primitive(575,39,0);{:271}{340:}primitive(632,13,256);parloc:=curval;
partoken:=536870911+parloc;{:340}{387:}primitive(667,119,0);
primitive(668,119,1);{:387}{395:}primitive(669,125,0);
primitive(670,125,1);primitive(671,125,2);primitive(672,125,3);
primitive(673,125,4);{:395}{422:}primitive(505,102,0);
primitive(531,102,1);primitive(414,102,2);primitive(415,102,3);
{:422}{427:}primitive(706,90,117);primitive(707,90,1);
primitive(708,93,0);primitive(709,93,1);primitive(710,94,1);
primitive(711,94,3);primitive(712,94,2);primitive(713,76,0);
primitive(714,76,1);primitive(715,76,2);primitive(716,76,3);
primitive(717,76,4);{:427}{479:}primitive(775,123,0);
primitive(776,123,1);primitive(777,123,3);primitive(778,123,4);
primitive(779,123,5);primitive(780,123,2);primitive(781,123,6);
primitive(782,123,7);primitive(783,123,8);primitive(784,123,9);
primitive(785,123,10);primitive(786,123,11);
{:479}{498:}primitive(802,120,0);primitive(803,120,1);
primitive(804,120,2);primitive(805,120,3);primitive(806,120,4);
primitive(807,120,5);primitive(808,120,6);primitive(809,120,7);
primitive(810,120,8);primitive(811,120,9);primitive(812,120,10);
primitive(813,120,11);primitive(814,120,12);primitive(815,120,13);
primitive(816,120,14);primitive(817,120,15);primitive(818,120,16);
primitive(819,120,17);primitive(820,120,18);primitive(821,120,19);
primitive(822,120,20);primitive(823,120,21);primitive(824,120,22);
primitive(825,120,23);{:498}{502:}primitive(826,121,2);
hash[15518].rh:=826;eqtb[15518]:=eqtb[curval];primitive(827,121,4);
primitive(828,121,3);{:502}{564:}primitive(853,98,0);
...
{:791}{994:}primitive(1024,92,0);primitive(1025,92,1);
primitive(1026,92,2);primitive(1027,92,3);primitive(1028,92,4);
primitive(1029,92,5);primitive(1030,92,6);primitive(1031,92,7);
{:994}{1064:}primitive(1080,14,0);primitive(1081,14,1);
{:1064}{1070:}primitive(1082,30,4);primitive(1083,30,0);
primitive(1084,30,1);primitive(1085,30,2);primitive(1086,30,3);
primitive(1087,31,4);primitive(1088,31,0);primitive(1089,31,1);
primitive(1090,31,2);primitive(1091,31,3);primitive(342,32,5);
primitive(346,33,1);primitive(348,34,99);
{:1070}{1083:}primitive(1109,25,1);primitive(1110,25,0);
primitive(1111,26,1);primitive(1112,26,0);primitive(428,24,0);
primitive(1113,24,1);primitive(1114,24,2);primitive(1019,24,3);
primitive(1115,24,4);primitive(1021,24,5);primitive(1116,24,121);
primitive(1117,78,3);primitive(1118,78,4);primitive(1119,78,1);
primitive(1120,35,99);primitive(1121,35,100);primitive(1122,35,101);
primitive(1123,35,102);{:1083}{1100:}primitive(1145,47,1);
primitive(1146,47,0);{:1100}{1119:}primitive(1157,29,14);
primitive(1158,29,13);primitive(1159,29,12);primitive(1160,27,0);
primitive(1161,27,1);primitive(1162,28,0);primitive(1163,28,1);
{:1119}{1126:}primitive(45,51,1);primitive(357,51,0);
{:1126}{1153:}primitive(1196,52,0);primitive(1197,52,1);
{:1153}{1168:}primitive(919,55,18);primitive(920,55,19);
primitive(921,55,20);primitive(922,55,21);primitive(923,55,22);
primitive(924,55,23);primitive(925,55,24);primitive(926,55,25);
primitive(928,55,28);primitive(927,55,29);primitive(1201,56,0);
primitive(931,56,1);primitive(932,56,2);
{:1168}{1181:}primitive(914,58,0);primitive(915,58,2);
primitive(916,58,4);primitive(917,58,6);
{:1181}{1190:}primitive(1219,57,0);primitive(1220,57,1);
primitive(1221,57,2);primitive(1222,57,3);primitive(1223,57,4);
primitive(1224,57,5);{:1190}{1200:}primitive(929,53,32);
primitive(930,53,33);hash[15517].rh:=930;eqtb[15517]:=eqtb[curval];
{:1200}{1220:}primitive(1243,106,1);primitive(1244,106,2);
primitive(1245,106,4);primitive(1246,110,0);primitive(1247,110,1);
primitive(1248,110,2);primitive(1249,110,3);
{:1220}{1231:}primitive(1263,107,0);primitive(1264,107,1);
{:1231}{1234:}primitive(1265,108,0);primitive(1266,108,8);
primitive(1267,108,1);primitive(1268,108,2);primitive(1269,108,3);
primitive(1270,108,4);primitive(1271,108,5);primitive(1272,108,6);
if mltexp then begin primitive(1273,108,7);end;
...
primitive(441,96,27438);primitive(442,96,27694);primitive(506,96,28779);
primitive(431,97,25583);primitive(432,97,25599);primitive(433,97,25615);
{:1242}{1263:}primitive(995,112,0);primitive(1007,112,1);
{:1263}{1267:}primitive(1295,86,0);primitive(1296,86,1);
{:1267}{1275:}primitive(273,113,0);primitive(274,113,1);
primitive(275,113,2);primitive(1305,113,3);
{:1275}{1285:}primitive(1306,65,1);primitive(1307,65,0);
{:1285}{1290:}primitive(1308,63,0);primitive(1309,63,1);
{:1290}{1299:}primitive(1315,62,27182);primitive(1316,62,27438);
{:1299}{1304:}primitive(1317,23,0);primitive(1318,23,1);
primitive(1319,23,2);primitive(1320,23,3);primitive(1321,23,4);
{:1304}{1357:}primitive(1367,64,0);primitive(629,64,1);writeloc:=curval;
primitive(1368,64,2);primitive(1369,64,3);hash[15524].rh:=1369;
eqtb[15524]:=eqtb[curval];primitive(1370,64,4);primitive(1371,64,5);
{:1357}{1420:}primitive(1396,81,28522);
{:1420}{1454:}primitive(439,89,0);{:1454}{1459:}primitive(1400,114,1);
primitive(1401,114,0);primitive(1402,114,3);primitive(1403,114,2);
primitive(1404,115,0);primitive(1405,115,1);primitive(1406,115,2);
{:1459}{1466:}primitive(1419,77,0);primitive(1420,88,26660);
{:1466}{1471:}primitive(1423,87,1);primitive(1424,87,2);{:1471};
...
printnl(1366);fflush(stdout);read(stdin,m);
...
memtop-membot+1);zmem:=yzmem-membot;eqtbtop:=29569+hashextra;
if hashextra=0 then hashtop:=24526 else hashtop:=eqtbtop;
yhash:=xmallocarray(twohalves,1+hashtop-hashoffset);
hash:=yhash-hashoffset;hash[514].lh:=0;hash[514].rh:=0;
...
{:112}{296:}if 536900480+hashextra>1073741823 then bad:=21;
...
write(stdout,'This is upTeX, Version 3.14159265','-p3.7','-u1.20')else
write(stdout,'This is upTeX, Version 3.14159265','-p3.7','-u1.20');
...
fontdir[0]:=0;fontnumext[0]:=0;fontname[0]:=853;fontarea[0]:=344;
