...
zprintcs ( integer p ) 
{
  ...
  if ( p < 514 ) {
	...
	printesc ( p - 257 ) ;
	if ( eqtb [26361 + p - 257 ].hh .v.RH == 11 ) 
	printchar ( 32 ) ;
      } 
    } 
    else if ( p < 1 ) 
  ...
  else if ( ( ( p >= 24527 ) && ( p <= 30050 ) ) || ( p > eqtbtop ) ) 
  printesc ( 544 ) ;
...
zshowtokenlist ( integer p , integer q , integer l ) 
{
  ...
  while ( ( p != -268435455L ) && ( tally < l ) ) {
    ...
    printcs ( mem [p ].hh .v.LH - 65535L ) ;
      ...
      {
	m = eqtb [26617 + kcatcodekey ( mem [p ].hh .v.LH ) ].hh .v.RH ;
	c = mem [p ].hh .v.LH ;
      } 
      else {
...
zshownodelist ( integer p ) 
{
  ...
  while ( p > memmin ) {
	...
	break ;
      case 1 : 
	{
	  printwritewhatsit ( 644 , p ) ;
	  printmark ( mem [p + 1 ].hh .v.RH ) ;
	} 
	break ;
      case 2 : 
	printwritewhatsit ( 1422 , p ) ;
	break ;
      case 3 : 
	{
	  printesc ( 1423 ) ;
...
{
  showbox_regmem 
  depththreshold = eqtb [28956 ].cint ;
  breadthmax = eqtb [28955 ].cint ;
  if ( breadthmax <= 0 ) 
  breadthmax = 5 ;
...
zflushnodelist ( halfword p ) 
{
  ...
  while ( p != -268435455L ) {
      ...
      case 30 : 
	{
	  ...
	  != 5 ) && ( mem [p + 1 ].hh .v.RH != 6 ) ) 
	  flushnodelist ( mem [p + 1 ].hh .v.LH ) ;
	  if ( mem [p + 2 ].hh .v.RH >= 2 && ( mem [p + 2 ].hh .v.RH != 5 
	  ) && ( mem [p + 2 ].hh .v.RH != 6 ) ) 
	  flushnodelist ( mem [p + 2 ].hh .v.LH ) ;
	  if ( mem [p + 3 ].hh .v.RH >= 2 && ( mem [p + 3 ].hh .v.RH != 5 
	  ) && ( mem [p + 3 ].hh .v.RH != 6 ) ) 
	...
	if ( memtop - 2 != pagetail ) 
	{
	  ...
	  if ( pagecontents > 0 ) 
	  {
	    ...
	    while ( r != memtop ) {
	      ...
	      printint ( t ) ;
	      print ( 1081 ) ;
	      if ( eqtb [29002 + t ].cint == 1000 ) 
	      t = mem [r + 3 ].cint ;
	      else t = xovern ( mem [r + 3 ].cint , 1000 ) * eqtb [29002 + 
	      t ].cint ;
	      printscaled ( t ) ;
	      if ( mem [r ].hh.b0 == 1 ) 
	      {
...
begindiagnostic ( void ) 
{
  ...
  oldsetting = selector ;
  if ( ( eqtb [28960 ].cint <= 0 ) && ( selector == 19 ) ) 
  {
    decr ( selector ) ;
    if ( history == 0 ) 
    history = 1 ;
...
zprintcmdchr ( quarterword cmd , halfword chrcode ) 
{
  ...
  case 79 : 
    if ( chrcode < 29002 ) 
    printparam ( chrcode - 28931 ) ;
    else {
	
      printesc ( 507 ) ;
      printint ( chrcode - 29002 ) ;
    } 
    break ;
  case 80 : 
    if ( chrcode < 29539 ) 
    printlengthparam ( chrcode - 29514 ) ;
    else {
	
      printesc ( 535 ) ;
      printint ( chrcode - 29539 ) ;
    } 
    break ;
  case 48 : 
    printesc ( 546 ) ;
  ...
  case 94 : 
    if ( chrcode == 26361 ) 
    printesc ( 436 ) ;
    else if ( chrcode == 26617 ) 
    printesc ( 437 ) ;
    else if ( chrcode == 26873 ) 
    printesc ( 438 ) ;
    else if ( chrcode == 28419 ) 
    printesc ( 445 ) ;
    else if ( chrcode == 28547 ) 
    printesc ( 1331 ) ;
    else if ( chrcode == 27651 ) 
    printesc ( 442 ) ;
    else if ( chrcode == 27907 ) 
    printesc ( 443 ) ;
    else if ( chrcode == 28163 ) 
    printesc ( 444 ) ;
    else if ( chrcode == 29258 ) 
    printesc ( 508 ) ;
    else printesc ( 1332 ) ;
    break ;
  case 95 : 
...
zshoweqtb ( halfword n ) 
{
  ...
  if ( n < 1 ) 
  printchar ( 63 ) ;
  else if ( ( n < 24528 ) || ( ( n > 30050 ) && ( n <= eqtbtop ) ) ) 
  {
    sprintcs ( n ) ;
    printchar ( 61 ) ;
...
{
  preparemag_regmem 
  if ( ( magset > 0 ) && ( eqtb [28948 ].cint != magset ) ) 
  {
    {
      if ( interaction == 3 ) 
      ;
    ...
    interror ( magset ) ;
    geqworddefine ( 28948 , magset ) ;
  } 
  if ( ( eqtb [28948 ].cint <= 0 ) || ( eqtb [28948 ].cint > 32768L ) ) 
  {
    {
      if ( interaction == 3 ) 
      ;
    ...
    interror ( eqtb [28948 ].cint ) ;
    geqworddefine ( 28948 , 1000 ) ;
  } 
  magset = eqtb [28948 ].cint ;
} 
void 
...
showcontext ( void ) 
{
  ...
  while ( true ) {
    ...
    if ( ( baseptr == inputptr ) || bottomline || ( nn < eqtb [28986 ].cint 
    ) ) 
    {
	...
	if ( curinput .statefield != 0 ) 
	{
	  ...
	  if ( buffer [curinput .limitfield ]== eqtb [28980 ].cint ) 
...
getnext ( void ) 
{
  ...
  if ( curinput .statefield != 0 ) 
  {
	...
	, curinput .locfield - 1 ) ;
	curcmd = eqtb [26617 + kcatcodekey ( curchr ) ].hh .v.RH ;
	incr ( curinput .locfield ) ;
      } 
      else lab21: curcmd = eqtb [26361 + curchr ].hh .v.RH ;
      ...
      case 58 : 
	{
	  ...
	  curcs = 513 ;
	    ...
	    1 , k - 1 ) == 2 ) 
	    {
	      cat = eqtb [26617 + kcatcodekey ( fromBUFF ( ustringcast ( 
	      buffer ) , curinput .limitfield + 1 , k - 1 ) ) ].hh .v.RH ;
	      incr ( k ) ;
	    } 
	    else cat = eqtb [26361 + curchr ].hh .v.RH ;
	...
	if ( ! forceeof ) {
	  ...
	  if ( curinput .namefield <= 19 ) 
	  {
	    if ( pseudoinput () ) 
	    firmuptheline () ;
	    else if ( ( eqtb [25071 ].hh .v.RH != -268435455L ) && ! eofseen 
	    [curinput .indexfield ]) 
	    {
  ...
  else if ( curinput .locfield != -268435455L ) 
  {
    ...
    {
      curchr = t ;
      curcmd = eqtb [26617 + kcatcodekey ( t ) ].hh .v.RH ;
    } 
    else {
...
zeffectivechar ( boolean errp , internalfontnumber f , quarterword c ) 
{
  ...
  if ( c >= eqtb [28988 ].cint ) {
      
    if ( c <= eqtb [28989 ].cint ) {
	
      if ( ( eqtb [28675 + c ].hh .v.RH > 0 ) ) 
      {
	basec = ( eqtb [28675 + c ].hh .v.RH % 256 ) ;
	result = basec ;
	if ( ! errp ) 
	goto lab40 ;
	if ( fontec [f ]>= basec ) {
...
zgetinhibitpos ( KANJIcode c , smallnumber n ) 
{
  ...
  {
    do {
	if ( ( eqtb [27129 + p ].hh .v.RH == 0 ) || ( eqtb [27129 + p ]
      .hh .v.RH == c ) ) 
      goto lab30 ;
      incr ( p ) ;
      if ( p > 255 ) 
    ...
    do {
	if ( eqtb [27129 + p ].hh .v.RH == 0 ) 
      goto lab31 ;
      if ( eqtb [27129 + p ].hh .v.RH == c ) 
      goto lab30 ;
      incr ( p ) ;
      if ( p > 255 ) 
      p = 0 ;
...
zgetkinsokupos ( KANJIcode c , smallnumber n ) 
{
  ...
  {
    do {
	if ( ( eqtb [27385 + p ].hh.b0 == 0 ) || ( eqtb [27385 + p ].hh 
      .v.RH == c ) ) 
      goto lab30 ;
      incr ( p ) ;
      if ( p > 255 ) 
    ...
    do {
	if ( eqtb [27385 + p ].hh.b0 == 0 ) 
      goto lab31 ;
      if ( eqtb [27385 + p ].hh .v.RH == c ) 
      goto lab30 ;
      incr ( p ) ;
      if ( p > 255 ) 
      p = 0 ;
...
zscansomethinginternal ( smallnumber level , boolean negative ) 
{
  ...
  {case 85 : 
    {
      ...
      curvallevel = 0 ;
      curval = 0 ;
      if ( ( q != 1000 ) && ( m == eqtb [27385 + q ].hh.b0 ) ) 
      {
	curval = eqtb [29795 + q ].cint ;
	curvallevel = 0 ;
      } 
    } 
    break ;
  ...
  case 94 : 
    {
      ...
      if ( m == 28419 ) 
      {
	curval1 = eqtb [28419 + curval ].hh .v.RH ;
	...
	) * 65536L + ( curval1 % 256 ) ;
	{
      ...
      {
	curval1 = eqtb [29258 + curval ].cint ;
  ...
  case 93 : 
	...
	curval = 0 ;
      ...
      else if ( eqtb [25061 ].hh .v.RH == -268435455L ) 
      curval = 0 ;
  ...
  case 92 : 
	...
	qx = q ;
	while ( ( q != -268435455L ) && ( ( ( mem [q ].hh.b1 ) % 8 ) != abs 
  ...
  case 100 : 
	...
	{case 0 : 
	  curval = eqtb [29002 + curval ].cint ;
	  break ;
	case 1 : 
	  curval = eqtb [29539 + curval ].cint ;
	  break ;
	case 2 : 
  ...
  case 74 : 
	...
	case 24 : 
	  {
	    q = curchr - 22 ;
	    scanint () ;
	    if ( ( eqtb [25061 ].hh .v.RH == -268435455L ) || ( curval <= 0 
	    ) ) 
	    curval = 0 ;
	    else {
	...
	curval = mem [mem [tx ].hh .v.RH ].hh .v.LH ;
      ...
      case 4 : 
	{
	  ...
	  if ( ! ( tx >= himemmin ) ) 
	  {
	    ...
	    {
	      r = mem [tx + 1 ].hh .v.RH ;
	      while ( mem [r ].hh .v.RH != -268435455L ) r = mem [r ].hh 
	      .v.RH ;
	      curval = mem [r ].hh.b1 ;
	    } 
	  } 
...
zscandimen ( boolean mu , boolean inf , boolean shortcut ) 
{
  ...
  else if ( scankeyword ( 773 ) ) 
  v = ( fontinfo [5 + parambase [eqtb [25588 ].hh .v.RH ]].cint ) ;
  else if ( scankeyword ( 774 ) ) {
  ...
  {
    preparemag () ;
    if ( eqtb [28948 ].cint != 1000 ) 
    {
      curval = xnoverd ( curval , 1000 , eqtb [28948 ].cint ) ;
      f = ( 1000 * f + 65536L * texremainder ) / eqtb [28948 ].cint ;
  ...
  else if ( scankeyword ( 782 ) ) 
  {
    num = 12 ;
    denom = 1 ;
  } 
  else if ( scankeyword ( 783 ) ) 
  {
    num = 7227 ;
    denom = 254 ;
  } 
  else if ( scankeyword ( 784 ) ) 
  {
    num = 7227 ;
    denom = 2540 ;
  } 
  else if ( scankeyword ( 785 ) ) 
  {
    num = 7227 ;
    denom = 7200 ;
  } 
  else if ( scankeyword ( 786 ) ) 
  {
    num = 1238 ;
    denom = 1157 ;
  } 
...
conditional ( void ) 
{
  ...
  case 5 : 
    ...
    break ;
  case 6 : 
    b = ( abs ( curlist .modefield ) == 114 ) ;
    break ;
  case 7 : 
    b = ( abs ( curlist .modefield ) == 227 ) ;
    break ;
  case 8 : 
  ...
  case 27 : 
    {
      ...
      b = ( ( curcmd != 113 ) && ( m != 0 ) && ( curcmd == primeqtb [m ]
  ...
  case 18 : 
	...
	if ( checkkanji ( mem [p ].hh .v.LH ) ) 
	{
	  buffer [m ]= Hi ( mem [p ].hh .v.LH ) ;
	  incr ( m ) ;
	} 
	buffer [m ]= Lo ( mem [p ].hh .v.LH ) ;
	incr ( m ) ;
	p = mem [p ].hh .v.RH ;
      } 
      if ( m > first + 1 ) 
...
openlogfile ( void ) 
{
  ...
  logopened = true ;
  {
    ...
    fprintf ( logfile , "%s%s%s%s",  "This is e-pTeX, Version 3.14159265" , "-p3.7" ,     "-150805" , "-2.6" ) ;
    else
    fprintf ( logfile , "%s%s%s%s",  "This is e-pTeX, Version 3.14159265" , "-p3.7" ,     "-150805" , "-2.6" ) ;
    Fputs ( logfile ,  " (" ) ;
    ...
    {register integer for_end; k = 3 * eqtb [28953 ].cint - 2 ;for_end = 3 
    * eqtb [28953 ].cint ; if ( k <= for_end) do 
      putc ( months [k ],  logfile );
    while ( k++ < for_end ) ;} 
    printchar ( 32 ) ;
    printint ( eqtb [28954 ].cint ) ;
    printchar ( 32 ) ;
    printtwo ( eqtb [28951 ].cint / 60 ) ;
    printchar ( 58 ) ;
    printtwo ( eqtb [28951 ].cint % 60 ) ;
    if ( ( eTeXmode == 1 ) ) 
    {
...
zreadfontinfo ( halfword u , strnumber nom , strnumber aire , scaled s ) 
{
  ...
  hyphenchar [f ]= eqtb [28978 ].cint ;
  skewchar [f ]= eqtb [28979 ].cint ;
  if ( bchlabel < nl ) 
...
zcharwarning ( internalfontnumber f , eightbits c ) 
{
  ...
  unsigned char l  ;
  integer oldsetting  ;
  if ( eqtb [28966 ].cint > 0 ) 
  {
    oldsetting = eqtb [28960 ].cint ;
    if ( ( eTeXmode == 1 ) && ( eqtb [28966 ].cint > 1 ) ) 
    eqtb [28960 ].cint = 1 ;
    {
      begindiagnostic () ;
      printnl ( 917 ) ;
...
zspecialout ( halfword p ) 
{
  ...
  goto lab30 ;
  geqworddefine ( 29537 , cw ) ;
  geqworddefine ( 29538 , t ) ;
  curpageheight = t ;
  curpagewidth = cw ;
...
zoutwhat ( halfword p ) 
{
  ...
  case 2 : 
	...
	else if ( j < 16 ) 
	{
	  ...
	  aopenout ( writefile [j ]) ) promptfilename ( 1445 , 881 ) ;
	  writeopen [j ]= true ;
	  if ( logopened ) 
	  {
	    oldsetting = selector ;
  ...
  case 6 : 
	...
	break ;
      ...
      {case 3 : 
      case 1 : 
	pdflastypos = curpagewidth - pdflastypos - 4736286L ;
	break ;
      case 4 : 
...
*              curg = round ( gluetemp ) ;
  ...
  lab30: if ( ( l != -268435455L ) && ( mem [l ].hh.b0 != 5 ) ) 
  {
    p = getnode ( 2 ) ;
    mem [p ].hh.b0 = 5 ;
    mem [p + 1 ].cint = disp ;
...
zadjusthlist ( halfword p , boolean pf ) 
{
  ...
  while ( p != -268435455L ) {
	  ...
	  if ( fontdir [mem [p ].hh.b0 ]!= 0 ) 
	{
	  ...
	  if ( insertskip == 1 ) 
	  {
		...
		if ( ( eqtb [27129 + x ].hh.b0 == 0 ) || ( eqtb [27129 + x 
		].hh.b0 == 1 ) ) 
		doins = false ;
		else doins = true ;
	      } 
      ...
      case 8 : 
	{
	  ...
	  if ( ( t >= himemmin ) ) 
	  {
		...
		if ( x != 1000 ) {
		  ...
		  if ( ( eqtb [27129 + x ].hh.b0 == 0 ) || ( eqtb [27129 + 
		  x ].hh.b0 == 2 ) ) 
		  doins = false ;
		  else doins = true ;
		} 
  ...
  if ( ( v != -268435455L ) && pf && ( i > 5 ) ) 
  {
	...
	{
	  cx = mem [mem [p ].hh .v.RH ].hh .v.LH ;
	  i = eqtb [26617 + kcatcodekey ( cx ) ].hh .v.RH ;
	  k = 0 ;
	  if ( ( i == 16 ) || ( i == 17 ) ) 
	  {
	    t = q ;
    ...
    if ( s != -268435455L ) 
    {
      ...
      mem [s + 1 ].cint = mem [s + 1 ].cint + eqtb [28987 ].cint ;
      else if ( eqtb [28987 ].cint != 0 ) 
      {
	s = newpenalty ( eqtb [28987 ].cint ) ;
	mem [s ].hh.b1 = 1 ;
	...
	if ( mltexenabledp ) 
	{
	  if ( c >= eqtb [28988 ].cint ) {
	    ...
	    if ( c <= eqtb [28989 ].cint ) {
	      ...
	      {
		basec = ( eqtb [28675 + c ].hh .v.RH % 256 ) ;
		accentc = ( eqtb [28675 + c ].hh .v.RH / 256 ) ;
		if ( ( fontec [f ]>= basec ) ) {
...
zshipout ( halfword p ) 
{
  ...
  unsigned char oldsetting  ;
  scaled t  ;
  synctexsheet ( eqtb [28948 ].cint ) ;
  {
    if ( eqtb [28965 ].cint > 0 ) 
    {
      printnl ( 343 ) ;
      println () ;
      print ( 922 ) ;
    ...
    printchar ( 91 ) ;
    j = 9 ;
    while ( ( eqtb [29002 + j ].cint == 0 ) && ( j > 0 ) ) decr ( j ) ;
    {register integer for_end; k = 0 ;for_end = j ; if ( k <= for_end) do 
      {
	printint ( eqtb [29002 + k ].cint ) ;
	if ( k < j ) 
	printchar ( 46 ) ;
      } 
    while ( k++ < for_end ) ;} 
    ...
    29533 ].cint > 1073741823L ) || ( mem [p + 1 ].cint + eqtb [29532 ]
    .cint > 1073741823L ) ) 
    {
      {
	if ( interaction == 3 ) 
    ...
    if ( mem [p + 3 ].cint + mem [p + 2 ].cint + eqtb [29533 ].cint > 
    maxv ) 
    maxv = mem [p + 3 ].cint + mem [p + 2 ].cint + eqtb [29533 ].cint ;
    if ( mem [p + 1 ].cint + eqtb [29532 ].cint > maxh ) 
    maxh = mem [p + 1 ].cint + eqtb [29532 ].cint ;
    if ( eqtb [29538 ].cint != 0 ) 
    curpageheight = eqtb [29538 ].cint ;
    else curpageheight = mem [p + 3 ].cint + mem [p + 2 ].cint + 2 * eqtb 
    [29533 ].cint + 2 * 4736286L ;
    if ( eqtb [29537 ].cint != 0 ) 
    curpagewidth = eqtb [29537 ].cint ;
    else curpagewidth = mem [p + 1 ].cint + 2 * eqtb [29532 ].cint + 2 * 
    4736286L ;
    if ( ( mem [p ].hh.b0 == 2 ) ) {
    ...
    if ( outputfilename == 0 ) 
    {
      ...
      openlogfile () ;
      packjobname ( 885 ) ;
      while ( ! bopenout ( dvifile ) ) promptfilename ( 886 , 885 ) ;
	...
	printint ( eqtb [28954 ].cint ) ;
	printchar ( 46 ) ;
	printtwo ( eqtb [28953 ].cint ) ;
	printchar ( 46 ) ;
	printtwo ( eqtb [28952 ].cint ) ;
	printchar ( 58 ) ;
	printtwo ( eqtb [28951 ].cint / 60 ) ;
	printtwo ( eqtb [28951 ].cint % 60 ) ;
	selector = oldsetting ;
    ...
    {register integer for_end; k = 0 ;for_end = 9 ; if ( k <= for_end) do 
      dvifour ( eqtb [29002 + k ].cint ) ;
    while ( k++ < for_end ) ;} 
    dvifour ( lastbop ) ;
    lastbop = pageloc ;
    curv = mem [p + 3 ].cint + eqtb [29533 ].cint ;
    tempptr = p ;
    switch ( mem [p ].hh.b0 ) 
    {case 0 : 
      hlistout () ;
...
zhpack ( halfword p , scaled w , smallnumber m ) 
{
  ...
  else if ( x > 0 ) 
  {
	...
	if ( lastbadness > eqtb [28957 ].cint ) 
	{
	  println () ;
	  if ( lastbadness > 100 ) 
	  printnl ( 937 ) ;
    ...
    ].hh .v.RH != -268435455L ) ) 
    {
      ...
      mem [r + 6 ].gr = 1.0 ;
      if ( ( - (integer) x - totalshrink [0 ]> eqtb [29522 ].cint ) || ( 
      eqtb [28957 ].cint < 100 ) ) 
      {
	if ( ( eqtb [29530 ].cint > 0 ) && ( - (integer) x - totalshrink [0 
	]> eqtb [29522 ].cint ) ) 
	{
	  while ( mem [q ].hh .v.RH != -268435455L ) q = mem [q ].hh .v.RH 
	  ;
	  mem [q ].hh .v.RH = newrule () ;
	  mem [mem [q ].hh .v.RH + 1 ].cint = eqtb [29530 ].cint ;
	} 
	println () ;
	printnl ( 945 ) ;
...
zvpackage ( halfword p , scaled h , smallnumber m , scaled l ) 
{
  ...
  else if ( x > 0 ) 
  {
    ...
    if ( o == 0 ) {
      ...
      {
	lastbadness = badness ( x , totalstretch [0 ]) ;
	if ( lastbadness > eqtb [28958 ].cint ) 
	{
	  println () ;
	  if ( lastbadness > 100 ) 
	  printnl ( 937 ) ;
    ...
    ].hh .v.RH != -268435455L ) ) 
    {
      lastbadness = 1000000L ;
      mem [r + 6 ].gr = 1.0 ;
      if ( ( - (integer) x - totalshrink [0 ]> eqtb [29523 ].cint ) || ( 
      eqtb [28958 ].cint < 100 ) ) 
      {
	println () ;
	printnl ( 950 ) ;
...
zmakeord ( halfword q ) 
{
  ...
  0 ) && ( ( mem [q + 1 ].hh .v.RH == 1 ) || ( mem [q + 1 ].hh .v.RH == 5 
  ) ) ) 
  {
    p = mem [q ].hh .v.RH ;
    if ( p != -268435455L ) {
...
zmakescripts ( halfword q , scaled delta ) 
{
  ...
  if ( mem [q + 2 ].hh .v.RH == 0 ) 
  {
    ...
    mem [x + 1 ].cint = mem [x + 1 ].cint + eqtb [29526 ].cint ;
    ...
    mem [x + 4 ].cint = - (integer) shiftup ;
      ...
      .v.LH ) ;
      mem [y + 1 ].cint = mem [y + 1 ].cint + eqtb [29526 ].cint ;
...
zmakeleftright ( halfword q , smallnumber style , scaled maxd , scaled maxh ) 
{
  ...
  if ( delta2 > delta1 ) 
  delta1 = delta2 ;
  delta = ( delta1 / 500 ) * eqtb [28949 ].cint ;
  delta2 = delta1 + delta1 - eqtb [29524 ].cint ;
  if ( delta < delta2 ) 
  delta = delta2 ;
...
mlisttohlist ( void ) 
{
  ...
  while ( q != -268435455L ) {
	...
	if ( ( curi .b0 > 0 ) ) 
	{
	  ...
	  if ( ( ( mem [q + 1 ].hh .v.RH == 4 ) || ( mem [q + 1 ].hh .v.RH 
	  == 6 ) ) && ( fontinfo [2 + parambase [curf ]].cint != 0 ) ) 
	  delta = 0 ;
...
getpreambletoken ( void ) 
{
  ...
  if ( curcmd == 9 ) 
  fatalerror ( 645 ) ;
  if ( ( curcmd == 81 ) && ( curchr == 24539 ) ) 
  {
    scanoptionalequals () ;
    scanglue ( 2 ) ;
    if ( eqtb [28974 ].cint > 0 ) 
    geqdefine ( 24539 , 129 , curval ) ;
    else eqdefine ( 24539 , 129 , curval ) ;
    goto lab20 ;
  } 
} 
void 
initalign ( void ) 
{
  ...
  pushalignment () ;
  alignstate = -1000000L ;
  if ( ( curlist .modefield == 227 ) && ( ( curlist .tailfield != curlist 
...
finalign ( void ) 
{
  ...
  confusion ( 1011 ) ;
  unsave () ;
  if ( nest [nestptr - 1 ].modefield == 227 ) 
  o = eqtb [29529 ].cint ;
  else o = 0 ;
  ...
  if ( curlist .modefield == 227 ) 
  {
    ...
    popnest () ;
    {
      mem [curlist .tailfield ].hh .v.RH = newpenalty ( eqtb [28942 ].cint 
      ) ;
      curlist .tailfield = mem [curlist .tailfield ].hh .v.RH ;
    } 
    {
    ...
    curlist .tailfield = q ;
    {
      mem [curlist .tailfield ].hh .v.RH = newpenalty ( eqtb [28943 ].cint 
      ) ;
      curlist .tailfield = mem [curlist .tailfield ].hh .v.RH ;
    } 
    {
...
ztrybreak ( integer pi , smallnumber breaktype ) 
{
  ...
  while ( true ) {
	...
	r == memtop - 7 ) ) ) 
	{
	  ...
	  if ( abs ( eqtb [28947 ].cint ) >= 1073741823L - minimumdemerits ) 
	  minimumdemerits = 1073741822L ;
	  else minimumdemerits = minimumdemerits + abs ( eqtb [28947 ].cint 
	  ) ;
	...
	( curactivewidth [5 ]!= 0 ) || ( curactivewidth [6 ]!= 0 ) ) 
	{
	  if ( dolastlinefit ) 
	  {
	    if ( curp == -268435455L ) 
	    {
	      ...
	      1073741823L ) ;
	      if ( eqtb [28998 ].cint < 1000 ) 
	      g = fract ( g , eqtb [28998 ].cint , 1000 , 1073741823L ) ;
	      if ( aritherror ) {
...
zpostlinebreak ( boolean d ) 
{
  ...
  do {
	...
	if ( d ) 
	pen = pen + eqtb [28938 ].cint ;
	else pen = pen + eqtb [28937 ].cint ;
      } 
      if ( discbreak ) 
      pen = pen + eqtb [28939 ].cint ;
      if ( pen != 0 ) 
      {
	r = newpenalty ( pen ) ;
...
showsavegroups ( void ) 
{
  ...
  while ( true ) {
	...
	if ( m == 227 ) 
	printchar ( 36 ) ;
	else if ( nest [p ].modefield == 227 ) 
	{
	  printcmdchr ( 51 , savestack [saveptr - 2 ].cint ) ;
	  goto lab40 ;
	} 
	printchar ( 36 ) ;
	goto lab40 ;
	...
	printchar ( 61 ) ;
      ...
      else printcmdchr ( 34 , i - ( 1073872797L ) ) ;
    } 
    lab41: printesc ( s ) ;
...
zvsplit ( halfword n , scaled h ) 
{
  ...
  q = vertbreak ( mem [v + 5 ].hh .v.RH , h , eqtb [29520 ].cint ) ;
  p = mem [v + 5 ].hh .v.RH ;
  if ( p == q ) 
  ...
  lab30: ;
  q = prunepagetop ( q , eqtb [28999 ].cint > 0 ) ;
  p = mem [v + 5 ].hh .v.RH ;
  if ( q != -268435455L ) 
  {
  ...
  q = vpackage ( p , h , 0 , eqtb [29520 ].cint ) ;
  mem [q ].hh.b1 = ( ( mem [q ].hh.b1 ) / 8 ) * 8 + ( ( mem [v ].hh.b1 ) 
  % 8 ) ;
...
zfreezepagespecs ( smallnumber s ) 
{
  ...
  pagecontents = s ;
  pagesofar [0 ]= eqtb [29518 ].cint ;
  pagemaxdepth = eqtb [29519 ].cint ;
  pagesofar [8 ]= 0 ;
  pagesofar [1 ]= 0 ;
  pagesofar [2 ]= 0 ;
  pagesofar [3 ]= 0 ;
...
zboxerror ( eightbits n ) 
{
  ...
  eqtb [25332 + n ].hh .v.RH = -268435455L ;
} 
void 
...
zfireup ( halfword c ) 
{
  ...
  {
    geqworddefine ( 28970 , mem [bestpagebreak + 1 ].cint ) ;
    mem [bestpagebreak + 1 ].cint = 10000 ;
  } 
  else geqworddefine ( 28970 , 10000 ) ;
  if ( saroot [6 ]!= -268435455L ) {
  ...
  if ( eqtb [25587 ].hh .v.RH != -268435455L ) 
  {
    {
      if ( interaction == 3 ) 
      ;
  ...
  if ( eqtb [28985 ].cint <= 0 ) 
  {
	...
	n = mem [r ].hh.b1 ;
	ensurevbox ( n ) ;
	if ( eqtb [25332 + n ].hh .v.RH == -268435455L ) 
  ...
  savevbadness = eqtb [28958 ].cint ;
  eqtb [28958 ].cint = 10000 ;
  savevfuzz = eqtb [29523 ].cint ;
  eqtb [29523 ].cint = 1073741823L ;
  ...
  eqtb [28958 ].cint = savevbadness ;
  eqtb [29523 ].cint = savevfuzz ;
  if ( lastglue != 268435455L ) 
...
buildpage ( void ) 
{
  ...
  do {
	...
	if ( mem [r ].hh.b1 != n ) 
	{
	  ...
	  if ( eqtb [29002 + n ].cint == 1000 ) 
	  h = mem [r + 3 ].cint ;
	  else h = xovern ( mem [r + 3 ].cint , 1000 ) * eqtb [29002 + n ]
	  .cint ;
	...
	insertpenalties = insertpenalties + mem [p + 1 ].cint ;
	  ...
	  if ( eqtb [29002 + n ].cint == 1000 ) 
	  h = mem [p + 3 ].cint ;
	  else h = xovern ( mem [p + 3 ].cint , 1000 ) * eqtb [29002 + n ]
	  .cint ;
	  if ( ( ( h <= 0 ) || ( h <= delta ) ) && ( mem [p + 3 ].cint + mem 
	  [r + 3 ].cint <= eqtb [29539 + n ].cint ) ) 
	  {
	    ...
	    if ( eqtb [29002 + n ].cint <= 0 ) 
	    w = 1073741823L ;
	    else {
		
	      w = pagesofar [0 ]- pagesofar [1 ]- pagesofar [8 ];
	      if ( eqtb [29002 + n ].cint != 1000 ) 
	      w = xovern ( w , eqtb [29002 + n ].cint ) * 1000 ;
	    } 
	    if ( w > eqtb [29539 + n ].cint - mem [r + 3 ].cint ) 
	    w = eqtb [29539 + n ].cint - mem [r + 3 ].cint ;
...
itsallover ( void ) 
{
  ...
  if ( privileged () ) 
  {
    ...
    mem [curlist .tailfield + 1 ].cint = eqtb [29517 ].cint ;
    {
...
normalparagraph ( void ) 
{
  ...
  eqworddefine ( 28950 , 0 ) ;
  if ( eqtb [29531 ].cint != 0 ) 
  eqworddefine ( 29531 , 0 ) ;
  if ( eqtb [28972 ].cint != 1 ) 
  eqworddefine ( 28972 , 1 ) ;
  if ( eqtb [25061 ].hh .v.RH != -268435455L ) 
  eqdefine ( 25061 , 130 , -268435455L ) ;
  if ( eqtb [25328 ].hh .v.RH != -268435455L ) 
  eqdefine ( 25328 , 130 , -268435455L ) ;
} 
void 
zboxend ( integer boxcontext ) 
{
  ...
  else if ( boxcontext < 1073872896L ) 
  {
    ...
    if ( curval < 256 ) {
      ...
      if ( ( a >= 4 ) ) 
      geqdefine ( 25332 + curval , 131 , curbox ) ;
      else eqdefine ( 25332 + curval , 131 , curbox ) ;
    } 
    else {
...
zbeginbox ( integer boxcontext ) 
{
  ...
  {case 0 : 
	...
	curbox = -268435455L ;
      ...
      if ( curval < 256 ) 
      eqtb [25332 + curval ].hh .v.RH = -268435455L ;
      else {
...
zscanbox ( integer boxcontext ) 
{
  ...
  if ( curcmd == 23 ) 
  beginbox ( boxcontext ) ;
  else if ( ( boxcontext >= 1073872897L ) && ( ( curcmd == 39 ) || ( curcmd == 
  38 ) ) ) 
  {
    curbox = scanrulespec () ;
    boxend ( boxcontext ) ;
...
znewgraf ( boolean indented ) 
{
  ...
  curlist .pgfield = ( normmin ( eqtb [28983 ].cint ) * 64 + normmin ( eqtb 
  [28984 ].cint ) ) * 65536L + curlang ;
  if ( indented ) 
  {
    curlist .tailfield = newnullbox () ;
    mem [curlist .headfield ].hh .v.RH = curlist .tailfield ;
    mem [curlist .tailfield + 1 ].cint = eqtb [29514 ].cint ;
...
unpackage ( void ) 
{
  ...
  if ( mem [p ].hh.b0 == 2 ) 
  p = mem [p + 5 ].hh .v.RH ;
  if ( ( abs ( curlist .modefield ) == 227 ) || ( ( abs ( curlist .modefield ) 
...
builddiscretionary ( void ) 
{
  ...
  case 2 : 
    {
      if ( ( n > 0 ) && ( abs ( curlist .modefield ) == 227 ) ) 
      {
	{
	  if ( interaction == 3 ) 
	  ;
...
makeaccent ( void ) 
{
  ...
  if ( p != -268435455L ) 
  {
    ...
    if ( curlist .dirfield == 3 ) 
    {
      ...
      disp = eqtb [29535 ].cint - eqtb [29536 ].cint ;
      else disp = eqtb [29535 ].cint ;
    } 
    else {
      ...
      disp = eqtb [29536 ].cint - eqtb [29535 ].cint ;
      else disp = eqtb [29536 ].cint ;
    } 
    {
      if ( ! ( curlist .tailfield >= himemmin ) && ( mem [curlist .tailfield 
      ].hh.b0 == 5 ) ) 
...
initmath ( void ) 
{
  ...
  if ( ( curcmd == 3 ) && ( curlist .modefield > 0 ) ) 
  {
    ...
    if ( eqtb [25061 ].hh .v.RH == -268435455L ) {
      ...
      if ( ( eqtb [29531 ].cint != 0 ) && ( ( ( eqtb [28972 ].cint >= 0 ) 
      && ( curlist .pgfield + 2 > eqtb [28972 ].cint ) ) || ( curlist 
      .pgfield + 1 < - (integer) eqtb [28972 ].cint ) ) ) 
      {
	l = eqtb [29517 ].cint - abs ( eqtb [29531 ].cint ) ;
	if ( eqtb [29531 ].cint > 0 ) 
	s = eqtb [29531 ].cint ;
	else s = 0 ;
      } 
    ...
    pushmath ( 15 ) ;
    curlist .modefield = 227 ;
    eqworddefine ( 28975 , -1 ) ;
    eqworddefine ( 29527 , w ) ;
    curlist .eTeXauxfield = j ;
    if ( ( eTeXmode == 1 ) ) 
    eqworddefine ( 28997 , x ) ;
    eqworddefine ( 29528 , l ) ;
...
zscanmath ( halfword p , halfword q ) 
{
  ...
  if ( cx == 0 ) 
  {
    mem [p ].hh .v.RH = 1 ;
    mem [p ].hh.b1 = c % 256 ;
    if ( ( c >= 458752L ) && ( ( ( eqtb [28975 ].cint >= 0 ) && ( eqtb [
    28975 ].cint < 256 ) ) ) ) 
    mem [p ].hh.b0 = eqtb [28975 ].cint ;
...
zsetmathchar ( integer c ) 
{
  ...
  if ( c >= 524288L ) 
  {
    ...
    if ( c >= 458752L ) 
    {
      if ( ( ( eqtb [28975 ].cint >= 0 ) && ( eqtb [28975 ].cint < 256 ) ) 
      ) 
      mem [p + 1 ].hh.b0 = eqtb [28975 ].cint ;
      mem [p ].hh.b0 = 18 ;
    } 
...
zscandelimiter ( halfword p , boolean r ) 
{
  ...
  scanfiftyonebitint () ;
    ...
    case 12 : 
      {
	curval = eqtb [29258 + curchr ].cint ;
	curval1 = getintone ( eqtb [29258 + curchr ]) ;
      } 
      break ;
    case 15 : 
      if ( curchr == 0 ) 
...
mathac ( void ) 
{
  ...
  if ( ( curval >= 458752L ) && ( ( eqtb [28975 ].cint >= 0 ) && ( eqtb [
  28975 ].cint < 256 ) ) ) 
  mem [curlist .tailfield + 5 ].hh.b0 = eqtb [28975 ].cint ;
...
aftermath ( void ) 
{
  ...
  if ( m < 0 ) 
  {
    ...
    {
      mem [curlist .tailfield ].hh .v.RH = newmath ( eqtb [29515 ].cint , 
      0 ) ;
      curlist .tailfield = mem [curlist .tailfield ].hh .v.RH ;
    } 
    curmlist = p ;
...
zdoregistercommand ( smallnumber a ) 
{
  ...
  if ( p < 2 ) {
    ...
    geqdefine ( l , 129 , curval ) ;
    else eqdefine ( l , 129 , curval ) ;
  } 
} 
void 
alteraux ( void ) 
...
doextension ( void ) 
{
  ...
  case 5 : 
    ...
    reportillegalcase () ;
      ...
      mem [curlist .tailfield + 1 ].hh.b0 = normmin ( eqtb [28983 ].cint ) 
      ;
      mem [curlist .tailfield + 1 ].hh.b1 = normmin ( eqtb [28984 ].cint ) 
      ;
    } 
    break ;
  case 6 : 
  ...
  */ maincontrol_regmem 
  ...
  case 265 : 
	...
	curlist .tailfield = mem [curlist .tailfield ].hh .v.RH ;
      ...
      if ( abs ( curlist .modefield ) == 1 ) 
      curlist .auxfield .cint = -65536000L ;
      else if ( abs ( curlist .modefield ) == 114 ) 
      curlist .auxfield .hh .v.LH = 1000 ;
    } 
    break ;
  case 31 : 
  ...
  case 150 : 
    if ( curchr > 0 ) 
    {
      if ( eTeXenabled ( ( eqtb [29001 ].cint > 0 ) , curcmd , curchr ) ) 
      {
  ...
  case 298 : 
    if ( ischarascii ( curchr ) ) {
      ...
      if ( curchr < 128 ) 
      setmathchar ( eqtb [28419 + curchr ].hh .v.RH ) ;
  ...
  lab130: if ( ( curlist .tailfield >= himemmin ) ) 
  {
    cx = mem [curlist .tailfield ].hh.b1 ;
    {
      ...
      if ( kp != 1000 ) 
      {
	if ( eqtb [27385 + kp ].hh.b0 == 2 ) 
	{
	  {
	    mem [curlist .tailfield ].hh .v.RH = newpenalty ( eqtb [29795 + 
	    kp ].cint ) ;
	    curlist .tailfield = mem [curlist .tailfield ].hh .v.RH ;
	  } 
	  mem [curlist .tailfield ].hh.b1 = 2 ;
  ...
  if ( mainf != 0 ) 
  {
    ...
    cx = curchr ;
    {
      ...
      if ( kp != 1000 ) 
      {
	if ( eqtb [27385 + kp ].hh.b0 == 1 ) 
	{
	  if ( ! ( curq >= himemmin ) && ( mem [curq ].hh.b0 == 14 ) ) 
	  mem [curq + 1 ].cint = mem [curq + 1 ].cint + eqtb [29795 + kp 
	  ].cint ;
	  else {
	      
	    mainp = mem [curq ].hh .v.RH ;
	    mem [curq ].hh .v.RH = newpenalty ( eqtb [29795 + kp ].cint ) 
	    ;
	    mem [mem [curq ].hh .v.RH ].hh.b1 = 2 ;
	    mem [mem [curq ].hh .v.RH ].hh .v.RH = mainp ;
	  } 
	} 
	else if ( eqtb [27385 + kp ].hh.b0 == 2 ) 
	{
	  {
	    mem [curlist .tailfield ].hh .v.RH = newpenalty ( eqtb [29795 + 
	    kp ].cint ) ;
  ...
  mains = eqtb [28163 + curchr ].hh .v.RH ;
  if ( mains == 1000 ) 
  curlist .auxfield .hh .v.LH = 1000 ;
  else if ( mains < 1000 ) 
  {
  ...
  if ( curlist .modefield > 0 ) {
    ...
    if ( eqtb [28982 ].cint != curlist .auxfield .hh .v.RH ) 
    fixlanguage () ;
  } 
  {
    ligstack = avail ;
  ...
  if ( ( curcmd == 16 ) || ( curcmd == 17 ) || ( curcmd == 18 ) ) 
  {
	...
	if ( kp != 1000 ) 
	{
	  ...
	  {
	    if ( ! ( curq >= himemmin ) && ( mem [curq ].hh.b0 == 14 ) ) 
	    mem [curq + 1 ].cint = mem [curq + 1 ].cint + eqtb [29795 + 
	    kp ].cint ;
	    else {
  ...
  if ( curcmd == 71 ) 
  {
	...
	cx = curl ;
	{
	  ...
	  if ( kp != 1000 ) 
	  {
		...
		mainp = mem [curq ].hh .v.RH ;
		mem [curq ].hh .v.RH = newpenalty ( eqtb [29795 + kp ]
		.cint ) ;
		mem [mem [curq ].hh .v.RH ].hh.b1 = 2 ;
		mem [mem [curq ].hh .v.RH ].hh .v.RH = mainp ;
	      } 
  ...
  ligstack = -268435455L ;
  goto lab110 ;
  lab101: mains = eqtb [28163 + curchr ].hh .v.RH ;
  if ( mains == 1000 ) 
  curlist .auxfield .hh .v.LH = 1000 ;
  else if ( mains < 1000 ) 
  {
