...
xeqlevel:array[28205..29312]of quarterword;{:259}{262:}hash:^twohalves;
...
{:221}{260:}for k:=28205 to 29312 do xeqlevel[k]:=1;
...
{:238}{246:}for k:=28205 to 28521 do eqtb[k].int:=0;
eqtb[28262].int:=256;eqtb[28263].int:=-1;eqtb[28222].int:=1000;
eqtb[28206].int:=10000;eqtb[28246].int:=1;eqtb[28245].int:=25;
eqtb[28251].int:=92;eqtb[28254].int:=13;
for k:=0 to 255 do eqtb[28522+k].int:=-1;eqtb[28568].int:=0;
{:246}{256:}for k:=28778 to 29312 do eqtb[k].int:=0;
{:256}{264:}hashused:=15514;hashhigh:=0;cscount:=0;
eqtb[15523].hh.b0:=127;hash[15523].rh:=533;
{:264}{563:}{:563}{957:}for k:=-trieopsize to trieopsize do trieophash[k
]:=0;for k:=0 to 255 do trieused[k]:=mintrieop;maxopused:=mintrieop;
trieopptr:=0;{:957}{962:}trienotready:=true;
{:962}{1228:}hash[15514].rh:=1259;
{:1228}{1314:}if iniversion then formatident:=1332;
{:1314}{1382:}hash[15522].rh:=1374;eqtb[15522].hh.b1:=1;
eqtb[15522].hh.b0:=124;eqtb[15522].hh.rh:=-268435455;{:1382}end;
endif('INITEX'){:8}{1423:}synctexoffset:=28265;{:1423}end;
...
begin if p<514 then if p>=257 then if p=513 then begin printesc(535);
printesc(536);printchar(32);end else begin printesc(p-257);
if eqtb[25635+p-257].hh.rh=11 then printchar(32);
end else if p<1 then printesc(537)else print(p-1)else if((p>=24526)and(p
<=29312))or(p>eqtbtop)then printesc(537)else if(hash[p].rh>=strptr)then
printesc(538)else begin printesc(hash[p].rh);printchar(32);end;end;
{:268}{269:}procedure sprintcs(p:halfword);
begin if p<514 then if p<257 then print(p-1)else if p<513 then printesc(
p-257)else begin printesc(535);printesc(536);
...
print(602);end;end;{:1398}{1500:}procedure printdir(dir:eightbits);
...
begin case abs(d)of 4:print(1115);3:print(1114);1:print(1116);end;
if d<0 then print(1424);print(1425);end;
...
if(m<16)and(c>256)then printesc(588)else{300:}case m of 16,17,18:
...
end;14:print(589);others:printesc(588)end{:300};end{:299};
p:=mem[p].hh.rh;end;if p<>-268435455 then printesc(587);10:end;
{:298}{312:}procedure runaway;var p:halfword;
begin if scannerstatus>1 then begin case scannerstatus of 2:begin
printnl(603);p:=defref;end;3:begin printnl(604);p:=memtop-3;end;
4:begin printnl(605);p:=memtop-4;end;5:begin printnl(606);p:=defref;end;
...
532);printint(q);printchar(41);end;end{:261};
{291:}if saveptr>0 then for q:=0 to saveptr-1 do begin if savestack[q].
hh.rh=p then begin printnl(579);printint(q);printchar(41);end;end{:291};
{944:}for q:=0 to hyphsize do begin if hyphlist[q]=p then begin printnl(
991);printint(q);printchar(41);end;end{:944};end;
...
print(910);end else showinfo;others:end;decr(poolptr);end;end;
{:703}{705:}procedure printstyle(c:integer);
begin case c div 2 of 0:printesc(911);1:printesc(912);2:printesc(913);
3:printesc(914);others:print(915)end;end;
...
10:{1369:}case mem[p].hh.b1 of 0:begin printwritewhatsit(1363,p);
printchar(61);
printfilename(mem[p+1].hh.rh,mem[p+2].hh.lh,mem[p+2].hh.rh);end;
1:begin printwritewhatsit(627,p);printmark(mem[p+1].hh.rh);end;
2:printwritewhatsit(1364,p);3:begin printesc(1365);
printmark(mem[p+1].hh.rh);end;4:begin printesc(1367);
printint(mem[p+1].hh.rh);print(1370);printint(mem[p+1].hh.b0);
printchar(44);printint(mem[p+1].hh.b1);printchar(41);end;
others:print(1371)end{:1369};5:begin printesc(320);
...
17:{706:}begin printesc(558);begin strpool[poolptr]:=68;incr(poolptr);
...
b0 of 18:printesc(916);19:printesc(917);20:printesc(918);
21:printesc(919);22:printesc(920);23:printesc(921);24:printesc(922);
25:printesc(923);29:printesc(924);28:printesc(925);31:printesc(572);
26:begin printesc(566);printdelimiter(p+5);end;30:begin printesc(539);
printfamandchar(p+5,1);end;32:begin printesc(926);printdelimiter(p+1);
end;33:begin printesc(927);printdelimiter(p+1);end;end;
if mem[p].hh.b1<>0 then if mem[p].hh.b1=1 then printesc(928)else
printesc(929);if mem[p].hh.b0<32 then printsubsidiarydata(p+1,46);
printsubsidiarydata(p+2,94);printsubsidiarydata(p+3,95);end{:707};
27:{708:}begin printesc(930);
if mem[p+1].int=1073741824 then print(931)else printscaled(mem[p+1].int)
;
if(mem[p+5].qqqq.b0<>0)or(mem[p+5].qqqq.b1<>0)or(mem[p+5].qqqq.b2<>0)or(
mem[p+5].qqqq.b3<>0)then begin print(932);printdelimiter(p+5);end;
if(mem[p+4].qqqq.b0<>0)or(mem[p+4].qqqq.b1<>0)or(mem[p+4].qqqq.b2<>0)or(
mem[p+4].qqqq.b3<>0)then begin print(933);printdelimiter(p+4);end;
...
2,4:freenode(p,2);others:confusion(1373)end;goto 30;end{:1371};
...
2,4:begin r:=getnode(2);words:=2;end;others:confusion(1372)end{:1370};
...
if p=0 then begin{997:}if memtop-2<>pagetail then begin printnl(1031);
if outputactive then print(1032);showbox(mem[memtop-2].hh.rh);
if pagecontents>0 then begin printnl(1033);printtotals;printnl(1034);
printscaled(pagesofar[0]);r:=mem[memtop].hh.rh;
while r<>memtop do begin println;printesc(335);t:=mem[r].hh.b1;
printint(t);print(1035);
if eqtb[28266+t].int=1000 then t:=mem[r+3].int else t:=xovern(mem[r+3].
int,1000)*eqtb[28266+t].int;printscaled(t);
if mem[r].hh.b0=1 then begin q:=memtop-2;t:=0;repeat q:=mem[q].hh.rh;
if(mem[q].hh.b0=4)and(mem[q].hh.b1=mem[r].hh.b1)then incr(t);
until q=mem[r+1].hh.lh;print(1036);printint(t);print(1037);end;
...
56:printesc(494);51:printesc(495);52:printesc(496);53:printesc(497);
54:printesc(498);55:printesc(499);57:printesc(500);58:printesc(501);
59:printesc(502);others:print(503)end;end;
...
begin case n of 0:printesc(506);1:printesc(507);2:printesc(508);
3:printesc(509);4:printesc(510);5:printesc(511);6:printesc(512);
7:printesc(513);8:printesc(514);9:printesc(515);10:printesc(516);
11:printesc(517);12:printesc(518);13:printesc(519);14:printesc(520);
15:printesc(521);16:printesc(522);17:printesc(523);18:printesc(524);
19:printesc(525);21:printesc(526);22:printesc(527);20:printesc(528);
others:print(529)end;end;
{:253}{258:}{304:}procedure printcmdchr(cmd:quarterword;
chrcode:halfword);begin case cmd of 1:begin print(590);print(chrcode);
end;2:begin print(591);print(chrcode);end;3:begin print(592);
print(chrcode);end;6:begin print(593);print(chrcode);end;
7:begin print(594);print(chrcode);end;8:begin print(595);print(chrcode);
end;9:print(596);10:begin print(597);print(chrcode);end;
11:begin print(598);print(chrcode);end;12:begin print(599);
print(chrcode);end;16,17,18:begin print(600);printkanji(chrcode);end;
...
{:237}{245:}78:if chrcode<28266 then printparam(chrcode-28205)else begin
printesc(504);printint(chrcode-28266);end;
{:245}{255:}79:if chrcode<28801 then printlengthparam(chrcode-28778)else
begin printesc(530);printint(chrcode-28801);end;
{:255}{272:}48:printesc(539);100:printesc(540);43:printesc(541);
44:printesc(542);82:printesc(552);64:printesc(543);45:printesc(564);
19:printesc(544);118:printesc(535);96:printesc(549);97:printesc(550);
98:printesc(551);15:printesc(545);102:printesc(546);70:printesc(536);
65:printesc(547);67:printesc(32);113:printesc(548);35:printesc(553);
39:printesc(554);42:printesc(555);40:printesc(335);47:printesc(47);
21:printesc(358);49:printesc(556);20:printesc(557);57:printesc(558);
101:printesc(559);37:printesc(560);68:printesc(561);114:printesc(562);
58:printesc(340);66:printesc(563);69:printesc(566);106:printesc(567);
0:printesc(568);108:printesc(569);88:printesc(565);92:printesc(426);
120:printesc(570);76:printesc(425);41:printesc(359);36:printesc(571);
59:printesc(572);38:printesc(573);{:272}{341:}13:printesc(630);
{:341}{388:}115:if chrcode=0 then printesc(665)else printesc(666);
{:388}{396:}121:case chrcode of 1:printesc(668);2:printesc(669);
3:printesc(670);4:printesc(671);others:printesc(667)end;
{:396}{423:}99:if chrcode=0 then printesc(504)else if chrcode=1 then
printesc(530)else if chrcode=2 then printesc(413)else printesc(414);
{:423}{428:}87:if chrcode=1 then printesc(705)else printesc(704);
90:if chrcode=0 then printesc(706)else printesc(707);
91:if chrcode=1 then printesc(708)else if chrcode=3 then printesc(709)
else printesc(710);73:case chrcode of 0:printesc(711);1:printesc(712);
2:printesc(713);3:printesc(714);others:printesc(715)end;
{:428}{480:}119:case chrcode of 0:printesc(773);1:printesc(774);
3:printesc(775);4:printesc(776);5:printesc(777);2:printesc(778);
6:printesc(779);7:printesc(780);8:printesc(781);9:printesc(782);
others:printesc(783)end;{:480}{499:}116:case chrcode of 1:printesc(800);
2:printesc(801);3:printesc(802);4:printesc(803);5:printesc(804);
6:printesc(805);7:printesc(806);8:printesc(807);9:printesc(808);
10:printesc(809);11:printesc(810);12:printesc(811);13:printesc(812);
14:printesc(813);15:printesc(814);16:printesc(815);17:printesc(816);
18:printesc(817);19:printesc(818);20:printesc(819);21:printesc(820);
22:printesc(821);23:printesc(822);others:printesc(799)end;
{:499}{503:}117:if chrcode=2 then printesc(823)else if chrcode=4 then
printesc(824)else printesc(825);
{:503}{792:}4:if chrcode=256 then printesc(949)else begin print(953);
print(chrcode);end;
5:if chrcode=257 then printesc(950)else printesc(951);
{:792}{995:}89:case chrcode of 0:printesc(1021);1:printesc(1022);
2:printesc(1023);3:printesc(1024);4:printesc(1025);5:printesc(1026);
6:printesc(1027);others:printesc(1028)end;
{:995}{1065:}14:if chrcode=1 then printesc(1078)else printesc(1077);
{:1065}{1071:}29:case chrcode of 4:printesc(1079);0:printesc(1080);
1:printesc(1081);2:printesc(1082);others:printesc(1083)end;
30:case chrcode of 4:printesc(1084);0:printesc(1085);1:printesc(1086);
2:printesc(1087);others:printesc(1088)end;31:printesc(341);
32:printesc(345);33:printesc(347);
{:1071}{1084:}24:if chrcode=1 then printesc(1106)else printesc(1107);
25:if chrcode=1 then printesc(1108)else printesc(1109);
23:case chrcode of 0:printesc(427);1:printesc(1110);2:printesc(1111);
3:printesc(1016);4:printesc(1112);5:printesc(1018);
others:printesc(1113)end;75:case chrcode of 4:printesc(1115);
3:printesc(1114);1:printesc(1116);end;
34:if chrcode=100 then printesc(1118)else if chrcode=101 then printesc(
1119)else if chrcode=102 then printesc(1120)else printesc(1117);
{:1084}{1101:}46:if chrcode=0 then printesc(1143)else printesc(1142);
{:1101}{1120:}28:if chrcode=12 then printesc(1156)else if chrcode=13
then printesc(1155)else printesc(1154);
26:if chrcode=1 then printesc(1158)else printesc(1157);
27:if chrcode=1 then printesc(1160)else printesc(1159);
{:1120}{1127:}50:if chrcode=1 then printesc(45)else printesc(356);
{:1127}{1155:}51:if chrcode=1 then printesc(1194)else printesc(1193);
{:1155}{1169:}53:case chrcode of 18:printesc(916);19:printesc(917);
20:printesc(918);21:printesc(919);22:printesc(920);23:printesc(921);
24:printesc(922);25:printesc(923);28:printesc(925);
others:printesc(924)end;
54:if chrcode=1 then printesc(928)else if chrcode=2 then printesc(929)
else printesc(1198);{:1169}{1182:}56:printstyle(chrcode);
{:1182}{1191:}55:case chrcode of 1:printesc(1217);2:printesc(1218);
3:printesc(1219);4:printesc(1220);5:printesc(1221);
others:printesc(1216)end;
{:1191}{1201:}52:if chrcode=32 then printesc(926)else printesc(927);
{:1201}{1221:}103:if chrcode=1 then printesc(1240)else if chrcode=2 then
printesc(1241)else printesc(1242);
107:if chrcode=0 then printesc(1243)else if chrcode=1 then printesc(1244
)else if chrcode=2 then printesc(1245)else printesc(1246);
{:1221}{1232:}104:if chrcode<>0 then printesc(1261)else printesc(1260);
{:1232}{1235:}105:case chrcode of 0:printesc(1262);1:printesc(1263);
2:printesc(1264);3:printesc(1265);4:printesc(1266);5:printesc(1267);
7:printesc(1269);others:printesc(1268)end;71:begin printesc(544);
printhex(chrcode);end;72:begin printesc(557);printhex(chrcode);end;
...
printesc(441)else printesc(505);94:printsize(chrcode-25583);
{:1243}{1264:}109:if chrcode=1 then printesc(1004)else printesc(992);
{:1264}{1268:}83:if chrcode=0 then printesc(1291)else printesc(1292);
{:1268}{1274:}95:begin print(1300);slowprint(fontname[chrcode]);
if fontsize[chrcode]<>fontdsize[chrcode]then begin print(784);
printscaled(fontsize[chrcode]);print(415);end;end;
{:1274}{1276:}110:case chrcode of 0:printesc(272);1:printesc(273);
2:printesc(274);others:printesc(1301)end;
{:1276}{1286:}63:if chrcode=0 then printesc(1303)else printesc(1302);
{:1286}{1291:}61:if chrcode=0 then printesc(1304)else printesc(1305);
{:1291}{1300:}60:if chrcode=26925 then printesc(1311)else printesc(1312)
;{:1300}{1305:}22:case chrcode of 1:printesc(1314);2:printesc(1315);
3:printesc(1316);4:printesc(1317);others:printesc(1313)end;
{:1305}{1308:}112:print(1324);122:print(1325);123:printesc(1326);
124:printesc(1327);125:begin printesc(1240);printesc(1327);end;
126:printesc(1328);{:1308}{1359:}62:case chrcode of 0:printesc(1363);
1:printesc(627);2:printesc(1364);3:printesc(1365);4:printesc(1366);
5:printesc(1367);others:print(1368)end;{:1359}{1455:}86:printesc(438);
{:1455}{1460:}111:begin if(chrcode mod 2)=0 then printesc(1400)else
printesc(1401);if chrcode<2 then print(1402)else print(1403);end;
{:1460}{1467:}74:printesc(1408);85:printesc(1409);
{:1467}{1472:}84:case chrcode of 1:printesc(1412);2:printesc(1413);end;
{:1472}others:print(601)end;end;
{:304}ifdef('STAT')procedure showeqtb(n:halfword);
begin if n<1 then printchar(63)else if(n<24527)or((n>29312)and(n<=
...
end{:241}{:239}else if n<28778 then{248:}begin if n<28266 then
printparam(n-28205)else if n<28522 then begin printesc(504);
printint(n-28266);end else begin printesc(505);printint(n-28522);end;
printchar(61);printint(eqtb[n].int);
end{:248}else if n<29057 then{257:}begin if n<28801 then
printlengthparam(n-28778)else begin printesc(530);printint(n-28801);end;
printchar(61);printscaled(eqtb[n].int);print(415);
end{:257}else if n<=29312 then print(531)else printchar(63);end;
...
incr(hashhigh);hash[p].lh:=hashhigh+29312;p:=hashhigh+29312;
end else begin repeat if(hashused=514)then overflow(534,15000+hashextra)
...
if maxsavestack>savesize-6 then overflow(574,savesize);end;
savestack[saveptr].hh.b0:=3;savestack[saveptr].hh.b1:=curgroup;
savestack[saveptr].hh.rh:=curboundary;
if curlevel=255 then overflow(575,255);curboundary:=saveptr;
...
{289:}if(p<28205)or(p>29312)then if eqtb[p].hh.b1=1 then begin eqdestroy
(savestack[saveptr]);
ifdef('STAT')if eqtb[28242].int>0 then restoretrace(p,577);
endif('STAT')end else begin eqdestroy(eqtb[p]);
eqtb[p]:=savestack[saveptr];
ifdef('STAT')if eqtb[28242].int>0 then restoretrace(p,578);
...
restoretrace(p,577);endif('STAT')end{:289};end;end;
30:curgroup:=savestack[saveptr].hh.b1;
curboundary:=savestack[saveptr].hh.rh{:288};end else confusion(576);end;
{:287}{294:}procedure preparemag;
begin if(magset>0)and(eqtb[28222].int<>magset)then begin begin if
interaction=3 then;
if filelineerrorstylep then printfileline else printnl(262);print(580);
end;printint(eqtb[28222].int);print(581);printnl(582);begin helpptr:=2;
helpline[1]:=583;helpline[0]:=584;end;interror(magset);
geqworddefine(28222,magset);end;
if(eqtb[28222].int<=0)or(eqtb[28222].int>32768)then begin begin if
interaction=3 then;
if filelineerrorstylep then printfileline else printnl(262);print(585);
end;begin helpptr:=1;helpline[0]:=586;end;interror(eqtb[28222].int);
...
print(602);shownmode:=curlist.modefield;end;printcmdchr(curcmd,curchr);
...
if(curinput.namefield=0)then if baseptr=0 then printnl(607)else printnl(
608)else begin printnl(609);
if curinput.namefield=17 then printchar(42)else printint(curinput.
namefield-1);printchar(62);end else begin printnl(610);printint(line);
...
end else begin{320:}case curinput.indexfield of 0:printnl(611);
1,2:printnl(612);
3:if curinput.locfield=-268435455 then printnl(613)else printnl(614);
4:printnl(615);5:begin println;printcs(curinput.namefield);end;
6:printnl(616);7:printnl(617);8:printnl(618);9:printnl(619);
10:printnl(620);11:printnl(621);12:printnl(622);13:printnl(623);
14:printnl(624);15:printnl(625);others:printnl(63)end{:320};
...
printnl(343);case t of 14:printesc(358);15:printesc(627);
others:printcmdchr(77,t+25055)end;print(589);tokenshow(p);
...
alignstate:=0 else fatalerror(628);begin decr(inputptr);
...
begin if inopen=maxinopen then overflow(629,maxinopen);
...
if filelineerrorstylep then printfileline else printnl(262);print(637);
end else begin curcs:=0;begin if interaction=3 then;
if filelineerrorstylep then printfileline else printnl(262);print(638);
end;end;{345:}p:=getavail;case scannerstatus of 2:begin print(644);
mem[p].hh.lh:=637;end;3:begin print(645);mem[p].hh.lh:=partoken;
longstate:=124;end;4:begin print(646);mem[p].hh.lh:=637;q:=p;
p:=getavail;mem[p].hh.rh:=q;mem[p].hh.lh:=81050;alignstate:=-1000000;
end;5:begin print(647);mem[p].hh.lh:=637;end;end;
begintokenlist(p,4){:345};print(639);sprintcs(warningindex);
begin helpptr:=4;helpline[3]:=640;helpline[2]:=641;helpline[1]:=642;
helpline[0]:=643;end;error;
end{:344}else begin begin if interaction=3 then;
if filelineerrorstylep then printfileline else printnl(262);print(631);
end;printcmdchr(116,curif);print(632);printint(skipline);
begin helpptr:=3;helpline[2]:=633;helpline[1]:=634;helpline[0]:=635;end;
if curcs<>0 then curcs:=0 else helpline[2]:=636;curtok:=81053;inserror;
...
if filelineerrorstylep then printfileline else printnl(262);print(648);
end;begin helpptr:=2;helpline[1]:=649;helpline[0]:=650;end;
...
if curinput.limitfield=curinput.startfield then printnl(651);println;
first:=curinput.startfield;begin;print(42);terminput;end;
curinput.limitfield:=last;
if(eqtb[28254].int<0)or(eqtb[28254].int>255)then decr(curinput.
limitfield)else buffer[curinput.limitfield]:=eqtb[28254].int;
first:=curinput.limitfield+1;curinput.locfield:=curinput.startfield;
end else fatalerror(652);end{:368};
...
begin if(scannerstatus=4)or(curalign=-268435455)then fatalerror(628);
...
print(686);end;sprintcs(warningindex);print(687);begin helpptr:=4;
helpline[3]:=688;helpline[2]:=689;helpline[1]:=690;helpline[0]:=691;end;
...
if filelineerrorstylep then printfileline else printnl(262);print(681);
end;sprintcs(warningindex);print(682);begin helpptr:=3;helpline[2]:=683;
helpline[1]:=684;helpline[0]:=685;end;backerror;end;
...
if filelineerrorstylep then printfileline else printnl(262);print(673);
end;sprintcs(warningindex);print(674);begin helpptr:=6;helpline[5]:=675;
helpline[4]:=676;helpline[3]:=677;helpline[2]:=678;helpline[1]:=679;
helpline[0]:=680;end;incr(alignstate);longstate:=122;curtok:=partoken;
inserror;goto 22;
...
printint(n);print(692);showtokenlist(pstack[n-1],-268435455,1000);
...
paramptr+n;if maxparamstack>paramsize then overflow(672,paramsize);end;
...
if expanddepthcount>=expanddepth then overflow(654,expanddepth);
...
if filelineerrorstylep then printfileline else printnl(262);print(661);
end;printesc(536);print(662);begin helpptr:=2;helpline[1]:=663;
helpline[0]:=664;end;backerror;end{:384};{385:}j:=first;p:=mem[r].hh.rh;
...
if filelineerrorstylep then printfileline else printnl(262);print(826);
end;printcmdchr(117,curchr);begin helpptr:=1;helpline[0]:=827;end;error;
...
if filelineerrorstylep then printfileline else printnl(262);print(655);
end;begin helpptr:=5;helpline[4]:=656;helpline[3]:=657;helpline[2]:=658;
helpline[1]:=659;helpline[0]:=660;end;error;end{:381}end;
...
if filelineerrorstylep then printfileline else printnl(262);print(693);
end;begin helpptr:=4;helpline[3]:=694;helpline[2]:=695;helpline[1]:=696;
helpline[0]:=697;end;backerror;curtok:=379;curcmd:=1;curchr:=123;
...
begin begin if interaction=3 then;
if filelineerrorstylep then printfileline else printnl(262);print(698);
end;begin helpptr:=1;helpline[0]:=699;end;error;end;
...
if filelineerrorstylep then printfileline else printnl(262);print(723);
...
if filelineerrorstylep then printfileline else printnl(262);print(728);
end;begin helpptr:=2;helpline[1]:=729;helpline[0]:=725;end;
...
if filelineerrorstylep then printfileline else printnl(262);print(730);
end;begin helpptr:=2;helpline[1]:=731;helpline[0]:=725;end;
interror(curval);curval:=0;end;end;
...
if filelineerrorstylep then printfileline else printnl(262);print(732);
end;begin helpptr:=2;helpline[1]:=733;helpline[0]:=725;end;
interror(curval);curval:=0;end;end;
...
if filelineerrorstylep then printfileline else printnl(262);print(866);
end;begin helpptr:=2;helpline[1]:=867;helpline[0]:=868;end;backerror;
...
repeat if fmemptr=fontmemsize then overflow(873,fontmemsize);
...
if filelineerrorstylep then printfileline else printnl(262);print(851);
end;printesc(hash[15525+f].rh);print(869);printint(fontparams[f]);
print(870);begin helpptr:=2;helpline[1]:=871;helpline[0]:=872;end;error;
...
n:smallnumber):halfword;label 30,31;var p,s:halfword;
begin s:=calcpos(c);p:=s;ifdef('TEXMF_DEBUG')println;print(1414);
printint(c);print(1415);printint(s);if p+26659<0 then begin print(1416);
println;end;
...
if(q<>1000)and(m=eqtb[26659+q].hh.b0)then begin curval:=eqtb[29057+q].
...
print(700);end;begin helpptr:=3;helpline[2]:=701;helpline[1]:=702;
helpline[0]:=703;end;backerror;begin curval:=0;curvallevel:=1;end;
...
then;if filelineerrorstylep then printfileline else printnl(262);
print(716);end;printcmdchr(87,m);begin helpptr:=4;helpline[3]:=717;
helpline[2]:=718;helpline[1]:=719;helpline[0]:=720;end;error;
...
case m of 0:curval:=eqtb[28266+curval].int;
1:curval:=eqtb[28801+curval].int;2:curval:=eqtb[24548+curval].hh.rh;
...
if filelineerrorstylep then printfileline else printnl(262);print(721);
end;printcmdchr(curcmd,curchr);print(722);printesc(570);
begin helpptr:=1;helpline[0]:=720;end;error;
if level<>5 then begin curval:=0;curvallevel:=1;
...
interaction=3 then;
if filelineerrorstylep then printfileline else printnl(262);print(734);
end;begin helpptr:=2;helpline[1]:=735;helpline[0]:=736;end;curval:=48;
...
end;begin helpptr:=2;helpline[1]:=738;helpline[0]:=739;end;error;
...
end;begin helpptr:=3;helpline[2]:=701;helpline[1]:=702;helpline[0]:=703;
...
interaction=3 then;
if filelineerrorstylep then printfileline else printnl(262);print(741);
end;print(742);begin helpptr:=1;helpline[0]:=743;end;error;
...
if scankeyword(744)then v:=({569:}fontinfo[6+parambase[eqtb[25582].hh.rh
]].int{:569})else if scankeyword(745)then v:=({570:}fontinfo[5+parambase
[eqtb[25582].hh.rh]].int{:570})else if scankeyword(746)then{1451:}if
...
qqqq.b0].int{:1451}else if scankeyword(747)then{1452:}if curlist.
...
interaction=3 then;
if filelineerrorstylep then printfileline else printnl(262);print(741);
end;print(748);begin helpptr:=4;helpline[3]:=749;helpline[2]:=750;
helpline[1]:=751;helpline[0]:=752;end;error;goto 88;end{:467};
if scankeyword(740)then{468:}begin preparemag;
...
{469:}if scankeyword(753)then begin num:=7227;denom:=100;
end else if scankeyword(754)then begin num:=12;denom:=1;
end else if scankeyword(755)then begin num:=7227;denom:=254;
end else if scankeyword(756)then begin num:=7227;denom:=2540;
end else if scankeyword(757)then begin num:=7227;denom:=7200;
end else if scankeyword(758)then begin num:=1238;denom:=1157;
end else if scankeyword(759)then begin num:=14856;denom:=1157;
end else if scankeyword(72)then begin num:=7227;denom:=10160;
end else if scankeyword(81)then begin num:=7227;denom:=10160;
end else if scankeyword(760)then goto 30 else{470:}begin begin if
interaction=3 then;
if filelineerrorstylep then printfileline else printnl(262);print(741);
end;print(761);begin helpptr:=6;helpline[5]:=762;helpline[4]:=763;
helpline[3]:=764;helpline[2]:=750;helpline[1]:=751;helpline[0]:=752;end;
...
interaction=3 then;
if filelineerrorstylep then printfileline else printnl(262);print(765);
...
mem[q+1].int:=curval;
if scankeyword(768)then begin scandimen(mu,true,false);
mem[q+2].int:=curval;mem[q].hh.b0:=curorder;end;
if scankeyword(769)then begin scandimen(mu,true,false);
...
mem[q+2].int:=0;end;
21:if scankeyword(770)then begin scandimen(false,false,false);
mem[q+1].int:=curval;goto 21;end;
if scankeyword(771)then begin scandimen(false,false,false);
mem[q+3].int:=curval;goto 21;end;
if scankeyword(772)then begin scandimen(false,false,false);
...
if fontsize[curval]<>fontdsize[curval]then begin print(784);
...
if filelineerrorstylep then printfileline else printnl(262);print(787);
end;begin helpptr:=1;helpline[0]:=788;end;error;end else begin incr(t);
if curtok<>t then begin begin if interaction=3 then;
if filelineerrorstylep then printfileline else printnl(262);print(789);
end;begin helpptr:=2;helpline[1]:=790;helpline[0]:=791;end;backerror;
...
if filelineerrorstylep then printfileline else printnl(262);print(693);
end;incr(alignstate);begin helpptr:=2;helpline[1]:=785;helpline[0]:=786;
...
end;sprintcs(warningindex);begin helpptr:=3;helpline[2]:=793;
helpline[1]:=794;helpline[0]:=795;end;backerror;curtok:=s;
...
terminput;end;n:=-1;
end else fatalerror(796){:495}else if readopen[m]=1 then{496:}if inputln
...
if filelineerrorstylep then printfileline else printnl(262);print(797);
end;printesc(567);begin helpptr:=1;helpline[0]:=798;end;
...
while true do begin if q=-268435455 then confusion(799);
...
interaction=3 then;
if filelineerrorstylep then printfileline else printnl(262);print(830);
end;printcmdchr(116,thisif);begin helpptr:=1;helpline[0]:=831;end;
backerror;r:=61;end;
...
if eqtb[28241].int>1 then begin begindiagnostic;print(832);printint(n);
...
if b then print(828)else print(829);enddiagnostic(false);end{:513};
...
begin if interaction=3 then;
if filelineerrorstylep then printfileline else printnl(262);print(826);
end;printesc(824);begin helpptr:=1;helpline[0]:=827;end;error;
...
if s=834 then begin if interaction=3 then;
if filelineerrorstylep then printfileline else printnl(262);print(835);
end else begin if interaction=3 then;
if filelineerrorstylep then printfileline else printnl(262);print(836);
end;printfilename(curname,curarea,curext);print(837);
if(e=838)or(e=343)then showcontext;println;
printcstring(promptfilenamehelpmsg);if(e<>343)then begin print(839);
print(e);print(39);end;print(41);println;printnl(840);print(s);
if interaction<2 then fatalerror(841);savedcurname:=curname;
savedcurext:=curext;savedcurarea:=curarea;;begin;print(602);terminput;
...
if jobname=0 then jobname:=getjobname(844);packjobname(845);
recorderchangefilename(stringcast(nameoffile+1));packjobname(846);
while not aopenout(logfile)do{546:}begin selector:=17;
promptfilename(848,846);end{:546};
...
then write(logfile,'This is pTeX, Version 3.14159265','-p3.7')else write
(logfile,'This is pTeX, Version 3.14159265','-p3.7');
write(logfile,' (');write(logfile,conststringcast(getencstring));
write(logfile,')');write(logfile,versionstring);slowprint(formatident);
print(849);printint(eqtb[28226].int);printchar(32);
...
printnl(847);l:=inputstack[0].limitfield;
...
if c>=eqtb[28262].int then if c<=eqtb[28263].int then if(eqtb[27949+c].
...
printnl(874);print(1389);print(c);print(875);slowprint(fontname[f]);
...
if s>=0 then begin print(784);printscaled(s);print(415);
end else if s<>-1000 then begin print(852);printint(-s);end;print(861);
begin helpptr:=4;helpline[3]:=862;helpline[2]:=863;helpline[1]:=864;
helpline[0]:=865;end;error;goto 30;end{:578};f:=fontptr+1;
...
if s>=0 then begin print(784);printscaled(s);print(415);
end else if s<>-1000 then begin print(852);printint(-s);end;
if fileopened then print(853)else if nametoolong then print(854)else
print(855);begin helpptr:=5;helpline[4]:=856;helpline[3]:=857;
helpline[2]:=858;helpline[1]:=859;helpline[0]:=860;end;error{:572};
...
printnl(874);if(c<32)or(c>126)then begin printchar(94);printchar(94);
...
end end else print(c);print(875);slowprint(fontname[f]);printchar(33);
...
if filelineerrorstylep then printfileline else printnl(262);print(1383);
end;begin helpptr:=2;helpline[1]:=1384;helpline[0]:=1065;end;error;
...
:=19;if not logopened then selector:=17;printnl(1375);
for d:=0 to(poolptr-strstart[strptr])-1 do begin print(strpool[strstart[
strptr]+d]);end;print(1376);
...
clobbered:=true;end;
if clobbered then print(1377)else begin runsystemret:=runsystem(
conststringcast(addressof(strpool[strstart[strptr]])));
if runsystemret=-1 then print(1378)else if runsystemret=0 then print(
1379)else if runsystemret=1 then print(1380)else if runsystemret=2 then
print(1381)end;end else begin print(1382);end;printchar(46);
...
if curext=343 then curext:=838;packfilename(curname,curarea,curext);
while not kpseoutnameok(stringcast(nameoffile+1))or not aopenout(
writefile[j])do promptfilename(1386,838);writeopen[j]:=true;
if logopened then begin oldsetting:=selector;
if(eqtb[28234].int<=0)then selector:=18 else selector:=19;printnl(1387);
printint(j);print(1388);printfilename(curname,curarea,curext);
print(837);printnl(343);println;selector:=oldsetting;end;end;end;
end{:1387};3:specialout(p);4:;others:confusion(1385)end;end;
...
dvidir:=curdirhv;end;others:confusion(1422);end end;
...
if(mem[tempptr].hh.b0<>0)and(mem[tempptr].hh.b0<>1)then confusion(1423);
...
goto 22;end;
if mltexenabledp then{1409:}begin{1411:}if c>=eqtb[28262].int then if c
<=eqtb[28263].int then if(eqtb[27949+c].hh.rh>0)then begin basec:=(eqtb[
...
printnl(1390);print(c);print(1271);print(accentc);print(32);
print(basec);print(875);slowprint(fontname[f]);printchar(33);
enddiagnostic(false);goto 22;end;begindiagnostic;printnl(874);
print(1389);print(c);print(875);slowprint(fontname[f]);printchar(33);
enddiagnostic(false);goto 22{:1411};
40:{1412:}if eqtb[28240].int>99 then begin begindiagnostic;
printnl(1391);print(c);print(1271);print(accentc);print(32);
print(basec);print(875);slowprint(fontname[f]);printchar(46);
...
topedge:=curv;
while p<>-268435455 do{641:}begin if(p>=himemmin)then confusion(878)else
...
begin if eqtb[28239].int>0 then begin printnl(343);println;print(879);
end;if termoffset>maxprintline-9 then println else if(termoffset>0)or(
fileoffset>0)then printchar(32);printchar(91);j:=9;
while(eqtb[28266+j].int=0)and(j>0)do decr(j);
for k:=0 to j do begin printint(eqtb[28266+k].int);
...
[p+3].int+mem[p+2].int+eqtb[28797].int>1073741823)or(mem[p+1].int+eqtb[
28796].int>1073741823)then begin begin if interaction=3 then;
if filelineerrorstylep then printfileline else printnl(262);print(883);
end;begin helpptr:=2;helpline[1]:=884;helpline[0]:=885;end;error;
if eqtb[28239].int<=0 then begin begindiagnostic;printnl(886);
showbox(p);enddiagnostic(true);end;goto 30;end;
if mem[p+3].int+mem[p+2].int+eqtb[28797].int>maxv then maxv:=mem[p+3].
int+mem[p+2].int+eqtb[28797].int;
if mem[p+1].int+eqtb[28796].int>maxh then maxh:=mem[p+1].int+eqtb[28796]
.int{:652};{628:}dvih:=0;dviv:=0;curh:=eqtb[28796].int;dvif:=0;
dvidir:=4;curdirhv:=dvidir;
if outputfilename=0 then begin if jobname=0 then openlogfile;
packjobname(842);while not bopenout(dvifile)do promptfilename(843,842);
...
incr(dviptr);if dviptr=dvilimit then dviswap;end;
end else begin oldsetting:=selector;selector:=21;print(877);
...
end;for k:=0 to 9 do dvifour(eqtb[28266+k].int);dvifour(lastbop);
lastbop:=pageloc;curv:=mem[p+3].int+eqtb[28797].int;tempptr:=p;
...
if dviptr>(2147483647-dvioffset)then begin curs:=-2;fatalerror(876);end;
...
{650:}ifdef('STAT')if eqtb[28236].int>1 then begin printnl(880);
printint(varused);printchar(38);printint(dynused);printchar(59);end;
endif('STAT')flushnodelist(p);
ifdef('STAT')if eqtb[28236].int>1 then begin print(881);
printint(varused);printchar(38);printint(dynused);print(882);
...
if scankeyword(892)then speccode:=0 else if scankeyword(893)then
...
if lastbadness>100 then printnl(894)else printnl(895);print(896);
...
{677:}if(-x-totalshrink[0]>eqtb[28786].int)or(eqtb[28231].int<100)then
begin if(eqtb[28794].int>0)and(-x-totalshrink[0]>eqtb[28786].int)then
begin while mem[q].hh.rh<>-268435455 do q:=mem[q].hh.rh;
mem[q].hh.rh:=newrule;mem[mem[q].hh.rh+1].int:=eqtb[28794].int;end;
println;printnl(902);printscaled(-x-totalshrink[0]);print(903);goto 50;
end{:677};
end else if o=0 then if mem[r+5].hh.rh<>-268435455 then{678:}begin
lastbadness:=badness(-x,totalshrink[0]);
if lastbadness>eqtb[28231].int then begin println;printnl(904);
printint(lastbadness);goto 50;end;end{:678};goto 10;end{:675}{:668};
50:{674:}if outputactive then print(897)else begin if packbeginline<>0
then begin if packbeginline>0 then print(898)else print(899);
printint(abs(packbeginline));print(900);end else print(901);
...
totalshrink[3]:=0{:661};
while p<>-268435455 do{680:}begin if(p>=himemmin)then confusion(905)else
...
if lastbadness>100 then printnl(894)else printnl(895);print(906);
...
if(totalshrink[o]<-x)and(o=0)and(mem[r+5].hh.rh<>-268435455)then begin
lastbadness:=1000000;mem[r+6].gr:=1.0;
{688:}if(-x-totalshrink[0]>eqtb[28787].int)or(eqtb[28232].int<100)then
begin println;printnl(907);printscaled(-x-totalshrink[0]);print(908);
goto 50;end{:688};
end else if o=0 then if mem[r+5].hh.rh<>-268435455 then{689:}begin
lastbadness:=badness(-x,totalshrink[0]);
if lastbadness>eqtb[28232].int then begin println;printnl(909);
printint(lastbadness);goto 50;end;end{:689};goto 10;end{:687}{:683};
50:{686:}if outputactive then print(897)else begin if packbeginline<>0
then begin print(899);printint(abs(packbeginline));print(900);
end else print(901);printint(line);println;end;begindiagnostic;
...
if d<eqtb[28780].int then p:=newparamglue(0)else begin p:=newskipparam(1
...
mem[b+1].int:=eqtb[28789].int;end;
...
end;printsize(cursize);printchar(32);printint(mem[a].hh.b0);print(934);
print(curc);printchar(41);begin helpptr:=4;helpline[3]:=935;
helpline[2]:=936;helpline[1]:=937;helpline[0]:=938;end;error;
...
confusion(940)end else begin if mem[v].hh.b0<>1 then confusion(572)end;
...
,mem[q+4].hh.lh);mem[x+1].int:=mem[x+1].int+eqtb[28790].int;
...
curstyle mod 2),mem[q+4].hh.lh);
mem[x+1].int:=mem[x+1].int+eqtb[28790].int;
...
mem[y+1].int:=mem[y+1].int+eqtb[28790].int;
...
delta2:=delta1+delta1-eqtb[28788].int;
...
5:goto 81;{:741}others:confusion(939)end;
{765:}case mem[q+1].hh.rh of 1,4,5,6:{766:}begin fetch(q+1);
...
others:confusion(941)end;mem[q+1].int:=p;
...
goto 30;end;others:confusion(942)end{:772};
...
52:if curstyle<4 then x:=19 else x:=0;others:confusion(944)end;
...
if curcmd=9 then fatalerror(628);
...
then;if filelineerrorstylep then printfileline else printnl(262);
print(716);end;printesc(553);print(945);begin helpptr:=3;
helpline[2]:=946;helpline[1]:=947;helpline[0]:=948;end;error;flushmath;
end{:787};pushnest;
...
begin if interaction=3 then;
if filelineerrorstylep then printfileline else printnl(262);print(954);
end;begin helpptr:=3;helpline[2]:=955;helpline[1]:=956;helpline[0]:=957;
...
if filelineerrorstylep then printfileline else printnl(262);print(958);
end;begin helpptr:=3;helpline[2]:=955;helpline[1]:=956;helpline[0]:=959;
...
begin if curalign=-268435455 then confusion(960);q:=mem[curalign].hh.rh;
if q=-268435455 then confusion(960);
if alignstate<500000 then fatalerror(628);p:=mem[q].hh.rh;
...
end;printesc(950);begin helpptr:=3;helpline[2]:=962;helpline[1]:=963;
helpline[0]:=964;end;mem[curalign+5].hh.lh:=257;error;end{:803};
...
if n>255 then confusion(965);q:=curspan;
...
begin if curgroup<>6 then confusion(966);unsave;
if curgroup<>6 then confusion(967);unsave;
if nest[nestptr-1].modefield=225 then o:=eqtb[28793].int else o:=0;
...
if curlist.modefield=-1 then begin rulesave:=eqtb[28794].int;
eqtb[28794].int:=0;z:=newnullbox;mem[z].hh.rh:=mem[memtop-8].hh.rh;
...
+0].int);eqtb[28794].int:=rulesave;deleteglueref(mem[z+7].hh.rh);
...
if filelineerrorstylep then printfileline else printnl(262);print(1239);
end;begin helpptr:=2;helpline[1]:=946;helpline[0]:=947;end;backerror;
end{:1219}else{1209:}begin getxtoken;
if curcmd<>3 then begin begin if interaction=3 then;
if filelineerrorstylep then printfileline else printnl(262);print(1235);
end;begin helpptr:=2;helpline[1]:=1236;helpline[0]:=1237;end;backerror;
...
end;begin helpptr:=5;helpline[4]:=969;helpline[3]:=970;helpline[2]:=971;
helpline[1]:=972;helpline[0]:=973;end;error;end;q:=newspec(p);
...
others:confusion(974)end{:852};end;
...
others:confusion(975)end{:853};s:=mem[s].hh.rh;end;
...
ifdef('STAT')if eqtb[28237].int>0 then{857:}begin printnl(976);
printint(mem[passive].hh.lh);print(977);printint(mem[q+1].hh.lh-1);
printchar(46);printint(fitclass);if breaktype=1 then printchar(45);
print(978);printint(mem[q+2].int);print(979);
...
if curp=-268435455 then printesc(630)else if(mem[curp].hh.b0<>12)and(not
(curp>=himemmin))then begin if mem[curp].hh.b0=14 then printesc(564)else
if mem[curp].hh.b0=9 then printesc(356)else if mem[curp].hh.b0=13 then
printesc(345)else printesc(348);end;print(980);
if mem[r+1].hh.rh=-268435455 then printchar(48)else printint(mem[mem[r+1
].hh.rh].hh.lh);print(981);
if b>10000 then printchar(42)else printint(b);print(982);printint(pi);
print(983);if artificialdemerits then printchar(42)else printint(d);
...
990);curlist.pgfield:=bestline-1;end;
...
if l=0 then begin if trieopptr=trieopsize then overflow(1000,trieopsize)
;u:=trieused[curlang];
if u=maxtrieop then overflow(1001,maxtrieop-mintrieop);incr(trieopptr);
...
{965:}if triemax<h+256 then begin if triesize<=h+256 then overflow(1002,
...
if filelineerrorstylep then printfileline else printnl(262);print(1008);
end;begin helpptr:=1;helpline[0]:=1007;end;error;end;end;
...
1002,triesize);incr(trieptr);trier[trieptr]:=p;p:=trieptr;triel[p]:=0;
...
end;begin helpptr:=1;helpline[0]:=1007;end;error;end;trieo[q]:=v;
...
end;printesc(1004);begin helpptr:=1;helpline[0]:=1007;end;error;end end;
end;30:{:972};end else begin begin if interaction=3 then;
if filelineerrorstylep then printfileline else printnl(262);print(1003);
end;printesc(1004);begin helpptr:=1;helpline[0]:=1005;end;error;
...
{:845}{859:}if eqtb[25060].hh.rh=-268435455 then if eqtb[28795].int=0
then begin lastspecialline:=0;secondwidth:=eqtb[28781].int;
secondindent:=0;
end else{860:}begin lastspecialline:=abs(eqtb[28246].int);
if eqtb[28246].int<0 then begin firstwidth:=eqtb[28781].int-abs(eqtb[
28795].int);
if eqtb[28795].int>=0 then firstindent:=eqtb[28795].int else firstindent
:=0;secondwidth:=eqtb[28781].int;secondindent:=0;
end else begin firstwidth:=eqtb[28781].int;firstindent:=0;
secondwidth:=eqtb[28781].int-abs(eqtb[28795].int);
if eqtb[28795].int>=0 then secondindent:=eqtb[28795].int else
secondindent:=0;end;
...
begindiagnostic;printnl(984);end;endif('STAT')secondpass:=false;
finalpass:=false;end else begin threshold:=eqtb[28206].int;
secondpass:=true;finalpass:=(eqtb[28798].int<=0);
...
5:;others:confusion(988)end{:881};s:=mem[s].hh.rh;until s=-268435455;
...
others:confusion(989)end{:882};decr(r);s:=mem[s].hh.rh;end;prevp:=curp;
...
14:trybreak(mem[curp+1].int,0);5,6,4,7:;others:confusion(987)end;
...
printnl(985);endif('STAT')threshold:=eqtb[28206].int;secondpass:=true;
finalpass:=(eqtb[28798].int<=0);
end else begin ifdef('STAT')if eqtb[28237].int>0 then printnl(986);
endif('STAT')background[2]:=background[2]+eqtb[28798].int;
...
interaction=3 then;
if filelineerrorstylep then printfileline else printnl(262);print(996);
end;begin helpptr:=2;helpline[1]:=997;helpline[0]:=998;end;error;
...
do decr(hyphnext);
if(hyphcount=hyphsize)or(hyphnext=0)then overflow(999,hyphsize);
...
end;printesc(992);print(993);begin helpptr:=2;helpline[1]:=994;
helpline[0]:=995;end;error;end{:947}end;end{:946};10:end;
...
flushnodelist(q);end;others:confusion(1010)end;
...
6,4:goto 45;others:confusion(1011)end{:984};
...
then;if filelineerrorstylep then printfileline else printnl(262);
print(1012);end;begin helpptr:=4;helpline[3]:=1013;helpline[2]:=1014;
helpline[1]:=1015;helpline[0]:=973;end;error;r:=newspec(q);
...
if filelineerrorstylep then printfileline else printnl(262);print(343);
end;printesc(1016);print(1017);printesc(1018);begin helpptr:=2;
helpline[1]:=1019;helpline[0]:=1020;end;error;vsplit:=-268435455;
goto 10;end;flushnodelist(mem[v].hh.rh);mem[v].hh.rh:=-268435455{:989};
q:=vertbreak(mem[v+5].hh.rh,h,eqtb[28784].int);{990:}p:=mem[v+5].hh.rh;
...
q:=vpackage(p,h,0,eqtb[28784].int);mem[q].hh.b1:=(mem[v].hh.b1);
...
print(1029);end;if pagesofar[5]<>0 then begin print(315);
printscaled(pagesofar[5]);print(1030);end;
if pagesofar[6]<>0 then begin print(316);printscaled(pagesofar[6]);end;
end;{:996}{998:}procedure freezepagespecs(s:smallnumber);
begin pagecontents:=s;pagesofar[0]:=eqtb[28782].int;
pagemaxdepth:=eqtb[28783].int;pagesofar[7]:=0;pagesofar[1]:=0;
...
=3 then;if filelineerrorstylep then printfileline else printnl(262);
print(1040);end;begin helpptr:=3;helpline[2]:=1041;helpline[1]:=1042;
helpline[0]:=1043;end;boxerror(n);end;end;
...
3 then;if filelineerrorstylep then printfileline else printnl(262);
print(343);end;printesc(427);print(1056);begin helpptr:=2;
helpline[1]:=1057;helpline[0]:=1043;end;boxerror(255);end{:1026};
...
if filelineerrorstylep then printfileline else printnl(262);print(1049);
end;begin helpptr:=3;helpline[2]:=1041;helpline[1]:=1050;
helpline[0]:=1043;end;boxerror(n);eqtb[25326+n].hh.rh:=newnullbox;
...
savevfuzz:=eqtb[28787].int;eqtb[28787].int:=1073741823;
...
if filelineerrorstylep then printfileline else printnl(262);print(1058);
end;printint(deadcycles);print(1059);begin helpptr:=3;helpline[2]:=1060;
helpline[1]:=1061;helpline[0]:=1062;end;error;
...
if eqtb[28266+n].int=1000 then h:=mem[r+3].int else h:=xovern(mem[r+3].
int,1000)*eqtb[28266+n].int;pagesofar[0]:=pagesofar[0]-h-mem[q+1].int;
pagesofar[2+mem[q].hh.b0]:=pagesofar[2+mem[q].hh.b0]+mem[q+2].int;
pagesofar[6]:=pagesofar[6]+mem[q+3].int;
if(mem[q].hh.b1<>0)and(mem[q+3].int<>0)then begin begin if interaction=3
then;if filelineerrorstylep then printfileline else printnl(262);
print(1051);end;printesc(413);printint(n);begin helpptr:=3;
helpline[2]:=1052;helpline[1]:=1053;helpline[0]:=973;end;error;end;
end{:1020};
...
if eqtb[28266+n].int=1000 then h:=mem[p+3].int else h:=xovern(mem[p+3].
int,1000)*eqtb[28266+n].int;
if((h<=0)or(h<=delta))and(mem[p+3].int+mem[r+3].int<=eqtb[28801+n].int)
then begin pagesofar[0]:=pagesofar[0]-h;
mem[r+3].int:=mem[r+3].int+mem[p+3].int;
end else{1021:}begin if eqtb[28266+n].int<=0 then w:=1073741823 else
begin w:=pagesofar[0]-pagesofar[1]-pagesofar[7];
if eqtb[28266+n].int<>1000 then w:=xovern(w,eqtb[28266+n].int)*1000;end;
if w>eqtb[28801+n].int-mem[r+3].int then w:=eqtb[28801+n].int-mem[r+3].
...
printnl(1054);printint(n);print(1055);printscaled(w);printchar(44);
printscaled(bestheightplusdepth);print(982);
if q=-268435455 then printint(-10000)else if mem[q].hh.b0=14 then
printint(mem[q+1].int)else printchar(48);enddiagnostic(false);
end{:1022};
endif('STAT')if eqtb[28266+n].int<>1000 then bestheightplusdepth:=xovern
(bestheightplusdepth,1000)*eqtb[28266+n].int;
...
end{:1021};end;goto 80;end{:1019};others:confusion(1044)end{:1011};
...
printnl(37);print(978);printtotals;print(1047);
printscaled(pagesofar[0]);print(981);
if b=1073741823 then printchar(42)else printint(b);print(982);
printint(pi);print(1048);
...
if(mem[q].hh.b1<>0)and(mem[q+3].int<>0)then begin begin if interaction=3
then;if filelineerrorstylep then printfileline else printnl(262);
print(1045);end;begin helpptr:=4;helpline[3]:=1046;helpline[2]:=1014;
helpline[1]:=1015;helpline[0]:=973;end;error;r:=newspec(q);
mem[r].hh.b1:=0;deleteglueref(q);mem[p+1].hh.lh:=r;q:=r;end;end;
...
if filelineerrorstylep then printfileline else printnl(262);print(1070);
end;begin helpptr:=2;helpline[1]:=1071;helpline[0]:=1072;end;inserror;
...
begin helpptr:=4;helpline[3]:=1073;helpline[2]:=1074;helpline[1]:=1075;
helpline[0]:=1076;end;error;end;
...
if filelineerrorstylep then printfileline else printnl(262);print(826);
end;printcmdchr(curcmd,curchr);begin helpptr:=1;helpline[0]:=1095;end;
error;end{:1078}else begin backinput;p:=getavail;mem[memtop-3].hh.rh:=p;
begin if interaction=3 then;
if filelineerrorstylep then printfileline else printnl(262);print(661);
end;{1077:}case curgroup of 14:begin mem[p].hh.lh:=81051;printesc(547);
end;15:begin mem[p].hh.lh:=804;printchar(36);end;
16:begin mem[p].hh.lh:=81052;mem[p].hh.rh:=getavail;p:=mem[p].hh.rh;
mem[p].hh.lh:=3118;printesc(1094);end;others:begin mem[p].hh.lh:=637;
printchar(125);end end{:1077};print(662);
begintokenlist(mem[memtop-3].hh.rh,4);begin helpptr:=5;
helpline[4]:=1089;helpline[3]:=1090;helpline[2]:=1091;helpline[1]:=1092;
helpline[0]:=1093;end;error;end;end;
{:1076}{1081:}procedure extrarightbrace;
begin begin if interaction=3 then;
if filelineerrorstylep then printfileline else printnl(262);print(1100);
end;case curgroup of 14:printesc(547);15:printchar(36);16:printesc(927);
end;begin helpptr:=5;helpline[4]:=1101;helpline[3]:=1102;
helpline[2]:=1103;helpline[1]:=1104;helpline[0]:=1105;end;error;
incr(alignstate);end;{:1081}{1082:}procedure normalparagraph;
begin if eqtb[28224].int<>0 then eqworddefine(28224,0);
if eqtb[28795].int<>0 then eqworddefine(28795,0);
...
if filelineerrorstylep then printfileline else printnl(262);print(1128);
end;begin helpptr:=3;helpline[2]:=1129;helpline[1]:=1130;
helpline[0]:=1131;end;backerror;flushnodelist(curbox);end;
...
helpline[0]:=1132;end;error;
end else if(curlist.modefield=1)and(curlist.headfield=curlist.tailfield)
then begin youcant;begin helpptr:=2;helpline[1]:=1133;helpline[0]:=1134;
...
n:=curval;if not scankeyword(892)then begin begin if interaction=3 then;
if filelineerrorstylep then printfileline else printnl(262);print(1135);
end;begin helpptr:=2;helpline[1]:=1136;helpline[0]:=1137;end;error;end;
...
end;begin helpptr:=3;helpline[2]:=1139;helpline[1]:=1140;
helpline[0]:=1141;end;backerror;end;end;
{:1096}{1098:}procedure package(c:smallnumber);var h:scaled;p:halfword;
d:scaled;begin d:=eqtb[28785].int;deleteglueref(curkanjiskip);
deleteglueref(curxkanjiskip);
...
mem[curlist.tailfield+1].int:=eqtb[28778].int;
...
begin if interaction=3 then;
if filelineerrorstylep then printfileline else printnl(262);print(721);
end;printesc(554);print(1144);begin helpptr:=2;helpline[1]:=1145;
helpline[0]:=1146;end;error;end else begin backinput;curtok:=partoken;
...
if filelineerrorstylep then printfileline else printnl(262);print(1147);
end;printesc(335);printint(255);begin helpptr:=1;helpline[0]:=1148;end;
...
;begin helpptr:=2;helpline[1]:=1133;helpline[0]:=1151;end;
if curchr=13 then helpline[0]:=(1152)else if curchr<>12 then helpline[0]
:=(1153);error;end;end{:1118}else begin tx:=curlist.tailfield;
if not(tx>=himemmin)then if mem[tx].hh.b0=5 then begin tx:=curlist.
...
end;begin helpptr:=3;helpline[2]:=1162;helpline[1]:=1163;
helpline[0]:=1164;end;error;goto 10;end;
case(mem[p].hh.b1)of 4,3,1:if abs(curlist.dirfield)<>(mem[p].hh.b1)then
begin begin if interaction=3 then;
if filelineerrorstylep then printfileline else printnl(262);print(1165);
end;begin helpptr:=2;helpline[1]:=1162;helpline[0]:=1166;end;error;
...
end;begin helpptr:=1;helpline[0]:=1174;end;error;begindiagnostic;
printnl(1175);showbox(p);enddiagnostic(true);flushnodelist(p);
...
interaction=3 then;
if filelineerrorstylep then printfileline else printnl(262);print(1167);
end;printesc(356);begin helpptr:=2;helpline[1]:=1168;helpline[0]:=1169;
...
end;begin helpptr:=2;helpline[1]:=1171;helpline[0]:=1172;end;error;end;
...
fontdir[f]=4 then disp:=eqtb[28799].int-eqtb[28800].int else disp:=eqtb[
28799].int end else begin if fontdir[f]=4 then disp:=0 else if fontdir[f
]=3 then disp:=eqtb[28800].int-eqtb[28799].int else disp:=eqtb[28800].
...
if filelineerrorstylep then printfileline else printnl(262);print(1180);
end;printcmdchr(curcmd,curchr);
if curtok=1062 then begin begin helpptr:=6;helpline[5]:=1181;
helpline[4]:=1182;helpline[3]:=1183;helpline[2]:=1184;helpline[1]:=1185;
helpline[0]:=1186;end;end else begin begin helpptr:=5;helpline[4]:=1181;
helpline[3]:=1187;helpline[2]:=1184;helpline[1]:=1185;helpline[0]:=1186;
...
end;decr(alignstate);curtok:=637;end;begin helpptr:=3;helpline[2]:=1177;
helpline[1]:=1178;helpline[0]:=1179;end;inserror;end;end;
{:1139}{1141:}procedure noalignerror;begin begin if interaction=3 then;
if filelineerrorstylep then printfileline else printnl(262);print(1180);
end;printesc(560);begin helpptr:=2;helpline[1]:=1188;helpline[0]:=1189;
end;error;end;procedure omiterror;begin begin if interaction=3 then;
if filelineerrorstylep then printfileline else printnl(262);print(1180);
end;printesc(563);begin helpptr:=2;helpline[1]:=1190;helpline[0]:=1189;
...
-268435455)or(inputstack[baseptr].statefield<>0)then fatalerror(628);
...
if filelineerrorstylep then printfileline else printnl(262);print(826);
end;printesc(536);begin helpptr:=1;helpline[0]:=1192;end;error;end;
...
{1161:}if eqtb[25060].hh.rh=-268435455 then if(eqtb[28795].int<>0)and(((
eqtb[28246].int>=0)and(curlist.pgfield+2>eqtb[28246].int))or(curlist.
pgfield+1<-eqtb[28246].int))then begin l:=eqtb[28781].int-abs(eqtb[28795
].int);if eqtb[28795].int>0 then s:=eqtb[28795].int else s:=0;
end else begin l:=eqtb[28781].int;s:=0;
...
eqworddefine(28791,w);eqworddefine(28792,l);eqworddefine(28793,s);
...
end;begin helpptr:=1;helpline[0]:=1196;end;error;
...
interaction=3 then;
if filelineerrorstylep then printfileline else printnl(262);print(1197);
end;begin helpptr:=1;helpline[0]:=1196;end;error;end end;10:end;
...
if interaction=3 then;
if filelineerrorstylep then printfileline else printnl(262);print(1195);
end;begin helpptr:=1;helpline[0]:=1196;end;error;end;
...
if filelineerrorstylep then printfileline else printnl(262);print(1199);
end;begin helpptr:=1;helpline[0]:=1200;end;error;10:end;
...
until(curcmd<>10)and(curcmd<>0){:415};
case curcmd of 11,12:curval:=eqtb[28522+curchr].int;
15:scantwentysevenbitint;others:curval:=-1 end;end;
if curval<0 then{1173:}begin begin if interaction=3 then;
if filelineerrorstylep then printfileline else printnl(262);print(1201);
end;begin helpptr:=6;helpline[5]:=1202;helpline[4]:=1203;
helpline[3]:=1204;helpline[2]:=1205;helpline[1]:=1206;helpline[0]:=1207;
...
if filelineerrorstylep then printfileline else printnl(262);print(1208);
end;printesc(556);print(1209);begin helpptr:=2;helpline[1]:=1210;
helpline[0]:=1211;end;error;end{:1178};
...
auxfield.int+2].hh.lh;if mem[q].hh.b0<>32 then confusion(927);
...
if filelineerrorstylep then printfileline else printnl(262);print(1212);
end;begin helpptr:=1;helpline[0]:=1213;end;
end else begin begin if interaction=3 then;
if filelineerrorstylep then printfileline else printnl(262);print(1214);
end;begin helpptr:=1;helpline[0]:=1215;end;end;error;end;end{:1189};
...
begin if interaction=3 then;
if filelineerrorstylep then printfileline else printnl(262);print(1222);
end;begin helpptr:=3;helpline[2]:=1223;helpline[1]:=1224;
helpline[0]:=1225;end;error;
...
if filelineerrorstylep then printfileline else printnl(262);print(826);
end;printesc(927);begin helpptr:=1;helpline[0]:=1226;end;error;
...
interaction=3 then;
if filelineerrorstylep then printfileline else printnl(262);print(1227);
end;begin helpptr:=3;helpline[2]:=1228;helpline[1]:=1229;
helpline[0]:=1230;end;error;flushmath;danger:=true;
...
interaction=3 then;
if filelineerrorstylep then printfileline else printnl(262);print(1231);
end;begin helpptr:=3;helpline[2]:=1232;helpline[1]:=1233;
helpline[0]:=1234;end;error;flushmath;danger:=true;end{:1207};
...
if m<0 then{1208:}begin if curlist.dirfield=3 then disp:=eqtb[28799].int
else disp:=eqtb[28800].int;
...
mem[curlist.tailfield].hh.b0:=5;mem[curlist.tailfield+1].int:=disp;
curlist.pdispfield:=disp;end;end;{:1503};
begin mem[curlist.tailfield].hh.rh:=newmath(eqtb[28779].int,0);
...
begin mem[curlist.tailfield].hh.rh:=newmath(eqtb[28779].int,1);
curlist.tailfield:=mem[curlist.tailfield].hh.rh;end;
{1504:}if disp<>0 then begin if not(curlist.tailfield>=himemmin)and(mem[
curlist.tailfield].hh.b0=5)then begin mem[curlist.tailfield+1].int:=0;
end else begin curlist.pnodefield:=curlist.tailfield;
...
w:=mem[b+1].int;z:=eqtb[28792].int;s:=eqtb[28793].int;
...
curlist.tailfield:=mem[curlist.tailfield].hh.rh;end;
if(d+s<=eqtb[28791].int)or l then begin g1:=3;g2:=4;
...
begin if curgroup<>15 then confusion(1238);unsave;
...
if(curcs=0)or(curcs>eqtbtop)or((curcs>15514)and(curcs<=29312))then begin
begin if interaction=3 then;
if filelineerrorstylep then printfileline else printnl(262);print(1253);
end;begin helpptr:=5;helpline[4]:=1254;helpline[3]:=1255;
helpline[2]:=1256;helpline[1]:=1257;helpline[0]:=1258;end;
...
if filelineerrorstylep then printfileline else printnl(262);print(721);
end;printcmdchr(curcmd,curchr);print(722);printcmdchr(q,0);
begin helpptr:=1;helpline[0]:=1284;end;error;goto 10;end;end;p:=curchr;
scaneightbitint;case p of 0:l:=curval+28266;1:l:=curval+28801;
2:l:=curval+24548;3:l:=curval+24804;end;end;40:{:1250};
if q=99 then scanoptionalequals else if scankeyword(1280)then;
aritherror:=false;
...
if filelineerrorstylep then printfileline else printnl(262);print(1281);
end;begin helpptr:=2;helpline[1]:=1282;helpline[0]:=1283;end;
...
end;begin helpptr:=1;helpline[0]:=1288;end;interror(curval);
...
if filelineerrorstylep then printfileline else printnl(262);print(1006);
end;printesc(565);begin helpptr:=1;helpline[0]:=1289;end;
...
if u>=514 then t:=hash[u].rh else if u>=257 then if u=513 then t:=1293
else t:=u-257 else begin oldsetting:=selector;selector:=21;print(1293);
...
if scankeyword(1294)then{1272:}begin scandimen(false,false,false);
s:=curval;
if(s<=0)or(s>=134217728)then begin begin if interaction=3 then;
if filelineerrorstylep then printfileline else printnl(262);print(1296);
end;printscaled(s);print(1297);begin helpptr:=2;helpline[1]:=1298;
helpline[0]:=1299;end;error;s:=10*65536;end;
end{:1272}else if scankeyword(1295)then begin scanint;s:=-curval;
if(curval<=0)or(curval>32768)then begin begin if interaction=3 then;
if filelineerrorstylep then printfileline else printnl(262);print(585);
end;begin helpptr:=1;helpline[0]:=586;end;interror(curval);s:=-1000;end;
...
if filelineerrorstylep then printfileline else printnl(262);print(1248);
end;printcmdchr(curcmd,curchr);printchar(39);begin helpptr:=1;
helpline[0]:=1249;end;backerror;goto 10;end{:1224};end;
{1225:}if(curcmd<>107)and(a mod 4<>0)then begin begin if interaction=3
then;if filelineerrorstylep then printfileline else printnl(262);
print(721);end;printesc(1240);print(1250);printesc(1241);print(1251);
printcmdchr(curcmd,curchr);printchar(39);begin helpptr:=1;
helpline[0]:=1252;end;error;end{:1225};
...
if(eqtb[28264].int>0)then begin begindiagnostic;printnl(1270);
print(p-27949);print(1271);print(n);printchar(32);print(curval);
enddiagnostic(false);end;n:=n*256+curval;
if(a>=4)then geqdefine(p,131,n)else eqdefine(p,131,n);
if(p-27949)<eqtb[28262].int then if(a>=4)then geqworddefine(28262,p
-27949)else eqworddefine(28262,p-27949);
if(p-27949)>eqtb[28263].int then if(a>=4)then geqworddefine(28263,p
-27949)else eqworddefine(28263,p-27949);end else begin n:=curchr;
getrtoken;p:=curcs;
...
case n of 2:if(a>=4)then geqdefine(p,78,28266+curval)else eqdefine(p,78,
28266+curval);
3:if(a>=4)then geqdefine(p,79,28801+curval)else eqdefine(p,79,28801+
curval);
...
if not scankeyword(892)then begin begin if interaction=3 then;
if filelineerrorstylep then printfileline else printnl(262);print(1135);
end;begin helpptr:=2;helpline[1]:=1272;helpline[0]:=1273;end;error;end;
...
curchr=28522 then n:=16777215 else n:=255{:1246};p:=curchr;scancharnum;
...
if((curval<m)and(p<28522))or(curval>n)then begin begin if interaction=3
then;if filelineerrorstylep then printfileline else printnl(262);
print(1274);end;printint(curval);if p<28522 then begin print(1275);
printint(m);print(1276);end else print(1277);printint(n);
if m=0 then begin begin helpptr:=1;helpline[0]:=1278;end;error;
end else begin begin helpptr:=1;helpline[0]:=1279;end;error;end;
curval:=m;end;
if p<27693 then if(a>=4)then geqdefine(p,131,curval)else eqdefine(p,131,
curval)else if p<28522 then if(a>=4)then geqdefine(p,131,curval)else
...
interaction=3 then;
if filelineerrorstylep then printfileline else printnl(262);print(716);
end;printesc(569);begin helpptr:=2;helpline[1]:=1285;helpline[0]:=1286;
...
if filelineerrorstylep then printfileline else printnl(262);print(1393);
end;printhex(curval);printchar(41);begin helpptr:=1;helpline[0]:=1394;
end;error;goto 10;
end else if(n<0)or(n>9)then begin begin if interaction=3 then;
if filelineerrorstylep then printfileline else printnl(262);print(1395);
end;printint(n);printchar(41);begin helpptr:=1;helpline[0]:=1394;end;
error;goto 10;
...
if filelineerrorstylep then printfileline else printnl(262);print(1410);
end;begin helpptr:=1;helpline[0]:=1394;end;error;goto 10;end;
if(a>=4)then geqdefine(26403+j,curval,n)else eqdefine(26403+j,curval,n);
end else begin begin if interaction=3 then;
if filelineerrorstylep then printfileline else printnl(262);print(1411);
end;printhex(n);printchar(41);begin helpptr:=1;helpline[0]:=1394;end;
...
if j=1000 then begin begin if interaction=3 then;
if filelineerrorstylep then printfileline else printnl(262);print(1417);
end;begin helpptr:=1;helpline[0]:=1394;end;error;goto 10;end;
if(p=1)or(p=2)then begin if(a>=4)then geqdefine(26659+j,p,n)else
eqdefine(26659+j,p,n);
if(a>=4)then geqworddefine(29057+j,curval)else eqworddefine(29057+j,
curval);end else confusion(531);
end else begin begin if interaction=3 then;
if filelineerrorstylep then printfileline else printnl(262);print(1418);
end;
if p=1 then print(1419)else if p=2 then print(1420)else printchar(63);
print(1421);printhex(n);printchar(41);begin helpptr:=1;
helpline[0]:=1394;end;error;goto 10;end;end;
{:1474}others:confusion(1247)end;
...
longhelpseen then begin helpptr:=1;helpline[0]:=1306;
end else begin if interaction<3 then longhelpseen:=true;
begin helpptr:=4;helpline[3]:=1307;helpline[2]:=1308;helpline[1]:=1309;
helpline[0]:=1310;end;end;error;useerrhelp:=false;end{:1296};
...
printnl(1329);printint(curval);printchar(61);
if eqtb[25326+curval].hh.rh=-268435455 then print(428)else showbox(eqtb[
25326+curval].hh.rh);end{:1309};0:{1307:}begin gettoken;
if interaction=3 then;printnl(1323);
if curcs<>0 then begin sprintcs(curcs);printchar(61);end;printmeaning;
goto 50;end{:1307};4:{1462:}begin printnl(1323);
if eqtb[25633].hh.rh>0 then print(1404)else print(1405);printnl(1323);
if eqtb[25634].hh.rh>0 then print(1406)else print(1407);goto 50;
end{:1462};others:{1310:}begin p:=thetoks;if interaction=3 then;
printnl(1323);tokenshow(memtop-3);flushlist(mem[memtop-3].hh.rh);
goto 50;end{:1310}end;{1311:}enddiagnostic(true);
begin if interaction=3 then;
if filelineerrorstylep then printfileline else printnl(262);print(1330);
end;if selector=19 then if eqtb[28234].int<=0 then begin selector:=17;
print(1331);selector:=19;end{:1311};
...
end else begin begin helpptr:=5;helpline[4]:=1318;helpline[3]:=1319;
helpline[2]:=1320;helpline[1]:=1321;helpline[0]:=1322;end;end;error;end;
...
end;begin helpptr:=1;helpline[0]:=1334;end;
begin if interaction=3 then interaction:=2;if logopened then error;
ifdef('TEXMF_DEBUG')if interaction>0 then debughelp;
endif('TEXMF_DEBUG')history:=3;jumpout;end;end{:1317};
{1341:}selector:=21;print(1350);print(jobname);printchar(32);
...
begin if poolptr+1>poolsize then overflow(257,poolsize-initpoolptr);end;
formatident:=makestring;packjobname(833);
while not wopenout(fmtfile)do promptfilename(1351,833);printnl(1352);
...
dumpthings(formatengine[0],x);libcfree(formatengine);dumpint(388349257);
{1400:}dumpthings(xord[0],256);dumpthings(xchr[0],256);
dumpthings(xprn[0],256);{:1400};dumpint(268435455);dumpint(hashhigh);
dumpint(membot);dumpint(memtop);dumpint(29312);dumpint(8501);
...
printint(strptr);print(1335);printint(poolptr){:1322};{1324:}sortavail;
...
dumpint(varused);dumpint(dynused);println;printint(x);print(1336);
...
while j<29312 do begin if eqtb[j].int=eqtb[j+1].int then goto 42;
incr(j);end;l:=29313;goto 32;42:incr(j);l:=j;
while j<29312 do begin if eqtb[j].int<>eqtb[j+1].int then goto 32;
incr(j);end;32:dumpint(l-k);dumpthings(eqtb[k],l-k);k:=j+1;dumpint(k-l);
until k>29312;if hashhigh>0 then dumpthings(eqtb[29313],hashhigh);
...
if hashhigh>0 then dumpthings(hash[29313],hashhigh);dumpint(cscount);
println;printint(cscount);print(1337){:1331}{:1326};
...
for k:=0 to fontptr do begin printnl(1341);printesc(hash[15525+k].rh);
printchar(61);printfilename(fontname[k],fontarea[k],343);
if fontsize[k]<>fontdsize[k]then begin print(784);
printscaled(fontsize[k]);print(415);end;end;end{:1335};println;
printint(fmemptr-7);print(1338);printint(fontptr-0);
if fontptr<>1 then print(1339)else print(1340){:1333};
...
printint(hyphcount);if hyphcount<>1 then print(1342)else print(1343);
...
dumpthings(hyfnext[1],trieopptr);printnl(1344);printint(triemax);
print(1345);printint(trieopptr);
if trieopptr<>1 then print(1346)else print(1347);print(1348);
printint(trieopsize);
for k:=255 downto 0 do if trieused[k]>0 then begin printnl(849);
printint(trieused[k]);print(1349);printint(k);dumpint(k);
...
others:confusion(1369)end;end;{:1361}{1389:}procedure fixlanguage;
var l:ASCIIcode;
...
if interaction=3 then;
if filelineerrorstylep then printfileline else printnl(262);print(1197);
end;begin helpptr:=1;helpline[0]:=1196;end;error;end;mem[p].hh.b0:=18;
...
if filelineerrorstylep then printfileline else printnl(262);print(1096);
end;begin helpptr:=2;helpline[1]:=1097;helpline[0]:=1098;end;error;end;
...
incr(mem[q].hh.rh);d:=eqtb[28784].int;f:=eqtb[28247].int;unsave;
...
interaction=3 then;
if filelineerrorstylep then printfileline else printnl(262);print(1149);
end;begin helpptr:=1;helpline[0]:=1150;end;error;
...
then;if filelineerrorstylep then printfileline else printnl(262);
print(1063);end;begin helpptr:=2;helpline[1]:=1064;helpline[0]:=1065;
...
3 then;if filelineerrorstylep then printfileline else printnl(262);
print(1066);end;printesc(427);printint(255);begin helpptr:=3;
helpline[2]:=1067;helpline[1]:=1068;helpline[0]:=1069;end;boxerror(255);
end{:1039};
...
begin if interaction=3 then;
if filelineerrorstylep then printfileline else printnl(262);print(661);
end;printesc(950);print(662);begin helpptr:=1;helpline[0]:=1191;end;
...
end{:1199};end;{:1198}others:confusion(1099)end;end;
...
if filelineerrorstylep then printfileline else printnl(262);print(1121);
end;printcmdchr(curcmd,curchr);print(1122);begin helpptr:=2;
helpline[1]:=1123;helpline[0]:=1124;end;error;
end else begin begin if interaction=3 then;
if filelineerrorstylep then printfileline else printnl(262);print(721);
end;printcmdchr(curcmd,curchr);print(1125);begin helpptr:=2;
helpline[1]:=1126;helpline[0]:=1127;end;error;end end;
...
curlist.tailfield].hh.rh:=newpenalty(eqtb[29057+kp].int);
curlist.tailfield:=mem[curlist.tailfield].hh.rh;end;
...
if fontdir[mainf]=4 then disp:=eqtb[28799].int-eqtb[28800].int else disp
:=eqtb[28799].int;mainf:=eqtb[25632].hh.rh;
end else begin if fontdir[mainf]=4 then disp:=0 else if fontdir[mainf]=3
then disp:=eqtb[28800].int-eqtb[28799].int else disp:=eqtb[28800].int;
...
eqtb[29057+kp].int else begin mainp:=mem[curq].hh.rh;
mem[curq].hh.rh:=newpenalty(eqtb[29057+kp].int);
...
tailfield].hh.rh:=newpenalty(eqtb[29057+kp].int);
curlist.tailfield:=mem[curlist.tailfield].hh.rh;end;
...
.tailfield+1].int:=mem[curlist.tailfield+1].int+eqtb[29057+kp].int else
begin begin mem[curlist.tailfield].hh.rh:=newpenalty(eqtb[29057+kp].int)
;curlist.tailfield:=mem[curlist.tailfield].hh.rh;end;
...
if curlist.dirfield=3 then disp:=eqtb[28799].int else disp:=eqtb[28800].
...
if hashextra<hashhigh then hashextra:=hashhigh;eqtbtop:=29312+hashextra;
...
eqtb[24526].hh.b1:=0;for x:=29313 to eqtbtop do eqtb[x]:=eqtb[24526];
undumpint(x);
...
mem:=zmem;undumpint(x);if x<>29312 then goto 6666;undumpint(x);
...
repeat undumpint(x);if(x<1)or(k+x>29313)then goto 6666;
undumpthings(eqtb[k],x);k:=k+x;undumpint(x);
if(x<0)or(k+x>29313)then goto 6666;
for j:=k to k+x-1 do eqtb[j]:=eqtb[k-1];k:=k+x;until k>29312;
if hashhigh>0 then undumpthings(eqtb[29313],hashhigh);{:1330};
...
if hashhigh>0 then begin undumpthings(hash[29313],hashhigh);
if debugformatfile then begin printcsnames(29313,hashhigh-(29313));end;
...
if totalpages=0 then printnl(887)else if curs<>-2 then begin begin
...
if dviptr>(2147483647-dvioffset)then begin curs:=-2;fatalerror(876);end;
if dviptr>0 then writedvi(0,dviptr-1){:610};printnl(888);
printfilename(0,outputfilename,0);print(284);printint(totalpages);
if totalpages<>1 then print(889)else print(890);print(327);
printint(dvioffset+dviptr);print(891);bclose(dvifile);end{:653};
{1431:}synctexterminate(logopened);{:1431};
if logopened then begin writeln(logfile);aclose(logfile);
selector:=selector-2;if selector=17 then begin printnl(1353);
...
endfilereading;while openparens>0 do begin print(1354);decr(openparens);
end;if curlevel>1 then begin printnl(40);printesc(1355);print(1356);
printint(curlevel-1);printchar(41);end;
while condptr<>-268435455 do begin printnl(40);printesc(1355);
print(1357);printcmdchr(116,curif);if ifline<>0 then begin print(1358);
printint(ifline);end;print(1359);ifline:=mem[condptr+1].int;
...
then begin selector:=17;printnl(1360);selector:=19;end;
...
goto 10;end;endif('INITEX')printnl(1361);goto 10;end;10:end;
...
primitive(493,78,28250);primitive(494,78,28261);primitive(495,78,28256);
primitive(496,78,28257);primitive(497,78,28258);primitive(498,78,28259);
primitive(499,78,28260);if mltexp then begin mltexenabledp:=true;
if false then primitive(500,78,28262);primitive(501,78,28263);
primitive(502,78,28264);end;{:244}{254:}primitive(506,79,28778);
primitive(507,79,28779);primitive(508,79,28780);primitive(509,79,28781);
...
primitive(525,79,28797);primitive(526,79,28799);primitive(527,79,28800);
primitive(528,79,28798);{:254}{271:}primitive(32,67,0);
primitive(47,47,0);primitive(539,48,0);primitive(540,100,0);
primitive(541,43,0);primitive(542,44,0);primitive(543,64,0);
primitive(544,19,0);primitive(535,118,0);primitive(545,15,0);
primitive(546,102,0);primitive(536,70,0);primitive(547,65,0);
hash[15516].rh:=547;eqtb[15516]:=eqtb[curval];primitive(548,113,0);
primitive(549,96,0);primitive(550,97,0);primitive(551,98,0);
primitive(552,82,0);primitive(553,35,0);primitive(554,39,0);
primitive(555,42,0);primitive(335,40,0);primitive(358,21,0);
primitive(556,49,0);primitive(557,20,0);primitive(558,57,0);
primitive(559,101,0);primitive(560,37,0);primitive(561,68,0);
primitive(562,114,0);primitive(340,58,0);primitive(563,66,0);
primitive(426,92,0);primitive(564,45,0);primitive(565,88,0);
primitive(566,69,0);primitive(567,106,0);primitive(568,0,256);
hash[15521].rh:=568;eqtb[15521]:=eqtb[curval];primitive(569,108,0);
primitive(570,120,0);primitive(425,76,0);primitive(359,41,0);
primitive(571,36,0);primitive(572,59,0);primitive(573,38,0);
{:271}{340:}primitive(630,13,256);parloc:=curval;partoken:=65535+parloc;
{:340}{387:}primitive(665,115,0);primitive(666,115,1);
{:387}{395:}primitive(667,121,0);primitive(668,121,1);
primitive(669,121,2);primitive(670,121,3);primitive(671,121,4);
{:395}{422:}primitive(504,99,0);primitive(530,99,1);primitive(413,99,2);
primitive(414,99,3);{:422}{427:}primitive(704,87,113);
primitive(705,87,1);primitive(706,90,0);primitive(707,90,1);
primitive(708,91,1);primitive(709,91,3);primitive(710,91,2);
primitive(711,73,0);primitive(712,73,1);primitive(713,73,2);
primitive(714,73,3);primitive(715,73,4);
{:427}{479:}primitive(773,119,0);primitive(774,119,1);
primitive(775,119,3);primitive(776,119,4);primitive(777,119,5);
primitive(778,119,2);primitive(779,119,6);primitive(780,119,7);
primitive(781,119,8);primitive(782,119,9);primitive(783,119,10);
{:479}{498:}primitive(799,116,0);primitive(800,116,1);
primitive(801,116,2);primitive(802,116,3);primitive(803,116,4);
primitive(804,116,5);primitive(805,116,6);primitive(806,116,7);
primitive(807,116,8);primitive(808,116,9);primitive(809,116,10);
primitive(810,116,11);primitive(811,116,12);primitive(812,116,13);
primitive(813,116,14);primitive(814,116,15);primitive(815,116,16);
primitive(816,116,17);primitive(817,116,18);primitive(818,116,19);
primitive(819,116,20);primitive(820,116,21);primitive(821,116,22);
primitive(822,116,23);{:498}{502:}primitive(823,117,2);
hash[15518].rh:=823;eqtb[15518]:=eqtb[curval];primitive(824,117,4);
primitive(825,117,3);{:502}{564:}primitive(850,95,0);
hash[15525].rh:=850;eqtb[15525]:=eqtb[curval];
{:564}{791:}primitive(949,4,256);primitive(950,5,257);
hash[15515].rh:=950;eqtb[15515]:=eqtb[curval];primitive(951,5,258);
hash[15519].rh:=952;hash[15520].rh:=952;eqtb[15520].hh.b0:=9;
eqtb[15520].hh.rh:=memtop-11;eqtb[15520].hh.b1:=1;
eqtb[15519]:=eqtb[15520];eqtb[15519].hh.b0:=126;
{:791}{994:}primitive(1021,89,0);primitive(1022,89,1);
primitive(1023,89,2);primitive(1024,89,3);primitive(1025,89,4);
primitive(1026,89,5);primitive(1027,89,6);primitive(1028,89,7);
{:994}{1064:}primitive(1077,14,0);primitive(1078,14,1);
{:1064}{1070:}primitive(1079,29,4);primitive(1080,29,0);
primitive(1081,29,1);primitive(1082,29,2);primitive(1083,29,3);
primitive(1084,30,4);primitive(1085,30,0);primitive(1086,30,1);
primitive(1087,30,2);primitive(1088,30,3);primitive(341,31,5);
primitive(345,32,1);primitive(347,33,99);
{:1070}{1083:}primitive(1106,24,1);primitive(1107,24,0);
primitive(1108,25,1);primitive(1109,25,0);primitive(427,23,0);
primitive(1110,23,1);primitive(1111,23,2);primitive(1016,23,3);
primitive(1112,23,4);primitive(1018,23,5);primitive(1113,23,117);
primitive(1114,75,3);primitive(1115,75,4);primitive(1116,75,1);
primitive(1117,34,99);primitive(1118,34,100);primitive(1119,34,101);
primitive(1120,34,102);{:1083}{1100:}primitive(1142,46,1);
primitive(1143,46,0);{:1100}{1119:}primitive(1154,28,14);
primitive(1155,28,13);primitive(1156,28,12);primitive(1157,26,0);
primitive(1158,26,1);primitive(1159,27,0);primitive(1160,27,1);
{:1119}{1126:}primitive(45,50,1);primitive(356,50,0);
{:1126}{1153:}primitive(1193,51,0);primitive(1194,51,1);
{:1153}{1168:}primitive(916,53,18);primitive(917,53,19);
primitive(918,53,20);primitive(919,53,21);primitive(920,53,22);
primitive(921,53,23);primitive(922,53,24);primitive(923,53,25);
primitive(925,53,28);primitive(924,53,29);primitive(1198,54,0);
primitive(928,54,1);primitive(929,54,2);
{:1168}{1181:}primitive(911,56,0);primitive(912,56,2);
primitive(913,56,4);primitive(914,56,6);
{:1181}{1190:}primitive(1216,55,0);primitive(1217,55,1);
primitive(1218,55,2);primitive(1219,55,3);primitive(1220,55,4);
primitive(1221,55,5);{:1190}{1200:}primitive(926,52,32);
primitive(927,52,33);hash[15517].rh:=927;eqtb[15517]:=eqtb[curval];
{:1200}{1220:}primitive(1240,103,1);primitive(1241,103,2);
primitive(1242,103,4);primitive(1243,107,0);primitive(1244,107,1);
primitive(1245,107,2);primitive(1246,107,3);
{:1220}{1231:}primitive(1260,104,0);primitive(1261,104,1);
{:1231}{1234:}primitive(1262,105,0);primitive(1263,105,1);
primitive(1264,105,2);primitive(1265,105,3);primitive(1266,105,4);
primitive(1267,105,5);primitive(1268,105,6);
if mltexp then begin primitive(1269,105,7);end;
...
primitive(440,93,27181);primitive(441,93,27437);primitive(505,93,28522);
primitive(430,94,25583);primitive(431,94,25599);primitive(432,94,25615);
{:1242}{1263:}primitive(992,109,0);primitive(1004,109,1);
{:1263}{1267:}primitive(1291,83,0);primitive(1292,83,1);
{:1267}{1275:}primitive(272,110,0);primitive(273,110,1);
primitive(274,110,2);primitive(1301,110,3);
{:1275}{1285:}primitive(1302,63,1);primitive(1303,63,0);
{:1285}{1290:}primitive(1304,61,0);primitive(1305,61,1);
{:1290}{1299:}primitive(1311,60,26925);primitive(1312,60,27181);
{:1299}{1304:}primitive(1313,22,0);primitive(1314,22,1);
primitive(1315,22,2);primitive(1316,22,3);primitive(1317,22,4);
{:1304}{1357:}primitive(1363,62,0);primitive(627,62,1);writeloc:=curval;
primitive(1364,62,2);primitive(1365,62,3);hash[15524].rh:=1365;
eqtb[15524]:=eqtb[curval];primitive(1366,62,4);primitive(1367,62,5);
{:1357}{1420:}primitive(1392,78,28265);
{:1420}{1454:}primitive(438,86,0);{:1454}{1459:}primitive(1396,111,1);
primitive(1397,111,0);primitive(1398,111,3);primitive(1399,111,2);
{:1459}{1466:}primitive(1408,74,0);primitive(1409,85,26403);
{:1466}{1471:}primitive(1412,84,1);primitive(1413,84,2);{:1471};
...
printnl(1362);fflush(stdout);read(stdin,m);
...
memtop-membot+1);zmem:=yzmem-membot;eqtbtop:=29312+hashextra;
if hashextra=0 then hashtop:=24526 else hashtop:=eqtbtop;
yhash:=xmallocarray(twohalves,1+hashtop-hashoffset);
hash:=yhash-hashoffset;hash[514].lh:=0;hash[514].rh:=0;
...
{:112}{296:}if 94847+hashextra>268435455 then bad:=21;
...
write(stdout,'This is pTeX, Version 3.14159265','-p3.7')else write(
stdout,'This is pTeX, Version 3.14159265','-p3.7');write(stdout,' (');
...
fontdir[0]:=0;fontnumext[0]:=0;fontname[0]:=850;fontarea[0]:=343;
...
{776:}magicoffset:=strstart[943]-9*18{:776};
{76:}if interaction=0 then selector:=16 else selector:=17{:76};
