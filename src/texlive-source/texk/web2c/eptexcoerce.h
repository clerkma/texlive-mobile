...
void zprintdirectionalt (integer d);
#define printdirectionalt(d) zprintdirectionalt((integer) (d))
#define printdirectionalt_regmem
void zprintdirection (integer d);
#define printdirection(d) zprintdirection((integer) (d))
#define printdirection_regmem
void zprintkanji (integer s);
#define printkanji(s) zprintkanji((integer) (s))
...
#define showtokenlist_regmem register memoryword *mem=zmem, *eqtb=zeqtb;
void runaway (void);
...
void zprintfamandchar (halfword p,integer t);
#define printfamandchar(p, t) zprintfamandchar((halfword) (p), (integer) (t))
...
#define deleqworddefine_regmem register memoryword *eqtb=zeqtb;
...
#define delgeqworddefine_regmem register memoryword *eqtb=zeqtb;
...
void scanomegafifteenbitint (void);
#define scanomegafifteenbitint_regmem
