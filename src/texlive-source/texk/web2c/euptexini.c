...
initialize ( void ) 
{
  ...
  pagesofar [8 ]= 0 ;
  pagemaxdepth = 0 ;
  {register integer for_end; k = 29188 ;for_end = 30307 ; if ( k <= for_end) 
  do 
    xeqlevel [k ]= 1 ;
  while ( k++ < for_end ) ;} 
  ...
  if ( iniversion ) 
  {
	...
	eqtb [26618 + k ].hh .v.RH = 16 ;
      ...
      eqtb [26760 ].hh .v.RH = 19 ;
      eqtb [26761 ].hh .v.RH = 19 ;
      eqtb [26766 ].hh .v.RH = 16 ;
      eqtb [26839 ].hh .v.RH = 17 ;
    ...
    {register integer for_end; k = 29188 ;for_end = 29514 ; if ( k <= 
    for_end) do 
      eqtb [k ].cint = 0 ;
    while ( k++ < for_end ) ;} 
    eqtb [29245 ].cint = 256 ;
    ...
    {register integer for_end; k = 0 ;for_end = 255 ; if ( k <= for_end) do 
      {
	eqtb [29515 + k ].cint = -1 ;
	setintone ( eqtb [29515 + k ], -1 ) ;
      } 
    while ( k++ < for_end ) ;} 
    eqtb [29561 ].cint = 0 ;
    setintone ( eqtb [29561 ], 0 ) ;
    {register integer for_end; k = 29771 ;for_end = 30307 ; if ( k <= 
    for_end) do 
      eqtb [k ].cint = 0 ;
    while ( k++ < for_end ) ;} 
    hashused = 15514 ;
...
zlinebreak ( boolean d ) 
{
  ...
  if ( eqtb [25061 ].hh .v.RH == -1073741823L ) {
    ...
    if ( eqtb [29788 ].cint == 0 ) 
    {
      lastspecialline = 0 ;
      secondwidth = eqtb [29774 ].cint ;
      secondindent = 0 ;
    } 
    else {
      ...
      {
	firstwidth = eqtb [29774 ].cint - abs ( eqtb [29788 ].cint ) ;
	if ( eqtb [29788 ].cint >= 0 ) 
	firstindent = eqtb [29788 ].cint ;
	else firstindent = 0 ;
	secondwidth = eqtb [29774 ].cint ;
	secondindent = 0 ;
      } 
	...
	firstwidth = eqtb [29774 ].cint ;
	firstindent = 0 ;
	secondwidth = eqtb [29774 ].cint - abs ( eqtb [29788 ].cint ) ;
	if ( eqtb [29788 ].cint >= 0 ) 
	secondindent = eqtb [29788 ].cint ;
	else secondindent = 0 ;
      } 
    } 
  } 
  ...
  while ( true ) {
	...
	;
      ...
      printnl ( 1033 ) ;
#endif /* STAT */
      background [2 ]= background [2 ]+ eqtb [29791 ].cint ;
      finalpass = true ;
    } 
  } 
  lab30: 
...
prefixedcommand ( void ) 
{
  ...
  case 109 : 
	...
	enddiagnostic ( false ) ;
      ...
      if ( ( p - 28932 ) < eqtb [29245 ].cint ) {
	  
	if ( ( a >= 4 ) ) 
	geqworddefine ( 29245 , p - 28932 ) ;
	else eqworddefine ( 29245 , p - 28932 ) ;
      } 
      if ( ( p - 28932 ) > eqtb [29246 ].cint ) {
	  
	if ( ( a >= 4 ) ) 
	geqworddefine ( 29246 , p - 28932 ) ;
	else eqworddefine ( 29246 , p - 28932 ) ;
      } 
    } 
    else {
	...
	default: 
	{
	  ...
	  {case 3 : 
	    if ( ( a >= 4 ) ) 
	    geqdefine ( p , 82 , 29259 + curval ) ;
	    else eqdefine ( p , 82 , 29259 + curval ) ;
	    break ;
	  case 4 : 
	    if ( ( a >= 4 ) ) 
	    geqdefine ( p , 83 , 29796 + curval ) ;
	    else eqdefine ( p , 83 , 29796 + curval ) ;
	    break ;
	  case 5 : 
	    if ( ( a >= 4 ) ) 
  ...
  case 88 : 
	...
	if ( ( p == 1 ) || ( p == 2 ) ) 
	{
	  ...
	  if ( ( a >= 4 ) ) 
	  geqworddefine ( 30052 + j , curval ) ;
	  else eqworddefine ( 30052 + j , curval ) ;
	} 
	else confusion ( 537 ) ;
      } 
      else {
...
storefmtfile ( void ) 
{
  ...
  packjobname ( 879 ) ;
  while ( ! wopenout ( fmtfile ) ) promptfilename ( 1413 , 879 ) ;
  printnl ( 1414 ) ;
  ...
  if ( hashhigh > 0 ) 
  dumpthings ( eqtb [30308 ], hashhigh ) ;
  dumpint ( parloc ) ;
  dumpint ( writeloc ) ;
  ...
  if ( hashhigh > 0 ) 
  dumpthings ( hash [30308 ], hashhigh ) ;
  dumpint ( cscount ) ;
  println () ;
  printint ( cscount ) ;
  print ( 1399 ) ;
...
loadfmtfile ( void ) 
{
  ...
  eqtb [24527 ].hh .v.RH = -1073741823L ;
  eqtb [24527 ].hh.b1 = 0 ;
  {register integer for_end; x = 30308 ;for_end = eqtbtop ; if ( x <= 
  for_end) do 
    eqtb [x ]= eqtb [24527 ];
  while ( x++ < for_end ) ;} 
  {
  ...
  if ( hashhigh > 0 ) 
  undumpthings ( eqtb [30308 ], hashhigh ) ;
  {
    undumpint ( x ) ;
    if ( ( x < 514 ) || ( x > hashtop ) ) 
    goto lab6666 ;
  ...
  if ( hashhigh > 0 ) 
  {
    undumpthings ( hash [30308 ], hashhigh ) ;
    if ( debugformatfile ) 
    {
      printcsnames ( 30308 , hashhigh - ( 30308 ) ) ;
    } 
  } 
  undumpint ( cscount ) ;
  {
...
initprim ( void ) 
{
  ...
  primitive ( 499 , 82 , 29239 ) ;
  primitive ( 500 , 82 , 29240 ) ;
  primitive ( 501 , 82 , 29241 ) ;
  primitive ( 502 , 82 , 29242 ) ;
  primitive ( 503 , 82 , 29243 ) ;
  if ( mltexp ) 
  {
    mltexenabledp = true ;
    if ( false ) 
    primitive ( 504 , 82 , 29245 ) ;
    primitive ( 505 , 82 , 29246 ) ;
    primitive ( 506 , 82 , 29247 ) ;
  } 
  primitive ( 510 , 83 , 29771 ) ;
  primitive ( 511 , 83 , 29772 ) ;
  primitive ( 512 , 83 , 29773 ) ;
  ...
  primitive ( 530 , 83 , 29792 ) ;
  primitive ( 531 , 83 , 29793 ) ;
  primitive ( 532 , 83 , 29791 ) ;
  primitive ( 32 , 69 , 0 ) ;
  primitive ( 47 , 48 , 0 ) ;
  primitive ( 547 , 49 , 0 ) ;
  primitive ( 548 , 104 , 0 ) ;
  ...
  primitive ( 692 , 126 , 3 ) ;
  primitive ( 693 , 126 , 4 ) ;
  primitive ( 508 , 103 , membot + 0 ) ;
  primitive ( 536 , 103 , membot + 1 ) ;
  primitive ( 417 , 103 , membot + 2 ) ;
  primitive ( 418 , 103 , membot + 3 ) ;
  primitive ( 731 , 91 , 118 ) ;
  primitive ( 732 , 91 , 1 ) ;
  primitive ( 733 , 94 , 0 ) ;
  primitive ( 734 , 94 , 1 ) ;
  primitive ( 735 , 95 , 1 ) ;
  ...
  primitive ( 811 , 124 , 8 ) ;
  primitive ( 812 , 124 , 9 ) ;
  primitive ( 813 , 124 , 10 ) ;
  primitive ( 814 , 124 , 18 ) ;
  primitive ( 844 , 121 , 0 ) ;
  primitive ( 845 , 121 , 1 ) ;
  primitive ( 846 , 121 , 2 ) ;
  primitive ( 847 , 121 , 3 ) ;
  ...
  primitive ( 852 , 121 , 8 ) ;
  primitive ( 853 , 121 , 9 ) ;
  primitive ( 854 , 121 , 10 ) ;
  primitive ( 855 , 121 , 11 ) ;
  primitive ( 856 , 121 , 12 ) ;
  primitive ( 857 , 121 , 13 ) ;
  primitive ( 858 , 121 , 14 ) ;
  primitive ( 859 , 121 , 15 ) ;
  primitive ( 860 , 121 , 16 ) ;
  primitive ( 861 , 121 , 20 ) ;
  primitive ( 862 , 121 , 21 ) ;
  primitive ( 863 , 121 , 22 ) ;
  primitive ( 864 , 121 , 23 ) ;
  primitive ( 865 , 121 , 24 ) ;
  primitive ( 866 , 121 , 25 ) ;
  primitive ( 867 , 121 , 26 ) ;
  primitive ( 316 , 122 , 2 ) ;
  hash [15518 ].v.RH = 316 ;
  ...
  primitive ( 1162 , 24 , 4 ) ;
  primitive ( 1065 , 24 , 5 ) ;
  primitive ( 1163 , 24 , 122 ) ;
  primitive ( 1164 , 79 , 3 ) ;
  primitive ( 1165 , 79 , 4 ) ;
  primitive ( 1166 , 79 , 1 ) ;
  primitive ( 1167 , 35 , 99 ) ;
  primitive ( 1168 , 35 , 100 ) ;
  primitive ( 1169 , 35 , 101 ) ;
  primitive ( 1170 , 35 , 102 ) ;
  primitive ( 1197 , 47 , 1 ) ;
  primitive ( 1198 , 47 , 0 ) ;
  primitive ( 1209 , 29 , 14 ) ;
  primitive ( 1210 , 29 , 13 ) ;
  primitive ( 1211 , 29 , 12 ) ;
  primitive ( 1212 , 27 , 0 ) ;
  primitive ( 1213 , 27 , 1 ) ;
  primitive ( 1214 , 28 , 0 ) ;
  primitive ( 1215 , 28 , 1 ) ;
  ...
  primitive ( 1296 , 107 , 1 ) ;
  primitive ( 1297 , 107 , 2 ) ;
  primitive ( 1298 , 107 , 4 ) ;
  primitive ( 1299 , 111 , 0 ) ;
  primitive ( 1300 , 111 , 1 ) ;
  primitive ( 1301 , 111 , 2 ) ;
  primitive ( 1302 , 111 , 3 ) ;
  primitive ( 1319 , 108 , 0 ) ;
  primitive ( 1320 , 108 , 1 ) ;
  primitive ( 1321 , 109 , 0 ) ;
  primitive ( 1322 , 109 , 9 ) ;
  primitive ( 1323 , 109 , 1 ) ;
  primitive ( 1324 , 109 , 2 ) ;
  primitive ( 1325 , 109 , 3 ) ;
  primitive ( 1326 , 109 , 4 ) ;
  primitive ( 1327 , 109 , 5 ) ;
  primitive ( 1328 , 109 , 6 ) ;
  primitive ( 1329 , 109 , 7 ) ;
  if ( mltexp ) 
  {
    primitive ( 1330 , 109 , 8 ) ;
  } 
  primitive ( 437 , 97 , 26362 ) ;
  primitive ( 438 , 97 , 26618 ) ;
  primitive ( 439 , 97 , 27130 ) ;
  primitive ( 446 , 97 , 28676 ) ;
  primitive ( 1335 , 97 , 28804 ) ;
  primitive ( 443 , 97 , 27908 ) ;
  primitive ( 444 , 97 , 28164 ) ;
  primitive ( 445 , 97 , 28420 ) ;
  primitive ( 509 , 97 , 29515 ) ;
  primitive ( 1336 , 97 , 29643 ) ;
  primitive ( 434 , 98 , 25589 ) ;
  primitive ( 435 , 98 , 25845 ) ;
  primitive ( 436 , 98 , 26101 ) ;
  primitive ( 1039 , 113 , 0 ) ;
  primitive ( 1051 , 113 , 1 ) ;
  primitive ( 1355 , 87 , 0 ) ;
  primitive ( 1356 , 87 , 1 ) ;
  primitive ( 274 , 114 , 0 ) ;
  primitive ( 275 , 114 , 1 ) ;
  primitive ( 276 , 114 , 2 ) ;
  primitive ( 1365 , 114 , 3 ) ;
  primitive ( 1366 , 65 , 1 ) ;
  primitive ( 1367 , 65 , 0 ) ;
  primitive ( 1368 , 63 , 0 ) ;
  primitive ( 1369 , 63 , 1 ) ;
  primitive ( 1375 , 62 , 27908 ) ;
  primitive ( 1376 , 62 , 28164 ) ;
  primitive ( 1377 , 23 , 0 ) ;
  primitive ( 1378 , 23 , 1 ) ;
  primitive ( 1379 , 23 , 2 ) ;
  primitive ( 1380 , 23 , 3 ) ;
  ...
  primitive ( 1426 , 64 , 2 ) ;
  primitive ( 1427 , 64 , 3 ) ;
  hash [15524 ].v.RH = 1427 ;
  eqtb [15524 ]= eqtb [curval ];
  primitive ( 1428 , 64 , 4 ) ;
  primitive ( 1429 , 64 , 5 ) ;
  primitive ( 1563 , 82 , 29248 ) ;
  primitive ( 442 , 90 , 0 ) ;
  primitive ( 1567 , 115 , 1 ) ;
  primitive ( 1568 , 115 , 0 ) ;
  primitive ( 1569 , 115 , 3 ) ;
  primitive ( 1570 , 115 , 2 ) ;
  primitive ( 1571 , 116 , 0 ) ;
  primitive ( 1572 , 116 , 1 ) ;
  primitive ( 1573 , 116 , 2 ) ;
  primitive ( 1586 , 78 , 0 ) ;
  primitive ( 1587 , 89 , 27386 ) ;
  primitive ( 1590 , 88 , 1 ) ;
  primitive ( 1591 , 88 , 2 ) ;
  nonewcontrolsequence = true ;
} 
...
mainbody ( void ) 
{
  ...
  if ( 65535L < 255 ) 
  bad = 19 ;
  if ( 536901218L + hashextra > 1073741823L ) 
  bad = 21 ;
  ...
  fprintf ( stdout , "%s%s%s%s%s",  "This is e-upTeX, Version 3.14159265" , "-p3.7" , "-u1.20"   , "-150805" , "-2.6" ) ;
  else
  fprintf ( stdout , "%s%s%s%s%s",  "This is e-upTeX, Version 3.14159265" , "-p3.7" ,   "-u1.20" , "-150805" , "-2.6" ) ;
  Fputs ( stdout ,  " (" ) ;
  ...
  outputfilename = 0 ;
  {
    ...
    == 1394 ) ) 
    {
      ...
      primitive ( 1452 , 77 , 3 ) ;
      primitive ( 1453 , 77 , 4 ) ;
      primitive ( 1454 , 77 , 10 ) ;
      primitive ( 815 , 124 , 11 ) ;
      primitive ( 540 , 119 , 1 ) ;
      primitive ( 816 , 124 , 12 ) ;
      primitive ( 817 , 124 , 13 ) ;
      primitive ( 818 , 124 , 14 ) ;
      primitive ( 819 , 124 , 15 ) ;
      primitive ( 820 , 124 , 16 ) ;
      primitive ( 821 , 124 , 17 ) ;
      primitive ( 1430 , 64 , 6 ) ;
      primitive ( 533 , 83 , 29794 ) ;
      primitive ( 534 , 83 , 29795 ) ;
      primitive ( 1455 , 77 , 7 ) ;
      primitive ( 1456 , 77 , 8 ) ;
      primitive ( 1457 , 77 , 9 ) ;
      primitive ( 869 , 121 , 27 ) ;
      primitive ( 1459 , 81 , 25071 ) ;
      primitive ( 1460 , 82 , 29249 ) ;
      primitive ( 1461 , 82 , 29250 ) ;
      primitive ( 1462 , 82 , 29251 ) ;
      primitive ( 1463 , 82 , 29252 ) ;
      primitive ( 1464 , 82 , 29253 ) ;
      primitive ( 1465 , 82 , 29254 ) ;
      primitive ( 1466 , 82 , 29255 ) ;
      primitive ( 1467 , 82 , 29256 ) ;
      primitive ( 1468 , 82 , 29257 ) ;
      primitive ( 1483 , 77 , 11 ) ;
      primitive ( 1484 , 77 , 12 ) ;
      primitive ( 1485 , 77 , 13 ) ;
      primitive ( 1486 , 77 , 14 ) ;
      primitive ( 1487 , 77 , 15 ) ;
      primitive ( 1488 , 77 , 18 ) ;
      primitive ( 1489 , 77 , 19 ) ;
      primitive ( 1490 , 77 , 20 ) ;
      primitive ( 1491 , 77 , 21 ) ;
      primitive ( 1492 , 77 , 22 ) ;
      primitive ( 1493 , 77 , 23 ) ;
      primitive ( 1494 , 77 , 24 ) ;
      primitive ( 1495 , 23 , 4 ) ;
      primitive ( 1497 , 23 , 5 ) ;
      primitive ( 1498 , 125 , 1 ) ;
      primitive ( 1499 , 125 , 5 ) ;
      primitive ( 1500 , 23 , 6 ) ;
      primitive ( 1504 , 94 , 2 ) ;
      primitive ( 974 , 53 , 1 ) ;
      primitive ( 1508 , 82 , 29258 ) ;
      primitive ( 1509 , 37 , 6 ) ;
      primitive ( 1510 , 37 , 7 ) ;
      primitive ( 1511 , 37 , 10 ) ;
      primitive ( 1512 , 37 , 11 ) ;
      primitive ( 1521 , 120 , 2 ) ;
      primitive ( 1523 , 110 , 1 ) ;
      primitive ( 868 , 118 , 1 ) ;
      primitive ( 1524 , 121 , 17 ) ;
      primitive ( 1525 , 121 , 18 ) ;
      primitive ( 1526 , 121 , 19 ) ;
      primitive ( 1310 , 107 , 8 ) ;
      primitive ( 1532 , 77 , 29 ) ;
      primitive ( 1533 , 77 , 30 ) ;
      primitive ( 1534 , 77 , 31 ) ;
      primitive ( 1535 , 77 , 32 ) ;
      primitive ( 1539 , 77 , 16 ) ;
      primitive ( 1540 , 77 , 17 ) ;
      primitive ( 1541 , 77 , 25 ) ;
      primitive ( 1542 , 77 , 26 ) ;
      primitive ( 1543 , 77 , 27 ) ;
      primitive ( 1544 , 77 , 28 ) ;
      primitive ( 1545 , 22 , 5 ) ;
      primitive ( 1546 , 126 , 5 ) ;
      primitive ( 1547 , 126 , 6 ) ;
      primitive ( 1548 , 126 , 7 ) ;
      primitive ( 1549 , 126 , 8 ) ;
      primitive ( 1550 , 126 , 9 ) ;
      primitive ( 1554 , 28 , 2 ) ;
      primitive ( 1555 , 28 , 3 ) ;
      primitive ( 1556 , 96 , 25328 ) ;
      primitive ( 1557 , 96 , 25329 ) ;
      primitive ( 1558 , 96 , 25330 ) ;
