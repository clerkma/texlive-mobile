...
#define noptions ( 6 ) 
  ...
  do {
    ...
    {
      printversionandexit ( "This is pTFtoPL, Version 3.3-p1.7" , nil , 
      "D.E. Knuth" , nil ) ;
    } 
  ...
  {
    fprintf ( stderr , "%s%s\n",  "ptftopl" , ": Need one or two file arguments." ) ;
    usage ( "ptftopl" ) ;
  } 
...
{
  integer k  ;
  kpsesetprogramname ( argv [0 ], "ptftopl" ) ;
  ...
  if ( verbose ) 
  {
    Fputs ( stderr ,  "This is pTFtoPL, Version 3.3-p1.7" ) ;
    fprintf ( stderr , "%s\n",  versionstring ) ;
...
zoutkanji ( integer jiscode ) 
{
  ...
  if ( charcodeformat == charcodeoctal ) 
  {
    ...
    putc ( xchr [Hi ( cx ) ],  plfile );
    putc ( xchr [Lo ( cx ) ],  plfile );
  } 
} 
boolean 
...
void mainbody( void ) {
  ...
  if ( fileformat != 1 ) 
  {
    ...
    {register integer for_end; kanjiindex = 0 ;for_end = 7237 ; if ( 
