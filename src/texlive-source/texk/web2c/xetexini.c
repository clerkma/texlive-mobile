...
initialize ( void ) 
{
  ...
  pagesofar [7 ]= 0 ;
  pagemaxdepth = 0 ;
  {register integer for_end; k = 8938740L ;for_end = 10053467L ; if ( k <= 
  for_end) do 
    xeqlevel [k ]= 1 ;
  while ( k++ < for_end ) ;} 
  ...
  prim [0 ].v.LH = 0 ;
  prim [0 ].v.RH = 0 ;
  {register integer for_end; k = 1 ;for_end = 481 ; if ( k <= for_end) do 
    prim [k ]= prim [0 ];
  while ( k++ < for_end ) ;} 
  primeqtb [0 ].hh.b1 = 0 ;
  ...
  if ( iniversion ) 
  {
    ...
    dynused = 15 ;
    eqtb [2252239L ].hh.b0 = 103 ;
    eqtb [2252239L ].hh .v.RH = -268435455L ;
    eqtb [2252239L ].hh.b1 = 0 ;
    {register integer for_end; k = 1 ;for_end = eqtbtop ; if ( k <= for_end) 
    do 
      eqtb [k ]= eqtb [2252239L ];
    while ( k++ < for_end ) ;} 
    eqtb [2252240L ].hh .v.RH = membot ;
    eqtb [2252240L ].hh.b1 = 1 ;
    eqtb [2252240L ].hh.b0 = 119 ;
    {register integer for_end; k = 2252241L ;for_end = 2252770L ; if ( k <= 
    for_end) do 
      eqtb [k ]= eqtb [2252240L ];
    while ( k++ < for_end ) ;} 
    mem [membot ].hh .v.RH = mem [membot ].hh .v.RH + 531 ;
    eqtb [2252771L ].hh .v.RH = -268435455L ;
    eqtb [2252771L ].hh.b0 = 120 ;
    eqtb [2252771L ].hh.b1 = 1 ;
    {register integer for_end; k = 2253039L ;for_end = 2253042L ; if ( k <= 
    for_end) do 
      eqtb [k ]= eqtb [2252771L ];
    while ( k++ < for_end ) ;} 
    {register integer for_end; k = 2252772L ;for_end = 2253038L ; if ( k <= 
    for_end) do 
      eqtb [k ]= eqtb [2252239L ];
    while ( k++ < for_end ) ;} 
    eqtb [2253043L ].hh .v.RH = -268435455L ;
    eqtb [2253043L ].hh.b0 = 121 ;
    eqtb [2253043L ].hh.b1 = 1 ;
    {register integer for_end; k = 2253044L ;for_end = 2253298L ; if ( k <= 
    for_end) do 
      eqtb [k ]= eqtb [2253043L ];
    while ( k++ < for_end ) ;} 
    eqtb [2253299L ].hh .v.RH = 0 ;
    eqtb [2253299L ].hh.b0 = 122 ;
    eqtb [2253299L ].hh.b1 = 1 ;
    {register integer for_end; k = 2253300L ;for_end = 2254067L ; if ( k <= 
    for_end) do 
      eqtb [k ]= eqtb [2253299L ];
    while ( k++ < for_end ) ;} 
    eqtb [2254068L ].hh .v.RH = 0 ;
    eqtb [2254068L ].hh.b0 = 122 ;
    eqtb [2254068L ].hh.b1 = 1 ;
    {register integer for_end; k = 2254069L ;for_end = 8938739L ; if ( k <= 
    for_end) do 
      eqtb [k ]= eqtb [2254068L ];
    while ( k++ < for_end ) ;} 
    {register integer for_end; k = 0 ;for_end = 1114111L ; if ( k <= 
    for_end) do 
      {
	eqtb [2254068L + k ].hh .v.RH = 12 ;
	eqtb [6710516L + k ].hh .v.RH = k ;
	eqtb [5596404L + k ].hh .v.RH = 1000 ;
      } 
    while ( k++ < for_end ) ;} 
    eqtb [2254081L ].hh .v.RH = 5 ;
    eqtb [2254100L ].hh .v.RH = 10 ;
    eqtb [2254160L ].hh .v.RH = 0 ;
    eqtb [2254105L ].hh .v.RH = 14 ;
    eqtb [2254195L ].hh .v.RH = 15 ;
    eqtb [2254068L ].hh .v.RH = 9 ;
    {register integer for_end; k = 48 ;for_end = 57 ; if ( k <= for_end) do 
      eqtb [6710516L + k ].hh .v.RH = k + setclassfield ( 7 ) ;
    while ( k++ < for_end ) ;} 
    {register integer for_end; k = 65 ;for_end = 90 ; if ( k <= for_end) do 
      {
	eqtb [2254068L + k ].hh .v.RH = 11 ;
	eqtb [2254068L + k + 32 ].hh .v.RH = 11 ;
	eqtb [6710516L + k ].hh .v.RH = k + setfamilyfield ( 1 ) + 
	setclassfield ( 7 ) ;
	eqtb [6710516L + k + 32 ].hh .v.RH = k + 32 + setfamilyfield ( 1 ) + 
	setclassfield ( 7 ) ;
	eqtb [3368180L + k ].hh .v.RH = k + 32 ;
	eqtb [3368180L + k + 32 ].hh .v.RH = k + 32 ;
	eqtb [4482292L + k ].hh .v.RH = k ;
	eqtb [4482292L + k + 32 ].hh .v.RH = k ;
	eqtb [5596404L + k ].hh .v.RH = 999 ;
      } 
    while ( k++ < for_end ) ;} 
    {register integer for_end; k = 8938740L ;for_end = 8939076L ; if ( k <= 
    for_end) do 
      eqtb [k ].cint = 0 ;
    while ( k++ < for_end ) ;} 
    eqtb [8938795L ].cint = 256 ;
    eqtb [8938796L ].cint = -1 ;
    eqtb [8938757L ].cint = 1000 ;
    eqtb [8938741L ].cint = 10000 ;
    eqtb [8938781L ].cint = 1 ;
    eqtb [8938780L ].cint = 25 ;
    eqtb [8938785L ].cint = 92 ;
    eqtb [8938788L ].cint = 13 ;
    {register integer for_end; k = 0 ;for_end = 65535L ; if ( k <= for_end) 
    do 
      eqtb [8939077L + k ].cint = -1 ;
    while ( k++ < for_end ) ;} 
    eqtb [8939123L ].cint = 0 ;
    {register integer for_end; k = 10053189L ;for_end = 10053467L ; if ( k 
    <= for_end) do 
      eqtb [k ].cint = 0 ;
    while ( k++ < for_end ) ;} 
    primused = 481 ;
...
znewtrieop ( smallnumber d , smallnumber n , trieopcode v ) 
{
  ...
  while ( true ) {
    ...
    if ( l == 0 ) 
    {
      ...
      overflow ( 66345L , trieopsize ) ;
      u = trieused [curlang ];
      if ( u == maxtrieop ) 
      overflow ( 66346L , maxtrieop - mintrieop ) ;
      incr ( trieopptr ) ;
      incr ( u ) ;
      trieused [curlang ]= u ;
      if ( u > maxopused ) 
  ...
  if ( trienotready ) 
  {
	...
	if ( digitsensed || ( curchr < 48 ) || ( curchr > 57 ) ) 
	{
	  ...
	  curchr = 0 ;
	    ...
	    curchr = eqtb [3368180L + curchr ].hh .v.RH ;
	    if ( curchr == 0 ) 
	    {
	      {
		if ( interaction == 3 ) 
	...
	trieo [p ]= mintrieop ;
      ...
      do 
	if ( ( eqtb [3368180L + c ].hh .v.RH > 0 ) || ( ( c == 255 ) && 
	firstchild ) ) 
	{
	  if ( p == 0 ) 
	  {
	  ...
	  trieo [p ]= eqtb [3368180L + c ].hh .v.RH ;
	  q = p ;
	  p = trier [q ];
	  firstchild = false ;
	} 
...
zlinebreak ( boolean d ) 
{
  ...
  if ( ( mem [eqtb [2252247L ].hh .v.RH ].hh.b1 != 0 ) && ( mem [eqtb [
  2252247L ].hh .v.RH + 3 ].cint != 0 ) ) 
  {
    eqtb [2252247L ].hh .v.RH = finiteshrink ( eqtb [2252247L ].hh .v.RH ) 
    ;
  } 
  if ( ( mem [eqtb [2252248L ].hh .v.RH ].hh.b1 != 0 ) && ( mem [eqtb [
  2252248L ].hh .v.RH + 3 ].cint != 0 ) ) 
  {
    eqtb [2252248L ].hh .v.RH = finiteshrink ( eqtb [2252248L ].hh .v.RH ) 
    ;
  } 
  q = eqtb [2252247L ].hh .v.RH ;
  r = eqtb [2252248L ].hh .v.RH ;
  ...
  if ( eqtb [2252771L ].hh .v.RH == -268435455L ) {
    ...
    {
      lastspecialline = 0 ;
      secondwidth = eqtb [10053192L ].cint ;
      secondindent = 0 ;
    } 
    else {
	
      lastspecialline = abs ( eqtb [8938781L ].cint ) ;
      if ( eqtb [8938781L ].cint < 0 ) 
      {
	firstwidth = eqtb [10053192L ].cint - abs ( eqtb [10053206L ].cint 
	) ;
	if ( eqtb [10053206L ].cint >= 0 ) 
	firstindent = eqtb [10053206L ].cint ;
	else firstindent = 0 ;
	secondwidth = eqtb [10053192L ].cint ;
	secondindent = 0 ;
      } 
	...
	firstwidth = eqtb [10053192L ].cint ;
	firstindent = 0 ;
	secondwidth = eqtb [10053192L ].cint - abs ( eqtb [10053206L ]
	.cint ) ;
	if ( eqtb [10053206L ].cint >= 0 ) 
	secondindent = eqtb [10053206L ].cint ;
	else secondindent = 0 ;
      } 
    } 
  } 
    ...
    lastspecialline = mem [eqtb [2252771L ].hh .v.RH ].hh .v.LH - 1 ;
    secondwidth = mem [eqtb [2252771L ].hh .v.RH + 2 * ( lastspecialline + 
    1 ) ].cint ;
    secondindent = mem [eqtb [2252771L ].hh .v.RH + 2 * lastspecialline + 1 
    ].cint ;
  } 
  if ( eqtb [8938759L ].cint == 0 ) 
  easyline = lastspecialline ;
  else easyline = 1073741823L ;
  threshold = eqtb [8938740L ].cint ;
  if ( threshold >= 0 ) 
  {
	;
#ifdef STAT
    ...
    threshold = eqtb [8938741L ].cint ;
    secondpass = true ;
    finalpass = ( eqtb [10053209L ].cint <= 0 ) ;
	;
#ifdef STAT
    if ( eqtb [8938772L ].cint > 0 ) 
    begindiagnostic () ;
  ...
  while ( true ) {
	...
	else if ( ( mem [curp ].hh.b1 == 40 ) || ( mem [curp ].hh.b1 == 41 
	) || ( mem [curp ].hh.b1 == 42 ) || ( mem [curp ].hh.b1 == 43 ) ) 
	{
	  activewidth [1 ]= activewidth [1 ]+ mem [curp + 1 ].cint ;
	} 
	break ;
      case 10 : 
	{
	  ...
	  if ( secondpass && autobreaking ) 
	  {
		...
		hc [0 ]= eqtb [3368180L + c ].hh .v.RH ;
		else if ( trietrc [hyphindex + c ]!= c ) 
		hc [0 ]= 0 ;
		else hc [0 ]= trietro [hyphindex + c ];
		if ( hc [0 ]!= 0 ) {
		    
		  if ( ( hc [0 ]== c ) || ( eqtb [8938778L ].cint > 0 ) ) 
		  goto lab32 ;
		  else goto lab31 ;
		} 
		lab22: prevs = s ;
		...
		+ 4 ].qqqq .b2 - 1 ; if ( l <= for_end) do 
		  {
			...
			mem [ha ].hh .v.RH = q ;
			mem [ha + 4 ].qqqq .b2 = l ;
			setnativemetrics ( ha , ( eqtb [8938814L ].cint > 0 
			) ) ;
			goto lab33 ;
		      } 
		    } 
	...
	goto lab30 ;
	{
	  ...
	  do {
	      if ( mem [r ].hh.b0 != 2 ) 
	    {
	      ...
	      if ( ( ( linediff < actuallooseness ) && ( eqtb [8938759L ]
	      .cint <= linediff ) ) || ( ( linediff > actuallooseness ) && ( 
	      eqtb [8938759L ].cint >= linediff ) ) ) 
	      {
		bestbet = r ;
	...
	if ( ( actuallooseness == eqtb [8938759L ].cint ) || finalpass ) 
	goto lab30 ;
      } 
    } 
	...
	;
      ...
      printnl ( 66329L ) ;
#endif /* STAT */
      background [2 ]= background [2 ]+ eqtb [10053209L ].cint ;
      finalpass = true ;
    } 
  } 
  lab30: 
...
newhyphexceptions ( void ) 
{
  ...
  while ( true ) {
	...
	hc [0 ]= eqtb [3368180L + curchr ].hh .v.RH ;
...
prefixedcommand ( void ) 
{
  ...
  {case 89 : 
    if ( ( a >= 4 ) ) 
    geqdefine ( 2253299L , 122 , curchr ) ;
    else eqdefine ( 2253299L , 122 , curchr ) ;
    break ;
  case 99 : 
    {
      if ( odd ( curchr ) && ! ( a >= 4 ) && ( eqtb [8938783L ].cint >= 0 ) 
      ) 
      a = a + 4 ;
      e = ( curchr >= 2 ) ;
      getrtoken () ;
  ...
  case 97 : 
	...
	enddiagnostic ( false ) ;
      ...
      if ( ( p - 7824628L ) < eqtb [8938795L ].cint ) {
	  
	if ( ( a >= 4 ) ) 
	geqworddefine ( 8938795L , p - 7824628L ) ;
	else eqworddefine ( 8938795L , p - 7824628L ) ;
      } 
      if ( ( p - 7824628L ) > eqtb [8938796L ].cint ) {
	  
	if ( ( a >= 4 ) ) 
	geqworddefine ( 8938796L , p - 7824628L ) ;
	else eqworddefine ( 8938796L , p - 7824628L ) ;
      } 
    } 
    else {
	...
	default: 
	{
	  ...
	  {case 2 : 
	    if ( ( a >= 4 ) ) 
	    geqdefine ( p , 74 , 8938821L + curval ) ;
	    else eqdefine ( p , 74 , 8938821L + curval ) ;
	    break ;
	  case 3 : 
	    if ( ( a >= 4 ) ) 
	    geqdefine ( p , 75 , 10053212L + curval ) ;
	    else eqdefine ( p , 75 , 10053212L + curval ) ;
	    break ;
	  case 4 : 
	    if ( ( a >= 4 ) ) 
	    geqdefine ( p , 76 , 2252259L + curval ) ;
	    else eqdefine ( p , 76 , 2252259L + curval ) ;
	    break ;
	  case 5 : 
	    if ( ( a >= 4 ) ) 
	    geqdefine ( p , 77 , 2252515L + curval ) ;
	    else eqdefine ( p , 77 , 2252515L + curval ) ;
	    break ;
	  case 6 : 
	    if ( ( a >= 4 ) ) 
	    geqdefine ( p , 73 , 2252783L + curval ) ;
	    else eqdefine ( p , 73 , 2252783L + curval ) ;
	    break ;
	  } 
	} 
	break ;
  ...
  case 73 : 
	...
	curptr = curval ;
	scaneightbitint () ;
	findsaelement ( 6 , curptr * 256 + curval , true ) ;
	curchr = curptr ;
	e = true ;
      } 
      p = curchr ;
	...
	if ( ( curcmd == 72 ) || ( curcmd == 73 ) ) 
	{
	  if ( curcmd == 72 ) {
	    ...
	    if ( curchr == membot ) 
	    {
	      scanregisternum () ;
	      if ( curval < 256 ) 
	      q = eqtb [2252783L + curval ].hh .v.RH ;
	      else {
  ...
  case 87 : 
	...
	scanusvnum () ;
	p = p + curval ;
	n = eqtb [5596404L + curval ].hh .v.RH % 65536L ;
	scanoptionalequals () ;
	scancharclass () ;
	if ( ( a >= 4 ) ) 
  ...
  case 86 : 
    {
      ...
      scanoptionalequals () ;
      scanint () ;
      if ( ( ( curval < 0 ) && ( p < 8939077L ) ) || ( curval > n ) ) 
      {
	{
	  if ( interaction == 3 ) 
	  ;
...
storefmtfile ( void ) 
{
  ...
  packjobname ( 66139L ) ;
  while ( ! wopenout ( fmtfile ) ) promptfilename ( 66697L , 66139L ) ;
  printnl ( 66698L ) ;
  ...
  if ( hashhigh > 0 ) 
  dumpthings ( eqtb [10053468L ], hashhigh ) ;
  dumpint ( parloc ) ;
  dumpint ( writeloc ) ;
  {register integer for_end; p = 0 ;for_end = 481 ; if ( p <= for_end) do 
    dumphh ( prim [p ]) ;
  while ( p++ < for_end ) ;} 
  {register integer for_end; p = 0 ;for_end = 481 ; if ( p <= for_end) do 
    dumpwd ( primeqtb [p ]) ;
  ...
  while ( p++ < for_end ) ;} 
  dumpthings ( hash [hashused + 1 ], 2252238L - hashused ) ;
  if ( hashhigh > 0 ) 
  dumpthings ( hash [10053468L ], hashhigh ) ;
  dumpint ( cscount ) ;
  println () ;
  printint ( cscount ) ;
  print ( 66679L ) ;
  ...
  dumpint ( fontptr ) ;
  {
    ...
    do 
      {
	printnl ( 66683L ) ;
	printesc ( hash [2243238L + k ].v.RH ) ;
	printchar ( 61 ) ;
	if ( ( ( fontarea [k ]== 65535L ) || ( fontarea [k ]== 65534L ) ) 
	|| ( fontmapping [k ]!= 0 ) ) 
	{
	  printfilename ( fontname [k ], 65622L , 65622L ) ;
	  {
	    if ( interaction == 3 ) 
	    ;
	    if ( filelineerrorstylep ) 
	...
	else printfilename ( fontname [k ], fontarea [k ], 65622L ) ;
...
loadfmtfile ( void ) 
{
  ...
  eqtb [2252239L ].hh .v.RH = -268435455L ;
  eqtb [2252239L ].hh.b1 = 0 ;
  {register integer for_end; x = 10053468L ;for_end = eqtbtop ; if ( x <= 
  for_end) do 
    eqtb [x ]= eqtb [2252239L ];
  while ( x++ < for_end ) ;} 
  {
    undumpint ( x ) ;
    if ( ( x < 0 ) || ( x > 1 ) ) 
  ...
  do {
      undumpint ( x ) ;
    if ( ( x < 1 ) || ( k + x > 10053468L ) ) 
    goto lab6666 ;
    undumpthings ( eqtb [k ], x ) ;
    k = k + x ;
    undumpint ( x ) ;
    if ( ( x < 0 ) || ( k + x > 10053468L ) ) 
    goto lab6666 ;
  ...
  if ( hashhigh > 0 ) 
  undumpthings ( eqtb [10053468L ], hashhigh ) ;
  {
    undumpint ( x ) ;
  ...
  undumpthings ( hash [hashused + 1 ], 2252238L - hashused ) ;
  if ( debugformatfile ) 
  {
    printcsnames ( 2228226L , 2252238L ) ;
  } 
  if ( hashhigh > 0 ) 
  {
    undumpthings ( hash [10053468L ], hashhigh ) ;
    if ( debugformatfile ) 
    {
      printcsnames ( 10053468L , hashhigh - ( 10053468L ) ) ;
    } 
  } 
  undumpint ( cscount ) ;
  {
...
initprim ( void ) 
{
  ...
  first = 0 ;
  primitive ( 65670L , 76 , 2252240L ) ;
  primitive ( 65671L , 76 , 2252241L ) ;
  primitive ( 65672L , 76 , 2252242L ) ;
  primitive ( 65673L , 76 , 2252243L ) ;
  primitive ( 65674L , 76 , 2252244L ) ;
  primitive ( 65675L , 76 , 2252245L ) ;
  primitive ( 65676L , 76 , 2252246L ) ;
  primitive ( 65677L , 76 , 2252247L ) ;
  primitive ( 65678L , 76 , 2252248L ) ;
  primitive ( 65679L , 76 , 2252249L ) ;
  primitive ( 65680L , 76 , 2252250L ) ;
  primitive ( 65681L , 76 , 2252251L ) ;
  primitive ( 65682L , 76 , 2252252L ) ;
  primitive ( 65683L , 76 , 2252253L ) ;
  primitive ( 65684L , 76 , 2252254L ) ;
  primitive ( 65685L , 76 , 2252255L ) ;
  primitive ( 65686L , 77 , 2252256L ) ;
  primitive ( 65687L , 77 , 2252257L ) ;
  primitive ( 65688L , 77 , 2252258L ) ;
  primitive ( 65693L , 73 , 2252772L ) ;
  primitive ( 65694L , 73 , 2252773L ) ;
  primitive ( 65695L , 73 , 2252774L ) ;
  primitive ( 65696L , 73 , 2252775L ) ;
  primitive ( 65697L , 73 , 2252776L ) ;
  primitive ( 65698L , 73 , 2252777L ) ;
  primitive ( 65699L , 73 , 2252778L ) ;
  primitive ( 65700L , 73 , 2252779L ) ;
  primitive ( 65701L , 73 , 2252780L ) ;
  primitive ( 65715L , 74 , 8938740L ) ;
  primitive ( 65716L , 74 , 8938741L ) ;
  primitive ( 65717L , 74 , 8938742L ) ;
  primitive ( 65718L , 74 , 8938743L ) ;
  primitive ( 65719L , 74 , 8938744L ) ;
  primitive ( 65720L , 74 , 8938745L ) ;
  primitive ( 65721L , 74 , 8938746L ) ;
  primitive ( 65722L , 74 , 8938747L ) ;
  primitive ( 65723L , 74 , 8938748L ) ;
  primitive ( 65724L , 74 , 8938749L ) ;
  primitive ( 65725L , 74 , 8938750L ) ;
  primitive ( 65726L , 74 , 8938751L ) ;
  primitive ( 65727L , 74 , 8938752L ) ;
  primitive ( 65728L , 74 , 8938753L ) ;
  primitive ( 65729L , 74 , 8938754L ) ;
  primitive ( 65730L , 74 , 8938755L ) ;
  primitive ( 65731L , 74 , 8938756L ) ;
  primitive ( 65732L , 74 , 8938757L ) ;
  primitive ( 65733L , 74 , 8938758L ) ;
  primitive ( 65734L , 74 , 8938759L ) ;
  primitive ( 65735L , 74 , 8938760L ) ;
  primitive ( 65736L , 74 , 8938761L ) ;
  primitive ( 65737L , 74 , 8938762L ) ;
  primitive ( 65738L , 74 , 8938763L ) ;
  primitive ( 65739L , 74 , 8938764L ) ;
  primitive ( 65740L , 74 , 8938765L ) ;
  primitive ( 65741L , 74 , 8938766L ) ;
  primitive ( 65742L , 74 , 8938767L ) ;
  primitive ( 65743L , 74 , 8938768L ) ;
  primitive ( 65744L , 74 , 8938769L ) ;
  primitive ( 65745L , 74 , 8938770L ) ;
  primitive ( 65746L , 74 , 8938771L ) ;
  primitive ( 65747L , 74 , 8938772L ) ;
  primitive ( 65748L , 74 , 8938773L ) ;
  primitive ( 65749L , 74 , 8938774L ) ;
  primitive ( 65750L , 74 , 8938775L ) ;
  primitive ( 65751L , 74 , 8938776L ) ;
  primitive ( 65752L , 74 , 8938777L ) ;
  primitive ( 65753L , 74 , 8938778L ) ;
  primitive ( 65754L , 74 , 8938779L ) ;
  primitive ( 65755L , 74 , 8938780L ) ;
  primitive ( 65756L , 74 , 8938781L ) ;
  primitive ( 65757L , 74 , 8938782L ) ;
  primitive ( 65758L , 74 , 8938783L ) ;
  primitive ( 65759L , 74 , 8938784L ) ;
  primitive ( 65760L , 74 , 8938785L ) ;
  primitive ( 65761L , 74 , 8938786L ) ;
  primitive ( 65762L , 74 , 8938787L ) ;
  primitive ( 65763L , 74 , 8938788L ) ;
  primitive ( 65764L , 74 , 8938789L ) ;
  primitive ( 65765L , 74 , 8938790L ) ;
  primitive ( 65766L , 74 , 8938791L ) ;
  primitive ( 65767L , 74 , 8938792L ) ;
  primitive ( 65768L , 74 , 8938793L ) ;
  primitive ( 65769L , 74 , 8938794L ) ;
  if ( mltexp ) 
  {
    mltexenabledp = true ;
    if ( false ) 
    primitive ( 65770L , 74 , 8938795L ) ;
    primitive ( 65771L , 74 , 8938796L ) ;
    primitive ( 65772L , 74 , 8938797L ) ;
  } 
  primitive ( 65773L , 74 , 8938809L ) ;
  primitive ( 65774L , 74 , 8938810L ) ;
  primitive ( 65778L , 75 , 10053189L ) ;
  primitive ( 65779L , 75 , 10053190L ) ;
  primitive ( 65780L , 75 , 10053191L ) ;
  primitive ( 65781L , 75 , 10053192L ) ;
  primitive ( 65782L , 75 , 10053193L ) ;
  primitive ( 65783L , 75 , 10053194L ) ;
  primitive ( 65784L , 75 , 10053195L ) ;
  primitive ( 65785L , 75 , 10053196L ) ;
  primitive ( 65786L , 75 , 10053197L ) ;
  primitive ( 65787L , 75 , 10053198L ) ;
  primitive ( 65788L , 75 , 10053199L ) ;
  primitive ( 65789L , 75 , 10053200L ) ;
  primitive ( 65790L , 75 , 10053201L ) ;
  primitive ( 65791L , 75 , 10053202L ) ;
  primitive ( 65792L , 75 , 10053203L ) ;
  primitive ( 65793L , 75 , 10053204L ) ;
  primitive ( 65794L , 75 , 10053205L ) ;
  primitive ( 65795L , 75 , 10053206L ) ;
  primitive ( 65796L , 75 , 10053207L ) ;
  primitive ( 65797L , 75 , 10053208L ) ;
  primitive ( 65798L , 75 , 10053209L ) ;
  primitive ( 65799L , 75 , 10053210L ) ;
  primitive ( 65800L , 75 , 10053211L ) ;
  primitive ( 32 , 64 , 0 ) ;
  primitive ( 47 , 44 , 0 ) ;
  primitive ( 65812L , 45 , 0 ) ;
  primitive ( 65813L , 92 , 0 ) ;
  primitive ( 65814L , 40 , 0 ) ;
  primitive ( 65815L , 41 , 0 ) ;
  primitive ( 65816L , 61 , 0 ) ;
  primitive ( 65817L , 16 , 0 ) ;
  primitive ( 65808L , 109 , 0 ) ;
  primitive ( 65818L , 15 , 0 ) ;
  primitive ( 65819L , 15 , 1 ) ;
  primitive ( 65820L , 15 , 1 ) ;
  primitive ( 65821L , 94 , 0 ) ;
  primitive ( 65809L , 67 , 0 ) ;
  primitive ( 65822L , 62 , 0 ) ;
  hash [2243228L ].v.RH = 65822L ;
  eqtb [2243228L ]= eqtb [curval ];
  primitive ( 65823L , 104 , 0 ) ;
  primitive ( 65824L , 90 , 0 ) ;
  primitive ( 65825L , 78 , 0 ) ;
  primitive ( 65826L , 32 , 0 ) ;
  primitive ( 65827L , 36 , 0 ) ;
  primitive ( 65828L , 39 , 0 ) ;
  primitive ( 65614L , 37 , 0 ) ;
  primitive ( 65636L , 18 , 0 ) ;
  primitive ( 65829L , 46 , 0 ) ;
  primitive ( 65830L , 46 , 1 ) ;
  primitive ( 65831L , 46 , 1 ) ;
  primitive ( 65832L , 17 , 0 ) ;
  primitive ( 65833L , 17 , 1 ) ;
  primitive ( 65834L , 17 , 1 ) ;
  primitive ( 65835L , 17 , 2 ) ;
  primitive ( 65836L , 17 , 2 ) ;
  primitive ( 65837L , 54 , 0 ) ;
  primitive ( 65838L , 93 , 0 ) ;
  primitive ( 65839L , 34 , 0 ) ;
  primitive ( 65840L , 65 , 0 ) ;
  primitive ( 65841L , 105 , 0 ) ;
  primitive ( 65805L , 105 , 1 ) ;
  primitive ( 65619L , 55 , 0 ) ;
  primitive ( 65842L , 63 , 0 ) ;
  primitive ( 65843L , 85 , 2252771L ) ;
  primitive ( 65844L , 42 , 0 ) ;
  primitive ( 65845L , 81 , 0 ) ;
  primitive ( 65846L , 66 , 0 ) ;
  primitive ( 65847L , 66 , 1 ) ;
  primitive ( 65848L , 66 , 1 ) ;
  primitive ( 65849L , 98 , 0 ) ;
  primitive ( 65850L , 0 , 1114112L ) ;
  hash [2243233L ].v.RH = 65850L ;
  eqtb [2243233L ]= eqtb [curval ];
  primitive ( 65851L , 100 , 0 ) ;
  primitive ( 65852L , 111 , 0 ) ;
  primitive ( 65702L , 72 , membot ) ;
  primitive ( 65637L , 38 , 0 ) ;
  primitive ( 65853L , 33 , 0 ) ;
  primitive ( 65854L , 56 , 0 ) ;
  primitive ( 65855L , 35 , 0 ) ;
  primitive ( 65916L , 13 , 1114112L ) ;
  parloc = curval ;
  partoken = 33554431L + parloc ;
  primitive ( 65951L , 106 , 0 ) ;
  primitive ( 65952L , 106 , 1 ) ;
  primitive ( 65953L , 112 , 0 ) ;
  primitive ( 65954L , 112 , 1 ) ;
  primitive ( 65955L , 112 , 2 ) ;
  primitive ( 65956L , 112 , 3 ) ;
  primitive ( 65957L , 112 , 4 ) ;
  primitive ( 65776L , 91 , membot + 0 ) ;
  primitive ( 65802L , 91 , membot + 1 ) ;
  primitive ( 65690L , 91 , membot + 2 ) ;
  primitive ( 65691L , 91 , membot + 3 ) ;
  primitive ( 66001L , 80 , 104 ) ;
  primitive ( 66002L , 80 , 1 ) ;
  primitive ( 66003L , 83 , 0 ) ;
  primitive ( 66004L , 83 , 1 ) ;
  primitive ( 66005L , 84 , 1 ) ;
  primitive ( 66006L , 84 , 3 ) ;
  primitive ( 66007L , 84 , 2 ) ;
  primitive ( 66008L , 71 , 0 ) ;
  primitive ( 66009L , 71 , 1 ) ;
  primitive ( 66010L , 71 , 2 ) ;
  primitive ( 66011L , 71 , 4 ) ;
  primitive ( 66012L , 71 , 5 ) ;
  primitive ( 66080L , 110 , 0 ) ;
  primitive ( 66081L , 110 , 1 ) ;
  primitive ( 66082L , 110 , 2 ) ;
  primitive ( 66083L , 110 , 3 ) ;
  primitive ( 66084L , 110 , 4 ) ;
  primitive ( 66085L , 110 , 15 ) ;
  primitive ( 66086L , 110 , 11 ) ;
  primitive ( 66087L , 110 , 12 ) ;
  primitive ( 66088L , 110 , 13 ) ;
  primitive ( 66089L , 110 , 14 ) ;
  primitive ( 66110L , 107 , 0 ) ;
  primitive ( 66111L , 107 , 1 ) ;
  primitive ( 66112L , 107 , 2 ) ;
  primitive ( 66113L , 107 , 3 ) ;
  primitive ( 66114L , 107 , 4 ) ;
  primitive ( 66115L , 107 , 5 ) ;
  primitive ( 66116L , 107 , 6 ) ;
  primitive ( 66117L , 107 , 7 ) ;
  primitive ( 66118L , 107 , 8 ) ;
  primitive ( 66119L , 107 , 9 ) ;
  primitive ( 66120L , 107 , 10 ) ;
  primitive ( 66121L , 107 , 11 ) ;
  primitive ( 66122L , 107 , 12 ) ;
  primitive ( 66123L , 107 , 13 ) ;
  primitive ( 66124L , 107 , 14 ) ;
  primitive ( 66125L , 107 , 15 ) ;
  primitive ( 66126L , 107 , 16 ) ;
  primitive ( 66127L , 107 , 21 ) ;
  primitive ( 66129L , 108 , 2 ) ;
  hash [2243230L ].v.RH = 66129L ;
  eqtb [2243230L ]= eqtb [curval ];
  primitive ( 66130L , 108 , 4 ) ;
  primitive ( 66131L , 108 , 3 ) ;
  primitive ( 66157L , 89 , 0 ) ;
  hash [2243238L ].v.RH = 66157L ;
  eqtb [2243238L ]= eqtb [curval ];
  primitive ( 66286L , 4 , 65537L ) ;
  primitive ( 66287L , 5 , 65538L ) ;
  hash [2243227L ].v.RH = 66287L ;
  eqtb [2243227L ]= eqtb [curval ];
  primitive ( 66288L , 5 , 65539L ) ;
  hash [2243231L ].v.RH = 66289L ;
  hash [2243232L ].v.RH = 66289L ;
  ...
  primitive ( 66366L , 82 , 0 ) ;
  primitive ( 66367L , 82 , 1 ) ;
  primitive ( 66368L , 82 , 2 ) ;
  primitive ( 66369L , 82 , 3 ) ;
  primitive ( 66370L , 82 , 4 ) ;
  primitive ( 66371L , 82 , 5 ) ;
  primitive ( 66372L , 82 , 6 ) ;
  primitive ( 66373L , 82 , 7 ) ;
  primitive ( 65626L , 14 , 0 ) ;
  primitive ( 66420L , 14 , 1 ) ;
  primitive ( 66421L , 26 , 4 ) ;
  primitive ( 66422L , 26 , 0 ) ;
  primitive ( 66423L , 26 , 1 ) ;
  primitive ( 66424L , 26 , 2 ) ;
  primitive ( 66425L , 26 , 3 ) ;
  primitive ( 66426L , 27 , 4 ) ;
  primitive ( 66427L , 27 , 0 ) ;
  primitive ( 66428L , 27 , 1 ) ;
  primitive ( 66429L , 27 , 2 ) ;
  primitive ( 66430L , 27 , 3 ) ;
  primitive ( 65620L , 28 , 5 ) ;
  primitive ( 65599L , 29 , 1 ) ;
  primitive ( 65625L , 30 , 99 ) ;
  primitive ( 66448L , 21 , 1 ) ;
  primitive ( 66449L , 21 , 0 ) ;
  primitive ( 66450L , 22 , 1 ) ;
  primitive ( 66451L , 22 , 0 ) ;
  primitive ( 65704L , 20 , 0 ) ;
  primitive ( 66452L , 20 , 1 ) ;
  primitive ( 66453L , 20 , 2 ) ;
  primitive ( 66361L , 20 , 3 ) ;
  primitive ( 66454L , 20 , 4 ) ;
  primitive ( 66363L , 20 , 5 ) ;
  primitive ( 66455L , 20 , 108 ) ;
  primitive ( 66456L , 31 , 99 ) ;
  primitive ( 66457L , 31 , 100 ) ;
  primitive ( 66458L , 31 , 101 ) ;
  primitive ( 66459L , 31 , 102 ) ;
  primitive ( 66475L , 43 , 1 ) ;
  primitive ( 66476L , 43 , 0 ) ;
  primitive ( 66486L , 25 , 12 ) ;
  primitive ( 66487L , 25 , 11 ) ;
  primitive ( 66488L , 25 , 10 ) ;
  primitive ( 66489L , 23 , 0 ) ;
  primitive ( 66490L , 23 , 1 ) ;
  primitive ( 66491L , 24 , 0 ) ;
  primitive ( 66492L , 24 , 1 ) ;
  primitive ( 45 , 47 , 1 ) ;
  primitive ( 65634L , 47 , 0 ) ;
  primitive ( 66523L , 48 , 0 ) ;
  primitive ( 66524L , 48 , 1 ) ;
  primitive ( 66236L , 50 , 16 ) ;
  primitive ( 66237L , 50 , 17 ) ;
  primitive ( 66238L , 50 , 18 ) ;
  primitive ( 66239L , 50 , 19 ) ;
  primitive ( 66240L , 50 , 20 ) ;
  primitive ( 66241L , 50 , 21 ) ;
  primitive ( 66242L , 50 , 22 ) ;
  primitive ( 66243L , 50 , 23 ) ;
  primitive ( 66245L , 50 , 26 ) ;
  primitive ( 66244L , 50 , 27 ) ;
  primitive ( 66525L , 51 , 0 ) ;
  primitive ( 66249L , 51 , 1 ) ;
  primitive ( 66250L , 51 , 2 ) ;
  primitive ( 66231L , 53 , 0 ) ;
  primitive ( 66232L , 53 , 2 ) ;
  primitive ( 66233L , 53 , 4 ) ;
  primitive ( 66234L , 53 , 6 ) ;
  primitive ( 66545L , 52 , 0 ) ;
  primitive ( 66546L , 52 , 1 ) ;
  primitive ( 66547L , 52 , 2 ) ;
  primitive ( 66548L , 52 , 3 ) ;
  primitive ( 66549L , 52 , 4 ) ;
  primitive ( 66550L , 52 , 5 ) ;
  primitive ( 66246L , 49 , 30 ) ;
  primitive ( 66247L , 49 , 31 ) ;
  hash [2243229L ].v.RH = 66247L ;
  eqtb [2243229L ]= eqtb [curval ];
  primitive ( 66570L , 95 , 1 ) ;
  primitive ( 66571L , 95 , 2 ) ;
  primitive ( 66572L , 95 , 4 ) ;
  primitive ( 66573L , 99 , 0 ) ;
  primitive ( 66574L , 99 , 1 ) ;
  primitive ( 66575L , 99 , 2 ) ;
  primitive ( 66576L , 99 , 3 ) ;
  primitive ( 66593L , 96 , 0 ) ;
  primitive ( 66594L , 96 , 1 ) ;
  primitive ( 66595L , 97 , 0 ) ;
  primitive ( 66596L , 97 , 1 ) ;
  primitive ( 66597L , 97 , 8 ) ;
  primitive ( 66598L , 97 , 8 ) ;
  primitive ( 66599L , 97 , 9 ) ;
  primitive ( 66600L , 97 , 9 ) ;
  primitive ( 66601L , 97 , 2 ) ;
  primitive ( 66602L , 97 , 3 ) ;
  primitive ( 66603L , 97 , 4 ) ;
  primitive ( 66604L , 97 , 5 ) ;
  primitive ( 66605L , 97 , 6 ) ;
  if ( mltexp ) 
  {
    primitive ( 66606L , 97 , 7 ) ;
  } 
  primitive ( 65710L , 86 , 2254068L ) ;
  primitive ( 65714L , 86 , 6710516L ) ;
  primitive ( 66611L , 87 , 6710516L ) ;
  primitive ( 66612L , 87 , 6710516L ) ;
  primitive ( 66613L , 87 , 6710517L ) ;
  primitive ( 66614L , 87 , 6710517L ) ;
  primitive ( 65711L , 86 , 3368180L ) ;
  primitive ( 65712L , 86 , 4482292L ) ;
  primitive ( 65713L , 86 , 5596404L ) ;
  primitive ( 66615L , 87 , 5596404L ) ;
  primitive ( 65777L , 86 , 8939077L ) ;
  primitive ( 66616L , 87 , 8939077L ) ;
  primitive ( 66617L , 87 , 8939077L ) ;
  primitive ( 66618L , 87 , 8939078L ) ;
  primitive ( 66619L , 87 , 8939078L ) ;
  primitive ( 65707L , 88 , 2253300L ) ;
  primitive ( 65708L , 88 , 2253556L ) ;
  primitive ( 65709L , 88 , 2253812L ) ;
  primitive ( 66337L , 101 , 0 ) ;
  primitive ( 66349L , 101 , 1 ) ;
  primitive ( 66634L , 79 , 0 ) ;
  primitive ( 66635L , 79 , 1 ) ;
  primitive ( 66636L , 79 , 2 ) ;
  primitive ( 66637L , 79 , 3 ) ;
  primitive ( 65554L , 102 , 0 ) ;
  primitive ( 65555L , 102 , 1 ) ;
  primitive ( 65556L , 102 , 2 ) ;
  primitive ( 66646L , 102 , 3 ) ;
  primitive ( 66647L , 60 , 1 ) ;
  primitive ( 66648L , 60 , 0 ) ;
  primitive ( 66649L , 58 , 0 ) ;
  primitive ( 66650L , 58 , 1 ) ;
  primitive ( 66656L , 57 , 3368180L ) ;
  primitive ( 66657L , 57 , 4482292L ) ;
  primitive ( 66658L , 19 , 0 ) ;
  primitive ( 66659L , 19 , 1 ) ;
  primitive ( 66660L , 19 , 2 ) ;
  primitive ( 66661L , 19 , 3 ) ;
  primitive ( 66709L , 59 , 0 ) ;
  primitive ( 65913L , 59 , 1 ) ;
  writeloc = curval ;
  primitive ( 66710L , 59 , 2 ) ;
  primitive ( 66711L , 59 , 3 ) ;
  hash [2243236L ].v.RH = 66711L ;
  eqtb [2243236L ]= eqtb [curval ];
  primitive ( 66712L , 59 , 4 ) ;
  primitive ( 66713L , 59 , 5 ) ;
  primitive ( 66940L , 74 , 8938820L ) ;
  nonewcontrolsequence = true ;
} 
#endif /* INITEX */
void 
mainbody ( void ) 
{
  ...
  if ( 65535L < 65535L ) 
  bad = 19 ;
  if ( 43607898L + hashextra > 1073741823L ) 
  bad = 21 ;
  ...
  if ( iniversion ) 
  {
    ...
    initstrptr = strptr ;
    initpoolptr = poolptr ;
    dateandtime ( eqtb [8938760L ].cint , eqtb [8938761L ].cint , eqtb [
    8938762L ].cint , eqtb [8938763L ].cint ) ;
  } 
#endif /* INITEX */
  ...
  fprintf ( stdout , "%s%s%s",  "This is XeTeX, Version 3.14159265" , "-2.6" , "-0.99993" ) 
  ;
  else
  fprintf ( stdout , "%s%s%s",  "This is XeTeX, Version 3.14159265" , "-2.6" ,   "-0.99993" ) ;
  ...
  outputfilename = 0 ;
  if ( nopdfoutput ) 
  outputfileextension = 66149L ;
  else outputfileextension = 66150L ;
  {
    {
      inputptr = 0 ;
      maxinstack = 0 ;
    ...
    {
      nonewcontrolsequence = false ;
      primitive ( 66714L , 59 , 41 ) ;
      primitive ( 66715L , 59 , 42 ) ;
      primitive ( 66716L , 59 , 43 ) ;
      primitive ( 66717L , 59 , 46 ) ;
      primitive ( 66718L , 73 , 2252782L ) ;
      primitive ( 66719L , 59 , 6 ) ;
      primitive ( 66777L , 71 , 3 ) ;
      primitive ( 66778L , 71 , 6 ) ;
      primitive ( 66779L , 110 , 5 ) ;
      primitive ( 66780L , 71 , 14 ) ;
      primitive ( 66781L , 110 , 6 ) ;
      primitive ( 66782L , 71 , 15 ) ;
      primitive ( 66783L , 71 , 16 ) ;
      primitive ( 66784L , 71 , 17 ) ;
      primitive ( 66785L , 71 , 18 ) ;
      primitive ( 66786L , 71 , 19 ) ;
      primitive ( 66787L , 71 , 20 ) ;
      primitive ( 66788L , 71 , 21 ) ;
      primitive ( 66789L , 71 , 22 ) ;
      primitive ( 66790L , 71 , 23 ) ;
      primitive ( 66791L , 71 , 24 ) ;
      primitive ( 66792L , 71 , 25 ) ;
      primitive ( 66793L , 71 , 26 ) ;
      primitive ( 66794L , 71 , 27 ) ;
      primitive ( 66795L , 71 , 28 ) ;
      primitive ( 66796L , 71 , 29 ) ;
      primitive ( 66797L , 110 , 7 ) ;
      primitive ( 66798L , 110 , 8 ) ;
      primitive ( 66799L , 110 , 9 ) ;
      primitive ( 66800L , 71 , 30 ) ;
      primitive ( 66801L , 71 , 31 ) ;
      primitive ( 66802L , 71 , 32 ) ;
      primitive ( 66803L , 71 , 33 ) ;
      primitive ( 66804L , 71 , 34 ) ;
      primitive ( 66805L , 71 , 35 ) ;
      primitive ( 66806L , 71 , 36 ) ;
      primitive ( 66807L , 71 , 37 ) ;
      primitive ( 66808L , 71 , 47 ) ;
      primitive ( 66809L , 110 , 10 ) ;
      primitive ( 66810L , 71 , 38 ) ;
      primitive ( 66811L , 71 , 39 ) ;
      primitive ( 66812L , 71 , 40 ) ;
      primitive ( 66813L , 71 , 41 ) ;
      primitive ( 66814L , 71 , 42 ) ;
      primitive ( 66090L , 110 , 43 ) ;
      primitive ( 66091L , 110 , 44 ) ;
      primitive ( 66013L , 71 , 45 ) ;
      primitive ( 66815L , 71 , 46 ) ;
      primitive ( 66828L , 73 , 2252781L ) ;
      primitive ( 66829L , 74 , 8938798L ) ;
      primitive ( 66830L , 74 , 8938799L ) ;
      primitive ( 66831L , 74 , 8938800L ) ;
      primitive ( 66832L , 74 , 8938801L ) ;
      primitive ( 66833L , 74 , 8938802L ) ;
      primitive ( 66834L , 74 , 8938803L ) ;
      primitive ( 66835L , 74 , 8938804L ) ;
      primitive ( 66836L , 74 , 8938805L ) ;
      primitive ( 66837L , 74 , 8938806L ) ;
      primitive ( 66851L , 71 , 7 ) ;
      primitive ( 66852L , 71 , 8 ) ;
      primitive ( 66853L , 71 , 9 ) ;
      primitive ( 66854L , 71 , 10 ) ;
      primitive ( 66855L , 71 , 11 ) ;
      primitive ( 66856L , 71 , 48 ) ;
      primitive ( 66857L , 71 , 49 ) ;
      primitive ( 66858L , 71 , 50 ) ;
      primitive ( 66859L , 71 , 51 ) ;
      primitive ( 66860L , 71 , 52 ) ;
      primitive ( 66861L , 71 , 53 ) ;
      primitive ( 66862L , 71 , 54 ) ;
      primitive ( 66863L , 19 , 4 ) ;
      primitive ( 66865L , 19 , 5 ) ;
      primitive ( 66866L , 111 , 1 ) ;
      primitive ( 66867L , 111 , 5 ) ;
      primitive ( 66868L , 19 , 6 ) ;
      primitive ( 66872L , 83 , 2 ) ;
      primitive ( 66248L , 49 , 1 ) ;
      primitive ( 66876L , 74 , 8938807L ) ;
      primitive ( 66877L , 74 , 8938811L ) ;
      primitive ( 66878L , 74 , 8938813L ) ;
      primitive ( 66879L , 74 , 8938814L ) ;
      primitive ( 66880L , 74 , 8938815L ) ;
      primitive ( 66881L , 74 , 8938812L ) ;
      primitive ( 66882L , 74 , 8938816L ) ;
      primitive ( 66883L , 74 , 8938819L ) ;
      primitive ( 66720L , 59 , 44 ) ;
      primitive ( 66721L , 59 , 45 ) ;
      primitive ( 66884L , 33 , 6 ) ;
      primitive ( 66885L , 33 , 7 ) ;
      primitive ( 66886L , 33 , 10 ) ;
      primitive ( 66887L , 33 , 11 ) ;
      primitive ( 66896L , 106 , 2 ) ;
      primitive ( 66898L , 98 , 1 ) ;
      primitive ( 66128L , 104 , 1 ) ;
      primitive ( 66899L , 107 , 17 ) ;
      primitive ( 66900L , 107 , 18 ) ;
      primitive ( 66901L , 107 , 19 ) ;
      primitive ( 66902L , 107 , 20 ) ;
      primitive ( 66584L , 95 , 8 ) ;
      primitive ( 66908L , 71 , 59 ) ;
      primitive ( 66909L , 71 , 60 ) ;
      primitive ( 66910L , 71 , 61 ) ;
      primitive ( 66911L , 71 , 62 ) ;
      primitive ( 66915L , 71 , 12 ) ;
      primitive ( 66916L , 71 , 13 ) ;
      primitive ( 66917L , 71 , 55 ) ;
      primitive ( 66918L , 71 , 56 ) ;
      primitive ( 66919L , 71 , 57 ) ;
      primitive ( 66920L , 71 , 58 ) ;
      primitive ( 66921L , 18 , 5 ) ;
      primitive ( 66922L , 112 , 5 ) ;
      primitive ( 66923L , 112 , 6 ) ;
      primitive ( 66924L , 112 , 7 ) ;
      primitive ( 66925L , 112 , 8 ) ;
      primitive ( 66926L , 112 , 9 ) ;
      primitive ( 66931L , 24 , 2 ) ;
      primitive ( 66932L , 24 , 3 ) ;
      primitive ( 66933L , 85 , 2253039L ) ;
      primitive ( 66934L , 85 , 2253040L ) ;
      primitive ( 66935L , 85 , 2253041L ) ;
      primitive ( 66936L , 85 , 2253042L ) ;
    ...
    while ( fontk++ < for_end ) ;} 
    magicoffset = strstart [( 66280L ) - 65536L ]- 9 * 16 ;
    if ( interaction == 0 ) 
    selector = 16 ;
    else selector = 17 ;
    if ( ( curinput .locfield < curinput .limitfield ) && ( eqtb [2254068L + 
