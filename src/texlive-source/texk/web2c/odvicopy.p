{3:}{9:}{$C-,A+,D-}{[$C+,D+]}
{:9}program ODVIcopy(dvifile,outfile,output);label 9999;
const{5:}maxfonts=1000;maxchars=750000;maxwidths=10000;
maxpackets=100000;maxbytes=3000000;maxrecursion=10;stacksize=100;
terminallinelength=256;negmaxchars=-10000;
{:5}type{7:}int31=0..2147483647;int24u=0..16777215;
int24=-8388608..8388607;int23=0..8388607;int16u=0..65535;
int16=-32768..32767;int15=0..32767;int8u=0..255;int8odvicopy=-128..127;
int7=0..127;{:7}{14:}ASCIIcode=0..255;
{:14}{15:}textfile=packed file of ASCIIcode;
{:15}{27:}signedbyte=-128..127;eightbits=0..255;
signedpair=-32768..32767;sixteenbits=0..65535;
signedtrio=-8388608..8388607;twentyfourbits=0..16777215;
signedquad=integer;{:27}{29:}bytefile=packed file of eightbits;
{:29}{31:}packedbyte=eightbits;bytepointer=0..maxbytes;
pcktpointer=0..maxpackets;{:31}{36:}hashcode=0..353;
{:36}{70:}widthpointer=0..maxwidths;
{:70}{76:}charoffset=negmaxchars..maxchars;charpointer=0..maxchars;
{:76}{79:}ftype=0..3;fontnumber=0..maxfonts;{:79}{83:}typeflag=0..31;
{:83}{116:}cmdpar=0..12;{:116}{119:}cmdcl=0..17;
{:119}{154:}vfstate=array[0..1,0..1]of boolean;{:154}{156:}vftype=0..4;
{:156}{192:}{[198:]pixvalue=-32767..32767;[:198]}
...
{:219}var{2:}randomreading:boolean;
{:2}{17:}xord:array[ASCIIcode]of ASCIIcode;
xchr:array[0..255]of ASCIIcode;{:17}{21:}history:0..3;
{:21}{32:}bytemem:packed array[bytepointer]of packedbyte;
...
phash:array[hashcode]of pcktpointer;
{:37}{46:}strfonts,strchars,strwidths,strpackets,strbytes,strrecursion,
strstack,strnamelength:pcktpointer;{:46}{49:}curpckt:pcktpointer;
...
whash:array[hashcode]of widthpointer;nwidths:widthpointer;
{:71}{77:}charwidths:array[charpointer]of widthpointer;
charpackets:array[charpointer]of pcktpointer;nchars:charpointer;
{:77}{80:}nf:fontnumber;{:80}{81:}fntcheck:array[fontnumber]of integer;
fntscaled:array[fontnumber]of int31;fntdesign:array[fontnumber]of int31;
{[195:]fntspace:array[fontnumber]of integer;[:195]}
fntname:array[fontnumber]of pcktpointer;fntbc:array[fontnumber]of int31;
fntec:array[fontnumber]of int31;fntchars:array[fontnumber]of charoffset;
fnttype:array[fontnumber]of ftype;
fntfont:array[fontnumber]of fontnumber;
fntextended:array[fontnumber]of boolean;{:81}{84:}curfnt:fontnumber;
curext:int24;curres:integer;curtype:typeflag;pcktext:int24;
pcktres:integer;pcktdup:boolean;pcktprev:pcktpointer;
pcktmmsg,pcktsmsg,pcktdmsg:int7;{:84}{90:}tfmfile:bytefile;
tfmext:pcktpointer;ofmext:pcktpointer;
{:90}{96:}tfmb0,tfmb1,tfmb2,tfmb3:eightbits;{:96}{100:}tfmconv:real;
{:100}{108:}dvifile:bytefile;dviloc:integer;fullname:^char;
{:108}{117:}dvipar:packed array[eightbits]of cmdpar;
{:117}{120:}dvicl:packed array[eightbits]of cmdcl;
{:120}{122:}dvicharcmd:array[boolean]of eightbits;
...
dviifnts:array[fontnumber]of fontnumber;dvinf:fontnumber;
{:128}{134:}vffile:bytefile;vfloc:integer;vflimit:integer;
vfext:pcktpointer;ovfext:pcktpointer;vfcurfnt:fontnumber;
{:134}{142:}{103:}z:integer;alpha:integer;beta:int15;
{:103}{:142}{146:}vfefnts:array[fontnumber]of integer;
...
vfruletype:array[boolean]of vftype;{:158}{173:}widthdimen:integer;
{:173}{177:}nopt:int16;kopt:int16;scanptr:bytepointer;sepchar:ASCIIcode;
{:177}{183:}typesetting:boolean;
{:183}{185:}selectcount:array[0..9,0..9]of integer;
...
selected:boolean;alldone:boolean;strmag,strselect:pcktpointer;
{:185}{193:}stack:array[stackindex]of stackrecord;curstack:stackrecord;
zerostack:stackrecord;stackptr:stackpointer;
{:193}{199:}{charpixels:array[charpointer]of pixvalue;hpixels:pixvalue;
vpixels:pixvalue;temppix:pixvalue;}
{:199}{220:}recurfnt:array[recurpointer]of fontnumber;
recurext:array[recurpointer]of int24;
recurres:array[recurpointer]of integer;
...
{:259}{301:}termout:text;dviname:constcstring;
{:301}{23:}{48:}procedure printpacket(p:pcktpointer);var k:bytepointer;
...
then write(termout,'  ')else write(termout,' ');end;end;}
{:60}{61:}procedure printfont(f:fontnumber);var p:pcktpointer;
k:bytepointer;m:int31;begin write(termout,' = ');p:=fntname[f];
for k:=pcktstart[p]+1 to pcktstart[p+1]-1 do write(termout,xchr[bytemem[
k]]);m:=round((fntscaled[f]/fntdesign[f])*outmag);
if m<>1000 then write(termout,' scaled ',m:1);end;
{:61}{181:}procedure printoptions;
begin writeln(termout,'Valid options are:');
{188:}writeln(termout,'  mag',sepchar,'<new_mag>');
writeln(termout,'  select',sepchar,'<start_count>',sepchar,
'[<max_pages>]  (up to ',10:1,' ranges)');{:188}end;
{:181}procedure closefilesandterminate;forward;
noreturn procedure jumpout;begin history:=3;closefilesandterminate;
uexit(1);end;{:23}{24:}noreturn procedure confusion(p:pcktpointer);
begin write(termout,' !This can''t happen (');printpacket(p);
writeln(termout,').');jumpout;end;
{:24}{25:}noreturn procedure overflow(p:pcktpointer;n:int16u);
begin write(termout,' !Sorry, ','ODVIcopy',' capacity exceeded [');
printpacket(p);writeln(termout,'=',n:1,'].');jumpout;end;
{:25}{94:}noreturn procedure badtfm;
begin write(termout,'Bad TFM or OFM file');printfont(curfnt);
writeln(termout,'!');begin writeln(stderr,' ',
'Use OFM2OPL/OPL2OFM/TFtoPL/PLtoTF to diagnose and correct the problem',
'.');jumpout;end;end;noreturn procedure badfont;begin writeln(termout);
case fnttype[curfnt]of 0:confusion(strfonts);1:badtfm;
{136:}2:begin write(termout,'Bad (O)VF file');printfont(curfnt);
writeln(termout,' loc=',vfloc:1);begin writeln(stderr,' ',
'Use OVF2OVP/OVP2OVF/VFtoVP/VPtoVF to diagnose and correct the problem',
'.');jumpout;end;end;
{:136}others:begin writeln(stderr,' ','internal error','.');jumpout;end;
end;end;{:94}{109:}noreturn procedure baddvi;begin writeln(termout);
writeln(termout,'Bad DVI file: loc=',dviloc:1,'!');
write(termout,' Use DVItype with output level');
if randomreading then write(termout,'=4')else write(termout,'<4');
...
{:294}{295:}longoptions[currentoption].name:='version';
...
{:295}{296:}longoptions[currentoption].name:='magnification';
longoptions[currentoption].hasarg:=1;longoptions[currentoption].flag:=0;
longoptions[currentoption].val:=0;currentoption:=currentoption+1;
{:296}{297:}longoptions[currentoption].name:='max-pages';
longoptions[currentoption].hasarg:=1;longoptions[currentoption].flag:=0;
longoptions[currentoption].val:=0;currentoption:=currentoption+1;
{:297}{298:}longoptions[currentoption].name:='page-start';
longoptions[currentoption].hasarg:=1;longoptions[currentoption].flag:=0;
longoptions[currentoption].val:=0;currentoption:=currentoption+1;
{:298}{300:}longoptions[currentoption].name:=0;
longoptions[currentoption].hasarg:=0;longoptions[currentoption].flag:=0;
...
end else if getoptreturnval=63 then begin usage('odvicopy');
end else if(strcmp(longoptions[optionindex].name,'help')=0)then begin
usagehelp(ODVICOPYHELP,nil);
end else if(strcmp(longoptions[optionindex].name,'version')=0)then begin
printversionandexit('This is ODVIcopy, Version 1.6',
'J. Plaice, Y. Haralambous, P. Breitenlohner',nil,nil);
...
begin selectmax[curselect]:=atou(optarg);curselect:=curselect+1;
...
if k>=10 then begin writeln(stderr,'odvicopy',
': More than ten count registers specified.');uexit(1);end;m:=m+1;
end else begin selectcount[curselect][k]:=strtol(optarg+m,addressof(
endnum),10);if endnum=optarg+m then begin writeln(stderr,'odvicopy',
': -page-start values must be numeric or *.');uexit(1);end;
selectthere[curselect][k]:=true;m:=m+endnum-(optarg+m);end;end;
selectvals[curselect]:=k;selected:=false;{:299};end;
until getoptreturnval=-1;
if(optind>argc)or(optind+2<argc)then begin writeln(stderr,'odvicopy',
': Need at most two file arguments.');usage('odvicopy');end;
if optind=argc then begin dviname:='<stdin>';
dvifile:=makebinaryfile(stdin);randomreading:=false;
end else begin dviname:=extendfilename(cmdline(optind),'dvi');
resetbin(dvifile,dviname);randomreading:=true;end;
if optind+2=argc then begin rewritebin(outfile,extendfilename(cmdline(
optind+1),'dvi'));termout:=stdout;
end else begin outfile:=makebinaryfile(stdout);termout:=stderr;end;end;
{:293}procedure initialize;var{16:}i:int16;{:16}{39:}h:hashcode;
{:39}begin kpsesetprogramname(argv[0],'odvicopy');parsearguments;
write(termout,'This is ODVIcopy, Version 1.6');
writeln(termout,versionstring);writeln(termout,
...
{:18}{19:}for i:=0 to 255 do xord[chr(i)]:=32;
for i:=32 to 126 do xord[xchr[i]]:=i;{:19}{22:}history:=0;
{:22}{38:}pcktptr:=1;byteptr:=1;pcktstart[0]:=1;pcktstart[1]:=1;
...
{:82}{85:}curfnt:=maxfonts;pcktmmsg:=0;pcktsmsg:=0;pcktdmsg:=0;
{:85}{118:}for i:=0 to 136 do dvipar[i]:=0;
...
dvipar[i+243]:=dvipar[i+235];end;
{:118}{121:}for i:=0 to 136 do dvicl[i]:=0;dvicl[132]:=1;dvicl[137]:=1;
...
dvidowncmd[12]:=157;dvidowncmd[13]:=162;dvidowncmd[14]:=167;
{:123}{126:}curcp:=0;curwp:=0;{:126}{129:}dvinf:=0;{:129}{147:}lclnf:=0;
{:147}{159:}vfmove[0][0][0]:=false;vfmove[0][0][1]:=false;
vfmove[0][1][0]:=false;vfmove[0][1][1]:=false;stackused:=0;
vfchartype[false]:=3;vfchartype[true]:=0;vfruletype[false]:=4;
vfruletype[true]:=1;{:159}{174:}widthdimen:=-1073741824;
widthdimen:=widthdimen-1073741824;{:174}{175:}nopt:=0;kopt:=0;
{:175}{184:}typesetting:=false;{:184}{194:}zerostack.hfield:=0;
zerostack.vfield:=0;for i:=0 to 1 do begin zerostack.wxfield[i]:=0;
zerostack.yzfield[i]:=0;end;{[201:]zerostack.hhfield:=0;
zerostack.vvfield:=0;[:201]}{:194}{221:}nrecur:=0;recurused:=0;
{:221}{245:}outloc:=0;outback:=-1;outmaxv:=0;outmaxh:=0;outstack:=0;
outpages:=0;{:245}{256:}outnf:=0;{:256}end;
{:3}{40:}function makepacket:pcktpointer;label 31;var i,k:bytepointer;
...
{42:}p:=phash[h];
while p<>0 do begin if(pcktstart[p+1]-pcktstart[p])=l then{43:}begin i:=
s;k:=pcktstart[p];
while(i<byteptr)and(bytemem[i]=bytemem[k])do begin i:=i+1;k:=k+1;end;
if i=byteptr then begin byteptr:=pcktstart[pcktptr];goto 31;end;
end{:43};p:=plink[p];end;p:=pcktptr;plink[p]:=phash[h];phash[h]:=p{:42};
...
byteptr:=pcktstart[pcktptr];end;
{:47}{50:}function pcktsbyte:int8odvicopy;var a:eightbits;
...
begin{if curloc>=curlimit then confusion(strpackets)else}
begin a:=bytemem[curloc];curloc:=curloc+1;end;pcktubyte:=a;end;
{:50}{51:}function pcktspair:int16;var a,b:eightbits;
begin{if curloc>=curlimit then confusion(strpackets)else}
begin a:=bytemem[curloc];curloc:=curloc+1;end;
{if curloc>=curlimit then confusion(strpackets)else}
begin b:=bytemem[curloc];curloc:=curloc+1;end;
if a<128 then pcktspair:=a*256+b else pcktspair:=(a-256)*256+b;end;
function pcktupair:int16u;var a,b:eightbits;
begin{if curloc>=curlimit then confusion(strpackets)else}
begin a:=bytemem[curloc];curloc:=curloc+1;end;
{if curloc>=curlimit then confusion(strpackets)else}
begin b:=bytemem[curloc];curloc:=curloc+1;end;pcktupair:=a*256+b;end;
...
if a<128 then pcktstrio:=(a*256+b)*256+c else pcktstrio:=((a-256)*256+b)
*256+c;end;function pcktutrio:int24u;var a,b,c:eightbits;
begin{if curloc>=curlimit then confusion(strpackets)else}
begin a:=bytemem[curloc];curloc:=curloc+1;end;
{if curloc>=curlimit then confusion(strpackets)else}
begin b:=bytemem[curloc];curloc:=curloc+1;end;
{if curloc>=curlimit then confusion(strpackets)else}
begin c:=bytemem[curloc];curloc:=curloc+1;end;
pcktutrio:=(a*256+b)*256+c;end;{:52}{53:}function pcktsquad:integer;
...
if a<128 then pcktsquad:=((a*256+b)*256+c)*256+d else pcktsquad:=(((a
-256)*256+b)*256+c)*256+d;end;{:53}{54:}{procedure pcktone(x:integer);
...
ext:integer;res:integer);var o:eightbits;begin;
if maxbytes-byteptr<5 then overflow(strbytes,maxbytes);
o:=dvicharcmd[upd];
if(res>=0)and(res<256)then begin if(not upd)or(res>127)or(ext<>0)then
begin if ext<0 then ext:=ext+16777216;
if ext=0 then begin bytemem[byteptr]:=o;byteptr:=byteptr+1;
...
end;end;begin bytemem[byteptr]:=res;byteptr:=byteptr+1;
end end else begin if(res>=0)and(res<65536)then begin bytemem[byteptr]:=
o+1;byteptr:=byteptr+1;
end else begin if(res>=0)and(res<16777216)then begin bytemem[byteptr]:=o
+2;byteptr:=byteptr+1;end else begin begin bytemem[byteptr]:=o+3;
byteptr:=byteptr+1;end;
if res>=0 then begin bytemem[byteptr]:=res div 16777216;
byteptr:=byteptr+1;end else begin res:=res+1073741824;
res:=res+1073741824;begin bytemem[byteptr]:=(res div 16777216)+128;
byteptr:=byteptr+1;end;res:=res mod 16777216;end;
res:=res mod 16777216 end;begin bytemem[byteptr]:=res div 65536;
byteptr:=byteptr+1;end;res:=res mod 65536 end;
begin bytemem[byteptr]:=res div 256;byteptr:=byteptr+1;end;
res:=res mod 256;begin bytemem[byteptr]:=res;byteptr:=byteptr+1;end end;
...
end;begin bytemem[byteptr]:=x;byteptr:=byteptr+1;end;end;
...
n:pcktpointer;curloc,curlimit:bytepointer;{ll:int15;}
begin n:=fntname[curfnt];
curname:=xmallocarray(char,(pcktstart[n+1]-pcktstart[n])+(pcktstart[e+1]
-pcktstart[e]));curloc:=pcktstart[n];curlimit:=pcktstart[n+1];
{if curloc>=curlimit then confusion(strpackets)else}
...
curname[lcurname]:=0;end;
{:67}{73:}function makewidth(w:integer):widthpointer;label 31;
var h:hashcode;p:widthpointer;x:int16;begin widths[nwidths]:=w;
{74:}if w>=0 then x:=w div 16777216 else begin w:=w+1073741824;
...
nwidths:=nwidths+1;31:makewidth:=p;end;
{:73}{86:}function findpacket:boolean;label 31,10;var p,q:pcktpointer;
f:eightbits;e:int24;begin q:=charpackets[fntchars[curfnt]+curres];
if q=maxpackets then begin if pcktmmsg<10 then begin writeln(termout,
...
end;findpacket:=false;goto 10;end;{87:}repeat p:=q;q:=maxpackets;
curloc:=pcktstart[p];curlimit:=pcktstart[p+1];if p=0 then begin e:=0;
f:=0;end else begin{if curloc>=curlimit then confusion(strpackets)else}
begin f:=bytemem[curloc];curloc:=curloc+1;end;case(f div 64)of 0:e:=0;
1:e:=pcktubyte;2:e:=pcktupair;others:e:=pcktstrio;end;
if(f mod 64)>=32 then q:=pcktupair;f:=f mod 32;end;
if e=curext then goto 31;until q=maxpackets{:87};
...
end;curext:=e;31:curpckt:=p;curtype:=f;findpacket:=true;10:end;
{:86}{88:}procedure startpacket(t:typeflag);label 31,32;
var p,q:pcktpointer;f:int8u;e:integer;curloc:bytepointer;
curlimit:bytepointer;begin q:=charpackets[fntchars[curfnt]+curres];
if q<>maxpackets then{87:}repeat p:=q;q:=maxpackets;
curloc:=pcktstart[p];curlimit:=pcktstart[p+1];if p=0 then begin e:=0;
f:=0;end else begin{if curloc>=curlimit then confusion(strpackets)else}
begin f:=bytemem[curloc];curloc:=curloc+1;end;case(f div 64)of 0:e:=0;
1:e:=pcktubyte;2:e:=pcktupair;others:e:=pcktstrio;end;
...
end else charpackets[fntchars[curfnt]+pcktres]:=makepacket;end;
{:89}{97:}procedure readtfmword;begin read(tfmfile,tfmb0);
read(tfmfile,tfmb1);read(tfmfile,tfmb2);read(tfmfile,tfmb3);
if eof(tfmfile)then badfont;end;
{:97}{98:}procedure checkchecksum(c:integer;u:boolean);
...
procedure printhex(num:int31);var c:int31;begin write(termout,'"');
c:=num div 268435456;
if(c<10)then write(termout,xchr[c+'0'])else write(termout,xchr[c-10+'a']
);num:=num mod 268435456;c:=num div 16777216;
if(c<10)then write(termout,xchr[c+'0'])else write(termout,xchr[c-10+'a']
);num:=num mod 16777216;c:=num div 1048576;
if(c<10)then write(termout,xchr[c+'0'])else write(termout,xchr[c-10+'a']
);num:=num mod 1048576;c:=num div 65536;
if(c<10)then write(termout,xchr[c+'0'])else write(termout,xchr[c-10+'a']
);num:=num mod 65536;c:=num div 4096;
if(c<10)then write(termout,xchr[c+'0'])else write(termout,xchr[c-10+'a']
);num:=num mod 4096;c:=num div 256;
if(c<10)then write(termout,xchr[c+'0'])else write(termout,xchr[c-10+'a']
);num:=num mod 256;c:=num div 16;
if(c<10)then write(termout,xchr[c+'0'])else write(termout,xchr[c-10+'a']
);num:=num mod 16;c:=num;
if(c<10)then write(termout,xchr[c+'0'])else write(termout,xchr[c-10+'a']
);end;function checkwidth(w:integer):widthpointer;var wp:widthpointer;
...
begin writeln(stderr,' ',' (compare TFM or OFM file)','.');jumpout;end;
end;if w<>widths[wp]then begin printhex(curext);write(termout,' ');
printhex(curres);write(termout,': char widths do not agree! (');
printhex(w);write(termout,' vs. ');printhex(widths[wp]);
writeln(termout,')');history:=2;end;checkwidth:=wp;end;
{:98}{99:}procedure loadfont;var l,j,lprime:integer;p:charpointer;
q:widthpointer;bc,ec:int31;lf:int31;lh:int31;nw:int31;w:integer;
firsttwo:int31;ofmlevel:integer;nco,extrawords:int31;tfmwidth:int31;
{103:}z:integer;alpha:integer;beta:int15;
...
free(fullname);end else begin lcurname:=0;makename(ofmext);
fullname:=kpsefindofm(curname);
if fullname then begin resetbin(tfmfile,fullname);free(curname);
free(fullname);
end else begin writeln(stderr,' ',
'---not loaded, TFM or OFM file can''t be opened!','.');jumpout;
end end{:95};{101:}nco:=0;extrawords:=0;readtfmword;
if tfmb0>127 then badfont else firsttwo:=tfmb0*256+tfmb1;
if(firsttwo<>0)then begin fntextended[curfnt]:=false;ofmlevel:=-1;
if tfmb2>127 then badfont else lh:=tfmb2*256+tfmb3;readtfmword;
if tfmb0>127 then badfont else bc:=tfmb0*256+tfmb1;
if tfmb2>127 then badfont else ec:=tfmb2*256+tfmb3;
if ec<bc then begin bc:=1;ec:=0;end else if ec>255 then badfont;
readtfmword;if tfmb0>127 then badfont else nw:=tfmb0*256+tfmb1;
if(nw=0)or(nw>256)then badfont;for l:=-2 to lh do begin readtfmword;
if l=1 then begin if tfmb0<128 then w:=((tfmb0*256+tfmb1)*256+tfmb2)*256
+tfmb3 else w:=(((tfmb0-256)*256+tfmb1)*256+tfmb2)*256+tfmb3;
checkchecksum(w,true);
end else if l=2 then begin if tfmb0>127 then badfont;
checkdesignsize(round(tfmconv*(((tfmb0*256+tfmb1)*256+tfmb2)*256+tfmb3))
);end end end else begin fntextended[curfnt]:=true;
if tfmb2>127 then badfont else ofmlevel:=tfmb2*256+tfmb3;readtfmword;
if tfmb0>127 then badfont else lf:=tfmb0*16777216+tfmb1*65536+tfmb2*256+
tfmb3;readtfmword;
if tfmb0>127 then badfont else lh:=tfmb0*16777216+tfmb1*65536+tfmb2*256+
tfmb3;readtfmword;
if tfmb0>127 then badfont else bc:=tfmb0*16777216+tfmb1*65536+tfmb2*256+
tfmb3;readtfmword;
if tfmb0>127 then badfont else ec:=tfmb0*16777216+tfmb1*65536+tfmb2*256+
tfmb3;if ec<bc then begin bc:=1;ec:=0;end else if ec>65535 then badfont;
readtfmword;
if tfmb0>127 then badfont else nw:=tfmb0*16777216+tfmb1*65536+tfmb2*256+
tfmb3;if(nw=0)or(nw>65536)then badfont;
for l:=1 to 8 do begin if eof(tfmfile)then badfont;readtfmword;end;
if ofmlevel=1 then begin readtfmword;
nco:=((tfmb0*256+tfmb1)*256+tfmb2)*256+tfmb3;readtfmword;readtfmword;
extrawords:=(((tfmb0*256+tfmb1)*256+tfmb2)*256+tfmb3)div 2;
for l:=1 to 12 do begin if eof(tfmfile)then badfont;readtfmword;end;end;
for l:=1 to lh do begin readtfmword;
if l=1 then begin if tfmb0<128 then w:=((tfmb0*256+tfmb1)*256+tfmb2)*256
+tfmb3 else w:=(((tfmb0-256)*256+tfmb1)*256+tfmb2)*256+tfmb3;
checkchecksum(w,true);
end else if l=2 then begin if tfmb0>127 then badfont;
checkdesignsize(round(tfmconv*(((tfmb0*256+tfmb1)*256+tfmb2)*256+tfmb3))
);end end;if ofmlevel>0 then for l:=1 to(nco-29-lh)do readtfmword;
end{:101};{102:}if ofmlevel<=0 then begin begin readtfmword;
if firsttwo<>0 then tfmwidth:=tfmb0 else begin if false then readtfmword
;tfmwidth:=tfmb0*256+tfmb1;end end;
while(tfmwidth=0)and(bc<=ec)do begin bc:=bc+1;begin readtfmword;
if firsttwo<>0 then tfmwidth:=tfmb0 else begin if true then readtfmword;
tfmwidth:=tfmb0*256+tfmb1;end end;end;fntbc[curfnt]:=bc;
fntchars[curfnt]:=nchars-bc;
if ec>=maxchars-fntchars[curfnt]then overflow(strchars,maxchars);
for l:=bc to ec do begin charwidths[nchars]:=tfmwidth;nchars:=nchars+1;
begin readtfmword;
if firsttwo<>0 then tfmwidth:=tfmb0 else begin if true then readtfmword;
tfmwidth:=tfmb0*256+tfmb1;end end;end;
while(charwidths[nchars-1]=0)and(ec>=bc)do begin nchars:=nchars-1;
ec:=ec-1;end;fntec[curfnt]:=ec end else begin fntbc[curfnt]:=bc;
fntchars[curfnt]:=nchars-bc;
if ec>=maxchars-fntchars[curfnt]then overflow(strchars,maxchars);
fntec[curfnt]:=ec;l:=bc;while l<=ec do begin readtfmword;
tfmwidth:=tfmb0*256+tfmb1;charwidths[nchars]:=tfmwidth;nchars:=nchars+1;
readtfmword;readtfmword;lprime:=l+(tfmb0*256+tfmb1);
for j:=l+1 to lprime do begin charwidths[nchars]:=tfmwidth;
nchars:=nchars+1;end;l:=lprime+1;for j:=1 to extrawords do readtfmword;
end;readtfmword;end{:102};
{105:}if nw-1>maxchars-nchars then overflow(strchars,maxchars);
...
charwidths[p]:=makewidth(w);end{:105};
{106:}for p:=fntchars[curfnt]+bc to nchars-1 do begin q:=charwidths[
nchars+charwidths[p]];charwidths[p]:=q;charpackets[p]:=maxpackets;
end{:106};xfclose(tfmfile,curname);
{[197:]fntspace[curfnt]:=fntscaled[curfnt]div 6;[:197]}
{write(termout,' loaded at ',fntscaled[curfnt]:1,' DVI units')};
writeln(termout,'.');end;
{:99}{107:}function definefont(load:boolean):fontnumber;
var savefnt:fontnumber;begin savefnt:=curfnt;curfnt:=0;
...
definefont:=curfnt;curfnt:=savefnt;end;
{:107}{112:}function dvilength:integer;
begin xfseek(dvifile,0,2,dviname);dviloc:=xftell(dvifile,dviname);
dvilength:=dviloc;end;procedure dvimove(n:integer);
begin xfseek(dvifile,n,0,dviname);dviloc:=n;end;
{:112}{113:}function dvisbyte:int8odvicopy;var a:eightbits;
...
if a<128 then dvispair:=a*256+b else dvispair:=(a-256)*256+b;end;
function dviupair:int16u;var a,b:eightbits;
begin if eof(dvifile)then baddvi else read(dvifile,a);
if eof(dvifile)then baddvi else read(dvifile,b);dviloc:=dviloc+2;
dviupair:=a*256+b;end;function dvistrio:int24;var a,b,c:eightbits;
begin if eof(dvifile)then baddvi else read(dvifile,a);
if eof(dvifile)then baddvi else read(dvifile,b);
if eof(dvifile)then baddvi else read(dvifile,c);dviloc:=dviloc+3;
if a<128 then dvistrio:=(a*256+b)*256+c else dvistrio:=((a-256)*256+b)
*256+c;end;function dviutrio:int24u;var a,b,c:eightbits;
begin if eof(dvifile)then baddvi else read(dvifile,a);
if eof(dvifile)then baddvi else read(dvifile,b);
if eof(dvifile)then baddvi else read(dvifile,c);dviloc:=dviloc+3;
dviutrio:=(a*256+b)*256+c;end;function dvisquad:integer;
var a,b,c,d:eightbits;
begin if eof(dvifile)then baddvi else read(dvifile,a);
if eof(dvifile)then baddvi else read(dvifile,b);
if eof(dvifile)then baddvi else read(dvifile,c);
if eof(dvifile)then baddvi else read(dvifile,d);dviloc:=dviloc+4;
if a<128 then dvisquad:=((a*256+b)*256+c)*256+d else dvisquad:=(((a-256)
*256+b)*256+c)*256+d;end;{:113}{114:}function dviuquad:int31;
var x:integer;begin x:=dvisquad;if x<0 then baddvi else dviuquad:=x;end;
...
if(x<=0)and(x<>-1)then baddvi else dvipointer:=x;end;
{:114}{127:}procedure dvifirstpar;begin repeat curcmd:=dviubyte;
until curcmd<>138;case dvipar[curcmd]of 0:begin curext:=0;
...
if(curcmd=3)and(curres>127)then curres:=curres-128;
while curcmd>0 do begin curext:=curext*256+curres;curres:=dviubyte;
curcmd:=curcmd-1;end;
if fntextended[curfnt]then begin curres:=256*curext+curres;curext:=0;
end end;end;1:;2:curparm:=dvisbyte;3:curparm:=dviubyte;
4:curparm:=dvispair;5:curparm:=dviupair;6:curparm:=dvistrio;
7:curparm:=dviutrio;8,9:curparm:=dvisquad;10:curparm:=dviuquad;
11:begin curvdimen:=dvisquad;curhdimen:=dvisquad;curupd:=(curcmd=132);
end;12:curparm:=curcmd-171;
others:begin writeln(stderr,' ','internal error','.');jumpout;end;end;
...
curfnt:=dviifnts[f];if fnttype[curfnt]=0 then loadfont;end;
{:130}{132:}procedure dvidofont(second:boolean);var f:fontnumber;
k:int15;begin write(termout,'DVI: font ',curparm:1);{131:}f:=0;
...
end else if dviifnts[f]<>dviifnts[dvinf]then baddvi;end;
{:132}{141:}function vfubyte:int8u;var a:eightbits;
...
vfupair:=a*256+b;end;function vfstrio:int24;var a,b,c:eightbits;
begin if eof(vffile)then badfont else read(vffile,a);
if eof(vffile)then badfont else read(vffile,b);
if eof(vffile)then badfont else read(vffile,c);vfloc:=vfloc+3;
if a<128 then vfstrio:=(a*256+b)*256+c else vfstrio:=((a-256)*256+b)*256
+c;end;function vfutrio:int24u;var a,b,c:eightbits;
begin if eof(vffile)then badfont else read(vffile,a);
if eof(vffile)then badfont else read(vffile,b);
if eof(vffile)then badfont else read(vffile,c);vfloc:=vfloc+3;
vfutrio:=(a*256+b)*256+c;end;function vfsquad:integer;
var a,b,c,d:eightbits;
begin if eof(vffile)then badfont else read(vffile,a);
if eof(vffile)then badfont else read(vffile,b);
if eof(vffile)then badfont else read(vffile,c);
if eof(vffile)then badfont else read(vffile,d);vfloc:=vfloc+4;
if a<128 then vfsquad:=((a*256+b)*256+c)*256+d else vfsquad:=(((a-256)
*256+b)*256+c)*256+d;end;{:141}{143:}function vffix1:integer;
var x:integer;begin if eof(vffile)then badfont else read(vffile,tfmb3);
vfloc:=vfloc+1;if tfmb3>127 then tfmb1:=255 else tfmb1:=0;tfmb2:=tfmb1;
...
curcmd:=curcmd-dvicharcmd[curupd];
if(curcmd=3)and(curres>127)then curres:=curres-128;
while curcmd>0 do begin curext:=curext*256+curres;curres:=vfubyte;
curcmd:=curcmd-1;end;
if fntextended[vfcurfnt]then begin curres:=256*curext+curres;curext:=0;
end end;end;curwp:=0;
...
label 21,30,32,10;var tempbyte:int8u;k:bytepointer;l:int15;
saveext:int24;saveres:integer;savecp:widthpointer;savewp:widthpointer;
saveupd:boolean;vfwp:widthpointer;vffnt:fontnumber;movezero:boolean;
lastpop:boolean;begin{139:}lcurname:=0;makename(vfext);
fullname:=kpsefindvf(curname);
if fullname then begin resetbin(vffile,fullname);free(curname);
free(fullname);end else begin lcurname:=0;makename(ovfext);
fullname:=kpsefindovf(curname);
if fullname then begin resetbin(vffile,fullname);free(curname);
free(fullname);end else goto 32 end;vfloc:=0{:139};saveext:=curext;
...
byteptr:=byteptr+1;end;if fntextended[curfnt]then write(termout,'O');
write(termout,'VF file: ''');printpacket(newpacket);
write(termout,''',');flushpacket;checkchecksum(vfsquad,false);
checkdesignsize(round(tfmconv*vfpquad));z:=fntscaled[curfnt];
{104:}alpha:=16;while z>=8388608 do begin z:=z div 2;alpha:=alpha+alpha;
end;beta:=256 div alpha;alpha:=alpha*z{:104};begin writeln(termout);
...
while curcmd<=242 do{160:}begin if curcmd<242 then begin vflimit:=curcmd
;curext:=0;curres:=vfubyte;vfwp:=checkwidth(vffix3u);
end else begin vflimit:=vfuquad;curext:=vfstrio;curres:=vfubyte;
if fntextended[curfnt]then begin curres:=256*curext+curres;curext:=0;
end;vfwp:=checkwidth(vffix4);end;vflimit:=vflimit+vfloc;
...
while true do begin 21:case curclass of 0,1,2:{164:}begin if(vfptr=0)or(
byteptr>vfpushloc[vfptr])then movezero:=false else case curclass of 0:
movezero:=(not curupd)or(vfcurfnt<>vffnt);1:movezero:=not curupd;
2:movezero:=true;others:begin writeln(stderr,' ','internal error','.');
jumpout;end;end;if movezero then begin byteptr:=byteptr-1;
vfptr:=vfptr-1;end;
case curclass of 0:{165:}begin if vfcurfnt<>vffnt then begin vflast[
vfptr]:=4;pcktunsigned(235,vfcurfnt);vffnt:=vfcurfnt;end;
...
pcktfour(curvdimen);pcktfour(curhdimen);end{:166};
2:{167:}begin vflast[vfptr]:=4;pcktunsigned(239,curparm);
...
if curclass=0 then if curupd then goto 21;end;end{:164};
3:{162:}if(vfptr>0)and(vfpushloc[vfptr]=byteptr)then begin if vfpushnum[
vfptr]=255 then overflow(strstack,255);
...
if byteptr=vfpushloc[vfptr]then{170:}begin if vfpushnum[vfptr]>0 then
begin vfpushnum[vfptr]:=vfpushnum[vfptr]-1;
begin vfmove[vfptr][0][0]:=vfmove[vfptr-1][0][0];
vfmove[vfptr][0][1]:=vfmove[vfptr-1][0][1];
vfmove[vfptr][1][0]:=vfmove[vfptr-1][1][0];
vfmove[vfptr][1][1]:=vfmove[vfptr-1][1][1]end;
end else begin byteptr:=byteptr-1;vfptr:=vfptr-1;end;
if curclass<>4 then goto 21;
end{:170}else begin if vflast[vfptr]=2 then{171:}begin byteptr:=byteptr
-2;for k:=vflastloc[vfptr]+1 to byteptr do bytemem[k-1]:=bytemem[k];
...
if vfpushnum[vfptr+1]>0 then{172:}begin vfptr:=vfptr+1;
{163:}begin if maxbytes-byteptr<1 then overflow(strbytes,maxbytes);
begin bytemem[byteptr]:=141;byteptr:=byteptr+1;end;end;
begin vfmove[vfptr][0][0]:=vfmove[vfptr-1][0][0];
vfmove[vfptr][0][1]:=vfmove[vfptr-1][0][1];
...
16:badfont;17:if curcmd<>138 then badfont;
others:begin writeln(stderr,' ','internal error','.');jumpout;end;end;
...
writeln(termout,' loaded.');}xfclose(vffile,curname);curext:=saveext;
curres:=saveres;curcp:=savecp;curwp:=savewp;curupd:=saveupd;dovf:=true;
goto 10;32:dovf:=false;10:end;{:151}{180:}{176:}procedure inputln;
...
byteptr]:=xord[getc(input)];byteptr:=byteptr+1;end;k:=k+1;end;end;
{:176}{178:}function scankeyword(p:pcktpointer;l:int7):boolean;
...
selectmax[curselect]:=0;selected:=true;
{:187}while true do begin inputln;p:=newpacket;bytemem[byteptr]:=32;
scanptr:=pcktstart[pcktptr-1];
while((bytemem[scanptr]=32)or(bytemem[scanptr]=47))and(scanptr<byteptr)
do scanptr:=scanptr+1;if scanptr=byteptr then begin flushpacket;goto 10;
end{190:}else if scankeyword(strmag,3)then outmag:=scanint else if
scankeyword(strselect,3)then if curselect=10 then writeln(termout,
...
jumpout;end;end;end;flushpacket;end;10:end;
{:180}{182:}{250:}procedure outpacket(p:pcktpointer);var k:bytepointer;
...
end;{:251}{252:}procedure outchar(upd:boolean;ext:integer;res:integer);
var o:eightbits;begin;o:=dvicharcmd[upd];
if(res>=0)and(res<256)then begin if(not upd)or(res>127)or(ext<>0)then
begin if ext<0 then ext:=ext+16777216;
if ext=0 then begin putbyte(o,outfile);outloc:=outloc+1;
...
end;end;begin putbyte(res,outfile);outloc:=outloc+1;
end end else begin if(res>=0)and(res<65536)then begin putbyte(o+1,
outfile);outloc:=outloc+1;
end else begin if(res>=0)and(res<16777216)then begin putbyte(o+2,outfile
);outloc:=outloc+1;end else begin begin putbyte(o+3,outfile);
outloc:=outloc+1;end;
if res>=0 then begin putbyte(res div 16777216,outfile);outloc:=outloc+1;
end else begin res:=res+1073741824;res:=res+1073741824;
begin putbyte((res div 16777216)+128,outfile);outloc:=outloc+1;end;
res:=res mod 16777216;end;res:=res mod 16777216 end;
begin putbyte(res div 65536,outfile);outloc:=outloc+1;end;
res:=res mod 65536 end;begin putbyte(res div 256,outfile);
outloc:=outloc+1;end;res:=res mod 256;begin putbyte(res,outfile);
outloc:=outloc+1;end end;end;
{:252}{253:}procedure outunsigned(o:eightbits;x:integer);begin;
if(x<256)and(x>=0)then if(o=235)and(x<64)then x:=x+171 else begin
...
begin putbyte(x,outfile);outloc:=outloc+1;end;end;
{:253}{254:}procedure outsigned(o:eightbits;x:integer);var xx:int31;
...
begin putbyte(x div 256,outfile);outloc:=outloc+1;end;x:=x mod 256;end;
begin putbyte(x,outfile);outloc:=outloc+1;end;end;
{:254}{258:}procedure outfntdef(f:fontnumber);var p:pcktpointer;
...
while k<l do begin k:=k+1;putbyte(bytemem[k],outfile);end;end;
{:258}{:182}{186:}function startmatch:boolean;var k:0..9;match:boolean;
begin match:=true;
...
comment:constcstring;{:260}begin alldone:=false;numselect:=curselect;
curselect:=0;if numselect=0 then selectmax[curselect]:=0;
{hconv:=(dvinum/254000.0)*(300/dviden)*(outmag/1000.0);
vconv:=(dvinum/254000.0)*(300/dviden)*(outmag/1000.0);}
{261:}begin putbyte(247,outfile);outloc:=outloc+1;end;
begin putbyte(2,outfile);outloc:=outloc+1;end;outfour(dvinum);
outfour(dviden);outfour(outmag);p:=pcktstart[pcktptr-1];q:=byteptr;
comment:='ODVIcopy 1.6 output from ';
if maxbytes-byteptr<25 then overflow(strbytes,maxbytes);
for k:=0 to 24 do begin bytemem[byteptr]:=xord[ucharcast(comment[k])];
byteptr:=byteptr+1;end;while bytemem[p]=32 do p:=p+1;
if p=q then byteptr:=byteptr-6 else begin k:=0;
while(k<25)and(bytemem[p+k]=bytemem[q+k])do k:=k+1;if k=25 then p:=p+25;
end;k:=byteptr-p;if k>255 then begin k:=255;q:=p+230;end;
...
outloc:=outloc+1;end;{:261}end;{:204}{205:}procedure dobop;
{262:}var{:262}i,j:0..9;
begin{206:}if not selected then selected:=startmatch;
...
{:205}{207:}procedure doeop;
{264:}{:264}begin if stackptr<>0 then baddvi;
{265:}begin putbyte(140,outfile);outloc:=outloc+1;end;
{:265}if selectmax[curselect]>0 then begin selectmax[curselect]:=
selectmax[curselect]-1;
if selectmax[curselect]=0 then begin selected:=false;
curselect:=curselect+1;if curselect=numselect then alldone:=true;end;
end;typesetting:=false;end;{:207}{208:}procedure dopush;
{266:}{:266}begin if stackptr=stackused then if stackused=stacksize then
overflow(strstack,stacksize)else stackused:=stackused+1;
stackptr:=stackptr+1;stack[stackptr]:=curstack;
{267:}if stackptr>outstack then outstack:=stackptr;
begin putbyte(141,outfile);outloc:=outloc+1;end;{:267}end;
procedure dopop;{268:}{:268}begin if stackptr=0 then baddvi;
curstack:=stack[stackptr];stackptr:=stackptr-1;
{269:}begin putbyte(142,outfile);outloc:=outloc+1;end;{:269}end;
{:208}{209:}procedure doxxx;{270:}var{:270}p:pcktpointer;
begin p:=newpacket;{271:}outunsigned(239,(pcktstart[p+1]-pcktstart[p]));
outpacket(p);{:271}flushpacket;end;{:209}{210:}procedure doright;
{272:}{:272}begin if curclass>=8 then curstack.wxfield[curclass-8]:=
curparm else if curclass<7 then curparm:=curstack.wxfield[curclass-5];
{273:}if curclass<7 then begin putbyte(curcmd,outfile);outloc:=outloc+1;
end else outsigned(dvirightcmd[curclass],curparm);
{:273}curstack.hfield:=curstack.hfield+curparm{;
...
curstack.hhfield:=temppix-2 else curstack.hhfield:=temppix+2;end};
{274:}if abs(curstack.hfield)>outmaxh then outmaxh:=abs(curstack.hfield)
;{:274}end;{:210}{211:}procedure dodown;
{275:}{:275}begin if curclass>=13 then curstack.yzfield[curclass-13]:=
curparm else if curclass<12 then curparm:=curstack.yzfield[curclass-10];
{276:}if curclass<12 then begin putbyte(curcmd,outfile);
outloc:=outloc+1;end else outsigned(dvidowncmd[curclass],curparm);
{:276}curstack.vfield:=curstack.vfield+curparm{;
...
curstack.vvfield:=temppix-2 else curstack.vvfield:=temppix+2;end};
{277:}if abs(curstack.vfield)>outmaxv then outmaxv:=abs(curstack.vfield)
;{:277}end;{:211}{212:}procedure dowidth;
{278:}{:278}begin{279:}begin putbyte(132,outfile);outloc:=outloc+1;end;
outfour(widthdimen);outfour(curhdimen);
{:279}curstack.hfield:=curstack.hfield+curhdimen{;
...
if vpixels<vconv*curvdimen then vpixels:=vpixels+1;end;}
{281:}begin putbyte(dvirulecmd[curupd],outfile);outloc:=outloc+1;end;
outfour(curvdimen);outfour(curhdimen);
{:281}end else begin visible:=false;
{282:}{281:}begin putbyte(dvirulecmd[curupd],outfile);outloc:=outloc+1;
end;outfour(curvdimen);outfour(curhdimen);{:281}{:282}end;
...
curstack.hhfield:=temppix-2 else curstack.hhfield:=temppix+2;end};
{274:}if abs(curstack.hfield)>outmaxh then outmaxh:=abs(curstack.hfield)
;{:274}end;end;{:213}{214:}procedure dochar;
{287:}{:287}begin{288:}{if fnttype[curfnt]<>3 then confusion(strfonts);}
if curfnt<>outfnt then begin outunsigned(235,fntfont[curfnt]);
outfnt:=curfnt;end;outchar(curupd,curext,curres);
{:288}if curupd then begin curstack.hfield:=curstack.hfield+widths[curwp
]{;begin curstack.hhfield:=curstack.hhfield+charpixels[curcp];
temppix:=round(hconv*(curstack.hfield));
if abs(temppix-curstack.hhfield)>2 then if temppix>curstack.hhfield then
curstack.hhfield:=temppix-2 else curstack.hhfield:=temppix+2;end};
{274:}if abs(curstack.hfield)>outmaxh then outmaxh:=abs(curstack.hfield)
;{:274}end;end;{:214}{216:}procedure dofont;label 30;
{283:}var{:283}p:charpointer;
begin{if fnttype[curfnt]=0 then confusion(strfonts);}p:=0;
{for p:=fntchars[curfnt]+fntbc[curfnt]to fntchars[curfnt]+fntec[curfnt]
do charpixels[p]:=round(hconv*(widths[charwidths[p]]));}
{284:}{:284}if dovf then goto 30;
{285:}if(outnf>=maxfonts)then overflow(strfonts,maxfonts);
...
outfnts[outnf]:=curfnt;outnf:=outnf+1;outfntdef(curfnt);
{:285}30:{if fnttype[curfnt]<=1 then confusion(strfonts);}end;
{:216}{218:}procedure pcktfirstpar;begin curcmd:=pcktubyte;
case dvipar[curcmd]of 0:begin curext:=0;
if curcmd<128 then begin curres:=curcmd;
curupd:=true end else begin curres:=pcktubyte;curupd:=(curcmd<133);
curcmd:=curcmd-dvicharcmd[curupd];
if(curcmd=3)and(curres>127)then curres:=curres-128;
while curcmd>0 do begin curext:=curext*256+curres;curres:=pcktubyte;
curcmd:=curcmd-1;end;
if fntextended[curfnt]then begin curres:=256*curext+curres;curext:=0;
end end;end;1:;2:curparm:=pcktsbyte;3:curparm:=pcktubyte;
4:curparm:=pcktspair;5:curparm:=pcktupair;6:curparm:=pcktstrio;
7:curparm:=pcktutrio;8,9,10:curparm:=pcktsquad;
11:begin curvdimen:=pcktsquad;curhdimen:=pcktsquad;curupd:=(curcmd=132);
end;12:curparm:=curcmd-171;
others:begin writeln(stderr,' ','internal error','.');jumpout;end;end;
curclass:=dvicl[curcmd];end;{:218}{222:}procedure dovfpacket;
...
recurres[nrecur]:=curres{:223};
{225:}if findpacket then f:=curtype else goto 30;
recurpckt[nrecur]:=curpckt;savelimit:=curlimit;curfnt:=fntfont[curfnt];
if curpckt=0 then begin curclass:=0;goto 31;end;
if curloc>=curlimit then goto 30;22:pcktfirstpar;
31:case curclass of 0:{226:}begin{217:}{286:}{:286}if fnttype[curfnt]<=1
then dofont{:217};curcp:=fntchars[curfnt]+curres;
curwp:=charwidths[curcp];
if(curloc=curlimit)and(f=0)and saveupd then begin saveupd:=false;
curupd:=true;end;
if fnttype[curfnt]=2 then{227:}begin recurloc[nrecur]:=curloc;
if curloc<curlimit then if bytemem[curloc]=142 then curupd:=false;
if nrecur=recurused then if recurused=maxrecursion then{228:}begin
writeln(termout,' !Infinite VF recursion?');
...
end{:228}else recurused:=recurused+1;nrecur:=nrecur+1;dovfpacket;
nrecur:=nrecur-1;curloc:=recurloc[nrecur];curlimit:=savelimit;
end{:227}else dochar;end{:226};1:dorule;
...
begin{hpixels:=charpixels[savecp];}dowidth;end;end;
{224:}curfnt:=recurfnt[nrecur]{:224};end;{:222}{229:}procedure dodvi;
label 30,10;var tempbyte:int8u;tempint:integer;dvistart:integer;
dviboppost:integer;dviback:integer;k:int15;
begin{230:}if dviubyte<>247 then baddvi;if dviubyte<>2 then baddvi;
...
writeln(termout,'.');dopre;flushpacket{:230};
if randomreading then{232:}begin dvistart:=dviloc;
{233:}tempint:=dvilength-5;repeat if tempint<49 then baddvi;
dvimove(tempint);tempbyte:=dviubyte;tempint:=tempint-1;
until tempbyte<>223;if tempbyte<>2 then baddvi;dvimove(tempint-4);
if dviubyte<>249 then baddvi;dviboppost:=dvipointer;
...
if curcmd<>249 then baddvi;
if not selected then{234:}begin dvistart:=dviboppost;
...
while curclass=16 do begin dvidofont(randomreading);dvifirstpar;end;
if curcmd=139 then{235:}begin for k:=0 to 9 do count[k]:=dvisquad;
tempint:=dvipointer;dobop;dvifirstpar;
if typesetting then{236:}while true do begin case curclass of 0:{238:}
begin{217:}{286:}{:286}if fnttype[curfnt]<=1 then dofont{:217};curwp:=0;
...
16:dvidofont(randomreading);17:goto 30;
others:begin writeln(stderr,' ','internal error','.');jumpout;end;end;
dvifirstpar;
end{:236}else{237:}while true do begin case curclass of 2:while curparm>
0 do begin tempbyte:=dviubyte;curparm:=curparm-1;end;
16:dvidofont(randomreading);17:goto 30;others:;end;dvifirstpar;
end{:237};30:if curcmd<>140 then baddvi;if selected then begin doeop;
if alldone then goto 10;end;end{:235};until curcmd<>140;
if curcmd<>248 then baddvi;10:end;
{:229}{240:}procedure closefilesandterminate;var k:int15;begin;
if history<3 then{215:}begin if typesetting then{289:}begin while
stackptr>0 do begin begin putbyte(142,outfile);outloc:=outloc+1;end;
stackptr:=stackptr-1;end;begin putbyte(140,outfile);outloc:=outloc+1;
end;end{:289};
{290:}if outloc>0 then begin{291:}begin putbyte(248,outfile);
outloc:=outloc+1;end;outfour(outback);outback:=outloc-5;outfour(dvinum);
...
,recurused:1,' of ',maxrecursion:1,' recursion levels.')[:242];}
{247:}{:247}{243:}case history of 0:writeln(termout,
...
end;{:240}{241:}begin initialize;
{45:}{if maxbytes-byteptr<5 then overflow(strbytes,maxbytes);}
...
{:45}{91:}{if maxbytes-byteptr<4 then overflow(strbytes,maxbytes);}
byteptr:=byteptr+4;bytemem[byteptr-4]:=46;bytemem[byteptr-3]:=116;
bytemem[byteptr-2]:=102;bytemem[byteptr-1]:=109;tfmext:=makepacket;
{if maxbytes-byteptr<4 then overflow(strbytes,maxbytes);}
byteptr:=byteptr+4;bytemem[byteptr-4]:=46;bytemem[byteptr-3]:=111;
bytemem[byteptr-2]:=102;bytemem[byteptr-1]:=109;ofmext:=makepacket;
{:91}{135:}{if maxbytes-byteptr<3 then overflow(strbytes,maxbytes);}
byteptr:=byteptr+3;bytemem[byteptr-3]:=46;bytemem[byteptr-2]:=118;
bytemem[byteptr-1]:=102;vfext:=makepacket;
{if maxbytes-byteptr<4 then overflow(strbytes,maxbytes);}
byteptr:=byteptr+4;bytemem[byteptr-4]:=46;bytemem[byteptr-3]:=111;
bytemem[byteptr-2]:=118;bytemem[byteptr-1]:=102;ovfext:=makepacket;
{:135}{191:}{if maxbytes-byteptr<3 then overflow(strbytes,maxbytes);}
