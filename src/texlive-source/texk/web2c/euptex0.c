...
zprintcs ( integer p ) 
{
  ...
  else if ( ( ( p >= 24527 ) && ( p <= 30307 ) ) || ( p > eqtbtop ) ) 
  printesc ( 545 ) ;
...
zshownodelist ( integer p ) 
{
  ...
  while ( p > memmin ) {
	...
	break ;
      case 1 : 
	{
	  printwritewhatsit ( 646 , p ) ;
	  printmark ( mem [p + 1 ].hh .v.RH ) ;
	} 
	break ;
      case 2 : 
	printwritewhatsit ( 1426 , p ) ;
	break ;
      case 3 : 
	{
	  printesc ( 1427 ) ;
	...
	if ( memtop - 2 != pagetail ) 
	{
	  ...
	  if ( pagecontents > 0 ) 
	  {
	    ...
	    while ( r != memtop ) {
	      ...
	      printint ( t ) ;
	      print ( 1084 ) ;
	      if ( eqtb [29259 + t ].cint == 1000 ) 
	      t = mem [r + 3 ].cint ;
	      else t = xovern ( mem [r + 3 ].cint , 1000 ) * eqtb [29259 + 
	      t ].cint ;
	      printscaled ( t ) ;
	      if ( mem [r ].hh.b0 == 1 ) 
	      {
...
zprintcmdchr ( quarterword cmd , halfword chrcode ) 
{
  ...
  case 82 : 
    ...
    printparam ( chrcode - 29188 ) ;
      ...
      printesc ( 508 ) ;
      printint ( chrcode - 29259 ) ;
    } 
    break ;
  case 83 : 
    if ( chrcode < 29796 ) 
    printlengthparam ( chrcode - 29771 ) ;
    else {
	
      printesc ( 536 ) ;
      printint ( chrcode - 29796 ) ;
    } 
    break ;
  case 49 : 
    printesc ( 547 ) ;
...
zshoweqtb ( halfword n ) 
{
  ...
  if ( n < 1 ) 
  printchar ( 63 ) ;
  else if ( ( n < 24528 ) || ( ( n > 30307 ) && ( n <= eqtbtop ) ) ) 
  {
    sprintcs ( n ) ;
    printchar ( 61 ) ;
...
zeffectivechar ( boolean errp , internalfontnumber f , quarterword c ) 
{
  ...
  if ( c >= eqtb [29245 ].cint ) {
      
    if ( c <= eqtb [29246 ].cint ) {
...
zscansomethinginternal ( smallnumber level , boolean negative ) 
{
  ...
  case 97 : 
	...
	) * 65536L + ( curval1 % 256 ) ;
	{
      ...
      {
	curval1 = eqtb [29515 + curval ].cint ;
  ...
  case 103 : 
	...
	{case 0 : 
	  curval = eqtb [29259 + curval ].cint ;
	  break ;
	case 1 : 
	  curval = eqtb [29796 + curval ].cint ;
	  break ;
	case 2 : 
...
openlogfile ( void ) 
{
  ...
  logopened = true ;
  {
    ...
    fprintf ( logfile , "%s%s%s%s%s",  "This is e-upTeX, Version 3.14159265" , "-p3.7" ,     "-u1.20" , "-150805" , "-2.6" ) ;
    else
    fprintf ( logfile , "%s%s%s%s%s",  "This is e-upTeX, Version 3.14159265" , "-p3.7" ,     "-u1.20" , "-150805" , "-2.6" ) ;
    Fputs ( logfile ,  " (" ) ;
...
zspecialout ( halfword p ) 
{
  ...
  goto lab30 ;
  geqworddefine ( 29794 , cw ) ;
  geqworddefine ( 29795 , t ) ;
  curpageheight = t ;
  curpagewidth = cw ;
...
zshipout ( halfword p ) 
{
  ...
  synctexsheet ( eqtb [29205 ].cint ) ;
  {
    ...
    printchar ( 91 ) ;
    j = 9 ;
    while ( ( eqtb [29259 + j ].cint == 0 ) && ( j > 0 ) ) decr ( j ) ;
    {register integer for_end; k = 0 ;for_end = j ; if ( k <= for_end) do 
      {
	printint ( eqtb [29259 + k ].cint ) ;
	if ( k < j ) 
	printchar ( 46 ) ;
      } 
    while ( k++ < for_end ) ;} 
    ...
    29790 ].cint > 1073741823L ) || ( mem [p + 1 ].cint + eqtb [29789 ]
    .cint > 1073741823L ) ) 
    {
      {
	if ( interaction == 3 ) 
    ...
    if ( mem [p + 3 ].cint + mem [p + 2 ].cint + eqtb [29790 ].cint > 
    maxv ) 
    maxv = mem [p + 3 ].cint + mem [p + 2 ].cint + eqtb [29790 ].cint ;
    if ( mem [p + 1 ].cint + eqtb [29789 ].cint > maxh ) 
    maxh = mem [p + 1 ].cint + eqtb [29789 ].cint ;
    if ( eqtb [29795 ].cint != 0 ) 
    curpageheight = eqtb [29795 ].cint ;
    else curpageheight = mem [p + 3 ].cint + mem [p + 2 ].cint + 2 * eqtb 
    [29790 ].cint + 2 * 4736286L ;
    if ( eqtb [29794 ].cint != 0 ) 
    curpagewidth = eqtb [29794 ].cint ;
    else curpagewidth = mem [p + 1 ].cint + 2 * eqtb [29789 ].cint + 2 * 
    4736286L ;
    if ( ( mem [p ].hh.b0 == 2 ) ) {
    ...
    {register integer for_end; k = 0 ;for_end = 9 ; if ( k <= for_end) do 
      dvifour ( eqtb [29259 + k ].cint ) ;
    while ( k++ < for_end ) ;} 
    dvifour ( lastbop ) ;
    lastbop = pageloc ;
    curv = mem [p + 3 ].cint + eqtb [29790 ].cint ;
    tempptr = p ;
    switch ( mem [p ].hh.b0 ) 
    {case 0 : 
      hlistout () ;
...
zhpack ( halfword p , scaled w , smallnumber m ) 
{
  ...
  else if ( x > 0 ) 
  {
    ...
    ].hh .v.RH != -1073741823L ) ) 
    {
      ...
      mem [r + 6 ].gr = 1.0 ;
      if ( ( - (integer) x - totalshrink [0 ]> eqtb [29779 ].cint ) || ( 
      eqtb [29214 ].cint < 100 ) ) 
      {
	if ( ( eqtb [29787 ].cint > 0 ) && ( - (integer) x - totalshrink [0 
	]> eqtb [29779 ].cint ) ) 
	{
	  while ( mem [q ].hh .v.RH != -1073741823L ) q = mem [q ].hh 
	  .v.RH ;
	  mem [q ].hh .v.RH = newrule () ;
	  mem [mem [q ].hh .v.RH + 1 ].cint = eqtb [29787 ].cint ;
	} 
	println () ;
	printnl ( 948 ) ;
...
zvpackage ( halfword p , scaled h , smallnumber m , scaled l ) 
{
  ...
  else if ( x > 0 ) 
  {
    ...
    ].hh .v.RH != -1073741823L ) ) 
    {
      lastbadness = 1000000L ;
      mem [r + 6 ].gr = 1.0 ;
      if ( ( - (integer) x - totalshrink [0 ]> eqtb [29780 ].cint ) || ( 
      eqtb [29215 ].cint < 100 ) ) 
      {
	println () ;
	printnl ( 953 ) ;
...
zmakescripts ( halfword q , scaled delta ) 
{
  ...
  if ( mem [q + 2 ].hh .v.RH == 0 ) 
  {
    ...
    mem [x + 1 ].cint = mem [x + 1 ].cint + eqtb [29783 ].cint ;
    ...
    mem [x + 4 ].cint = - (integer) shiftup ;
      ...
      .v.LH ) ;
      mem [y + 1 ].cint = mem [y + 1 ].cint + eqtb [29783 ].cint ;
...
zmakeleftright ( halfword q , smallnumber style , scaled maxd , scaled maxh ) 
{
  ...
  delta2 = delta1 + delta1 - eqtb [29781 ].cint ;
  if ( delta < delta2 ) 
  delta = delta2 ;
	...
	( curactivewidth [5 ]!= 0 ) || ( curactivewidth [6 ]!= 0 ) ) 
	{
	  if ( dolastlinefit ) 
	  {
	    if ( curp == -1073741823L ) 
	    {
	      ...
	      1073741823L ) ;
	      if ( eqtb [29255 ].cint < 1000 ) 
	      g = fract ( g , eqtb [29255 ].cint , 1000 , 1073741823L ) ;
	      if ( aritherror ) {
...
zvsplit ( halfword n , scaled h ) 
{
  ...
  q = vertbreak ( mem [v + 5 ].hh .v.RH , h , eqtb [29777 ].cint ) ;
  p = mem [v + 5 ].hh .v.RH ;
  if ( p == q ) 
  ...
  lab30: ;
  q = prunepagetop ( q , eqtb [29256 ].cint > 0 ) ;
  p = mem [v + 5 ].hh .v.RH ;
  if ( q != -1073741823L ) 
  {
  ...
  q = vpackage ( p , h , 0 , eqtb [29777 ].cint ) ;
  mem [q ].hh.b1 = ( ( mem [q ].hh.b1 ) / 8 ) * 8 + ( ( mem [v ].hh.b1 ) 
  % 8 ) ;
...
zfreezepagespecs ( smallnumber s ) 
{
  ...
  pagecontents = s ;
  pagesofar [0 ]= eqtb [29775 ].cint ;
  pagemaxdepth = eqtb [29776 ].cint ;
  pagesofar [8 ]= 0 ;
  pagesofar [1 ]= 0 ;
  pagesofar [2 ]= 0 ;
  pagesofar [3 ]= 0 ;
...
zfireup ( halfword c ) 
{
  ...
  savevfuzz = eqtb [29780 ].cint ;
  eqtb [29780 ].cint = 1073741823L ;
...
buildpage ( void ) 
{
  ...
  do {
	...
	if ( mem [r ].hh.b1 != n ) 
	{
	  ...
	  if ( eqtb [29259 + n ].cint == 1000 ) 
	  h = mem [r + 3 ].cint ;
	  else h = xovern ( mem [r + 3 ].cint , 1000 ) * eqtb [29259 + n ]
	  .cint ;
	...
	insertpenalties = insertpenalties + mem [p + 1 ].cint ;
	  ...
	  if ( eqtb [29259 + n ].cint == 1000 ) 
	  h = mem [p + 3 ].cint ;
	  else h = xovern ( mem [p + 3 ].cint , 1000 ) * eqtb [29259 + n ]
	  .cint ;
	  if ( ( ( h <= 0 ) || ( h <= delta ) ) && ( mem [p + 3 ].cint + mem 
	  [r + 3 ].cint <= eqtb [29796 + n ].cint ) ) 
	  {
	    ...
	    if ( eqtb [29259 + n ].cint <= 0 ) 
	    w = 1073741823L ;
	    else {
		
	      w = pagesofar [0 ]- pagesofar [1 ]- pagesofar [8 ];
	      if ( eqtb [29259 + n ].cint != 1000 ) 
	      w = xovern ( w , eqtb [29259 + n ].cint ) * 1000 ;
	    } 
	    if ( w > eqtb [29796 + n ].cint - mem [r + 3 ].cint ) 
	    w = eqtb [29796 + n ].cint - mem [r + 3 ].cint ;
...
znewgraf ( boolean indented ) 
{
  ...
  if ( indented ) 
  {
    ...
    mem [curlist .tailfield + 1 ].cint = eqtb [29771 ].cint ;
...
makeaccent ( void ) 
{
  ...
  if ( p != -1073741823L ) 
  {
    ...
    if ( curlist .dirfield == 3 ) 
    {
      ...
      disp = eqtb [29792 ].cint - eqtb [29793 ].cint ;
      else disp = eqtb [29792 ].cint ;
    } 
    else {
      ...
      disp = eqtb [29793 ].cint - eqtb [29792 ].cint ;
      else disp = eqtb [29793 ].cint ;
    } 
    {
      if ( ! ( curlist .tailfield >= himemmin ) && ( mem [curlist .tailfield 
      ].hh.b0 == 5 ) ) 
...
initmath ( void ) 
{
  ...
  if ( ( curcmd == 3 ) && ( curlist .modefield > 0 ) ) 
  {
    ...
    if ( eqtb [25061 ].hh .v.RH == -1073741823L ) {
      ...
      if ( ( eqtb [29788 ].cint != 0 ) && ( ( ( eqtb [29229 ].cint >= 0 ) 
      && ( curlist .pgfield + 2 > eqtb [29229 ].cint ) ) || ( curlist 
      .pgfield + 1 < - (integer) eqtb [29229 ].cint ) ) ) 
      {
	l = eqtb [29774 ].cint - abs ( eqtb [29788 ].cint ) ;
	if ( eqtb [29788 ].cint > 0 ) 
	s = eqtb [29788 ].cint ;
	else s = 0 ;
      } 
    ...
    eqworddefine ( 29784 , w ) ;
    curlist .eTeXauxfield = j ;
    if ( ( eTeXmode == 1 ) ) 
    eqworddefine ( 29254 , x ) ;
    eqworddefine ( 29785 , l ) ;
...
zscandelimiter ( halfword p , boolean r ) 
{
  ...
  scanfiftyonebitint () ;
    ...
    case 12 : 
      {
	curval = eqtb [29515 + curchr ].cint ;
	curval1 = getintone ( eqtb [29515 + curchr ]) ;
      } 
      break ;
    case 15 : 
      if ( curchr == 0 ) 
...
aftermath ( void ) 
{
  ...
  if ( m < 0 ) 
  {
    ...
    {
      mem [curlist .tailfield ].hh .v.RH = newmath ( eqtb [29772 ].cint , 
      0 ) ;
      curlist .tailfield = mem [curlist .tailfield ].hh .v.RH ;
    } 
    curmlist = p ;
...
maincontrol ( void ) 
{
  ...
  */ maincontrol_regmem 
  ...
  case 155 : 
    if ( curchr > 0 ) 
    {
      if ( eTeXenabled ( ( eqtb [29258 ].cint > 0 ) , curcmd , curchr ) ) 
      {
  ...
  lab130: if ( ( curlist .tailfield >= himemmin ) ) 
  {
	...
	{
	  {
	    mem [curlist .tailfield ].hh .v.RH = newpenalty ( eqtb [30052 + 
	    kp ].cint ) ;
	    curlist .tailfield = mem [curlist .tailfield ].hh .v.RH ;
	  } 
	  mem [curlist .tailfield ].hh.b1 = 2 ;
  ...
  if ( mainf != 0 ) 
  {
	...
	if ( eqtb [27642 + kp ].hh.b0 == 1 ) 
	{
	  ...
	  mem [curq + 1 ].cint = mem [curq + 1 ].cint + eqtb [30052 + kp 
	  ].cint ;
	  else {
	      
	    mainp = mem [curq ].hh .v.RH ;
	    mem [curq ].hh .v.RH = newpenalty ( eqtb [30052 + kp ].cint ) 
	    ;
  ...
  if ( ( curcmd >= 16 ) && ( curcmd <= 19 ) ) 
  {
	...
	if ( kp != 1000 ) 
	{
	  ...
	  {
	    if ( ! ( curq >= himemmin ) && ( mem [curq ].hh.b0 == 14 ) ) 
	    mem [curq + 1 ].cint = mem [curq + 1 ].cint + eqtb [30052 + 
	    kp ].cint ;
	    else {
  ...
  if ( curcmd == 73 ) 
  {
	...
	cx = curl ;
	{
	  ...
	  if ( kp != 1000 ) 
	  {
		...
		mainp = mem [curq ].hh .v.RH ;
		mem [curq ].hh .v.RH = newpenalty ( eqtb [30052 + kp ]
		.cint ) ;
		mem [mem [curq ].hh .v.RH ].hh.b1 = 2 ;
		mem [mem [curq ].hh .v.RH ].hh .v.RH = mainp ;
	      } 
