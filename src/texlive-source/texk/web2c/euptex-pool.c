...
static const char *poolfilearr[] = {
  ...
  "main memory size",
  "new_dir_node:not box",
  "new_dir_node:illegal dir",
  "new_dir_node:y->" "?",
  "new_dir_node:t->" "?",
  "new_dir_node:d->" "?",
  ...
  "Use `",
  "' at top of list",
  "Direction change command is available only while",
  ...
  "I'm skip this control sequences.",
  ...
  "cjktoken",
  "auto spacing mode; ",
  "no auto spacing mode; ",
  "auto xspacing mode",
  "no auto xspacing mode",
  "inhibitglue",
  "inhibitxspcode",
  "Inhibit table is full!!",
  "Invalid KANJI code (",
  "prebreakpenalty",
  "postbreakpenalty",
  "c:=",
